 ...
 *
 * @method array getInfos() 获取媒体传输事件的配置信息列表。
 * @method void setInfos(array $Infos) 设置媒体传输事件的配置信息列表。
 ...
 */
class DescribeStreamLinkEventsResponse extends AbstractModel
{
    /**
     * @var array 媒体传输事件的配置信息列表。
     */
    public $Infos;
    ...
    /**
     * @param array $Infos 媒体传输事件的配置信息列表。

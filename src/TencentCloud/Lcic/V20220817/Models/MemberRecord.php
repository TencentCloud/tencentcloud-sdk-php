...
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getStage() 获取本堂课用户是否上过台。0 否；1 是
 * @method void setStage(integer $Stage) 设置本堂课用户是否上过台。0 否；1 是
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var integer 本堂课用户是否上过台。0 否；1 是
     */
    public $Stage;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $Stage 本堂课用户是否上过台。0 否；1 是

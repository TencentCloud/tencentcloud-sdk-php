 ...
 * @method string getConfigMapName() 获取ConfigMap名
 * @method void setConfigMapName(string $ConfigMapName) 设置ConfigMap名
...
class DeleteConfigMapRequest extends AbstractModel
{
     ...
     * @param string $ConfigMapName ConfigMap名

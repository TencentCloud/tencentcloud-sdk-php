 ...
 *
 * @method SessionInfo getSession() 获取<p>会话信息</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setSession(SessionInfo $Session) 设置<p>会话信息</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param SessionInfo $Session <p>会话信息</p>
注意：此字段可能返回 null，表示取不到有效值。

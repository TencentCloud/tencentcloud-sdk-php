 ...
 * @method string getName() 获取<p>按知识库名称精确匹配筛选，不填则返回所有知识库。</p>
 * @method void setName(string $Name) 设置<p>按知识库名称精确匹配筛选，不填则返回所有知识库。</p>
 */
class DescribeKnowledgeBasesRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>按知识库名称精确匹配筛选，不填则返回所有知识库。</p>
     */
    public $Name;
     ...
     * @param string $Name <p>按知识库名称精确匹配筛选，不填则返回所有知识库。</p>
     */

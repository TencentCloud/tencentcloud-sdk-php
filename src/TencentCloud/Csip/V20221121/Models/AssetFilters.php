 ...
 * @method boolean getExactMatch() 获取<p>是否模糊查询</p>
 * @method void setExactMatch(boolean $ExactMatch) 设置<p>是否模糊查询</p>
 */
class AssetFilters extends AbstractModel
{
     ...
     * @param boolean $ExactMatch <p>是否模糊查询</p>
     */

 ...
 * MCP Tool 列表
 *
 * @method array getDataList() 获取<p>MCPTool 列表</p>
 * @method void setDataList(array $DataList) 设置<p>MCPTool 列表</p>
 * @method integer getTotalCount() 获取<p>总数</p>
 * @method void setTotalCount(integer $TotalCount) 设置<p>总数</p>
 */
class CNAPIGwMCPToolList extends AbstractModel
{
    /**
     * @var array <p>MCPTool 列表</p>
     */
    public $DataList;
    ...
    /**
     * @param array $DataList <p>MCPTool 列表</p>

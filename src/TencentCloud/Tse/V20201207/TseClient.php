...
/**
 * @method Models\AddCloudNativeAPIGatewayConsumerGroupAuthResponse AddCloudNativeAPIGatewayConsumerGroupAuth(Models\AddCloudNativeAPIGatewayConsumerGroupAuthRequest $req) 添加消费者组授权
 * @method Models\AddCloudNativeAPIGatewayConsumerInGroupResponse AddCloudNativeAPIGatewayConsumerInGroup(Models\AddCloudNativeAPIGatewayConsumerInGroupRequest $req) 将消费者添加到指定的消费者组中
 ...
 * @method Models\CreateCloudNativeAPIGatewayConsumerResponse CreateCloudNativeAPIGatewayConsumer(Models\CreateCloudNativeAPIGatewayConsumerRequest $req) 创建云原生网关的消费者，支持多种密钥生成方式
 * @method Models\CreateCloudNativeAPIGatewayConsumerGroupResponse CreateCloudNativeAPIGatewayConsumerGroup(Models\CreateCloudNativeAPIGatewayConsumerGroupRequest $req) 创建云原生网关的消费者组
 * @method Models\CreateCloudNativeAPIGatewayLLMModelAPIResponse CreateCloudNativeAPIGatewayLLMModelAPI(Models\CreateCloudNativeAPIGatewayLLMModelAPIRequest $req) 创建AI网关模型 API
 ...
 * @method Models\CreateCloudNativeAPIGatewaySecretKeyResponse CreateCloudNativeAPIGatewaySecretKey(Models\CreateCloudNativeAPIGatewaySecretKeyRequest $req) 创建云原生网关密钥
 ...
 * @method Models\CreateOrModifyCloudNativeAPIGatewayCORSResponse CreateOrModifyCloudNativeAPIGatewayCORS(Models\CreateOrModifyCloudNativeAPIGatewayCORSRequest $req) 创建或编辑云原生网关跨域配置
 ...
 * @method Models\DeleteCloudNativeAPIGatewayCORSResponse DeleteCloudNativeAPIGatewayCORS(Models\DeleteCloudNativeAPIGatewayCORSRequest $req) 删除云原生网关跨域插件
 ...
 * @method Models\DeleteCloudNativeAPIGatewayConsumerResponse DeleteCloudNativeAPIGatewayConsumer(Models\DeleteCloudNativeAPIGatewayConsumerRequest $req) 删除指定的云原生网关消费者
 * @method Models\DeleteCloudNativeAPIGatewayConsumerGroupResponse DeleteCloudNativeAPIGatewayConsumerGroup(Models\DeleteCloudNativeAPIGatewayConsumerGroupRequest $req) 删除云原生网关消费者组的信息
 ...
 * @method Models\DeleteCloudNativeAPIGatewayLLMModelAPIResponse DeleteCloudNativeAPIGatewayLLMModelAPI(Models\DeleteCloudNativeAPIGatewayLLMModelAPIRequest $req) 删除 LLM 模型 API 信息
 * @method Models\DeleteCloudNativeAPIGatewayLLMModelServiceResponse DeleteCloudNativeAPIGatewayLLMModelService(Models\DeleteCloudNativeAPIGatewayLLMModelServiceRequest $req) 删除 LLM 模型服务信息
 ...
 * @method Models\DeleteCloudNativeAPIGatewaySecretKeyResponse DeleteCloudNativeAPIGatewaySecretKey(Models\DeleteCloudNativeAPIGatewaySecretKeyRequest $req) 删除云原生网关密钥
 ...
 * @method Models\DescribeCloudNativeAPIGatewayConsumerResponse DescribeCloudNativeAPIGatewayConsumer(Models\DescribeCloudNativeAPIGatewayConsumerRequest $req) 查询指定的云原生网关消费者
 * @method Models\DescribeCloudNativeAPIGatewayConsumerGroupResponse DescribeCloudNativeAPIGatewayConsumerGroup(Models\DescribeCloudNativeAPIGatewayConsumerGroupRequest $req) 查看云原生网关消费者组的信息
 * @method Models\DescribeCloudNativeAPIGatewayConsumerGroupListResponse DescribeCloudNativeAPIGatewayConsumerGroupList(Models\DescribeCloudNativeAPIGatewayConsumerGroupListRequest $req) 获取消费者组列表
 * @method Models\DescribeCloudNativeAPIGatewayConsumerListResponse DescribeCloudNativeAPIGatewayConsumerList(Models\DescribeCloudNativeAPIGatewayConsumerListRequest $req) 查询云原生网关消费者列表
 ...
 * @method Models\DescribeCloudNativeAPIGatewayLLMModelAPIResponse DescribeCloudNativeAPIGatewayLLMModelAPI(Models\DescribeCloudNativeAPIGatewayLLMModelAPIRequest $req) 查询单个 LLM 模型 API 信息
 ...
 * @method Models\DescribeCloudNativeAPIGatewayLLMModelServiceResponse DescribeCloudNativeAPIGatewayLLMModelService(Models\DescribeCloudNativeAPIGatewayLLMModelServiceRequest $req) 查询单个 LLM 模型服务列表
 ...
 * @method Models\DescribeCloudNativeAPIGatewaySecretKeyResponse DescribeCloudNativeAPIGatewaySecretKey(Models\DescribeCloudNativeAPIGatewaySecretKeyRequest $req) 查询密钥详情
 * @method Models\DescribeCloudNativeAPIGatewaySecretKeyListResponse DescribeCloudNativeAPIGatewaySecretKeyList(Models\DescribeCloudNativeAPIGatewaySecretKeyListRequest $req) 获取密钥列表
 * @method Models\DescribeCloudNativeAPIGatewaySecretKeyValueResponse DescribeCloudNativeAPIGatewaySecretKeyValue(Models\DescribeCloudNativeAPIGatewaySecretKeyValueRequest $req) 查询密钥值
 ...
 * @method Models\ModifyCloudNativeAPIGatewayConsumerResponse ModifyCloudNativeAPIGatewayConsumer(Models\ModifyCloudNativeAPIGatewayConsumerRequest $req) 修改云原生网关消费者的信息
 * @method Models\ModifyCloudNativeAPIGatewayConsumerGroupResponse ModifyCloudNativeAPIGatewayConsumerGroup(Models\ModifyCloudNativeAPIGatewayConsumerGroupRequest $req) 修改云原生网关消费者组的信息
 * @method Models\ModifyCloudNativeAPIGatewayLLMModelAPIResponse ModifyCloudNativeAPIGatewayLLMModelAPI(Models\ModifyCloudNativeAPIGatewayLLMModelAPIRequest $req) 修改 LLM 模型 API 信息
 ...
 * @method Models\ModifyCloudNativeAPIGatewaySecretKeyStatusResponse ModifyCloudNativeAPIGatewaySecretKeyStatus(Models\ModifyCloudNativeAPIGatewaySecretKeyStatusRequest $req) 修改密钥状态
 ...
 * @method Models\RemoveCloudNativeAPIGatewayConsumerGroupAuthResponse RemoveCloudNativeAPIGatewayConsumerGroupAuth(Models\RemoveCloudNativeAPIGatewayConsumerGroupAuthRequest $req) 云原生网关移除消费者组授权
 * @method Models\RemoveCloudNativeAPIGatewayConsumerInGroupResponse RemoveCloudNativeAPIGatewayConsumerInGroup(Models\RemoveCloudNativeAPIGatewayConsumerInGroupRequest $req) 从指定的消费者组中移除消费者

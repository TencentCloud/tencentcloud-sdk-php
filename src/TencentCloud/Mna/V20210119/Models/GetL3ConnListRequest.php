 ...
 * @method string getDeviceId() 获取搜索分组的DeviceId，为空时匹配所有分组
 * @method void setDeviceId(string $DeviceId) 设置搜索分组的DeviceId，为空时匹配所有分组
 */
class GetL3ConnListRequest extends AbstractModel
{
    ...
    /**
     * @var string 搜索分组的DeviceId，为空时匹配所有分组
     */
    public $DeviceId;
     ...
     * @param string $DeviceId 搜索分组的DeviceId，为空时匹配所有分组
     */

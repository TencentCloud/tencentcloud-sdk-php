 ...
 * @method array getRegions() 获取<p>下属城市明细</p>
 * @method void setRegions(array $Regions) 设置<p>下属城市明细</p>
 * @method string getCity() 获取<p>城市</p>
 * @method void setCity(string $City) 设置<p>城市</p>
 */
class FlavorKingCycleBrandImportantCityScanAnalysisCityItem extends AbstractModel
{
    /**
     * @var float <p>口味王分布</p>
     */
     ...
     * @param array $Regions <p>下属城市明细</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Regions",$param) and $param["Regions"] !== null) {
            ...
            foreach ($param["Regions"] as $key => $value){
                $obj = new FlavorKingCycleBrandImportantCityScanAnalysisRegionItem();

 ...
 * @method NetworkAclEntrySet getNetworkAclEntrySet() 获取网络三元组ACL规则集。
 * @method void setNetworkAclEntrySet(NetworkAclEntrySet $NetworkAclEntrySet) 设置网络三元组ACL规则集。
 */
class CreateNetworkAclEntriesRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var NetworkAclEntrySet 网络三元组ACL规则集。
     */
    public $NetworkAclEntrySet;

    /**
     * @param string $NetworkAclId 网络ACL实例ID。例如：acl-12345678。
     * @param NetworkAclEntrySet $NetworkAclEntrySet 网络三元组ACL规则集。
     */

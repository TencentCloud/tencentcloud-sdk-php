 ...
 * @method string getType() 获取类型:"allcount", "falls", "samp", "version", "ext3","nettype", "platform","isp","region","device","browser","ext1","ext2"
 * @method void setType(string $Type) 设置类型:"allcount", "falls", "samp", "version", "ext3","nettype", "platform","isp","region","device","browser","ext1","ext2"
...
class DescribeDataPvUrlStatisticsRequest extends AbstractModel
{
    ...
    /**
     * @var string 类型:"allcount", "falls", "samp", "version", "ext3","nettype", "platform","isp","region","device","browser","ext1","ext2"
     */
    public $Type;

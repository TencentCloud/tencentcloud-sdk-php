 ...
 * @method string getFields() 获取查询指标 fields
 * @method void setFields(string $Fields) 设置查询指标 fields
 ...
 * @method string getBusinessContext() 获取业务上下文参数
 * @method void setBusinessContext(string $BusinessContext) 设置业务上下文参数
 */
class DescribeAppDimensionMetricsRequest extends AbstractModel
{
    /**
     ...
     * @param string $Fields 查询指标 fields
     ...
     * @param string $BusinessContext 业务上下文参数
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("BusinessContext",$param) and $param["BusinessContext"] !== null) {
            $this->BusinessContext = $param["BusinessContext"];
        }
    }
}

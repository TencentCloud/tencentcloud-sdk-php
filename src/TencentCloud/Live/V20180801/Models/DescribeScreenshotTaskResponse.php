 ...
 * @method array getTaskList() 获取截图任务列表。当该字段为空，说明已返回所有数据。
 * @method void setTaskList(array $TaskList) 设置截图任务列表。当该字段为空，说明已返回所有数据。
...
class DescribeScreenshotTaskResponse extends AbstractModel
{
    ...
    /**
     * @var array 截图任务列表。当该字段为空，说明已返回所有数据。
     */
    public $TaskList;
     ...
     * @param array $TaskList 截图任务列表。当该字段为空，说明已返回所有数据。

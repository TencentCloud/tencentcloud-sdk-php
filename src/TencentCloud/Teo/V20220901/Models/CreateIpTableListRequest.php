 ...
 * @method array getIpTableRules() 获取基础访问管控Ip规则列表。
 * @method void setIpTableRules(array $IpTableRules) 设置基础访问管控Ip规则列表。
 */
class CreateIpTableListRequest extends AbstractModel
{
     ...
     * @param array $IpTableRules 基础访问管控Ip规则列表。
     */

...
class CreateIntegrationEmployeesResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("CreateEmployeeResult",$param) and $param["CreateEmployeeResult"] !== null) {
            $this->CreateEmployeeResult = new CreateStaffResult();
            $this->CreateEmployeeResult->deserialize($param["CreateEmployeeResult"]);
        }

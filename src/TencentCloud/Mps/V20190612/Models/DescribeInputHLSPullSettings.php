 ...
 * 查询输入的HLS配置信息。
 *
 * @method array getSourceAddresses() 获取HLS源站地址信息。
 * @method void setSourceAddresses(array $SourceAddresses) 设置HLS源站地址信息。
 */
class DescribeInputHLSPullSettings extends AbstractModel
{
    ...
    /**
     * @param array $SourceAddresses HLS源站地址信息。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("SourceAddresses",$param) and $param["SourceAddresses"] !== null) {
            ...
            foreach ($param["SourceAddresses"] as $key => $value){
                $obj = new DescribeHLSPullSourceAddress();

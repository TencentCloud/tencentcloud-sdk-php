 ...
 * @method string getStatus() 获取<p>状态</p><p>枚举值：</p><ul><li>Active： 正常</li></ul>
 * @method void setStatus(string $Status) 设置<p>状态</p><p>枚举值：</p><ul><li>Active： 正常</li></ul>
...
class ApiKeyInfo extends AbstractModel
{
    ...
    /**
     * @var string <p>状态</p><p>枚举值：</p><ul><li>Active： 正常</li></ul>
     */
    public $Status;
     ...
     * @param string $Status <p>状态</p><p>枚举值：</p><ul><li>Active： 正常</li></ul>

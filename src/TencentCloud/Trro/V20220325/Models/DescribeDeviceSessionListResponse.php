 ...
 * @method array getDeviceSessionList() 获取<p>会话列表</p>
 * @method void setDeviceSessionList(array $DeviceSessionList) 设置<p>会话列表</p>
...
class DescribeDeviceSessionListResponse extends AbstractModel
{
     ...
     * @param array $DeviceSessionList <p>会话列表</p>

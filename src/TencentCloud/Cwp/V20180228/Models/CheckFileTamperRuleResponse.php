 ...
 *
 * @method integer getErrCode() 获取0=校验通过  1=规则名称校验不通过
 * @method void setErrCode(integer $ErrCode) 设置0=校验通过  1=规则名称校验不通过
...
{
    /**
     * @var integer 0=校验通过  1=规则名称校验不通过
     */
    public $ErrCode;
    ...
    /**
     * @param integer $ErrCode 0=校验通过  1=规则名称校验不通过

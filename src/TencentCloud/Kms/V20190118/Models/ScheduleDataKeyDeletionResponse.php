 ...
 * @method string getDataKeyId() 获取唯一标志被计划删除的数据密钥
 * @method void setDataKeyId(string $DataKeyId) 设置唯一标志被计划删除的数据密钥
...
class ScheduleDataKeyDeletionResponse extends AbstractModel
{
     ...
     * @param string $DataKeyId 唯一标志被计划删除的数据密钥

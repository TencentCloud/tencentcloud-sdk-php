 ...
 * @method array getItemIDList() 获取<p>要重新扫描的检测项 ID 列表，不可为空且元素不可为 0。</p>
 * @method void setItemIDList(array $ItemIDList) 设置<p>要重新扫描的检测项 ID 列表，不可为空且元素不可为 0。</p>
...
class ScanBaselineItemListRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>要重新扫描的检测项 ID 列表，不可为空且元素不可为 0。</p>
     */
    public $ItemIDList;
     ...
     * @param array $ItemIDList <p>要重新扫描的检测项 ID 列表，不可为空且元素不可为 0。</p>

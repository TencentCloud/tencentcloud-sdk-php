 ...
 * @method string getName() 获取高优路由表名称，最大长度不能超过60个字节。
 * @method void setName(string $Name) 设置高优路由表名称，最大长度不能超过60个字节。
 * @method array getTags() 获取指定绑定的标签列表，例如：[{"Key": "city", "Value": "shanghai"}]
 * @method void setTags(array $Tags) 设置指定绑定的标签列表，例如：[{"Key": "city", "Value": "shanghai"}]
 */
class CreateHighPriorityRouteTableRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string 高优路由表名称，最大长度不能超过60个字节。
     */
    public $Name;
     ...
     * @param string $Name 高优路由表名称，最大长度不能超过60个字节。

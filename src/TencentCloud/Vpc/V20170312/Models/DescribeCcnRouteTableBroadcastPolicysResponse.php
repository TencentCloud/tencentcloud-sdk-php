 ...
 *
 * @method array getPolicySet() 获取路由表传播策略。
 * @method void setPolicySet(array $PolicySet) 设置路由表传播策略。
 ...
 */
class DescribeCcnRouteTableBroadcastPolicysResponse extends AbstractModel
{
    /**
     * @var array 路由表传播策略。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("PolicySet",$param) and $param["PolicySet"] !== null) {
            ...
            foreach ($param["PolicySet"] as $key => $value){
                $obj = new CcnRouteTableBroadcastPolicys();

 ...
 * @method float getCredits() 获取<p>该任务消耗的积分数量。</p>
 * @method void setCredits(float $Credits) 设置<p>该任务消耗的积分数量。</p>
 * @method string getPayload() 获取<p>任务调用时传入的透传参数。</p>
 * @method void setPayload(string $Payload) 设置<p>任务调用时传入的透传参数。</p>
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeReferenceToVideoViduJobResponse extends AbstractModel
{
    /**
    ...
    /**
     * @var float <p>该任务消耗的积分数量。</p>
     */
    public $Credits;

    /**
     * @var string <p>任务调用时传入的透传参数。</p>
     */
    public $Payload;
     ...
     * @param float $Credits <p>该任务消耗的积分数量。</p>
     * @param string $Payload <p>任务调用时传入的透传参数。</p>

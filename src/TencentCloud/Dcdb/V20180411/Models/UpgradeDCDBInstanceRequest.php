 ...
 * @method boolean getAutoVoucher() 获取<p>是否自动使用代金券进行支付，默认不使用。</p>
 * @method void setAutoVoucher(boolean $AutoVoucher) 设置<p>是否自动使用代金券进行支付，默认不使用。</p>
...
class UpgradeDCDBInstanceRequest extends AbstractModel
{
    ...
    /**
     * @var boolean <p>是否自动使用代金券进行支付，默认不使用。</p>
     */
    public $AutoVoucher;
     ...
     * @param boolean $AutoVoucher <p>是否自动使用代金券进行支付，默认不使用。</p>

 ...
 * @method string getTopicRegion() 获取topic所在region
 * @method void setTopicRegion(string $TopicRegion) 设置topic所在region
 */
class EnableEksEventPersistenceRequest extends AbstractModel
{
    /**
     * @var string 集群ID
     */
     ...
     * @param string $TopicRegion topic所在region
     */

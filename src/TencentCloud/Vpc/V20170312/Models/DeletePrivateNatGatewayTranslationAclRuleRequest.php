 ...
 * @method array getAclRuleIds() 获取访问控制规则对应`ID`
 * @method void setAclRuleIds(array $AclRuleIds) 设置访问控制规则对应`ID`
 * @method string getOriginalIp() 获取源`IP`,当转换规则类型为三层时有效
 * @method void setOriginalIp(string $OriginalIp) 设置源`IP`,当转换规则类型为三层时有效
 */
class DeletePrivateNatGatewayTranslationAclRuleRequest extends AbstractModel
{
    /**
     ...
     * @param array $AclRuleIds 访问控制规则对应`ID`
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("AclRuleIds",$param) and $param["AclRuleIds"] !== null) {
            $this->AclRuleIds = $param["AclRuleIds"];
        }

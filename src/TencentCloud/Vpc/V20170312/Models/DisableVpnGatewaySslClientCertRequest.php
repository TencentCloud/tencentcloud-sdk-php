 ...
 * @method array getSslVpnClientIds() 获取SSL-VPN-CLIENT 实例ID列表。批量禁用时使用。不可和SslVpnClientId同时使用。
 * @method void setSslVpnClientIds(array $SslVpnClientIds) 设置SSL-VPN-CLIENT 实例ID列表。批量禁用时使用。不可和SslVpnClientId同时使用。
 */
class DisableVpnGatewaySslClientCertRequest extends AbstractModel
{
    ...
    /**
     * @var array SSL-VPN-CLIENT 实例ID列表。批量禁用时使用。不可和SslVpnClientId同时使用。
     */
    public $SslVpnClientIds;

    /**
     * @param string $SslVpnClientId SSL-VPN-CLIENT 实例ID。不可和SslVpnClientIds同时使用。
     * @param array $SslVpnClientIds SSL-VPN-CLIENT 实例ID列表。批量禁用时使用。不可和SslVpnClientId同时使用。
     */

 ...
 *
 * @method array getPlanSet() 获取<p>触发计划列表。</p>
 * @method void setPlanSet(array $PlanSet) 设置<p>触发计划列表。</p>
 ...
 */
class DescribeAISchedulePlanListResponse extends AbstractModel
{
    /**
     * @var array <p>触发计划列表。</p>
     */
    public $PlanSet;
    ...
    /**
     * @param array $PlanSet <p>触发计划列表。</p>

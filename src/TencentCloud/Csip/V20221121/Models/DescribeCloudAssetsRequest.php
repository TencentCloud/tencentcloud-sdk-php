 ...
 * @method boolean getIsCloudHost() 获取是否查询主机资产
 * @method void setIsCloudHost(boolean $IsCloudHost) 设置是否查询主机资产
 */
class DescribeCloudAssetsRequest extends AbstractModel
{
    /**
     ...
     * @param boolean $IsCloudHost 是否查询主机资产
     */

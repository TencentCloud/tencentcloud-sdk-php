...
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getTestList() 获取检验指标表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTestList(array $TestList) 设置检验指标表
注意：此字段可能返回 null，表示取不到有效值。
 * @method Inspection getInspection() 获取检查报告内容
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setInspection(Inspection $Inspection) 设置检查报告内容
注意：此字段可能返回 null，表示取不到有效值。
 * @method CaseHistory getCaseHistory() 获取病历资料
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setCaseHistory(CaseHistory $CaseHistory) 设置病历资料
注意：此字段可能返回 null，表示取不到有效值。
 * @method Pathology getPathology() 获取病理检查内容
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setPathology(Pathology $Pathology) 设置病理检查内容
注意：此字段可能返回 null，表示取不到有效值。
 */
class TextReport extends AbstractModel
{
    /**
     * @var array 报告类别信息
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var CaseHistory 病历资料
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $CaseHistory;

    /**
     * @var Pathology 病理检查内容
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Pathology;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $TestList 检验指标表
注意：此字段可能返回 null，表示取不到有效值。
     * @param Inspection $Inspection 检查报告内容
注意：此字段可能返回 null，表示取不到有效值。
     * @param CaseHistory $CaseHistory 病历资料
注意：此字段可能返回 null，表示取不到有效值。
     * @param Pathology $Pathology 病理检查内容
注意：此字段可能返回 null，表示取不到有效值。
     */

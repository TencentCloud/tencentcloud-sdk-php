...
注意：
RegisterInfo 中的OrganizationIdCardType值不为空的时候，才可设置为不可编辑。
 * @method boolean getUnifiedSocialCreditCodeSame() 获取是否允许编辑企业注册时统一社会信用代码。
<br/>true:不允许编辑。
<br/>false:允许编辑（默认值）。
<br/>
...
注意：
RegisterInfo 中的UnifiedSocialCreditCode值不为空的时候，才可设置为不可编辑。
 * @method void setUnifiedSocialCreditCodeSame(boolean $UnifiedSocialCreditCodeSame) 设置是否允许编辑企业注册时统一社会信用代码。
<br/>true:不允许编辑。
<br/>false:允许编辑（默认值）。
<br/>
...
RegisterInfo 中的UnifiedSocialCreditCode值不为空的时候，才可设置为不可编辑。
     */
    public $UnifiedSocialCreditCodeSame;
...
注意：
RegisterInfo 中的OrganizationIdCardType值不为空的时候，才可设置为不可编辑。
     * @param boolean $UnifiedSocialCreditCodeSame 是否允许编辑企业注册时统一社会信用代码。
<br/>true:不允许编辑。
<br/>false:允许编辑（默认值）。
<br/>
...
RegisterInfo 中的UnifiedSocialCreditCode值不为空的时候，才可设置为不可编辑。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("UnifiedSocialCreditCodeSame",$param) and $param["UnifiedSocialCreditCodeSame"] !== null) {
            $this->UnifiedSocialCreditCodeSame = $param["UnifiedSocialCreditCodeSame"];
        }
    }
}

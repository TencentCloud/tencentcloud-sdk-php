 ...
 * @method SmartPredictReqData getData() 获取请求体
 * @method void setData(SmartPredictReqData $Data) 设置请求体
 */
class SmartPredictRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var SmartPredictReqData 请求体
     */
    public $Data;

    /**
     * @param CommonHeader $Header 请求头
     * @param SmartPredictReqData $Data 请求体
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Data",$param) and $param["Data"] !== null) {
            $this->Data = new SmartPredictReqData();

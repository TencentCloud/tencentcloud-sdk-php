...
注意：此字段可能返回 null，表示取不到有效值。
 * @method boolean getResourceValue() 获取是否启用
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResourceValue(boolean $ResourceValue) 设置是否启用
注意：此字段可能返回 null，表示取不到有效值。
 * @method boolean getCanChange() 获取能否变更
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setCanChange(boolean $CanChange) 设置能否变更
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 */
class ResourceDTO extends AbstractModel
{
    /**
     * @var string 资源名称
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param boolean $ResourceValue 是否启用
注意：此字段可能返回 null，表示取不到有效值。
     * @param boolean $CanChange 能否变更
注意：此字段可能返回 null，表示取不到有效值。

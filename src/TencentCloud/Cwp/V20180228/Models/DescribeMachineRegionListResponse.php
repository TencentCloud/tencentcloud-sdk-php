 ...
 *
 * @method array getRegionList() 获取云服务器类型地域列表
 * @method void setRegionList(array $RegionList) 设置云服务器类型地域列表
...
class DescribeMachineRegionListResponse extends AbstractModel
{
    ...
    /**
     * @param array $RegionList 云服务器类型地域列表

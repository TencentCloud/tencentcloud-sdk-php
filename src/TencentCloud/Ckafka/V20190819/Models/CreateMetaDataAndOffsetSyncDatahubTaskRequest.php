 ...
 *
 * @method string getTaskName() 获取<p>任务名称</p><p>参数格式：task-test</p><p>64字符内</p>
 * @method void setTaskName(string $TaskName) 设置<p>任务名称</p><p>参数格式：task-test</p><p>64字符内</p>
 ...
 * @method string getTargetResourceId() 获取<p>同步目标链接</p><p>参数格式：resource-test</p>
 * @method void setTargetResourceId(string $TargetResourceId) 设置<p>同步目标链接</p><p>参数格式：resource-test</p>
 ...
 * @method string getOffsetType() 获取<p>Offset类型，最开始位置earliest，最新位置latest</p><p>枚举值：</p><ul><li>earliest： 最开始位置</li><li>latest： 最新位置</li></ul>
 * @method void setOffsetType(string $OffsetType) 设置<p>Offset类型，最开始位置earliest，最新位置latest</p><p>枚举值：</p><ul><li>earliest： 最开始位置</li><li>latest： 最新位置</li></ul>
 ...
 */
class CreateMetaDataAndOffsetSyncDatahubTaskRequest extends AbstractModel
{
    /**
     * @var string <p>任务名称</p><p>参数格式：task-test</p><p>64字符内</p>
     */
    public $TaskName;
    ...
    /**
     * @var string <p>同步目标链接</p><p>参数格式：resource-test</p>
     */
    ...
    /**
     * @var string <p>Offset类型，最开始位置earliest，最新位置latest</p><p>枚举值：</p><ul><li>earliest： 最开始位置</li><li>latest： 最新位置</li></ul>
     */
    public $OffsetType;
    ...
    /**
     * @param string $TaskName <p>任务名称</p><p>参数格式：task-test</p><p>64字符内</p>
     * @param string $SourceResourceId <p>同步源连接</p><p>参数格式：resource-test</p>
     * @param string $TargetResourceId <p>同步目标链接</p><p>参数格式：resource-test</p>
     * @param string $Description <p>连接器任务描述</p><p>128字符内</p>
     * @param string $OffsetType <p>Offset类型，最开始位置earliest，最新位置latest</p><p>枚举值：</p><ul><li>earliest： 最开始位置</li><li>latest： 最新位置</li></ul>

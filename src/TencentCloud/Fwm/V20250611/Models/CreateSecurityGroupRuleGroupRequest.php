 ...
 *
 * @method string getGroupName() 获取规则组ID
 * @method void setGroupName(string $GroupName) 设置规则组ID
 ...
 */
class CreateSecurityGroupRuleGroupRequest extends AbstractModel
{
    /**
     * @var string 规则组ID
     */

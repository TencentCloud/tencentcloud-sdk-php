 ...
 *
 * @method DataSourceInfo getDataSourceInfo() 获取数据源信息
 * @method void setDataSourceInfo(DataSourceInfo $DataSourceInfo) 设置数据源信息
...
class DescribeDataSourceResponse extends AbstractModel
{
    ...
    /**
     * @param DataSourceInfo $DataSourceInfo 数据源信息

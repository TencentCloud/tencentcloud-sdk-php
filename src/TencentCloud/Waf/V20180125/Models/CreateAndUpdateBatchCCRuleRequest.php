 ...
 * @method array getDomains() 获取批量规则配置的域名
 * @method void setDomains(array $Domains) 设置批量规则配置的域名
 * @method array getGroupIds() 获取批量规则配置的防护组
 * @method void setGroupIds(array $GroupIds) 设置批量规则配置的防护组
 * @method string getJobType() 获取定时生效类型
 * @method void setJobType(string $JobType) 设置定时生效类型
 * @method JobDateTime getJobDateTime() 获取定时生效配置
 * @method void setJobDateTime(JobDateTime $JobDateTime) 设置定时生效配置
 * @method string getCronType() 获取定时生效类型：month or week
 * @method void setCronType(string $CronType) 设置定时生效类型：month or week
 * @method integer getExpireTime() 获取过期时间
 * @method void setExpireTime(integer $ExpireTime) 设置过期时间
 */
class CreateAndUpdateBatchCCRuleRequest extends AbstractModel
{
    /**
     * @var string 名称
     */
    ...
    /**
     * @var JobDateTime 定时生效配置
     */
    public $JobDateTime;

    /**
     * @var string 定时生效类型：month or week
     */
    public $CronType;
     ...
     * @param array $Domains 批量规则配置的域名
     * @param array $GroupIds 批量规则配置的防护组
     * @param string $JobType 定时生效类型
     * @param JobDateTime $JobDateTime 定时生效配置
     * @param string $CronType 定时生效类型：month or week

 ...
 * @method string getPayloadBase64() 获取设备回复的的消息内容，采用base64编码
 * @method void setPayloadBase64(string $PayloadBase64) 设置设备回复的的消息内容，采用base64编码
...
class PublishRRPCMessageResponse extends AbstractModel
{
    ...
    /**
     * @var string 设备回复的的消息内容，采用base64编码
     */
     ...
     * @param string $PayloadBase64 设备回复的的消息内容，采用base64编码

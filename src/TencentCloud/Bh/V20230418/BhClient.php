...
namespace TencentCloud\Bh\V20230418;

use TencentCloud\Common\AbstractClient;
use TencentCloud\Common\Profile\ClientProfile;
use TencentCloud\Common\Credential;
use TencentCloud\Bh\V20230418\Models as Models;
...
class BhClient extends AbstractClient
{
     ...
     * @var string
     */
    protected $endpoint = "bh.tencentcloudapi.com";

    /**
     * @var string
     */
    protected $service = "bh";
    ...
    {
        $respClass = "TencentCloud"."\\".ucfirst("bh")."\\"."V20230418\\Models"."\\".ucfirst($action)."Response";
        $obj = new $respClass();

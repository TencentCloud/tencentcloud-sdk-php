 ...
 * @method string getDomainIds() 获取要复制的域名ID。要从多个域名复制线路分组时，用英文逗号分隔，例如1002,1005
 * @method void setDomainIds(string $DomainIds) 设置要复制的域名ID。要从多个域名复制线路分组时，用英文逗号分隔，例如1002,1005
 ...
 */
class CreateLineGroupCopyRequest extends AbstractModel
{
    /**
     * @var string 域名
     */
    ...
    /**
     * @var string 要复制的域名ID。要从多个域名复制线路分组时，用英文逗号分隔，例如1002,1005
     */
    public $DomainIds;
     ...
     * @param string $DomainIds 要复制的域名ID。要从多个域名复制线路分组时，用英文逗号分隔，例如1002,1005

 ...
 * @method string getProjectId() 获取密钥对所属的项目`ID`。
 * @method void setProjectId(string $ProjectId) 设置密钥对所属的项目`ID`。
...
class KeyPair extends AbstractModel
{
     ...
     * @param string $ProjectId 密钥对所属的项目`ID`。

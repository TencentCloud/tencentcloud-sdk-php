 ...
 * @method Models\ModifyApiSecSensitiveRuleResponse ModifyApiSecSensitiveRule(Models\ModifyApiSecSensitiveRuleRequest $req) 修改api安全敏感检测规则
 ...
 * @method Models\ModifyDomainWhiteRuleResponse ModifyDomainWhiteRule(Models\ModifyDomainWhiteRuleRequest $req) 修改域名规则白名单
 ...
 * @method Models\ModifyInstanceElasticModeResponse ModifyInstanceElasticMode(Models\ModifyInstanceElasticModeRequest $req) 接口无用，没有人调用
 ...
 * @method Models\ModifyOwaspDomainUpdateStatusResponse ModifyOwaspDomainUpdateStatus(Models\ModifyOwaspDomainUpdateStatusRequest $req) 修改域名新规则状态

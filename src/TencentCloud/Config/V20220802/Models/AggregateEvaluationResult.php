...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getResourceOwnerName() 获取资源所属用户名称
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResourceOwnerName(string $ResourceOwnerName) 设置资源所属用户名称
注意：此字段可能返回 null，表示取不到有效值。
 */
class AggregateEvaluationResult extends AbstractModel
{
    /**
     * @var string 资源id
     */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $ResourceOwnerName 资源所属用户名称
注意：此字段可能返回 null，表示取不到有效值。
     */

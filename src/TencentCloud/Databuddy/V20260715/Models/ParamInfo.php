 ...
 * 参数键值对
 *
 * @method string getParamId() 获取参数ID，创建时无需传入，由服务端生成
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setParamId(string $ParamId) 设置参数ID，创建时无需传入，由服务端生成
注意：此字段可能返回 null，表示取不到有效值。
...
{
    /**
     * @var string 参数ID，创建时无需传入，由服务端生成
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $ParamId;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param string $ParamId 参数ID，创建时无需传入，由服务端生成
注意：此字段可能返回 null，表示取不到有效值。

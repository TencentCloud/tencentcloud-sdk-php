 ...
 * @method integer getRuleTemplateId() 获取规则模板ID，当Type≠3（自定义SQL）时必填
 * @method void setRuleTemplateId(integer $RuleTemplateId) 设置规则模板ID，当Type≠3（自定义SQL）时必填
 ...
 * @method integer getConditionType() 获取检测范围，当Type=1(系统模板)时必填。 1.全表 2.条件扫描
 * @method void setConditionType(integer $ConditionType) 设置检测范围，当Type=1(系统模板)时必填。 1.全表 2.条件扫描
 * @method string getConditionExpression() 获取条件扫描WHERE条件表达式，ConditionType=2(条件扫描)时必填
 * @method void setConditionExpression(string $ConditionExpression) 设置条件扫描WHERE条件表达式，ConditionType=2(条件扫描)时必填
 * @method string getCustomSql() 获取自定义SQL，Type=3（自定义SQL）时必填
 * @method void setCustomSql(string $CustomSql) 设置自定义SQL，Type=3（自定义SQL）时必填
 ...
 * @method QualityRuleFieldConfig getFieldConfig() 获取自定义模版sql表达式字段替换参数，Type=2时必填
 * @method void setFieldConfig(QualityRuleFieldConfig $FieldConfig) 设置自定义模版sql表达式字段替换参数，Type=2时必填
 * @method string getTargetObjectValue() 获取目标字段名称  CITY
 * @method void setTargetObjectValue(string $TargetObjectValue) 设置目标字段名称  CITY
 * @method array getSourceEngineTypes() 获取该规则支持的执行引擎列表，Type=3（自定义SQL）时必填，可选值如下：1 - MYSQL2 - HIVE4 - SPARK8 - LIVY16 - DLC32 - GBASE64 - TCHouse-P128 - DORIS256 - TCHouse-D512 - EMR_STARROCKS1024 - TCHouse-X
 * @method void setSourceEngineTypes(array $SourceEngineTypes) 设置该规则支持的执行引擎列表，Type=3（自定义SQL）时必填，可选值如下：1 - MYSQL2 - HIVE4 - SPARK8 - LIVY16 - DLC32 - GBASE64 - TCHouse-P128 - DORIS256 - TCHouse-D512 - EMR_STARROCKS1024 - TCHouse-X
 ...
 * @method string getTargetCatalogName() 获取目标数据目录名称，主要用于dlc数据源
 * @method void setTargetCatalogName(string $TargetCatalogName) 设置目标数据目录名称，主要用于dlc数据源
 */
class ModifyQualityRuleRequest extends AbstractModel
{
    /**
     * @var string 项目Id
     */
    ...
    /**
     * @var integer 规则模板ID，当Type≠3（自定义SQL）时必填
     */
    ...
    /**
     * @var integer 检测范围，当Type=1(系统模板)时必填。 1.全表 2.条件扫描
     */
    public $ConditionType;

    /**
     * @var string 条件扫描WHERE条件表达式，ConditionType=2(条件扫描)时必填
     */
    public $ConditionExpression;

    /**
     * @var string 自定义SQL，Type=3（自定义SQL）时必填
     */
    public $CustomSql;
    ...
    /**
     * @var QualityRuleFieldConfig 自定义模版sql表达式字段替换参数，Type=2时必填
     */
    public $FieldConfig;
    ...
    /**
     * @var array 该规则支持的执行引擎列表，Type=3（自定义SQL）时必填，可选值如下：1 - MYSQL2 - HIVE4 - SPARK8 - LIVY16 - DLC32 - GBASE64 - TCHouse-P128 - DORIS256 - TCHouse-D512 - EMR_STARROCKS1024 - TCHouse-X
     */
    ...
    /**
     * @var string 目标数据目录名称，主要用于dlc数据源
     */
     ...
     * @param integer $RuleTemplateId 规则模板ID，当Type≠3（自定义SQL）时必填
     ...
     * @param integer $ConditionType 检测范围，当Type=1(系统模板)时必填。 1.全表 2.条件扫描
     * @param string $ConditionExpression 条件扫描WHERE条件表达式，ConditionType=2(条件扫描)时必填
     * @param string $CustomSql 自定义SQL，Type=3（自定义SQL）时必填
     ...
     * @param QualityRuleFieldConfig $FieldConfig 自定义模版sql表达式字段替换参数，Type=2时必填
     * @param string $TargetObjectValue 目标字段名称  CITY
     * @param array $SourceEngineTypes 该规则支持的执行引擎列表，Type=3（自定义SQL）时必填，可选值如下：1 - MYSQL2 - HIVE4 - SPARK8 - LIVY16 - DLC32 - GBASE64 - TCHouse-P128 - DORIS256 - TCHouse-D512 - EMR_STARROCKS1024 - TCHouse-X
     ...
     * @param string $TargetCatalogName 目标数据目录名称，主要用于dlc数据源
     */

 ...
 * @method string getGridItemName() 获取Grid部署项名称
 * @method void setGridItemName(string $GridItemName) 设置Grid部署项名称
...
class DescribeEdgeUnitDeployGridItemYamlRequest extends AbstractModel
{
     ...
     * @param string $GridItemName Grid部署项名称

 ...
 * @method string getToolVersion() 获取<p>mcp tool版本</p>
 * @method void setToolVersion(string $ToolVersion) 设置<p>mcp tool版本</p>
 */
class RollbackCloudNativeAPIGatewayMCPToolVersionRequest extends AbstractModel
{
    /**
     ...
     * @param string $ToolVersion <p>mcp tool版本</p>
     */

 ...
 * @method string getId() 获取流量防盗刷的规则 ID，仅作为出参返回。
 * @method void setId(string $Id) 设置流量防盗刷的规则 ID，仅作为出参返回。
...
class BandwidthAbuseDefense extends AbstractModel
{
    ...
    /**
     * @var string 流量防盗刷的规则 ID，仅作为出参返回。
     */
    public $Id;
     ...
     * @param string $Id 流量防盗刷的规则 ID，仅作为出参返回。

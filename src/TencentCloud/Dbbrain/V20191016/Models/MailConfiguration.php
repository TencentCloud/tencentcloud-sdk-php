 ...
 * @method array getRegion() 获取地域配置, 如["ap-guangzhou", "ap-shanghai"]。
 * @method void setRegion(array $Region) 设置地域配置, 如["ap-guangzhou", "ap-shanghai"]。
...
class MailConfiguration extends AbstractModel
{
    ...
    /**
     * @var array 地域配置, 如["ap-guangzhou", "ap-shanghai"]。
     */
    public $Region;
     ...
     * @param array $Region 地域配置, 如["ap-guangzhou", "ap-shanghai"]。

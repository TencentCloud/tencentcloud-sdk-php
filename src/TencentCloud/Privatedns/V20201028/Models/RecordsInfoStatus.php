...
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getStatus() 获取是否添加成功：0是失败，1是成功
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setStatus(integer $Status) 设置是否添加成功：0是失败，1是成功
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getMessage() 获取若status为0，则此处为失败原因描述
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setMessage(string $Message) 设置若status为0，则此处为失败原因描述
注意：此字段可能返回 null，表示取不到有效值。
 */
class RecordsInfoStatus extends AbstractModel
{
    /**
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var integer 是否添加成功：0是失败，1是成功
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Status;

    /**
     * @var string 若status为0，则此处为失败原因描述
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Message;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $Status 是否添加成功：0是失败，1是成功
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $Message 若status为0，则此处为失败原因描述
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 *
 * @method integer getDefinition() 获取<p>转动图模板唯一标识。</p>
 * @method void setDefinition(integer $Definition) 设置<p>转动图模板唯一标识。</p>
...
class DeleteAnimatedGraphicsTemplateRequest extends AbstractModel
{
    ...
    /**
     * @param integer $Definition <p>转动图模板唯一标识。</p>

 ...
 * @method array getStatusList() 获取定时任务状态列表。<br><li>UNDO：未执行</li> <br><li>DOING：正在执行</li><br><li>DONE：执行完成。</li>
 * @method void setStatusList(array $StatusList) 设置定时任务状态列表。<br><li>UNDO：未执行</li> <br><li>DOING：正在执行</li><br><li>DONE：执行完成。</li>
 */
class DescribeInstancesActionTimerRequest extends AbstractModel
{
    ...
    /**
     * @var array 定时任务状态列表。<br><li>UNDO：未执行</li> <br><li>DOING：正在执行</li><br><li>DONE：执行完成。</li>
     */
    public $StatusList;
     ...
     * @param array $StatusList 定时任务状态列表。<br><li>UNDO：未执行</li> <br><li>DOING：正在执行</li><br><li>DONE：执行完成。</li>
     */

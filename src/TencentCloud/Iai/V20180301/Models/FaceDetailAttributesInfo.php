...
- 取值范围：[0,65]，其中65代表“65岁及以上”。 
- FaceAttributesType 不含Age 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method integer getBeauty() 获取美丑打分。
- 取值范围：[0,100]。 
- FaceAttributesType不含 Beauty或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method void setBeauty(integer $Beauty) 设置美丑打分。
- 取值范围：[0,100]。 
- FaceAttributesType不含 Beauty或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
...
- AttributeItem对应的Type为 —— 0：自然，1：高兴，2：惊讶，3：生气，4：悲伤，5：厌恶，6：害怕。
- FaceAttributesType 不含Emotion 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method Eye getEye() 获取眼睛相关信息。
- 可识别是否戴眼镜、是否闭眼、是否双眼皮和眼睛大小。
- FaceAttributesType 不含Eye 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method void setEye(Eye $Eye) 设置眼睛相关信息。
- 可识别是否戴眼镜、是否闭眼、是否双眼皮和眼睛大小。
- FaceAttributesType 不含Eye 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method Eyebrow getEyebrow() 获取眉毛相关信息。
- 可识别眉毛浓密、弯曲、长短信息。
- FaceAttributesType 不含Eyebrow 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method void setEyebrow(Eyebrow $Eyebrow) 设置眉毛相关信息。
- 可识别眉毛浓密、弯曲、长短信息。
- FaceAttributesType 不含Eyebrow 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
...
- AttributeItem对应的Type为 —— 0：男性，1：女性。
- FaceAttributesType 不含Gender 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method Hair getHair() 获取头发信息。
- 包含头发长度、有无刘海、头发颜色。 
- FaceAttributesType 不含Hair 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method void setHair(Hair $Hair) 设置头发信息。
- 包含头发长度、有无刘海、头发颜色。 
- FaceAttributesType 不含Hair 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method Hat getHat() 获取帽子信息。

- 可识别是否佩戴帽子、帽子款式、帽子颜色。
- FaceAttributesType 不含Hat 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method void setHat(Hat $Hat) 设置帽子信息。

- 可识别是否佩戴帽子、帽子款式、帽子颜色。
- FaceAttributesType 不含Hat 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method HeadPose getHeadPose() 获取姿态信息。
- 包含人脸的上下偏移、左右偏移、平面旋转信息。 
- FaceAttributesType 不含Headpose 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method void setHeadPose(HeadPose $HeadPose) 设置姿态信息。
- 包含人脸的上下偏移、左右偏移、平面旋转信息。 
- FaceAttributesType 不含Headpose 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
...
- AttributeItem对应的Type为 —— 0: 无口罩， 1: 有口罩不遮脸，2: 有口罩遮下巴，3: 有口罩遮嘴，4: 正确佩戴口罩。
- FaceAttributesType 不含Mask 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method Mouth getMouth() 获取嘴巴信息。
- 可识别是否张嘴、嘴唇厚度。
- FaceAttributesType 不含 Mouth 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method void setMouth(Mouth $Mouth) 设置嘴巴信息。
- 可识别是否张嘴、嘴唇厚度。
- FaceAttributesType 不含 Mouth 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
...
- AttributeItem对应的Type为 ——  0：黄色皮肤，1：棕色皮肤，2：黑色皮肤，3：白色皮肤。
- FaceAttributesType 不含 Skin 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method integer getSmile() 获取微笑程度。
- 取值范围：[0,100]。 
- FaceAttributesType 不含 Smile 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method void setSmile(integer $Smile) 设置微笑程度。
- 取值范围：[0,100]。 
- FaceAttributesType 不含 Smile 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 */
...
- 取值范围：[0,65]，其中65代表“65岁及以上”。 
- FaceAttributesType 不含Age 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param integer $Beauty 美丑打分。
- 取值范围：[0,100]。 
- FaceAttributesType不含 Beauty或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param AttributeItem $Emotion 情绪，可识别自然、高兴、惊讶、生气、悲伤、厌恶、害怕。 
- AttributeItem对应的Type为 —— 0：自然，1：高兴，2：惊讶，3：生气，4：悲伤，5：厌恶，6：害怕。
- FaceAttributesType 不含Emotion 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param Eye $Eye 眼睛相关信息。
- 可识别是否戴眼镜、是否闭眼、是否双眼皮和眼睛大小。
- FaceAttributesType 不含Eye 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param Eyebrow $Eyebrow 眉毛相关信息。
- 可识别眉毛浓密、弯曲、长短信息。
- FaceAttributesType 不含Eyebrow 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param AttributeItem $Gender 性别信息。 
- AttributeItem对应的Type为 —— 0：男性，1：女性。
- FaceAttributesType 不含Gender 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param Hair $Hair 头发信息。
- 包含头发长度、有无刘海、头发颜色。 
- FaceAttributesType 不含Hair 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param Hat $Hat 帽子信息。
...
- 可识别是否佩戴帽子、帽子款式、帽子颜色。
- FaceAttributesType 不含Hat 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param HeadPose $HeadPose 姿态信息。
- 包含人脸的上下偏移、左右偏移、平面旋转信息。 
- FaceAttributesType 不含Headpose 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param AttributeItem $Mask 口罩佩戴信息。 
- AttributeItem对应的Type为 —— 0: 无口罩， 1: 有口罩不遮脸，2: 有口罩遮下巴，3: 有口罩遮嘴，4: 正确佩戴口罩。
- FaceAttributesType 不含Mask 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param Mouth $Mouth 嘴巴信息。
- 可识别是否张嘴、嘴唇厚度。
- FaceAttributesType 不含 Mouth 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。

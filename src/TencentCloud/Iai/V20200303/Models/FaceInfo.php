 ...
 * @method FaceAttributesInfo getFaceAttributesInfo() 获取人脸属性信息。
 ...
 * @method void setFaceAttributesInfo(FaceAttributesInfo $FaceAttributesInfo) 设置人脸属性信息。
- 包含性别( gender )、年龄( age )、表情( expression )、魅力( beauty )、眼镜( glass )、口罩（mask）、头发（hair）和姿态 (pitch，roll，yaw )。
- 只有当 NeedFaceAttributes 设为 1 时才返回有效信息。
 * @method FaceQualityInfo getFaceQualityInfo() 获取人脸质量信息。
- 包含质量分（score）、模糊分（sharpness）、光照分（brightness）、遮挡分（completeness）。
- 只有当NeedFaceDetection设为1时才返回有效信息。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setFaceQualityInfo(FaceQualityInfo $FaceQualityInfo) 设置人脸质量信息。
- 包含质量分（score）、模糊分（sharpness）、光照分（brightness）、遮挡分（completeness）。
- 只有当NeedFaceDetection设为1时才返回有效信息。
注意：此字段可能返回 null，表示取不到有效值。
 */
...
- 若需截取完整人脸，可以在完整分completeness满足需求的情况下，将负值坐标取0。
     ...
     * @param FaceAttributesInfo $FaceAttributesInfo 人脸属性信息。
- 包含性别( gender )、年龄( age )、表情( expression )、魅力( beauty )、眼镜( glass )、口罩（mask）、头发（hair）和姿态 (pitch，roll，yaw )。
- 只有当 NeedFaceAttributes 设为 1 时才返回有效信息。
     * @param FaceQualityInfo $FaceQualityInfo 人脸质量信息。
- 包含质量分（score）、模糊分（sharpness）、光照分（brightness）、遮挡分（completeness）。
- 只有当NeedFaceDetection设为1时才返回有效信息。
注意：此字段可能返回 null，表示取不到有效值。
     */

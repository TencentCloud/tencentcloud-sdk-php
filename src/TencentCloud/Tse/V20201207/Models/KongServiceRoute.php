 ...
 * @method integer getRouteTotalCount() 获取<p>路由总条数</p>
 * @method void setRouteTotalCount(integer $RouteTotalCount) 设置<p>路由总条数</p>
 * @method boolean getRouteHasMore() 获取<p>是否有未返回的路由</p>
 * @method void setRouteHasMore(boolean $RouteHasMore) 设置<p>是否有未返回的路由</p>
 * @method array getRoutes() 获取<p>路由信息</p>
 * @method void setRoutes(array $Routes) 设置<p>路由信息</p>
 */
class KongServiceRoute extends AbstractModel
{
    ...
    /**
     * @var integer <p>路由总条数</p>
     */
    public $RouteTotalCount;

    /**
     * @var boolean <p>是否有未返回的路由</p>
     */
    public $RouteHasMore;
     ...
     * @param integer $RouteTotalCount <p>路由总条数</p>
     * @param boolean $RouteHasMore <p>是否有未返回的路由</p>
     * @param array $Routes <p>路由信息</p>
     */

 ...
 * @method string getDimension() 获取获取day：d，   min:m
 * @method void setDimension(string $Dimension) 设置获取day：d，   min:m
 */
class DescribeUvListRequest extends AbstractModel
{
     ...
     * @param string $Dimension 获取day：d，   min:m
     */

 ...
 *
 * @method boolean getDefendStatus() 获取<p>防护开关</p>
 * @method void setDefendStatus(boolean $DefendStatus) 设置<p>防护开关</p>
 * @method boolean getUnbindHostLicense() 获取关闭防护时是否同步解绑集群下主机 License
枚举值：
true：同步解绑集群所有节点主机授权
false：仅停止容器计费，节点保留主机安全防护
默认值：false
补充说明：仅 DefendStatus=false（关闭防护）时生效
 * @method void setUnbindHostLicense(boolean $UnbindHostLicense) 设置关闭防护时是否同步解绑集群下主机 License
枚举值：
true：同步解绑集群所有节点主机授权
false：仅停止容器计费，节点保留主机安全防护
默认值：false
补充说明：仅 DefendStatus=false（关闭防护）时生效
 * @method array getClusterAssetIds() 获取<p>集群id数组</p>
 * @method void setClusterAssetIds(array $ClusterAssetIds) 设置<p>集群id数组</p>
 ...
 */
class ModifyClusterDefendStatusRequest extends AbstractModel
{
    /**
     * @var boolean <p>防护开关</p>
     */
    public $DefendStatus;

    /**
     * @var boolean 关闭防护时是否同步解绑集群下主机 License
枚举值：
true：同步解绑集群所有节点主机授权
false：仅停止容器计费，节点保留主机安全防护
默认值：false
补充说明：仅 DefendStatus=false（关闭防护）时生效
     */
    public $UnbindHostLicense;

    /**
     * @var array <p>集群id数组</p>
     * @deprecated
     */
    ...
    /**
     * @param boolean $DefendStatus <p>防护开关</p>
     * @param boolean $UnbindHostLicense 关闭防护时是否同步解绑集群下主机 License
枚举值：
true：同步解绑集群所有节点主机授权
false：仅停止容器计费，节点保留主机安全防护
默认值：false
补充说明：仅 DefendStatus=false（关闭防护）时生效
     * @param array $ClusterAssetIds <p>集群id数组</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("UnbindHostLicense",$param) and $param["UnbindHostLicense"] !== null) {
            $this->UnbindHostLicense = $param["UnbindHostLicense"];
        }

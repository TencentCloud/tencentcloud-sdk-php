...
<br>截图相关文档：[直播截图](/document/product/267/32737)。
 * @method Models\CreateLiveStreamMonitorResponse CreateLiveStreamMonitor(Models\CreateLiveStreamMonitorRequest $req) 该接口用来创建直播流监播任务。
 ...
 * @method Models\CreateSceneVideoTaskResponse CreateSceneVideoTask(Models\CreateSceneVideoTaskRequest $req) 该接口用于创建场景化视频任务。
 ...
 * @method Models\DeleteLivePadRuleResponse DeleteLivePadRule(Models\DeleteLivePadRuleRequest $req) 删除直播垫片规则。
 * @method Models\DeleteLivePadTemplateResponse DeleteLivePadTemplate(Models\DeleteLivePadTemplateRequest $req) 删除直播垫片模板。
 ...
 * @method Models\DescribeAIGCTaskStatusResponse DescribeAIGCTaskStatus(Models\DescribeAIGCTaskStatusRequest $req) 查询视频转绘任务
 ...
 * @method Models\DescribeLiveAvatarTemporaryScriptListResponse DescribeLiveAvatarTemporaryScriptList(Models\DescribeLiveAvatarTemporaryScriptListRequest $req) 调用该接口，用于查询临时驱动数字人播报话术列表。
 * @method Models\DescribeLiveAvatarTimbreListResponse DescribeLiveAvatarTimbreList(Models\DescribeLiveAvatarTimbreListRequest $req) 调用该接口，获取可用的数字人声音信息列表。包括官方预制音色，以及个人复刻音色。
 ...
 * @method Models\DescribeLiveCloudEffectConfigResponse DescribeLiveCloudEffectConfig(Models\DescribeLiveCloudEffectConfigRequest $req) 使用该接口查询云端特效配置信息。
 ...
 * @method Models\DescribeLiveDomainPlayInfoListResponse DescribeLiveDomainPlayInfoList(Models\DescribeLiveDomainPlayInfoListRequest $req) 该接口为监控数据接口，数据采集及统计方式与计费数据不同，仅供运营分析使用，不能用于计费对账参考。
 ...
 * @method Models\DescribeLiveStreamMonitorResponse DescribeLiveStreamMonitor(Models\DescribeLiveStreamMonitorRequest $req) 该接口用来查询某个特定监播任务的配置。
 * @method Models\DescribeLiveStreamMonitorListResponse DescribeLiveStreamMonitorList(Models\DescribeLiveStreamMonitorListRequest $req) 该接口用来查询直播流监播任务配置的列表信息。
...
查询下行播放错误码信息。
 * @method Models\DescribeProIspPlaySumInfoListResponse DescribeProIspPlaySumInfoList(Models\DescribeProIspPlaySumInfoListRequest $req) 该接口为监控数据接口，数据采集及统计方式与计费数据不同，仅供运营分析使用，不能用于计费对账参考。
查询某段时间内每个国家地区每个省份每个运营商的平均每秒流量，总流量，总请求数信息。
 * @method Models\DescribeProvinceIspPlayInfoListResponse DescribeProvinceIspPlayInfoList(Models\DescribeProvinceIspPlayInfoListRequest $req) 该接口为监控数据接口，数据采集及统计方式与计费数据不同，仅供运营分析使用，不能用于计费对账参考。
 ...
 * @method Models\DescribeSceneVideoTaskResponse DescribeSceneVideoTask(Models\DescribeSceneVideoTaskRequest $req) 该接口用于查询场景化视频任务进展及结果。
 ...
 * @method Models\DescribeStreamDayPlayInfoListResponse DescribeStreamDayPlayInfoList(Models\DescribeStreamDayPlayInfoListRequest $req) 该接口为监控数据接口，数据采集及统计方式与计费数据不同，仅供运营分析使用，不能用于计费对账参考。
查询天维度每条流的播放数据，包括总流量等。
 * @method Models\DescribeStreamPlayInfoListResponse DescribeStreamPlayInfoList(Models\DescribeStreamPlayInfoListRequest $req) 该接口为监控数据接口，数据采集及统计方式与计费数据不同，仅供运营分析使用，不能用于计费对账参考。
查询播放数据，支持按流名称查询详细播放数据，也可按播放域名查询详细总数据，数据延迟4分钟左右。
 * @method Models\DescribeStreamPushInfoListResponse DescribeStreamPushInfoList(Models\DescribeStreamPushInfoListRequest $req) 该接口为监控数据接口，数据采集及统计方式与计费数据不同，仅供运营分析使用，不能用于计费对账参考。
 ...
 * @method Models\DescribeTopClientIpSumInfoListResponse DescribeTopClientIpSumInfoList(Models\DescribeTopClientIpSumInfoListRequest $req) 该接口为监控数据接口，数据采集及统计方式与计费数据不同，仅供运营分析使用，不能用于计费对账参考。
 ...
 * @method Models\EnableOptimalSwitchingResponse EnableOptimalSwitching(Models\EnableOptimalSwitchingRequest $req) 启用择优调度。
 ...
 * @method Models\GenerateLiveAvatarScriptBroadcastResponse GenerateLiveAvatarScriptBroadcast(Models\GenerateLiveAvatarScriptBroadcastRequest $req) 调用该接口，用于触发话术播报生成，并返回音频播报URL。
 ...
 * @method Models\ModifyLiveAvatarRoomResponse ModifyLiveAvatarRoom(Models\ModifyLiveAvatarRoomRequest $req) 调用该接口，用于修改数字人(包括AIGC数字人)直播间。
 * @method Models\ModifyLiveAvatarScriptResponse ModifyLiveAvatarScript(Models\ModifyLiveAvatarScriptRequest $req) 调用该接口，用于修改数字人直播间话术。
...
由于 Referer 信息包含在 http 协议中，在开启配置后，播放协议为 rtmp 或 WebRTC 不会校验 Referer 配置，仍可正常播放。如需配置 Referer 鉴权建议使用 http-flv 或 http-hls 协议播放。
 * @method Models\ModifyLivePadTemplateResponse ModifyLivePadTemplate(Models\ModifyLivePadTemplateRequest $req) 修改直播垫片模板。
 ...
 * @method Models\ModifyOriginStreamInfoResponse ModifyOriginStreamInfo(Models\ModifyOriginStreamInfoRequest $req) 变更直播源站配置，支持直播源站格式。
 ...
 * @method Models\SendTemporaryScriptToAvatarRoomResponse SendTemporaryScriptToAvatarRoom(Models\SendTemporaryScriptToAvatarRoomRequest $req) 调用该接口，用于临时驱动数字人播报。
 * @method Models\StartLiveAvatarRoomResponse StartLiveAvatarRoom(Models\StartLiveAvatarRoomRequest $req) 调用该接口，用于启动数字人（包括AIGC数字人）直播间。
 ...
 * @method Models\StopLiveAvatarRoomResponse StopLiveAvatarRoom(Models\StopLiveAvatarRoomRequest $req) 调用该接口，用于停止数字人直播间。

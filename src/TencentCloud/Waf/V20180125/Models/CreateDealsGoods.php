 ...
 * @method CreateDealsGoodsDetail getGoodsDetail() 获取商品明细
 * @method void setGoodsDetail(CreateDealsGoodsDetail $GoodsDetail) 设置商品明细
...
class CreateDealsGoods extends AbstractModel
{
    ...
    /**
     * @var CreateDealsGoodsDetail 商品明细
     */
    public $GoodsDetail;
...
9表示购买非中国大陆资源
     ...
     * @param CreateDealsGoodsDetail $GoodsDetail 商品明细

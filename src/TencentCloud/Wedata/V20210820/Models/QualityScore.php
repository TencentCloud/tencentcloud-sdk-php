 ...
 * 质量评分
 *
 * @method float getCompositeScore() 获取综合分数
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setCompositeScore(float $CompositeScore) 设置综合分数
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getScoringDistribution() 获取评分分布
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setScoringDistribution(array $ScoringDistribution) 设置评分分布
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getTotalTableNumber() 获取总表数
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTotalTableNumber(integer $TotalTableNumber) 设置总表数
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param float $CompositeScore 综合分数
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $ScoringDistribution 评分分布
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $TotalTableNumber 总表数
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 * @method integer getScope() 获取<p>1 全部旗舰版主机，0 InstanceIds列表主机</p>
 * @method void setScope(integer $Scope) 设置<p>1 全部旗舰版主机，0 InstanceIds列表主机</p>
 * @method array getInstanceIds() 获取<p>自选主机</p>
 * @method void setInstanceIds(array $InstanceIds) 设置<p>自选主机</p>
 * @method array getExcludeInstanceIds() 获取<p>自选排除主机</p>
 * @method void setExcludeInstanceIds(array $ExcludeInstanceIds) 设置<p>自选排除主机</p>
...
class DescribeNetAttackSettingResponse extends AbstractModel
{
    ...
    /**
     * @var integer <p>1 全部旗舰版主机，0 InstanceIds列表主机</p>
     */
    public $Scope;
     ...
     * @param integer $Scope <p>1 全部旗舰版主机，0 InstanceIds列表主机</p>
     * @param array $InstanceIds <p>自选主机</p>
     * @param array $ExcludeInstanceIds <p>自选排除主机</p>

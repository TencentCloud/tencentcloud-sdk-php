 ...
 *
 * @method array getFilters() 获取<li>HostId - string - 是否必填：否 - 主机Id</li>
 ...
 * @method void setFilters(array $Filters) 设置<li>HostId - string - 是否必填：否 - 主机Id</li>
<li>RuleId - int64 - 是否必填：否 - 规则Id</li>
<li>PolicyId - int64 - 是否必填：否 - 规则Id</li>
<li>ItemName - string - 是否必填：否 - 项名称</li>
<li>DetectStatus - int - 是否必填：否 - 检测状态</li>
 ...
 * @method string getBy() 获取可选排序列: [HostCount|FirstTime|LastTime]
 * @method void setBy(string $By) 设置可选排序列: [HostCount|FirstTime|LastTime]
 */
class DescribeBaselineItemDetectListRequest extends AbstractModel
{
    /**
     * @var array <li>HostId - string - 是否必填：否 - 主机Id</li>
<li>RuleId - int64 - 是否必填：否 - 规则Id</li>
<li>PolicyId - int64 - 是否必填：否 - 规则Id</li>
<li>ItemName - string - 是否必填：否 - 项名称</li>
<li>DetectStatus - int - 是否必填：否 - 检测状态</li>
...
<li>EndTime - string - 是否必填：否 - 结束时间</li>
    ...
    /**
     * @var string 可选排序列: [HostCount|FirstTime|LastTime]
     */
    public $By;

    /**
     * @param array $Filters <li>HostId - string - 是否必填：否 - 主机Id</li>
<li>RuleId - int64 - 是否必填：否 - 规则Id</li>
<li>PolicyId - int64 - 是否必填：否 - 规则Id</li>
<li>ItemName - string - 是否必填：否 - 项名称</li>
<li>DetectStatus - int - 是否必填：否 - 检测状态</li>
...
<li>EndTime - string - 是否必填：否 - 结束时间</li>
     ...
     * @param string $By 可选排序列: [HostCount|FirstTime|LastTime]
     */

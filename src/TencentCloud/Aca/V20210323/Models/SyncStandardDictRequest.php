 ...
 * @method SyncDictData getData() 获取字典数据
 * @method void setData(SyncDictData $Data) 设置字典数据
 */
class SyncStandardDictRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var SyncDictData 字典数据
     */
    public $Data;

    /**
     * @param CommonHeader $Header 请求头
     * @param SyncDictData $Data 字典数据
     */

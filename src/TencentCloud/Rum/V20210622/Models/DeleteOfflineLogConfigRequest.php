 ...
 * @method string getUniqueID() 获取用户唯一标示(uin or aid)
 * @method void setUniqueID(string $UniqueID) 设置用户唯一标示(uin or aid)
 */
class DeleteOfflineLogConfigRequest extends AbstractModel
{
    ...
    /**
     * @var string 用户唯一标示(uin or aid)
     */
    public $UniqueID;

    /**
     * @param string $ProjectKey 项目唯一上报 key
     * @param string $UniqueID 用户唯一标示(uin or aid)
     */

 ...
 * BankSlipOCR返回参数结构体
 *
 * @method array getBankSlipInfos() 获取银行回单识别结果，具体内容请点击左侧链接。
 * @method void setBankSlipInfos(array $BankSlipInfos) 设置银行回单识别结果，具体内容请点击左侧链接。
...
{
    /**
     * @var array 银行回单识别结果，具体内容请点击左侧链接。
     */
    ...
    /**
     * @param array $BankSlipInfos 银行回单识别结果，具体内容请点击左侧链接。

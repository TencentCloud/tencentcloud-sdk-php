 ...
 * @method string getUpdateTime() 获取修改时间，时间格式：yyyy-mm-dd hh:mm:ss。
 * @method void setUpdateTime(string $UpdateTime) 设置修改时间，时间格式：yyyy-mm-dd hh:mm:ss。
 */
class SecurityGroup extends AbstractModel
{
    ...
    /**
     * @var string 修改时间，时间格式：yyyy-mm-dd hh:mm:ss。
     */
    public $UpdateTime;
     ...
     * @param string $UpdateTime 修改时间，时间格式：yyyy-mm-dd hh:mm:ss。
     */

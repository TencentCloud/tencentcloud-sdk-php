 ...
 * @method string getInstanceStatusDesc() 获取状态描述
 * @method void setInstanceStatusDesc(string $InstanceStatusDesc) 设置状态描述
 ...
 * @method integer getMaintainDuration() 获取持续的时间
 * @method void setMaintainDuration(integer $MaintainDuration) 设置持续的时间
 ...
 * @method array getInstanceTasks() 获取实例任务
 * @method void setInstanceTasks(array $InstanceTasks) 设置实例任务
 */
class InstanceSet extends AbstractModel
{
     ...
     * @param array $InstanceTasks 实例任务
     */

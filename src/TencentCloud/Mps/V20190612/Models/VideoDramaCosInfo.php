 ...
 *
 * @method string getCosBucketRegion() 获取<p>cos通地域</p>
 * @method void setCosBucketRegion(string $CosBucketRegion) 设置<p>cos通地域</p>
 ...
 */
class VideoDramaCosInfo extends AbstractModel
{
    /**
     * @var string <p>cos通地域</p>
     */
    ...
    /**
     * @param string $CosBucketRegion <p>cos通地域</p>

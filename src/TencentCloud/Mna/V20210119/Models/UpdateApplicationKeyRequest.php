 ...
 *
 * @method string getMpApplicationKey() 获取应用的base64密钥字符串
 * @method void setMpApplicationKey(string $MpApplicationKey) 设置应用的base64密钥字符串
...
class UpdateApplicationKeyRequest extends AbstractModel
{
    ...
    /**
     * @param string $MpApplicationKey 应用的base64密钥字符串

 ...
 *
 * @method array getContainerList() 获取<p>镜像关联容器信息</p>
 * @method void setContainerList(array $ContainerList) 设置<p>镜像关联容器信息</p>
...
class DescribeImageAssociatedContainerListResponse extends AbstractModel
{
    ...
    /**
     * @param array $ContainerList <p>镜像关联容器信息</p>

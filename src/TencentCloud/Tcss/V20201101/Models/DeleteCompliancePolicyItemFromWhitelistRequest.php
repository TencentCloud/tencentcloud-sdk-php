 ...
 *
 * @method array getWhitelistIdSet() 获取指定的白名单项的ID的列表
 * @method void setWhitelistIdSet(array $WhitelistIdSet) 设置指定的白名单项的ID的列表
 */
class DeleteCompliancePolicyItemFromWhitelistRequest extends AbstractModel
{
    /**
     * @var array 指定的白名单项的ID的列表
     */
    public $WhitelistIdSet;

    /**
     * @param array $WhitelistIdSet 指定的白名单项的ID的列表
     */

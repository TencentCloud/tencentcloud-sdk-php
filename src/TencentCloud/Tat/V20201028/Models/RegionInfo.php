 ...
 * @method string getRegionState() 获取地域是否可用状态，AVAILABLE 代表可用，UNAVAILABLE 代表不可用。
 * @method void setRegionState(string $RegionState) 设置地域是否可用状态，AVAILABLE 代表可用，UNAVAILABLE 代表不可用。
 */
class RegionInfo extends AbstractModel
{
    ...
    /**
     * @var string 地域是否可用状态，AVAILABLE 代表可用，UNAVAILABLE 代表不可用。
     */
    public $RegionState;
     ...
     * @param string $RegionState 地域是否可用状态，AVAILABLE 代表可用，UNAVAILABLE 代表不可用。
     */

...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getNextCursor() 获取<p>下一个游标</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setNextCursor(string $NextCursor) 设置<p>下一个游标</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method boolean getHasMore() 获取<p>还有后续吗</p>
 * @method void setHasMore(boolean $HasMore) 设置<p>还有后续吗</p>
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var string <p>下一个游标</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $NextCursor;

    /**
     * @var boolean <p>还有后续吗</p>
     */
    public $HasMore;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $NextCursor <p>下一个游标</p>
注意：此字段可能返回 null，表示取不到有效值。
     * @param boolean $HasMore <p>还有后续吗</p>

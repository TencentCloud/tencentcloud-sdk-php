 ...
 * @method array getFilters() 获取<p>过滤条件。  listener-id- String -（过滤条件）监听器实例ID。</p>
 * @method void setFilters(array $Filters) 设置<p>过滤条件。  listener-id- String -（过滤条件）监听器实例ID。</p>
 */
class DescribeListenersRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>过滤条件。  listener-id- String -（过滤条件）监听器实例ID。</p>
     */
    public $Filters;
     ...
     * @param array $Filters <p>过滤条件。  listener-id- String -（过滤条件）监听器实例ID。</p>
     */

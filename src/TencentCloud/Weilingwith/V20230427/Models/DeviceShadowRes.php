 ...
 * @method array getSet() 获取设备影子列表
 * @method void setSet(array $Set) 设置设备影子列表
 */
class DeviceShadowRes extends AbstractModel
{
    /**
     * @var integer 第几页
     */

 ...
 *
 * @method integer getCoresCnt() 获取弹性计费上限，最小值500
 * @method void setCoresCnt(integer $CoresCnt) 设置弹性计费上限，最小值500
 */
class CreateOrModifyPostPayCoresRequest extends AbstractModel
{
    /**
     * @var integer 弹性计费上限，最小值500
     */
    public $CoresCnt;

    /**
     * @param integer $CoresCnt 弹性计费上限，最小值500
     */

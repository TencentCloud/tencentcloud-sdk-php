 ...
 * @method string getBy() 获取排序列，严格相等：CreateTime创建时间，ModifyTime更新时间
 * @method void setBy(string $By) 设置排序列，严格相等：CreateTime创建时间，ModifyTime更新时间
 */
...
<li>Exception - String - 是否必填：否 - 插件状态 0:正常,1:异常,2:无java进程注入</li>
    ...
    /**
     * @var string 排序列，严格相等：CreateTime创建时间，ModifyTime更新时间
     */
    public $By;
...
<li>Exception - String - 是否必填：否 - 插件状态 0:正常,1:异常,2:无java进程注入</li>
     ...
     * @param string $By 排序列，严格相等：CreateTime创建时间，ModifyTime更新时间
     */

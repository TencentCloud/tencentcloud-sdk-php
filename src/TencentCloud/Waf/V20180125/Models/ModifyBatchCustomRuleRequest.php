 ...
 *
 * @method integer getId() 获取批量规则Id
 * @method void setId(integer $Id) 设置批量规则Id
 ...
 * @method array getGroupIds() 获取防护对象组ID列表
 * @method void setGroupIds(array $GroupIds) 设置防护对象组ID列表
 ...
 * @method integer getActionRatio() 获取动作灰度的比例，1-100，默认是100
 * @method void setActionRatio(integer $ActionRatio) 设置动作灰度的比例，1-100，默认是100
 */
class ModifyBatchCustomRuleRequest extends AbstractModel
{
    /**
     * @var integer 批量规则Id
     */
    ...
    /**
     * @var integer 动作灰度的比例，1-100，默认是100
     */
    public $ActionRatio;

    /**
     * @param integer $Id 批量规则Id
     ...
     * @param array $GroupIds 防护对象组ID列表
     * @param string $LogicalOp 匹配条件的逻辑关系，支持and、or，分别表示多个逻辑匹配条件是与、或的关系
     * @param string $PageId 页面ID
     * @param integer $ActionRatio 动作灰度的比例，1-100，默认是100
     */

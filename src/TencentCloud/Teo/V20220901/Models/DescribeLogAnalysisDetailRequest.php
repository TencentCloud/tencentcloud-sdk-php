 ...
 * @method string getSort() 获取<p>原始日志是否按时间排序返回；可选值：<ul><li>asc：升序；</li><li>desc：降序。</li></ul>默认为 desc。</p>
 * @method void setSort(string $Sort) 设置<p>原始日志是否按时间排序返回；可选值：<ul><li>asc：升序；</li><li>desc：降序。</li></ul>默认为 desc。</p>
 */
class DescribeLogAnalysisDetailRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>原始日志是否按时间排序返回；可选值：<ul><li>asc：升序；</li><li>desc：降序。</li></ul>默认为 desc。</p>
     */
    public $Sort;
     ...
     * @param string $Sort <p>原始日志是否按时间排序返回；可选值：<ul><li>asc：升序；</li><li>desc：降序。</li></ul>默认为 desc。</p>
     */

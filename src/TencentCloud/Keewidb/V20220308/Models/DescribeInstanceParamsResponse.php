 ...
 *
 * @method integer getTotalCount() 获取实例参数总数量。
 * @method void setTotalCount(integer $TotalCount) 设置实例参数总数量。
 * @method array getInstanceEnumParam() 获取实例枚举类型参数数组。
 * @method void setInstanceEnumParam(array $InstanceEnumParam) 设置实例枚举类型参数数组。
 * @method array getInstanceIntegerParam() 获取实例整型参数数组。
 * @method void setInstanceIntegerParam(array $InstanceIntegerParam) 设置实例整型参数数组。
 * @method array getInstanceTextParam() 获取实例字符型参数数组。
 * @method void setInstanceTextParam(array $InstanceTextParam) 设置实例字符型参数数组。
 * @method array getInstanceMultiParam() 获取实例多选项型参数数组。
 * @method void setInstanceMultiParam(array $InstanceMultiParam) 设置实例多选项型参数数组。
...
class DescribeInstanceParamsResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 实例参数总数量。
     * @param array $InstanceEnumParam 实例枚举类型参数数组。
     * @param array $InstanceIntegerParam 实例整型参数数组。
     * @param array $InstanceTextParam 实例字符型参数数组。
     * @param array $InstanceMultiParam 实例多选项型参数数组。

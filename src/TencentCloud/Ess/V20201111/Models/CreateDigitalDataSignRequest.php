 ...
 * @method string getPlainText() 获取数据加签的原文
 * @method void setPlainText(string $PlainText) 设置数据加签的原文
 */
class CreateDigitalDataSignRequest extends AbstractModel
{
    /**
     ...
     * @param string $PlainText 数据加签的原文
     */

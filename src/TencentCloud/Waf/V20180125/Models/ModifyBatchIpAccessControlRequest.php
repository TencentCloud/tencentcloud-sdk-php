 ...
 *
 * @method integer getRuleId() 获取编辑的批量规则ID
 * @method void setRuleId(integer $RuleId) 设置编辑的批量规则ID
 ...
 */
class ModifyBatchIpAccessControlRequest extends AbstractModel
{
    /**
     * @var integer 编辑的批量规则ID
     */
    public $RuleId;
    ...
    /**
     * @param integer $RuleId 编辑的批量规则ID

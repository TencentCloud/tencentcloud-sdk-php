 ...
 * @method ImageVulBaseInfo getVulInfo() 获取<p>漏洞详情</p>
 * @method void setVulInfo(ImageVulBaseInfo $VulInfo) 设置<p>漏洞详情</p>
...
class ImageVul extends AbstractModel
{
     ...
     * @param ImageVulBaseInfo $VulInfo <p>漏洞详情</p>

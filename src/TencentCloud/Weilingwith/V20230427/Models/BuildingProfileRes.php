...
class BuildingProfileRes extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("BuildingProfile",$param) and $param["BuildingProfile"] !== null) {
            $this->BuildingProfile = new BuildingProfile();
            $this->BuildingProfile->deserialize($param["BuildingProfile"]);
        }
    }
}

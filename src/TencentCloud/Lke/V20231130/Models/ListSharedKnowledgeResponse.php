 ...
 *
 * @method integer getTotal() 获取累计数量
 * @method void setTotal(integer $Total) 设置累计数量
 ...
 */
class ListSharedKnowledgeResponse extends AbstractModel
{
    /**
     * @var integer 累计数量
     */

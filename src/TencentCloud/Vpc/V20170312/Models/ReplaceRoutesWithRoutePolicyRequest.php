 ...
 * @method array getRoutes() 获取路由策略对象。需要指定路由策略唯一ID（RouteItemId）。
 * @method void setRoutes(array $Routes) 设置路由策略对象。需要指定路由策略唯一ID（RouteItemId）。
 */
class ReplaceRoutesWithRoutePolicyRequest extends AbstractModel
{
    ...
    /**
     * @var array 路由策略对象。需要指定路由策略唯一ID（RouteItemId）。
     */
    public $Routes;

    /**
     * @param string $RouteTableId 路由表实例ID。
     * @param array $Routes 路由策略对象。需要指定路由策略唯一ID（RouteItemId）。
     */

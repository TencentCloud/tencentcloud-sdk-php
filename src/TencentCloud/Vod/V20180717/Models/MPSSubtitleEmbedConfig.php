 ...
 * @method string getFontPath() 获取<p>自定义字体文件url地址</p>
 * @method void setFontPath(string $FontPath) 设置<p>自定义字体文件url地址</p>
 ...
 * @method MPSSubtitleBoardConfig getSubtitleBoardConfig() 获取<p>背景配置</p>
 * @method void setSubtitleBoardConfig(MPSSubtitleBoardConfig $SubtitleBoardConfig) 设置<p>背景配置</p>
 * @method MPSSubtitleLayoutConfig getSubtitleLayoutConfig() 获取<p>排列配置</p>
 * @method void setSubtitleLayoutConfig(MPSSubtitleLayoutConfig $SubtitleLayoutConfig) 设置<p>排列配置</p>
 * @method MPSSubtitleOutlineConfig getSubtitleOutlineConfig() 获取<p>文字描边配置</p>
 * @method void setSubtitleOutlineConfig(MPSSubtitleOutlineConfig $SubtitleOutlineConfig) 设置<p>文字描边配置</p>
 * @method MPSSubtitleShadowConfig getSubtitleShadowConfig() 获取<p>文字阴影配置</p>
 * @method void setSubtitleShadowConfig(MPSSubtitleShadowConfig $SubtitleShadowConfig) 设置<p>文字阴影配置</p>
...
class MPSSubtitleEmbedConfig extends AbstractModel
{
    ...
    /**
     * @var MPSSubtitleBoardConfig <p>背景配置</p>
     */
    public $SubtitleBoardConfig;

    /**
     * @var MPSSubtitleLayoutConfig <p>排列配置</p>
     */
    public $SubtitleLayoutConfig;

    /**
     * @var MPSSubtitleOutlineConfig <p>文字描边配置</p>
     */
    public $SubtitleOutlineConfig;

    /**
     * @var MPSSubtitleShadowConfig <p>文字阴影配置</p>
     */
     ...
     * @param string $FontPath <p>自定义字体文件url地址</p>
     ...
     * @param MPSSubtitleBoardConfig $SubtitleBoardConfig <p>背景配置</p>
     * @param MPSSubtitleLayoutConfig $SubtitleLayoutConfig <p>排列配置</p>
     * @param MPSSubtitleOutlineConfig $SubtitleOutlineConfig <p>文字描边配置</p>
     * @param MPSSubtitleShadowConfig $SubtitleShadowConfig <p>文字阴影配置</p>

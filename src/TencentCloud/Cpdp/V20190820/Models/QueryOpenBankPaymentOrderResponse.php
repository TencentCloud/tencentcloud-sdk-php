 ...
 * @method QueryOpenBankPaymentOrderResult getResult() 获取查询支付结果响应对象。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(QueryOpenBankPaymentOrderResult $Result) 设置查询支付结果响应对象。
注意：此字段可能返回 null，表示取不到有效值。
...
class QueryOpenBankPaymentOrderResponse extends AbstractModel
{
    ...
    /**
     * @var QueryOpenBankPaymentOrderResult 查询支付结果响应对象。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
     ...
     * @param QueryOpenBankPaymentOrderResult $Result 查询支付结果响应对象。
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new QueryOpenBankPaymentOrderResult();

 ...
 * @method string getResourceType() 获取部署资源类型，如waf
 * @method void setResourceType(string $ResourceType) 设置部署资源类型，如waf
...
class DescribeHostWafInstanceListRequest extends AbstractModel
{
     ...
     * @param string $ResourceType 部署资源类型，如waf

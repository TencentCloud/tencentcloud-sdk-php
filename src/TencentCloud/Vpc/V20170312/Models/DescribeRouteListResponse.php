 ...
 *
 * @method array getRouteSet() 获取路由对象。
 * @method void setRouteSet(array $RouteSet) 设置路由对象。
 ...
 */
class DescribeRouteListResponse extends AbstractModel
{
    /**
     * @var array 路由对象。
     */

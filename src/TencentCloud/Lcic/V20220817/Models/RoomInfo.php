 ...
 * @method integer getStartTime() 获取<p>预定的房间开始时间，unix时间戳。</p>
 * @method void setStartTime(integer $StartTime) 设置<p>预定的房间开始时间，unix时间戳。</p>
 * @method integer getEndTime() 获取<p>预定的房间结束时间，unix时间戳。</p>
 * @method void setEndTime(integer $EndTime) 设置<p>预定的房间结束时间，unix时间戳。</p>
 ...
 * @method string getSubType() 获取<p>房间子类型，可以有以下取值： videodoc 文档+视频 video 纯视频</p>
 * @method void setSubType(string $SubType) 设置<p>房间子类型，可以有以下取值： videodoc 文档+视频 video 纯视频</p>
 * @method string getTeacherId() 获取<p>老师ID。通过[注册用户]接口获取的UserId。</p>
 * @method void setTeacherId(string $TeacherId) 设置<p>老师ID。通过[注册用户]接口获取的UserId。</p>
 * @method integer getAutoMic() 获取<p>进入课堂时是否自动连麦。可以有以下取值： 0 不自动连麦（需要手动申请上麦，默认值） 1 自动连麦</p>
 * @method void setAutoMic(integer $AutoMic) 设置<p>进入课堂时是否自动连麦。可以有以下取值： 0 不自动连麦（需要手动申请上麦，默认值） 1 自动连麦</p>
 * @method integer getTurnOffMic() 获取<p>释放音视频权限后是否自动取消连麦。可以有以下取值： 0 自动取消连麦（默认值） 1 保持连麦状态</p>
 ...
 * @method integer getAudienceType() 获取<p>观看类型。</p>
 * @method void setAudienceType(integer $AudienceType) 设置<p>观看类型。</p>
 * @method integer getRecordLayout() 获取<p>录制布局。</p>
 * @method void setRecordLayout(integer $RecordLayout) 设置<p>录制布局。</p>
 * @method string getGroupId() 获取<p>房间绑定的群组ID</p>
 * @method void setGroupId(string $GroupId) 设置<p>房间绑定的群组ID</p>
 ...
 * @method integer getInteractionMode() 获取<p>开启专注模式。 0 收看全部角色音视频(默认) 1 只看老师和助教</p>
 * @method void setInteractionMode(integer $InteractionMode) 设置<p>开启专注模式。 0 收看全部角色音视频(默认) 1 只看老师和助教</p>
...
class RoomInfo extends AbstractModel
{
    ...
    /**
     * @var integer <p>预定的房间开始时间，unix时间戳。</p>
     */
    public $StartTime;

    /**
     * @var integer <p>预定的房间结束时间，unix时间戳。</p>
     */
    public $EndTime;
    ...
    /**
     * @var string <p>房间子类型，可以有以下取值： videodoc 文档+视频 video 纯视频</p>
     */
    public $SubType;

    /**
     * @var string <p>老师ID。通过[注册用户]接口获取的UserId。</p>
     */
    public $TeacherId;

    /**
     * @var integer <p>进入课堂时是否自动连麦。可以有以下取值： 0 不自动连麦（需要手动申请上麦，默认值） 1 自动连麦</p>
     */
    public $AutoMic;

    /**
     * @var integer <p>释放音视频权限后是否自动取消连麦。可以有以下取值： 0 自动取消连麦（默认值） 1 保持连麦状态</p>
     */
    public $TurnOffMic;

    /**
     * @var integer <p>高音质模式。可以有以下取值： 0 不开启高音质（默认值） 1 开启高音质</p>
     */
    public $AudioQuality;
    ...
    /**
     * @var array <p>助教Id列表。通过[注册用户]接口获取的UserId。</p>
     */
    public $Assistants;
    ...
    /**
     * @var integer <p>观看类型。</p>
     */
    public $AudienceType;

    /**
     * @var integer <p>录制布局。</p>
     */
    public $RecordLayout;

    /**
     * @var string <p>房间绑定的群组ID</p>
     */
    public $GroupId;
    ...
    /**
     * @var integer <p>开启专注模式。 0 收看全部角色音视频(默认) 1 只看老师和助教</p>
     */
     ...
     * @param string $SubType <p>房间子类型，可以有以下取值： videodoc 文档+视频 video 纯视频</p>
     * @param string $TeacherId <p>老师ID。通过[注册用户]接口获取的UserId。</p>
     ...
     * @param integer $RecordLayout <p>录制布局。</p>
     * @param string $GroupId <p>房间绑定的群组ID</p>
     * @param integer $EnableDirectControl <p>打开学生麦克风/摄像头的授权开关</p>
     * @param integer $InteractionMode <p>开启专注模式。 0 收看全部角色音视频(默认) 1 只看老师和助教</p>

 ...
 * @method array getSyncRobotCommands() 获取指令及指令参数数组。
 * @method void setSyncRobotCommands(array $SyncRobotCommands) 设置指令及指令参数数组。
 */
class SyncKTVRobotCommandRequest extends AbstractModel
{
     ...
     * @param array $SyncRobotCommands 指令及指令参数数组。
     */

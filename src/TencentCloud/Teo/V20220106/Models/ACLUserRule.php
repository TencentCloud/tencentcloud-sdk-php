 ...
 * @method string getRuleStatus() 获取状态
 * @method void setRuleStatus(string $RuleStatus) 设置状态
 * @method array getConditions() 获取ACL规则
 * @method void setConditions(array $Conditions) 设置ACL规则
 * @method integer getRulePriority() 获取规则优先级
 * @method void setRulePriority(integer $RulePriority) 设置规则优先级
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param string $RuleStatus 状态
     * @param array $Conditions ACL规则
     * @param integer $RulePriority 规则优先级

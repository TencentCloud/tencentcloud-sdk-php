 ...
 * @method string getIncludeCompliancePackRuleResult() 获取<p>包含合规包规则统计信息</p><p>枚举值：</p><ul><li>1： 是</li></ul>
 * @method void setIncludeCompliancePackRuleResult(string $IncludeCompliancePackRuleResult) 设置<p>包含合规包规则统计信息</p><p>枚举值：</p><ul><li>1： 是</li></ul>
 */
class ListCompliancePacksRequest extends AbstractModel
{
    /**
     * @var integer <p>数量</p>
     */
    ...
    /**
     * @var string <p>包含合规包规则统计信息</p><p>枚举值：</p><ul><li>1： 是</li></ul>
     */
     ...
     * @param string $IncludeCompliancePackRuleResult <p>包含合规包规则统计信息</p><p>枚举值：</p><ul><li>1： 是</li></ul>
     */

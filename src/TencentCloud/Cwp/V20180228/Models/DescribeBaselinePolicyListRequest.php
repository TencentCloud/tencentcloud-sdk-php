 ...
 * @method string getBy() 获取可选排序列: [RuleCount|ItemCount|HostCount]
 * @method void setBy(string $By) 设置可选排序列: [RuleCount|ItemCount|HostCount]
 */
class DescribeBaselinePolicyListRequest extends AbstractModel
{
    ...
    /**
     * @var string 可选排序列: [RuleCount|ItemCount|HostCount]
     */
    public $By;
     ...
     * @param string $By 可选排序列: [RuleCount|ItemCount|HostCount]
     */

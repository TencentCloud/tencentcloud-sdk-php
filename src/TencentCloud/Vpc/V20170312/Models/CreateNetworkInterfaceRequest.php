 ...
 * @method string getNetworkInterfaceName() 获取<p>弹性网卡名称，最大长度不能超过60个字节。</p>
 * @method void setNetworkInterfaceName(string $NetworkInterfaceName) 设置<p>弹性网卡名称，最大长度不能超过60个字节。</p>
 ...
 * @method integer getSecondaryPrivateIpAddressCount() 获取<p>新申请的内网IP地址个数，内网IP地址个数总和不能超过配额数。<br>配额数查询：<a href="https://cloud.tencent.com/document/api/215/42942">DescribeVpcLimits</a>。</p>
 * @method void setSecondaryPrivateIpAddressCount(integer $SecondaryPrivateIpAddressCount) 设置<p>新申请的内网IP地址个数，内网IP地址个数总和不能超过配额数。<br>配额数查询：<a href="https://cloud.tencent.com/document/api/215/42942">DescribeVpcLimits</a>。</p>
 ...
 * @method string getTrunkingFlag() 获取<p>网卡trunking模式设置，Enable-开启，Disable--关闭，默认关闭。</p>
 * @method void setTrunkingFlag(string $TrunkingFlag) 设置<p>网卡trunking模式设置，Enable-开启，Disable--关闭，默认关闭。</p>
...
class CreateNetworkInterfaceRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>弹性网卡名称，最大长度不能超过60个字节。</p>
     */
    ...
    /**
     * @var integer <p>新申请的内网IP地址个数，内网IP地址个数总和不能超过配额数。<br>配额数查询：<a href="https://cloud.tencent.com/document/api/215/42942">DescribeVpcLimits</a>。</p>
     */
    ...
    /**
     * @var string <p>网卡trunking模式设置，Enable-开启，Disable--关闭，默认关闭。</p>
     */
    public $TrunkingFlag;
     ...
     * @param string $NetworkInterfaceName <p>弹性网卡名称，最大长度不能超过60个字节。</p>
     ...
     * @param integer $SecondaryPrivateIpAddressCount <p>新申请的内网IP地址个数，内网IP地址个数总和不能超过配额数。<br>配额数查询：<a href="https://cloud.tencent.com/document/api/215/42942">DescribeVpcLimits</a>。</p>
     ...
     * @param string $TrunkingFlag <p>网卡trunking模式设置，Enable-开启，Disable--关闭，默认关闭。</p>

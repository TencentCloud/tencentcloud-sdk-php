 ...
 * @method integer getLimit() 获取分页查询限制数目，默认值：20，上限：100。
 * @method void setLimit(integer $Limit) 设置分页查询限制数目，默认值：20，上限：100。
...
class DescribePrefetchOriginLimitRequest extends AbstractModel
{
    ...
    /**
     * @var integer 分页查询限制数目，默认值：20，上限：100。
     */
    public $Limit;
...
<li>area：按照限制加速区域过滤，不支持模糊查询。可选项：<br> Overseas：全球可用区（不含中国大陆）；<br> MainlandChina：中国大陆可用区。</li>
     ...
     * @param integer $Limit 分页查询限制数目，默认值：20，上限：100。

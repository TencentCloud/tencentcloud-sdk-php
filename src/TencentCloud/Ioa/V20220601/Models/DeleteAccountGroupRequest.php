 ...
 * @method integer getAccountGroupId() 获取<p>分组或者目录id(只支持32位)</p>
 * @method void setAccountGroupId(integer $AccountGroupId) 设置<p>分组或者目录id(只支持32位)</p>
 */
class DeleteAccountGroupRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>分组或者目录id(只支持32位)</p>
     */
     ...
     * @param integer $AccountGroupId <p>分组或者目录id(只支持32位)</p>
     */

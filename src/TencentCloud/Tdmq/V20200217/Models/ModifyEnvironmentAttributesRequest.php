 ...
 * @method integer getMsgTTL() 获取未消费消息过期时间，单位：秒，范围60秒~1天。
 * @method void setMsgTTL(integer $MsgTTL) 设置未消费消息过期时间，单位：秒，范围60秒~1天。
...
class ModifyEnvironmentAttributesRequest extends AbstractModel
{
    ...
    /**
     * @var integer 未消费消息过期时间，单位：秒，范围60秒~1天。
     */
    public $MsgTTL;
     ...
     * @param integer $MsgTTL 未消费消息过期时间，单位：秒，范围60秒~1天。

 ...
 *
 * @method integer getTotalCount() 获取后端服务列表总数。
 * @method void setTotalCount(integer $TotalCount) 设置后端服务列表总数。
 * @method array getCrossTargetSet() 获取后端服务列表。
 * @method void setCrossTargetSet(array $CrossTargetSet) 设置后端服务列表。

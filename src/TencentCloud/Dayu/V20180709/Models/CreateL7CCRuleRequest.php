 ...
 * @method array getRuleConfig() 获取7层CC自定义规则参数，当操作码为query时，可以不用填写；当操作码为add或del时，必须填写；
 * @method void setRuleConfig(array $RuleConfig) 设置7层CC自定义规则参数，当操作码为query时，可以不用填写；当操作码为add或del时，必须填写；
 */
...
class CreateL7CCRuleRequest extends AbstractModel
{
    ...
    /**
     * @var array 7层CC自定义规则参数，当操作码为query时，可以不用填写；当操作码为add或del时，必须填写；
     */
    public $RuleConfig;
    /**
     ...
     * @param array $RuleConfig 7层CC自定义规则参数，当操作码为query时，可以不用填写；当操作码为add或del时，必须填写；
     */

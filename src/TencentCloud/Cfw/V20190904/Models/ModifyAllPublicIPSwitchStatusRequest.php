 ...
 * @method array getFireWallPublicIPs() 获取选中的防火墙开关Id
 * @method void setFireWallPublicIPs(array $FireWallPublicIPs) 设置选中的防火墙开关Id
 */
class ModifyAllPublicIPSwitchStatusRequest extends AbstractModel
{
     ...
     * @param array $FireWallPublicIPs 选中的防火墙开关Id
     */

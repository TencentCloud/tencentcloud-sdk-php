 ...
 *
 * @method string getEncryptedBody() 获取<p>请求体被加密后的密文（Base64编码），本接口只支持加密传输</p>
 * @method void setEncryptedBody(string $EncryptedBody) 设置<p>请求体被加密后的密文（Base64编码），本接口只支持加密传输</p>
 * @method Encryption getEncryption() 获取<p>敏感数据加密信息。对传入信息有加密需求的用户可使用此参数，详情请点击左侧链接。</p>
 * @method void setEncryption(Encryption $Encryption) 设置<p>敏感数据加密信息。对传入信息有加密需求的用户可使用此参数，详情请点击左侧链接。</p>
...
{
    /**
     * @var string <p>请求体被加密后的密文（Base64编码），本接口只支持加密传输</p>
     */
    public $EncryptedBody;

    /**
     * @var Encryption <p>敏感数据加密信息。对传入信息有加密需求的用户可使用此参数，详情请点击左侧链接。</p>
     */
    public $Encryption;
    ...
    /**
     * @param string $EncryptedBody <p>请求体被加密后的密文（Base64编码），本接口只支持加密传输</p>
     * @param Encryption $Encryption <p>敏感数据加密信息。对传入信息有加密需求的用户可使用此参数，详情请点击左侧链接。</p>

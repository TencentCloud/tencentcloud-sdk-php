 ...
 * @method AiAnalysisTaskCoverInput getInput() 获取<p>智能封面任务输入。</p>
 * @method void setInput(AiAnalysisTaskCoverInput $Input) 设置<p>智能封面任务输入。</p>
 * @method AiAnalysisTaskCoverOutput getOutput() 获取<p>智能封面任务输出。</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiAnalysisTaskCoverOutput $Output) 设置<p>智能封面任务输出。</p>
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiAnalysisTaskCoverResult extends AbstractModel
{
    ...
    /**
     * @var AiAnalysisTaskCoverInput <p>智能封面任务输入。</p>
     */
    public $Input;

    /**
     * @var AiAnalysisTaskCoverOutput <p>智能封面任务输出。</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiAnalysisTaskCoverInput $Input <p>智能封面任务输入。</p>
     * @param AiAnalysisTaskCoverOutput $Output <p>智能封面任务输出。</p>
注意：此字段可能返回 null，表示取不到有效值。
     */

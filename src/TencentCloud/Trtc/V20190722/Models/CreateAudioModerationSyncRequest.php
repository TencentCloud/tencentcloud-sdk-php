 ...
 * @method string getDataId() 获取<p>据标识，可以由英文字母、数字、下划线、-、@#组成，不超过64个字符</p>
 * @method void setDataId(string $DataId) 设置<p>据标识，可以由英文字母、数字、下划线、-、@#组成，不超过64个字符</p>
...
class CreateAudioModerationSyncRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>据标识，可以由英文字母、数字、下划线、-、@#组成，不超过64个字符</p>
     */
    public $DataId;
     ...
     * @param string $DataId <p>据标识，可以由英文字母、数字、下划线、-、@#组成，不超过64个字符</p>

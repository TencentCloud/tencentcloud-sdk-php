 ...
 *
 * @method string getConsumerGroup() 获取消费者组标识
 * @method void setConsumerGroup(string $ConsumerGroup) 设置消费者组标识
 * @method array getTopicPartitionOffsetsInfo() 获取消费点位信息
 * @method void setTopicPartitionOffsetsInfo(array $TopicPartitionOffsetsInfo) 设置消费点位信息
...
class DescribeConsumerOffsetsResponse extends AbstractModel
{
    ...
    /**
     * @param string $ConsumerGroup 消费者组标识
     * @param array $TopicPartitionOffsetsInfo 消费点位信息

...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getRayDashboardUrl() 获取<p>Ray Dashboard 访问地址（通过 Ingress 代理）</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setRayDashboardUrl(string $RayDashboardUrl) 设置<p>Ray Dashboard 访问地址（通过 Ingress 代理）</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getGpuResourceSummary() 获取<p>运行中部署的 GPU 资源汇总</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setGpuResourceSummary(array $GpuResourceSummary) 设置<p>运行中部署的 GPU 资源汇总</p>
注意：此字段可能返回 null，表示取不到有效值。
 ...
 * @method boolean getIsCustom() 获取<p>是否为自定义代码部署</p>
 * @method void setIsCustom(boolean $IsCustom) 设置<p>是否为自定义代码部署</p>
 ...
 */
class GetInferenceServiceResponse extends AbstractModel
{
    /**
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var string <p>Ray Dashboard 访问地址（通过 Ingress 代理）</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var array <p>运行中部署的 GPU 资源汇总</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $GpuResourceSummary;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $RayDashboardUrl <p>Ray Dashboard 访问地址（通过 Ingress 代理）</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $GpuResourceSummary <p>运行中部署的 GPU 资源汇总</p>
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param boolean $IsCustom <p>是否为自定义代码部署</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("GpuResourceSummary",$param) and $param["GpuResourceSummary"] !== null) {
            $this->GpuResourceSummary = [];
            foreach ($param["GpuResourceSummary"] as $key => $value){
                $obj = new GpuSummaryItem();
                $obj->deserialize($value);
                array_push($this->GpuResourceSummary, $obj);
            }
        }

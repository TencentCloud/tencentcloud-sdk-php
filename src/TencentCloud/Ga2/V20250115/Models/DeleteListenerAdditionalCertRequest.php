 ...
 * @method array getAdditionalCertificates() 获取证书ID。
 * @method void setAdditionalCertificates(array $AdditionalCertificates) 设置证书ID。
 */
class DeleteListenerAdditionalCertRequest extends AbstractModel
{
     ...
     * @param array $AdditionalCertificates 证书ID。
     */

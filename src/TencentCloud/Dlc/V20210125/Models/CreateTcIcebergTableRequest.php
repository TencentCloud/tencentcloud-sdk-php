 ...
 * @method boolean getDryRun() 获取为true时只获取sql而不执行
 * @method void setDryRun(boolean $DryRun) 设置为true时只获取sql而不执行
 ...
 */
class CreateTcIcebergTableRequest extends AbstractModel
{
    /**
     ...
     * @param boolean $DryRun 为true时只获取sql而不执行

...
注意：此字段可能返回 null，表示取不到有效值。
 * @method TaskTypeExtVO getTaskTypeExtValue() 获取TaskTypeExts的Value
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTaskTypeExtValue(TaskTypeExtVO $TaskTypeExtValue) 设置TaskTypeExts的Value
注意：此字段可能返回 null，表示取不到有效值。
 */
class TaskTypeExtParamVO extends AbstractModel
{
    /**
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var TaskTypeExtVO TaskTypeExts的Value
注意：此字段可能返回 null，表示取不到有效值。
     */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param TaskTypeExtVO $TaskTypeExtValue TaskTypeExts的Value
注意：此字段可能返回 null，表示取不到有效值。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("TaskTypeExtValue",$param) and $param["TaskTypeExtValue"] !== null) {
            $this->TaskTypeExtValue = new TaskTypeExtVO();

 ...
 * @method integer getVirtualAccountGroupId() 获取分组id
 * @method void setVirtualAccountGroupId(integer $VirtualAccountGroupId) 设置分组id
 */
class GrantResourceOperationByVirtualGroups extends AbstractModel
{
    /**
     ...
     * @param integer $VirtualAccountGroupId 分组id
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("VirtualAccountGroupId",$param) and $param["VirtualAccountGroupId"] !== null) {
            $this->VirtualAccountGroupId = $param["VirtualAccountGroupId"];
        }
    }
}

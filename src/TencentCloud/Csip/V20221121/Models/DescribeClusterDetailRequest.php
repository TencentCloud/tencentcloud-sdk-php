 ...
 *
 * @method string getClusterAssetId() 获取<p>集群资产id</p>
 * @method void setClusterAssetId(string $ClusterAssetId) 设置<p>集群资产id</p>
...
class DescribeClusterDetailRequest extends AbstractModel
{
    ...
    /**
     * @param string $ClusterAssetId <p>集群资产id</p>

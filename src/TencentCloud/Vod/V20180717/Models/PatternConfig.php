 ...
 * @method integer getEdgeSamplingStep() 获取<p>边缘采样步数</p><p>取值范围：[1, 10]</p><p>默认值：5</p>
 * @method void setEdgeSamplingStep(integer $EdgeSamplingStep) 设置<p>边缘采样步数</p><p>取值范围：[1, 10]</p><p>默认值：5</p>
 * @method integer getEdgeExpansionStep() 获取<p>边缘扩展步数</p><p>默认值：5</p>
 * @method void setEdgeExpansionStep(integer $EdgeExpansionStep) 设置<p>边缘扩展步数</p><p>默认值：5</p>
 * @method float getEdgeBlendingIntensity() 获取<p>边缘融合强度</p><p>取值范围：[0.0, 1.0]</p><p>默认值：0.5</p>
 * @method void setEdgeBlendingIntensity(float $EdgeBlendingIntensity) 设置<p>边缘融合强度</p><p>取值范围：[0.0, 1.0]</p><p>默认值：0.5</p>
 */
class PatternConfig extends AbstractModel
{
    ...
    /**
     * @var integer <p>边缘采样步数</p><p>取值范围：[1, 10]</p><p>默认值：5</p>
     */
    public $EdgeSamplingStep;

    /**
     * @var integer <p>边缘扩展步数</p><p>默认值：5</p>
     */
    public $EdgeExpansionStep;

    /**
     * @var float <p>边缘融合强度</p><p>取值范围：[0.0, 1.0]</p><p>默认值：0.5</p>
     */
     ...
     * @param integer $EdgeSamplingStep <p>边缘采样步数</p><p>取值范围：[1, 10]</p><p>默认值：5</p>
     * @param integer $EdgeExpansionStep <p>边缘扩展步数</p><p>默认值：5</p>
     * @param float $EdgeBlendingIntensity <p>边缘融合强度</p><p>取值范围：[0.0, 1.0]</p><p>默认值：0.5</p>
     */

 ...
 * @method integer getOffset() 获取分页开始位置
 * @method void setOffset(integer $Offset) 设置分页开始位置
 * @method integer getLimit() 获取分页每页数
 * @method void setLimit(integer $Limit) 设置分页每页数
 */
class DescribeRecordGroupListRequest extends AbstractModel
{
     ...
     * @param integer $Offset 分页开始位置
     * @param integer $Limit 分页每页数
     */

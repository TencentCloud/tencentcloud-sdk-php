 ...
 * @method array getLabels() 获取<p>批量删除的消费标签列表</p><p>入参限制：批量上限为 32 条</p>
 * @method void setLabels(array $Labels) 设置<p>批量删除的消费标签列表</p><p>入参限制：批量上限为 32 条</p>
 */
class DeleteConsumerLabelsRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var array <p>批量删除的消费标签列表</p><p>入参限制：批量上限为 32 条</p>
     */
    public $Labels;
     ...
     * @param array $Labels <p>批量删除的消费标签列表</p><p>入参限制：批量上限为 32 条</p>
     */

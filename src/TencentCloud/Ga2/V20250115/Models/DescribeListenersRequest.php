 ...
 * @method array getFilters() 获取过滤条件。  listener-id- String -（过滤条件）监听器实例ID。
 * @method void setFilters(array $Filters) 设置过滤条件。  listener-id- String -（过滤条件）监听器实例ID。
 */
class DescribeListenersRequest extends AbstractModel
{
    ...
    /**
     * @var array 过滤条件。  listener-id- String -（过滤条件）监听器实例ID。
     */
    public $Filters;
     ...
     * @param array $Filters 过滤条件。  listener-id- String -（过滤条件）监听器实例ID。
     */

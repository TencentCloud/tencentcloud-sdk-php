 ...
 *
 * @method integer getReturnCode() 获取状态值，0：修改成功，非0：修改失败
 * @method void setReturnCode(integer $ReturnCode) 设置状态值，0：修改成功，非0：修改失败
 ...
 */
class ModifyEWRuleStatusResponse extends AbstractModel
{
    /**
     * @var integer 状态值，0：修改成功，非0：修改失败
     */
    public $ReturnCode;
    ...
    /**
     * @param integer $ReturnCode 状态值，0：修改成功，非0：修改失败

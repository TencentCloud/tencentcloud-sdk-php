 ...
 * @method array getFlowInfos() 获取<p>合同组中每个合同签署流程的信息，合同组中最少包含2个合同，不能超过50个合同。</p>
 * @method void setFlowInfos(array $FlowInfos) 设置<p>合同组中每个合同签署流程的信息，合同组中最少包含2个合同，不能超过50个合同。</p>
...
class ChannelCreateFlowGroupByTemplatesRequest extends AbstractModel
{
     ...
     * @param array $FlowInfos <p>合同组中每个合同签署流程的信息，合同组中最少包含2个合同，不能超过50个合同。</p>

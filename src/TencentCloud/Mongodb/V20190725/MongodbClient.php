 ...
 * @method Models\ModifyInstanceAzResponse ModifyInstanceAz(Models\ModifyInstanceAzRequest $req) 本接口(ModifyInstanceAz)用于调整 MongoDB 云数据库的节点可用区分布，可通过指定主可用区和全部可用区分布信息完成云数据库的节点分布调整。
 ...
 * @method Models\ScaleDownDBInstanceCpuResponse ScaleDownDBInstanceCpu(Models\ScaleDownDBInstanceCpuRequest $req) ScaleDownDBInstanceCpu
 * @method Models\ScaleUpDBInstanceCpuResponse ScaleUpDBInstanceCpu(Models\ScaleUpDBInstanceCpuRequest $req) 手动开启cpu弹性扩容

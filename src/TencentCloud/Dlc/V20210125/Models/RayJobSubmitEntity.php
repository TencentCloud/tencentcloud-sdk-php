 ...
 * @method string getJobSource() 获取<p>作业来源（如 RAY_JOB / RAY_SERVE / 平台直提交等）</p>
 * @method void setJobSource(string $JobSource) 设置<p>作业来源（如 RAY_JOB / RAY_SERVE / 平台直提交等）</p>
 */
class RayJobSubmitEntity extends AbstractModel
{
    /**
     * @var string <p>任务ID</p>
     */
    ...
    /**
     * @var string <p>作业来源（如 RAY_JOB / RAY_SERVE / 平台直提交等）</p>
     */
    public $JobSource;
     ...
     * @param string $JobSource <p>作业来源（如 RAY_JOB / RAY_SERVE / 平台直提交等）</p>
     */

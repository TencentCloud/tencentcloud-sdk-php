 ...
 *
 * @method string getTaskId() 获取<p>视频处理任务的任务 ID。</p>
 * @method void setTaskId(string $TaskId) 设置<p>视频处理任务的任务 ID。</p>
...
class DescribeTaskDetailRequest extends AbstractModel
{
    ...
    /**
     * @param string $TaskId <p>视频处理任务的任务 ID。</p>

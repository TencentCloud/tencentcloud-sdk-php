 ...
 *
 * @method string getId() 获取<p>获取Ray集群详情请求</p>
 * @method void setId(string $Id) 设置<p>获取Ray集群详情请求</p>
 ...
 */
class GetRayClusterResponse extends AbstractModel
{
    /**
     * @var string <p>获取Ray集群详情请求</p>
     */
    public $Id;
    ...
    /**
     * @param string $Id <p>获取Ray集群详情请求</p>

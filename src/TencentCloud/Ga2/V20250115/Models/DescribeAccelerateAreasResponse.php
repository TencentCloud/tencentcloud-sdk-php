...
class DescribeAccelerateAreasResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("AccelerateAreaSet",$param) and $param["AccelerateAreaSet"] !== null) {
            $this->AccelerateAreaSet = [];
            foreach ($param["AccelerateAreaSet"] as $key => $value){
                $obj = new AcceleratorAreas();
                $obj->deserialize($value);
                array_push($this->AccelerateAreaSet, $obj);
            }
        }

 ...
 * @method Models\CreateAudioModerationSyncTaskResponse CreateAudioModerationSyncTask(Models\CreateAudioModerationSyncTaskRequest $req) 本接口（CreateAudioModerationSyncTask） 用于提交短音频内容进行智能审核任务，使用前请您使用腾讯云主账号登录控制台 [开通音频内容安全服务](https://console.cloud.tencent.com/cms/audio/package) 并调整好对应的业务配置。

 ...
 *
 * @method array getItems() 获取<p>返回训练实例列表</p>
 * @method void setItems(array $Items) 设置<p>返回训练实例列表</p>
 * @method integer getTotal() 获取<p>总数</p>
 * @method void setTotal(integer $Total) 设置<p>总数</p>
 * @method integer getPage() 获取<p>当前页</p>
 * @method void setPage(integer $Page) 设置<p>当前页</p>
 ...
 */
class ListMlflowServerTrainingInstancesResponse extends AbstractModel
{
    /**
     * @var array <p>返回训练实例列表</p>
     */
    public $Items;
    ...
    /**
     * @param array $Items <p>返回训练实例列表</p>
     * @param integer $Total <p>总数</p>
     * @param integer $Page <p>当前页</p>

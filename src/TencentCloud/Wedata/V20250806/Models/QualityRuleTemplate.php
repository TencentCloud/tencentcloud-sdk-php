...
注意：此字段可能返回 null，表示取不到有效值。
 * @method QualitySqlExpression getResolvedSqlExpression() 获取sql表达式解析对象
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResolvedSqlExpression(QualitySqlExpression $ResolvedSqlExpression) 设置sql表达式解析对象
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var QualitySqlExpression sql表达式解析对象
注意：此字段可能返回 null，表示取不到有效值。
     */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param QualitySqlExpression $ResolvedSqlExpression sql表达式解析对象
注意：此字段可能返回 null，表示取不到有效值。

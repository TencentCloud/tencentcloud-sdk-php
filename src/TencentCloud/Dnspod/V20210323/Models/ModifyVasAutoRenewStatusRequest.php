 ...
 *
 * @method string getResourceId() 获取资源ID。可以从控制台查看所有的资源
 * @method void setResourceId(string $ResourceId) 设置资源ID。可以从控制台查看所有的资源
...
class ModifyVasAutoRenewStatusRequest extends AbstractModel
{
    ...
    /**
     * @param string $ResourceId 资源ID。可以从控制台查看所有的资源

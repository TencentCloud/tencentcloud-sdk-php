 ...
 * @method Order getOrder() 获取<p>兑奖关联的订单信息</p>
 * @method void setOrder(Order $Order) 设置<p>兑奖关联的订单信息</p>
 * @method Result getResult() 获取<p>兑奖结果</p>
 * @method void setResult(Result $Result) 设置<p>兑奖结果</p>
...
class RedeemEvent extends AbstractModel
{
     ...
     * @param Order $Order <p>兑奖关联的订单信息</p>
     * @param Result $Result <p>兑奖结果</p>

 ...
 * QA 操作权限信息
 *
 * @method boolean getCanAccept() 获取<p>是否可校验（采纳/不采纳）</p>
 * @method void setCanAccept(boolean $CanAccept) 设置<p>是否可校验（采纳/不采纳）</p>
 ...
 */
class QAPermission extends AbstractModel
{
    /**
     * @var boolean <p>是否可校验（采纳/不采纳）</p>
     */
    public $CanAccept;
    ...
    /**
     * @param boolean $CanAccept <p>是否可校验（采纳/不采纳）</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("CanAccept",$param) and $param["CanAccept"] !== null) {
            $this->CanAccept = $param["CanAccept"];
        }

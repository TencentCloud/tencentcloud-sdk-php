 ...
 * @method string getOrganizationName() 获取<p>企业用户动态签署方场景指定预设企业名称。<code>注意：1. 若为企业动态签署方场景，此参数必须要指定。2. 企业动态签署方场景暂不支持指定姓名证件手机号等参数，仅支持指定企业名称。3. 暂不支持指定子客企业，此处预设的企业仅支持SaaS企业。</code></p>
 * @method void setOrganizationName(string $OrganizationName) 设置<p>企业用户动态签署方场景指定预设企业名称。<code>注意：1. 若为企业动态签署方场景，此参数必须要指定。2. 企业动态签署方场景暂不支持指定姓名证件手机号等参数，仅支持指定企业名称。3. 暂不支持指定子客企业，此处预设的企业仅支持SaaS企业。</code></p>
 */
class PresetApproverInfo extends AbstractModel
{
    ...
    /**
     * @var string <p>企业用户动态签署方场景指定预设企业名称。<code>注意：1. 若为企业动态签署方场景，此参数必须要指定。2. 企业动态签署方场景暂不支持指定姓名证件手机号等参数，仅支持指定企业名称。3. 暂不支持指定子客企业，此处预设的企业仅支持SaaS企业。</code></p>
     */
     ...
     * @param string $OrganizationName <p>企业用户动态签署方场景指定预设企业名称。<code>注意：1. 若为企业动态签署方场景，此参数必须要指定。2. 企业动态签署方场景暂不支持指定姓名证件手机号等参数，仅支持指定企业名称。3. 暂不支持指定子客企业，此处预设的企业仅支持SaaS企业。</code></p>
     */

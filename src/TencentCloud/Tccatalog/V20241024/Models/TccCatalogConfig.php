 ...
 * @method TccConnectionConfig getConnection() 获取Tcc数据目录连接信息
 * @method void setConnection(TccConnectionConfig $Connection) 设置Tcc数据目录连接信息
 ...
 */
class TccCatalogConfig extends AbstractModel
{
    /**
     * @var string 数据目录唯一id
     */
    ...
    /**
     * @var TccConnectionConfig Tcc数据目录连接信息
     */
    public $Connection;
     ...
     * @param TccConnectionConfig $Connection Tcc数据目录连接信息
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Connection",$param) and $param["Connection"] !== null) {
            $this->Connection = new TccConnectionConfig();

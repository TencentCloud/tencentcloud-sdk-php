...
注意：此字段可能返回 null，表示取不到有效值。
 * @method RefundOrderResult getResult() 获取退款响应对象
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(RefundOrderResult $Result) 设置退款响应对象
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new RefundOrderResult();

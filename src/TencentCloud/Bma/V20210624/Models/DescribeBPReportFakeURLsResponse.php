...
class DescribeBPReportFakeURLsResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ReportFakeURLInfos",$param) and $param["ReportFakeURLInfos"] !== null) {
            $this->ReportFakeURLInfos = [];
            foreach ($param["ReportFakeURLInfos"] as $key => $value){
                $obj = new ReportFakeURLInfo();
                $obj->deserialize($value);
                array_push($this->ReportFakeURLInfos, $obj);
            }
        }

 ...
 * @method integer getTotalCount() 获取高性能计算集群总数。
 * @method void setTotalCount(integer $TotalCount) 设置高性能计算集群总数。
...
class DescribeHpcClustersResponse extends AbstractModel
{
     ...
     * @param integer $TotalCount 高性能计算集群总数。

...
注意：此字段可能返回 null，表示取不到有效值。
 * @method UserGroupVO getData() 获取<p>数据</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setData(UserGroupVO $Data) 设置<p>数据</p>
注意：此字段可能返回 null，表示取不到有效值。

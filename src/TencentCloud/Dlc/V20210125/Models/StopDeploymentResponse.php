 ...
 * @method string getImagePullType() 获取<p>镜像拉取方式</p>
 * @method void setImagePullType(string $ImagePullType) 设置<p>镜像拉取方式</p>
 ...
 */
class StopDeploymentResponse extends AbstractModel
{
    /**
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param string $ImagePullType <p>镜像拉取方式</p>

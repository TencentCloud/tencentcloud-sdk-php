...
/**
 * @method Models\CreateNameListResponse CreateNameList(Models\CreateNameListRequest $req) 创建黑白名单列表的数据 包含列表名称 列表名单类型id 关联场景id 数据类型id 记录状态 备注 数据来源 手动输入数据或cos文件key
 ...
 * @method Models\ImportNameListDataResponse ImportNameListData(Models\ImportNameListDataRequest $req) 新增黑白名单详情数据 手动导入或批量导入

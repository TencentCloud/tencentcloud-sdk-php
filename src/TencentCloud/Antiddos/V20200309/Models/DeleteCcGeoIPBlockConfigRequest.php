 ...
 * @method CcGeoIPBlockConfig getCcGeoIPBlockConfig() 获取CC区域封禁配置，填写参数时配置ID不能为空
 * @method void setCcGeoIPBlockConfig(CcGeoIPBlockConfig $CcGeoIPBlockConfig) 设置CC区域封禁配置，填写参数时配置ID不能为空
 */
class DeleteCcGeoIPBlockConfigRequest extends AbstractModel
{
    ...
    /**
     * @var CcGeoIPBlockConfig CC区域封禁配置，填写参数时配置ID不能为空
     */
    public $CcGeoIPBlockConfig;

    /**
     * @param string $InstanceId 资源实例ID
     * @param CcGeoIPBlockConfig $CcGeoIPBlockConfig CC区域封禁配置，填写参数时配置ID不能为空
     */

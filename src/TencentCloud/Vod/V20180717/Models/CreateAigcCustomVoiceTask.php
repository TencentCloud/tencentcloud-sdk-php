 ...
 * @method CreateAigcCustomVoiceInput getInput() 获取<p>创建 AIGC 自定义音色输入信息。</p>
 * @method void setInput(CreateAigcCustomVoiceInput $Input) 设置<p>创建 AIGC 自定义音色输入信息。</p>
 * @method CreateAigcCustomVoiceOutput getOutput() 获取<p>创建 AIGC 自定义音色输出信息。</p>
 * @method void setOutput(CreateAigcCustomVoiceOutput $Output) 设置<p>创建 AIGC 自定义音色输出信息。</p>
...
class CreateAigcCustomVoiceTask extends AbstractModel
{
    ...
    /**
     * @var CreateAigcCustomVoiceInput <p>创建 AIGC 自定义音色输入信息。</p>
     */
    public $Input;

    /**
     * @var CreateAigcCustomVoiceOutput <p>创建 AIGC 自定义音色输出信息。</p>
     */
    public $Output;
     ...
     * @param CreateAigcCustomVoiceInput $Input <p>创建 AIGC 自定义音色输入信息。</p>
     * @param CreateAigcCustomVoiceOutput $Output <p>创建 AIGC 自定义音色输出信息。</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Input",$param) and $param["Input"] !== null) {
            $this->Input = new CreateAigcCustomVoiceInput();
            $this->Input->deserialize($param["Input"]);
        }

        if (array_key_exists("Output",$param) and $param["Output"] !== null) {
            $this->Output = new CreateAigcCustomVoiceOutput();

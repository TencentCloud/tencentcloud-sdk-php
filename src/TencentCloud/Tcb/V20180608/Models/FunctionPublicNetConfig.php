...
注意：此字段可能返回 null，表示取不到有效值。
 * @method FunctionEipConfig getEipConfig() 获取Eip配置
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setEipConfig(FunctionEipConfig $EipConfig) 设置Eip配置
注意：此字段可能返回 null，表示取不到有效值。
 */
class FunctionPublicNetConfig extends AbstractModel
{
    /**
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param FunctionEipConfig $EipConfig Eip配置
注意：此字段可能返回 null，表示取不到有效值。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("EipConfig",$param) and $param["EipConfig"] !== null) {
            $this->EipConfig = new FunctionEipConfig();

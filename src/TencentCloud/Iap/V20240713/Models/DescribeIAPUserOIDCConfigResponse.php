 ...
 *
 * @method integer getProviderType() 获取身份提供商类型。 13：IAP用户OIDC身份提供商
 * @method void setProviderType(integer $ProviderType) 设置身份提供商类型。 13：IAP用户OIDC身份提供商
 ...
 * @method array getFingerprints() 获取HTTPS CA证书的验证指纹，允许英文字母和数字，每个指纹长度为40个字符，最多5个指纹。
 * @method void setFingerprints(array $Fingerprints) 设置HTTPS CA证书的验证指纹，允许英文字母和数字，每个指纹长度为40个字符，最多5个指纹。
 * @method integer getEnableAutoPublicKey() 获取是否需要开启自动使用OIDC签名公钥，1:需要，2:不需要，默认不需要
 * @method void setEnableAutoPublicKey(integer $EnableAutoPublicKey) 设置是否需要开启自动使用OIDC签名公钥，1:需要，2:不需要，默认不需要
...
{
    /**
     * @var integer 身份提供商类型。 13：IAP用户OIDC身份提供商
     */
    public $ProviderType;
    ...
    /**
     * @var array HTTPS CA证书的验证指纹，允许英文字母和数字，每个指纹长度为40个字符，最多5个指纹。
     */
    public $Fingerprints;

    /**
     * @var integer 是否需要开启自动使用OIDC签名公钥，1:需要，2:不需要，默认不需要
     */
    ...
    /**
     * @param integer $ProviderType 身份提供商类型。 13：IAP用户OIDC身份提供商
     * @param string $IdentityUrl 身份提供商URL
     * @param string $IdentityKey 签名公钥
     * @param string $ClientId 客户端id
     * @param integer $Status 状态：0:未设置，11:已开启，2:已禁用
     * @param array $Fingerprints HTTPS CA证书的验证指纹，允许英文字母和数字，每个指纹长度为40个字符，最多5个指纹。
     * @param integer $EnableAutoPublicKey 是否需要开启自动使用OIDC签名公钥，1:需要，2:不需要，默认不需要

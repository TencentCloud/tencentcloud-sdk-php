 ...
 * @method Models\AsyncRegisterIpsResponse AsyncRegisterIps(Models\AsyncRegisterIpsRequest $req) 黑石1.0接口，业务已下线，90天无调用
 ...
 * @method Models\BindIpsToNatGatewayResponse BindIpsToNatGateway(Models\BindIpsToNatGatewayRequest $req) 黑石1.0接口，业务已下线，90天无调用

可用于将子网的部分IP绑定到NAT网关
 * @method Models\BindSubnetsToNatGatewayResponse BindSubnetsToNatGateway(Models\BindSubnetsToNatGatewayRequest $req) 黑石1.0接口，业务已下线，90天无调用

NAT网关绑定子网后，该子网内全部IP可出公网
 * @method Models\CreateCustomerGatewayResponse CreateCustomerGateway(Models\CreateCustomerGatewayRequest $req) 90天无调用
 ...
 * @method Models\CreateHostedInterfaceResponse CreateHostedInterface(Models\CreateHostedInterfaceRequest $req) 黑石1.0接口，业务已下线，90天无调用
 ...
 * @method Models\CreateNatGatewayResponse CreateNatGateway(Models\CreateNatGatewayRequest $req) 黑石1.0接口，业务已下线，90天无调用

创建NAT网关接口，可针对网段方式、子网全部IP、子网部分IP这三种方式创建NAT网关
 * @method Models\CreateRoutePoliciesResponse CreateRoutePolicies(Models\CreateRoutePoliciesRequest $req) 黑石1.0接口，业务已下线，90天无调用
 ...
 * @method Models\CreateVpcResponse CreateVpc(Models\CreateVpcRequest $req) 黑石1.0接口，业务已下线，90天无调用

创建黑石私有网络
 * @method Models\CreateVpcPeerConnectionResponse CreateVpcPeerConnection(Models\CreateVpcPeerConnectionRequest $req) 黑石1.0接口，业务已下线，90天无调用
 ...
 * @method Models\DeleteNatGatewayResponse DeleteNatGateway(Models\DeleteNatGatewayRequest $req) 黑石1.0接口，业务已下线，90天无调用

删除NAT网关
 * @method Models\DeleteRoutePolicyResponse DeleteRoutePolicy(Models\DeleteRoutePolicyRequest $req) 黑石1.0接口，业务已下线，90天无调用
 ...
 * @method Models\DeregisterIpsResponse DeregisterIps(Models\DeregisterIpsRequest $req) 黑石1.0接口，业务已下线，90天无调用
 ...
 * @method Models\DownloadCustomerGatewayConfigurationResponse DownloadCustomerGatewayConfiguration(Models\DownloadCustomerGatewayConfigurationRequest $req) 90天无调用
 ...
 * @method Models\ModifyRoutePolicyResponse ModifyRoutePolicy(Models\ModifyRoutePolicyRequest $req) 黑石1.0接口，业务已下线，90天无调用

修改自定义路由
 * @method Models\ModifyRouteTableResponse ModifyRouteTable(Models\ModifyRouteTableRequest $req) 黑石1.0接口，业务已下线，90天无调用
 ...
 * @method Models\UnbindIpsFromNatGatewayResponse UnbindIpsFromNatGateway(Models\UnbindIpsFromNatGatewayRequest $req) 黑石1.0接口，业务已下线，90天无调用

NAT网关解绑IP接口，可将子网的部分IP从NAT网关中解绑
 * @method Models\UnbindSubnetsFromNatGatewayResponse UnbindSubnetsFromNatGateway(Models\UnbindSubnetsFromNatGatewayRequest $req) 黑石1.0接口，业务已下线，90天无调用

NAT网关解绑子网接口，可将子网解绑NAT网关
 * @method Models\UpgradeNatGatewayResponse UpgradeNatGateway(Models\UpgradeNatGatewayRequest $req) 黑石1.0接口，业务已下线，90天无调用

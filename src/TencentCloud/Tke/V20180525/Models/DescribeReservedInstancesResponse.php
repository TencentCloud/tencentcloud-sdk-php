 ...
 * @method array getReservedInstanceSet() 获取预留实例列表。
 * @method void setReservedInstanceSet(array $ReservedInstanceSet) 设置预留实例列表。
...
class DescribeReservedInstancesResponse extends AbstractModel
{
     ...
     * @param array $ReservedInstanceSet 预留实例列表。

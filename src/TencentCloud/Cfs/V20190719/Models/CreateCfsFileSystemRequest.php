 ...
 * @method string getPGroupId() 获取权限组 ID,pgroupbasic 是默认权限组
 * @method void setPGroupId(string $PGroupId) 设置权限组 ID,pgroupbasic 是默认权限组
 ...
 * @method string getCcnId() 获取云联网ID， 若网络类型选择的是CCN，该字段为必填;通过查询云联网列表接口获取
 * @method void setCcnId(string $CcnId) 设置云联网ID， 若网络类型选择的是CCN，该字段为必填;通过查询云联网列表接口获取
...
class CreateCfsFileSystemRequest extends AbstractModel
{
    ...
    /**
     * @var string 权限组 ID,pgroupbasic 是默认权限组
     */
    public $PGroupId;
    ...
    /**
     * @var string 云联网ID， 若网络类型选择的是CCN，该字段为必填;通过查询云联网列表接口获取
     */
    public $CcnId;
...
说明：增强版的通用系统需要开通白名单才能使用，如有需要请提交工单与我们联系。
     ...
     * @param string $PGroupId 权限组 ID,pgroupbasic 是默认权限组
     ...
     * @param string $CcnId 云联网ID， 若网络类型选择的是CCN，该字段为必填;通过查询云联网列表接口获取

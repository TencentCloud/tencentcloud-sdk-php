 ...
 * @method string getStreamKey() 获取RTMP源站的StreamKey信息。
 * @method void setStreamKey(string $StreamKey) 设置RTMP源站的StreamKey信息。
 */
class RTMPPullSourceAddress extends AbstractModel
{
    ...
    /**
     * @var string RTMP源站的StreamKey信息。
     */
    public $StreamKey;

    /**
     * @param string $TcUrl RTMP源站的TcUrl地址。
     * @param string $StreamKey RTMP源站的StreamKey信息。
     */

 ...
 * @method array getGroupId() 获取根据域名分组 id 获取域名
 * @method void setGroupId(array $GroupId) 设置根据域名分组 id 获取域名
...
RECENT：最近操作过的域名
     ...
     * @param array $GroupId 根据域名分组 id 获取域名

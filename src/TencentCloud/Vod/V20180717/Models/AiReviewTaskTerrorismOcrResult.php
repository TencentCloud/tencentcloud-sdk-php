 ...
 * @method AiReviewTerrorismOcrTaskInput getInput() 获取智能识别 Ocr 文字涉及令人不安全的信息的任务输入。
 * @method void setInput(AiReviewTerrorismOcrTaskInput $Input) 设置智能识别 Ocr 文字涉及令人不安全的信息的任务输入。
 * @method AiReviewTerrorismOcrTaskOutput getOutput() 获取智能识别 Ocr 文字涉及令人不安全的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewTerrorismOcrTaskOutput $Output) 设置智能识别 Ocr 文字涉及令人不安全的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiReviewTaskTerrorismOcrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewTerrorismOcrTaskInput 智能识别 Ocr 文字涉及令人不安全的信息的任务输入。
     */
    public $Input;

    /**
     * @var AiReviewTerrorismOcrTaskOutput 智能识别 Ocr 文字涉及令人不安全的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiReviewTerrorismOcrTaskInput $Input 智能识别 Ocr 文字涉及令人不安全的信息的任务输入。
     * @param AiReviewTerrorismOcrTaskOutput $Output 智能识别 Ocr 文字涉及令人不安全的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

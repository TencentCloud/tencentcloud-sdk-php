 ...
 * @method boolean getRollback() 获取切换回滚至非直连
 * @method void setRollback(boolean $Rollback) 设置切换回滚至非直连
 */
class SwitchClusterEndpointRequest extends AbstractModel
{
    /**
     * @var string 集群ID
     */
     ...
     * @param boolean $Rollback 切换回滚至非直连
     */

 ...
 * @method CreateBatchPaymentData getResult() 获取返回响应
 * @method void setResult(CreateBatchPaymentData $Result) 设置返回响应
...
class CreateBatchPaymentResponse extends AbstractModel
{
    ...
    /**
     * @var CreateBatchPaymentData 返回响应
     */
    public $Result;
     ...
     * @param CreateBatchPaymentData $Result 返回响应
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new CreateBatchPaymentData();

 ...
 *
 * @method array getItems() 获取<p>归档日志列表</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setItems(array $Items) 设置<p>归档日志列表</p>
注意：此字段可能返回 null，表示取不到有效值。

 ...
 * @method boolean getEnable() 获取<p>是否启用</p><p>枚举值：</p><ul><li>true： 启用</li><li>false： 不启用</li></ul>
 * @method void setEnable(boolean $Enable) 设置<p>是否启用</p><p>枚举值：</p><ul><li>true： 启用</li><li>false： 不启用</li></ul>
 * @method array getScanType() 获取<p>扫描类别</p><p>枚举值：</p><ul><li>VUL： 漏洞</li><li>VIRUS： 木马</li><li>RISK： 敏感信息</li></ul>
 * @method void setScanType(array $ScanType) 设置<p>扫描类别</p><p>枚举值：</p><ul><li>VUL： 漏洞</li><li>VIRUS： 木马</li><li>RISK： 敏感信息</li></ul>
 ...
 * @method integer getTimeout() 获取<p>CreateImageRegistryTimedScanTaskConfig</p>
 * @method void setTimeout(integer $Timeout) 设置<p>CreateImageRegistryTimedScanTaskConfig</p>
 */
class CreateImageRegistryTimedScanTaskConfigRequest extends AbstractModel
{
    ...
    /**
     * @var boolean <p>是否启用</p><p>枚举值：</p><ul><li>true： 启用</li><li>false： 不启用</li></ul>
     */
    public $Enable;

    /**
     * @var array <p>扫描类别</p><p>枚举值：</p><ul><li>VUL： 漏洞</li><li>VIRUS： 木马</li><li>RISK： 敏感信息</li></ul>
     */
    public $ScanType;
     ...
     * @param boolean $Enable <p>是否启用</p><p>枚举值：</p><ul><li>true： 启用</li><li>false： 不启用</li></ul>
     * @param array $ScanType <p>扫描类别</p><p>枚举值：</p><ul><li>VUL： 漏洞</li><li>VIRUS： 木马</li><li>RISK： 敏感信息</li></ul>

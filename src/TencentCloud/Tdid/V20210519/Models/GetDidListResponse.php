 ...
 * GetDidList返回参数结构体
 *
 * @method array getDataList() 获取数据列表
 * @method void setDataList(array $DataList) 设置数据列表
 * @method integer getAllCount() 获取数据总条数
 * @method void setAllCount(integer $AllCount) 设置数据总条数

 ...
 * @method WafGroupInfo getWafGroupInfo() 获取托管规则信息。
 * @method void setWafGroupInfo(WafGroupInfo $WafGroupInfo) 设置托管规则信息。
...
class DescribeSecurityGroupManagedRulesResponse extends AbstractModel
{
     ...
     * @param WafGroupInfo $WafGroupInfo 托管规则信息。

...
/**
 * @method JobView getJobSet() 获取作业列表
 * @method void setJobSet(JobView $JobSet) 设置作业列表
...
class DescribeJobsResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("JobSet",$param) and $param["JobSet"] !== null) {
            $this->JobSet = new JobView();
            $this->JobSet->deserialize($param["JobSet"]);
        }

...
* @method Models\CreateEncryptKeysResponse CreateEncryptKeys(Models\CreateEncryptKeysRequest $req) 该接口用来设置加密的秘钥。注意，同一个content id，只能设置一次！
...
由于缓存，删除操作需要约半小时生效
* @method Models\DescribeAllKeysResponse DescribeAllKeys(Models\DescribeAllKeysRequest $req) 本接口用来查询指定DRM类型、ContentType的所有加密秘钥

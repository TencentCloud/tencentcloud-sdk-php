 ...
 * @method integer getLimit() 获取<p>分页查询limit</p>
 * @method void setLimit(integer $Limit) 设置<p>分页查询limit</p>
 * @method integer getOffset() 获取<p>分页查询偏移</p>
 * @method void setOffset(integer $Offset) 设置<p>分页查询偏移</p>
 */
class DescribeCloudNativeAPIGatewayMCPToolVersionListRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var integer <p>分页查询limit</p>
     */
    public $Limit;

    /**
     * @var integer <p>分页查询偏移</p>
     */
    public $Offset;
     ...
     * @param integer $Limit <p>分页查询limit</p>
     * @param integer $Offset <p>分页查询偏移</p>
     */

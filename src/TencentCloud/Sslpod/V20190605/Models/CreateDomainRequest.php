 ...
 * @method boolean getNotice() 获取是否开启通知告警；true：开启通知告警，false：关闭通知告警
 * @method void setNotice(boolean $Notice) 设置是否开启通知告警；true：开启通知告警，false：关闭通知告警
...
class CreateDomainRequest extends AbstractModel
{
    ...
    /**
     * @var boolean 是否开启通知告警；true：开启通知告警，false：关闭通知告警
     */
    public $Notice;
     ...
     * @param boolean $Notice 是否开启通知告警；true：开启通知告警，false：关闭通知告警

 ...
 * @method PersonImageInfo getImageInfo() 获取自定义人脸信息
 * @method void setImageInfo(PersonImageInfo $ImageInfo) 设置自定义人脸信息
...
class CreateCustomPersonResponse extends AbstractModel
{
     ...
     * @param PersonImageInfo $ImageInfo 自定义人脸信息

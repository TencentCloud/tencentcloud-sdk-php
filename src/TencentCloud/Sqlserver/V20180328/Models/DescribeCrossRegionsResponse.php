 ...
 *
 * @method array getRegions() 获取支持跨地域备份的目标地域集合
 * @method void setRegions(array $Regions) 设置支持跨地域备份的目标地域集合
...
class DescribeCrossRegionsResponse extends AbstractModel
{
    ...
    /**
     * @param array $Regions 支持跨地域备份的目标地域集合

 ...
 * @method array getNumbers() 获取<p>号码列表</p>
 * @method void setNumbers(array $Numbers) 设置<p>号码列表</p>
...
class DescribeNumbersResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Numbers",$param) and $param["Numbers"] !== null) {
            $this->Numbers = [];
            foreach ($param["Numbers"] as $key => $value){
                $obj = new NumberInfo();
                $obj->deserialize($value);
                array_push($this->Numbers, $obj);
            }
        }

 ...
 *
 * @method string getRegion() 获取高防包购买地域
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setRegion(string $Region) 设置高防包购买地域
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getProtectIpCount() 获取防护IP数量
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setProtectIpCount(integer $ProtectIpCount) 设置防护IP数量
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getBandwidth() 获取防护业务带宽 50Mbps
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setBandwidth(integer $Bandwidth) 设置防护业务带宽 50Mbps
注意：此字段可能返回 null，表示取不到有效值。
 * @method boolean getElasticBandwidthFlag() 获取是否开启弹性防护带宽 true 开启 
默认为false 不开启
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setElasticBandwidthFlag(boolean $ElasticBandwidthFlag) 设置是否开启弹性防护带宽 true 开启 
默认为false 不开启
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var integer 防护业务带宽 50Mbps
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Bandwidth;

    /**
     * @var boolean 是否开启弹性防护带宽 true 开启 
默认为false 不开启
注意：此字段可能返回 null，表示取不到有效值。
     */
    ...
    /**
     * @param string $Region 高防包购买地域
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $ProtectIpCount 防护IP数量
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $Bandwidth 防护业务带宽 50Mbps
注意：此字段可能返回 null，表示取不到有效值。
     * @param boolean $ElasticBandwidthFlag 是否开启弹性防护带宽 true 开启 
默认为false 不开启
注意：此字段可能返回 null，表示取不到有效值。
     */

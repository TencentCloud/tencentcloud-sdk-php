 ...
 *
 * @method string getAnalyzeTaskType() 获取分析任务类型
 * @method void setAnalyzeTaskType(string $AnalyzeTaskType) 设置分析任务类型
 * @method string getMetricType() 获取指标类型，counter 或者 gauge
 * @method void setMetricType(string $MetricType) 设置指标类型，counter 或者 gauge
 * @method string getField() 获取指标详细字段
 * @method void setField(string $Field) 设置指标详细字段
 * @method string getFilter() 获取过滤条件
 * @method void setFilter(string $Filter) 设置过滤条件
 * @method string getGroupBy() 获取聚合时间, 1m、1d、100d 等等
 * @method void setGroupBy(string $GroupBy) 设置聚合时间, 1m、1d、100d 等等
...
class DescribeProbeMetricDataRequest extends AbstractModel
{
    ...
    /**
     * @var string 指标类型，counter 或者 gauge
     */
    public $MetricType;
    ...
    /**
     * @param string $AnalyzeTaskType 分析任务类型
     * @param string $MetricType 指标类型，counter 或者 gauge
     * @param string $Field 指标详细字段
     * @param string $Filter 过滤条件
     * @param string $GroupBy 聚合时间, 1m、1d、100d 等等

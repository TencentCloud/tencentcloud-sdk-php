 ...
 * @method string getOrderField() 获取排序字段。支持：`AddressTemplateId` `CreatedTime` `UpdateTime`。注意：该字段没有默认值。
 * @method void setOrderField(string $OrderField) 设置排序字段。支持：`AddressTemplateId` `CreatedTime` `UpdateTime`。注意：该字段没有默认值。
 ...
 * @method string getMemberOrderField() 获取IP成员排序字段。支持：`Address` `UpdateTime`。注意：该字段没有默认值。
 * @method void setMemberOrderField(string $MemberOrderField) 设置IP成员排序字段。支持：`Address` `UpdateTime`。注意：该字段没有默认值。
 * @method string getMemberOrderDirection() 获取IP成员排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
 * @method void setMemberOrderDirection(string $MemberOrderDirection) 设置IP成员排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
 */
...
<li>address-ip - IP地址。</li>
    ...
    /**
     * @var string 排序字段。支持：`AddressTemplateId` `CreatedTime` `UpdateTime`。注意：该字段没有默认值。
     */
    public $OrderField;
    ...
    /**
     * @var string IP成员排序字段。支持：`Address` `UpdateTime`。注意：该字段没有默认值。
     */
    public $MemberOrderField;

    /**
     * @var string IP成员排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
     */
...
<li>address-ip - IP地址。</li>
     ...
     * @param string $OrderField 排序字段。支持：`AddressTemplateId` `CreatedTime` `UpdateTime`。注意：该字段没有默认值。
     * @param string $OrderDirection 排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
     * @param string $MemberOrderField IP成员排序字段。支持：`Address` `UpdateTime`。注意：该字段没有默认值。
     * @param string $MemberOrderDirection IP成员排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
     */

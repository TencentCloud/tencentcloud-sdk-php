 ...
 *
 * @method string getHealthCheckPolicyName() 获取健康检测策略名称
 * @method void setHealthCheckPolicyName(string $HealthCheckPolicyName) 设置健康检测策略名称
...
class CreateHealthCheckPolicyResponse extends AbstractModel
{
    ...
    /**
     * @param string $HealthCheckPolicyName 健康检测策略名称

 ...
 * @method array getBindInstanceIds() 获取配置绑定的实例ID，当配置级别为"Instance"时需要传入。
 * @method void setBindInstanceIds(array $BindInstanceIds) 设置配置绑定的实例ID，当配置级别为"Instance"时需要传入。
 */
class CreateMailProfileRequest extends AbstractModel
{
    ...
    /**
     * @var array 配置绑定的实例ID，当配置级别为"Instance"时需要传入。
     */
     ...
     * @param array $BindInstanceIds 配置绑定的实例ID，当配置级别为"Instance"时需要传入。
     */

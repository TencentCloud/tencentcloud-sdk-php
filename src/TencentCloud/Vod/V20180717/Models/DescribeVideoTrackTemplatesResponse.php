 ...
 * @method array getVideoTrackTemplateSet() 获取视频轨模板详情列表。
 * @method void setVideoTrackTemplateSet(array $VideoTrackTemplateSet) 设置视频轨模板详情列表。
...
class DescribeVideoTrackTemplatesResponse extends AbstractModel
{
     ...
     * @param array $VideoTrackTemplateSet 视频轨模板详情列表。

 ...
 * @method array getPolicyIds() 获取ddos 策略组id集合
 * @method void setPolicyIds(array $PolicyIds) 设置ddos 策略组id集合
...
class DescribeDDosMajorAttackEventRequest extends AbstractModel
{
     ...
     * @param array $PolicyIds ddos 策略组id集合

 ...
 * @method boolean getIsGlobal() 获取true:全部镜像，false:指定镜像。IsGlobal=true时ImageIds返回空数组
 * @method void setIsGlobal(boolean $IsGlobal) 设置true:全部镜像，false:指定镜像。IsGlobal=true时ImageIds返回空数组
...
class AccessControlRuleInfo extends AbstractModel
{
    ...
    /**
     * @var boolean true:全部镜像，false:指定镜像。IsGlobal=true时ImageIds返回空数组
     */
    public $IsGlobal;
     ...
     * @param boolean $IsGlobal true:全部镜像，false:指定镜像。IsGlobal=true时ImageIds返回空数组

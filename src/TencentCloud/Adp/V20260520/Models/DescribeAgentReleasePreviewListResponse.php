 ...
 *
 * @method array getReleaseList() 获取<p>发布预览列表</p>
 * @method void setReleaseList(array $ReleaseList) 设置<p>发布预览列表</p>
 ...
 */
class DescribeAgentReleasePreviewListResponse extends AbstractModel
{
    /**
     * @var array <p>发布预览列表</p>
     */
    public $ReleaseList;
    ...
    /**
     * @param array $ReleaseList <p>发布预览列表</p>

 ...
 * @method string getDataRetrievalName() 获取<p>数据检索名称示例值：DataDive</p>
 * @method void setDataRetrievalName(string $DataRetrievalName) 设置<p>数据检索名称示例值：DataDive</p>
 ...
 */
class ModifyDataRetrievalRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>数据检索名称示例值：DataDive</p>
     */
     ...
     * @param string $DataRetrievalName <p>数据检索名称示例值：DataDive</p>

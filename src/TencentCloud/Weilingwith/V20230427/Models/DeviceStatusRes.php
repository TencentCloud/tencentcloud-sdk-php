 ...
 * @method array getDeviceStatusSet() 获取设备状态信息列表
 * @method void setDeviceStatusSet(array $DeviceStatusSet) 设置设备状态信息列表
 */
class DeviceStatusRes extends AbstractModel
{
    /**
     * @var integer 第几页
     */
     ...
     * @param array $DeviceStatusSet 设备状态信息列表
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("DeviceStatusSet",$param) and $param["DeviceStatusSet"] !== null) {
            ...
            foreach ($param["DeviceStatusSet"] as $key => $value){
                $obj = new DeviceStatusInfo();
                $obj->deserialize($value);
                array_push($this->DeviceStatusSet, $obj);
            }
        }
    }
}

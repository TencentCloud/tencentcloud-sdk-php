 ...
 * @method string getAudioData() 获取<p>合成音频的base64编码，默认wav格式</p>
 * @method void setAudioData(string $AudioData) 设置<p>合成音频的base64编码，默认wav格式</p>
 * @method string getAudioUrl() 获取<p>合成音频url，有效期24小时</p>
 * @method void setAudioUrl(string $AudioUrl) 设置<p>合成音频url，有效期24小时</p>
 * @method string getExtInfo() 获取<p>扩展信息，json字符串  duration: 结果音频时长，单位秒</p>
 * @method void setExtInfo(string $ExtInfo) 设置<p>扩展信息，json字符串  duration: 结果音频时长，单位秒</p>
...
class TextToSpeechResponse extends AbstractModel
{
    ...
    /**
     * @var string <p>合成音频的base64编码，默认wav格式</p>
     */
    public $AudioData;
    ...
    /**
     * @var string <p>扩展信息，json字符串  duration: 结果音频时长，单位秒</p>
     */
    public $ExtInfo;
     ...
     * @param string $AudioData <p>合成音频的base64编码，默认wav格式</p>
     * @param string $AudioUrl <p>合成音频url，有效期24小时</p>
     * @param string $ExtInfo <p>扩展信息，json字符串  duration: 结果音频时长，单位秒</p>

 ...
 * @method string getUniqueID() 获取需要监听的用户唯一标示(aid 或 uin)
 * @method void setUniqueID(string $UniqueID) 设置需要监听的用户唯一标示(aid 或 uin)
 */
class CreateOfflineLogConfigRequest extends AbstractModel
{
    ...
    /**
     * @var string 需要监听的用户唯一标示(aid 或 uin)
     */
    public $UniqueID;

    /**
     * @param string $ProjectKey 项目唯一上报 key
     * @param string $UniqueID 需要监听的用户唯一标示(aid 或 uin)
     */

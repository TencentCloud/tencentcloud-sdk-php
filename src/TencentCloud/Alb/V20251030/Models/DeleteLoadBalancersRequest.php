 ...
 *
 * @method array getLoadBalancerIds() 获取负载均衡实例 ID 列表，ID 格式为 alb- 后接 8 位字母数字。
 * @method void setLoadBalancerIds(array $LoadBalancerIds) 设置负载均衡实例 ID 列表，ID 格式为 alb- 后接 8 位字母数字。
...
{
    /**
     * @var array 负载均衡实例 ID 列表，ID 格式为 alb- 后接 8 位字母数字。
     */
...
- **false**（默认值）：发送正常请求，通过检查后返回`HTTP 2xx`状态码并直接进行操作。
    ...
    /**
     * @param array $LoadBalancerIds 负载均衡实例 ID 列表，ID 格式为 alb- 后接 8 位字母数字。

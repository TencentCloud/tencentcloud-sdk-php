 ...
 * @method AiReviewTerrorismOcrTaskInput getInput() 获取内容审核 Ocr 文字敏感任务输入。
 * @method void setInput(AiReviewTerrorismOcrTaskInput $Input) 设置内容审核 Ocr 文字敏感任务输入。
 * @method AiReviewTerrorismOcrTaskOutput getOutput() 获取内容审核 Ocr 文字敏感任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewTerrorismOcrTaskOutput $Output) 设置内容审核 Ocr 文字敏感任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiReviewTaskTerrorismOcrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewTerrorismOcrTaskInput 内容审核 Ocr 文字敏感任务输入。
     */
    public $Input;

    /**
     * @var AiReviewTerrorismOcrTaskOutput 内容审核 Ocr 文字敏感任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiReviewTerrorismOcrTaskInput $Input 内容审核 Ocr 文字敏感任务输入。
     * @param AiReviewTerrorismOcrTaskOutput $Output 内容审核 Ocr 文字敏感任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 * @method array getInstanceIdList() 获取实例列表，商品发货延迟可能返回空
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setInstanceIdList(array $InstanceIdList) 设置实例列表，商品发货延迟可能返回空
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param array $InstanceIdList 实例列表，商品发货延迟可能返回空
注意：此字段可能返回 null，表示取不到有效值。

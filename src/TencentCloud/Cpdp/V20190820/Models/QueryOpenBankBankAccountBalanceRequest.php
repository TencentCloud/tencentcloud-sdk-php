...
__WECHAT__: 微信支付
__ALIPAY__: 支付宝
 * @method string getPaymentMethod() 获取支付方式，如
__EBANK_PAYMENT__:ebank付款
__OPENBANK_PAYMENT__: openbank付款
 * @method void setPaymentMethod(string $PaymentMethod) 设置支付方式，如
__EBANK_PAYMENT__:ebank付款
__OPENBANK_PAYMENT__: openbank付款
 * @method string getBindSerialNo() 获取绑卡序列号，银行账户唯一ID，区分多卡或多账户的场景
 * @method void setBindSerialNo(string $BindSerialNo) 设置绑卡序列号，银行账户唯一ID，区分多卡或多账户的场景
...
__OPENBANK_PAYMENT__: openbank付款
    ...
    /**
     * @var string 绑卡序列号，银行账户唯一ID，区分多卡或多账户的场景
     */
    public $BindSerialNo;
...
__WECHAT__: 微信支付
__ALIPAY__: 支付宝
     * @param string $PaymentMethod 支付方式，如
__EBANK_PAYMENT__:ebank付款
__OPENBANK_PAYMENT__: openbank付款
     * @param string $BindSerialNo 绑卡序列号，银行账户唯一ID，区分多卡或多账户的场景

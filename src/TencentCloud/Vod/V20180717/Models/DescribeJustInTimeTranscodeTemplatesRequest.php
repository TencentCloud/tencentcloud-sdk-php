 ...
 *
 * @method array getNames() 获取模板名过滤条件，数组长度限制：100。
 * @method void setNames(array $Names) 设置模板名过滤条件，数组长度限制：100。
...
<li>Custom：用户自定义任务流模板。</li>
    ...
    /**
     * @param array $Names 模板名过滤条件，数组长度限制：100。

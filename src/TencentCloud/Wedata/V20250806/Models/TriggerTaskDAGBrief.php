 ...
 * 工作流任务概要信息
 *
 * @method array getTriggerTasks() 获取任务信息合集
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTriggerTasks(array $TriggerTasks) 设置任务信息合集
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getTriggerTaskLinks() 获取任务连接信息合集
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTriggerTaskLinks(array $TriggerTaskLinks) 设置任务连接信息合集
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $TriggerTasks 任务信息合集
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $TriggerTaskLinks 任务连接信息合集
注意：此字段可能返回 null，表示取不到有效值。
     */

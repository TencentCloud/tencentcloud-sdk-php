 ...
 * @method array getClusterParamList() 获取集群参数列表
 * @method void setClusterParamList(array $ClusterParamList) 设置集群参数列表
 * @method array getInstanceParamList() 获取实例参数列表
 * @method void setInstanceParamList(array $InstanceParamList) 设置实例参数列表
...
class ModifyInstanceParamRequest extends AbstractModel
{
     ...
     * @param array $ClusterParamList 集群参数列表
     * @param array $InstanceParamList 实例参数列表

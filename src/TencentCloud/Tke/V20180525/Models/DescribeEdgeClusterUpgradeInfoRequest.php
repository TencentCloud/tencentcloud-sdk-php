 ...
 * @method string getEdgeVersion() 获取要升级到的TKEEdge版本
 * @method void setEdgeVersion(string $EdgeVersion) 设置要升级到的TKEEdge版本
 */
class DescribeEdgeClusterUpgradeInfoRequest extends AbstractModel
{
    ...
    /**
     * @var string 要升级到的TKEEdge版本
     */
    public $EdgeVersion;

    /**
     * @param string $ClusterId 集群ID
     * @param string $EdgeVersion 要升级到的TKEEdge版本
     */

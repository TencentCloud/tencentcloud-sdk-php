 ...
 *
 * @method array getTrainingModelVersions() 获取模型版本列表
 * @method void setTrainingModelVersions(array $TrainingModelVersions) 设置模型版本列表
...
class DescribeTrainingModelVersionsResponse extends AbstractModel
{
    ...
    /**
     * @param array $TrainingModelVersions 模型版本列表

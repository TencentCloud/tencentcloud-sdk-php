 ...
 * @method integer getEndTime() 获取结束时间秒，EndTime-StartTime不得超过31天秒数31243600
 * @method void setEndTime(integer $EndTime) 设置结束时间秒，EndTime-StartTime不得超过31天秒数31243600
...
class DescribeYarnApplicationsRequest extends AbstractModel
{
    ...
    /**
     * @var integer 结束时间秒，EndTime-StartTime不得超过31天秒数31243600
     */
    public $EndTime;
     ...
     * @param integer $EndTime 结束时间秒，EndTime-StartTime不得超过31天秒数31243600

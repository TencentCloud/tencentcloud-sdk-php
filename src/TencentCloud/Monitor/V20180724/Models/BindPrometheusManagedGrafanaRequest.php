 ...
 * @method string getGrafanaId() 获取Grafana 可视化服务实例 ID
 * @method void setGrafanaId(string $GrafanaId) 设置Grafana 可视化服务实例 ID
 */
class BindPrometheusManagedGrafanaRequest extends AbstractModel
{
    ...
    /**
     * @var string Grafana 可视化服务实例 ID
     */
    public $GrafanaId;

    /**
     * @param string $InstanceId Prometheus 实例 ID
     * @param string $GrafanaId Grafana 可视化服务实例 ID
     */

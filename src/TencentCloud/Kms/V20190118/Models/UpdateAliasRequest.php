...
/**
 * @method string getAlias() 获取新的别名，1-64个字符或数字的组合
 * @method void setAlias(string $Alias) 设置新的别名，1-64个字符或数字的组合
...
class UpdateAliasRequest extends AbstractModel
{
    ...
    public $KeyId;
    /**
     * @param string $Alias 新的别名，1-64个字符或数字的组合

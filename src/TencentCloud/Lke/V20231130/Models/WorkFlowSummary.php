...
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getRunNodes() 获取<p>节点信息</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setRunNodes(array $RunNodes) 设置<p>节点信息</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getPendingMessages() 获取<p>中间消息</p>
 * @method void setPendingMessages(array $PendingMessages) 设置<p>中间消息</p>
 * @method OptionCardIndex getOptionCardIndex() 获取<p>选项卡索引</p>
 * @method void setOptionCardIndex(OptionCardIndex $OptionCardIndex) 设置<p>选项卡索引</p>
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $PendingMessages <p>中间消息</p>
     * @param OptionCardIndex $OptionCardIndex <p>选项卡索引</p>
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("PendingMessages",$param) and $param["PendingMessages"] !== null) {
            $this->PendingMessages = $param["PendingMessages"];
        }

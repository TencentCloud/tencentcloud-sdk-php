 ...
 * @method string getAllocateId() 获取<p>分配请求ID</p>
 * @method void setAllocateId(string $AllocateId) 设置<p>分配请求ID</p>
 */
class ReleaseEnvRequest extends AbstractModel
{
    /**
     * @var string <p>环境ID</p>
     */
    ...
    /**
     * @var string <p>分配请求ID</p>
     */
    public $AllocateId;

    /**
     * @param string $EnvId <p>环境ID</p>
     * @param string $AllocateId <p>分配请求ID</p>
     */

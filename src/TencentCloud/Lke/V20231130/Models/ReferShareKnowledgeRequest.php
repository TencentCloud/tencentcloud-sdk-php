 ...
 *
 * @method string getAppBizId() 获取应用业务id
 * @method void setAppBizId(string $AppBizId) 设置应用业务id
 * @method array getKnowledgeBizId() 获取共享知识库业务id列表
 * @method void setKnowledgeBizId(array $KnowledgeBizId) 设置共享知识库业务id列表
 ...
 */
class ReferShareKnowledgeRequest extends AbstractModel
{
    /**
     * @var string 应用业务id
     */
    ...
    /**
     * @param string $AppBizId 应用业务id
     * @param array $KnowledgeBizId 共享知识库业务id列表

 ...
 * @method ViewContractResult getResult() 获取合同明细响应对象
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(ViewContractResult $Result) 设置合同明细响应对象
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var ViewContractResult 合同明细响应对象
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param ViewContractResult $Result 合同明细响应对象
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new ViewContractResult();

...
2. 建议中国大陆地区的用户设置腾讯云镜像源：`composer config -g repos.packagist composer https://mirrors.tencent.com/composer/`，执行命令 `composer require tencentcloud/tencentcloud-sdk-php` 添加依赖。

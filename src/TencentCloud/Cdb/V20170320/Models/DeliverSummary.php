 ...
 * @method string getDeliverConsumer() 获取<p>投递者</p>
 * @method void setDeliverConsumer(string $DeliverConsumer) 设置<p>投递者</p>
 * @method string getDeliverConsumerName() 获取<p>投递者名称</p>
 * @method void setDeliverConsumerName(string $DeliverConsumerName) 设置<p>投递者名称</p>
 * @method string getDeliverError() 获取<p>投递异常错误</p>
 * @method void setDeliverError(string $DeliverError) 设置<p>投递异常错误</p>
 */
class DeliverSummary extends AbstractModel
{
    ...
    /**
     * @var string <p>投递者名称</p>
     */
    public $DeliverConsumerName;

    /**
     * @var string <p>投递异常错误</p>
     */
    public $DeliverError;
     ...
     * @param string $DeliverConsumer <p>投递者</p>
     * @param string $DeliverConsumerName <p>投递者名称</p>
     * @param string $DeliverError <p>投递异常错误</p>
     */

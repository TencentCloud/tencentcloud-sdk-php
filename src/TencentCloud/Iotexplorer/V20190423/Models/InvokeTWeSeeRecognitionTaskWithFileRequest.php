 ...
 * @method string getInputBase64() 获取视频 / 图片文件的 Base64 编码字符串
 * @method void setInputBase64(string $InputBase64) 设置视频 / 图片文件的 Base64 编码字符串
 ...
 */
class InvokeTWeSeeRecognitionTaskWithFileRequest extends AbstractModel
{
    /**
     * @var string 产品ID
     */
    ...
    /**
     * @var string 视频 / 图片文件的 Base64 编码字符串
     */
    public $InputBase64;
...
- `ObjectDetect`：目标检测
     ...
     * @param string $InputBase64 视频 / 图片文件的 Base64 编码字符串

 ...
 * @method FlexFundingAccountInfo getFundingAccountInfo() 获取资金账户信息
 * @method void setFundingAccountInfo(FlexFundingAccountInfo $FundingAccountInfo) 设置资金账户信息
...
__test__:测试环境
缺省默认为生产环境
 * @method string getNotifyUrl() 获取支付结果通知回调地址
 * @method void setNotifyUrl(string $NotifyUrl) 设置支付结果通知回调地址
 */
class ApplyFlexPaymentRequest extends AbstractModel
{
    /**
     * @var string 收款用户ID
     */
...
OCCASION:偶然所得
    ...
    /**
     * @var FlexFundingAccountInfo 资金账户信息
     */
...
OCCASION:偶然所得
     ...
     * @param FlexFundingAccountInfo $FundingAccountInfo 资金账户信息
...
__test__:测试环境
缺省默认为生产环境
     * @param string $NotifyUrl 支付结果通知回调地址
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("FundingAccountInfo",$param) and $param["FundingAccountInfo"] !== null) {
            $this->FundingAccountInfo = new FlexFundingAccountInfo();
            $this->FundingAccountInfo->deserialize($param["FundingAccountInfo"]);
        }

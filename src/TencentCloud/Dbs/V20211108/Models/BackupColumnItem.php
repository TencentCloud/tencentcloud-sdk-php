 ...
 * @method string getNewColumnName() 获取重命名后的列名。
 * @method void setNewColumnName(string $NewColumnName) 设置重命名后的列名。
 */
class BackupColumnItem extends AbstractModel
{
    /**
     * @var string 列名。
     */
     ...
     * @param string $NewColumnName 重命名后的列名。
     */

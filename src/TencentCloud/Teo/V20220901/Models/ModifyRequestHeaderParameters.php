 ...
 * 修改 HTTP 回源请求头配置参数。
 *
 * @method array getHeaderActions() 获取HTTP 头部设置规则列表。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setHeaderActions(array $HeaderActions) 设置HTTP 头部设置规则列表。
注意：此字段可能返回 null，表示取不到有效值。
 */
class ModifyRequestHeaderParameters extends AbstractModel
{
    /**
     * @var array HTTP 头部设置规则列表。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $HeaderActions;

    /**
     * @param array $HeaderActions HTTP 头部设置规则列表。
注意：此字段可能返回 null，表示取不到有效值。
     */

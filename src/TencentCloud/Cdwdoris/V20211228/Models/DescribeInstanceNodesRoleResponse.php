 ...
 *
 * @method string getErrorMsg() 获取错误码
 * @method void setErrorMsg(string $ErrorMsg) 设置错误码
 * @method integer getTotalCount() 获取节点总数
 * @method void setTotalCount(integer $TotalCount) 设置节点总数
 * @method array getNodeInfos() 获取无
 * @method void setNodeInfos(array $NodeInfos) 设置无
...
class DescribeInstanceNodesRoleResponse extends AbstractModel
{
    ...
    /**
     * @param string $ErrorMsg 错误码
     * @param integer $TotalCount 节点总数
     * @param array $NodeInfos 无

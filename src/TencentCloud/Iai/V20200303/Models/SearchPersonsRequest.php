...
- 低于34将影响搜索精度。
- 建议设置为80。
 * @method integer getMaxPersonNum() 获取单张被识别的人脸返回的最相似人员数量。
- 默认值为5，最大值为100。
- 例，设MaxFaceNum为1，MaxPersonNum为8，则返回Top8相似的人员信息。
- 值越大，需要处理的时间越长。建议不要超过10。
 * @method void setMaxPersonNum(integer $MaxPersonNum) 设置单张被识别的人脸返回的最相似人员数量。
- 默认值为5，最大值为100。
- 例，设MaxFaceNum为1，MaxPersonNum为8，则返回Top8相似的人员信息。
- 值越大，需要处理的时间越长。建议不要超过10。
...
- 建议设置为80。
    ...
    /**
     * @var integer 单张被识别的人脸返回的最相似人员数量。
- 默认值为5，最大值为100。
- 例，设MaxFaceNum为1，MaxPersonNum为8，则返回Top8相似的人员信息。
- 值越大，需要处理的时间越长。建议不要超过10。
     */
...
- 低于34将影响搜索精度。
- 建议设置为80。
     * @param integer $MaxPersonNum 单张被识别的人脸返回的最相似人员数量。
- 默认值为5，最大值为100。
- 例，设MaxFaceNum为1，MaxPersonNum为8，则返回Top8相似的人员信息。
- 值越大，需要处理的时间越长。建议不要超过10。

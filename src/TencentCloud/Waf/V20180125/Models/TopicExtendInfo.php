 ...
 * 日志主题扩展信息
 *
 * @method AnonymousInfo getAnonymousAccess() 获取日志主题免鉴权配置信息
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setAnonymousAccess(AnonymousInfo $AnonymousAccess) 设置日志主题免鉴权配置信息
注意：此字段可能返回 null，表示取不到有效值。
 */
class TopicExtendInfo extends AbstractModel
{
    /**
     * @var AnonymousInfo 日志主题免鉴权配置信息
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $AnonymousAccess;

    /**
     * @param AnonymousInfo $AnonymousAccess 日志主题免鉴权配置信息
注意：此字段可能返回 null，表示取不到有效值。
     */

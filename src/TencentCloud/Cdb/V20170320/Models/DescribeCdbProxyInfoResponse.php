 ...
 *
 * @method integer getCount() 获取代理组数量
 * @method void setCount(integer $Count) 设置代理组数量
 * @method array getProxyInfos() 获取代理组信息
 * @method void setProxyInfos(array $ProxyInfos) 设置代理组信息
...
class DescribeCdbProxyInfoResponse extends AbstractModel
{
    ...
    /**
     * @param integer $Count 代理组数量
     * @param array $ProxyInfos 代理组信息

 ...
 *
 * @method boolean getExist() 获取true 是 false 否
 * @method void setExist(boolean $Exist) 设置true 是 false 否
...
class DescribeRecordExistExceptDefaultNSResponse extends AbstractModel
{
    ...
    /**
     * @param boolean $Exist true 是 false 否

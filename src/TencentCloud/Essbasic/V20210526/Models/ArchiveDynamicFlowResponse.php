 ...
 * @method array getApprovers() 获取动态签署人的参与人信息
 * @method void setApprovers(array $Approvers) 设置动态签署人的参与人信息
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class ArchiveDynamicFlowResponse extends AbstractModel
{
    /**
     * @var string 合同流程ID
     */
     ...
     * @param array $Approvers 动态签署人的参与人信息
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Approvers",$param) and $param["Approvers"] !== null) {
            ...
            foreach ($param["Approvers"] as $key => $value){
                $obj = new ChannelArchiveDynamicApproverData();

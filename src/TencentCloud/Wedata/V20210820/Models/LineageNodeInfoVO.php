 ...
 * LineageNodeInfoVo
 *
 * @method LineageResouce getCurrentResource() 获取当前资源
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setCurrentResource(LineageResouce $CurrentResource) 设置当前资源
注意：此字段可能返回 null，表示取不到有效值。
 * @method LineageRelationVO getRelation() 获取关系
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setRelation(LineageRelationVO $Relation) 设置关系
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 */
class LineageNodeInfoVO extends AbstractModel
{
    /**
     * @var LineageResouce 当前资源
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $CurrentResource;

    /**
     * @var LineageRelationVO 关系
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Relation;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param LineageResouce $CurrentResource 当前资源
注意：此字段可能返回 null，表示取不到有效值。
     * @param LineageRelationVO $Relation 关系
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Relation",$param) and $param["Relation"] !== null) {
            $this->Relation = new LineageRelationVO();

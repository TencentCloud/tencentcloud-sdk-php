...
注意：此字段可能返回 null，表示取不到有效值。
 * @method boolean getSensitive() 获取<p>是否脱敏</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setSensitive(boolean $Sensitive) 设置<p>是否脱敏</p>
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param boolean $Sensitive <p>是否脱敏</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Sensitive",$param) and $param["Sensitive"] !== null) {
            $this->Sensitive = $param["Sensitive"];
        }
    }
}

 ...
 *
 * @method array getAsyncSearchTasks() 获取异步检索任务列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setAsyncSearchTasks(array $AsyncSearchTasks) 设置异步检索任务列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getTotalCount() 获取异步检索任务的总数
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTotalCount(integer $TotalCount) 设置异步检索任务的总数
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $AsyncSearchTasks 异步检索任务列表
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $TotalCount 异步检索任务的总数
注意：此字段可能返回 null，表示取不到有效值。

 ...
 * @method AiReviewPornAsrTaskInput getInput() 获取音视频审核 Asr 文字涉及令人反感的信息的任务输入。
 * @method void setInput(AiReviewPornAsrTaskInput $Input) 设置音视频审核 Asr 文字涉及令人反感的信息的任务输入。
 * @method AiReviewPornAsrTaskOutput getOutput() 获取音视频审核 Asr 文字涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewPornAsrTaskOutput $Output) 设置音视频审核 Asr 文字涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getProgress() 获取音视频审核 Asr 文字涉及令人反感的信息的任务进度，取值范围 [0-100] 。
 * @method void setProgress(integer $Progress) 设置音视频审核 Asr 文字涉及令人反感的信息的任务进度，取值范围 [0-100] 。
 */
class AiReviewTaskPornAsrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPornAsrTaskInput 音视频审核 Asr 文字涉及令人反感的信息的任务输入。
     */
    public $Input;

    /**
     * @var AiReviewPornAsrTaskOutput 音视频审核 Asr 文字涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;

    /**
     * @var integer 音视频审核 Asr 文字涉及令人反感的信息的任务进度，取值范围 [0-100] 。
     */
    public $Progress;
     ...
     * @param AiReviewPornAsrTaskInput $Input 音视频审核 Asr 文字涉及令人反感的信息的任务输入。
     * @param AiReviewPornAsrTaskOutput $Output 音视频审核 Asr 文字涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $Progress 音视频审核 Asr 文字涉及令人反感的信息的任务进度，取值范围 [0-100] 。
     */

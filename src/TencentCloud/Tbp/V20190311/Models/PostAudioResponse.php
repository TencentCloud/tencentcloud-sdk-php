...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getResponseText() 获取机器人应答文本
 * @method void setResponseText(string $ResponseText) 设置机器人应答文本
...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getWaveData() 获取tts合成pcm音频
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setWaveData(string $WaveData) 设置tts合成pcm音频
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $ResponseText 机器人应答文本
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $WaveData tts合成pcm音频
注意：此字段可能返回 null，表示取不到有效值。

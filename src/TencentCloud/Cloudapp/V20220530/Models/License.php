 ...
 * @method string getLicenseMode() 获取软件授权模式。
 ...
 * @method void setLicenseMode(string $LicenseMode) 设置软件授权模式。
 ...
 * @method string getLicenseStatus() 获取软件的授权状态。
 ...
 * @method void setLicenseStatus(string $LicenseStatus) 设置软件的授权状态。
 ...
 * @method integer getBillingMode() 获取被授权的软件的计费模式。
 ...
 * @method void setBillingMode(integer $BillingMode) 设置被授权的软件的计费模式。
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param string $LicenseMode 软件授权模式。
...
<td>订阅授权。授权如果过了有效期，则会进入过期状态。</td>
     ...
     * @param string $LicenseStatus 软件的授权状态。
...
<td>授权已失效。用户如果退货软件，则授权会自动失效。</td>
     ...
     * @param integer $BillingMode 被授权的软件的计费模式。

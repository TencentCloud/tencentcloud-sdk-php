 ...
 *
 * @method array getUsages() 获取指定区间指定产品的用量汇总
 * @method void setUsages(array $Usages) 设置指定区间指定产品的用量汇总
...
class DescribeTIWDailyUsageResponse extends AbstractModel
{
    ...
    /**
     * @param array $Usages 指定区间指定产品的用量汇总

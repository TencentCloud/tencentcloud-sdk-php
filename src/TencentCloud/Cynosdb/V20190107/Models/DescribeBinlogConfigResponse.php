 ...
 *
 * @method string getBinlogCrossRegionsConfigUpdateTime() 获取Binlog跨地域配置更新时间
 * @method void setBinlogCrossRegionsConfigUpdateTime(string $BinlogCrossRegionsConfigUpdateTime) 设置Binlog跨地域配置更新时间
 * @method BinlogConfigInfo getBinlogConfig() 获取Binlog配置信息
 * @method void setBinlogConfig(BinlogConfigInfo $BinlogConfig) 设置Binlog配置信息
...
{
    /**
     * @var string Binlog跨地域配置更新时间
     */
    public $BinlogCrossRegionsConfigUpdateTime;

    /**
     * @var BinlogConfigInfo Binlog配置信息
     */
    public $BinlogConfig;
    ...
    /**
     * @param string $BinlogCrossRegionsConfigUpdateTime Binlog跨地域配置更新时间
     * @param BinlogConfigInfo $BinlogConfig Binlog配置信息

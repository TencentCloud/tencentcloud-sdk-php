 ...
 * @method string getRegion() 获取资产所属地域
 * @method void setRegion(string $Region) 设置资产所属地域
 ...
 * @method array getApproverSteps() 获取审批步骤
 * @method void setApproverSteps(array $ApproverSteps) 设置审批步骤
 ...
 * @method string getCreateTime() 获取申请单创建时间。
 * @method void setCreateTime(string $CreateTime) 设置申请单创建时间。
 */
class DspmApplyOrder extends AbstractModel
{
     ...
     * @param array $ApproverSteps 审批步骤
     ...
     * @param string $CreateTime 申请单创建时间。
     */

 ...
 * @method string getOperator() 获取<p>操作类型</p>
 * @method void setOperator(string $Operator) 设置<p>操作类型</p>
 */
class AIGWKVMatch extends AbstractModel
{
    /**
     * @var string <p>键</p>
     */
     ...
     * @param string $Operator <p>操作类型</p>
     */

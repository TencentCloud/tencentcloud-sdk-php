 ...
 * @method string getBy() 获取可选排序列: [HostCount]
 * @method void setBy(string $By) 设置可选排序列: [HostCount]
 */
class DescribeBaselineRuleIgnoreListRequest extends AbstractModel
{
    /**
...
<li>ItemId- int - 是否必填：否 - 检测项Id</li>
     ...
     * @param string $By 可选排序列: [HostCount]
     */

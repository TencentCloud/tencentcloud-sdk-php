 ...
 *
 * @method array getWhiteboardPushTaskSet() 获取推流任务搜索结果集合
 * @method void setWhiteboardPushTaskSet(array $WhiteboardPushTaskSet) 设置推流任务搜索结果集合
 * @method integer getTotalCount() 获取推流总任务数
 * @method void setTotalCount(integer $TotalCount) 设置推流总任务数
...
class DescribeWhiteboardPushSearchResponse extends AbstractModel
{
    ...
    /**
     * @param array $WhiteboardPushTaskSet 推流任务搜索结果集合
     * @param integer $TotalCount 推流总任务数

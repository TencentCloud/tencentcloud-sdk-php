 ...
 * @method string getExceptionFilter() 获取异常过滤正则规则，逗号分隔
 * @method void setExceptionFilter(string $ExceptionFilter) 设置异常过滤正则规则，逗号分隔
 * @method string getUrlConvergence() 获取URL收敛正则规则，逗号分隔
 * @method void setUrlConvergence(string $UrlConvergence) 设置URL收敛正则规则，逗号分隔
 * @method string getErrorCodeFilter() 获取错误码过滤，逗号分隔
 * @method void setErrorCodeFilter(string $ErrorCodeFilter) 设置错误码过滤，逗号分隔
 * @method string getUrlExclude() 获取URL排除正则规则，逗号分隔
 * @method void setUrlExclude(string $UrlExclude) 设置URL排除正则规则，逗号分隔
 * @method integer getIsRelatedLog() 获取日志开关 0 关 1 开
 * @method void setIsRelatedLog(integer $IsRelatedLog) 设置日志开关 0 关 1 开
 ...
 * @method string getLogSource() 获取日志来源 CLS | ES
 * @method void setLogSource(string $LogSource) 设置日志来源 CLS | ES
 * @method string getIgnoreOperationName() 获取需过滤的接口
 * @method void setIgnoreOperationName(string $IgnoreOperationName) 设置需过滤的接口
 ...
 * @method boolean getEventEnable() 获取是否开启应用诊断的开关
 * @method void setEventEnable(boolean $EventEnable) 设置是否开启应用诊断的开关
 ...
 * @method boolean getEnableSecurityConfig() 获取是否开启应用安全配置
 * @method void setEnableSecurityConfig(boolean $EnableSecurityConfig) 设置是否开启应用安全配置
 ...
 * @method integer getIsRemoteCommandExecutionAnalysis() 获取是否开启远程命令检测
 * @method void setIsRemoteCommandExecutionAnalysis(integer $IsRemoteCommandExecutionAnalysis) 设置是否开启远程命令检测
 ...
 * @method boolean getUrlAutoConvergenceEnable() 获取接口自动收敛开关,0 关 | 1 开
 * @method void setUrlAutoConvergenceEnable(boolean $UrlAutoConvergenceEnable) 设置接口自动收敛开关,0 关 | 1 开
...
class ModifyApmApplicationConfigRequest extends AbstractModel
{
    ...
    /**
     * @var string 异常过滤正则规则，逗号分隔
     */
    public $ExceptionFilter;

    /**
     * @var string URL收敛正则规则，逗号分隔
     */
    public $UrlConvergence;

    /**
     * @var string 错误码过滤，逗号分隔
     */
    public $ErrorCodeFilter;

    /**
     * @var string URL排除正则规则，逗号分隔
     */
    public $UrlExclude;

    /**
     * @var integer 日志开关 0 关 1 开
     */
    public $IsRelatedLog;
     ...
     * @param string $ExceptionFilter 异常过滤正则规则，逗号分隔
     * @param string $UrlConvergence URL收敛正则规则，逗号分隔
     * @param string $ErrorCodeFilter 错误码过滤，逗号分隔
     * @param string $UrlExclude URL排除正则规则，逗号分隔
     * @param integer $IsRelatedLog 日志开关 0 关 1 开
     * @param string $LogRegion 日志地域
     * @param string $LogTopicID 日志主题ID
     * @param string $LogSet CLS 日志集 | ES 集群ID
     * @param string $LogSource 日志来源 CLS | ES
     * @param string $IgnoreOperationName 需过滤的接口
     ...
     * @param boolean $EventEnable 是否开启应用诊断的开关
     ...
     * @param boolean $UrlAutoConvergenceEnable 接口自动收敛开关,0 关 | 1 开

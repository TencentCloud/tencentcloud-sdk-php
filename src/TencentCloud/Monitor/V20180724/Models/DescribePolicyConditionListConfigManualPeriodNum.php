 ...
 *
 * @method integer getDefault() 获取<p>默认周期数</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setDefault(integer $Default) 设置<p>默认周期数</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getKeys() 获取<p>可选周期数</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setKeys(array $Keys) 设置<p>可选周期数</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param integer $Default <p>默认周期数</p>
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $Keys <p>可选周期数</p>
注意：此字段可能返回 null，表示取不到有效值。

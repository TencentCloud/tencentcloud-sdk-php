 ...
 * @method string getAssetStatus() 获取<p>资产运行状态</p>
 * @method void setAssetStatus(string $AssetStatus) 设置<p>资产运行状态</p>
 * @method integer getPublicExpose() 获取<p>是否公网暴露</p>
 * @method void setPublicExpose(integer $PublicExpose) 设置<p>是否公网暴露</p>
...
class AssetItem extends AbstractModel
{
    ...
    /**
     * @var string <p>资产运行状态</p>
     */
    public $AssetStatus;

    /**
     * @var integer <p>是否公网暴露</p>
     */
    public $PublicExpose;
     ...
     * @param string $AssetStatus <p>资产运行状态</p>
     * @param integer $PublicExpose <p>是否公网暴露</p>

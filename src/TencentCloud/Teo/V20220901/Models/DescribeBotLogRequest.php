 ...
 * @method array getQueryCondition() 获取筛选条件，当前key的可选条件有：
...
<li>uri：统一资源标识符 。</li>
 * @method void setQueryCondition(array $QueryCondition) 设置筛选条件，当前key的可选条件有：
<li>action：执行动作（处置方式）；</li>
<li>sipCountryCode：ip所在国家；</li>
<li>attackIp：攻击ip；</li>
<li>ruleId：规则id；</li>
...
<li>mainland：中国大陆地区数据。</li>不填将根据用户所在地智能选择地区。
     ...
     * @param array $QueryCondition 筛选条件，当前key的可选条件有：
<li>action：执行动作（处置方式）；</li>
<li>sipCountryCode：ip所在国家；</li>
<li>attackIp：攻击ip；</li>
<li>ruleId：规则id；</li>

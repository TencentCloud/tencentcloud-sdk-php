 ...
 *
 * @method array getClientUploadAccelerationUsageDataSet() 获取客户端上传加速统计数据。
 * @method void setClientUploadAccelerationUsageDataSet(array $ClientUploadAccelerationUsageDataSet) 设置客户端上传加速统计数据。
...
class DescribeClientUploadAccelerationUsageDataResponse extends AbstractModel
{
    ...
    /**
     * @param array $ClientUploadAccelerationUsageDataSet 客户端上传加速统计数据。

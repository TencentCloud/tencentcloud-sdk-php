 ...
 * @method Models\CreateLiveAvatarScriptResponse CreateLiveAvatarScript(Models\CreateLiveAvatarScriptRequest $req) 调用该接口，用于创建数字人直播间话术。
 ...
 * @method Models\DescribeLiveAvatarScriptsResponse DescribeLiveAvatarScripts(Models\DescribeLiveAvatarScriptsRequest $req) 调用该接口，查询数字人直播间话术信息列表。
 ...
 * @method Models\ModifyLiveAvatarRoomResponse ModifyLiveAvatarRoom(Models\ModifyLiveAvatarRoomRequest $req) 调用该接口，用于修改数字人直播间。
 ...
 * @method Models\StartLiveAvatarRoomResponse StartLiveAvatarRoom(Models\StartLiveAvatarRoomRequest $req) 调用该接口，用于启动数字人直播间。

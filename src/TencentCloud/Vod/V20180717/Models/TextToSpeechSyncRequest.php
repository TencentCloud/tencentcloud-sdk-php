 ...
 * @method TextToSpeechSyncOutputOption getOutput() 获取<p>输出相关参数</p><p>可以指定输出形式等。默认输出音频URL。</p>
 * @method void setOutput(TextToSpeechSyncOutputOption $Output) 设置<p>输出相关参数</p><p>可以指定输出形式等。默认输出音频URL。</p>
...
class TextToSpeechSyncRequest extends AbstractModel
{
    ...
    /**
     * @var TextToSpeechSyncOutputOption <p>输出相关参数</p><p>可以指定输出形式等。默认输出音频URL。</p>
     */
    public $Output;
     ...
     * @param TextToSpeechSyncOutputOption $Output <p>输出相关参数</p><p>可以指定输出形式等。默认输出音频URL。</p>

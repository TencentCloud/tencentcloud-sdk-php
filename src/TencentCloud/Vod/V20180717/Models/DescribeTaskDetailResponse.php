 ...
 * @method AigcVideoRedrawTask getAigcVideoRedrawTask() 获取<p>AIGC 视频转绘信息，仅当 TaskType 为AigcVideoRedrawTask，该字段有值。</p>
 * @method void setAigcVideoRedrawTask(AigcVideoRedrawTask $AigcVideoRedrawTask) 设置<p>AIGC 视频转绘信息，仅当 TaskType 为AigcVideoRedrawTask，该字段有值。</p>
 * @method AigcAudioTask getAigcAudioTask() 获取<p>AIGC音效信息，仅当TaskType为AigcAudioTask时，该字段有值。</p>
 * @method void setAigcAudioTask(AigcAudioTask $AigcAudioTask) 设置<p>AIGC音效信息，仅当TaskType为AigcAudioTask时，该字段有值。</p>
 * @method CreateAigcAudioCloneTask getCreateAigcAudioCloneTask() 获取<p>AIGC 声音复刻信息，仅当 TaskType 为CreateAigcAudioClone，该字段有值。</p>
 * @method void setCreateAigcAudioCloneTask(CreateAigcAudioCloneTask $CreateAigcAudioCloneTask) 设置<p>AIGC 声音复刻信息，仅当 TaskType 为CreateAigcAudioClone，该字段有值。</p>
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var AigcVideoRedrawTask <p>AIGC 视频转绘信息，仅当 TaskType 为AigcVideoRedrawTask，该字段有值。</p>
     */
    public $AigcVideoRedrawTask;

    /**
     * @var AigcAudioTask <p>AIGC音效信息，仅当TaskType为AigcAudioTask时，该字段有值。</p>
     */
    public $AigcAudioTask;

    /**
     * @var CreateAigcAudioCloneTask <p>AIGC 声音复刻信息，仅当 TaskType 为CreateAigcAudioClone，该字段有值。</p>
     */
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param AigcVideoRedrawTask $AigcVideoRedrawTask <p>AIGC 视频转绘信息，仅当 TaskType 为AigcVideoRedrawTask，该字段有值。</p>
     * @param AigcAudioTask $AigcAudioTask <p>AIGC音效信息，仅当TaskType为AigcAudioTask时，该字段有值。</p>
     * @param CreateAigcAudioCloneTask $CreateAigcAudioCloneTask <p>AIGC 声音复刻信息，仅当 TaskType 为CreateAigcAudioClone，该字段有值。</p>

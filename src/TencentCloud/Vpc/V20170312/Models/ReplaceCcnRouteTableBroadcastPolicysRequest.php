 ...
 * @method array getPolicys() 获取新的路由传播策略
 * @method void setPolicys(array $Policys) 设置新的路由传播策略
 */
class ReplaceCcnRouteTableBroadcastPolicysRequest extends AbstractModel
{
    /**
     * @var string 云联网ID
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Policys",$param) and $param["Policys"] !== null) {
            ...
            foreach ($param["Policys"] as $key => $value){
                $obj = new CcnRouteTableBroadcastPolicy();

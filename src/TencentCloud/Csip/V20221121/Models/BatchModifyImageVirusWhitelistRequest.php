 ...
 *
 * @method array getRuleId() 获取<p>木马白名单id</p>
 * @method void setRuleId(array $RuleId) 设置<p>木马白名单id</p>
 ...
 */
class BatchModifyImageVirusWhitelistRequest extends AbstractModel
{
    /**
     * @var array <p>木马白名单id</p>
     */
    public $RuleId;
    ...
    /**
     * @param array $RuleId <p>木马白名单id</p>

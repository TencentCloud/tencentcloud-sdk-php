 ...
 * @method WaterPrintConfig getWaterPrintConfig() 获取水印防护配置
 * @method void setWaterPrintConfig(WaterPrintConfig $WaterPrintConfig) 设置水印防护配置
 */
class CreateWaterPrintConfigRequest extends AbstractModel
{
    ...
    /**
     * @var WaterPrintConfig 水印防护配置
     */
    public $WaterPrintConfig;

    /**
     * @param string $InstanceId 资源实例ID
     * @param WaterPrintConfig $WaterPrintConfig 水印防护配置
     */

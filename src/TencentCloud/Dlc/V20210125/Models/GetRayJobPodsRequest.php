 ...
 * @method array getFilters() 获取过滤条件（列表名称）
 * @method void setFilters(array $Filters) 设置过滤条件（列表名称）
 * @method array getSortFields() 获取排序字段列表
 * @method void setSortFields(array $SortFields) 设置排序字段列表
 */
class GetRayJobPodsRequest extends AbstractModel
{
    /**
     * @var string 任务ID
     */

 ...
 *
 * @method array getEvents() 获取<p>人员关联的云存事件列表</p>
 ...
 */
class DescribeCloudStorageEventsByTWeSeePersonResponse extends AbstractModel
{
    /**
     * @var array <p>人员关联的云存事件列表</p>
     */
    public $Events;

    /**
     * @var integer <p>人员关联的云存事件总数</p>
     */
    public $Total;
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Events",$param) and $param["Events"] !== null) {
            ...
            foreach ($param["Events"] as $key => $value){
                $obj = new CloudStorageEventWithAITasks();

 ...
 * @method string getToolVersion() 获取<p>tool版本id</p>
 * @method void setToolVersion(string $ToolVersion) 设置<p>tool版本id</p>
 */
class DescribeCloudNativeAPIGatewayMCPToolVersionRequest extends AbstractModel
{
    /**
     ...
     * @param string $ToolVersion <p>tool版本id</p>
     */

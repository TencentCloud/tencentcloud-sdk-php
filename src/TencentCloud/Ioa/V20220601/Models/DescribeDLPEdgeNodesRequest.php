 ...
 * @method Condition getCondition() 获取过滤条件、分页参数<li>EdgeNodeName - string - 是否必填：否 - 操作符: ilike  - 排序支持：否- 按节点名称过滤。</li>
 * @method void setCondition(Condition $Condition) 设置过滤条件、分页参数<li>EdgeNodeName - string - 是否必填：否 - 操作符: ilike  - 排序支持：否- 按节点名称过滤。</li>
 */
class DescribeDLPEdgeNodesRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var Condition 过滤条件、分页参数<li>EdgeNodeName - string - 是否必填：否 - 操作符: ilike  - 排序支持：否- 按节点名称过滤。</li>
     */
    public $Condition;
     ...
     * @param Condition $Condition 过滤条件、分页参数<li>EdgeNodeName - string - 是否必填：否 - 操作符: ilike  - 排序支持：否- 按节点名称过滤。</li>
     */

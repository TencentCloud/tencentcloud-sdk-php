...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("BatchInstances",$param) and $param["BatchInstances"] !== null) {
            $this->BatchInstances = [];
            foreach ($param["BatchInstances"] as $key => $value){
                $obj = new BatchTaskInstance();
                $obj->deserialize($value);
                array_push($this->BatchInstances, $obj);
            }
        }

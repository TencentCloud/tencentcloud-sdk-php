...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getMsg() 获取<p>&quot;success&quot;</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setMsg(string $Msg) 设置<p>&quot;success&quot;</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method ApiKeyAuthApplyVO getData() 获取<p>数据</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setData(ApiKeyAuthApplyVO $Data) 设置<p>数据</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeAuthApiKeyInfoResponse extends AbstractModel
{
    /**
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var string <p>&quot;success&quot;</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Msg;

    /**
     * @var ApiKeyAuthApplyVO <p>数据</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Data;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $Msg <p>&quot;success&quot;</p>
注意：此字段可能返回 null，表示取不到有效值。
     * @param ApiKeyAuthApplyVO $Data <p>数据</p>
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Data",$param) and $param["Data"] !== null) {
            $this->Data = new ApiKeyAuthApplyVO();

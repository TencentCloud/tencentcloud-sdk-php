 ...
 *
 * @method array getCcnAttachedInstanceSet() 获取云联网关联的实例列表。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setCcnAttachedInstanceSet(array $CcnAttachedInstanceSet) 设置云联网关联的实例列表。
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $CcnAttachedInstanceSet 云联网关联的实例列表。
注意：此字段可能返回 null，表示取不到有效值。

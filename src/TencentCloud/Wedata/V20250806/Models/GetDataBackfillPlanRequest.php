 ...
 * @method string getTimeZone() 获取展示时区，默认UTC+8
 * @method void setTimeZone(string $TimeZone) 设置展示时区，默认UTC+8
 */
class GetDataBackfillPlanRequest extends AbstractModel
{
     ...
     * @param string $TimeZone 展示时区，默认UTC+8
     */

...
/**
 * @method string getType() 获取视频处理对象的类型，现在仅支持 COS。
 * @method void setType(string $Type) 设置视频处理对象的类型，现在仅支持 COS。
...
{
    /**
     * @var string 视频处理对象的类型，现在仅支持 COS。
     */
    public $Type;
    ...
    public $CosInputInfo;
    /**
     * @param string $Type 视频处理对象的类型，现在仅支持 COS。

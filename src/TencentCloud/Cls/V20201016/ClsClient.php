 ...
 * @method Models\CreateCloudProductLogTaskResponse CreateCloudProductLogTask(Models\CreateCloudProductLogTaskRequest $req) 内部云产品接入使用相关接口
 ...
 * @method Models\DeleteCloudProductLogTaskResponse DeleteCloudProductLogTask(Models\DeleteCloudProductLogTaskRequest $req) 内部云产品接入使用相关接口
 ...
 * @method Models\ModifyCloudProductLogTaskResponse ModifyCloudProductLogTask(Models\ModifyCloudProductLogTaskRequest $req) 内部云产品接入使用相关接口

 ...
 * @method AiReviewProhibitedOcrTaskInput getInput() 获取智能识别 Ocr 文字鉴违禁任务输入。
 * @method void setInput(AiReviewProhibitedOcrTaskInput $Input) 设置智能识别 Ocr 文字鉴违禁任务输入。
 * @method AiReviewProhibitedOcrTaskOutput getOutput() 获取智能识别 Ocr 文字鉴违禁任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewProhibitedOcrTaskOutput $Output) 设置智能识别 Ocr 文字鉴违禁任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiReviewTaskProhibitedOcrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewProhibitedOcrTaskInput 智能识别 Ocr 文字鉴违禁任务输入。
     */
    public $Input;

    /**
     * @var AiReviewProhibitedOcrTaskOutput 智能识别 Ocr 文字鉴违禁任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiReviewProhibitedOcrTaskInput $Input 智能识别 Ocr 文字鉴违禁任务输入。
     * @param AiReviewProhibitedOcrTaskOutput $Output 智能识别 Ocr 文字鉴违禁任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 *
 * @method string getProjectId() 获取ProjectId 值
 * @method void setProjectId(string $ProjectId) 设置ProjectId 值
...
class DescribeRuleExecStatRequest extends AbstractModel
{
    ...
    /**
     * @param string $ProjectId ProjectId 值

 ...
 * 镜像仓库扫描子任务信息
 *
 * @method integer getSubTaskId() 获取<p>任务子id</p>
 * @method void setSubTaskId(integer $SubTaskId) 设置<p>任务子id</p>
 ...
 * @method string getScanStatus() 获取<p>任务状态</p><p>枚举值：</p><ul><li>FINISHED： 扫描完成</li><li>SCANNING： 扫描中</li><li>CANCELLED： 已取消</li><li>SCAN_EXCEPTION： 扫描异常</li></ul>
 * @method void setScanStatus(string $ScanStatus) 设置<p>任务状态</p><p>枚举值：</p><ul><li>FINISHED： 扫描完成</li><li>SCANNING： 扫描中</li><li>CANCELLED： 已取消</li><li>SCAN_EXCEPTION： 扫描异常</li></ul>
 * @method string getFailedReason() 获取<p>失败原因</p>
 * @method void setFailedReason(string $FailedReason) 设置<p>失败原因</p>
...
class ImageRegistryScanSubTaskInfo extends AbstractModel
{
    ...
    /**
     * @var string <p>任务状态</p><p>枚举值：</p><ul><li>FINISHED： 扫描完成</li><li>SCANNING： 扫描中</li><li>CANCELLED： 已取消</li><li>SCAN_EXCEPTION： 扫描异常</li></ul>
     */
    public $ScanStatus;
    ...
    /**
     * @param integer $SubTaskId <p>任务子id</p>
     * @param string $ImageId <p>镜像id</p>
     * @param string $ImageName <p>镜像名</p>
     * @param string $ImageTag <p>镜像tag</p>
     * @param string $ScanStatus <p>任务状态</p><p>枚举值：</p><ul><li>FINISHED： 扫描完成</li><li>SCANNING： 扫描中</li><li>CANCELLED： 已取消</li><li>SCAN_EXCEPTION： 扫描异常</li></ul>
     * @param string $FailedReason <p>失败原因</p>

 ...
 * @method string getSearchScope() 获取要查询的搜索范围
 * @method void setSearchScope(string $SearchScope) 设置要查询的搜索范围
 ...
 * @method string getStatus() 获取开发态/生产态
 * @method void setStatus(string $Status) 设置开发态/生产态
 ...
 * @method array getFolderPaths() 获取文件夹路径
 * @method void setFolderPaths(array $FolderPaths) 设置文件夹路径
 * @method array getTaskStatus() 获取任务状态
 * @method void setTaskStatus(array $TaskStatus) 设置任务状态
 */
class DescribeCodeSearchInfoV2Request extends AbstractModel
{
    /**
     * @var string 搜索关键词
     */
     ...
     * @param string $SearchScope 要查询的搜索范围
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("SearchScope",$param) and $param["SearchScope"] !== null) {
            $this->SearchScope = $param["SearchScope"];
        }
        ...
        if (array_key_exists("FolderPaths",$param) and $param["FolderPaths"] !== null) {
            $this->FolderPaths = $param["FolderPaths"];
        }

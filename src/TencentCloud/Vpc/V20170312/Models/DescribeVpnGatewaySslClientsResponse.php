...
class DescribeVpnGatewaySslClientsResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("SslVpnClientSet",$param) and $param["SslVpnClientSet"] !== null) {
            $this->SslVpnClientSet = [];
            foreach ($param["SslVpnClientSet"] as $key => $value){
                $obj = new SslVpnClient();
                $obj->deserialize($value);
                array_push($this->SslVpnClientSet, $obj);
            }
        }

...
<li> hosting：SSL托管证书；</li>
<li> apply：申请免费证书。</li>
 * @method array getCertId() 获取选择托管证书时需填入相应证书 ID。
 * @method void setCertId(array $CertId) 设置选择托管证书时需填入相应证书 ID。
 */
...
<li> hosting：SSL托管证书；</li>
<li> apply：申请免费证书。</li>
     * @param array $CertId 选择托管证书时需填入相应证书 ID。
     */

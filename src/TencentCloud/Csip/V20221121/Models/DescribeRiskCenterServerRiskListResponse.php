 ...
 * @method array getData() 获取风险服务列表
 * @method void setData(array $Data) 设置风险服务列表
 * @method array getInstanceTypeLists() 获取资产类型枚举
 * @method void setInstanceTypeLists(array $InstanceTypeLists) 设置资产类型枚举
...
class DescribeRiskCenterServerRiskListResponse extends AbstractModel
{
     ...
     * @param array $Data 风险服务列表
     * @param array $InstanceTypeLists 资产类型枚举

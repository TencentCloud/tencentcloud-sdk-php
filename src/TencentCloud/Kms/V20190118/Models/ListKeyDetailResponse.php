 ...
 * @method array getKeyMetadatas() 获取返回的属性信息列表，此字段可能返回 null，表示取不到有效值。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setKeyMetadatas(array $KeyMetadatas) 设置返回的属性信息列表，此字段可能返回 null，表示取不到有效值。
注意：此字段可能返回 null，表示取不到有效值。
...
class ListKeyDetailResponse extends AbstractModel
{
    ...
    /**
     * @var array 返回的属性信息列表，此字段可能返回 null，表示取不到有效值。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $KeyMetadatas;
     ...
     * @param array $KeyMetadatas 返回的属性信息列表，此字段可能返回 null，表示取不到有效值。
注意：此字段可能返回 null，表示取不到有效值。

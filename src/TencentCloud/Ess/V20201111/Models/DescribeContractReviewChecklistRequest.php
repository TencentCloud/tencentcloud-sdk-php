 ...
 * @method string getChecklistId() 获取<p>需要获取的合同风险审查清单ID</p>
 * @method void setChecklistId(string $ChecklistId) 设置<p>需要获取的合同风险审查清单ID</p>
 ...
 */
class DescribeContractReviewChecklistRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>需要获取的合同风险审查清单ID</p>
     */
    public $ChecklistId;
     ...
     * @param string $ChecklistId <p>需要获取的合同风险审查清单ID</p>

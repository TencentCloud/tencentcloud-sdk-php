 ...
 * @method array getStrategyList() 获取云原生API网关实例策略列表。
 * @method void setStrategyList(array $StrategyList) 设置云原生API网关实例策略列表。
 */
class ListCloudNativeAPIGatewayStrategyResult extends AbstractModel
{
    ...
    /**
     * @var array 云原生API网关实例策略列表。
     */
    public $StrategyList;

    /**
     * @param integer $TotalCount 总数。
     * @param array $StrategyList 云原生API网关实例策略列表。
     */

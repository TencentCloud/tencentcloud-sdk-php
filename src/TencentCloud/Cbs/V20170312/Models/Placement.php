 ...
 * @method string getCageId() 获取围笼Id，可通过 [DescribeDiskStoragePool](https://cloud.tencent.com/document/api/362/62143) 获取。作为入参时，表示对指定的CageId的资源进行操作，可为空。 作为出参时，表示资源所属围笼ID，可为空。
...
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getProjectId() 获取实例所属项目ID，可通过[DescribeProject](/document/api/651/78725)获取。不填默认为0，表示默认项目。
 * @method void setProjectId(integer $ProjectId) 设置实例所属项目ID，可通过[DescribeProject](/document/api/651/78725)获取。不填默认为0，表示默认项目。
...
class Placement extends AbstractModel
{
    ...
    /**
     * @var string 围笼Id，可通过 [DescribeDiskStoragePool](https://cloud.tencent.com/document/api/362/62143) 获取。作为入参时，表示对指定的CageId的资源进行操作，可为空。 作为出参时，表示资源所属围笼ID，可为空。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $CageId;

    /**
     * @var integer 实例所属项目ID，可通过[DescribeProject](/document/api/651/78725)获取。不填默认为0，表示默认项目。
     */
    public $ProjectId;

    /**
     * @var string 实例所属项目名称，可通过[DescribeProject](/document/api/651/78725)获取。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $ProjectName;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $ProjectId 实例所属项目ID，可通过[DescribeProject](/document/api/651/78725)获取。不填默认为0，表示默认项目。

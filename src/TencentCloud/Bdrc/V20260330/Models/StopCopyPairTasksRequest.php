 ...
 * @method string getCopyPairType() 获取复制对类型（DISK/INSTANCE/CFS）
 * @method void setCopyPairType(string $CopyPairType) 设置复制对类型（DISK/INSTANCE/CFS）
 */
class StopCopyPairTasksRequest extends AbstractModel
{
    /**
     * @var array 复制对ID列表
     */
    ...
    /**
     * @var string 复制对类型（DISK/INSTANCE/CFS）
     */
    public $CopyPairType;

    /**
     * @param array $CopyPairIds 复制对ID列表
     * @param string $CopyPairType 复制对类型（DISK/INSTANCE/CFS）
     */

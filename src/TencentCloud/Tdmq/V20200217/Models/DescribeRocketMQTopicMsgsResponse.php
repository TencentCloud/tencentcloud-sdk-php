 ...
 * @method array getTopicMsgLogSets() 获取消息列表
 * @method void setTopicMsgLogSets(array $TopicMsgLogSets) 设置消息列表
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param array $TopicMsgLogSets 消息列表

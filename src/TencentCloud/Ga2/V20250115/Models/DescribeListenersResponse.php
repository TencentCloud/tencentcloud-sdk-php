 ...
 *
 * @method array getListenerSet() 获取符合条件的监听器实例。
 * @method void setListenerSet(array $ListenerSet) 设置符合条件的监听器实例。
...
class DescribeListenersResponse extends AbstractModel
{
    ...
    /**
     * @param array $ListenerSet 符合条件的监听器实例。

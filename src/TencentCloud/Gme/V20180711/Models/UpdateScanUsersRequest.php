 ...
 * @method string getUserIdString() 获取字符串用户号，逗号分隔
 * @method void setUserIdString(string $UserIdString) 设置字符串用户号，逗号分隔
 * @method array getUserIdRegex() 获取正则表达式用户号，["^6.*"]6开头的用户号
 * @method void setUserIdRegex(array $UserIdRegex) 设置正则表达式用户号，["^6.*"]6开头的用户号
 */
class UpdateScanUsersRequest extends AbstractModel
{
    ...
    /**
     * @var string 字符串用户号，逗号分隔
     */
    public $UserIdString;

    /**
     * @var array 正则表达式用户号，["^6.*"]6开头的用户号
     */
    public $UserIdRegex;

    /**
     * @param integer $BizId 应用ID
     * @param string $UserIdString 字符串用户号，逗号分隔
     * @param array $UserIdRegex 正则表达式用户号，["^6.*"]6开头的用户号
     */

 ...
 * @method array getDetails() 获取子任务记录列表，对于shell与python只有一条记录
 * @method void setDetails(array $Details) 设置子任务记录列表，对于shell与python只有一条记录
 * @method string getRequestId() 获取唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 */
class SubmitShellTaskResponse extends AbstractModel
{
    /**
    ...
    /**
     * @var array 子任务记录列表，对于shell与python只有一条记录
     */
    public $Details;
     ...
     * @param array $Details 子任务记录列表，对于shell与python只有一条记录

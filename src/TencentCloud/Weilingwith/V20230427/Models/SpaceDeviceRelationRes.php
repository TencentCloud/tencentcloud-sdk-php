...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("SpaceDeviceRelationList",$param) and $param["SpaceDeviceRelationList"] !== null) {
            $this->SpaceDeviceRelationList = [];
            foreach ($param["SpaceDeviceRelationList"] as $key => $value){
                $obj = new SpaceDeviceRelation();
                $obj->deserialize($value);
                array_push($this->SpaceDeviceRelationList, $obj);
            }
        }
    }
}

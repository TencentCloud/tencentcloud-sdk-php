 ...
 * @method boolean getIsEnable() 获取策略开关，true开启，false关闭
 * @method void setIsEnable(boolean $IsEnable) 设置策略开关，true开启，false关闭
 */
class ModifyAbnormalProcessRuleStatusRequest extends AbstractModel
{
    ...
    /**
     * @var boolean 策略开关，true开启，false关闭
     */
    public $IsEnable;

    /**
     * @param array $RuleIdSet 策略的ids
     * @param boolean $IsEnable 策略开关，true开启，false关闭
     */

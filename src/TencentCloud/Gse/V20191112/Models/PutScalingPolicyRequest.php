 ...
 * @method TargetConfiguration getTargetConfiguration() 获取基于规则的扩缩容配置
 * @method void setTargetConfiguration(TargetConfiguration $TargetConfiguration) 设置基于规则的扩缩容配置
 */
...
class PutScalingPolicyRequest extends AbstractModel
{
    ...
    /**
     * @var TargetConfiguration 基于规则的扩缩容配置
     */
    public $TargetConfiguration;
    /**
     * @param string $FleetId 服务部署ID
     * @param TargetConfiguration $TargetConfiguration 基于规则的扩缩容配置
     */

 ...
 * @method array getHitInfos() 获取该字段用于命中的关键词信息
 * @method void setHitInfos(array $HitInfos) 设置该字段用于命中的关键词信息
 */
...
返回值：**Block**：建议屏蔽，**Review** ：建议人工复审，**Pass**：建议通过
     ...
     * @param array $HitInfos 该字段用于命中的关键词信息
     */

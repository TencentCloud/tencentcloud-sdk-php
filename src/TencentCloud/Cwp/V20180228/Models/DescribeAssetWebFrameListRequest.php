 ...
 * @method string getBy() 获取可选排序：[FirstTime|JarCount]
 * @method void setBy(string $By) 设置可选排序：[FirstTime|JarCount]
 */
...
<li>Os -String 是否必填: 否 - 操作系统( DescribeMachineOsList 接口 值 )</li>
    ...
    /**
     * @var string 可选排序：[FirstTime|JarCount]
     */
    public $By;
...
<li>Os -String 是否必填: 否 - 操作系统( DescribeMachineOsList 接口 值 )</li>
     ...
     * @param string $By 可选排序：[FirstTime|JarCount]
     */

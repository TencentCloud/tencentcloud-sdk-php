 ...
 * @method RebuildMediaTaskInput getInput() 获取音画质重生任务的输入。
 * @method void setInput(RebuildMediaTaskInput $Input) 设置音画质重生任务的输入。
 * @method RebuildMediaTaskOutput getOutput() 获取音画质重生任务的输出。
 * @method void setOutput(RebuildMediaTaskOutput $Output) 设置音画质重生任务的输出。
...
<li>70000：内部服务错误，建议重试。</li>
    ...
    /**
     * @var RebuildMediaTaskInput 音画质重生任务的输入。
     */
    public $Input;

    /**
     * @var RebuildMediaTaskOutput 音画质重生任务的输出。
     */
    public $Output;
...
<li>70000：内部服务错误，建议重试。</li>
     ...
     * @param RebuildMediaTaskInput $Input 音画质重生任务的输入。
     * @param RebuildMediaTaskOutput $Output 音画质重生任务的输出。

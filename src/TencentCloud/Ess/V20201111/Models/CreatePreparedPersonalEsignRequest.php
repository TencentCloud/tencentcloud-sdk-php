 ...
 * @method string getMobile() 获取<p>手机号码；当需要开通“授权签”时，该参数必传</p>
 * @method void setMobile(string $Mobile) 设置<p>手机号码；当需要开通“授权签”时，该参数必传</p>
...
class CreatePreparedPersonalEsignRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>手机号码；当需要开通“授权签”时，该参数必传</p>
     */
    public $Mobile;
     ...
     * @param string $Mobile <p>手机号码；当需要开通“授权签”时，该参数必传</p>

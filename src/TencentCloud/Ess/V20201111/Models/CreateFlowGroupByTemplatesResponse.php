 ...
 * @method array getApprovers() 获取<p>合同组签署人信息。</p>
 * @method void setApprovers(array $Approvers) 设置<p>合同组签署人信息。</p>
 * @method string getWorkflowInstanceId() 获取<p>FlowGroupNeedWorkflow</p>
 * @method void setWorkflowInstanceId(string $WorkflowInstanceId) 设置<p>FlowGroupNeedWorkflow</p>
...
class CreateFlowGroupByTemplatesResponse extends AbstractModel
{
    ...
    /**
     * @var array <p>合同组签署人信息。</p>
     */
    public $Approvers;

    /**
     * @var string <p>FlowGroupNeedWorkflow</p>
     */
     ...
     * @param array $Approvers <p>合同组签署人信息。</p>
     * @param string $WorkflowInstanceId <p>FlowGroupNeedWorkflow</p>

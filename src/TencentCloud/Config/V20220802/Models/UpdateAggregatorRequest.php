 ...
 * @method string getAccountGroupId() 获取<p>账号组类型</p><p>枚举值：</p><ul><li>RD： 全局账号组</li><li>CUSTOM： 自定义账号组</li></ul>
 * @method void setAccountGroupId(string $AccountGroupId) 设置<p>账号组类型</p><p>枚举值：</p><ul><li>RD： 全局账号组</li><li>CUSTOM： 自定义账号组</li></ul>
 ...
 */
class UpdateAggregatorRequest extends AbstractModel
{
    /**
     ...
     * @param string $AccountGroupId <p>账号组类型</p><p>枚举值：</p><ul><li>RD： 全局账号组</li><li>CUSTOM： 自定义账号组</li></ul>

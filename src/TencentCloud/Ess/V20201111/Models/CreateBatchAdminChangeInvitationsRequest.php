...
注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
 * @method array getAdminChangeInvitationInfos() 获取组织机构超管变更信息。
一次最多支持10条超管变更信息。
 * @method void setAdminChangeInvitationInfos(array $AdminChangeInvitationInfos) 设置组织机构超管变更信息。
一次最多支持10条超管变更信息。
...
注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
     * @param array $AdminChangeInvitationInfos 组织机构超管变更信息。
一次最多支持10条超管变更信息。

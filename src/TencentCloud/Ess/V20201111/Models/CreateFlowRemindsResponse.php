 ...
 *
 * @method array getRemindFlowRecords() 获取签署连接过期时间字符串：年月日-时分秒
 * @method void setRemindFlowRecords(array $RemindFlowRecords) 设置签署连接过期时间字符串：年月日-时分秒
...
class CreateFlowRemindsResponse extends AbstractModel
{
    ...
    /**
     * @param array $RemindFlowRecords 签署连接过期时间字符串：年月日-时分秒

...
use TencentCloud\Cii\V20201210\Models as Models;
...
class CiiClient extends AbstractClient
{
    ...
    {
        $respClass = "TencentCloud"."\\".ucfirst("cii")."\\"."V20201210\\Models"."\\".ucfirst($action)."Response";
        $obj = new $respClass();

 ...
 * @method AutoSignConfig getAutoSignConfig() 获取<p>授权签开通配置信息, 包括开通的人员的信息等</p>
 * @method void setAutoSignConfig(AutoSignConfig $AutoSignConfig) 设置<p>授权签开通配置信息, 包括开通的人员的信息等</p>
 ...
 * @method string getUserData() 获取<p>调用方自定义的个性化字段(可自定义此字段的值)，并以base64方式编码，支持的最大数据大小为 20480长度。 在个人授权签的开通、关闭等回调信息场景中，该字段的信息将原封不动地透传给贵方。</p>
 * @method void setUserData(string $UserData) 设置<p>调用方自定义的个性化字段(可自定义此字段的值)，并以base64方式编码，支持的最大数据大小为 20480长度。 在个人授权签的开通、关闭等回调信息场景中，该字段的信息将原封不动地透传给贵方。</p>
...
class ChannelCreateUserAutoSignEnableUrlRequest extends AbstractModel
{
    ...
    /**
     * @var AutoSignConfig <p>授权签开通配置信息, 包括开通的人员的信息等</p>
     */
    ...
    /**
     * @var string <p>调用方自定义的个性化字段(可自定义此字段的值)，并以base64方式编码，支持的最大数据大小为 20480长度。 在个人授权签的开通、关闭等回调信息场景中，该字段的信息将原封不动地透传给贵方。</p>
     */
    public $UserData;
     ...
     * @param AutoSignConfig $AutoSignConfig <p>授权签开通配置信息, 包括开通的人员的信息等</p>
     ...
     * @param string $UserData <p>调用方自定义的个性化字段(可自定义此字段的值)，并以base64方式编码，支持的最大数据大小为 20480长度。 在个人授权签的开通、关闭等回调信息场景中，该字段的信息将原封不动地透传给贵方。</p>

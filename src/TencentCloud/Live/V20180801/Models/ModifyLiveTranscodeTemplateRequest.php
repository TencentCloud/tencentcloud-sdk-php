 ...
 * @method integer getWidth() 获取<p>宽。0-3000。<br>数值必须是2的倍数，0是原始宽度</p>
 * @method void setWidth(integer $Width) 设置<p>宽。0-3000。<br>数值必须是2的倍数，0是原始宽度</p>
 ...
 * @method integer getHeight() 获取<p>高。0-3000。<br>数值必须是2的倍数，0是原始宽度</p>
 * @method void setHeight(integer $Height) 设置<p>高。0-3000。<br>数值必须是2的倍数，0是原始宽度</p>
 * @method integer getFps() 获取<p>帧率，默认0。<br>范围0-60</p>
 * @method void setFps(integer $Fps) 设置<p>帧率，默认0。<br>范围0-60</p>
 * @method integer getGop() 获取<p>关键帧间隔，单位：秒。<br>范围2-6</p>
 * @method void setGop(integer $Gop) 设置<p>关键帧间隔，单位：秒。<br>范围2-6</p>
 ...
 * @method string getProfile() 获取<p>编码质量：<br>baseline/main/high。</p>
 * @method void setProfile(string $Profile) 设置<p>编码质量：<br>baseline/main/high。</p>
 ...
 * @method integer getAudienceDrivenTranscode() 获取<p>是否智能降码，1 表示智能降码。</p>
 * @method void setAudienceDrivenTranscode(integer $AudienceDrivenTranscode) 设置<p>是否智能降码，1 表示智能降码。</p>
 * @method integer getAudienceThreshold() 获取<p>智能降码人数阈值，当 AudienceDrivenTranscode = 1 时生效。  取值范围：[100, 1000000]。</p>
 * @method void setAudienceThreshold(integer $AudienceThreshold) 设置<p>智能降码人数阈值，当 AudienceDrivenTranscode = 1 时生效。  取值范围：[100, 1000000]。</p>
 */
class ModifyLiveTranscodeTemplateRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>宽。0-3000。<br>数值必须是2的倍数，0是原始宽度</p>
     */
    public $Width;
    ...
    /**
     * @var integer <p>高。0-3000。<br>数值必须是2的倍数，0是原始宽度</p>
     */
    public $Height;

    /**
     * @var integer <p>帧率，默认0。<br>范围0-60</p>
     */
    public $Fps;

    /**
     * @var integer <p>关键帧间隔，单位：秒。<br>范围2-6</p>
     */
    public $Gop;
    ...
    /**
     * @var string <p>编码质量：<br>baseline/main/high。</p>
     */
    public $Profile;
    ...
    /**
     * @var integer <p>是否智能降码，1 表示智能降码。</p>
     */
    public $AudienceDrivenTranscode;

    /**
     * @var integer <p>智能降码人数阈值，当 AudienceDrivenTranscode = 1 时生效。  取值范围：[100, 1000000]。</p>
     */
     ...
     * @param integer $Width <p>宽。0-3000。<br>数值必须是2的倍数，0是原始宽度</p>
     * @param integer $NeedVideo <p>是否保留视频，0：否，1：是。默认1。</p>
     * @param integer $NeedAudio <p>是否保留音频，0：否，1：是。默认1。</p>
     * @param integer $Height <p>高。0-3000。<br>数值必须是2的倍数，0是原始宽度</p>
     * @param integer $Fps <p>帧率，默认0。<br>范围0-60</p>
     * @param integer $Gop <p>关键帧间隔，单位：秒。<br>范围2-6</p>
     * @param integer $Rotate <p>旋转角度，默认0。<br>可取值：0，90，180，270</p>
     * @param string $Profile <p>编码质量：<br>baseline/main/high。</p>
     ...
     * @param integer $AudienceDrivenTranscode <p>是否智能降码，1 表示智能降码。</p>
     * @param integer $AudienceThreshold <p>智能降码人数阈值，当 AudienceDrivenTranscode = 1 时生效。  取值范围：[100, 1000000]。</p>
     */

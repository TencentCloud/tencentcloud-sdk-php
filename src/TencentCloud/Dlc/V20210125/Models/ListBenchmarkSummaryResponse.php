 ...
 *
 * @method array getItems() 获取<p>模型评测汇总列表（排行榜数据）</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setItems(array $Items) 设置<p>模型评测汇总列表（排行榜数据）</p>
注意：此字段可能返回 null，表示取不到有效值。
 ...
 */
class ListBenchmarkSummaryResponse extends AbstractModel
{
    /**
     * @var array <p>模型评测汇总列表（排行榜数据）</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Items;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $Items <p>模型评测汇总列表（排行榜数据）</p>
注意：此字段可能返回 null，表示取不到有效值。

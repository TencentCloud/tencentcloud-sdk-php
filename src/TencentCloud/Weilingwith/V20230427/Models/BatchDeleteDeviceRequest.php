 ...
 * @method array getWIDSet() 获取设备wid数组列表
 * @method void setWIDSet(array $WIDSet) 设置设备wid数组列表
 * @method string getApplicationToken() 获取应用token
 * @method void setApplicationToken(string $ApplicationToken) 设置应用token
 */
class BatchDeleteDeviceRequest extends AbstractModel
{
    /**
     * @var integer 工作空间id
     */

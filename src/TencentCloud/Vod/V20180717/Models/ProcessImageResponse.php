 ...
 * ProcessImage返回参数结构体
 *
 * @method array getContentReviewResultSet() 获取图片内容智能识别任务结果。
 * @method void setContentReviewResultSet(array $ContentReviewResultSet) 设置图片内容智能识别任务结果。
...
class ProcessImageResponse extends AbstractModel
{
    ...
    /**
     * @param array $ContentReviewResultSet 图片内容智能识别任务结果。

 ...
 * @method float getOriginalPrice() 获取原始价格
 * @method void setOriginalPrice(float $OriginalPrice) 设置原始价格
 * @method float getDiscount() 获取折扣率
 * @method void setDiscount(float $Discount) 设置折扣率
 * @method float getDiscountPrice() 获取折扣后的价格
 * @method void setDiscountPrice(float $DiscountPrice) 设置折扣后的价格
 * @method float getOriginalCredits() 获取折扣前每天资源点
 * @method void setOriginalCredits(float $OriginalCredits) 设置折扣前每天资源点
 * @method float getDiscountCredits() 获取折扣后每天所需资源点
 * @method void setDiscountCredits(float $DiscountCredits) 设置折扣后每天所需资源点
 */
class VMPrice extends AbstractModel
{
    /**
     ...
     * @param float $DiscountPrice 折扣后的价格
     * @param float $OriginalCredits 折扣前每天资源点
     * @param float $DiscountCredits 折扣后每天所需资源点
     */

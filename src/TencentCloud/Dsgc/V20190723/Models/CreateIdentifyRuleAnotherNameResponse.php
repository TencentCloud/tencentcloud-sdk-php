 ...
 *
 * @method integer getAliasRuleId() 获取创建的别名规则id
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setAliasRuleId(integer $AliasRuleId) 设置创建的别名规则id
注意：此字段可能返回 null，表示取不到有效值。
 ...
 */
class CreateIdentifyRuleAnotherNameResponse extends AbstractModel
{
    /**
     * @var integer 创建的别名规则id
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $AliasRuleId;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param integer $AliasRuleId 创建的别名规则id
注意：此字段可能返回 null，表示取不到有效值。

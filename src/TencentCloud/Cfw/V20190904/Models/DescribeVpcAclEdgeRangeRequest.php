 ...
 *
 * @method string getFromList() 获取规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
 * @method void setFromList(string $FromList) 设置规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
 ...
 */
class DescribeVpcAclEdgeRangeRequest extends AbstractModel
{
    /**
     * @var string 规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
     */
    public $FromList;
    ...
    /**
     * @param string $FromList 规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("FromList",$param) and $param["FromList"] !== null) {
            $this->FromList = $param["FromList"];
        }

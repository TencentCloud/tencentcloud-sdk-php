 ...
 * @method CloneVoiceAsyncInput getInput() 获取<p>音色克隆任务输入信息。</p>
 * @method void setInput(CloneVoiceAsyncInput $Input) 设置<p>音色克隆任务输入信息。</p>
 * @method CloneVoiceAsyncOutput getOutput() 获取<p>音色克隆任务输出信息。</p>
 * @method void setOutput(CloneVoiceAsyncOutput $Output) 设置<p>音色克隆任务输出信息。</p>
 ...
 */
class CloneVoiceAsyncTask extends AbstractModel
{
    /**
    ...
    /**
     * @var CloneVoiceAsyncInput <p>音色克隆任务输入信息。</p>
     */
    public $Input;

    /**
     * @var CloneVoiceAsyncOutput <p>音色克隆任务输出信息。</p>
     */
    public $Output;
     ...
     * @param CloneVoiceAsyncInput $Input <p>音色克隆任务输入信息。</p>
     * @param CloneVoiceAsyncOutput $Output <p>音色克隆任务输出信息。</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Input",$param) and $param["Input"] !== null) {
            $this->Input = new CloneVoiceAsyncInput();
            $this->Input->deserialize($param["Input"]);
        }

        if (array_key_exists("Output",$param) and $param["Output"] !== null) {
            $this->Output = new CloneVoiceAsyncOutput();

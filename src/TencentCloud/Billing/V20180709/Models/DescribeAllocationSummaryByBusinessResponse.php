 ...
 * @method array getDetail() 获取<p>分账账单按产品汇总明细</p>
 * @method void setDetail(array $Detail) 设置<p>分账账单按产品汇总明细</p>
...
class DescribeAllocationSummaryByBusinessResponse extends AbstractModel
{
     ...
     * @param array $Detail <p>分账账单按产品汇总明细</p>

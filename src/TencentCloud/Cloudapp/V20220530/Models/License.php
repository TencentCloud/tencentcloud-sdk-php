 ...
 * @method string getLicenseLevel() 获取授权的层级：Master 主授权；Child 子授权/增强型授权
 * @method void setLicenseLevel(string $LicenseLevel) 设置授权的层级：Master 主授权；Child 子授权/增强型授权
 */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var string 授权的层级：Master 主授权；Child 子授权/增强型授权
     */
    public $LicenseLevel;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param string $LicenseLevel 授权的层级：Master 主授权；Child 子授权/增强型授权
     */

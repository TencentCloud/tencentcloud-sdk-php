 ...
 * @method AiAnalysisTaskHeadTailInput getInput() 获取片头片尾任务输入。
 * @method void setInput(AiAnalysisTaskHeadTailInput $Input) 设置片头片尾任务输入。
 * @method AiAnalysisTaskHeadTailOutput getOutput() 获取片头片尾任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiAnalysisTaskHeadTailOutput $Output) 设置片头片尾任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiAnalysisTaskHeadTailResult extends AbstractModel
{
    ...
    /**
     * @var AiAnalysisTaskHeadTailInput 片头片尾任务输入。
     */
    public $Input;

    /**
     * @var AiAnalysisTaskHeadTailOutput 片头片尾任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiAnalysisTaskHeadTailInput $Input 片头片尾任务输入。
     * @param AiAnalysisTaskHeadTailOutput $Output 片头片尾任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 * @method array getStaffStatusList() 获取设置座席状态列表，最大个数 10
 * @method void setStaffStatusList(array $StaffStatusList) 设置设置座席状态列表，最大个数 10
 */
class SetStaffStatusRequest extends AbstractModel
{
    ...
    /**
     * @var array 设置座席状态列表，最大个数 10
     */
    public $StaffStatusList;

    /**
     * @param integer $SdkAppId 应用 ID（必填），可以查看 https://console.cloud.tencent.com/ccc
     * @param array $StaffStatusList 设置座席状态列表，最大个数 10
     */

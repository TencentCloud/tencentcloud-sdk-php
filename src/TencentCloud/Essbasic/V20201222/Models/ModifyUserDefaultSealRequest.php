 ...
 * @method string getUserId() 获取用户唯一标识，需要重新指定默认印章的用户ID
 * @method void setUserId(string $UserId) 设置用户唯一标识，需要重新指定默认印章的用户ID
 * @method string getSealId() 获取重新指定的默认印章ID
 * @method void setSealId(string $SealId) 设置重新指定的默认印章ID
 * @method string getSourceIp() 获取请求重新指定个人默认印章的客户端IP
 * @method void setSourceIp(string $SourceIp) 设置请求重新指定个人默认印章的客户端IP
 */
class ModifyUserDefaultSealRequest extends AbstractModel
{
    ...
    /**
     * @var string 用户唯一标识，需要重新指定默认印章的用户ID
     */
    public $UserId;
    ...
    /**
     * @var string 请求重新指定个人默认印章的客户端IP
     */
    public $SourceIp;

    /**
     * @param Caller $Caller 调用方信息
     * @param string $UserId 用户唯一标识，需要重新指定默认印章的用户ID
     * @param string $SealId 重新指定的默认印章ID
     * @param string $SourceIp 请求重新指定个人默认印章的客户端IP
     */

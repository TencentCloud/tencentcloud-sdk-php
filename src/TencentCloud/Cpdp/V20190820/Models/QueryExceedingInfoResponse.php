 ...
 * @method QueryExceedingInfoResult getResult() 获取超额信息结果。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(QueryExceedingInfoResult $Result) 设置超额信息结果。
注意：此字段可能返回 null，表示取不到有效值。
...
class QueryExceedingInfoResponse extends AbstractModel
{
    ...
    /**
     * @var QueryExceedingInfoResult 超额信息结果。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
     ...
     * @param QueryExceedingInfoResult $Result 超额信息结果。
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new QueryExceedingInfoResult();

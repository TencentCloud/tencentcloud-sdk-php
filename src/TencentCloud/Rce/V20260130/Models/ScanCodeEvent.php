 ...
 * 扫码事件详情
 *
 * @method PromotionCode getPromotionCode() 获取<p>营销活动码</p>
 * @method void setPromotionCode(PromotionCode $PromotionCode) 设置<p>营销活动码</p>
...
class ScanCodeEvent extends AbstractModel
{
    ...
    /**
     * @param PromotionCode $PromotionCode <p>营销活动码</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("PromotionCode",$param) and $param["PromotionCode"] !== null) {
            $this->PromotionCode = new PromotionCode();
            $this->PromotionCode->deserialize($param["PromotionCode"]);
        }

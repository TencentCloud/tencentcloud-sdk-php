 ...
 *
 * @method string getTriggerType() 获取手动触发：MANUAL  周期触发：SCHEDULE
 * @method void setTriggerType(string $TriggerType) 设置手动触发：MANUAL  周期触发：SCHEDULE
 ...
 */
class StartAggregateConfigRuleEvaluationRequest extends AbstractModel
{
    /**
     * @var string 手动触发：MANUAL  周期触发：SCHEDULE
     */
    public $TriggerType;
    ...
    /**
     * @param string $TriggerType 手动触发：MANUAL  周期触发：SCHEDULE

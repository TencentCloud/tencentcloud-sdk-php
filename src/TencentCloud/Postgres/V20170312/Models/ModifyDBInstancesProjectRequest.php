 ...
 * @method string getProjectId() 获取所属新项目的ID。可通过[DescribeProject](https://cloud.tencent.com/document/api/651/78725)获取
 * @method void setProjectId(string $ProjectId) 设置所属新项目的ID。可通过[DescribeProject](https://cloud.tencent.com/document/api/651/78725)获取
 */
class ModifyDBInstancesProjectRequest extends AbstractModel
{
    ...
    /**
     * @var string 所属新项目的ID。可通过[DescribeProject](https://cloud.tencent.com/document/api/651/78725)获取
     */
    public $ProjectId;
     ...
     * @param string $ProjectId 所属新项目的ID。可通过[DescribeProject](https://cloud.tencent.com/document/api/651/78725)获取
     */

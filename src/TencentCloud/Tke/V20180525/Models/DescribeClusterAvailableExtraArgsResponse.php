 ...
 * @method AvailableExtraArgs getAvailableExtraArgs() 获取可用的自定义参数
 * @method void setAvailableExtraArgs(AvailableExtraArgs $AvailableExtraArgs) 设置可用的自定义参数
 * @method string getClusterType() 获取集群类型
 * @method void setClusterType(string $ClusterType) 设置集群类型
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeClusterAvailableExtraArgsResponse extends AbstractModel
{
    /**
     * @var string 集群版本
     */
    ...
    /**
     * @var AvailableExtraArgs 可用的自定义参数
     */
     ...
     * @param AvailableExtraArgs $AvailableExtraArgs 可用的自定义参数
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("AvailableExtraArgs",$param) and $param["AvailableExtraArgs"] !== null) {
            $this->AvailableExtraArgs = new AvailableExtraArgs();

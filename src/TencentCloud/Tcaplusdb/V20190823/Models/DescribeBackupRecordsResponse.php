 ...
 *
 * @method array getBackupRecords() 获取备份记录详情
 * @method void setBackupRecords(array $BackupRecords) 设置备份记录详情
 * @method integer getTotalCount() 获取返回记录条数
 * @method void setTotalCount(integer $TotalCount) 设置返回记录条数
...
class DescribeBackupRecordsResponse extends AbstractModel
{
    ...
    /**
     * @param array $BackupRecords 备份记录详情
     * @param integer $TotalCount 返回记录条数

 ...
 *
 * @method boolean getOnlyRule() 获取<p>查找自动填写字段</p>
 * @method void setOnlyRule(boolean $OnlyRule) 设置<p>查找自动填写字段</p>
 ...
 */
class DescribeProfileFieldsMenuRequest extends AbstractModel
{
    /**
     * @var boolean <p>查找自动填写字段</p>
     */
    public $OnlyRule;
    ...
    /**
     * @param boolean $OnlyRule <p>查找自动填写字段</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("OnlyRule",$param) and $param["OnlyRule"] !== null) {
            $this->OnlyRule = $param["OnlyRule"];
        }

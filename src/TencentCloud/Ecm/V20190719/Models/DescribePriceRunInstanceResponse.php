 ...
 *
 * @method InstancesPrice getInstancePrice() 获取实例价格信息
 * @method void setInstancePrice(InstancesPrice $InstancePrice) 设置实例价格信息
...
class DescribePriceRunInstanceResponse extends AbstractModel
{
    ...
    /**
     * @param InstancesPrice $InstancePrice 实例价格信息
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("InstancePrice",$param) and $param["InstancePrice"] !== null) {
            $this->InstancePrice = new InstancesPrice();

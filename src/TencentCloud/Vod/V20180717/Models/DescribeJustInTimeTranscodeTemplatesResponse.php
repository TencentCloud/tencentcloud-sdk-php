 ...
 * @method array getJustInTimeTranscodeTemplateSet() 获取模板详情列表。
 * @method void setJustInTimeTranscodeTemplateSet(array $JustInTimeTranscodeTemplateSet) 设置模板详情列表。
...
class DescribeJustInTimeTranscodeTemplatesResponse extends AbstractModel
{
     ...
     * @param array $JustInTimeTranscodeTemplateSet 模板详情列表。

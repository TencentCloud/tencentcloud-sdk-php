 ...
 *
 * @method array getList() 获取镜像自动授权规则授权范围主机列表
 * @method void setList(array $List) 设置镜像自动授权规则授权范围主机列表
...
class DescribeAutoAuthorizedRuleHostResponse extends AbstractModel
{
    ...
    /**
     * @param array $List 镜像自动授权规则授权范围主机列表
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("List",$param) and $param["List"] !== null) {
            ...
            foreach ($param["List"] as $key => $value){
                $obj = new AutoAuthorizedRuleHostInfo();

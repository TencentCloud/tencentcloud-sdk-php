 ...
 * @method string getSnapshotPolicyName() 获取快照策略名
 * @method void setSnapshotPolicyName(string $SnapshotPolicyName) 设置快照策略名
 ...
 */
class CreateEtcdSnapshotPolicyRequest extends AbstractModel
{
    /**
     * @var string etcd实例Id
     */
     ...
     * @param string $SnapshotPolicyName 快照策略名

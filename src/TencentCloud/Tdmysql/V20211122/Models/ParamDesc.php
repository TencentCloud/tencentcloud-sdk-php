 ...
 * @method boolean getNeedRestart() 获取true:需要重启
 * @method void setNeedRestart(boolean $NeedRestart) 设置true:需要重启
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param boolean $NeedRestart true:需要重启

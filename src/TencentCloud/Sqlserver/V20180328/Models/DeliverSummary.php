...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getDeliverConsumer() 获取投递订阅者
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setDeliverConsumer(string $DeliverConsumer) 设置投递订阅者
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getDeliverConsumerName() 获取投递订阅者名称
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setDeliverConsumerName(string $DeliverConsumerName) 设置投递订阅者名称
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getDeliverError() 获取投递
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setDeliverError(string $DeliverError) 设置投递
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $DeliverConsumer 投递订阅者
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $DeliverConsumerName 投递订阅者名称
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $DeliverError 投递
注意：此字段可能返回 null，表示取不到有效值。
     */

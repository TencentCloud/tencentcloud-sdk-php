...
/**
 * @method array getModels() 获取Model数组，用以显示所有模型的信息
 * @method void setModels(array $Models) 设置Model数组，用以显示所有模型的信息
...
class ListModelsResponse extends AbstractModel
{
    ...
    public $RequestId;
    /**
     * @param array $Models Model数组，用以显示所有模型的信息

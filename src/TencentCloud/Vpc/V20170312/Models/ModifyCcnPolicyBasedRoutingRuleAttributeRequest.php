 ...
 * @method string getPolicyBasedRoutingRuleId() 获取策略路由匹配规则ID
 * @method void setPolicyBasedRoutingRuleId(string $PolicyBasedRoutingRuleId) 设置策略路由匹配规则ID
 * @method string getDescription() 获取描述
 * @method void setDescription(string $Description) 设置描述
 */
class ModifyCcnPolicyBasedRoutingRuleAttributeRequest extends AbstractModel
{
    /**
     * @var string 云联网ID
     */
     ...
     * @param string $PolicyBasedRoutingRuleId 策略路由匹配规则ID

 ...
 * @method integer getLimit() 获取每页输出的参数列表大小。默认为 20，最多输出100条。
 * @method void setLimit(integer $Limit) 设置每页输出的参数列表大小。默认为 20，最多输出100条。
...
class DescribeInstanceParamRecordsRequest extends AbstractModel
{
    ...
    /**
     * @var integer 每页输出的参数列表大小。默认为 20，最多输出100条。
     */
    public $Limit;
     ...
     * @param integer $Limit 每页输出的参数列表大小。默认为 20，最多输出100条。

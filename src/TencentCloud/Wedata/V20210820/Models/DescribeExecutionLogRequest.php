 ...
 * @method integer getDetailId() 获取子任务记录id
 * @method void setDetailId(integer $DetailId) 设置子任务记录id
 */
class DescribeExecutionLogRequest extends AbstractModel
{
    /**
     * @var string 任务实例Id
     */
     ...
     * @param integer $DetailId 子任务记录id
     */

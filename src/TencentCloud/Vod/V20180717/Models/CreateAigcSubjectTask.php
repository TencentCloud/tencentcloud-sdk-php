 ...
 * @method CreateAigcSubjectInput getInput() 获取<p>创建 AIGC 主体输入信息。</p>
 * @method void setInput(CreateAigcSubjectInput $Input) 设置<p>创建 AIGC 主体输入信息。</p>
 * @method CreateAigcSubjectOutput getOutput() 获取<p>创建 AIGC 主体输出信息。</p>
 * @method void setOutput(CreateAigcSubjectOutput $Output) 设置<p>创建 AIGC 主体输出信息。</p>
...
class CreateAigcSubjectTask extends AbstractModel
{
    ...
    /**
     * @var CreateAigcSubjectInput <p>创建 AIGC 主体输入信息。</p>
     */
    public $Input;

    /**
     * @var CreateAigcSubjectOutput <p>创建 AIGC 主体输出信息。</p>
     */
    public $Output;
     ...
     * @param CreateAigcSubjectInput $Input <p>创建 AIGC 主体输入信息。</p>
     * @param CreateAigcSubjectOutput $Output <p>创建 AIGC 主体输出信息。</p>

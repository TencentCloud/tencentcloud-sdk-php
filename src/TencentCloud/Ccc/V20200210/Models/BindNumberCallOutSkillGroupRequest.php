 ...
 * @method array getSkillGroupIds() 获取待绑定的技能组Id列表
 * @method void setSkillGroupIds(array $SkillGroupIds) 设置待绑定的技能组Id列表
 */
class BindNumberCallOutSkillGroupRequest extends AbstractModel
{
     ...
     * @param array $SkillGroupIds 待绑定的技能组Id列表
     */

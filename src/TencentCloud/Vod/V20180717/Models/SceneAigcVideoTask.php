 ...
 * @method SceneAigcVideoTaskInput getInput() 获取AIGC 生视频任务的输入信息。
 * @method void setInput(SceneAigcVideoTaskInput $Input) 设置AIGC 生视频任务的输入信息。
 * @method SceneAigcVideoTaskOutput getOutput() 获取AIGC 生视频任务的输出信息。
 * @method void setOutput(SceneAigcVideoTaskOutput $Output) 设置AIGC 生视频任务的输出信息。
...
class SceneAigcVideoTask extends AbstractModel
{
    ...
    /**
     * @var SceneAigcVideoTaskInput AIGC 生视频任务的输入信息。
     */
    public $Input;

    /**
     * @var SceneAigcVideoTaskOutput AIGC 生视频任务的输出信息。
     */
    public $Output;
     ...
     * @param SceneAigcVideoTaskInput $Input AIGC 生视频任务的输入信息。
     * @param SceneAigcVideoTaskOutput $Output AIGC 生视频任务的输出信息。

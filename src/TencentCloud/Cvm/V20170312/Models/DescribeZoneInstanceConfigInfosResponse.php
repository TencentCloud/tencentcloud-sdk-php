 ...
 *
 * @method array getInstanceTypeQuotaSet() 获取<p>可用区机型配置列表。</p>
 * @method void setInstanceTypeQuotaSet(array $InstanceTypeQuotaSet) 设置<p>可用区机型配置列表。</p>
...
class DescribeZoneInstanceConfigInfosResponse extends AbstractModel
{
    ...
    /**
     * @param array $InstanceTypeQuotaSet <p>可用区机型配置列表。</p>

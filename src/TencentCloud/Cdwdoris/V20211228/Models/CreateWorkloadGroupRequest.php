 ...
 * @method WorkloadGroupConfig getWorkloadGroup() 获取资源组配置
 * @method void setWorkloadGroup(WorkloadGroupConfig $WorkloadGroup) 设置资源组配置
 */
class CreateWorkloadGroupRequest extends AbstractModel
{
    ...
    /**
     * @var WorkloadGroupConfig 资源组配置
     */
    public $WorkloadGroup;

    /**
     * @param string $InstanceId 集群id	
     * @param WorkloadGroupConfig $WorkloadGroup 资源组配置
     */

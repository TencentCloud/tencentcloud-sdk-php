 ...
 * @method string getExtra() 获取<p>该字段用于返回输入参数中的额外附加信息（Extra），如未配置则默认返回值为空。<br>备注：不同客户或Biztype下返回信息不同，如需配置该字段请提交工单咨询或联系售后专员处理。</p>
 * @method void setExtra(string $Extra) 设置<p>该字段用于返回输入参数中的额外附加信息（Extra），如未配置则默认返回值为空。<br>备注：不同客户或Biztype下返回信息不同，如需配置该字段请提交工单咨询或联系售后专员处理。</p>
 ...
 * @method array getSpeakerResults() 获取<p>该字段用于返回音频文件说话人检测的详细审核结果</p>
 * @method void setSpeakerResults(array $SpeakerResults) 设置<p>该字段用于返回音频文件说话人检测的详细审核结果</p>
 * @method array getTravelResults() 获取<p>该字段用于返回音频文件出行检测的详细审核结果</p>
 * @method void setTravelResults(array $TravelResults) 设置<p>该字段用于返回音频文件出行检测的详细审核结果</p>
 * @method string getSubTag() 获取<p>该字段用于返回音频文件的三级标签</p>
 * @method void setSubTag(string $SubTag) 设置<p>该字段用于返回音频文件的三级标签</p>
 * @method string getSubTagCode() 获取<p>该字段用于返回音频文件的三级标签码</p>
 * @method void setSubTagCode(string $SubTagCode) 设置<p>该字段用于返回音频文件的三级标签码</p>
 * @method array getLabelResults() 获取<p>该字段用于返回音频文件歌曲识别的详细审核结果</p>
 * @method void setLabelResults(array $LabelResults) 设置<p>该字段用于返回音频文件歌曲识别的详细审核结果</p>
...
class AudioResult extends AbstractModel
{
    ...
    /**
     * @var string <p>该字段用于返回输入参数中的额外附加信息（Extra），如未配置则默认返回值为空。<br>备注：不同客户或Biztype下返回信息不同，如需配置该字段请提交工单咨询或联系售后专员处理。</p>
     */
    public $Extra;
    ...
    /**
     * @var array <p>该字段用于返回音频文件说话人检测的详细审核结果</p>
     */
    public $SpeakerResults;

    /**
     * @var array <p>该字段用于返回音频文件出行检测的详细审核结果</p>
     */
    public $TravelResults;

    /**
     * @var string <p>该字段用于返回音频文件的三级标签</p>
     */
    public $SubTag;

    /**
     * @var string <p>该字段用于返回音频文件的三级标签码</p>
     */
    public $SubTagCode;

    /**
     * @var array <p>该字段用于返回音频文件歌曲识别的详细审核结果</p>
     */
    public $LabelResults;
     ...
     * @param string $Extra <p>该字段用于返回输入参数中的额外附加信息（Extra），如未配置则默认返回值为空。<br>备注：不同客户或Biztype下返回信息不同，如需配置该字段请提交工单咨询或联系售后专员处理。</p>
     ...
     * @param array $SpeakerResults <p>该字段用于返回音频文件说话人检测的详细审核结果</p>
     * @param array $TravelResults <p>该字段用于返回音频文件出行检测的详细审核结果</p>
     * @param string $SubTag <p>该字段用于返回音频文件的三级标签</p>
     * @param string $SubTagCode <p>该字段用于返回音频文件的三级标签码</p>
     * @param array $LabelResults <p>该字段用于返回音频文件歌曲识别的详细审核结果</p>

 ...
 * @method array getFilters() 获取<br><li> taskId按照【配置id】进行过滤。类型：String  必选：否</li>
 ...
 * @method void setFilters(array $Filters) 设置<br><li> taskId按照【配置id】进行过滤。类型：String  必选：否</li>
<br><li> name按照【配置名称】进行过滤。类型：String 必选：否</li>
<br><li> status按照【配置状态标记】进行过滤。类型：String 必选：否</li>
<br><li> 每次请求的Filters的上限为10，Filter.Values的上限为100。</li>
...
class DescribeMetricSubscribesRequest extends AbstractModel
{
    ...
    /**
     * @var array <br><li> taskId按照【配置id】进行过滤。类型：String  必选：否</li>
<br><li> name按照【配置名称】进行过滤。类型：String 必选：否</li>
<br><li> status按照【配置状态标记】进行过滤。类型：String 必选：否</li>
<br><li> 每次请求的Filters的上限为10，Filter.Values的上限为100。</li>
     */
     ...
     * @param array $Filters <br><li> taskId按照【配置id】进行过滤。类型：String  必选：否</li>
<br><li> name按照【配置名称】进行过滤。类型：String 必选：否</li>
<br><li> status按照【配置状态标记】进行过滤。类型：String 必选：否</li>
<br><li> 每次请求的Filters的上限为10，Filter.Values的上限为100。</li>

 ...
 * @method string getTaskId() 获取<p>任务id，<a href="">创建归档任务</a>时返回</p>
 * @method void setTaskId(string $TaskId) 设置<p>任务id，<a href="">创建归档任务</a>时返回</p>
 */
class DescribeArchiveFlowTaskRequest extends AbstractModel
{
    /**

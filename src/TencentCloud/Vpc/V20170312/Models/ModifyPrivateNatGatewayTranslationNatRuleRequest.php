 ...
 * @method array getTranslationNatRules() 获取转换规则对象数组。仅支持修改单个转换规则
 * @method void setTranslationNatRules(array $TranslationNatRules) 设置转换规则对象数组。仅支持修改单个转换规则
 ...
 */
class ModifyPrivateNatGatewayTranslationNatRuleRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var array 转换规则对象数组。仅支持修改单个转换规则
     */
     ...
     * @param array $TranslationNatRules 转换规则对象数组。仅支持修改单个转换规则
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("TranslationNatRules",$param) and $param["TranslationNatRules"] !== null) {
            ...
            foreach ($param["TranslationNatRules"] as $key => $value){
                $obj = new TranslationNatRuleDiff();

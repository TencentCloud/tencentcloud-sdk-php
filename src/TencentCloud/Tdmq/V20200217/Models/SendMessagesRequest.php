 ...
 * SendMessages请求参数结构体
 *
 * @method string getStringToken() 获取Token 是用来做鉴权使用的
 * @method void setStringToken(string $StringToken) 设置Token 是用来做鉴权使用的
 * @method string getTopic() 获取消息要发送的topic的名字
 * @method void setTopic(string $Topic) 设置消息要发送的topic的名字
...
{
    /**
     * @var string Token 是用来做鉴权使用的
     */
    public $StringToken;

    /**
     * @var string 消息要发送的topic的名字
     */
    public $Topic;
    ...
    /**
     * @param string $StringToken Token 是用来做鉴权使用的
     * @param string $Topic 消息要发送的topic的名字

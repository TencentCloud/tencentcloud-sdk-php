 ...
 *
 * @method array getQueueInfoList() 获取<p>队列列表信息</p>
 * @method void setQueueInfoList(array $QueueInfoList) 设置<p>队列列表信息</p>
...
class DescribeRabbitMQServerlessQueuesResponse extends AbstractModel
{
    ...
    /**
     * @param array $QueueInfoList <p>队列列表信息</p>

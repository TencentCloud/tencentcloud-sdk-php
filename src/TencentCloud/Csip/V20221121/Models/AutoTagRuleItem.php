 ...
 * @method boolean getEnable() 获取<p>开关状态</p>
 * @method void setEnable(boolean $Enable) 设置<p>开关状态</p>
 ...
 * @method integer getPriority() 获取<p>规则优先级</p>
 * @method void setPriority(integer $Priority) 设置<p>规则优先级</p>
 * @method string getCreateTime() 获取<p>创建时间</p>
 * @method void setCreateTime(string $CreateTime) 设置<p>创建时间</p>
 * @method string getUpdateTime() 获取<p>更新时间</p>
 * @method void setUpdateTime(string $UpdateTime) 设置<p>更新时间</p>
 */
class AutoTagRuleItem extends AbstractModel
{
    /**

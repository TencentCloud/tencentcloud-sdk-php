...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getCreatorNickName() 获取创建者
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setCreatorNickName(string $CreatorNickName) 设置创建者
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getCreateUserId() 获取创建者ID
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setCreateUserId(integer $CreateUserId) 设置创建者ID
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getCronTime() 获取任务启动时间
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setCronTime(integer $CronTime) 设置任务启动时间
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $CreatorNickName 创建者
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $CreateUserId 创建者ID
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $CronTime 任务启动时间
注意：此字段可能返回 null，表示取不到有效值。

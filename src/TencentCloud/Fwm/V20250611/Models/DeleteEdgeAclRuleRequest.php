 ...
 * @method array getRuleIds() 获取要删除的规则ID列表
 * @method void setRuleIds(array $RuleIds) 设置要删除的规则ID列表
 */
class DeleteEdgeAclRuleRequest extends AbstractModel
{
    /**
     * @var string 规则组ID
     */
    ...
    /**
     * @var array 要删除的规则ID列表
     */
    public $RuleIds;

    /**
     * @param string $GroupId 规则组ID
     * @param array $RuleIds 要删除的规则ID列表
     */

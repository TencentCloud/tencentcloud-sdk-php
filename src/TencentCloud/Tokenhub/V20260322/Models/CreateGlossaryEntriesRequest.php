 ...
 * @method array getEntries() 获取术语条目列表。单次最多 100 个。
 * @method void setEntries(array $Entries) 设置术语条目列表。单次最多 100 个。
 */
class CreateGlossaryEntriesRequest extends AbstractModel
{
    ...
    /**
     * @var array 术语条目列表。单次最多 100 个。
     */
    public $Entries;

    /**
     * @param string $GlossaryId 术语库 ID。可通过 DescribeGlossaries 接口获取。
     * @param array $Entries 术语条目列表。单次最多 100 个。
     */

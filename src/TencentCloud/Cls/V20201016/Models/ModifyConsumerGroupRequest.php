 ...
 *
 * @method string getConsumerGroup() 获取更新的目标消费者组标识
 * @method void setConsumerGroup(string $ConsumerGroup) 设置更新的目标消费者组标识
 * @method integer getTimeout() 获取消费者心跳超时时间（秒）
 * @method void setTimeout(integer $Timeout) 设置消费者心跳超时时间（秒）
 * @method array getTopics() 获取更新的消费者组包含的日志主题列表
 * @method void setTopics(array $Topics) 设置更新的消费者组包含的日志主题列表
...
class ModifyConsumerGroupRequest extends AbstractModel
{
    ...
    /**
     * @param string $ConsumerGroup 更新的目标消费者组标识
     * @param integer $Timeout 消费者心跳超时时间（秒）
     * @param array $Topics 更新的消费者组包含的日志主题列表

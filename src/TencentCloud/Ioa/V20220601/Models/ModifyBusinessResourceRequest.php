 ...
 * @method integer getProtocol() 获取业务资源协议类型,3：所有,2：UDP，1：TCP(只支持32位)
 * @method void setProtocol(integer $Protocol) 设置业务资源协议类型,3：所有,2：UDP，1：TCP(只支持32位)
 ...
 * @method integer getServiceId() 获取修改业务资源的id(只支持32位)
 * @method void setServiceId(integer $ServiceId) 设置修改业务资源的id(只支持32位)
 ...
 */
class ModifyBusinessResourceRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var integer 业务资源协议类型,3：所有,2：UDP，1：TCP(只支持32位)
     */
    public $Protocol;
     ...
     * @param integer $Protocol 业务资源协议类型,3：所有,2：UDP，1：TCP(只支持32位)
     ...
     * @param integer $ServiceId 修改业务资源的id(只支持32位)

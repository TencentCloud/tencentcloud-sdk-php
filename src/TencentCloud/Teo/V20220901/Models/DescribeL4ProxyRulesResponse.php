 ...
 *
 * @method integer getTotalCount() 获取转发规则总数。
 * @method void setTotalCount(integer $TotalCount) 设置转发规则总数。
 * @method array getL4ProxyRules() 获取转发规则列表。	
 * @method void setL4ProxyRules(array $L4ProxyRules) 设置转发规则列表。	

 ...
 * 智能分类任务输入类型
 *
 * @method integer getDefinition() 获取<p>视频智能分类模板 ID。</p>
 * @method void setDefinition(integer $Definition) 设置<p>视频智能分类模板 ID。</p>
...
class AiAnalysisTaskClassificationInput extends AbstractModel
{
    ...
    /**
     * @param integer $Definition <p>视频智能分类模板 ID。</p>

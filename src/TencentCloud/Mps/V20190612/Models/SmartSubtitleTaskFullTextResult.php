...
注意：此字段可能返回 null，表示取不到有效值。
 * @method SmartSubtitleTaskTextResultOutput getOutput() 获取智能字幕任务输出信息。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(SmartSubtitleTaskTextResultOutput $Output) 设置智能字幕任务输出信息。
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var SmartSubtitleTaskTextResultOutput 智能字幕任务输出信息。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param SmartSubtitleTaskTextResultOutput $Output 智能字幕任务输出信息。
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Output",$param) and $param["Output"] !== null) {
            $this->Output = new SmartSubtitleTaskTextResultOutput();

 ...
 * @method array getInstanceList() 获取高防IP资产实例列表
 * @method void setInstanceList(array $InstanceList) 设置高防IP资产实例列表
...
class DescribeListBGPIPInstancesResponse extends AbstractModel
{
     ...
     * @param array $InstanceList 高防IP资产实例列表

 ...
 *
 * @method array getInfos() 获取日志信息列表。
 * @method void setInfos(array $Infos) 设置日志信息列表。
 * @method integer getPageNum() 获取当前页码。
 * @method void setPageNum(integer $PageNum) 设置当前页码。

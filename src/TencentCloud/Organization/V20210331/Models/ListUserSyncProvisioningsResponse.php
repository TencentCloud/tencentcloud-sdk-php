 ...
 * @method array getUserProvisionings() 获取CAM同步的用户列表。
 * @method void setUserProvisionings(array $UserProvisionings) 设置CAM同步的用户列表。
...
class ListUserSyncProvisioningsResponse extends AbstractModel
{
     ...
     * @param array $UserProvisionings CAM同步的用户列表。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("UserProvisionings",$param) and $param["UserProvisionings"] !== null) {
            $this->UserProvisionings = [];
            foreach ($param["UserProvisionings"] as $key => $value){
                $obj = new UserProvisioning();
                $obj->deserialize($value);
                array_push($this->UserProvisionings, $obj);
            }
        }

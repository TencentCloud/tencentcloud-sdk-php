 ...
 *
 * @method string getStaringAgentId() 获取入口启动AgentID
 ...
 */
class DescribeAppAgentListResponse extends AbstractModel
{
    /**
     * @var string 入口启动AgentID
     */
    public $StaringAgentId;

    /**
     * @var array 应用Agent信息列表
     */
    public $Agents;
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("StaringAgentId",$param) and $param["StaringAgentId"] !== null) {
            $this->StaringAgentId = $param["StaringAgentId"];
        }

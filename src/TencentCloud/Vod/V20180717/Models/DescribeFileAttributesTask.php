 ...
 * @method DescribeFileAttributesTaskOutput getOutput() 获取获取媒体文件属性任务的输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(DescribeFileAttributesTaskOutput $Output) 设置获取媒体文件属性任务的输出。
注意：此字段可能返回 null，表示取不到有效值。
...
<li>70000：内部服务错误，建议重试。</li>
    ...
    /**
     * @var DescribeFileAttributesTaskOutput 获取媒体文件属性任务的输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
...
<li>70000：内部服务错误，建议重试。</li>
     ...
     * @param DescribeFileAttributesTaskOutput $Output 获取媒体文件属性任务的输出。
注意：此字段可能返回 null，表示取不到有效值。

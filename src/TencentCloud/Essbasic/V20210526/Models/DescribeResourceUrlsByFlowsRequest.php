...
第三方平台子客企业和员工必须已经经过实名认证
 * @method array getFlowIds() 获取需要下载的合同流程的ID,  至少需要1个,  做多50个
 * @method void setFlowIds(array $FlowIds) 设置需要下载的合同流程的ID,  至少需要1个,  做多50个
...
第三方平台子客企业和员工必须已经经过实名认证
    ...
    /**
     * @var array 需要下载的合同流程的ID,  至少需要1个,  做多50个
     */
    public $FlowIds;
...
第三方平台子客企业和员工必须已经经过实名认证
     * @param array $FlowIds 需要下载的合同流程的ID,  至少需要1个,  做多50个

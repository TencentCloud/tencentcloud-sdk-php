 ...
 * @method EmbeddingUsage getUsage() 获取token 使用计数，按照总token数量收费。
 * @method void setUsage(EmbeddingUsage $Usage) 设置token 使用计数，按照总token数量收费。
...
class GetEmbeddingResponse extends AbstractModel
{
    ...
    /**
     * @var EmbeddingUsage token 使用计数，按照总token数量收费。
     */
    public $Usage;
     ...
     * @param EmbeddingUsage $Usage token 使用计数，按照总token数量收费。

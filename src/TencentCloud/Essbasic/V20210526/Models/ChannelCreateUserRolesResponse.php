 ...
 *
 * @method array getFailedCreateRoleData() 获取绑定失败的用户角色列表
 * @method void setFailedCreateRoleData(array $FailedCreateRoleData) 设置绑定失败的用户角色列表
 * @method string getRequestId() 获取唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 */
class ChannelCreateUserRolesResponse extends AbstractModel
{
    /**
     * @var array 绑定失败的用户角色列表
     */
    ...
    /**
     * @param array $FailedCreateRoleData 绑定失败的用户角色列表

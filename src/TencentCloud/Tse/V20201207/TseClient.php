 ...
 * @method Models\CreateCloudNativeAPIGatewayConsumerResponse CreateCloudNativeAPIGatewayConsumer(Models\CreateCloudNativeAPIGatewayConsumerRequest $req) 创建消费者。
 * @method Models\CreateCloudNativeAPIGatewayConsumerGroupResponse CreateCloudNativeAPIGatewayConsumerGroup(Models\CreateCloudNativeAPIGatewayConsumerGroupRequest $req) 创建消费者组。
 ...
 * @method Models\DeleteCloudNativeAPIGatewayConsumerResponse DeleteCloudNativeAPIGatewayConsumer(Models\DeleteCloudNativeAPIGatewayConsumerRequest $req) 删除消费者（被绑定到消费者组/密钥时需先解绑）。
 * @method Models\DeleteCloudNativeAPIGatewayConsumerGroupResponse DeleteCloudNativeAPIGatewayConsumerGroup(Models\DeleteCloudNativeAPIGatewayConsumerGroupRequest $req) 删除消费者组（被授权资源占用时返回 CheckItems）。
 ...
 * @method Models\DescribeCloudNativeAPIGatewayConsumerResponse DescribeCloudNativeAPIGatewayConsumer(Models\DescribeCloudNativeAPIGatewayConsumerRequest $req) 查询消费者详情。
 ...
 * @method Models\DescribeCloudNativeAPIGatewayConsumerGroupListResponse DescribeCloudNativeAPIGatewayConsumerGroupList(Models\DescribeCloudNativeAPIGatewayConsumerGroupListRequest $req) 查询消费者组列表。
 * @method Models\DescribeCloudNativeAPIGatewayConsumerListResponse DescribeCloudNativeAPIGatewayConsumerList(Models\DescribeCloudNativeAPIGatewayConsumerListRequest $req) 查询消费者列表。
 ...
 * @method Models\ModifyCloudNativeAPIGatewayConsumerResponse ModifyCloudNativeAPIGatewayConsumer(Models\ModifyCloudNativeAPIGatewayConsumerRequest $req) 修改消费者。
 ...
 * @method Models\ModifyCloudNativeAPIGatewaySecretKeyStatusResponse ModifyCloudNativeAPIGatewaySecretKeyStatus(Models\ModifyCloudNativeAPIGatewaySecretKeyStatusRequest $req) 修改密钥启用状态。

 ...
 * @method string getRegistrantType() 获取认证类型：I=个人，E=企业
 * @method void setRegistrantType(string $RegistrantType) 设置认证类型：I=个人，E=企业
 * @method string getOrganizationNameCN() 获取域名所有者，中文
 * @method void setOrganizationNameCN(string $OrganizationNameCN) 设置域名所有者，中文
 * @method string getOrganizationName() 获取域名所有者，英文
 * @method void setOrganizationName(string $OrganizationName) 设置域名所有者，英文
 * @method string getRegistrantNameCN() 获取域名联系人，中文
 * @method void setRegistrantNameCN(string $RegistrantNameCN) 设置域名联系人，中文
 * @method string getRegistrantName() 获取域名联系人，英文
 * @method void setRegistrantName(string $RegistrantName) 设置域名联系人，英文
 */
...
false：关闭锁定
     ...
     * @param string $RegistrantType 认证类型：I=个人，E=企业
     * @param string $OrganizationNameCN 域名所有者，中文
     * @param string $OrganizationName 域名所有者，英文
     * @param string $RegistrantNameCN 域名联系人，中文
     * @param string $RegistrantName 域名联系人，英文
     */

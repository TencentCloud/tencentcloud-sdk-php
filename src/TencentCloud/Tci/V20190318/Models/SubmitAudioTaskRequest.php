 ...
 * @method string getClassId() 获取课堂标识符
 * @method void setClassId(string $ClassId) 设置课堂标识符
 * @method integer getIdentity() 获取身份，1：老师 2：学生
 * @method void setIdentity(integer $Identity) 设置身份，1：老师 2：学生
...
class SubmitAudioTaskRequest extends AbstractModel
{
     ...
     * @param string $ClassId 课堂标识符
     * @param integer $Identity 身份，1：老师 2：学生

 ...
 * @method float getParameterSizeMin() 获取<p>模型参数最小值</p>
 * @method void setParameterSizeMin(float $ParameterSizeMin) 设置<p>模型参数最小值</p>
 * @method float getParameterSizeMax() 获取<p>模型参数最大值</p>
 * @method void setParameterSizeMax(float $ParameterSizeMax) 设置<p>模型参数最大值</p>
 */
class ListInferenceModelsRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var float <p>模型参数最小值</p>
     */
    public $ParameterSizeMin;

    /**
     * @var float <p>模型参数最大值</p>
     */
    public $ParameterSizeMax;
     ...
     * @param float $ParameterSizeMin <p>模型参数最小值</p>
     * @param float $ParameterSizeMax <p>模型参数最大值</p>
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ParameterSizeMin",$param) and $param["ParameterSizeMin"] !== null) {
            $this->ParameterSizeMin = $param["ParameterSizeMin"];
        }

        if (array_key_exists("ParameterSizeMax",$param) and $param["ParameterSizeMax"] !== null) {
            $this->ParameterSizeMax = $param["ParameterSizeMax"];
        }
    }
}

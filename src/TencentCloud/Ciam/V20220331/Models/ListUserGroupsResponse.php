 ...
 *
 * @method array getContent() 获取用户组列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setContent(array $Content) 设置用户组列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getTotal() 获取总条数
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTotal(integer $Total) 设置总条数
注意：此字段可能返回 null，表示取不到有效值。
 * @method Pageable getPageable() 获取分页
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setPageable(Pageable $Pageable) 设置分页
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $Content 用户组列表
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $Total 总条数
注意：此字段可能返回 null，表示取不到有效值。
     * @param Pageable $Pageable 分页
注意：此字段可能返回 null，表示取不到有效值。

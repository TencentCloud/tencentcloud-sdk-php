 ...
 * @method string getOrderBy() 获取排序字段，取值范围[SessionStartTime,Duration]。默认值为SessionStartTime。
 * @method void setOrderBy(string $OrderBy) 设置排序字段，取值范围[SessionStartTime,Duration]。默认值为SessionStartTime。
...
class DescribeSlowQueryListRequest extends AbstractModel
{
    ...
    /**
     * @var string 排序字段，取值范围[SessionStartTime,Duration]。默认值为SessionStartTime。
     */
    public $OrderBy;
     ...
     * @param string $OrderBy 排序字段，取值范围[SessionStartTime,Duration]。默认值为SessionStartTime。

...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getVersion() 获取<p>模型版本号</p>
 * @method void setVersion(string $Version) 设置<p>模型版本号</p>
 ...
 */
class CreateModelVersionResponse extends AbstractModel
{
    /**
     * @var string <p>版本ID</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $Version <p>模型版本号</p>

 ...
 * @method integer getFileSize() 获取<p>日志文件大小</p><p>单位：字节</p>
 * @method void setFileSize(integer $FileSize) 设置<p>日志文件大小</p><p>单位：字节</p>
 ...
 * @method integer getFrom() 获取<p>日志导出起始时间</p>
 * @method void setFrom(integer $From) 设置<p>日志导出起始时间</p>
 * @method integer getTo() 获取<p>日志导出结束时间</p>
 * @method void setTo(integer $To) 设置<p>日志导出结束时间</p>
 ...
 * @method string getCreateTime() 获取<p>日志导出创建时间</p>
 * @method void setCreateTime(string $CreateTime) 设置<p>日志导出创建时间</p>
...
class ExportInfo extends AbstractModel
{
    ...
    /**
     * @var integer <p>日志文件大小</p><p>单位：字节</p>
     */
    public $FileSize;
    ...
    /**
     * @var integer <p>日志导出起始时间</p>
     */
    public $From;

    /**
     * @var integer <p>日志导出结束时间</p>
     */
    public $To;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param integer $FileSize <p>日志文件大小</p><p>单位：字节</p>
     ...
     * @param integer $From <p>日志导出起始时间</p>
     * @param integer $To <p>日志导出结束时间</p>
     * @param string $CosPath <p>日志导出路径,有效期一个小时，请尽快使用该路径下载。</p>
     * @param string $CreateTime <p>日志导出创建时间</p>

 ...
 * @method boolean getIsCloudHost() 获取是否查询主机列表
 * @method void setIsCloudHost(boolean $IsCloudHost) 设置是否查询主机列表
 */
class CreateAllAssetsExportJobRequest extends AbstractModel
{
    /**
     ...
     * @param boolean $IsCloudHost 是否查询主机列表
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("IsCloudHost",$param) and $param["IsCloudHost"] !== null) {
            $this->IsCloudHost = $param["IsCloudHost"];
        }
    }
}

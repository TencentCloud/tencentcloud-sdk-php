 ...
 * @method integer getMarkPicIndex() 获取需要删除的水印Index。
 * @method void setMarkPicIndex(integer $MarkPicIndex) 设置需要删除的水印Index。
 */
class DeleteCasterMarkPicInfoRequest extends AbstractModel
{
    /**
     * @var integer 导播台ID。
     */
    ...
    /**
     * @var integer 需要删除的水印Index。
     */
    public $MarkPicIndex;

    /**
     * @param integer $CasterId 导播台ID。
     * @param integer $MarkPicIndex 需要删除的水印Index。
     */

 ...
 * @method string getExtendServiceType() 获取<p>取值如下所示：<ul><li>OPEN_SERVER_SIGN：企业“授权签”</li><li>BATCH_SIGN：批量签署</li></ul></p>
 * @method void setExtendServiceType(string $ExtendServiceType) 设置<p>取值如下所示：<ul><li>OPEN_SERVER_SIGN：企业“授权签”</li><li>BATCH_SIGN：批量签署</li></ul></p>
...
class DeleteExtendedServiceAuthInfosRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>取值如下所示：<ul><li>OPEN_SERVER_SIGN：企业“授权签”</li><li>BATCH_SIGN：批量签署</li></ul></p>
     */
     ...
     * @param string $ExtendServiceType <p>取值如下所示：<ul><li>OPEN_SERVER_SIGN：企业“授权签”</li><li>BATCH_SIGN：批量签署</li></ul></p>

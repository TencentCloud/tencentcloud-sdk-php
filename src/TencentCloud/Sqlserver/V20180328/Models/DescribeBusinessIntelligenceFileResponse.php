 ...
 *
 * @method integer getTotalCount() 获取文件部署任务总数
 * @method void setTotalCount(integer $TotalCount) 设置文件部署任务总数
 * @method array getBackupMigrationSet() 获取文件部署任务集合
 * @method void setBackupMigrationSet(array $BackupMigrationSet) 设置文件部署任务集合
...
class DescribeBusinessIntelligenceFileResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 文件部署任务总数
     * @param array $BackupMigrationSet 文件部署任务集合

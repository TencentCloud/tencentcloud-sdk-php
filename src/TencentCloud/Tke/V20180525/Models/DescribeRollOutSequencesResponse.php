 ...
 *
 * @method array getSequences() 获取发布序列
 * @method void setSequences(array $Sequences) 设置发布序列
 ...
 */
class DescribeRollOutSequencesResponse extends AbstractModel
{
    /**
     * @var array 发布序列
     */

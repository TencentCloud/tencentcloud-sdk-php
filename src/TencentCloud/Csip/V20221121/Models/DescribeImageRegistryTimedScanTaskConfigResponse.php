 ...
 * @method array getTaskInfo() 获取<p>定时任务列表</p>
 * @method void setTaskInfo(array $TaskInfo) 设置<p>定时任务列表</p>
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeImageRegistryTimedScanTaskConfigResponse extends AbstractModel
{
    /**
     * @var integer <p>总数</p>
     */
     ...
     * @param array $TaskInfo <p>定时任务列表</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("TaskInfo",$param) and $param["TaskInfo"] !== null) {
            ...
            foreach ($param["TaskInfo"] as $key => $value){
                $obj = new ImageRegistryTimedScanTaskInfo();

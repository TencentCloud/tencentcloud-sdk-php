 ...
 * @method CustomActionParameters getCustomActionParameters() 获取<p>定制配置操作参数，当 Name 取值为 CustomAction 时，该参数必填。</p><p>您可以通过 DescribeAvailableCustomActionsForRuleEngine 接口的返回值 CustomActionSet 获取您当前支持的定制配置项列表。</p>
 * @method void setCustomActionParameters(CustomActionParameters $CustomActionParameters) 设置<p>定制配置操作参数，当 Name 取值为 CustomAction 时，该参数必填。</p><p>您可以通过 DescribeAvailableCustomActionsForRuleEngine 接口的返回值 CustomActionSet 获取您当前支持的定制配置项列表。</p>
 */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var CustomActionParameters <p>定制配置操作参数，当 Name 取值为 CustomAction 时，该参数必填。</p><p>您可以通过 DescribeAvailableCustomActionsForRuleEngine 接口的返回值 CustomActionSet 获取您当前支持的定制配置项列表。</p>
     */
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param CustomActionParameters $CustomActionParameters <p>定制配置操作参数，当 Name 取值为 CustomAction 时，该参数必填。</p><p>您可以通过 DescribeAvailableCustomActionsForRuleEngine 接口的返回值 CustomActionSet 获取您当前支持的定制配置项列表。</p>
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("CustomActionParameters",$param) and $param["CustomActionParameters"] !== null) {
            $this->CustomActionParameters = new CustomActionParameters();
            $this->CustomActionParameters->deserialize($param["CustomActionParameters"]);
        }
    }
}

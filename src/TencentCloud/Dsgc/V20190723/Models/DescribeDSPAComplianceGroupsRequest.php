 ...
 * @method boolean getIsFilterCloseComplianceGroup() 获取是否仅显示已开启模板
 * @method void setIsFilterCloseComplianceGroup(boolean $IsFilterCloseComplianceGroup) 设置是否仅显示已开启模板
 */
class DescribeDSPAComplianceGroupsRequest extends AbstractModel
{
     ...
     * @param boolean $IsFilterCloseComplianceGroup 是否仅显示已开启模板
     */

 ...
 * @method string getQueryKey() 获取查询key
 * @method void setQueryKey(string $QueryKey) 设置查询key
 */
class FindFuzzyTasksDsRequest extends AbstractModel
{
    /**
     * @var string 项目Id
     */

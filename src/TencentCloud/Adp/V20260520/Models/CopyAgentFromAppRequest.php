 ...
 * @method string getTargetAppId() 获取<p>目标应用ID，kind=0时需传入</p>
 * @method void setTargetAppId(string $TargetAppId) 设置<p>目标应用ID，kind=0时需传入</p>
 ...
 */
class CopyAgentFromAppRequest extends AbstractModel
{
    /**
     * @var string <p>应用Id</p>
     */
    ...
    /**
     * @var string <p>目标应用ID，kind=0时需传入</p>
     */
    public $TargetAppId;
     ...
     * @param string $TargetAppId <p>目标应用ID，kind=0时需传入</p>

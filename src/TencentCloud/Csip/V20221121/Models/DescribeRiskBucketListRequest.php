 ...
 * @method string getPolicyId() 获取规则id
 * @method void setPolicyId(string $PolicyId) 设置规则id
 * @method Filter getFilter() 获取过滤器
 * @method void setFilter(Filter $Filter) 设置过滤器
 */
class DescribeRiskBucketListRequest extends AbstractModel
{
    /**

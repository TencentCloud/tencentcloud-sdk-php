 ...
 * @method integer getBlackListCount() 获取<p>号码拉入黑名单统计。</p><p>单位：个</p>
 * @method void setBlackListCount(integer $BlackListCount) 设置<p>号码拉入黑名单统计。</p><p>单位：个</p>
 * @method integer getFrequencyLimitCount() 获取<p>运营商频率限制数</p><p>单位：个</p>
 * @method void setFrequencyLimitCount(integer $FrequencyLimitCount) 设置<p>运营商频率限制数</p><p>单位：个</p>
 */
class CallbackStatusStatistics extends AbstractModel
{
    ...
    /**
     * @var integer <p>号码拉入黑名单统计。</p><p>单位：个</p>
     */
    public $BlackListCount;

    /**
     * @var integer <p>运营商频率限制数</p><p>单位：个</p>
     */
     ...
     * @param integer $BlackListCount <p>号码拉入黑名单统计。</p><p>单位：个</p>
     * @param integer $FrequencyLimitCount <p>运营商频率限制数</p><p>单位：个</p>
     */

 ...
 *
 * @method array getInfos() 获取传输流的媒体数据列表。
 * @method void setInfos(array $Infos) 设置传输流的媒体数据列表。

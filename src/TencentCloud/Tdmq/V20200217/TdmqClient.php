 ...
 * @method Models\CreateAMQPClusterResponse CreateAMQPCluster(Models\CreateAMQPClusterRequest $req) 创建AMQP集群
 * @method Models\CreateAMQPExchangeResponse CreateAMQPExchange(Models\CreateAMQPExchangeRequest $req) 创建AMQP Exchange
 * @method Models\CreateAMQPQueueResponse CreateAMQPQueue(Models\CreateAMQPQueueRequest $req) 创建AMQP队列
 * @method Models\CreateAMQPRouteRelationResponse CreateAMQPRouteRelation(Models\CreateAMQPRouteRelationRequest $req) 创建AMQP路由关系
 * @method Models\CreateAMQPVHostResponse CreateAMQPVHost(Models\CreateAMQPVHostRequest $req) 创建Amqp Vhost
 ...
 * @method Models\DeleteAMQPClusterResponse DeleteAMQPCluster(Models\DeleteAMQPClusterRequest $req) 删除AMQP集群
 * @method Models\DeleteAMQPExchangeResponse DeleteAMQPExchange(Models\DeleteAMQPExchangeRequest $req) 删除Amqp交换机
 * @method Models\DeleteAMQPQueueResponse DeleteAMQPQueue(Models\DeleteAMQPQueueRequest $req) 删除Amqp队列
 * @method Models\DeleteAMQPRouteRelationResponse DeleteAMQPRouteRelation(Models\DeleteAMQPRouteRelationRequest $req) 删除Amqp路由关系
 * @method Models\DeleteAMQPVHostResponse DeleteAMQPVHost(Models\DeleteAMQPVHostRequest $req) 删除Vhost
 ...
 * @method Models\DescribeAMQPClusterResponse DescribeAMQPCluster(Models\DescribeAMQPClusterRequest $req) 获取单个Amqp集群信息
 * @method Models\DescribeAMQPClustersResponse DescribeAMQPClusters(Models\DescribeAMQPClustersRequest $req) 获取amqp集群列表
 * @method Models\DescribeAMQPCreateQuotaResponse DescribeAMQPCreateQuota(Models\DescribeAMQPCreateQuotaRequest $req) 获取用户的配额，如Queue容量，Exchange容量，Vhost容量，单Vhost Tps数,剩余可创建集群数
 * @method Models\DescribeAMQPExchangesResponse DescribeAMQPExchanges(Models\DescribeAMQPExchangesRequest $req) 获取AMQP Exchange列表
 ...
 * @method Models\ModifyAMQPExchangeResponse ModifyAMQPExchange(Models\ModifyAMQPExchangeRequest $req) 更新Amqp交换机
 * @method Models\ModifyAMQPQueueResponse ModifyAMQPQueue(Models\ModifyAMQPQueueRequest $req) 更新Amqp队列
 * @method Models\ModifyAMQPVHostResponse ModifyAMQPVHost(Models\ModifyAMQPVHostRequest $req) 更新Vhost

...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getForwardKey() 获取第三方推送密钥，为空表示不使用鉴权token。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setForwardKey(string $ForwardKey) 设置第三方推送密钥，为空表示不使用鉴权token。
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var string 第三方推送密钥，为空表示不使用鉴权token。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $ForwardKey;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $ForwardKey 第三方推送密钥，为空表示不使用鉴权token。
注意：此字段可能返回 null，表示取不到有效值。

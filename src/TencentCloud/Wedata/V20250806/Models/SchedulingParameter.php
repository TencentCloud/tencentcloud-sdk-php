...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getExtProperties() 获取拓展参数json
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setExtProperties(string $ExtProperties) 设置拓展参数json
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $ExtProperties 拓展参数json
注意：此字段可能返回 null，表示取不到有效值。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ExtProperties",$param) and $param["ExtProperties"] !== null) {
            $this->ExtProperties = $param["ExtProperties"];
        }
    }
}

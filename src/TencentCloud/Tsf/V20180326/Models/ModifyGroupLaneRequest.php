 ...
 * @method array getLaneList() 获取泳道部署组列表。
 * @method void setLaneList(array $LaneList) 设置泳道部署组列表。
 */
class ModifyGroupLaneRequest extends AbstractModel
{
    /**
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("LaneList",$param) and $param["LaneList"] !== null) {
            $this->LaneList = [];
            foreach ($param["LaneList"] as $key => $value){
                $obj = new LaneGroup();
                $obj->deserialize($value);
                array_push($this->LaneList, $obj);
            }
        }
    }
}

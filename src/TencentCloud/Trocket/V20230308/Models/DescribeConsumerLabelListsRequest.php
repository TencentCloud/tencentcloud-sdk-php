 ...
 * @method array getGroups() 获取<p>消费组名称列表</p><p>入参限制：批量上限为 32 条</p>
 * @method void setGroups(array $Groups) 设置<p>消费组名称列表</p><p>入参限制：批量上限为 32 条</p>
 */
class DescribeConsumerLabelListsRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var array <p>消费组名称列表</p><p>入参限制：批量上限为 32 条</p>
     */
    public $Groups;
     ...
     * @param array $Groups <p>消费组名称列表</p><p>入参限制：批量上限为 32 条</p>
     */

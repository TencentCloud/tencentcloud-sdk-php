 ...
 * @method string getQuuid() 获取<p>主机UUID（可选，由列表带回透传）</p>
 * @method void setQuuid(string $Quuid) 设置<p>主机UUID（可选，由列表带回透传）</p>
 * @method string getInstanceId() 获取<p>实例ID（可选，由列表带回透传，用于安全中心标签富化）</p>
 * @method void setInstanceId(string $InstanceId) 设置<p>实例ID（可选，由列表带回透传，用于安全中心标签富化）</p>
 * @method string getAlertSubType() 获取<p>告警子类型</p>
 * @method void setAlertSubType(string $AlertSubType) 设置<p>告警子类型</p>
 */
class EdrAlertTarget extends AbstractModel
{
    ...
    /**
     * @var string <p>主机UUID（可选，由列表带回透传）</p>
     */
    public $Quuid;

    /**
     * @var string <p>实例ID（可选，由列表带回透传，用于安全中心标签富化）</p>
     */
    public $InstanceId;

    /**
     * @var string <p>告警子类型</p>
     */
    public $AlertSubType;
     ...
     * @param string $Quuid <p>主机UUID（可选，由列表带回透传）</p>
     * @param string $InstanceId <p>实例ID（可选，由列表带回透传，用于安全中心标签富化）</p>
     * @param string $AlertSubType <p>告警子类型</p>
     */

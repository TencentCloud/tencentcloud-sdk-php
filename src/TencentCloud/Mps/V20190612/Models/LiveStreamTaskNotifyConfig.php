 ...
 * @method string getCmqModel() 获取有 Queue 和 Topic 两种模型。
 * @method void setCmqModel(string $CmqModel) 设置有 Queue 和 Topic 两种模型。
 * @method string getCmqRegion() 获取TDMQ-CMQ 的园区，如 sh，bj 等。
 * @method void setCmqRegion(string $CmqRegion) 设置TDMQ-CMQ 的园区，如 sh，bj 等。
 * @method string getQueueName() 获取当模型为 Queue 时有效，表示接收事件通知的 TDMQ-CMQ 的队列名。
 * @method void setQueueName(string $QueueName) 设置当模型为 Queue 时有效，表示接收事件通知的 TDMQ-CMQ 的队列名。
 * @method string getTopicName() 获取当模型为 Topic 时有效，表示接收事件通知的 TDMQ-CMQ 的主题名。
 * @method void setTopicName(string $TopicName) 设置当模型为 Topic 时有效，表示接收事件通知的 TDMQ-CMQ 的主题名。
...
<font color="red"> 注：不填或为空时默认 CMQ，如需采用其他类型需填写对应类型值。 </font>
    ...
    /**
     * @var string 有 Queue 和 Topic 两种模型。
     */
    public $CmqModel;

    /**
     * @var string TDMQ-CMQ 的园区，如 sh，bj 等。
     */
    public $CmqRegion;

    /**
     * @var string 当模型为 Queue 时有效，表示接收事件通知的 TDMQ-CMQ 的队列名。
     */
    public $QueueName;

    /**
     * @var string 当模型为 Topic 时有效，表示接收事件通知的 TDMQ-CMQ 的主题名。
     */
    public $TopicName;
...
<font color="red"> 注：不填或为空时默认 CMQ，如需采用其他类型需填写对应类型值。 </font>
     ...
     * @param string $CmqModel 有 Queue 和 Topic 两种模型。
     * @param string $CmqRegion TDMQ-CMQ 的园区，如 sh，bj 等。
     * @param string $QueueName 当模型为 Queue 时有效，表示接收事件通知的 TDMQ-CMQ 的队列名。
     * @param string $TopicName 当模型为 Topic 时有效，表示接收事件通知的 TDMQ-CMQ 的主题名。

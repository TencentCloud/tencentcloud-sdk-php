 ...
 * @method string getRegionState() 获取地域是否可用状态，取值仅为AVAILABLE（表示可用状态）。
 * @method void setRegionState(string $RegionState) 设置地域是否可用状态，取值仅为AVAILABLE（表示可用状态）。
...
class RegionInfo extends AbstractModel
{
    ...
    /**
     * @var string 地域是否可用状态，取值仅为AVAILABLE（表示可用状态）。
     */
    public $RegionState;
     ...
     * @param string $RegionState 地域是否可用状态，取值仅为AVAILABLE（表示可用状态）。

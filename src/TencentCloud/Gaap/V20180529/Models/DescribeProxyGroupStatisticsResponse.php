 ...
 *
 * @method array getStatisticsData() 获取<p>通道组统计数据</p>
 * @method void setStatisticsData(array $StatisticsData) 设置<p>通道组统计数据</p>
...
class DescribeProxyGroupStatisticsResponse extends AbstractModel
{
    ...
    /**
     * @param array $StatisticsData <p>通道组统计数据</p>

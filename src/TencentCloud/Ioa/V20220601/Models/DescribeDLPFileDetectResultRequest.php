 ...
 * @method string getQueryID() 获取<p>查询ID，即提交送检任务接口（CreateDLPFileDetectionTask）返回的任务ID（DLPFileDetectionTaskID）</p>
 * @method void setQueryID(string $QueryID) 设置<p>查询ID，即提交送检任务接口（CreateDLPFileDetectionTask）返回的任务ID（DLPFileDetectionTaskID）</p>
 */
class DescribeDLPFileDetectResultRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>查询ID，即提交送检任务接口（CreateDLPFileDetectionTask）返回的任务ID（DLPFileDetectionTaskID）</p>
     */
    public $QueryID;
     ...
     * @param string $QueryID <p>查询ID，即提交送检任务接口（CreateDLPFileDetectionTask）返回的任务ID（DLPFileDetectionTaskID）</p>
     */

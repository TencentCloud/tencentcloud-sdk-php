 ...
 *
 * @method integer getEnable() 获取<p>是否开启防卸载 0 否 1 是 9 未设置,和0一样是未开启</p>
 * @method void setEnable(integer $Enable) 设置<p>是否开启防卸载 0 否 1 是 9 未设置,和0一样是未开启</p>
 ...
 */
class DescribePreventUninstallGlobalConfResponse extends AbstractModel
{
    /**
     * @var integer <p>是否开启防卸载 0 否 1 是 9 未设置,和0一样是未开启</p>
     */
    public $Enable;
    ...
    /**
     * @param integer $Enable <p>是否开启防卸载 0 否 1 是 9 未设置,和0一样是未开启</p>

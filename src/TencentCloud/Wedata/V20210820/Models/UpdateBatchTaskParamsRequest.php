 ...
 * @method array getMapParamList() 获取调度参数键值对
 * @method void setMapParamList(array $MapParamList) 设置调度参数键值对
 * @method string getProjectId() 获取项目ID
 * @method void setProjectId(string $ProjectId) 设置项目ID
 */
class UpdateBatchTaskParamsRequest extends AbstractModel
{
    /**
     * @var array 待更新的任务ID
     */
     ...
     * @param array $MapParamList 调度参数键值对

 ...
 *
 * @method string getBaseBackupId() 获取<p>数据备份集ID</p>
 * @method void setBaseBackupId(string $BaseBackupId) 设置<p>数据备份集ID</p>
...
class CreateBaseBackupResponse extends AbstractModel
{
    ...
    /**
     * @param string $BaseBackupId <p>数据备份集ID</p>

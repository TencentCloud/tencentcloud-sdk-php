 ...
 * @method integer getExpiresAt() 获取自定义的账户过期时间（时间戳）
 * @method void setExpiresAt(integer $ExpiresAt) 设置自定义的账户过期时间（时间戳）
...
class ModifyCustomAccountRequest extends AbstractModel
{
     ...
     * @param integer $ExpiresAt 自定义的账户过期时间（时间戳）

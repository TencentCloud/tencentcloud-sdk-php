 ...
 * @method void setManagedIds(array $ManagedIds) 设置想开启的规则id
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getRuleID() 获取本规则的id
 * @method void setRuleID(integer $RuleID) 设置本规则的id
 * @method string getAction() 获取drop/trans/monitor/alg
 * @method void setAction(string $Action) 设置drop/trans/monitor/alg
 * @method integer getPunishTime() 获取ip封禁的惩罚时间
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setPunishTime(integer $PunishTime) 设置ip封禁的惩罚时间
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getPunishTimeUnit() 获取单位
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setPunishTimeUnit(string $PunishTimeUnit) 设置单位
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var string drop/trans/monitor/alg
     */
    public $Action;

    /**
     * @var integer ip封禁的惩罚时间
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $PunishTime;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $ManagedIds 想开启的规则id
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $RuleID 本规则的id
     * @param string $Action drop/trans/monitor/alg
     * @param integer $PunishTime ip封禁的惩罚时间
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $PunishTimeUnit 单位
注意：此字段可能返回 null，表示取不到有效值。

 ...
 * @method AigcVideoRedrawTaskInput getInput() 获取<p>AIGC 视频转绘任务的输入信息。</p>
 * @method void setInput(AigcVideoRedrawTaskInput $Input) 设置<p>AIGC 视频转绘任务的输入信息。</p>
 * @method AigcVideoRedrawTaskOutput getOutput() 获取<p>AIGC 视频转绘任务的输出信息。</p>
 * @method void setOutput(AigcVideoRedrawTaskOutput $Output) 设置<p>AIGC 视频转绘任务的输出信息。</p>
...
class AigcVideoRedrawTask extends AbstractModel
{
    ...
    /**
     * @var AigcVideoRedrawTaskInput <p>AIGC 视频转绘任务的输入信息。</p>
     */
    public $Input;

    /**
     * @var AigcVideoRedrawTaskOutput <p>AIGC 视频转绘任务的输出信息。</p>
     */
    public $Output;
     ...
     * @param AigcVideoRedrawTaskInput $Input <p>AIGC 视频转绘任务的输入信息。</p>
     * @param AigcVideoRedrawTaskOutput $Output <p>AIGC 视频转绘任务的输出信息。</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Input",$param) and $param["Input"] !== null) {
            $this->Input = new AigcVideoRedrawTaskInput();
            $this->Input->deserialize($param["Input"]);
        }

        if (array_key_exists("Output",$param) and $param["Output"] !== null) {
            $this->Output = new AigcVideoRedrawTaskOutput();

 ...
 * @method integer getUseDefaultImageService() 获取是否使用默认镜像服务
 * @method void setUseDefaultImageService(integer $UseDefaultImageService) 设置是否使用默认镜像服务
...
class CreateServiceV2Request extends AbstractModel
{
     ...
     * @param integer $UseDefaultImageService 是否使用默认镜像服务

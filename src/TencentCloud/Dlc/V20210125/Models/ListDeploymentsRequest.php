 ...
 * @method integer getStartTime() 获取<p>创建时间起始</p><p>单位：ms</p>
 * @method void setStartTime(integer $StartTime) 设置<p>创建时间起始</p><p>单位：ms</p>
 * @method integer getEndTime() 获取<p>创建时间截止</p><p>单位：ms</p>
 * @method void setEndTime(integer $EndTime) 设置<p>创建时间截止</p><p>单位：ms</p>
 ...
 */
class ListDeploymentsRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var integer <p>创建时间起始</p><p>单位：ms</p>
     */
    public $StartTime;

    /**
     * @var integer <p>创建时间截止</p><p>单位：ms</p>
     */
    public $EndTime;
     ...
     * @param integer $StartTime <p>创建时间起始</p><p>单位：ms</p>
     * @param integer $EndTime <p>创建时间截止</p><p>单位：ms</p>

 ...
 * @method array getCustomIds() 获取自定义 id 列表，最多同时查询 10 个自定义 id
 * @method void setCustomIds(array $CustomIds) 设置自定义 id 列表，最多同时查询 10 个自定义 id
 */
class DescribeCustomFlowIdsRequest extends AbstractModel
{
    ...
    /**
     * @var array 自定义 id 列表，最多同时查询 10 个自定义 id
     */
    public $CustomIds;

    /**
     * @param Caller $Caller 调用方信息
     * @param array $CustomIds 自定义 id 列表，最多同时查询 10 个自定义 id
     */

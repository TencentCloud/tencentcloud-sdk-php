...
```
 * @method string getDevConProperties() 获取若项目为标准模式，则此字段必填
 * @method void setDevConProperties(string $DevConProperties) 设置若项目为标准模式，则此字段必填
...
```
     * @param string $DevConProperties 若项目为标准模式，则此字段必填

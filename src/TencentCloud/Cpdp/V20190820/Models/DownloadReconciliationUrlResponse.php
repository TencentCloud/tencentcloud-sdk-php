 ...
 * @method string getHashType() 获取hash类型
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setHashType(string $HashType) 设置hash类型
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getHashValue() 获取hash值
 * @method void setHashValue(string $HashValue) 设置hash值
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param string $HashType hash类型
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $HashValue hash值

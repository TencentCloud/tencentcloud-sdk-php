 ...
 * head组规格
 *
 * @method string getName() 获取<p>head/worker名称</p>
 * @method void setName(string $Name) 设置<p>head/worker名称</p>
 ...
 * @method integer getPodNum() 获取<p>Pod数量</p>
 * @method void setPodNum(integer $PodNum) 设置<p>Pod数量</p>
 * @method boolean getHighAvailability() 获取<p>是否支持高级可用</p>
 * @method void setHighAvailability(boolean $HighAvailability) 设置<p>是否支持高级可用</p>
 ...
 */
class HeadSpecDTO extends AbstractModel
{
    /**
     * @var string <p>head/worker名称</p>
     */
    public $Name;
    ...
    /**
     * @var integer <p>Pod数量</p>
     */
    public $PodNum;

    /**
     * @var boolean <p>是否支持高级可用</p>
     */
    ...
    /**
     * @param string $Name <p>head/worker名称</p>
     ...
     * @param integer $PodNum <p>Pod数量</p>
     * @param boolean $HighAvailability <p>是否支持高级可用</p>

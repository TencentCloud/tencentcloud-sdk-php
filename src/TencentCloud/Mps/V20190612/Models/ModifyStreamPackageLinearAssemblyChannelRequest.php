 ...
 *
 * @method string getId() 获取Channel Id。
 * @method void setId(string $Id) 设置Channel Id。
 * @method string getName() 获取修改后的名称。
 * @method void setName(string $Name) 设置修改后的名称。
 * @method string getTier() 获取定义channel的特性，Standard支持直播和点播源，Basic只支持点播源编排。
 * @method void setTier(string $Tier) 设置定义channel的特性，Standard支持直播和点播源，Basic只支持点播源编排。
 * @method string getPlaybackMode() 获取频道中的source切换的模式，分Linear线性和Loop循环，直播只支持Linear。
 * @method void setPlaybackMode(string $PlaybackMode) 设置频道中的source切换的模式，分Linear线性和Loop循环，直播只支持Linear。
 * @method boolean getTimeShiftEnable() 获取时移开启开关。
 * @method void setTimeShiftEnable(boolean $TimeShiftEnable) 设置时移开启开关。
 * @method TimeShiftInfo getTimeShiftConf() 获取时移配置。	
 * @method void setTimeShiftConf(TimeShiftInfo $TimeShiftConf) 设置时移配置。	
 * @method SlateInfo getSlateConf() 获取垫片配置。	
 * @method void setSlateConf(SlateInfo $SlateConf) 设置垫片配置。	
...
class ModifyStreamPackageLinearAssemblyChannelRequest extends AbstractModel
{
    ...
    /**
     * @var string 定义channel的特性，Standard支持直播和点播源，Basic只支持点播源编排。
     */
    public $Tier;

    /**
     * @var string 频道中的source切换的模式，分Linear线性和Loop循环，直播只支持Linear。
     */
    public $PlaybackMode;
     ...
     * @param string $Tier 定义channel的特性，Standard支持直播和点播源，Basic只支持点播源编排。
     * @param string $PlaybackMode 频道中的source切换的模式，分Linear线性和Loop循环，直播只支持Linear。
     * @param boolean $TimeShiftEnable 时移开启开关。
     * @param TimeShiftInfo $TimeShiftConf 时移配置。	
     * @param SlateInfo $SlateConf 垫片配置。	

 ...
 * @method integer getIsInComplete() 获取字段是否不完整
0 字段正常
1 字段不完整
 * @method void setIsInComplete(integer $IsInComplete) 设置字段是否不完整
0 字段正常
1 字段不完整
 * @method integer getIsReflect() 获取字段反光
0 字段正常
1 字段有反光
 * @method void setIsReflect(integer $IsReflect) 设置字段反光
0 字段正常
1 字段有反光
 */
...
1 字段有反光
     ...
     * @param integer $IsInComplete 字段是否不完整
0 字段正常
1 字段不完整
     * @param integer $IsReflect 字段反光
0 字段正常
1 字段有反光
     */

 ...
 * @method string getNeedRelievedFlowId() 获取<p>待解除的签署流程编号（即原签署流程的编号）。</p>
 * @method void setNeedRelievedFlowId(string $NeedRelievedFlowId) 设置<p>待解除的签署流程编号（即原签署流程的编号）。</p>
...
class CreateReleaseFlowRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>待解除的签署流程编号（即原签署流程的编号）。</p>
     */
     ...
     * @param string $NeedRelievedFlowId <p>待解除的签署流程编号（即原签署流程的编号）。</p>

 ...
 *
 * @method string getReportUrl() 获取下载url
 * @method void setReportUrl(string $ReportUrl) 设置下载url
 * @method string getCode() 获取code
 * @method void setCode(string $Code) 设置code
 ...
 */
class DescribeVerifyReportResponse extends AbstractModel
{
    /**
     * @var string 下载url
     */

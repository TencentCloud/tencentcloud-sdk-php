...
注意：此字段可能返回 null，表示取不到有效值。
 * @method QueryOpenBankDailyReceiptDownloadUrlResult getResult() 获取按日期查询回单下载地址响应对象。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(QueryOpenBankDailyReceiptDownloadUrlResult $Result) 设置按日期查询回单下载地址响应对象。
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var QueryOpenBankDailyReceiptDownloadUrlResult 按日期查询回单下载地址响应对象。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param QueryOpenBankDailyReceiptDownloadUrlResult $Result 按日期查询回单下载地址响应对象。
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new QueryOpenBankDailyReceiptDownloadUrlResult();

 ...
 * @method PagerDutyRobotNoticeTmpl getTemplate() 获取自定义PagerDutyRobot内容模板
 * @method void setTemplate(PagerDutyRobotNoticeTmpl $Template) 设置自定义PagerDutyRobot内容模板
 */
class PagerDutyRobotNoticeTmplMatcher extends AbstractModel
{
    /**
    ...
    /**
     * @var PagerDutyRobotNoticeTmpl 自定义PagerDutyRobot内容模板
     */
    public $Template;

    /**
     * @param array $MatchingStatus 匹配状态 Invalid; Trigger 告警触发; Recovery 告警恢复
     * @param PagerDutyRobotNoticeTmpl $Template 自定义PagerDutyRobot内容模板
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Template",$param) and $param["Template"] !== null) {
            $this->Template = new PagerDutyRobotNoticeTmpl();

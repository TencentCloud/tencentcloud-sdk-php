 ...
 * @method array getConfigs() 获取<p>批量查询的路由配置列表</p><p>入参限制：批量上限为 32 条</p>
 * @method void setConfigs(array $Configs) 设置<p>批量查询的路由配置列表</p><p>入参限制：批量上限为 32 条</p>
 */
class DescribeConsumerRouteConfigsRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var array <p>批量查询的路由配置列表</p><p>入参限制：批量上限为 32 条</p>
     */
    public $Configs;
     ...
     * @param array $Configs <p>批量查询的路由配置列表</p><p>入参限制：批量上限为 32 条</p>
     */

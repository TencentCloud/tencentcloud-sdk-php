...
lifeState：
    按照任务状态过滤，当前支持process， done
 */
class DescribeEtcdTasksRequest extends AbstractModel
{
    /**
     * @var string 任务ID
     */

 ...
 * TextToSpeech请求参数结构体
 *
 * @method string getText() 获取<p>需要转语音的文字内容，最大支持2000字符</p>
 * @method void setText(string $Text) 设置<p>需要转语音的文字内容，最大支持2000字符</p>
 ...
 * @method integer getAlignmentMode() 获取<p>字幕级别</p><p>枚举值：</p><ul><li>0： 无字幕</li><li>1： 句子级别字幕</li><li>2： 词级别字幕，目前只有flow_01_ex支持词级别字幕</li></ul><p>默认值：0</p>
 * @method void setAlignmentMode(integer $AlignmentMode) 设置<p>字幕级别</p><p>枚举值：</p><ul><li>0： 无字幕</li><li>1： 句子级别字幕</li><li>2： 词级别字幕，目前只有flow_01_ex支持词级别字幕</li></ul><p>默认值：0</p>
...
{
    /**
     * @var string <p>需要转语音的文字内容，最大支持2000字符</p>
     */
    public $Text;
    ...
    /**
     * @var integer <p>字幕级别</p><p>枚举值：</p><ul><li>0： 无字幕</li><li>1： 句子级别字幕</li><li>2： 词级别字幕，目前只有flow_01_ex支持词级别字幕</li></ul><p>默认值：0</p>
     */
    ...
    /**
     * @param string $Text <p>需要转语音的文字内容，最大支持2000字符</p>
     ...
     * @param integer $AlignmentMode <p>字幕级别</p><p>枚举值：</p><ul><li>0： 无字幕</li><li>1： 句子级别字幕</li><li>2： 词级别字幕，目前只有flow_01_ex支持词级别字幕</li></ul><p>默认值：0</p>

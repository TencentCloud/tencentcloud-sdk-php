 ...
 * @method array getExternalLabels() 获取新的external_labels
 * @method void setExternalLabels(array $ExternalLabels) 设置新的external_labels
 */
class ModifyPrometheusAgentExternalLabelsRequest extends AbstractModel
{
     ...
     * @param array $ExternalLabels 新的external_labels
     */

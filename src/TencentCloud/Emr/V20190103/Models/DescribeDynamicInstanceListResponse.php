...
class DescribeDynamicInstanceListResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("DynamicInstanceList",$param) and $param["DynamicInstanceList"] !== null) {
            $this->DynamicInstanceList = [];
            foreach ($param["DynamicInstanceList"] as $key => $value){
                $obj = new RayCluster();

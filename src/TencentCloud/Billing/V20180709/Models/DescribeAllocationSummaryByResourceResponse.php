 ...
 * @method array getDetail() 获取<p>分账账单按资源汇总明细</p>
 * @method void setDetail(array $Detail) 设置<p>分账账单按资源汇总明细</p>
...
class DescribeAllocationSummaryByResourceResponse extends AbstractModel
{
     ...
     * @param array $Detail <p>分账账单按资源汇总明细</p>

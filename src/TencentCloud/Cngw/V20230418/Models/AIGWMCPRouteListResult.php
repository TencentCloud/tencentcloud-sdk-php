 ...
 * MCP 路由列表分页查询结果
 *
 * @method array getDataList() 获取<p>路由列表</p>
 * @method void setDataList(array $DataList) 设置<p>路由列表</p>
 * @method integer getTotalCount() 获取<p>总数</p>
 * @method void setTotalCount(integer $TotalCount) 设置<p>总数</p>
 */
class AIGWMCPRouteListResult extends AbstractModel
{
    /**
     * @var array <p>路由列表</p>
     */

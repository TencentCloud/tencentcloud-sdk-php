 ...
 * @method integer getAccountGroupId() 获取分组id
 * @method void setAccountGroupId(integer $AccountGroupId) 设置分组id
 */
class GrantResourceOperationByAccountGroups extends AbstractModel
{
    /**
     ...
     * @param integer $AccountGroupId 分组id
     */

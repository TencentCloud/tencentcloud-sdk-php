 ...
 * @method string getName() 获取<p>AI 网关 LLM 模型 API 的唯一标识名称，格式规则：2-50 字符，支持中英文大小写、数字及分隔符（“-”、“_”)，不能以数字和分隔符开头，不能以分隔符结尾。</p>
 * @method void setName(string $Name) 设置<p>AI 网关 LLM 模型 API 的唯一标识名称，格式规则：2-50 字符，支持中英文大小写、数字及分隔符（“-”、“_”)，不能以数字和分隔符开头，不能以分隔符结尾。</p>
 ...
 * @method AIGWLogConfig getLogConfig() 获取<p>模型 API 日志配置。未传时使用默认日志配置。</p>
 * @method void setLogConfig(AIGWLogConfig $LogConfig) 设置<p>模型 API 日志配置。未传时使用默认日志配置。</p>
 * @method AIGWRerankMaxDocumentsConfig getMaxDocumentsConfig() 获取<p>Rerank场景最大文档数限制</p>
 * @method void setMaxDocumentsConfig(AIGWRerankMaxDocumentsConfig $MaxDocumentsConfig) 设置<p>Rerank场景最大文档数限制</p>
...
class CreateCloudNativeAPIGatewayLLMModelAPIRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>AI 网关 LLM 模型 API 的唯一标识名称，格式规则：2-50 字符，支持中英文大小写、数字及分隔符（“-”、“_”)，不能以数字和分隔符开头，不能以分隔符结尾。</p>
     */
    public $Name;
    ...
    /**
     * @var AIGWLogConfig <p>模型 API 日志配置。未传时使用默认日志配置。</p>
     */
    public $LogConfig;

    /**
     * @var AIGWRerankMaxDocumentsConfig <p>Rerank场景最大文档数限制</p>
     */
     ...
     * @param string $Name <p>AI 网关 LLM 模型 API 的唯一标识名称，格式规则：2-50 字符，支持中英文大小写、数字及分隔符（“-”、“_”)，不能以数字和分隔符开头，不能以分隔符结尾。</p>
     ...
     * @param AIGWLogConfig $LogConfig <p>模型 API 日志配置。未传时使用默认日志配置。</p>
     * @param AIGWRerankMaxDocumentsConfig $MaxDocumentsConfig <p>Rerank场景最大文档数限制</p>

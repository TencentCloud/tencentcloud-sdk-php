 ...
 * @method AiReviewPornOcrTaskInput getInput() 获取智能识别 Ocr 文字涉及令人反感的信息的任务输入。
 * @method void setInput(AiReviewPornOcrTaskInput $Input) 设置智能识别 Ocr 文字涉及令人反感的信息的任务输入。
 * @method AiReviewPornOcrTaskOutput getOutput() 获取Ocr 文字智能识别涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewPornOcrTaskOutput $Output) 设置Ocr 文字智能识别涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiReviewTaskPornOcrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPornOcrTaskInput 智能识别 Ocr 文字涉及令人反感的信息的任务输入。
     */
    public $Input;

    /**
     * @var AiReviewPornOcrTaskOutput Ocr 文字智能识别涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiReviewPornOcrTaskInput $Input 智能识别 Ocr 文字涉及令人反感的信息的任务输入。
     * @param AiReviewPornOcrTaskOutput $Output Ocr 文字智能识别涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

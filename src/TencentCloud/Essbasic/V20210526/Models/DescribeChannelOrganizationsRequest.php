 ...
 * @method string getOrganizationOpenId() 获取子客OrganizationOpenId，定向查询某个子客的企业数据。
 * @method void setOrganizationOpenId(string $OrganizationOpenId) 设置子客OrganizationOpenId，定向查询某个子客的企业数据。
 * @method array getAuthorizationStatusList() 获取企业认证状态过滤字段。可值如下：
<ul>
 ...
 * @method void setAuthorizationStatusList(array $AuthorizationStatusList) 设置企业认证状态过滤字段。可值如下：
<ul>
  <li>**"UNVERIFIED"**： 未认证的企业</li>
  <li>**"VERIFYINGLEGALPENDINGAUTHORIZATION"**： 认证中待法人授权的企业</li>
  <li>**"VERIFYINGAUTHORIZATIONFILEPENDING"**： 认证中授权书审核中的企业</li>
...
第三方平台子客企业和员工必须已经经过实名认证
    ...
    /**
     * @var string 子客OrganizationOpenId，定向查询某个子客的企业数据。
     */
    public $OrganizationOpenId;

    /**
     * @var array 企业认证状态过滤字段。可值如下：
<ul>
  <li>**"UNVERIFIED"**： 未认证的企业</li>
  <li>**"VERIFYINGLEGALPENDINGAUTHORIZATION"**： 认证中待法人授权的企业</li>
  <li>**"VERIFYINGAUTHORIZATIONFILEPENDING"**： 认证中授权书审核中的企业</li>
...
第三方平台子客企业和员工必须已经经过实名认证
     ...
     * @param string $OrganizationOpenId 子客OrganizationOpenId，定向查询某个子客的企业数据。
     * @param array $AuthorizationStatusList 企业认证状态过滤字段。可值如下：
<ul>
  <li>**"UNVERIFIED"**： 未认证的企业</li>
  <li>**"VERIFYINGLEGALPENDINGAUTHORIZATION"**： 认证中待法人授权的企业</li>
  <li>**"VERIFYINGAUTHORIZATIONFILEPENDING"**： 认证中授权书审核中的企业</li>

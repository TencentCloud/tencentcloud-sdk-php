 ...
 * 查询策略输出的告警接收人信息
 *
 * @method array getReceiverGroupList() 获取<p>告警接收组id列表</p>
 * @method void setReceiverGroupList(array $ReceiverGroupList) 设置<p>告警接收组id列表</p>
 * @method array getReceiverUserList() 获取<p>告警接收人id列表</p>
 * @method void setReceiverUserList(array $ReceiverUserList) 设置<p>告警接收人id列表</p>
 ...
 * @method string getReceiverType() 获取<p>接收类型。“group”(接收组)或“user”(接收人)</p>
 * @method void setReceiverType(string $ReceiverType) 设置<p>接收类型。“group”(接收组)或“user”(接收人)</p>
 ...
 * @method string getReceiveLanguage() 获取<p>告警发送语言</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setReceiveLanguage(string $ReceiveLanguage) 设置<p>告警发送语言</p>
注意：此字段可能返回 null，表示取不到有效值。
 */
class DescribePolicyGroupInfoReceiverInfo extends AbstractModel
{
    /**
     * @var array <p>告警接收组id列表</p>
     */
    public $ReceiverGroupList;

    /**
     * @var array <p>告警接收人id列表</p>
     */
    ...
    /**
     * @var string <p>接收类型。“group”(接收组)或“user”(接收人)</p>
     */
    public $ReceiverType;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var string <p>告警发送语言</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $ReceiveLanguage;

    /**
     * @param array $ReceiverGroupList <p>告警接收组id列表</p>
     * @param array $ReceiverUserList <p>告警接收人id列表</p>
     ...
     * @param string $ReceiverType <p>接收类型。“group”(接收组)或“user”(接收人)</p>
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param string $ReceiveLanguage <p>告警发送语言</p>
注意：此字段可能返回 null，表示取不到有效值。
     */

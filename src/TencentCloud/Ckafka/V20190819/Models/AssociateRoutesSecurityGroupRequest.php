 ...
 *
 * @method array getInstanceRoutes() 获取绑定路由的列表
 * @method void setInstanceRoutes(array $InstanceRoutes) 设置绑定路由的列表
 * @method string getSecurityGroupId() 获取安全组id
 * @method void setSecurityGroupId(string $SecurityGroupId) 设置安全组id
 */
class AssociateRoutesSecurityGroupRequest extends AbstractModel
{
    /**
     * @var array 绑定路由的列表
     */
    ...
    /**
     * @param array $InstanceRoutes 绑定路由的列表

 ...
 * @method string getDescription() 获取Virtual Host 描述
 * @method void setDescription(string $Description) 设置Virtual Host 描述
...
class ModifyRabbitMQVirtualHostRequest extends AbstractModel
{
     ...
     * @param string $Description Virtual Host 描述

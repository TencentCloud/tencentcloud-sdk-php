 ...
 * @method string getResourceType() 获取支持的资源类型如下,clb,cdn,ddos,waf,apigateway,teo,tke,cos,lighthouse,vod,tcb,tse
 * @method void setResourceType(string $ResourceType) 设置支持的资源类型如下,clb,cdn,ddos,waf,apigateway,teo,tke,cos,lighthouse,vod,tcb,tse
 */
class DescribeHostDeployRecordRequest extends AbstractModel
{
    ...
    /**
     * @var string 支持的资源类型如下,clb,cdn,ddos,waf,apigateway,teo,tke,cos,lighthouse,vod,tcb,tse
     */
    public $ResourceType;
     ...
     * @param string $ResourceType 支持的资源类型如下,clb,cdn,ddos,waf,apigateway,teo,tke,cos,lighthouse,vod,tcb,tse
     */

 ...
 * @method string getDay() 获取清算日期（YYYYMMDD，今天传昨天的日期，每日下午1点后出前一日的账单）
 * @method void setDay(string $Day) 设置清算日期（YYYYMMDD，今天传昨天的日期，每日下午1点后出前一日的账单）
 */
class GetBillDownloadUrlRequest extends AbstractModel
{
    ...
    /**
     * @var string 清算日期（YYYYMMDD，今天传昨天的日期，每日下午1点后出前一日的账单）
     */
    public $Day;
     ...
     * @param string $Day 清算日期（YYYYMMDD，今天传昨天的日期，每日下午1点后出前一日的账单）
     */

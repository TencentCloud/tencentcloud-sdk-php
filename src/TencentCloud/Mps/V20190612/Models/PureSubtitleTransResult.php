 ...
 * 纯字幕翻译结果
 *
 * @method string getStatus() 获取任务状态（有以下三种）： 
- PROCESSING
- SUCCESS 
- FAIL
 * @method void setStatus(string $Status) 设置任务状态（有以下三种）： 
- PROCESSING
- SUCCESS 
- FAIL
 ...
 * @method SmartSubtitleTaskResultInput getInput() 获取翻译任务输入信息。
 * @method void setInput(SmartSubtitleTaskResultInput $Input) 设置翻译任务输入信息。
 * @method PureSubtitleTransResultOutput getOutput() 获取纯字幕翻译输出结果
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(PureSubtitleTransResultOutput $Output) 设置纯字幕翻译输出结果
注意：此字段可能返回 null，表示取不到有效值。
...
- FAIL
    ...
    /**
     * @var SmartSubtitleTaskResultInput 翻译任务输入信息。
     */
    public $Input;

    /**
     * @var PureSubtitleTransResultOutput 纯字幕翻译输出结果
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
    ...
    /**
     * @param string $Status 任务状态（有以下三种）： 
- PROCESSING
- SUCCESS 
- FAIL
     ...
     * @param SmartSubtitleTaskResultInput $Input 翻译任务输入信息。
     * @param PureSubtitleTransResultOutput $Output 纯字幕翻译输出结果
注意：此字段可能返回 null，表示取不到有效值。

 ...
 * 拆条任务输入类型
 *
 * @method integer getDefinition() 获取<p>拆条任务模板 ID。</p>
 * @method void setDefinition(integer $Definition) 设置<p>拆条任务模板 ID。</p>
...
class AiAnalysisTaskSegmentInput extends AbstractModel
{
    ...
    /**
     * @param integer $Definition <p>拆条任务模板 ID。</p>

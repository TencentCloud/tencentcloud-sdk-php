 ...
 * 会话时长明细
 *
 * @method string getSessionTime() 获取会话时间
 * @method void setSessionTime(string $SessionTime) 设置会话时间
 ...
 * @method integer getDeductDuration() 获取抵扣时长:min
 * @method void setDeductDuration(integer $DeductDuration) 设置抵扣时长:min
 */
class DurationDetails extends AbstractModel
{
    /**
     * @var string 会话时间
     */
    ...
    /**
     * @var integer 抵扣时长:min
     */
    public $DeductDuration;

    /**
     * @param string $SessionTime 会话时间
     ...
     * @param integer $DeductDuration 抵扣时长:min
     */

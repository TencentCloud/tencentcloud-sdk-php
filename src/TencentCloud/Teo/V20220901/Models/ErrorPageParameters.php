 ...
 * 自定义错误页面配置参数。
 *
 * @method array getErrorPageParams() 获取自定义错误页面配置列表。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setErrorPageParams(array $ErrorPageParams) 设置自定义错误页面配置列表。
注意：此字段可能返回 null，表示取不到有效值。
 */
class ErrorPageParameters extends AbstractModel
{
    /**
     * @var array 自定义错误页面配置列表。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $ErrorPageParams;

    /**
     * @param array $ErrorPageParams 自定义错误页面配置列表。
注意：此字段可能返回 null，表示取不到有效值。
     */

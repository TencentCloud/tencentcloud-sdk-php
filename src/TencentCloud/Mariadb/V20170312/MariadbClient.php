 ...
 * @method Models\TerminateDedicatedDBInstanceResponse TerminateDedicatedDBInstance(Models\TerminateDedicatedDBInstanceRequest $req) 本接口（IsolateDedicatedDBInstance）用于销毁已隔离的独享云数据库实例。

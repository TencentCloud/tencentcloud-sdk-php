 ...
 * @method AiReviewPoliticalTaskInput getInput() 获取内容审核涉敏任务输入。
 * @method void setInput(AiReviewPoliticalTaskInput $Input) 设置内容审核涉敏任务输入。
 * @method AiReviewPoliticalTaskOutput getOutput() 获取内容审核涉敏任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewPoliticalTaskOutput $Output) 设置内容审核涉敏任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiReviewTaskPoliticalResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPoliticalTaskInput 内容审核涉敏任务输入。
     */
    public $Input;

    /**
     * @var AiReviewPoliticalTaskOutput 内容审核涉敏任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiReviewPoliticalTaskInput $Input 内容审核涉敏任务输入。
     * @param AiReviewPoliticalTaskOutput $Output 内容审核涉敏任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

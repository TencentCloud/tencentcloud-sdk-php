 ...
 *
 * @method array getDuplicateHosts() 获取<p>重复添加的提示列表</p>
 * @method void setDuplicateHosts(array $DuplicateHosts) 设置<p>重复添加的提示列表</p>
...
class AddLoginWhiteListsResponse extends AbstractModel
{
    ...
    /**
     * @param array $DuplicateHosts <p>重复添加的提示列表</p>

 ...
 * DetachPolicy请求参数结构体
 *
 * @method integer getTargetId() 获取解绑策略目标ID。成员Uin或部门ID
 * @method void setTargetId(integer $TargetId) 设置解绑策略目标ID。成员Uin或部门ID
...
{
    /**
     * @var integer 解绑策略目标ID。成员Uin或部门ID
     */
    public $TargetId;
    ...
    /**
     * @param integer $TargetId 解绑策略目标ID。成员Uin或部门ID

 ...
 * 告警通知内容模板支持的变量或者函数
 *
 * @method string getName() 获取变量/函数名称
 * @method void setName(string $Name) 设置变量/函数名称
 ...
 */
class NotificationContentTemplateSupportDetail extends AbstractModel
{
    /**
     * @var string 变量/函数名称
     */

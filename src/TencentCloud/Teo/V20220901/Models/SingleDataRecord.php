 ...
 * @method array getTypeValue() 获取查询维度下具体指标值。
 * @method void setTypeValue(array $TypeValue) 设置查询维度下具体指标值。
 */
class SingleDataRecord extends AbstractModel
{
    ...
    /**
     * @var array 查询维度下具体指标值。
     */
    public $TypeValue;

    /**
     * @param string $TypeKey 查询维度值。
     * @param array $TypeValue 查询维度下具体指标值。
     */

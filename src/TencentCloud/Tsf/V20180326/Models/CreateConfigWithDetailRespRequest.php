 ...
 * @method string getConfigType() 获取配置项值类型，固定值。
 * @method void setConfigType(string $ConfigType) 设置配置项值类型，固定值。
 ...
 */
class CreateConfigWithDetailRespRequest extends AbstractModel
{
    /**
...
- false：关闭
     ...
     * @param string $ConfigType 配置项值类型，固定值。

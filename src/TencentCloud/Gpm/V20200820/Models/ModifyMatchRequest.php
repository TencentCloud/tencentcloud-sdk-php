 ...
 * @method string getNotifyUrl() 获取只支持 http 和 https 协议
 * @method void setNotifyUrl(string $NotifyUrl) 设置只支持 http 和 https 协议
...
class ModifyMatchRequest extends AbstractModel
{
    ...
    /**
     * @var string 只支持 http 和 https 协议
     */
    public $NotifyUrl;
     ...
     * @param string $NotifyUrl 只支持 http 和 https 协议

 ...
 * @method array getLabels() 获取<p>批量查询的消费者标签列表</p><p>入参限制：批量上限为 32 条</p>
 * @method void setLabels(array $Labels) 设置<p>批量查询的消费者标签列表</p><p>入参限制：批量上限为 32 条</p>
 */
class DescribeConsumerLabelRoutesRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var array <p>批量查询的消费者标签列表</p><p>入参限制：批量上限为 32 条</p>
     */
    public $Labels;
     ...
     * @param array $Labels <p>批量查询的消费者标签列表</p><p>入参限制：批量上限为 32 条</p>
     */

 ...
 *
 * @method array getCertTaskIds() 获取证书关联云资源异步任务ID列表
 * @method void setCertTaskIds(array $CertTaskIds) 设置证书关联云资源异步任务ID列表
...
class CreateCertificateBindResourceSyncTaskResponse extends AbstractModel
{
    ...
    /**
     * @param array $CertTaskIds 证书关联云资源异步任务ID列表

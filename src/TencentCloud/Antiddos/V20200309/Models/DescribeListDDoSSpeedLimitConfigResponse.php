 ...
 * @method array getConfigList() 获取访问限速配置列表
 * @method void setConfigList(array $ConfigList) 设置访问限速配置列表
...
class DescribeListDDoSSpeedLimitConfigResponse extends AbstractModel
{
     ...
     * @param array $ConfigList 访问限速配置列表
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ConfigList",$param) and $param["ConfigList"] !== null) {
            ...
            foreach ($param["ConfigList"] as $key => $value){
                $obj = new DDoSSpeedLimitConfigRelation();

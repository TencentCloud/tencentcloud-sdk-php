 ...
 * @method string getTablePhysicalId() 获取表物理id
 * @method void setTablePhysicalId(string $TablePhysicalId) 设置表物理id
 ...
 */
class CreateTaskOutputRegistryRequest extends AbstractModel
{
    /**
     * @var string 任务id
     */
     ...
     * @param string $TablePhysicalId 表物理id

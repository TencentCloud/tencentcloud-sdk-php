 ...
 * @method array getTaskNames() 获取本次批量操作成功任务id，用于审计
 * @method void setTaskNames(array $TaskNames) 设置本次批量操作成功任务id，用于审计
...
class BatchStartIntegrationTasksResponse extends AbstractModel
{
     ...
     * @param array $TaskNames 本次批量操作成功任务id，用于审计

 ...
 *
 * @method array getAddressSet() 获取申请到的弹性公网 IPv6 地址的唯一 ID 列表。
 * @method void setAddressSet(array $AddressSet) 设置申请到的弹性公网 IPv6 地址的唯一 ID 列表。
...
{
    /**
     * @var array 申请到的弹性公网 IPv6 地址的唯一 ID 列表。
     */
    public $AddressSet;
    ...
    /**
     * @param array $AddressSet 申请到的弹性公网 IPv6 地址的唯一 ID 列表。

 ...
 *
 * @method array getTags() 获取SQL相关维度信息
 * @method void setTags(array $Tags) 设置SQL相关维度信息
 * @method array getRecords() 获取链路相关信息
 * @method void setRecords(array $Records) 设置链路相关信息
...
class DescribeApmSQLInjectionDetailResponse extends AbstractModel
{
    ...
    /**
     * @param array $Tags SQL相关维度信息
     * @param array $Records 链路相关信息

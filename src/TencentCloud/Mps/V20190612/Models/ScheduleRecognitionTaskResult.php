 ...
 * @method AiRecognitionTaskInput getInput() 获取识别任务的输入。
 * @method void setInput(AiRecognitionTaskInput $Input) 设置识别任务的输入。
...
class ScheduleRecognitionTaskResult extends AbstractModel
{
    ...
    /**
     * @var AiRecognitionTaskInput 识别任务的输入。
     */
    public $Input;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param AiRecognitionTaskInput $Input 识别任务的输入。

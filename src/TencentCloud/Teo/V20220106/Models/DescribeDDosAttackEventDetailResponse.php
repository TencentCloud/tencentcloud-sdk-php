 ...
 *
 * @method DDosAttackEventDetailData getData() 获取DDos攻击事件详情。
 * @method void setData(DDosAttackEventDetailData $Data) 设置DDos攻击事件详情。
...
{
    /**
     * @var DDosAttackEventDetailData DDos攻击事件详情。
     */
    public $Data;
...
<li>0 ：成功 。</li>
    ...
    /**
     * @param DDosAttackEventDetailData $Data DDos攻击事件详情。
...
<li>0 ：成功 。</li>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Data",$param) and $param["Data"] !== null) {
            $this->Data = new DDosAttackEventDetailData();

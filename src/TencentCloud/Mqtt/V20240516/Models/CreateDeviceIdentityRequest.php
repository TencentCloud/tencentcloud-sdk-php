 ...
 * @method string getStatus() 获取1:ENABLED-可用（默认）
2:DISABLE-不可用
 * @method void setStatus(string $Status) 设置1:ENABLED-可用（默认）
2:DISABLE-不可用
...
class CreateDeviceIdentityRequest extends AbstractModel
{
    ...
    /**
     * @var string 1:ENABLED-可用（默认）
2:DISABLE-不可用
     */
    public $Status;

    /**
     * @var string 主要签名key，不传则由系统自动生成，需要base64编码。
     */
    public $PrimaryKey;

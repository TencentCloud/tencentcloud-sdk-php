 ...
 *
 * @method array getDedicatedClusterIds() 获取要删除的专用集群id
 * @method void setDedicatedClusterIds(array $DedicatedClusterIds) 设置要删除的专用集群id
 */
class DeleteDedicatedClustersRequest extends AbstractModel
{
    /**
     * @var array 要删除的专用集群id
     */
    public $DedicatedClusterIds;

    /**
     * @param array $DedicatedClusterIds 要删除的专用集群id
     */

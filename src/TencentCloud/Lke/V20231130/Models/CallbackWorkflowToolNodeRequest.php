 ...
 *
 * @method string getCallbackToken() 获取ADP调用外部API时,通过HTTP Header(X-ADP-Callback-Token)传递回调CallbackToken
 * @method void setCallbackToken(string $CallbackToken) 设置ADP调用外部API时,通过HTTP Header(X-ADP-Callback-Token)传递回调CallbackToken
 * @method string getResult() 获取回调结果,可选,为JSON字符串
 * @method void setResult(string $Result) 设置回调结果,可选,为JSON字符串
 ...
 */
class CallbackWorkflowToolNodeRequest extends AbstractModel
{
    /**
     * @var string ADP调用外部API时,通过HTTP Header(X-ADP-Callback-Token)传递回调CallbackToken
     */
    public $CallbackToken;

    /**
     * @var string 回调结果,可选,为JSON字符串
     */
    public $Result;
    ...
    /**
     * @param string $CallbackToken ADP调用外部API时,通过HTTP Header(X-ADP-Callback-Token)传递回调CallbackToken
     * @param string $Result 回调结果,可选,为JSON字符串

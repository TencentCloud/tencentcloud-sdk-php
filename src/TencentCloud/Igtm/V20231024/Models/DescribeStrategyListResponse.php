 ...
 *
 * @method array getStrategySet() 获取<p>策略列表</p>
 * @method void setStrategySet(array $StrategySet) 设置<p>策略列表</p>
 ...
 */
class DescribeStrategyListResponse extends AbstractModel
{
    /**
     * @var array <p>策略列表</p>
     */
    ...
    /**
     * @param array $StrategySet <p>策略列表</p>

 ...
 * @method string getKey() 获取键名，长度为 1-512 个字符，支持合法 UTF-8 字符。
 * @method void setKey(string $Key) 设置键名，长度为 1-512 个字符，支持合法 UTF-8 字符。
...
class EdgeKVPutRequest extends AbstractModel
{
    ...
    /**
     * @var string 键名，长度为 1-512 个字符，支持合法 UTF-8 字符。
     */
    public $Key;
     ...
     * @param string $Key 键名，长度为 1-512 个字符，支持合法 UTF-8 字符。

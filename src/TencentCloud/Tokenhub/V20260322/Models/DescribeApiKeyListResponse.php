 ...
 * @method integer getTotalCount() 获取符合条件的 API 密钥总数。
 * @method void setTotalCount(integer $TotalCount) 设置符合条件的 API 密钥总数。
...
class DescribeApiKeyListResponse extends AbstractModel
{
     ...
     * @param integer $TotalCount 符合条件的 API 密钥总数。

 ...
 * @method integer getProgress() 获取音画质重生任务进度，取值范围 [0-100] 。
 * @method void setProgress(integer $Progress) 设置音画质重生任务进度，取值范围 [0-100] 。
 * @method QualityEnhanceTaskInput getInput() 获取音画质重生任务的输入。
 * @method void setInput(QualityEnhanceTaskInput $Input) 设置音画质重生任务的输入。
 * @method QualityEnhanceTaskOutput getOutput() 获取音画质重生任务的输出。
 * @method void setOutput(QualityEnhanceTaskOutput $Output) 设置音画质重生任务的输出。
 * @method MediaMetaData getMetaData() 获取音画质重生输出视频的元信息。
 * @method void setMetaData(MediaMetaData $MetaData) 设置音画质重生输出视频的元信息。
...
<li>70000：内部服务错误，建议重试。</li>
    ...
    /**
     * @var integer 音画质重生任务进度，取值范围 [0-100] 。
     */
    public $Progress;

    /**
     * @var QualityEnhanceTaskInput 音画质重生任务的输入。
     */
    public $Input;

    /**
     * @var QualityEnhanceTaskOutput 音画质重生任务的输出。
     */
    public $Output;

    /**
     * @var MediaMetaData 音画质重生输出视频的元信息。
     */
    public $MetaData;
...
<li>70000：内部服务错误，建议重试。</li>
     ...
     * @param integer $Progress 音画质重生任务进度，取值范围 [0-100] 。
     * @param QualityEnhanceTaskInput $Input 音画质重生任务的输入。
     * @param QualityEnhanceTaskOutput $Output 音画质重生任务的输出。
     * @param MediaMetaData $MetaData 音画质重生输出视频的元信息。

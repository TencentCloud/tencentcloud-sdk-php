 ...
 * @method array getBillDates() 获取<p>日期，用作筛选，PeriodType=day时可传</p>
 * @method void setBillDates(array $BillDates) 设置<p>日期，用作筛选，PeriodType=day时可传</p>
...
class DescribeAllocationSummaryByBusinessRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>日期，用作筛选，PeriodType=day时可传</p>
     */
    public $BillDates;
     ...
     * @param array $BillDates <p>日期，用作筛选，PeriodType=day时可传</p>

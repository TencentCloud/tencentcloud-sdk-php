 ...
 * @method array getRecordList() 获取<p>扫描任务记录列表</p>
 * @method void setRecordList(array $RecordList) 设置<p>扫描任务记录列表</p>
...
class DescribeEDRScanRecordListResponse extends AbstractModel
{
     ...
     * @param array $RecordList <p>扫描任务记录列表</p>

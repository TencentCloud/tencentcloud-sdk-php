 ...
 *
 * @method string getDomain() 获取需要查询的API所属的域名
 * @method void setDomain(string $Domain) 设置需要查询的API所属的域名
 ...
 * @method string getBy() 获取目前支持根据ts_version排序
 * @method void setBy(string $By) 设置目前支持根据ts_version排序
...
class DescribeCCRuleListRequest extends AbstractModel
{
    ...
    /**
     * @param string $Domain 需要查询的API所属的域名
     * @param integer $Offset 偏移
     * @param integer $Limit 容量
     * @param string $By 目前支持根据ts_version排序

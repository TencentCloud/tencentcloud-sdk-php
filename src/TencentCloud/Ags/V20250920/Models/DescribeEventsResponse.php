 ...
 * @method integer getTotalCount() 获取<p>符合条件的事件总数。</p>
 * @method void setTotalCount(integer $TotalCount) 设置<p>符合条件的事件总数。</p>
...
class DescribeEventsResponse extends AbstractModel
{
     ...
     * @param integer $TotalCount <p>符合条件的事件总数。</p>

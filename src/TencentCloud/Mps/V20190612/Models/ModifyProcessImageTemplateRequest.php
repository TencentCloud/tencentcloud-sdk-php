 ...
 * @method string getComment() 获取模板描述信息，长度限制256个字符。
 * @method void setComment(string $Comment) 设置模板描述信息，长度限制256个字符。
 * @method ImageTaskInput getProcessImageTemplate() 获取图片处理模板参数。
 * @method void setProcessImageTemplate(ImageTaskInput $ProcessImageTemplate) 设置图片处理模板参数。
 */
class ModifyProcessImageTemplateRequest extends AbstractModel
{
    ...
    /**
     * @var string 模板描述信息，长度限制256个字符。
     */
    public $Comment;

    /**
     * @var ImageTaskInput 图片处理模板参数。
     */
     ...
     * @param string $Comment 模板描述信息，长度限制256个字符。
     * @param ImageTaskInput $ProcessImageTemplate 图片处理模板参数。
     */

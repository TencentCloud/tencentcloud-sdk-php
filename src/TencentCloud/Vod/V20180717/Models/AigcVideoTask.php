 ...
 * @method AigcVideoTaskInput getInput() 获取<p>AIGC 生视频任务的输入信息。</p>
 * @method void setInput(AigcVideoTaskInput $Input) 设置<p>AIGC 生视频任务的输入信息。</p>
 * @method AigcVideoTaskOutput getOutput() 获取<p>AIGC 生视频任务的输出信息。</p>
 * @method void setOutput(AigcVideoTaskOutput $Output) 设置<p>AIGC 生视频任务的输出信息。</p>
...
class AigcVideoTask extends AbstractModel
{
    ...
    /**
     * @var AigcVideoTaskInput <p>AIGC 生视频任务的输入信息。</p>
     */
    public $Input;

    /**
     * @var AigcVideoTaskOutput <p>AIGC 生视频任务的输出信息。</p>
     */
    public $Output;
     ...
     * @param AigcVideoTaskOutput $Output <p>AIGC 生视频任务的输出信息。</p>

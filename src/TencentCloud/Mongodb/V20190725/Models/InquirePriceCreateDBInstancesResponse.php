 ...
 *
 * @method DBInstancePrice getPrice() 获取<p>价格</p>
 * @method void setPrice(DBInstancePrice $Price) 设置<p>价格</p>
...
class InquirePriceCreateDBInstancesResponse extends AbstractModel
{
    ...
    /**
     * @param DBInstancePrice $Price <p>价格</p>

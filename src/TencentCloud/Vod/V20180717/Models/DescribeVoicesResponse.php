 ...
 * @method integer getTotalCount() 获取<p>可用音色总数</p>
 * @method void setTotalCount(integer $TotalCount) 设置<p>可用音色总数</p>
...
class DescribeVoicesResponse extends AbstractModel
{
     ...
     * @param integer $TotalCount <p>可用音色总数</p>

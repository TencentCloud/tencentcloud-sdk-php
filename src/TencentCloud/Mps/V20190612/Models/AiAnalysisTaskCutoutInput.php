 ...
 * 智能抠图任务输入类型
 *
 * @method integer getDefinition() 获取<p>视频智能抠图模板 ID。</p>
 * @method void setDefinition(integer $Definition) 设置<p>视频智能抠图模板 ID。</p>
...
class AiAnalysisTaskCutoutInput extends AbstractModel
{
    ...
    /**
     * @param integer $Definition <p>视频智能抠图模板 ID。</p>

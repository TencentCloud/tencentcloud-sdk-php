 ...
 * @method integer getType() 获取消息来源(1、分享用户端  2、对话API)
 * @method void setType(integer $Type) 设置消息来源(1、分享用户端  2、对话API)
...
class GetLikeDataCountRequest extends AbstractModel
{
    ...
    /**
     * @var integer 消息来源(1、分享用户端  2、对话API)
     */
    public $Type;
     ...
     * @param integer $Type 消息来源(1、分享用户端  2、对话API)

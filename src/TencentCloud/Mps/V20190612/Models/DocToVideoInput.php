 ...
 * @method string getModelName() 获取<p>文档生成视频模型名称</p><p>枚举值：</p><ul><li>WAND： WAND</li></ul><p>默认值：WAND</p>
 * @method void setModelName(string $ModelName) 设置<p>文档生成视频模型名称</p><p>枚举值：</p><ul><li>WAND： WAND</li></ul><p>默认值：WAND</p>
...
class DocToVideoInput extends AbstractModel
{
    ...
    /**
     * @var string <p>文档生成视频模型名称</p><p>枚举值：</p><ul><li>WAND： WAND</li></ul><p>默认值：WAND</p>
     */
    public $ModelName;
     ...
     * @param string $ModelName <p>文档生成视频模型名称</p><p>枚举值：</p><ul><li>WAND： WAND</li></ul><p>默认值：WAND</p>

 ...
 * @method boolean getWithAsyncResult() 获取是否异步执行，如果异步执行，可使用返回值中的交易TxID查询执行结果
 * @method void setWithAsyncResult(boolean $WithAsyncResult) 设置是否异步执行，如果异步执行，可使用返回值中的交易TxID查询执行结果
 */
class InvokeFabricChaincodeRequest extends AbstractModel
{
    ...
    /**
     * @var boolean 是否异步执行，如果异步执行，可使用返回值中的交易TxID查询执行结果
     */
    public $WithAsyncResult;
     ...
     * @param boolean $WithAsyncResult 是否异步执行，如果异步执行，可使用返回值中的交易TxID查询执行结果
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("WithAsyncResult",$param) and $param["WithAsyncResult"] !== null) {
            $this->WithAsyncResult = $param["WithAsyncResult"];
        }
    }
}

 ...
 * @method string getCheckProtocol() 获取检查协议，可选值 PING TCP HTTP HTTPS
 * @method void setCheckProtocol(string $CheckProtocol) 设置检查协议，可选值 PING TCP HTTP HTTPS
 * @method integer getCheckInterval() 获取检查间隔（秒），可选值 15 60 120 300
 * @method void setCheckInterval(integer $CheckInterval) 设置检查间隔（秒），可选值 15 60 120 300
 * @method integer getTimeout() 获取超时时间，单位:秒，可选值 2  3  5  10
 * @method void setTimeout(integer $Timeout) 设置超时时间，单位:秒，可选值 2  3  5  10
 * @method integer getFailTimes() 获取重试次数，可选值为 0，1，2
 * @method void setFailTimes(integer $FailTimes) 设置重试次数，可选值为 0，1，2
 * @method integer getFailRate() 获取失败比例，可选值为 20 30 40 50 60 70 80 100，默认值为50
 * @method void setFailRate(integer $FailRate) 设置失败比例，可选值为 20 30 40 50 60 70 80 100，默认值为50
 ...
 * @method array getDetectorGroupIds() 获取探测器组id列表
 * @method void setDetectorGroupIds(array $DetectorGroupIds) 设置探测器组id列表
 * @method integer getPingNum() 获取PING 包数目， 当CheckProtocol=ping时必填，可选值 20 50 100
 * @method void setPingNum(integer $PingNum) 设置PING 包数目， 当CheckProtocol=ping时必填，可选值 20 50 100
 * @method integer getTcpPort() 获取检查端口，可选值为1-65535之间的整数
 * @method void setTcpPort(integer $TcpPort) 设置检查端口，可选值为1-65535之间的整数
 ...
 * @method integer getPacketLossRate() 获取丢包率告警阈值，当CheckProtocol=ping时必填，取值在10 30 50 80 90 100
 * @method void setPacketLossRate(integer $PacketLossRate) 设置丢包率告警阈值，当CheckProtocol=ping时必填，取值在10 30 50 80 90 100
 * @method integer getContinuePeriod() 获取持续周期数，可选值1-5
 * @method void setContinuePeriod(integer $ContinuePeriod) 设置持续周期数，可选值1-5
 */
class ModifyMonitorRequest extends AbstractModel
{
    /**
     * @var integer 监控器id
     */
    ...
    /**
     * @var string 检查协议，可选值 PING TCP HTTP HTTPS
     */
    public $CheckProtocol;

    /**
     * @var integer 检查间隔（秒），可选值 15 60 120 300
     */
    public $CheckInterval;

    /**
     * @var integer 超时时间，单位:秒，可选值 2  3  5  10
     */
    public $Timeout;
    ...
    /**
     * @var integer 失败比例，可选值为 20 30 40 50 60 70 80 100，默认值为50
     */
    public $FailRate;
    ...
    /**
     * @var integer PING 包数目， 当CheckProtocol=ping时必填，可选值 20 50 100
     */
    public $PingNum;

    /**
     * @var integer 检查端口，可选值为1-65535之间的整数
     */
    public $TcpPort;
    ...
    /**
     * @var integer 丢包率告警阈值，当CheckProtocol=ping时必填，取值在10 30 50 80 90 100
     */
     ...
     * @param string $CheckProtocol 检查协议，可选值 PING TCP HTTP HTTPS
     * @param integer $CheckInterval 检查间隔（秒），可选值 15 60 120 300
     * @param integer $Timeout 超时时间，单位:秒，可选值 2  3  5  10
     * @param integer $FailTimes 重试次数，可选值为 0，1，2
     * @param integer $FailRate 失败比例，可选值为 20 30 40 50 60 70 80 100，默认值为50
     * @param string $DetectorStyle 监控节点类型，可选值有AUTO INTERNAL OVERSEAS IPV6 ALL
     * @param array $DetectorGroupIds 探测器组id列表
     * @param integer $PingNum PING 包数目， 当CheckProtocol=ping时必填，可选值 20 50 100
     * @param integer $TcpPort 检查端口，可选值为1-65535之间的整数
     ...
     * @param integer $PacketLossRate 丢包率告警阈值，当CheckProtocol=ping时必填，取值在10 30 50 80 90 100

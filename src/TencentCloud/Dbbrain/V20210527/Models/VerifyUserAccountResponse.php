 ...
 *
 * @method string getSessionToken() 获取会话token，有效期为5分钟。
 * @method void setSessionToken(string $SessionToken) 设置会话token，有效期为5分钟。
...
class VerifyUserAccountResponse extends AbstractModel
{
    ...
    /**
     * @param string $SessionToken 会话token，有效期为5分钟。

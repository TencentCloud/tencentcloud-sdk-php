 ...
 * @method integer getVideoTime() 获取音视频通话时长。单位：秒。
 * @method void setVideoTime(integer $VideoTime) 设置音视频通话时长。单位：秒。
 * @method integer getClass1VideoTime() 获取标清视频通话时长。单位：秒。
 * @method void setClass1VideoTime(integer $Class1VideoTime) 设置标清视频通话时长。单位：秒。
 * @method integer getClass2VideoTime() 获取高清视频通话时长。单位：秒。
 * @method void setClass2VideoTime(integer $Class2VideoTime) 设置高清视频通话时长。单位：秒。
 * @method integer getClass3VideoTime() 获取超高清视频通话时长。单位：秒。
 * @method void setClass3VideoTime(integer $Class3VideoTime) 设置超高清视频通话时长。单位：秒。
 * @method integer getAudioTime() 获取音频通话时长。单位：秒。
 * @method void setAudioTime(integer $AudioTime) 设置音频通话时长。单位：秒。
 * @method float getBandwidth() 获取带宽。单位：Mbps。
 * @method void setBandwidth(float $Bandwidth) 设置带宽。单位：Mbps。
 * @method integer getVideo2KTime() 获取2k视频通话时长。单位：秒。
 * @method void setVideo2KTime(integer $Video2KTime) 设置2k视频通话时长。单位：秒。
 * @method integer getVideo4KTime() 获取4k视频通话时长。单位：秒。
 * @method void setVideo4KTime(integer $Video4KTime) 设置4k视频通话时长。单位：秒。
 */
class TrtcTimeNewUsage extends AbstractModel
{
    ...
    /**
     * @var integer 音视频通话时长。单位：秒。
     */
    public $VideoTime;

    /**
     * @var integer 标清视频通话时长。单位：秒。
     */
    public $Class1VideoTime;

    /**
     * @var integer 高清视频通话时长。单位：秒。
     */
    public $Class2VideoTime;

    /**
     * @var integer 超高清视频通话时长。单位：秒。
     */
    public $Class3VideoTime;

    /**
     * @var integer 音频通话时长。单位：秒。
     */
    public $AudioTime;
    ...
    /**
     * @var integer 2k视频通话时长。单位：秒。
     */
    public $Video2KTime;

    /**
     * @var integer 4k视频通话时长。单位：秒。
     */
    public $Video4KTime;
     ...
     * @param integer $VideoTime 音视频通话时长。单位：秒。
     * @param integer $Class1VideoTime 标清视频通话时长。单位：秒。
     * @param integer $Class2VideoTime 高清视频通话时长。单位：秒。
     * @param integer $Class3VideoTime 超高清视频通话时长。单位：秒。
     * @param integer $AudioTime 音频通话时长。单位：秒。
     * @param float $Bandwidth 带宽。单位：Mbps。
     * @param integer $Video2KTime 2k视频通话时长。单位：秒。
     * @param integer $Video4KTime 4k视频通话时长。单位：秒。
     */

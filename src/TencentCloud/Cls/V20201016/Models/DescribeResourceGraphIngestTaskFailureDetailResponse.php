...
/**
 * DescribeResourceGraphIngestTaskFailureDetail返回参数结构体
 *
 * @method string getErrorMessage() 获取<p>接入任务报错信息详情</p>
 * @method void setErrorMessage(string $ErrorMessage) 设置<p>接入任务报错信息详情</p>
 ...
 * @method integer getFirstFailedAt() 获取<p>第一次失败时间</p><p>单位：秒</p>
 * @method void setFirstFailedAt(integer $FirstFailedAt) 设置<p>第一次失败时间</p><p>单位：秒</p>
 ...
 */
class DescribeResourceGraphIngestTaskFailureDetailResponse extends AbstractModel
{
    /**
     * @var string <p>接入任务报错信息详情</p>
     */
    public $ErrorMessage;
    ...
    /**
     * @var integer <p>第一次失败时间</p><p>单位：秒</p>
     */
    ...
    /**
     * @param string $ErrorMessage <p>接入任务报错信息详情</p>
     * @param integer $LastFailedTime <p>最近一次失败时间</p><p>单位：秒</p>
     * @param integer $RetryCount <p>重试次数</p>
     * @param integer $FirstFailedAt <p>第一次失败时间</p><p>单位：秒</p>

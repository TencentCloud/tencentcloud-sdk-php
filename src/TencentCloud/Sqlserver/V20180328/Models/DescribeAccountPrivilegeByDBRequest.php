 ...
 * @method string getAccountName() 获取数据库属于账号名称
 * @method void setAccountName(string $AccountName) 设置数据库属于账号名称
...
class DescribeAccountPrivilegeByDBRequest extends AbstractModel
{
     ...
     * @param string $AccountName 数据库属于账号名称

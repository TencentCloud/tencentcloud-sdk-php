 ...
 * @method string getTableName() 获取<p>Table名称</p>
 * @method void setTableName(string $TableName) 设置<p>Table名称</p>
 */
class DescribeCatalogTableInfoRequest extends AbstractModel
{
    /**
     ...
     * @param string $TableName <p>Table名称</p>
     */

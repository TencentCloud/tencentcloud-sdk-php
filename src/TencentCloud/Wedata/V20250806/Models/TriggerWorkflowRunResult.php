...
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getItems() 获取工作流运行以及相关任务运行信息集合
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setItems(array $Items) 设置工作流运行以及相关任务运行信息集合
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $Items 工作流运行以及相关任务运行信息集合
注意：此字段可能返回 null，表示取不到有效值。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Items",$param) and $param["Items"] !== null) {
            ...
            foreach ($param["Items"] as $key => $value){
                $obj = new TriggerWorkflowRunBrief();

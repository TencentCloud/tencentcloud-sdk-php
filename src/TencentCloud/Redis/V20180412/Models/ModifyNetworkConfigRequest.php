 ...
 * @method integer getRecycle() 获取vip保留时间，单位：天
 * @method void setRecycle(integer $Recycle) 设置vip保留时间，单位：天
 */
class ModifyNetworkConfigRequest extends AbstractModel
{
     ...
     * @param integer $Recycle vip保留时间，单位：天
     */

 ...
 * @method integer getGroupId() 获取分组id, 不传默认全部
 * @method void setGroupId(integer $GroupId) 设置分组id, 不传默认全部
 */
class DescribeDeviceGroupListRequest extends AbstractModel
{
    /**
     * @var string 应用token
     */
     ...
     * @param integer $GroupId 分组id, 不传默认全部
     */

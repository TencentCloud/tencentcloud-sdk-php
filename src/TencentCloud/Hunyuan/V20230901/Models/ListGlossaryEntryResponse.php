 ...
 *
 * @method array getEntries() 获取术语条目列表
 * @method void setEntries(array $Entries) 设置术语条目列表
 * @method integer getTotal() 获取条目总数量
 * @method void setTotal(integer $Total) 设置条目总数量
 ...
 */
class ListGlossaryEntryResponse extends AbstractModel
{
    /**
     * @var array 术语条目列表
     */
    ...
    /**
     * @param array $Entries 术语条目列表
     * @param integer $Total 条目总数量

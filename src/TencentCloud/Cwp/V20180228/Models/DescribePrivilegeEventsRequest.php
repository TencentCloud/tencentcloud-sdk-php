 ...
 * @method string getBy() 获取排序字段：CreateTime-发现时间
 * @method void setBy(string $By) 设置排序字段：CreateTime-发现时间
 */
...
<li>Keywords - String - 是否必填：否 - 关键词(主机IP)</li>
    ...
    /**
     * @var string 排序字段：CreateTime-发现时间
     */
    public $By;
...
<li>Keywords - String - 是否必填：否 - 关键词(主机IP)</li>
     ...
     * @param string $By 排序字段：CreateTime-发现时间
     */

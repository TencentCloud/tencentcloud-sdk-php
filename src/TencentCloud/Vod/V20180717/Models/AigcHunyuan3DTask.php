 ...
 * @method string getErrCodeExt() 获取<p>扩展错误码。</p>
 * @method void setErrCodeExt(string $ErrCodeExt) 设置<p>扩展错误码。</p>
 ...
 * @method AigcHunyuan3DTaskInput getInput() 获取<p>AIGC 混元 3D 任务的输入信息。</p>
 * @method void setInput(AigcHunyuan3DTaskInput $Input) 设置<p>AIGC 混元 3D 任务的输入信息。</p>
 * @method AigcHunyuan3DTaskOutput getOutput() 获取<p>AIGC 混元 3D 任务的输出信息。</p>
 * @method void setOutput(AigcHunyuan3DTaskOutput $Output) 设置<p>AIGC 混元 3D 任务的输出信息。</p>
 ...
 */
class AigcHunyuan3DTask extends AbstractModel
{
    /**
    ...
    /**
     * @var AigcHunyuan3DTaskInput <p>AIGC 混元 3D 任务的输入信息。</p>
     */
    public $Input;

    /**
     * @var AigcHunyuan3DTaskOutput <p>AIGC 混元 3D 任务的输出信息。</p>
     */
    public $Output;
     ...
     * @param string $ErrCodeExt <p>扩展错误码。</p>
     * @param string $Message <p>错误信息。</p>
     * @param integer $Progress <p>任务进度，取值范围 [0-100] 。</p>
     * @param AigcHunyuan3DTaskInput $Input <p>AIGC 混元 3D 任务的输入信息。</p>
     * @param AigcHunyuan3DTaskOutput $Output <p>AIGC 混元 3D 任务的输出信息。</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Input",$param) and $param["Input"] !== null) {
            $this->Input = new AigcHunyuan3DTaskInput();
            $this->Input->deserialize($param["Input"]);
        }

        if (array_key_exists("Output",$param) and $param["Output"] !== null) {
            $this->Output = new AigcHunyuan3DTaskOutput();

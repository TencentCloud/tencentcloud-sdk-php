 ...
 * @method string getType() 获取交换机类型，可选值为Direct, Fanout, Topic
 * @method void setType(string $Type) 设置交换机类型，可选值为Direct, Fanout, Topic
...
class CreateAMQPExchangeRequest extends AbstractModel
{
    ...
    /**
     * @var string 交换机类型，可选值为Direct, Fanout, Topic
     */
    public $Type;
     ...
     * @param string $Type 交换机类型，可选值为Direct, Fanout, Topic

 ...
 * @method boolean getRetProfile() 获取<p>是否返回头像。默认不返回。</p>
 * @method void setRetProfile(boolean $RetProfile) 设置<p>是否返回头像。默认不返回。</p>
 * @method string getCardSide() 获取<p>图片正反面<br>FRONT：正面<br>BACK：反面 （仅支持来往内地通行证反面识别，不支持港澳台通行证反面识别）<br>默认为FRONT</p>
 * @method void setCardSide(string $CardSide) 设置<p>图片正反面<br>FRONT：正面<br>BACK：反面 （仅支持来往内地通行证反面识别，不支持港澳台通行证反面识别）<br>默认为FRONT</p>
 */
class MainlandPermitOCRRequest extends AbstractModel
{
    ...
    /**
     * @var boolean <p>是否返回头像。默认不返回。</p>
     */
    public $RetProfile;

    /**
     * @var string <p>图片正反面<br>FRONT：正面<br>BACK：反面 （仅支持来往内地通行证反面识别，不支持港澳台通行证反面识别）<br>默认为FRONT</p>
     */
    public $CardSide;
     ...
     * @param boolean $RetProfile <p>是否返回头像。默认不返回。</p>
     * @param string $CardSide <p>图片正反面<br>FRONT：正面<br>BACK：反面 （仅支持来往内地通行证反面识别，不支持港澳台通行证反面识别）<br>默认为FRONT</p>
     */

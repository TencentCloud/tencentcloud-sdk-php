 ...
 * @method AiAnalysisTaskFrameTagInput getInput() 获取<p>智能按帧标签任务输入。</p>
 * @method void setInput(AiAnalysisTaskFrameTagInput $Input) 设置<p>智能按帧标签任务输入。</p>
 * @method AiAnalysisTaskFrameTagOutput getOutput() 获取<p>智能按帧标签任务输出。</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiAnalysisTaskFrameTagOutput $Output) 设置<p>智能按帧标签任务输出。</p>
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiAnalysisTaskFrameTagResult extends AbstractModel
{
    ...
    /**
     * @var AiAnalysisTaskFrameTagInput <p>智能按帧标签任务输入。</p>
     */
    public $Input;

    /**
     * @var AiAnalysisTaskFrameTagOutput <p>智能按帧标签任务输出。</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiAnalysisTaskFrameTagInput $Input <p>智能按帧标签任务输入。</p>
     * @param AiAnalysisTaskFrameTagOutput $Output <p>智能按帧标签任务输出。</p>
注意：此字段可能返回 null，表示取不到有效值。
     */

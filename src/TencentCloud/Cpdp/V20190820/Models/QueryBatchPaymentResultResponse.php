 ...
 * @method QueryBatchPaymentResultData getResult() 获取返回响应
 * @method void setResult(QueryBatchPaymentResultData $Result) 设置返回响应
...
class QueryBatchPaymentResultResponse extends AbstractModel
{
    ...
    /**
     * @var QueryBatchPaymentResultData 返回响应
     */
    public $Result;
     ...
     * @param QueryBatchPaymentResultData $Result 返回响应
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new QueryBatchPaymentResultData();

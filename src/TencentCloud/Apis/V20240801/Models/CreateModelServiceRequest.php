 ...
 * @method string getFindHostKeyMethod() 获取<p>会话判断方式</p><p>枚举值：</p><ul><li>fromClientIP： 客户端IP</li><li>fromHeader： 通过header值</li><li>autoDetect： 自动探测</li></ul>
 * @method void setFindHostKeyMethod(string $FindHostKeyMethod) 设置<p>会话判断方式</p><p>枚举值：</p><ul><li>fromClientIP： 客户端IP</li><li>fromHeader： 通过header值</li><li>autoDetect： 自动探测</li></ul>
 * @method string getHostKeyHeaderName() 获取<p>会话判定方式为fromHeader时会话的header名称</p>
 * @method void setHostKeyHeaderName(string $HostKeyHeaderName) 设置<p>会话判定方式为fromHeader时会话的header名称</p>
 * @method boolean getFallbackStatus() 获取<p>是否启用Fallback模型</p>
...
class CreateModelServiceRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>会话判断方式</p><p>枚举值：</p><ul><li>fromClientIP： 客户端IP</li><li>fromHeader： 通过header值</li><li>autoDetect： 自动探测</li></ul>
     */
    public $FindHostKeyMethod;

    /**
     * @var string <p>会话判定方式为fromHeader时会话的header名称</p>
     */
    public $HostKeyHeaderName;

    /**
     * @var boolean <p>是否启用Fallback模型</p>
     */
    public $FallbackStatus;

    /**
     * @var array <p>Fallback模型配置</p>
     */
     ...
     * @param string $FindHostKeyMethod <p>会话判断方式</p><p>枚举值：</p><ul><li>fromClientIP： 客户端IP</li><li>fromHeader： 通过header值</li><li>autoDetect： 自动探测</li></ul>

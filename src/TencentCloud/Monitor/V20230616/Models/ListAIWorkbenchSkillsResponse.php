 ...
 *
 * @method array getSkills() 获取<p>技能列表</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setSkills(array $Skills) 设置<p>技能列表</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Skills",$param) and $param["Skills"] !== null) {
            $this->Skills = [];
            foreach ($param["Skills"] as $key => $value){
                $obj = new SkillInfo();
                $obj->deserialize($value);
                array_push($this->Skills, $obj);
            }
        }

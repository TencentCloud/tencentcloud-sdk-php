 ...
 *
 * @method ResponseCode getSuccess() 获取成功返回的状态码
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setSuccess(ResponseCode $Success) 设置成功返回的状态码
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param ResponseCode $Success 成功返回的状态码
注意：此字段可能返回 null，表示取不到有效值。

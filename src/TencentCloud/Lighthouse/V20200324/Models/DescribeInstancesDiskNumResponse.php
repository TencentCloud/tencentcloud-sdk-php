 ...
 *
 * @method array getAttachDetailSet() 获取挂载信息列表
 * @method void setAttachDetailSet(array $AttachDetailSet) 设置挂载信息列表
 * @method integer getTotalCount() 获取挂载信息数量
 * @method void setTotalCount(integer $TotalCount) 设置挂载信息数量
...
class DescribeInstancesDiskNumResponse extends AbstractModel
{
    ...
    /**
     * @param array $AttachDetailSet 挂载信息列表
     * @param integer $TotalCount 挂载信息数量

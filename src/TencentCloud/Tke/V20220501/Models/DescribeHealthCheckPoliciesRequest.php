 ...
 * @method array getFilters() 获取·  HealthCheckPolicyName
    按照【健康检测策略名称】进行过滤。
    类型：String
    必选：否
 * @method void setFilters(array $Filters) 设置·  HealthCheckPolicyName
    按照【健康检测策略名称】进行过滤。
    类型：String
    必选：否
...
class DescribeHealthCheckPoliciesRequest extends AbstractModel
{
     ...
     * @param array $Filters ·  HealthCheckPolicyName
    按照【健康检测策略名称】进行过滤。
    类型：String
    必选：否

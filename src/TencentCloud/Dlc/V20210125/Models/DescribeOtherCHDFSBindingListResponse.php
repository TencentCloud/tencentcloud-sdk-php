 ...
 *
 * @method array getOtherCHDFSBindingList() 获取非DLC 产品绑定列表
 * @method void setOtherCHDFSBindingList(array $OtherCHDFSBindingList) 设置非DLC 产品绑定列表
...
class DescribeOtherCHDFSBindingListResponse extends AbstractModel
{
    ...
    /**
     * @param array $OtherCHDFSBindingList 非DLC 产品绑定列表

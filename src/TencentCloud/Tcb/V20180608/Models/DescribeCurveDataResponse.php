 ...
 * @method array getTime() 获取各数据点的时间戳数组（Unix 时间戳，秒级），与  ⁠Values⁠  一一对应
 * @method void setTime(array $Time) 设置各数据点的时间戳数组（Unix 时间戳，秒级），与  ⁠Values⁠  一一对应
 ...
 * @method string getStatistics() 获取 聚合方式， ⁠"last"⁠  表示取时间段内最后一个值，“max”表示取时间段内最大值，“avg”表示取时间段内的平均值
 * @method void setStatistics(string $Statistics) 设置 聚合方式， ⁠"last"⁠  表示取时间段内最后一个值，“max”表示取时间段内最大值，“avg”表示取时间段内的平均值
...
class DescribeCurveDataResponse extends AbstractModel
{
    ...
    /**
     * @var array 各数据点的时间戳数组（Unix 时间戳，秒级），与  ⁠Values⁠  一一对应
     */
    public $Time;
    ...
    /**
     * @var string  聚合方式， ⁠"last"⁠  表示取时间段内最后一个值，“max”表示取时间段内最大值，“avg”表示取时间段内的平均值
     */
    public $Statistics;
     ...
     * @param array $Time 各数据点的时间戳数组（Unix 时间戳，秒级），与  ⁠Values⁠  一一对应
     * @param array $NewValues 有效的监控数据, 每个有效监控数据的上报时间可以从时间数组中的对应位置上获取到
     * @param string $Statistics  聚合方式， ⁠"last"⁠  表示取时间段内最后一个值，“max”表示取时间段内最大值，“avg”表示取时间段内的平均值

 ...
 */
class DescribeLiveCloudEffectConfigResponse extends AbstractModel
{
    /**
     * @var array <p>模板生礼物的模板信息列表。</p>
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("EffectTemplateList",$param) and $param["EffectTemplateList"] !== null) {
            $this->EffectTemplateList = [];
            foreach ($param["EffectTemplateList"] as $key => $value){

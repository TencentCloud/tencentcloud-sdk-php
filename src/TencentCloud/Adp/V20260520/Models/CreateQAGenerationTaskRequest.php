 ...
 *
 * @method array getDocIdList() 获取<p>待生成 QA 的文档 ID 列表（数量：1~20）</p>
 * @method void setDocIdList(array $DocIdList) 设置<p>待生成 QA 的文档 ID 列表（数量：1~20）</p>
 * @method string getKbId() 获取<p>所属知识库 ID</p>
 * @method void setKbId(string $KbId) 设置<p>所属知识库 ID</p>
 */
class CreateQAGenerationTaskRequest extends AbstractModel
{
    /**
     * @var array <p>待生成 QA 的文档 ID 列表（数量：1~20）</p>
     */
    public $DocIdList;
    ...
    /**
     * @param array $DocIdList <p>待生成 QA 的文档 ID 列表（数量：1~20）</p>

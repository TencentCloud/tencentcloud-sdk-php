 ...
 * @method string getId() 获取<p>配额 id</p>
 * @method void setId(string $Id) 设置<p>配额 id</p>
 */
class DescribeCloudNativeAPIGatewayAIQuotaRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>配额 id</p>
     */
    public $Id;

    /**
     * @param string $GatewayId <p>网关实例Id</p>
     * @param string $Id <p>配额 id</p>
     */

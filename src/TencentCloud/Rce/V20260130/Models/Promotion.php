 ...
 * @method Coupon getCoupon() 获取<p>优惠券</p>
 * @method void setCoupon(Coupon $Coupon) 设置<p>优惠券</p>
 * @method CreditPoint getCreditPoint() 获取<p>积分</p>
 * @method void setCreditPoint(CreditPoint $CreditPoint) 设置<p>积分</p>
 */
class Promotion extends AbstractModel
{
     ...
     * @param Coupon $Coupon <p>优惠券</p>
     * @param CreditPoint $CreditPoint <p>积分</p>
     */

 ...
 *
 * @method string getId() 获取模型ID，TrainingModel ID
 * @method void setId(string $Id) 设置模型ID，TrainingModel ID
...
{
    /**
     * @var string 模型ID，TrainingModel ID
     */
    public $Id;
    ...
    /**
     * @param string $Id 模型ID，TrainingModel ID

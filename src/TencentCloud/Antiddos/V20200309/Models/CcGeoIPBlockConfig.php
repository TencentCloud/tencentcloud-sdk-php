 ...
 * @method array getAreaList() 获取当RegionType为customized时，必须填写AreaList；当RegionType为china或oversea时，AreaList为空
 * @method void setAreaList(array $AreaList) 设置当RegionType为customized时，必须填写AreaList；当RegionType为china或oversea时，AreaList为空
 */
...
alg(人机校验)
    ...
    /**
     * @var array 当RegionType为customized时，必须填写AreaList；当RegionType为china或oversea时，AreaList为空
     */
    public $AreaList;
...
alg(人机校验)
     ...
     * @param array $AreaList 当RegionType为customized时，必须填写AreaList；当RegionType为china或oversea时，AreaList为空
     */

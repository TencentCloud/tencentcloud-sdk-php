 ...
 * @method array getSessionIds() 获取批量删除 会话id 列表
 * @method void setSessionIds(array $SessionIds) 设置批量删除 会话id 列表
 */
class DeleteDataAgentSessionRequest extends AbstractModel
{
     ...
     * @param array $SessionIds 批量删除 会话id 列表
     */

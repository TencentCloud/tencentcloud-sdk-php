 ...
 * base64编码后的代码块
 *
 * @method string getZipFile() 获取包含函数代码的zip格式文件
 * @method void setZipFile(string $ZipFile) 设置包含函数代码的zip格式文件
 ...
 * @method string getCosTimestamp() 获取上传云开发cos后返回的时间戳
 * @method void setCosTimestamp(string $CosTimestamp) 设置上传云开发cos后返回的时间戳
 */
class CodeReq extends AbstractModel
{
    /**
     * @var string 包含函数代码的zip格式文件
     */
    public $ZipFile;
    ...
    /**
     * @var string 上传云开发cos后返回的时间戳
     */
    public $CosTimestamp;

    /**
     * @param string $ZipFile 包含函数代码的zip格式文件
     ...
     * @param string $CosTimestamp 上传云开发cos后返回的时间戳
     */

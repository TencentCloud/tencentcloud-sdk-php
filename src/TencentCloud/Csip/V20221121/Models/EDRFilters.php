 ...
 * @method boolean getExactMatch() 获取<p>是否模糊匹配，前端框架会带上，可以不管</p>
 * @method void setExactMatch(boolean $ExactMatch) 设置<p>是否模糊匹配，前端框架会带上，可以不管</p>
 */
class EDRFilters extends AbstractModel
{
    /**
    ...
    /**
     * @var boolean <p>是否模糊匹配，前端框架会带上，可以不管</p>
     */
    public $ExactMatch;
     ...
     * @param boolean $ExactMatch <p>是否模糊匹配，前端框架会带上，可以不管</p>
     */

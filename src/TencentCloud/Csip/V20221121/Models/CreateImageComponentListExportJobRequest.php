 ...
 *
 * @method string getId() 获取<p>镜像id</p>
 * @method void setId(string $Id) 设置<p>镜像id</p>
 ...
 */
class CreateImageComponentListExportJobRequest extends AbstractModel
{
    /**
     * @var string <p>镜像id</p>
     */

 ...
 *
 * @method ZoneSetting getZoneSetting() 获取站点配置。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setZoneSetting(ZoneSetting $ZoneSetting) 设置站点配置。
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param ZoneSetting $ZoneSetting 站点配置。
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ZoneSetting",$param) and $param["ZoneSetting"] !== null) {
            $this->ZoneSetting = new ZoneSetting();

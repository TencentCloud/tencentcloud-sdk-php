 ...
 * @method float getScore() 获取<p>该问题的质量得分，范围 [0, 100]。</p>
 * @method void setScore(float $Score) 设置<p>该问题的质量得分，范围 [0, 100]。</p>
 * @method float getConfidence() 获取<p>该问题的判断置信度，范围 [0, 100]。</p>
 * @method void setConfidence(float $Confidence) 设置<p>该问题的判断置信度，范围 [0, 100]。</p>
 * @method integer getStartTimeMs() 获取<p>问题起始时间（毫秒）。</p>
 * @method void setStartTimeMs(integer $StartTimeMs) 设置<p>问题起始时间（毫秒）。</p>
 * @method integer getEndTimeMs() 获取<p>问题结束时间（毫秒）</p>
 * @method void setEndTimeMs(integer $EndTimeMs) 设置<p>问题结束时间（毫秒）</p>
...
class LLMDetectionIssue extends AbstractModel
{
    ...
    /**
     * @var float <p>该问题的质量得分，范围 [0, 100]。</p>
     */
    public $Score;

    /**
     * @var float <p>该问题的判断置信度，范围 [0, 100]。</p>
     */
    public $Confidence;

    /**
     * @var integer <p>问题起始时间（毫秒）。</p>
     */
    public $StartTimeMs;

    /**
     * @var integer <p>问题结束时间（毫秒）</p>
     */
    public $EndTimeMs;
     ...
     * @param float $Score <p>该问题的质量得分，范围 [0, 100]。</p>
     * @param float $Confidence <p>该问题的判断置信度，范围 [0, 100]。</p>
     * @param integer $StartTimeMs <p>问题起始时间（毫秒）。</p>
     * @param integer $EndTimeMs <p>问题结束时间（毫秒）</p>

 ...
 * @method SubnetInfo getSubnetInfo() 获取子网信息
 * @method void setSubnetInfo(SubnetInfo $SubnetInfo) 设置子网信息
 */
class DeleteCrossVpcSubnetSupportForClientNodeRequest extends AbstractModel
{
    /**
     * @var string 文件系统ID
     */
     ...
     * @param SubnetInfo $SubnetInfo 子网信息
     */

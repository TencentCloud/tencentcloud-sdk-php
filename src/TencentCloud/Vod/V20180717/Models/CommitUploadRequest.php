 ...
 * CommitUpload请求参数结构体
 *
 * @method string getVodSessionKey() 获取<p>点播会话，取申请上传接口的返回值 VodSessionKey。</p>
 * @method void setVodSessionKey(string $VodSessionKey) 设置<p>点播会话，取申请上传接口的返回值 VodSessionKey。</p>
...
{
    /**
     * @var string <p>点播会话，取申请上传接口的返回值 VodSessionKey。</p>
     */
    ...
    /**
     * @param string $VodSessionKey <p>点播会话，取申请上传接口的返回值 VodSessionKey。</p>

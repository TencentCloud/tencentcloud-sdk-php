 ...
 * @method CasterMarkPicInfo getMarkPicInfo() 获取新的水印信息。
 * @method void setMarkPicInfo(CasterMarkPicInfo $MarkPicInfo) 设置新的水印信息。
 */
class ModifyCasterMarkPicInfoRequest extends AbstractModel
{
    /**
     * @var integer 导播台ID。
     */
    ...
    /**
     * @var CasterMarkPicInfo 新的水印信息。
     */
    public $MarkPicInfo;

    /**
     * @param integer $CasterId 导播台ID。
     * @param CasterMarkPicInfo $MarkPicInfo 新的水印信息。
     */

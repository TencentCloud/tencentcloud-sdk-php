 ...
 *
 * @method array getConfigList() 获取配置列表
 * @method void setConfigList(array $ConfigList) 设置配置列表
 * @method integer getTotalCount() 获取配置数目
 * @method void setTotalCount(integer $TotalCount) 设置配置数目

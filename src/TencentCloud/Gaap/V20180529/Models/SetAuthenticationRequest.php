 ...
 * @method string getRealServerCertificateId() 获取源站CA证书ID，从证书管理页获取。
 * @method void setRealServerCertificateId(string $RealServerCertificateId) 设置源站CA证书ID，从证书管理页获取。
...
默认为0。
     ...
     * @param string $RealServerCertificateId 源站CA证书ID，从证书管理页获取。

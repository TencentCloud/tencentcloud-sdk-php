 ...
 * @method integer getMarkWordIndex() 获取需要删除的文字水印Index。
 * @method void setMarkWordIndex(integer $MarkWordIndex) 设置需要删除的文字水印Index。
 */
class DeleteCasterMarkWordInfoRequest extends AbstractModel
{
    /**
     * @var integer 导播台ID。
     */
    ...
    /**
     * @var integer 需要删除的文字水印Index。
     */
    public $MarkWordIndex;

    /**
     * @param integer $CasterId 导播台ID。
     * @param integer $MarkWordIndex 需要删除的文字水印Index。
     */

 ...
 *
 * @method array getVulInfo() 获取主机漏洞修护信息列表
 * @method void setVulInfo(array $VulInfo) 设置主机漏洞修护信息列表
...
class DescribeCanFixVulMachineResponse extends AbstractModel
{
    ...
    /**
     * @param array $VulInfo 主机漏洞修护信息列表

...
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getPageSize() 获取当前页码数
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setPageSize(integer $PageSize) 设置当前页码数
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getItems() 获取job记录
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setItems(array $Items) 设置job记录
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getPageNumber() 获取当前页条目数
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setPageNumber(integer $PageNumber) 设置当前页条目数
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getRequestId() 获取回溯ID
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setRequestId(string $RequestId) 设置回溯ID
注意：此字段可能返回 null，表示取不到有效值。
 */
class ListBatchJobPages extends AbstractModel
{
    /**
     * @var integer 总条数
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $PageSize 当前页码数
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $Items job记录
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $PageNumber 当前页条目数
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $RequestId 回溯ID
注意：此字段可能返回 null，表示取不到有效值。
     */

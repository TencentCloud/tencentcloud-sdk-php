 ...
 * @method string getTaggingRule() 获取打标策略
 * @method void setTaggingRule(string $TaggingRule) 设置打标策略
 */
class DescribeTagRuleAssetsRequest extends AbstractModel
{
    /**

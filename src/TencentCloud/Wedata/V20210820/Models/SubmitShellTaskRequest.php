 ...
 *
 * @method string getGroupId() 获取执行资源组id
 * @method void setGroupId(string $GroupId) 设置执行资源组id
 ...
 * @method boolean getScriptEncryption() 获取脚本内容是否加密，默认不加膜
 * @method void setScriptEncryption(boolean $ScriptEncryption) 设置脚本内容是否加密，默认不加膜
 */
class SubmitShellTaskRequest extends AbstractModel
{
    /**
     * @var string 执行资源组id
     */
    ...
    /**
     * @var boolean 脚本内容是否加密，默认不加膜
     */
    public $ScriptEncryption;

    /**
     * @param string $GroupId 执行资源组id
     ...
     * @param boolean $ScriptEncryption 脚本内容是否加密，默认不加膜
     */

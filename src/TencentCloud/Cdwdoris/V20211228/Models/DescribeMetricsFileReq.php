 ...
 * @method integer getIfAttention() 获取是否关注
 * @method void setIfAttention(integer $IfAttention) 设置是否关注
 */
class DescribeMetricsFileReq extends AbstractModel
{
    /**
     * @var string 集群类型
     */
     ...
     * @param integer $IfAttention 是否关注
     */

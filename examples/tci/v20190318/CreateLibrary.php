...
// 导入要请求接口对应的Request类
use TencentCloud\Tci\V20190318\Models\CreateLibraryRequest;
use TencentCloud\Tci\V20190318\Models\CreateLibrary;
...
try {
    ...
    $req = new CreateLibraryRequest();
    $req->LibraryName="testfxh2";

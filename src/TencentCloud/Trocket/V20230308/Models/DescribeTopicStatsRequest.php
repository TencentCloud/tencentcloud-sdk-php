 ...
 * @method string getGroupId() 获取<p>消费组ID，可通过DescribeConsumerGroupList接口返回的ConsumerGroup字段或控制台查询</p>
 * @method void setGroupId(string $GroupId) 设置<p>消费组ID，可通过DescribeConsumerGroupList接口返回的ConsumerGroup字段或控制台查询</p>
 ...
 */
class DescribeTopicStatsRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>消费组ID，可通过DescribeConsumerGroupList接口返回的ConsumerGroup字段或控制台查询</p>
     */
    public $GroupId;
     ...
     * @param string $GroupId <p>消费组ID，可通过DescribeConsumerGroupList接口返回的ConsumerGroup字段或控制台查询</p>

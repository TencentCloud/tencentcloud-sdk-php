 ...
 * 用户自定义文本智能识别任务控制参数
 *
 * @method string getSwitch() 获取用户自定文本智能识别任务开关，可选值：
<li>ON：开启自定义文本智能识别任务；</li>
<li>OFF：关闭自定义文本智能识别任务。</li>
 * @method void setSwitch(string $Switch) 设置用户自定文本智能识别任务开关，可选值：
<li>ON：开启自定义文本智能识别任务；</li>
<li>OFF：关闭自定义文本智能识别任务。</li>
 * @method array getLabelSet() 获取用户自定义文本过滤标签，智能识别结果包含选择的标签则返回结果，如果过滤标签为空，则智能识别结果全部返回。如果要使用标签过滤功能，添加自定义文本关键词素材时需要添加对应标签。
标签个数最多 10 个，每个标签长度最多 16 个字符。
 * @method void setLabelSet(array $LabelSet) 设置用户自定义文本过滤标签，智能识别结果包含选择的标签则返回结果，如果过滤标签为空，则智能识别结果全部返回。如果要使用标签过滤功能，添加自定义文本关键词素材时需要添加对应标签。
标签个数最多 10 个，每个标签长度最多 16 个字符。
...
<li>OFF：关闭自定义文本智能识别任务。</li>
    ...
    /**
     * @var array 用户自定义文本过滤标签，智能识别结果包含选择的标签则返回结果，如果过滤标签为空，则智能识别结果全部返回。如果要使用标签过滤功能，添加自定义文本关键词素材时需要添加对应标签。
标签个数最多 10 个，每个标签长度最多 16 个字符。
     */
    public $LabelSet;
    ...
    /**
     * @param string $Switch 用户自定文本智能识别任务开关，可选值：
<li>ON：开启自定义文本智能识别任务；</li>
<li>OFF：关闭自定义文本智能识别任务。</li>
     * @param array $LabelSet 用户自定义文本过滤标签，智能识别结果包含选择的标签则返回结果，如果过滤标签为空，则智能识别结果全部返回。如果要使用标签过滤功能，添加自定义文本关键词素材时需要添加对应标签。
标签个数最多 10 个，每个标签长度最多 16 个字符。

 ...
 * @method integer getIsBestSignal() 获取最优先信号选取策略
 * @method void setIsBestSignal(integer $IsBestSignal) 设置最优先信号选取策略
 */
class CreateTacticRequest extends AbstractModel
{
     ...
     * @param integer $IsBestSignal 最优先信号选取策略
     */

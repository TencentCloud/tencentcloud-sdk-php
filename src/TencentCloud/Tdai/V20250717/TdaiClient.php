 ...
 * @method Models\CreateMemoryPlusSpaceResponse CreateMemoryPlusSpace(Models\CreateMemoryPlusSpaceRequest $req) 本接口（CreateMemoryPlusSpace）用于创建正式版 Memory 实例。
 ...
 * @method Models\DescribeMemoryPlusRecordResponse DescribeMemoryPlusRecord(Models\DescribeMemoryPlusRecordRequest $req) 本接口（DescribeMemoryPlusRecord）用于查询 Memory 实例的记忆数据。
 * @method Models\DescribeMemoryPlusSpaceResponse DescribeMemoryPlusSpace(Models\DescribeMemoryPlusSpaceRequest $req) 本接口（DescribeMemoryPlusSpace）用于查询 Memory 正式版实例详情。
 * @method Models\DescribeMemoryPlusSpacesResponse DescribeMemoryPlusSpaces(Models\DescribeMemoryPlusSpacesRequest $req) 本接口（DescribeMemoryPlusSpaces）用于查询 Memory正式版实例列表。
 * @method Models\DescribeReportUrlResponse DescribeReportUrl(Models\DescribeReportUrlRequest $req) 智能体报告地址生成并下载
 * @method Models\DescribeServiceAccessKeyResponse DescribeServiceAccessKey(Models\DescribeServiceAccessKeyRequest $req) 本接口（DescribeServiceAccessKey）用于查询服务访问密钥。
 * @method Models\DestroyMemoryPlusSpaceResponse DestroyMemoryPlusSpace(Models\DestroyMemoryPlusSpaceRequest $req) 本接口（DestroyMemoryPlusSpace）用于从回收站彻底销毁 Memory 实例。
 ...
 * @method Models\IsolateMemoryPlusSpaceResponse IsolateMemoryPlusSpace(Models\IsolateMemoryPlusSpaceRequest $req) 本接口（IsolateMemoryPlusSpace）用于将正式版 Memory 实例放入回收站隔离。
 ...
 * @method Models\ModifyMemoryPlusSpaceResponse ModifyMemoryPlusSpace(Models\ModifyMemoryPlusSpaceRequest $req) 本接口（ModifyMemoryPlusSpace）用于修改正式版 Memory 实例，可修改实例名称与描述。
 ...
 * @method Models\RecoverMemoryPlusSpaceResponse RecoverMemoryPlusSpace(Models\RecoverMemoryPlusSpaceRequest $req) 本接口（RecoverMemoryPlusSpace）用于从回收站恢复 Memory 实例。

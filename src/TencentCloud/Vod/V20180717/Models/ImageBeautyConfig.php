 ...
 * 图片美颜配置。
 *
 * @method array getBeautyEffectItems() 获取<p>美颜效果项。</p>
 * @method void setBeautyEffectItems(array $BeautyEffectItems) 设置<p>美颜效果项。</p>
 * @method array getBeautyFilterItems() 获取<p>美颜滤镜项。</p>
 * @method void setBeautyFilterItems(array $BeautyFilterItems) 设置<p>美颜滤镜项。</p>
 */
class ImageBeautyConfig extends AbstractModel
{
    ...
    /**
     * @param array $BeautyEffectItems <p>美颜效果项。</p>
     * @param array $BeautyFilterItems <p>美颜滤镜项。</p>
     */

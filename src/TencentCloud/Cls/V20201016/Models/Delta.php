 ...
 * @method string getContent() 获取<p>内容详情</p>
 * @method void setContent(string $Content) 设置<p>内容详情</p>
 ...
 * @method array getToolCalls() 获取<p>模型生成的工具调用。仅支持输出参数返回。<br>对于每一次的输出值应该以Id为标识对Type、Name、Arguments字段进行合并。</p>
 * @method void setToolCalls(array $ToolCalls) 设置<p>模型生成的工具调用。仅支持输出参数返回。<br>对于每一次的输出值应该以Id为标识对Type、Name、Arguments字段进行合并。</p>
 */
class Delta extends AbstractModel
{
    ...
    /**
     * @var array <p>模型生成的工具调用。仅支持输出参数返回。<br>对于每一次的输出值应该以Id为标识对Type、Name、Arguments字段进行合并。</p>
     */
    public $ToolCalls;

    /**
     * @param string $Role <p>角色</p><p>枚举值：</p><ul><li>user： 用户</li><li>assistant： AI助手</li></ul>
     * @param string $Content <p>内容详情</p>
     * @param string $ReasoningContent <p>思维链内容。<br>用于展示模型思考过程，仅深度思考模式可用。仅作为输出参数返回，在进行多轮对话时，无需传入输入参数中。</p>
     * @param array $ToolCalls <p>模型生成的工具调用。仅支持输出参数返回。<br>对于每一次的输出值应该以Id为标识对Type、Name、Arguments字段进行合并。</p>
     */

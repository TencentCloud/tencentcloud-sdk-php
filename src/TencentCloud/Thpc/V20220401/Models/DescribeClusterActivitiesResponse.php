...
class DescribeClusterActivitiesResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ClusterActivitySet",$param) and $param["ClusterActivitySet"] !== null) {
            $this->ClusterActivitySet = [];
            foreach ($param["ClusterActivitySet"] as $key => $value){
                $obj = new ClusterActivity();
                $obj->deserialize($value);
                array_push($this->ClusterActivitySet, $obj);
            }
        }

 ...
 * @method Models\DescribeApplicationListResponse DescribeApplicationList(Models\DescribeApplicationListRequest $req) 本接口(DescribeApplicationList)用于查询自己账号下的应用列表，**默认只返回GME2.0应用，如果还需要包含GME3.0应用请将NewVersion置为1**
 ...
 * @method Models\ModifyRecordInfoResponse ModifyRecordInfo(Models\ModifyRecordInfoRequest $req) 修改录制配置信息

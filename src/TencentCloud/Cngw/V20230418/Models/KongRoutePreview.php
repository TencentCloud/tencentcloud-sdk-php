 ...
 * @method array getMethods() 获取<p>请求方法列表</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setMethods(array $Methods) 设置<p>请求方法列表</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getPaths() 获取<p>路由Paths列表</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setPaths(array $Paths) 设置<p>路由Paths列表</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getHosts() 获取<p>路由Hosts列表</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setHosts(array $Hosts) 设置<p>路由Hosts列表</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getProtocols() 获取<p>协议列表</p>
 * @method void setProtocols(array $Protocols) 设置<p>协议列表</p>
 * @method boolean getPreserveHost() 获取<p>是否保留Host头</p>
 * @method void setPreserveHost(boolean $PreserveHost) 设置<p>是否保留Host头</p>
 ...
 * @method boolean getStripPath() 获取<p>是否去除路径前缀</p>
 * @method void setStripPath(boolean $StripPath) 设置<p>是否去除路径前缀</p>
 * @method string getCreatedTime() 获取<p>创建时间</p>
 * @method void setCreatedTime(string $CreatedTime) 设置<p>创建时间</p>
 * @method boolean getForceHttps() 获取<p>强制转换 https</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setForceHttps(boolean $ForceHttps) 设置<p>强制转换 https</p>
注意：此字段可能返回 null，表示取不到有效值。
 ...
 * @method array getHeaders() 获取<p>headers</p>
 * @method void setHeaders(array $Headers) 设置<p>headers</p>
...
class KongRoutePreview extends AbstractModel
{
    ...
    /**
     * @var array <p>请求方法列表</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Methods;

    /**
     * @var array <p>路由Paths列表</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Paths;

    /**
     * @var array <p>路由Hosts列表</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Hosts;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param array $Methods <p>请求方法列表</p>
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $Paths <p>路由Paths列表</p>
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $Hosts <p>路由Hosts列表</p>
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $Protocols <p>协议列表</p>
     * @param boolean $PreserveHost <p>是否保留Host头</p>
     * @param integer $HttpsRedirectStatusCode <p>HTTPS重定向状态码</p>
     * @param boolean $StripPath <p>是否去除路径前缀</p>
     * @param string $CreatedTime <p>创建时间</p>
     * @param boolean $ForceHttps <p>强制转换 https</p>
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $ServiceName <p>服务名</p>
     * @param string $ServiceID <p>服务ID</p>
     * @param array $DestinationPorts <p>目的端口</p>
     * @param array $Headers <p>headers</p>

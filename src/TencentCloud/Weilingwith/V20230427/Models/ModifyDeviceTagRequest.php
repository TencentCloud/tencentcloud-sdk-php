 ...
 * @method array getSet() 获取设备标签修改信息集合
 * @method void setSet(array $Set) 设置设备标签修改信息集合
 * @method string getApplicationToken() 获取应用token	
 * @method void setApplicationToken(string $ApplicationToken) 设置应用token	
 */
class ModifyDeviceTagRequest extends AbstractModel
{
    /**
     * @var integer 工作空间id
     */

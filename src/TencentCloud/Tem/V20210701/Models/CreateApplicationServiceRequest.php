 ...
 * @method ServicePortMapping getService() 获取访问方式详情
 * @method void setService(ServicePortMapping $Service) 设置访问方式详情
 */
class CreateApplicationServiceRequest extends AbstractModel
{
     ...
     * @param ServicePortMapping $Service 访问方式详情
     */

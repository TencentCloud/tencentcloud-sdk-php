 ...
 * @method string getFileName() 获取带后缀的文件名称，如music.mp3
 * @method void setFileName(string $FileName) 设置带后缀的文件名称，如music.mp3
...
class CreateAudioDepositRequest extends AbstractModel
{
    ...
    /**
     * @var string 带后缀的文件名称，如music.mp3
     */
    public $FileName;
     ...
     * @param string $FileName 带后缀的文件名称，如music.mp3

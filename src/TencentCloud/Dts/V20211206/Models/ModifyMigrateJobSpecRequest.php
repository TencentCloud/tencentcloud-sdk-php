...
class ModifyMigrateJobSpecRequest extends AbstractModel
{
    ...
    /**
     * @var string 新实例规格大小，包括：micro、small、medium、large、xlarge、2xlarge
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("NewInstanceClass",$param) and $param["NewInstanceClass"] !== null) {
            $this->NewInstanceClass = $param["NewInstanceClass"];
        }
    }
}

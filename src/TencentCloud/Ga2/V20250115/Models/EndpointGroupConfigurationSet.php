 ...
 * @method string getListenerId() 获取<p>监听器实例ID。</p>
 * @method void setListenerId(string $ListenerId) 设置<p>监听器实例ID。</p>
 ...
 * @method array getEndpointConfigurations() 获取<p>终端节点信息。</p>
 * @method void setEndpointConfigurations(array $EndpointConfigurations) 设置<p>终端节点信息。</p>
 ...
 * @method integer getUnhealthyThreshold() 获取<p>不健康阈值。</p>
 * @method void setUnhealthyThreshold(integer $UnhealthyThreshold) 设置<p>不健康阈值。</p>
 ...
 * @method string getEndpointGroupType() 获取<p>终端节点组类型。</p>
 * @method void setEndpointGroupType(string $EndpointGroupType) 设置<p>终端节点组类型。</p>
 * @method string getForwardProtocol() 获取<p>回源协议。</p>
 * @method void setForwardProtocol(string $ForwardProtocol) 设置<p>回源协议。</p>
 * @method array getPortOverrides() 获取<p>端口映射信息。</p>
 * @method void setPortOverrides(array $PortOverrides) 设置<p>端口映射信息。</p>
 * @method boolean getVirtualExistForwardingRuleFlag() 获取<p>自定义终端节点组是否绑定七层转发规则。</p>
 * @method void setVirtualExistForwardingRuleFlag(boolean $VirtualExistForwardingRuleFlag) 设置<p>自定义终端节点组是否绑定七层转发规则。</p>
 * @method array getOriginPublicIps() 获取<p>出终端节点组公网IP。</p>
 * @method void setOriginPublicIps(array $OriginPublicIps) 设置<p>出终端节点组公网IP。</p>
 * @method string getIspType() 获取<p>运营商类型；中国移动(CMCC)，中国联通(CUCC)，中国电信(CTCC)。</p>
...
class EndpointGroupConfigurationSet extends AbstractModel
{
    ...
    /**
     * @var array <p>端口映射信息。</p>
     */
    public $PortOverrides;

    /**
     * @var boolean <p>自定义终端节点组是否绑定七层转发规则。</p>
     */
    public $VirtualExistForwardingRuleFlag;

    /**
     * @var array <p>出终端节点组公网IP。</p>
     */
    public $OriginPublicIps;

    /**
     * @var string <p>运营商类型；中国移动(CMCC)，中国联通(CUCC)，中国电信(CTCC)。</p>
     */
    public $IspType;
     ...
     * @param array $EndpointConfigurations <p>终端节点信息。</p>
     ...
     * @param integer $UnhealthyThreshold <p>不健康阈值。</p>
     ...
     * @param string $EndpointGroupType <p>终端节点组类型。</p>
     * @param string $ForwardProtocol <p>回源协议。</p>
     * @param array $PortOverrides <p>端口映射信息。</p>
     * @param boolean $VirtualExistForwardingRuleFlag <p>自定义终端节点组是否绑定七层转发规则。</p>

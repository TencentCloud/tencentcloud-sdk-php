 ...
 *
 * @method array getTagFilters() 获取标签过滤数组，数量最多6个
 * @method void setTagFilters(array $TagFilters) 设置标签过滤数组，数量最多6个
...
class DescribeResourcesByTagsRequest extends AbstractModel
{
    ...
    /**
     * @param array $TagFilters 标签过滤数组，数量最多6个

 ...
 * @method string getAccountName() 获取仿冒公众号名称
 * @method void setAccountName(string $AccountName) 设置仿冒公众号名称
 * @method string getWechatId() 获取公众号ID
 * @method void setWechatId(string $WechatId) 设置公众号ID
 ...
 */
class DisplayFakeWechatOfficial extends AbstractModel
{
    /**
     * @var integer 主键ID
     */
     ...
     * @param string $AccountName 仿冒公众号名称
     * @param string $WechatId 公众号ID
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("WechatId",$param) and $param["WechatId"] !== null) {
            $this->WechatId = $param["WechatId"];
        }

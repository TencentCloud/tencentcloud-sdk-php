 ...
 * @method array getFilters() 获取过滤条件,每次请求的Filters的上限为10，Filter.Values的上限为5
 * @method void setFilters(array $Filters) 设置过滤条件,每次请求的Filters的上限为10，Filter.Values的上限为5
 * @method array getOrderFields() 获取排序方式
 * @method void setOrderFields(array $OrderFields) 设置排序方式
...
class DescribeRuleGroupsByPageRequest extends AbstractModel
{
    ...
    /**
     * @var array 过滤条件,每次请求的Filters的上限为10，Filter.Values的上限为5
     */
    public $Filters;
     ...
     * @param array $Filters 过滤条件,每次请求的Filters的上限为10，Filter.Values的上限为5
     * @param array $OrderFields 排序方式

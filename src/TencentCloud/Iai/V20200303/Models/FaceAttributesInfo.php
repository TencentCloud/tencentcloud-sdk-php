...
- 取值范围：[0~100]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method integer getExpression() 获取微笑。
- 取值说明：[0(normal，正常)~100(laugh，大笑)]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method void setExpression(integer $Expression) 设置微笑。
- 取值说明：[0(normal，正常)~100(laugh，大笑)]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method boolean getGlass() 获取是否有眼镜。
- 取值范围： [true,false]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method void setGlass(boolean $Glass) 设置是否有眼镜。
- 取值范围： [true,false]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
...
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。  
- 建议：人脸入库选择[-20,20]的图片。
 * @method integer getBeauty() 获取魅力。
- 取值范围：[0~100]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method void setBeauty(integer $Beauty) 设置魅力。
- 取值范围：[0~100]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
 * @method boolean getHat() 获取是否有帽子。
- 取值范围： [true,false]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setHat(boolean $Hat) 设置是否有帽子。
- 取值范围： [true,false]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
注意：此字段可能返回 null，表示取不到有效值。
 * @method boolean getMask() 获取是否有口罩。
- 取值范围： [true,false]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setMask(boolean $Mask) 设置是否有口罩。
- 取值范围： [true,false]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
注意：此字段可能返回 null，表示取不到有效值。
...
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
注意：此字段可能返回 null，表示取不到有效值。
 * @method boolean getEyeOpen() 获取双眼是否睁开。
- 取值范围： [true,false]。
- 只要有超过一只眼睛闭眼，就返回false。
-  NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setEyeOpen(boolean $EyeOpen) 设置双眼是否睁开。
- 取值范围： [true,false]。
- 只要有超过一只眼睛闭眼，就返回false。
-  NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
注意：此字段可能返回 null，表示取不到有效值。
...
- 取值范围：[0~100]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param integer $Expression 微笑。
- 取值说明：[0(normal，正常)~100(laugh，大笑)]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param boolean $Glass 是否有眼镜。
- 取值范围： [true,false]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
...
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。  
- 建议：人脸入库选择[-20,20]的图片。
     * @param integer $Beauty 魅力。
- 取值范围：[0~100]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
     * @param boolean $Hat 是否有帽子。
- 取值范围： [true,false]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
注意：此字段可能返回 null，表示取不到有效值。
     * @param boolean $Mask 是否有口罩。
- 取值范围： [true,false]。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
注意：此字段可能返回 null，表示取不到有效值。

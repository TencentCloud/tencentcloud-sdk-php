...
注意：此字段可能返回 null，表示取不到有效值。
 * @method CreateTagTableVO getData() 获取数据
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setData(CreateTagTableVO $Data) 设置数据
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param CreateTagTableVO $Data 数据
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Data",$param) and $param["Data"] !== null) {
            $this->Data = new CreateTagTableVO();

 ...
 * @method string getParameterSize() 获取<p>模型参数量</p>
 * @method void setParameterSize(string $ParameterSize) 设置<p>模型参数量</p>
 ...
 * @method array getSupportedEngines() 获取<p>模型支持的推理引擎列表</p>
 * @method void setSupportedEngines(array $SupportedEngines) 设置<p>模型支持的推理引擎列表</p>
 ...
 */
class GetInferenceModelResponse extends AbstractModel
{
    /**
     * @var string <p>模型ID</p>
     */
     ...
     * @param string $ParameterSize <p>模型参数量</p>
     ...
     * @param array $SupportedEngines <p>模型支持的推理引擎列表</p>

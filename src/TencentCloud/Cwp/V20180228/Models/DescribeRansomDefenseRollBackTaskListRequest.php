 ...
 * @method string getBy() 获取排序字段支持CreateTime、ModifyTime
 * @method void setBy(string $By) 设置排序字段支持CreateTime、ModifyTime
 */
...
<li>Names- String - 主机名称</li>
    ...
    /**
     * @var string 排序字段支持CreateTime、ModifyTime
     */
    public $By;
...
<li>Names- String - 主机名称</li>
     ...
     * @param string $By 排序字段支持CreateTime、ModifyTime
     */

 ...
 * @method SceneAigcImageTaskInput getInput() 获取AIGC 生图任务的输入信息。
 * @method void setInput(SceneAigcImageTaskInput $Input) 设置AIGC 生图任务的输入信息。
 * @method SceneAigcImageTaskOutput getOutput() 获取AIGC 生图任务的输出信息。
 * @method void setOutput(SceneAigcImageTaskOutput $Output) 设置AIGC 生图任务的输出信息。
...
class SceneAigcImageTask extends AbstractModel
{
    ...
    /**
     * @var SceneAigcImageTaskInput AIGC 生图任务的输入信息。
     */
    public $Input;

    /**
     * @var SceneAigcImageTaskOutput AIGC 生图任务的输出信息。
     */
    public $Output;
     ...
     * @param SceneAigcImageTaskInput $Input AIGC 生图任务的输入信息。
     * @param SceneAigcImageTaskOutput $Output AIGC 生图任务的输出信息。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Input",$param) and $param["Input"] !== null) {
            $this->Input = new SceneAigcImageTaskInput();
            $this->Input->deserialize($param["Input"]);
        }

        if (array_key_exists("Output",$param) and $param["Output"] !== null) {
            $this->Output = new SceneAigcImageTaskOutput();

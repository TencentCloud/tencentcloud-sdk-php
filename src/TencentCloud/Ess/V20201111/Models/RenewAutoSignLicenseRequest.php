...
<ul><li> **E_PRESCRIPTION_AUTO_SIGN** :  电子处方场景</li><li> **OTHER** :  通用场景</li></ul>
 * @method UserThreeFactor getUserInfo() 获取需要续期自动签的个人的信息，如姓名，证件信息等。
 * @method void setUserInfo(UserThreeFactor $UserInfo) 设置需要续期自动签的个人的信息，如姓名，证件信息等。
 * @method Agent getAgent() 获取代理企业和员工的信息。
在集团企业代理子企业操作的场景中，需设置此参数。在此情境下，ProxyOrganizationId（子企业的组织ID）为必填项。
 * @method void setAgent(Agent $Agent) 设置代理企业和员工的信息。
在集团企业代理子企业操作的场景中，需设置此参数。在此情境下，ProxyOrganizationId（子企业的组织ID）为必填项。
 */
class RenewAutoSignLicenseRequest extends AbstractModel
{
    /**
...
<ul><li> **E_PRESCRIPTION_AUTO_SIGN** :  电子处方场景</li><li> **OTHER** :  通用场景</li></ul>
    ...
    /**
     * @var UserThreeFactor 需要续期自动签的个人的信息，如姓名，证件信息等。
     */
    public $UserInfo;
...
<ul><li> **E_PRESCRIPTION_AUTO_SIGN** :  电子处方场景</li><li> **OTHER** :  通用场景</li></ul>
     * @param UserThreeFactor $UserInfo 需要续期自动签的个人的信息，如姓名，证件信息等。

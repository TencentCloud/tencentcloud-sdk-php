...
class DescribeUserCosSnapshotListResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("CosSnapshotInfoList",$param) and $param["CosSnapshotInfoList"] !== null) {
            $this->CosSnapshotInfoList = [];
            foreach ($param["CosSnapshotInfoList"] as $key => $value){
                $obj = new CosSnapShotInfo();
                $obj->deserialize($value);
                array_push($this->CosSnapshotInfoList, $obj);
            }
        }

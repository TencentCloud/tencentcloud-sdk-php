 ...
 * @method array getFaceIds() 获取人脸 ID 列表，最多 5 个
 * @method void setFaceIds(array $FaceIds) 设置人脸 ID 列表，最多 5 个
 * @method integer getChannelId() 获取通道 ID，默认值为 0
 * @method void setChannelId(integer $ChannelId) 设置通道 ID，默认值为 0
 */
class CreateTWeSeePersonRequest extends AbstractModel
{
    /**
     * @var string 产品 ID
     */
     ...
     * @param array $FaceIds 人脸 ID 列表，最多 5 个

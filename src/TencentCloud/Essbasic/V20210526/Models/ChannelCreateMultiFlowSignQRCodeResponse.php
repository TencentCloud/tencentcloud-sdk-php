 ...
 * @method SignUrl getSignUrls() 获取<p>一码多签签署码链接信息，适用于客户系统整合二维码功能。通过链接，用户可直接访问电子签名小程序并签署合同。</p>
 * @method void setSignUrls(SignUrl $SignUrls) 设置<p>一码多签签署码链接信息，适用于客户系统整合二维码功能。通过链接，用户可直接访问电子签名小程序并签署合同。</p>
...
class ChannelCreateMultiFlowSignQRCodeResponse extends AbstractModel
{
    ...
    /**
     * @var SignUrl <p>一码多签签署码链接信息，适用于客户系统整合二维码功能。通过链接，用户可直接访问电子签名小程序并签署合同。</p>
     */
    public $SignUrls;
     ...
     * @param SignUrl $SignUrls <p>一码多签签署码链接信息，适用于客户系统整合二维码功能。通过链接，用户可直接访问电子签名小程序并签署合同。</p>

 ...
 * @method array getFilters() 获取<p>过滤条件 IpOrAlias - String - 是否必填：否 - 主机ip或别名筛选</p>
 * @method void setFilters(array $Filters) 设置<p>过滤条件 IpOrAlias - String - 是否必填：否 - 主机ip或别名筛选</p>
 */
class DescribeLoginWhiteHostListRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>过滤条件 IpOrAlias - String - 是否必填：否 - 主机ip或别名筛选</p>
     */
    public $Filters;
     ...
     * @param array $Filters <p>过滤条件 IpOrAlias - String - 是否必填：否 - 主机ip或别名筛选</p>
     */

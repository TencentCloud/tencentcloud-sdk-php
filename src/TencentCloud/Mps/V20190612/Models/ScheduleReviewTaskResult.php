 ...
 * @method AiContentReviewTaskInput getInput() 获取<p>审核任务的输入。</p>
 * @method void setInput(AiContentReviewTaskInput $Input) 设置<p>审核任务的输入。</p>
 * @method array getOutput() 获取<p>审核任务的输出。</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(array $Output) 设置<p>审核任务的输出。</p>
注意：此字段可能返回 null，表示取不到有效值。
...
class ScheduleReviewTaskResult extends AbstractModel
{
    ...
    /**
     * @var AiContentReviewTaskInput <p>审核任务的输入。</p>
     */
    public $Input;

    /**
     * @var array <p>审核任务的输出。</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param AiContentReviewTaskInput $Input <p>审核任务的输入。</p>
     * @param array $Output <p>审核任务的输出。</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Input",$param) and $param["Input"] !== null) {
            $this->Input = new AiContentReviewTaskInput();

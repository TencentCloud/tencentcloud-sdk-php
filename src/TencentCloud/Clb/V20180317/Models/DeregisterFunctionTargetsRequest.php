 ...
 * @method array getFunctionTargets() 获取待解绑的云函数列表。
 * @method void setFunctionTargets(array $FunctionTargets) 设置待解绑的云函数列表。
 * @method string getLocationId() 获取目标转发规则的 ID，当将云函数从七层转发规则上解绑时，必须输入此参数或 Domain+Url 参数。
 * @method void setLocationId(string $LocationId) 设置目标转发规则的 ID，当将云函数从七层转发规则上解绑时，必须输入此参数或 Domain+Url 参数。
...
class DeregisterFunctionTargetsRequest extends AbstractModel
{
    ...
    /**
     * @var string 目标转发规则的 ID，当将云函数从七层转发规则上解绑时，必须输入此参数或 Domain+Url 参数。
     */
    public $LocationId;

 ...
 * @method array getLocalDestinationIpPortTranslationNatRules() 获取目的端口转换规则数组。
 * @method void setLocalDestinationIpPortTranslationNatRules(array $LocalDestinationIpPortTranslationNatRules) 设置目的端口转换规则数组。
 */
class DeletePrivateNatGatewayDestinationIpPortTranslationNatRuleRequest extends AbstractModel
{
    /**
     ...
     * @param array $LocalDestinationIpPortTranslationNatRules 目的端口转换规则数组。
     */

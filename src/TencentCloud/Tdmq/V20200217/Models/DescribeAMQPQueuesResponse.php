 ...
 * @method array getQueues() 获取队列信息列表
 * @method void setQueues(array $Queues) 设置队列信息列表
...
class DescribeAMQPQueuesResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Queues",$param) and $param["Queues"] !== null) {
            $this->Queues = [];
            foreach ($param["Queues"] as $key => $value){
                $obj = new AMQPQueueDetail();
                $obj->deserialize($value);
                array_push($this->Queues, $obj);
            }
        }

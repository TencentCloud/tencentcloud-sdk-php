 ...
 * @method string getResourceConfigId() 获取<p>ResourceConfigId</p>
 * @method void setResourceConfigId(string $ResourceConfigId) 设置<p>ResourceConfigId</p>
 ...
 * @method string getClusterGroup() 获取<p>默认计算组名称</p>
 * @method void setClusterGroup(string $ClusterGroup) 设置<p>默认计算组名称</p>
 ...
 * @method string getAdvancedOptions() 获取<p>高级参数，JSON 字符串</p>
 * @method void setAdvancedOptions(string $AdvancedOptions) 设置<p>高级参数，JSON 字符串</p>
 ...
 * @method string getDispatchStrategy() 获取<p>集群分派策略</p>
 * @method void setDispatchStrategy(string $DispatchStrategy) 设置<p>集群分派策略</p>
 * @method string getSubmissionTarget() 获取<p>作业提交目标：GROUP（按计算组分派）/ CLUSTER（指定集群）/ SERVERLESS（按 Serverless 拉起）</p>
 * @method void setSubmissionTarget(string $SubmissionTarget) 设置<p>作业提交目标：GROUP（按计算组分派）/ CLUSTER（指定集群）/ SERVERLESS（按 Serverless 拉起）</p>
...
class JobSpec extends AbstractModel
{
    ...
    /**
     * @var string <p>ResourceConfigId</p>
     */
    ...
    /**
     * @var string <p>集群分派策略</p>
     */
    public $DispatchStrategy;

    /**
     * @var string <p>作业提交目标：GROUP（按计算组分派）/ CLUSTER（指定集群）/ SERVERLESS（按 Serverless 拉起）</p>
     */
     ...
     * @param string $ResourceConfigId <p>ResourceConfigId</p>
     ...
     * @param string $AdvancedOptions <p>高级参数，JSON 字符串</p>
     * @param array $Tags <p>标签列表（TagKey-TagValue），用于将资源与腾讯云标签系统中的标签绑定</p>
     * @param string $DispatchStrategy <p>集群分派策略</p>
     * @param string $SubmissionTarget <p>作业提交目标：GROUP（按计算组分派）/ CLUSTER（指定集群）/ SERVERLESS（按 Serverless 拉起）</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ClusterGroup",$param) and $param["ClusterGroup"] !== null) {
            $this->ClusterGroup = $param["ClusterGroup"];
        }

 ...
 * @method integer getInstanceTimeRange() 获取<p>作业实例计数时间窗口（毫秒时长）。不传时默认 7 天。</p>
 * @method void setInstanceTimeRange(integer $InstanceTimeRange) 设置<p>作业实例计数时间窗口（毫秒时长）。不传时默认 7 天。</p>
 */
class DescribeJobDefinitionsRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var integer <p>作业实例计数时间窗口（毫秒时长）。不传时默认 7 天。</p>
     */
    public $InstanceTimeRange;
     ...
     * @param integer $InstanceTimeRange <p>作业实例计数时间窗口（毫秒时长）。不传时默认 7 天。</p>
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("InstanceTimeRange",$param) and $param["InstanceTimeRange"] !== null) {
            $this->InstanceTimeRange = $param["InstanceTimeRange"];
        }
    }
}

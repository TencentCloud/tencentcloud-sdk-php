...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("IncAbstract",$param) and $param["IncAbstract"] !== null) {
            $this->IncAbstract = new IncCompareAbstractInfo();
            $this->IncAbstract->deserialize($param["IncAbstract"]);
        }

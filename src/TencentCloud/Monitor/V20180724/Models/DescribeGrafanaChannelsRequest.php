 ...
 * @method integer getChannelState() 获取<p>告警通道状态(不用填写，目前只有可用和删除状态，默认只能查询可用的告警通道)</p>
 * @method void setChannelState(integer $ChannelState) 设置<p>告警通道状态(不用填写，目前只有可用和删除状态，默认只能查询可用的告警通道)</p>
 */
class DescribeGrafanaChannelsRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>告警通道状态(不用填写，目前只有可用和删除状态，默认只能查询可用的告警通道)</p>
     */
    public $ChannelState;
     ...
     * @param integer $ChannelState <p>告警通道状态(不用填写，目前只有可用和删除状态，默认只能查询可用的告警通道)</p>
     */

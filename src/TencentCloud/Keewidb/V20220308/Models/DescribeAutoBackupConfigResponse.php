 ...
 *
 * @method array getWeekDays() 获取自动备份的周期。包括：Monday，Tuesday，Wednesday，Thursday，Friday，Saturday，Sunday。
 * @method void setWeekDays(array $WeekDays) 设置自动备份的周期。包括：Monday，Tuesday，Wednesday，Thursday，Friday，Saturday，Sunday。
 * @method string getTimePeriod() 获取自动备份时间段。
 * @method void setTimePeriod(string $TimePeriod) 设置自动备份时间段。
 * @method integer getBackupStorageDays() 获取全量备份文件保存天数。
 * @method void setBackupStorageDays(integer $BackupStorageDays) 设置全量备份文件保存天数。
 * @method integer getBinlogStorageDays() 获取增量备份文件保存天数。
 * @method void setBinlogStorageDays(integer $BinlogStorageDays) 设置增量备份文件保存天数。
...
{
    /**
     * @var array 自动备份的周期。包括：Monday，Tuesday，Wednesday，Thursday，Friday，Saturday，Sunday。
     */
    public $WeekDays;
    ...
    /**
     * @param array $WeekDays 自动备份的周期。包括：Monday，Tuesday，Wednesday，Thursday，Friday，Saturday，Sunday。
     * @param string $TimePeriod 自动备份时间段。
     * @param integer $BackupStorageDays 全量备份文件保存天数。
     * @param integer $BinlogStorageDays 增量备份文件保存天数。

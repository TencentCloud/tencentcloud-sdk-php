 ...
 * @method integer getDisable() 获取禁用项目，1，禁用，0，启用
 * @method void setDisable(integer $Disable) 设置禁用项目，1，禁用，0，启用
...
class UpdateProjectRequest extends AbstractModel
{
     ...
     * @param integer $Disable 禁用项目，1，禁用，0，启用

 ...
 *
 * @method array getStrategyList() 获取默认策略基础信息列表
 * @method void setStrategyList(array $StrategyList) 设置默认策略基础信息列表
...
class DescribeBaselineDefaultStrategyListResponse extends AbstractModel
{
    ...
    /**
     * @param array $StrategyList 默认策略基础信息列表

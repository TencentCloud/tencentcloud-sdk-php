 ...
 * @method string getFuncName() 获取合约方法名，由合约代码定义
 * @method void setFuncName(string $FuncName) 设置合约方法名，由合约代码定义
 * @method string getFuncParam() 获取合约方法入参，json格式字符串，key/value都是string类型的map，由合约代码定义
 * @method void setFuncParam(string $FuncParam) 设置合约方法入参，json格式字符串，key/value都是string类型的map，由合约代码定义
 */
class QueryChainMakerContractRequest extends AbstractModel
{
    ...
    /**
     * @var string 合约方法名，由合约代码定义
     */
    public $FuncName;

    /**
     * @var string 合约方法入参，json格式字符串，key/value都是string类型的map，由合约代码定义
     */
    public $FuncParam;
     ...
     * @param string $FuncName 合约方法名，由合约代码定义
     * @param string $FuncParam 合约方法入参，json格式字符串，key/value都是string类型的map，由合约代码定义
     */

...
注意：此字段可能返回 null，表示取不到有效值。
 * @method BatchTaskOperateNew getData() 获取批量操作返回结果
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setData(BatchTaskOperateNew $Data) 设置批量操作返回结果
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getRequestId() 获取唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 */
class UpdateBatchTaskParameterResponse extends AbstractModel
{
    /**
     * @var integer 1
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var BatchTaskOperateNew 批量操作返回结果
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Data;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param BatchTaskOperateNew $Data 批量操作返回结果
注意：此字段可能返回 null，表示取不到有效值。

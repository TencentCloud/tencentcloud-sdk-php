 ...
 * @method ConfigFile getConfigFile() 获取配置文件列表详情
 * @method void setConfigFile(ConfigFile $ConfigFile) 设置配置文件列表详情
 */
class CreateConfigFileRequest extends AbstractModel
{
    /**
     * @var string TSE 实例id
     */
    ...
    /**
     * @var ConfigFile 配置文件列表详情
     */
    public $ConfigFile;

    /**
     * @param string $InstanceId TSE 实例id
     * @param ConfigFile $ConfigFile 配置文件列表详情
     */

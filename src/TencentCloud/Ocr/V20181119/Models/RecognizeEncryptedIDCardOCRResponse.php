 ...
 * @method string getEncryptedBody() 获取<p>加密后的数据（Base64编码）</p>
 * @method void setEncryptedBody(string $EncryptedBody) 设置<p>加密后的数据（Base64编码）</p>
...
class RecognizeEncryptedIDCardOCRResponse extends AbstractModel
{
    ...
    /**
     * @var string <p>加密后的数据（Base64编码）</p>
     */
     ...
     * @param string $EncryptedBody <p>加密后的数据（Base64编码）</p>

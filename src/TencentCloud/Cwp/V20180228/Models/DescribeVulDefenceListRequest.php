 ...
 *
 * @method array getFilters() 获取过滤条件：Level、Keywords
 * @method void setFilters(array $Filters) 设置过滤条件：Level、Keywords
 ...
 * @method string getBy() 获取排序列，严格相等：PublishTime发布时间
 * @method void setBy(string $By) 设置排序列，严格相等：PublishTime发布时间
 */
class DescribeVulDefenceListRequest extends AbstractModel
{
    /**
     * @var array 过滤条件：Level、Keywords
     */
    public $Filters;
    ...
    /**
     * @var string 排序列，严格相等：PublishTime发布时间
     */
    public $By;

    /**
     * @param array $Filters 过滤条件：Level、Keywords
     * @param integer $Offset 数据偏移
     * @param integer $Limit 数据限制
     * @param string $Order 排序，大小写无关：asc 升序，desc降序
     * @param string $By 排序列，严格相等：PublishTime发布时间
     */

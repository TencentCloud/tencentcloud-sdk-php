 ...
 * @method integer getClusterStackType() 获取<p>集群堆栈类型</p>
 * @method void setClusterStackType(integer $ClusterStackType) 设置<p>集群堆栈类型</p>
 ...
 */
class DescribeExceptionDetailRequest extends AbstractModel
{
    /**
     * @var string <p>产品Id</p>
     */
    ...
    /**
     * @var integer <p>集群堆栈类型</p>
     */
    public $ClusterStackType;
     ...
     * @param integer $ClusterStackType <p>集群堆栈类型</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ClusterStackType",$param) and $param["ClusterStackType"] !== null) {
            $this->ClusterStackType = $param["ClusterStackType"];
        }

 ...
 * @method string getUserId() 获取原始用户ID
 * @method void setUserId(string $UserId) 设置原始用户ID
 * @method string getToUserId() 获取目标用户ID
 * @method void setToUserId(string $ToUserId) 设置目标用户ID
 */

 ...
 * @method string getWorkflowId() 获取<p>待删除的工作流ID，可通过 ListWorkflows 获取。必填</p>
 * @method void setWorkflowId(string $WorkflowId) 设置<p>待删除的工作流ID，可通过 ListWorkflows 获取。必填</p>
 */
class DeleteWorkflowRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>待删除的工作流ID，可通过 ListWorkflows 获取。必填</p>
     */
    public $WorkflowId;

    /**
     * @param string $WorkspaceId <p>工作空间ID，可通过 ListWorkspaces 获取。必填</p>
     * @param string $WorkflowId <p>待删除的工作流ID，可通过 ListWorkflows 获取。必填</p>
     */

 ...
 * @method string getFileName() 获取带后缀的文件名称，如 test.png
 * @method void setFileName(string $FileName) 设置带后缀的文件名称，如 test.png
...
class CreateImageDepositRequest extends AbstractModel
{
    ...
    /**
     * @var string 带后缀的文件名称，如 test.png
     */
    public $FileName;
     ...
     * @param string $FileName 带后缀的文件名称，如 test.png

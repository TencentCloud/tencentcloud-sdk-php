 ...
 * @method integer getQualityControl() 获取图片质量控制，若图片中包含多张人脸，会对要求处理的人脸进行质量控制判断。  
0: 不进行控制， 
1:较低的质量要求， 
2: 一般的质量要求， 
3: 较高的质量要求。 
 ...
 * @method void setQualityControl(integer $QualityControl) 设置图片质量控制，若图片中包含多张人脸，会对要求处理的人脸进行质量控制判断。  
0: 不进行控制， 
1:较低的质量要求， 
2: 一般的质量要求， 
3: 较高的质量要求。 
...
值越大，需要处理的时间越长。建议不要超过10。
    ...
    /**
     * @var integer 图片质量控制，若图片中包含多张人脸，会对要求处理的人脸进行质量控制判断。  
0: 不进行控制， 
1:较低的质量要求， 
2: 一般的质量要求， 
3: 较高的质量要求。 
...
值越大，需要处理的时间越长。建议不要超过10。
     ...
     * @param integer $QualityControl 图片质量控制，若图片中包含多张人脸，会对要求处理的人脸进行质量控制判断。  
0: 不进行控制， 
1:较低的质量要求， 
2: 一般的质量要求， 
3: 较高的质量要求。 

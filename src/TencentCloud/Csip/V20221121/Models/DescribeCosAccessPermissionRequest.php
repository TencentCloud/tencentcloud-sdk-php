 ...
 * @method string getRelUin() 获取需要查看的uin
 * @method void setRelUin(string $RelUin) 设置需要查看的uin
 * @method Filter getFilter() 获取过滤器
 * @method void setFilter(Filter $Filter) 设置过滤器
 */
class DescribeCosAccessPermissionRequest extends AbstractModel
{
    /**
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("RelUin",$param) and $param["RelUin"] !== null) {
            $this->RelUin = $param["RelUin"];
        }

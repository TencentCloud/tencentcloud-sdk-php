 ...
 * @method integer getStatus() 获取开关，0关闭，1开启
 * @method void setStatus(integer $Status) 设置开关，0关闭，1开启
 * @method string getLimitObject() 获取支持API，Domain。如果基于API，则LimitPaths不能为空，否则LimitPaths为空
 * @method void setLimitObject(string $LimitObject) 设置支持API，Domain。如果基于API，则LimitPaths不能为空，否则LimitPaths为空
 ...
 * @method LimitPath getLimitPaths() 获取限流路径
 * @method void setLimitPaths(LimitPath $LimitPaths) 设置限流路径
 ...
 */
class UpdateRateLimitV2Request extends AbstractModel
{
    /**
     * @var string 域名
     */
    ...
    /**
     * @var integer 开关，0关闭，1开启
     */
    public $Status;

    /**
     * @var string 支持API，Domain。如果基于API，则LimitPaths不能为空，否则LimitPaths为空
     */
    public $LimitObject;
     ...
     * @param integer $Status 开关，0关闭，1开启
     * @param string $LimitObject 支持API，Domain。如果基于API，则LimitPaths不能为空，否则LimitPaths为空
     ...
     * @param LimitPath $LimitPaths 限流路径

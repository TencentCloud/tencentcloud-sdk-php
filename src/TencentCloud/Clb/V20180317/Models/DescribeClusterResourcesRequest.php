 ...
 *
 * @method integer getLimit() 获取返回集群中资源列表数目，默认20，最大值100
 * @method void setLimit(integer $Limit) 设置返回集群中资源列表数目，默认20，最大值100
 * @method integer getOffset() 获取返回集群中资源列表起始偏移量，默认0
 * @method void setOffset(integer $Offset) 设置返回集群中资源列表起始偏移量，默认0
...
{
    /**
     * @var integer 返回集群中资源列表数目，默认20，最大值100
     */
    public $Limit;

    /**
     * @var integer 返回集群中资源列表起始偏移量，默认0
     */
    public $Offset;
...
<li> idle - String 是否必填：否 - （过滤条件）按照是否闲置过滤，如"True","False"。</li>
    ...
    /**
     * @param integer $Limit 返回集群中资源列表数目，默认20，最大值100
     * @param integer $Offset 返回集群中资源列表起始偏移量，默认0

 ...
 * @method string getMsgKey() 获取消息 Key，从 [DescribeMessageList](https://cloud.tencent.com/document/api/1493/114593) 接口或业务日志中获得。
 * @method void setMsgKey(string $MsgKey) 设置消息 Key，从 [DescribeMessageList](https://cloud.tencent.com/document/api/1493/114593) 接口或业务日志中获得。
 ...
 * @method string getTag() 获取消息 Tag，从 [DescribeMessageList](https://cloud.tencent.com/document/api/1493/114593) 接口或业务日志中获得。
 * @method void setTag(string $Tag) 设置消息 Tag，从 [DescribeMessageList](https://cloud.tencent.com/document/api/1493/114593) 接口或业务日志中获得。
 */
class DescribeMessageListRequest extends AbstractModel
{
    ...
    /**
     * @var string 消息 Key，从 [DescribeMessageList](https://cloud.tencent.com/document/api/1493/114593) 接口或业务日志中获得。
     */
    public $MsgKey;
    ...
    /**
     * @var string 消息 Tag，从 [DescribeMessageList](https://cloud.tencent.com/document/api/1493/114593) 接口或业务日志中获得。
     */
    public $Tag;
     ...
     * @param string $MsgKey 消息 Key，从 [DescribeMessageList](https://cloud.tencent.com/document/api/1493/114593) 接口或业务日志中获得。
     * @param integer $RecentMessageNum 查询最近N条消息 最大不超过1024，默认-1为其他查询条件
     * @param boolean $QueryDeadLetterMessage 是否查询死信消息，默认为false
     * @param string $Tag 消息 Tag，从 [DescribeMessageList](https://cloud.tencent.com/document/api/1493/114593) 接口或业务日志中获得。
     */

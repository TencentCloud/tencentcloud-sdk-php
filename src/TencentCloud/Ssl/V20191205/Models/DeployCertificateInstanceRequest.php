 ...
 * @method string getResourceType() 获取证书部署云资源支持的云资源类型：
- clb
- cdn
- ddos
- live
 ...
 * @method void setResourceType(string $ResourceType) 设置证书部署云资源支持的云资源类型：
- clb
- cdn
- ddos
- live
...
- tcb：Type|Region|EnvId|Domain， 例：["AccessService|ap-shanghai|ceshi-4s5h0ymg11c839c7|tencent.com"]
     ...
     * @param string $ResourceType 证书部署云资源支持的云资源类型：
- clb
- cdn
- ddos
- live

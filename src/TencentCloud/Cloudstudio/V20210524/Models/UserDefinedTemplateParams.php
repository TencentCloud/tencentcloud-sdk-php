...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getVersionControlType() 获取模板仓库类型
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setVersionControlType(string $VersionControlType) 设置模板仓库类型
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getVersionControlUrl() 获取模板地址
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setVersionControlUrl(string $VersionControlUrl) 设置模板地址
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $VersionControlType 模板仓库类型
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $VersionControlUrl 模板地址
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 * SetRenewal返回参数结构体
 *
 * @method array getInstanceList() 获取操作失败时的实例列表。
 * @method void setInstanceList(array $InstanceList) 设置操作失败时的实例列表。
...
class SetRenewalResponse extends AbstractModel
{
    ...
    /**
     * @param array $InstanceList 操作失败时的实例列表。

 ...
 * 媒体删除事件。
 *
 * @method array getMaterialIdSet() 获取删除的媒体 Id 列表。
 * @method void setMaterialIdSet(array $MaterialIdSet) 设置删除的媒体 Id 列表。
 */
class MaterialDeletedEvent extends AbstractModel
{
    /**
     * @var array 删除的媒体 Id 列表。
     */
    public $MaterialIdSet;

    /**
     * @param array $MaterialIdSet 删除的媒体 Id 列表。
     */

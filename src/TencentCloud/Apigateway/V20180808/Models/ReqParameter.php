 ...
 * @method string getPosition() 获取API 的前端参数位置，如 head。目前支持 head、qurey、path。
 * @method void setPosition(string $Position) 设置API 的前端参数位置，如 head。目前支持 head、qurey、path。
...
class ReqParameter extends AbstractModel
{
    ...
    /**
     * @var string API 的前端参数位置，如 head。目前支持 head、qurey、path。
     */
    public $Position;
     ...
     * @param string $Position API 的前端参数位置，如 head。目前支持 head、qurey、path。

 ...
 * @method AiReviewTerrorismTaskInput getInput() 获取智能识别涉及令人不安全的信息的任务输入。
 * @method void setInput(AiReviewTerrorismTaskInput $Input) 设置智能识别涉及令人不安全的信息的任务输入。
 * @method AiReviewTerrorismTaskOutput getOutput() 获取智能识别涉及令人不安全的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewTerrorismTaskOutput $Output) 设置智能识别涉及令人不安全的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiReviewTaskTerrorismResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewTerrorismTaskInput 智能识别涉及令人不安全的信息的任务输入。
     */
    public $Input;

    /**
     * @var AiReviewTerrorismTaskOutput 智能识别涉及令人不安全的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiReviewTerrorismTaskInput $Input 智能识别涉及令人不安全的信息的任务输入。
     * @param AiReviewTerrorismTaskOutput $Output 智能识别涉及令人不安全的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

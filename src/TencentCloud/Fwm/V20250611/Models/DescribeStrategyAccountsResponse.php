 ...
 *
 * @method array getAccounts() 获取账号列表
 * @method void setAccounts(array $Accounts) 设置账号列表
 * @method array getAccountGroups() 获取账号组列表
 * @method void setAccountGroups(array $AccountGroups) 设置账号组列表
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeStrategyAccountsResponse extends AbstractModel
{
    /**
     * @var array 账号列表
     */
     ...
     * @param array $AccountGroups 账号组列表
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("AccountGroups",$param) and $param["AccountGroups"] !== null) {
            ...
            foreach ($param["AccountGroups"] as $key => $value){
                $obj = new AccountGroupQuotaDetail();
                $obj->deserialize($value);

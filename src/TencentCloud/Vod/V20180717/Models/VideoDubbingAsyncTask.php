 ...
 * @method string getStatus() 获取<p>任务状态，取值：</p><li>PROCESSING：处理中；</li><li>FINISH：已完成。</li>
 * @method void setStatus(string $Status) 设置<p>任务状态，取值：</p><li>PROCESSING：处理中；</li><li>FINISH：已完成。</li>
 ...
 * @method string getErrCodeExt() 获取<p>错误码，空字符串表示成功，其他值表示失败，取值请参考 <a href="https://cloud.tencent.com/document/product/266/50368#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">视频处理类错误码</a> 列表。</p>
 * @method void setErrCodeExt(string $ErrCodeExt) 设置<p>错误码，空字符串表示成功，其他值表示失败，取值请参考 <a href="https://cloud.tencent.com/document/product/266/50368#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">视频处理类错误码</a> 列表。</p>
 * @method VideoDubbingAsyncInput getInput() 获取<p>视频配音任务输入信息。</p>
 * @method void setInput(VideoDubbingAsyncInput $Input) 设置<p>视频配音任务输入信息。</p>
 * @method VideoDubbingAsyncOutput getOutput() 获取<p>视频配音任务输出信息。</p>
 * @method void setOutput(VideoDubbingAsyncOutput $Output) 设置<p>视频配音任务输出信息。</p>
 ...
 */
class VideoDubbingAsyncTask extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>任务状态，取值：</p><li>PROCESSING：处理中；</li><li>FINISH：已完成。</li>
     */
    public $Status;
    ...
    /**
     * @var string <p>错误码，空字符串表示成功，其他值表示失败，取值请参考 <a href="https://cloud.tencent.com/document/product/266/50368#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">视频处理类错误码</a> 列表。</p>
     */
    public $ErrCodeExt;

    /**
     * @var VideoDubbingAsyncInput <p>视频配音任务输入信息。</p>
     */
    public $Input;

    /**
     * @var VideoDubbingAsyncOutput <p>视频配音任务输出信息。</p>
     */
    public $Output;
     ...
     * @param string $Status <p>任务状态，取值：</p><li>PROCESSING：处理中；</li><li>FINISH：已完成。</li>
     ...
     * @param string $ErrCodeExt <p>错误码，空字符串表示成功，其他值表示失败，取值请参考 <a href="https://cloud.tencent.com/document/product/266/50368#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">视频处理类错误码</a> 列表。</p>
     * @param VideoDubbingAsyncInput $Input <p>视频配音任务输入信息。</p>
     * @param VideoDubbingAsyncOutput $Output <p>视频配音任务输出信息。</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Input",$param) and $param["Input"] !== null) {
            $this->Input = new VideoDubbingAsyncInput();
            $this->Input->deserialize($param["Input"]);
        }

        if (array_key_exists("Output",$param) and $param["Output"] !== null) {
            $this->Output = new VideoDubbingAsyncOutput();

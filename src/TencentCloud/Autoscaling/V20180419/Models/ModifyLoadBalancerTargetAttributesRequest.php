 ...
 * @method array getForwardLoadBalancers() 获取需修改目标规则属性的应用型负载均衡器列表，长度上限为50
 * @method void setForwardLoadBalancers(array $ForwardLoadBalancers) 设置需修改目标规则属性的应用型负载均衡器列表，长度上限为50
 */
class ModifyLoadBalancerTargetAttributesRequest extends AbstractModel
{
    ...
    /**
     * @var array 需修改目标规则属性的应用型负载均衡器列表，长度上限为50
     */
    public $ForwardLoadBalancers;

    /**
     * @param string $AutoScalingGroupId 伸缩组ID
     * @param array $ForwardLoadBalancers 需修改目标规则属性的应用型负载均衡器列表，长度上限为50
     */

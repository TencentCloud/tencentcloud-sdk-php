 ...
 *
 * @method array getSuccessInstanceIds() 获取解除隔离成功实例Id列表
 * @method void setSuccessInstanceIds(array $SuccessInstanceIds) 设置解除隔离成功实例Id列表
 * @method array getFailedInstanceIds() 获取解除隔离失败实例Id列表
 * @method void setFailedInstanceIds(array $FailedInstanceIds) 设置解除隔离失败实例Id列表
...
{
    /**
     * @var array 解除隔离成功实例Id列表
     */
    public $SuccessInstanceIds;

    /**
     * @var array 解除隔离失败实例Id列表
     */
    ...
    /**
     * @param array $SuccessInstanceIds 解除隔离成功实例Id列表
     * @param array $FailedInstanceIds 解除隔离失败实例Id列表

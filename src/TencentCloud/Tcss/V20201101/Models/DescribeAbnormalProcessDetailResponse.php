 ...
 * @method AbnormalProcessEventDescription getEventDetail() 获取事件描述
 * @method void setEventDetail(AbnormalProcessEventDescription $EventDetail) 设置事件描述
...
class DescribeAbnormalProcessDetailResponse extends AbstractModel
{
    ...
    /**
     * @var AbnormalProcessEventDescription 事件描述
     */
    public $EventDetail;

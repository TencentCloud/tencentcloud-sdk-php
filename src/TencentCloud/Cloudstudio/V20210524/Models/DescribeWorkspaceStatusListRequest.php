 ...
 *
 * @method string getCloudStudioSessionTeam() 获取xxx
 * @method void setCloudStudioSessionTeam(string $CloudStudioSessionTeam) 设置xxx
 */
class DescribeWorkspaceStatusListRequest extends AbstractModel
{
    ...
    /**
     * @param string $CloudStudioSessionTeam xxx
     */

 ...
 *
 * @method string getInstanceID() 获取<p>资产唯一id</p>
 * @method void setInstanceID(string $InstanceID) 设置<p>资产唯一id</p>
 * @method string getButtonAction() 获取<p>操作动作：编辑、删除</p>
 * @method void setButtonAction(string $ButtonAction) 设置<p>操作动作：编辑、删除</p>
...
class ModifyIsolateTableRequest extends AbstractModel
{
    ...
    /**
     * @param string $InstanceID <p>资产唯一id</p>
     * @param string $ButtonAction <p>操作动作：编辑、删除</p>

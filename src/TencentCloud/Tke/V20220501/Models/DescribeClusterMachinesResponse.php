 ...
 *
 * @method array getMachines() 获取节点池节点列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setMachines(array $Machines) 设置节点池节点列表
注意：此字段可能返回 null，表示取不到有效值。
 ...
 */
class DescribeClusterMachinesResponse extends AbstractModel
{
    /**
     * @var array 节点池节点列表
注意：此字段可能返回 null，表示取不到有效值。

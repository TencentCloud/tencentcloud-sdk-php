 ...
 *
 * @method array getLayer4Listeners() 获取4层转发监听器列表
 * @method void setLayer4Listeners(array $Layer4Listeners) 设置4层转发监听器列表
 * @method array getLayer7Listeners() 获取7层转发监听器列表
 * @method void setLayer7Listeners(array $Layer7Listeners) 设置7层转发监听器列表
...
class DescribeListListenerResponse extends AbstractModel
{
    ...
    /**
     * @param array $Layer4Listeners 4层转发监听器列表
     * @param array $Layer7Listeners 7层转发监听器列表

 ...
 * @method string getConfigName() 获取名称
 * @method void setConfigName(string $ConfigName) 设置名称
 * @method TalkBasicConfigInfo getBasicConfig() 获取系统基础配置，当需要使用系统三段式配置时配置。
 * @method void setBasicConfig(TalkBasicConfigInfo $BasicConfig) 设置系统基础配置，当需要使用系统三段式配置时配置。
 ...
 */
class ModifyTWeTalkProductConfigV2Request extends AbstractModel
{
    /**
     * @var string 产品ID
     */
    ...
    /**
     * @var TalkBasicConfigInfo 系统基础配置，当需要使用系统三段式配置时配置。
     */
    public $BasicConfig;
     ...
     * @param TalkBasicConfigInfo $BasicConfig 系统基础配置，当需要使用系统三段式配置时配置。

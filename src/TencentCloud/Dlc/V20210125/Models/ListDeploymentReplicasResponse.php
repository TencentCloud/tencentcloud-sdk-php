 ...
 *
 * @method array getItems() 获取<p>副本列表</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setItems(array $Items) 设置<p>副本列表</p>
注意：此字段可能返回 null，表示取不到有效值。
 ...
 */
class ListDeploymentReplicasResponse extends AbstractModel
{
    /**
     * @var array <p>副本列表</p>
注意：此字段可能返回 null，表示取不到有效值。

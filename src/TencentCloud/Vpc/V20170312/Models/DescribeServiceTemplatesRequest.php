 ...
 * @method boolean getNeedMemberInfo() 获取是否获取协议端口成员标识。
 * @method void setNeedMemberInfo(boolean $NeedMemberInfo) 设置是否获取协议端口成员标识。
 * @method string getOrderField() 获取排序字段。支持：`ServiceTemplateId ` `CreatedTime` `UpdateTime`。注意：该字段没有默认值。
 * @method void setOrderField(string $OrderField) 设置排序字段。支持：`ServiceTemplateId ` `CreatedTime` `UpdateTime`。注意：该字段没有默认值。
 ...
 * @method string getMemberOrderField() 获取协议端口排序字段。支持：`Service ` `UpdateTime`。注意：该字段没有默认值。
 * @method void setMemberOrderField(string $MemberOrderField) 设置协议端口排序字段。支持：`Service ` `UpdateTime`。注意：该字段没有默认值。
 * @method string getMemberOrderDirection() 获取协议端口排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
 * @method void setMemberOrderDirection(string $MemberOrderDirection) 设置协议端口排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
 */
...
<li>service-port- 协议端口。</li>
    ...
    /**
     * @var boolean 是否获取协议端口成员标识。
     */
    public $NeedMemberInfo;

    /**
     * @var string 排序字段。支持：`ServiceTemplateId ` `CreatedTime` `UpdateTime`。注意：该字段没有默认值。
     */
    public $OrderField;
    ...
    /**
     * @var string 协议端口排序字段。支持：`Service ` `UpdateTime`。注意：该字段没有默认值。
     */
    public $MemberOrderField;

    /**
     * @var string 协议端口排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
     */
...
<li>service-port- 协议端口。</li>
     ...
     * @param boolean $NeedMemberInfo 是否获取协议端口成员标识。
     * @param string $OrderField 排序字段。支持：`ServiceTemplateId ` `CreatedTime` `UpdateTime`。注意：该字段没有默认值。
     * @param string $OrderDirection 排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
     * @param string $MemberOrderField 协议端口排序字段。支持：`Service ` `UpdateTime`。注意：该字段没有默认值。
     * @param string $MemberOrderDirection 协议端口排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
     */

 ...
 * @method array getDomains() 获取域名集合，不填默认查询所有域名。
 * @method void setDomains(array $Domains) 设置域名集合，不填默认查询所有域名。
 * @method array getQueryCondition() 获取筛选条件。
限速规则日志中取值有：
...
<li>uri ：统一资源标识符 。</li>
 * @method void setQueryCondition(array $QueryCondition) 设置筛选条件。
限速规则日志中取值有：
<li>action ：执行动作（处置方式）；</li>
<li>ruleId ：规则id ；</li>
<li>oriDomain ：被攻击的子域名 ；</li>
...
<li>requestMethod ：请求方法 ；</li>
<li>uri ：统一资源标识符 。</li>
 * @method string getEntityType() 获取日志类型，取值有：
<li>rate ：限速日志 ；</li>
...
<li>acl ：自定义规则日志 。</li>不填默认为rate。
     ...
     * @param array $Domains 域名集合，不填默认查询所有域名。
     * @param array $QueryCondition 筛选条件。
限速规则日志中取值有：
<li>action ：执行动作（处置方式）；</li>
<li>ruleId ：规则id ；</li>
<li>oriDomain ：被攻击的子域名 ；</li>

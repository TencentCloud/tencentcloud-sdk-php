 ...
 * @method string getKnowledgeBaseId() 获取<p>要修改的知识库ID。</p>
 * @method void setKnowledgeBaseId(string $KnowledgeBaseId) 设置<p>要修改的知识库ID。</p>
 * @method string getName() 获取<p>新的知识库名称。长度限制：1-64个字符。</p>
 * @method void setName(string $Name) 设置<p>新的知识库名称。长度限制：1-64个字符。</p>
 * @method string getDescription() 获取<p>新的知识库描述。长度限制：最多256个字符。</p>
 * @method void setDescription(string $Description) 设置<p>新的知识库描述。长度限制：最多256个字符。</p>
 */
class ModifyKnowledgeBaseRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>要修改的知识库ID。</p>
     */
    public $KnowledgeBaseId;

    /**
     * @var string <p>新的知识库名称。长度限制：1-64个字符。</p>
     */
    public $Name;

    /**
     * @var string <p>新的知识库描述。长度限制：最多256个字符。</p>
     */
    public $Description;
     ...
     * @param string $KnowledgeBaseId <p>要修改的知识库ID。</p>
     * @param string $Name <p>新的知识库名称。长度限制：1-64个字符。</p>
     * @param string $Description <p>新的知识库描述。长度限制：最多256个字符。</p>
     */

 ...
 * @method array getDomains() 获取子域名列表，不填默认选择全部全部子域名。
 * @method void setDomains(array $Domains) 设置子域名列表，不填默认选择全部全部子域名。
...
<li>mainland：中国大陆地区数据。</li>不填将根据用户所在地智能选择地区。
     ...
     * @param array $Domains 子域名列表，不填默认选择全部全部子域名。

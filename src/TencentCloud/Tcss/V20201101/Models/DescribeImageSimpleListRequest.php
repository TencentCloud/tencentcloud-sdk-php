 ...
 *
 * @method array getFilters() 获取IsAuthorized 是否已经授权, 0:否 1:是 无:全部
 * @method void setFilters(array $Filters) 设置IsAuthorized 是否已经授权, 0:否 1:是 无:全部
...
{
    /**
     * @var array IsAuthorized 是否已经授权, 0:否 1:是 无:全部
     */
    public $Filters;

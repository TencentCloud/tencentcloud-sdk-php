 ...
 * @method array getBandwidthPackageIds() 获取带宽包Ids(申请数量大于1时有效)
 * @method void setBandwidthPackageIds(array $BandwidthPackageIds) 设置带宽包Ids(申请数量大于1时有效)
...
class CreateBandwidthPackageResponse extends AbstractModel
{
     ...
     * @param array $BandwidthPackageIds 带宽包Ids(申请数量大于1时有效)

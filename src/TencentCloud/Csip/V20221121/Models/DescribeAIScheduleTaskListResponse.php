 ...
 *
 * @method array getTaskSet() 获取<p>任务列表。</p>
 * @method void setTaskSet(array $TaskSet) 设置<p>任务列表。</p>
 ...
 */
class DescribeAIScheduleTaskListResponse extends AbstractModel
{
    /**
     * @var array <p>任务列表。</p>
     */

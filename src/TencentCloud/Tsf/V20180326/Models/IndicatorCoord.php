...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("CoordX",$param) and $param["CoordX"] !== null) {
            $this->CoordX = $param["CoordX"];
        }

        if (array_key_exists("CoordY",$param) and $param["CoordY"] !== null) {
            $this->CoordY = $param["CoordY"];
        }

        if (array_key_exists("CoordTag",$param) and $param["CoordTag"] !== null) {
            $this->CoordTag = $param["CoordTag"];
        }
    }
}

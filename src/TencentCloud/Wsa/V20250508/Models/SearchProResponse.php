 ...
 * @method string getVersion() 获取<p>用户版本：lite/standard/flagship（极速/标准/旗舰）</p>
 * @method void setVersion(string $Version) 设置<p>用户版本：lite/standard/flagship（极速/标准/旗舰）</p>
...
class SearchProResponse extends AbstractModel
{
    ...
    /**
     * @var string <p>用户版本：lite/standard/flagship（极速/标准/旗舰）</p>
     */
    public $Version;
     ...
     * @param string $Version <p>用户版本：lite/standard/flagship（极速/标准/旗舰）</p>

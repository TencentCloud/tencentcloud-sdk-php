 ...
 * @method array getNamespaceList() 获取<p>命名空间列表</p>
 * @method void setNamespaceList(array $NamespaceList) 设置<p>命名空间列表</p>
...
class DescribeImageRegistryNamespaceListResponse extends AbstractModel
{
     ...
     * @param array $NamespaceList <p>命名空间列表</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("NamespaceList",$param) and $param["NamespaceList"] !== null) {
            ...
            foreach ($param["NamespaceList"] as $key => $value){
                $obj = new ImageRegistryNamespaceInfo();

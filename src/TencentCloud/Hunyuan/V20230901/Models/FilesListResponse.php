 ...
 * FilesList返回参数结构体
 *
 * @method integer getTotal() 获取文件数量。
 * @method void setTotal(integer $Total) 设置文件数量。
 * @method string getObject() 获取对象类型，始终为 list。
 * @method void setObject(string $Object) 设置对象类型，始终为 list。
 * @method array getData() 获取FileObject 列表。
 * @method void setData(array $Data) 设置FileObject 列表。
 ...
 */
class FilesListResponse extends AbstractModel
{
    /**
     * @var integer 文件数量。
     */
    ...
    /**
     * @var string 对象类型，始终为 list。
     */
    public $Object;

    /**
     * @var array FileObject 列表。
     */
    public $Data;
    ...
    /**
     * @param integer $Total 文件数量。
     * @param string $Object 对象类型，始终为 list。
     * @param array $Data FileObject 列表。

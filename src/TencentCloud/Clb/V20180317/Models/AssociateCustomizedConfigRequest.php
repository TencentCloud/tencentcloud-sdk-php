 ...
 * @method array getBindList() 获取关联的server或location
 * @method void setBindList(array $BindList) 设置关联的server或location
 */
class AssociateCustomizedConfigRequest extends AbstractModel
{
    ...
    /**
     * @var array 关联的server或location
     */
    public $BindList;

    /**
     * @param string $UconfigId 配置ID
     * @param array $BindList 关联的server或location
     */

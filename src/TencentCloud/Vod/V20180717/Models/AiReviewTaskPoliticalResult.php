 ...
 * @method AiReviewPoliticalTaskInput getInput() 获取音视频审核涉及令人不适宜信息的任务输入。
 * @method void setInput(AiReviewPoliticalTaskInput $Input) 设置音视频审核涉及令人不适宜信息的任务输入。
 * @method AiReviewPoliticalTaskOutput getOutput() 获取音视频审核涉及令人不适宜信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewPoliticalTaskOutput $Output) 设置音视频审核涉及令人不适宜信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getProgress() 获取音视频审核涉及令人不适宜信息的任务进度，取值范围 [0-100] 。
 * @method void setProgress(integer $Progress) 设置音视频审核涉及令人不适宜信息的任务进度，取值范围 [0-100] 。
 */
class AiReviewTaskPoliticalResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPoliticalTaskInput 音视频审核涉及令人不适宜信息的任务输入。
     */
    public $Input;

    /**
     * @var AiReviewPoliticalTaskOutput 音视频审核涉及令人不适宜信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;

    /**
     * @var integer 音视频审核涉及令人不适宜信息的任务进度，取值范围 [0-100] 。
     */
    public $Progress;
     ...
     * @param AiReviewPoliticalTaskInput $Input 音视频审核涉及令人不适宜信息的任务输入。
     * @param AiReviewPoliticalTaskOutput $Output 音视频审核涉及令人不适宜信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $Progress 音视频审核涉及令人不适宜信息的任务进度，取值范围 [0-100] 。
     */

 ...
 *
 * @method string getObjectId() 获取业务层为DID设置的唯一标识
 * @method void setObjectId(string $ObjectId) 设置业务层为DID设置的唯一标识
 * @method integer getDAPId() 获取DID应用Id
 * @method void setDAPId(integer $DAPId) 设置DID应用Id
 */
class GetTDidByObjectIdRequest extends AbstractModel
{
    /**
     * @var string 业务层为DID设置的唯一标识
     */
    public $ObjectId;

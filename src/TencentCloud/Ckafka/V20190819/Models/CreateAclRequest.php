 ...
 * @method string getHost() 获取默认为*，表示任何host都可以访问。支持填写IP或网段，支持“;”分隔。
 * @method void setHost(string $Host) 设置默认为*，表示任何host都可以访问。支持填写IP或网段，支持“;”分隔。
...
class CreateAclRequest extends AbstractModel
{
    ...
    /**
     * @var integer Acl操作方式，(2:ALL，3:READ，4:WRITE，5:CREATE，6:DELETE，7:ALTER，8:DESCRIBE，9:CLUSTER_ACTION，10:DESCRIBE_CONFIGS，11:ALTER_CONFIGS，12:IDEMPOTENT_WRITE)
     */
    public $Operation;
    ...
    /**
     * @var string 默认为*，表示任何host都可以访问。支持填写IP或网段，支持“;”分隔。
     */
    public $Host;
     ...
     * @param string $Host 默认为*，表示任何host都可以访问。支持填写IP或网段，支持“;”分隔。

 ...
 * @method array getDataList() 获取<p>配额列表</p>
 * @method void setDataList(array $DataList) 设置<p>配额列表</p>
 */
class AIGWQuotaList extends AbstractModel
{
    /**
     * @var integer <p>总数</p>
     */

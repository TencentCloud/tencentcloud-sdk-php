 ...
 * @method array getUsageList() 获取各个时间点用量明细，单位:分钟
 * @method void setUsageList(array $UsageList) 设置各个时间点用量明细，单位:分钟
...
class DescribeTrtcUsageResponse extends AbstractModel
{
     ...
     * @param array $UsageList 各个时间点用量明细，单位:分钟

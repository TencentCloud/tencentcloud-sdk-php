...
class DescribeFlashSMSListResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("FlashSMSList",$param) and $param["FlashSMSList"] !== null) {
            $this->FlashSMSList = [];
            foreach ($param["FlashSMSList"] as $key => $value){
                $obj = new FlashSMSRecord();
                $obj->deserialize($value);
                array_push($this->FlashSMSList, $obj);
            }
        }

 ...
 *
 * @method array getIndexes() 获取索引相关信息
 * @method void setIndexes(array $Indexes) 设置索引相关信息
 * @method integer getIndexNum() 获取索引个数
 * @method void setIndexNum(integer $IndexNum) 设置索引个数
...
class DescribeTableResponse extends AbstractModel
{
    ...
    /**
     * @param array $Indexes 索引相关信息
     * @param integer $IndexNum 索引个数

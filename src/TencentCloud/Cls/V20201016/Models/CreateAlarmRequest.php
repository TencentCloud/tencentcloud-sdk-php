 ...
 * @method void setCondition(string $Condition) 设置告警发送通知的触发条件
 注意:  
- Condition和AlarmLevel是一组配置，MultiConditions是另一组配置，2组配置互斥。
...
默认值为true
 * @method boolean getEnable() 获取请使用Status参数控制是否开启告警策略。
 * @method void setEnable(boolean $Enable) 设置请使用Status参数控制是否开启告警策略。
 ...
 * @method array getTags() 获取标签描述列表，通过指定该参数可以同时绑定标签到相应的告警策略。

最大支持10个标签键值对，并且不能有重复的键值对。
 * @method void setTags(array $Tags) 设置标签描述列表，通过指定该参数可以同时绑定标签到相应的告警策略。
...
默认值为true
    ...
    /**
     * @var boolean 请使用Status参数控制是否开启告警策略。
     * @deprecated
     */
    public $Enable;
...
默认值false
    ...
    /**
     * @var array 标签描述列表，通过指定该参数可以同时绑定标签到相应的告警策略。
...
默认值为true
     * @param boolean $Enable 请使用Status参数控制是否开启告警策略。

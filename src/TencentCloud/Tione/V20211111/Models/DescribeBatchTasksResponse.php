...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("BatchTaskSet",$param) and $param["BatchTaskSet"] !== null) {
            $this->BatchTaskSet = [];
            foreach ($param["BatchTaskSet"] as $key => $value){
                $obj = new BatchTaskSetItem();
                $obj->deserialize($value);
                array_push($this->BatchTaskSet, $obj);
            }
        }

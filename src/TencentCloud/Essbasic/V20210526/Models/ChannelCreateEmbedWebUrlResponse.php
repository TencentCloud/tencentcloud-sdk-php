 ...
 *
 * @method string getWebUrl() 获取<p>嵌入的web链接，5分钟有效</p>
 * @method void setWebUrl(string $WebUrl) 设置<p>嵌入的web链接，5分钟有效</p>
...
class ChannelCreateEmbedWebUrlResponse extends AbstractModel
{
    ...
    /**
     * @param string $WebUrl <p>嵌入的web链接，5分钟有效</p>

 ...
 *
 * @method array getStrategyIds() 获取策略ID列表,0表示未绑定任何策略
 * @method void setStrategyIds(array $StrategyIds) 设置策略ID列表,0表示未绑定任何策略
...
class DescribeRansomDefenseMachineStrategyInfoResponse extends AbstractModel
{
    ...
    /**
     * @param array $StrategyIds 策略ID列表,0表示未绑定任何策略

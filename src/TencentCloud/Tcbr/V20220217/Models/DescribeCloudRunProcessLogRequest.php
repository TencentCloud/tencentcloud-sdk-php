 ...
 * @method string getRunId() 获取操作 Id
 * @method void setRunId(string $RunId) 设置操作 Id
 */
class DescribeCloudRunProcessLogRequest extends AbstractModel
{
    /**
     * @var string 环境 Id
     */

 ...
 *
 * @method integer getTotalCount() 获取该地域下live实例总数	
 * @method void setTotalCount(integer $TotalCount) 设置该地域下live实例总数	
 * @method array getInstanceList() 获取live实例详情	

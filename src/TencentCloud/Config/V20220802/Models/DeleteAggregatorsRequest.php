 ...
 * @method integer getOwnerUin() 获取账号组创建者ID
 * @method void setOwnerUin(integer $OwnerUin) 设置账号组创建者ID
 */
class DeleteAggregatorsRequest extends AbstractModel
{
    /**
     * @var string 账号组ID
     */
    ...
    /**
     * @var integer 账号组创建者ID
     */
    public $OwnerUin;

    /**
     * @param string $AccountGroupId 账号组ID
     * @param integer $OwnerUin 账号组创建者ID
     */

 ...
 * @method array getBestFrameList() 获取<p>最佳截图列表。</p><ul><li>仅在配置了返回多张最佳截图时返回。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setBestFrameList(array $BestFrameList) 设置<p>最佳截图列表。</p><ul><li>仅在配置了返回多张最佳截图时返回。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var array <p>最佳截图列表。</p><ul><li>仅在配置了返回多张最佳截图时返回。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 *
 * @method string getUrl() 获取<p>个人用户授权签的开通链接, 短链或者长链接形式。过期时间受 <code>ExpiredTime</code> 参数控制。</p>
 * @method void setUrl(string $Url) 设置<p>个人用户授权签的开通链接, 短链或者长链接形式。过期时间受 <code>ExpiredTime</code> 参数控制。</p>
 ...
 */
class ChannelCreateUserAutoSignEnableUrlResponse extends AbstractModel
{
    /**
     * @var string <p>个人用户授权签的开通链接, 短链或者长链接形式。过期时间受 <code>ExpiredTime</code> 参数控制。</p>
     */
    public $Url;
    ...
    /**
     * @param string $Url <p>个人用户授权签的开通链接, 短链或者长链接形式。过期时间受 <code>ExpiredTime</code> 参数控制。</p>

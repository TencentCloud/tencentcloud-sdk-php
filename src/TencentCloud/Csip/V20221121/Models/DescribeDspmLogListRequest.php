 ...
 * @method string getField() 获取<p>排序字段(opTime=时间,dangerLvl=风险等级)</p>
 * @method void setField(string $Field) 设置<p>排序字段(opTime=时间,dangerLvl=风险等级)</p>
 * @method string getDangerLevel() 获取<p>风险等级(0-安全,1-低风险,2-中风险,3-高风险,不传全部)</p>
 * @method void setDangerLevel(string $DangerLevel) 设置<p>风险等级(0-安全,1-低风险,2-中风险,3-高风险,不传全部)</p>
 ...
 * @method integer getRestoreLogId() 获取<p>恢复日志id</p>
 * @method void setRestoreLogId(integer $RestoreLogId) 设置<p>恢复日志id</p>
 ...
 * @method array getDbTypes() 获取<p>数据库类型, 支持的值：cdb，mariadb</p>
 * @method void setDbTypes(array $DbTypes) 设置<p>数据库类型, 支持的值：cdb，mariadb</p>
 ...
 * @method array getDangerLevels() 获取<p>风险等级数组(0-安全,1-低风险,2-中风险,3-高风险)</p>
 * @method void setDangerLevels(array $DangerLevels) 设置<p>风险等级数组(0-安全,1-低风险,2-中风险,3-高风险)</p>
 ...
 * @method string getClientMac() 获取<p>客户端MAC</p>
 * @method void setClientMac(string $ClientMac) 设置<p>客户端MAC</p>
 */
class DescribeDspmLogListRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>排序字段(opTime=时间,dangerLvl=风险等级)</p>
     */
    public $Field;

    /**
     * @var string <p>风险等级(0-安全,1-低风险,2-中风险,3-高风险,不传全部)</p>
     */
    public $DangerLevel;
    ...
    /**
     * @var array <p>数据库类型, 支持的值：cdb，mariadb</p>
     */
    public $DbTypes;
    ...
    /**
     * @var array <p>风险等级数组(0-安全,1-低风险,2-中风险,3-高风险)</p>
     */
    public $DangerLevels;
     ...
     * @param string $Field <p>排序字段(opTime=时间,dangerLvl=风险等级)</p>
     * @param string $DangerLevel <p>风险等级(0-安全,1-低风险,2-中风险,3-高风险,不传全部)</p>
     ...
     * @param integer $RestoreLogId <p>恢复日志id</p>
     ...
     * @param array $DbTypes <p>数据库类型, 支持的值：cdb，mariadb</p>
     ...
     * @param array $DangerLevels <p>风险等级数组(0-安全,1-低风险,2-中风险,3-高风险)</p>
     * @param string $SensitiveCategoryRule <p>字段分类</p>
     * @param string $SensitiveLevelRisk <p>字段分级</p>
     * @param string $ClientMac <p>客户端MAC</p>
     */

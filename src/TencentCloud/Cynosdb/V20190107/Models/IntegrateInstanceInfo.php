 ...
 * @method string getDeviceType() 获取实例机器类型 common-公通用型,exclusive-独享型
 * @method void setDeviceType(string $DeviceType) 设置实例机器类型 common-公通用型,exclusive-独享型
 */
class IntegrateInstanceInfo extends AbstractModel
{
    ...
    /**
     * @var string 实例机器类型 common-公通用型,exclusive-独享型
     */
    public $DeviceType;
     ...
     * @param string $DeviceType 实例机器类型 common-公通用型,exclusive-独享型
     */

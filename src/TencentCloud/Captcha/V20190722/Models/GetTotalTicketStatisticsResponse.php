 ...
 *
 * @method CaptchaStatisticObj getData() 获取返回数据
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setData(CaptchaStatisticObj $Data) 设置返回数据
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getCaptchaCode() 获取返回码
 * @method void setCaptchaCode(integer $CaptchaCode) 设置返回码
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param CaptchaStatisticObj $Data 返回数据
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $CaptchaCode 返回码

 ...
 * @method string getPeriodBegin() 获取有效期起始时间 2025-01-01(周期: 天) / 2025-01（周期: 月）
 * @method void setPeriodBegin(string $PeriodBegin) 设置有效期起始时间 2025-01-01(周期: 天) / 2025-01（周期: 月）
 * @method string getPeriodEnd() 获取有效期结束时间  2025-12-01(周期：天)  / 2025-12（周期：月）
 * @method void setPeriodEnd(string $PeriodEnd) 设置有效期结束时间  2025-12-01(周期：天)  / 2025-12（周期：月）
 * @method string getPlanType() 获取FIX 固定预算，CYCLE 计划预算
 * @method void setPlanType(string $PlanType) 设置FIX 固定预算，CYCLE 计划预算
...
class CreateBudgetRequest extends AbstractModel
{
    ...
    /**
     * @var string 有效期起始时间 2025-01-01(周期: 天) / 2025-01（周期: 月）
     */
    public $PeriodBegin;

    /**
     * @var string 有效期结束时间  2025-12-01(周期：天)  / 2025-12（周期：月）
     */
    public $PeriodEnd;

    /**
     * @var string FIX 固定预算，CYCLE 计划预算
     */
    public $PlanType;
...
预算计划类型为CYCLE(计划预算)时传[{"dateDesc":"2025-07","quota":"1000"},{"dateDesc":"2025-08","quota":"2000"}]；
     ...
     * @param string $PeriodBegin 有效期起始时间 2025-01-01(周期: 天) / 2025-01（周期: 月）
     * @param string $PeriodEnd 有效期结束时间  2025-12-01(周期：天)  / 2025-12（周期：月）
     * @param string $PlanType FIX 固定预算，CYCLE 计划预算

 ...
 * @method string getAudioRole() 获取音频角色
 * @method void setAudioRole(string $AudioRole) 设置音频角色
 * @method string getAudioText() 获取音频语音文本
 * @method void setAudioText(string $AudioText) 设置音频语音文本
 ...
 */
class TravelResult extends AbstractModel
{
    /**
     * @var string 一级标签
     */
     ...
     * @param string $AudioRole 音频角色
     * @param string $AudioText 音频语音文本

 ...
 *
 * @method ReservedInstanceSpec getReservedInstanceSpec() 获取预留券实例规格。
 * @method void setReservedInstanceSpec(ReservedInstanceSpec $ReservedInstanceSpec) 设置预留券实例规格。
 * @method integer getInstanceCount() 获取购买实例数量，一次最大购买数量为300。
 * @method void setInstanceCount(integer $InstanceCount) 设置购买实例数量，一次最大购买数量为300。
 ...
 * @method string getInstanceName() 获取预留券名称。
 * @method void setInstanceName(string $InstanceName) 设置预留券名称。
...
{
    /**
     * @var ReservedInstanceSpec 预留券实例规格。
     */
    public $ReservedInstanceSpec;

    /**
     * @var integer 购买实例数量，一次最大购买数量为300。
     */
     ...
     * @param string $InstanceName 预留券名称。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ReservedInstanceSpec",$param) and $param["ReservedInstanceSpec"] !== null) {
            $this->ReservedInstanceSpec = new ReservedInstanceSpec();
            $this->ReservedInstanceSpec->deserialize($param["ReservedInstanceSpec"]);
        }

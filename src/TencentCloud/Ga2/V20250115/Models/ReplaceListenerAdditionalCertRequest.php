 ...
 * @method string getAdditionalCertificate() 获取证书ID。
 * @method void setAdditionalCertificate(string $AdditionalCertificate) 设置证书ID。
 * @method string getOldCertificate() 获取旧的证书ID。
 * @method void setOldCertificate(string $OldCertificate) 设置旧的证书ID。
 */
class ReplaceListenerAdditionalCertRequest extends AbstractModel
{
     ...
     * @param string $AdditionalCertificate 证书ID。
     * @param string $OldCertificate 旧的证书ID。
     */

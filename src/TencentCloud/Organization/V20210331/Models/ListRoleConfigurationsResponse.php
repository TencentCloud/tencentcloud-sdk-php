 ...
 * @method array getRoleConfigurations() 获取<p>权限配置列表。</p>
 * @method void setRoleConfigurations(array $RoleConfigurations) 设置<p>权限配置列表。</p>
...
class ListRoleConfigurationsResponse extends AbstractModel
{
     ...
     * @param array $RoleConfigurations <p>权限配置列表。</p>

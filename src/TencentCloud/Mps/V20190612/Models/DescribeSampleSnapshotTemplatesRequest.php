...
<li>Preset：系统预置模板；</li>
<li>Custom：用户自定义模板。</li>
 * @method string getName() 获取采样截图模板标识过滤条件，长度限制：64 个字符。
 * @method void setName(string $Name) 设置采样截图模板标识过滤条件，长度限制：64 个字符。
 */
...
<li>Custom：用户自定义模板。</li>
    ...
    /**
     * @var string 采样截图模板标识过滤条件，长度限制：64 个字符。
     */
    public $Name;
...
<li>Preset：系统预置模板；</li>
<li>Custom：用户自定义模板。</li>
     * @param string $Name 采样截图模板标识过滤条件，长度限制：64 个字符。
     */

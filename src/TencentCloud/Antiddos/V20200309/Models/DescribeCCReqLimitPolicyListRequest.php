 ...
 *
 * @method string getBusiness() 获取DDoS防护子产品代号（bgp-multip表示高防包，bgpip表示高防IP）
 * @method void setBusiness(string $Business) 设置DDoS防护子产品代号（bgp-multip表示高防包，bgpip表示高防IP）
...
{
    /**
     * @var string DDoS防护子产品代号（bgp-multip表示高防包，bgpip表示高防IP）
     */
    public $Business;
    ...
    /**
     * @param string $Business DDoS防护子产品代号（bgp-multip表示高防包，bgpip表示高防IP）

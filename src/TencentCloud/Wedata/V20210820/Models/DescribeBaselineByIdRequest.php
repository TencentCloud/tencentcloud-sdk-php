 ...
 *
 * @method string getBaselineId() 获取无
 * @method void setBaselineId(string $BaselineId) 设置无
 * @method string getProjectId() 获取1
 * @method void setProjectId(string $ProjectId) 设置1
 */
class DescribeBaselineByIdRequest extends AbstractModel
{
    /**
     * @var string 无
     */

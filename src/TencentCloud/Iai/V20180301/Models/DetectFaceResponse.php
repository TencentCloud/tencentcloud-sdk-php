 ...
 * DetectFace返回参数结构体
 *
 * @method integer getImageWidth() 获取请求的图片宽度，单位为：像素（px）。
 * @method void setImageWidth(integer $ImageWidth) 设置请求的图片宽度，单位为：像素（px）。
 * @method integer getImageHeight() 获取请求的图片高度，单位为：像素（px）。
 * @method void setImageHeight(integer $ImageHeight) 设置请求的图片高度，单位为：像素（px）。
...
{
    /**
     * @var integer 请求的图片宽度，单位为：像素（px）。
     */
    public $ImageWidth;

    /**
     * @var integer 请求的图片高度，单位为：像素（px）。
     */
    public $ImageHeight;
...
不同算法模型版本对应的人脸识别算法不同，新版本的整体效果会优于旧版本，建议使用“3.0”版本。
    ...
    /**
     * @param integer $ImageWidth 请求的图片宽度，单位为：像素（px）。
     * @param integer $ImageHeight 请求的图片高度，单位为：像素（px）。

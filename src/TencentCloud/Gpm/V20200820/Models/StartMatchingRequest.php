 ...
 * @method string getMatchTicketId() 获取请求 Id 默认 "" 为空则由 GPM 自动生成 长度 128。
 * @method void setMatchTicketId(string $MatchTicketId) 设置请求 Id 默认 "" 为空则由 GPM 自动生成 长度 128。
 */
class StartMatchingRequest extends AbstractModel
{
    ...
    /**
     * @var string 请求 Id 默认 "" 为空则由 GPM 自动生成 长度 128。
     */
     ...
     * @param string $MatchTicketId 请求 Id 默认 "" 为空则由 GPM 自动生成 长度 128。
     */

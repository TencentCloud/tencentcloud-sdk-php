 ...
 *
 * @method string getInstanceId() 获取实例 ID，形如：tdsql3-ow7t8lmc。
 * @method void setInstanceId(string $InstanceId) 设置实例 ID，形如：tdsql3-ow7t8lmc。
...
{
    /**
     * @var string 实例 ID，形如：tdsql3-ow7t8lmc。
     */
    public $InstanceId;
    ...
    /**
     * @param string $InstanceId 实例 ID，形如：tdsql3-ow7t8lmc。

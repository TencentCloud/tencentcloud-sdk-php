 ...
 *
 * @method WebEventData getData() 获取Web攻击事件数据
 * @method void setData(WebEventData $Data) 设置Web攻击事件数据
...
class DescribeWebManagedRulesAttackEventsResponse extends AbstractModel
{
    ...
    /**
     * @param WebEventData $Data Web攻击事件数据

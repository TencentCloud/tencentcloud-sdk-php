...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("NotebookSet",$param) and $param["NotebookSet"] !== null) {
            $this->NotebookSet = [];
            foreach ($param["NotebookSet"] as $key => $value){
                $obj = new NotebookSetItem();
                $obj->deserialize($value);
                array_push($this->NotebookSet, $obj);
            }
        }

 ...
 *
 * @method array getAsyncRequestIds() 获取自治任务ID。
 * @method void setAsyncRequestIds(array $AsyncRequestIds) 设置自治任务ID。
 ...
 */
class CancelRedisBigKeyAnalysisTasksRequest extends AbstractModel
{
    /**
     * @var array 自治任务ID。
     */
    ...
    /**
     * @param array $AsyncRequestIds 自治任务ID。

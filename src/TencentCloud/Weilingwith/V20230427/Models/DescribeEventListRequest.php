 ...
 * @method string getTriggerType() 获取事件触发类型，(app, device, timer)
 * @method void setTriggerType(string $TriggerType) 设置事件触发类型，(app, device, timer)
 * @method array getIdSet() 获取事件id详情
 * @method void setIdSet(array $IdSet) 设置事件id详情
 */
class DescribeEventListRequest extends AbstractModel
{
    /**
     * @var integer 工作空间id
     */
    ...
    /**
     * @var string 事件触发类型，(app, device, timer)
     */
    public $TriggerType;
     ...
     * @param string $TriggerType 事件触发类型，(app, device, timer)

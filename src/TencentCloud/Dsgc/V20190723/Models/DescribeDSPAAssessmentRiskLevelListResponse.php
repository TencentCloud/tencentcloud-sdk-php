 ...
 * @method array getRiskLevelList() 获取风险等级列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setRiskLevelList(array $RiskLevelList) 设置风险等级列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getRequestId() 获取唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeDSPAAssessmentRiskLevelListResponse extends AbstractModel
{
    /**
     * @var integer 总条数
     */
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param array $RiskLevelList 风险等级列表
注意：此字段可能返回 null，表示取不到有效值。

 ...
 * @method string getNetworkType() 获取集群网络插件类型，支持：CiliumOverlay、HostNetwork
 * @method void setNetworkType(string $NetworkType) 设置集群网络插件类型，支持：CiliumOverlay、HostNetwork
 * @method string getSubnetId() 获取子网ID
 * @method void setSubnetId(string $SubnetId) 设置子网ID
 * @method boolean getEnabled() 获取是否开启注册节点专线连接支持
 * @method void setEnabled(boolean $Enabled) 设置是否开启注册节点专线连接支持
 ...
 * @method string getStatus() 获取开启注册节点池状态，支持 Initializing、InitFailed、Enabled、Disabled
 * @method void setStatus(string $Status) 设置开启注册节点池状态，支持 Initializing、InitFailed、Enabled、Disabled
 ...
 * @method array getProgress() 获取开启注册节点能力的进度
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setProgress(array $Progress) 设置开启注册节点能力的进度
注意：此字段可能返回 null，表示取不到有效值。
 * @method boolean getEnabledPublicConnect() 获取是否开启注册节点公网连接支持
 * @method void setEnabledPublicConnect(boolean $EnabledPublicConnect) 设置是否开启注册节点公网连接支持
...
class DescribeExternalNodeSupportConfigResponse extends AbstractModel
{
    ...
    /**
     * @var string 集群网络插件类型，支持：CiliumOverlay、HostNetwork
     */
    public $NetworkType;
    ...
    /**
     * @var string 开启注册节点池状态，支持 Initializing、InitFailed、Enabled、Disabled
     */
    public $Status;
    ...
    /**
     * @var array 开启注册节点能力的进度
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Progress;

    /**
     * @var boolean 是否开启注册节点公网连接支持
     */
     ...
     * @param string $NetworkType 集群网络插件类型，支持：CiliumOverlay、HostNetwork
     * @param string $SubnetId 子网ID
     * @param boolean $Enabled 是否开启注册节点专线连接支持
     * @param string $AS 节点所属交换机的BGP AS 号
     * @param string $SwitchIP 节点所属交换机的交换机 IP
     * @param string $Status 开启注册节点池状态，支持 Initializing、InitFailed、Enabled、Disabled
     * @param string $FailedReason 如果开启失败原因
     * @param string $Master 内网访问地址
     * @param string $Proxy 镜像仓库代理地址
     * @param array $Progress 开启注册节点能力的进度
注意：此字段可能返回 null，表示取不到有效值。
     * @param boolean $EnabledPublicConnect 是否开启注册节点公网连接支持

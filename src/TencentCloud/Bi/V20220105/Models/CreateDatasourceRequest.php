 ...
 * @method array getOperationAuthLimit() 获取<p>操作权限限制</p>
 * @method void setOperationAuthLimit(array $OperationAuthLimit) 设置<p>操作权限限制</p>
...
class CreateDatasourceRequest extends AbstractModel
{
     ...
     * @param array $OperationAuthLimit <p>操作权限限制</p>

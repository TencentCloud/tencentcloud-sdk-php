 ...
 * Pod节点选择项集合
 *
 * @method array getMatchExpressions() 获取节点选择项表达式集合
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setMatchExpressions(array $MatchExpressions) 设置节点选择项表达式集合
注意：此字段可能返回 null，表示取不到有效值。
 */
class NodeSelectorTerm extends AbstractModel
{
    /**
     * @var array 节点选择项表达式集合
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $MatchExpressions;

    /**
     * @param array $MatchExpressions 节点选择项表达式集合
注意：此字段可能返回 null，表示取不到有效值。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("MatchExpressions",$param) and $param["MatchExpressions"] !== null) {
            ...
            foreach ($param["MatchExpressions"] as $key => $value){
                $obj = new NodeSelectorRequirement();

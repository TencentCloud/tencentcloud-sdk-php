 ...
 *
 * @method boolean getResult() 获取<p>是否成功</p>
 * @method void setResult(boolean $Result) 设置<p>是否成功</p>
 ...
 */
class CreateCloudNativeAPIGatewayLLMModelServiceResponse extends AbstractModel
{
    /**

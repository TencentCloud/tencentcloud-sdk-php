...
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getExpandSecondPeriod() 获取弹性扩容观测周期（秒级），可取值为：15，30，45，60，180，300，600，900，1800。
 * @method void setExpandSecondPeriod(integer $ExpandSecondPeriod) 设置弹性扩容观测周期（秒级），可取值为：15，30，45，60，180，300，600，900，1800。
 * @method integer getShrinkSecondPeriod() 获取缩容观测周期（秒级），可取值为：300、600、900、1800。
 * @method void setShrinkSecondPeriod(integer $ShrinkSecondPeriod) 设置缩容观测周期（秒级），可取值为：300、600、900、1800。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var integer 弹性扩容观测周期（秒级），可取值为：15，30，45，60，180，300，600，900，1800。
     */
    public $ExpandSecondPeriod;

    /**
     * @var integer 缩容观测周期（秒级），可取值为：300、600、900、1800。
     */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $ExpandSecondPeriod 弹性扩容观测周期（秒级），可取值为：15，30，45，60，180，300，600，900，1800。
     * @param integer $ShrinkSecondPeriod 缩容观测周期（秒级），可取值为：300、600、900、1800。
     */

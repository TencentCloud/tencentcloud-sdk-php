 ...
 *
 * @method array getBackups() 获取备份列表
 * @method void setBackups(array $Backups) 设置备份列表
 ...
 */
class DescribeAndroidInstanceBackupsResponse extends AbstractModel
{
    /**
     * @var array 备份列表
     */

 ...
 * @method array getBackupNames() 获取备份名称列表
 * @method void setBackupNames(array $BackupNames) 设置备份名称列表
 * @method array getFileNames() 获取文件名列表
 * @method void setFileNames(array $FileNames) 设置文件名列表
 * @method integer getLimit() 获取返回数量，范围: (0, 100]，默认100
 * @method void setLimit(integer $Limit) 设置返回数量，范围: (0, 100]，默认100
...
class DescribeBinlogListByVaultRequest extends AbstractModel
{
    ...
    /**
     * @var integer 返回数量，范围: (0, 100]，默认100
     */
    public $Limit;
     ...
     * @param array $BackupNames 备份名称列表
     * @param array $FileNames 文件名列表
     * @param integer $Limit 返回数量，范围: (0, 100]，默认100

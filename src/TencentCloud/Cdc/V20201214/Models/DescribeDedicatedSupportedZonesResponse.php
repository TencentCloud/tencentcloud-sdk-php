 ...
 *
 * @method array getZoneSet() 获取<p>支持的可用区列表</p>
 * @method void setZoneSet(array $ZoneSet) 设置<p>支持的可用区列表</p>
...
class DescribeDedicatedSupportedZonesResponse extends AbstractModel
{
    ...
    /**
     * @param array $ZoneSet <p>支持的可用区列表</p>

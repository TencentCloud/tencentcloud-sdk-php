 ...
 *
 * @method DomainSimpleInfo getDomainInfo() 获取域名信息
 * @method void setDomainInfo(DomainSimpleInfo $DomainInfo) 设置域名信息
...
class DescribeDomainSimpleInfoResponse extends AbstractModel
{
    ...
    /**
     * @param DomainSimpleInfo $DomainInfo 域名信息
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("DomainInfo",$param) and $param["DomainInfo"] !== null) {
            $this->DomainInfo = new DomainSimpleInfo();

 ...
 * @method array getList() 获取各主机漏洞防御插件信息列表
 * @method void setList(array $List) 设置各主机漏洞防御插件信息列表
...
class DescribeVulDefencePluginStatusResponse extends AbstractModel
{
     ...
     * @param array $List 各主机漏洞防御插件信息列表
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("List",$param) and $param["List"] !== null) {
            ...
            foreach ($param["List"] as $key => $value){
                $obj = new VulDefencePluginStatus();

...
/**
 * @method Models\ApplyMarketComponentResponse ApplyMarketComponent(Models\ApplyMarketComponentRequest $req) 产品停售，预下线

从组件市场选中组件并添加到应用模板列表
 * @method Models\BuildMessageRouteResponse BuildMessageRoute(Models\BuildMessageRouteRequest $req) 建立消息路由
 * @method Models\CreateApplicationVisualizationResponse CreateApplicationVisualization(Models\CreateApplicationVisualizationRequest $req) 产品停售，预下线
 ...
 * @method Models\CreateEdgeUnitApplicationVisualizationResponse CreateEdgeUnitApplicationVisualization(Models\CreateEdgeUnitApplicationVisualizationRequest $req) 产品停售，预下线

可视化创建应用
 * @method Models\CreateEdgeUnitApplicationYamlResponse CreateEdgeUnitApplicationYaml(Models\CreateEdgeUnitApplicationYamlRequest $req) 产品停售，预下线
 ...
 * @method Models\DeleteApplicationsResponse DeleteApplications(Models\DeleteApplicationsRequest $req) 产品停售，预下线
 ...
 * @method Models\DeleteEdgeUnitApplicationsResponse DeleteEdgeUnitApplications(Models\DeleteEdgeUnitApplicationsRequest $req) 产品停售，预下线
 ...
 * @method Models\DescribeApplicationVisualizationResponse DescribeApplicationVisualization(Models\DescribeApplicationVisualizationRequest $req) 产品停售，预下线

获取应用模板可视化配置信息
 * @method Models\DescribeApplicationYamlResponse DescribeApplicationYaml(Models\DescribeApplicationYamlRequest $req) 产品停售，预下线

查询应用模板Yaml
 * @method Models\DescribeApplicationYamlErrorResponse DescribeApplicationYamlError(Models\DescribeApplicationYamlErrorRequest $req) 产品停售，预下线

检查应用模板的Yaml配置
 * @method Models\DescribeApplicationsResponse DescribeApplications(Models\DescribeApplicationsRequest $req) 产品停售，预下线
 ...
 * @method Models\DescribeEdgeUnitApplicationEventsResponse DescribeEdgeUnitApplicationEvents(Models\DescribeEdgeUnitApplicationEventsRequest $req) 产品停售，预下线

获取应用事件列表
 * @method Models\DescribeEdgeUnitApplicationLogsResponse DescribeEdgeUnitApplicationLogs(Models\DescribeEdgeUnitApplicationLogsRequest $req) 产品停售，预下线

获取应用日志
 * @method Models\DescribeEdgeUnitApplicationPodContainersResponse DescribeEdgeUnitApplicationPodContainers(Models\DescribeEdgeUnitApplicationPodContainersRequest $req) 产品停售，预下线

获取应用容器状态
 * @method Models\DescribeEdgeUnitApplicationPodsResponse DescribeEdgeUnitApplicationPods(Models\DescribeEdgeUnitApplicationPodsRequest $req) 产品停售，预下线

获取应用下Pod状态
 * @method Models\DescribeEdgeUnitApplicationVisualizationResponse DescribeEdgeUnitApplicationVisualization(Models\DescribeEdgeUnitApplicationVisualizationRequest $req) 产品停售，预下线

获取单元可视化配置信息
 * @method Models\DescribeEdgeUnitApplicationYamlResponse DescribeEdgeUnitApplicationYaml(Models\DescribeEdgeUnitApplicationYamlRequest $req) 产品停售，预下线

获取应用的Yaml配置
 * @method Models\DescribeEdgeUnitApplicationYamlErrorResponse DescribeEdgeUnitApplicationYamlError(Models\DescribeEdgeUnitApplicationYamlErrorRequest $req) 产品停售，预下线
 ...
 * @method Models\DescribeEdgeUnitCloudResponse DescribeEdgeUnitCloud(Models\DescribeEdgeUnitCloudRequest $req) 产品停售，预下线
 ...
 * @method Models\ModifyApplicationBasicInfoResponse ModifyApplicationBasicInfo(Models\ModifyApplicationBasicInfoRequest $req) 产品停售，预下线

修改应用模板基本信息
 * @method Models\ModifyApplicationVisualizationResponse ModifyApplicationVisualization(Models\ModifyApplicationVisualizationRequest $req) 产品停售，预下线

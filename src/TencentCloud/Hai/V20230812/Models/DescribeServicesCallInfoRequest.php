 ...
 *
 * @method array getServiceIds() 获取推理服务ID列表
 * @method void setServiceIds(array $ServiceIds) 设置推理服务ID列表
 * @method integer getLimit() 获取分页大小
 * @method void setLimit(integer $Limit) 设置分页大小
 * @method integer getOffset() 获取偏移量
 * @method void setOffset(integer $Offset) 设置偏移量
 */
class DescribeServicesCallInfoRequest extends AbstractModel
{
    /**
     * @var array 推理服务ID列表
     */
    ...
    /**
     * @param array $ServiceIds 推理服务ID列表

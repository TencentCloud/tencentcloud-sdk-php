 ...
 * @method array getFilters() 获取<p>过滤条件组合，Direction 为0时表述查询出向规则，为1时表示查询入向规则</p>
 * @method void setFilters(array $Filters) 设置<p>过滤条件组合，Direction 为0时表述查询出向规则，为1时表示查询入向规则</p>
 ...
 * @method void setBy(string $By) 设置<p>排序所用到的字段，默认为sequence</p>
 */
class DescribeNatAcRuleRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>过滤条件组合，Direction 为0时表述查询出向规则，为1时表示查询入向规则</p>
     */
    public $Filters;
    ...
    /**
     * @var string <p>desc：降序；asc：升序。根据By字段的值进行排序，这里传参的话则By也必须有值，默认为asc</p>
     */
    public $Order;

    /**
     * @var string <p>排序所用到的字段，默认为sequence</p>
     */
    public $By;
     ...
     * @param array $Filters <p>过滤条件组合，Direction 为0时表述查询出向规则，为1时表示查询入向规则</p>

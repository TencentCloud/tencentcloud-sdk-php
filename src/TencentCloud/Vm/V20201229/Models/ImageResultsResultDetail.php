 ...
 * @method array getOcrHitInfos() 获取该字段用于返回OCR命中的关键词信息。
 * @method void setOcrHitInfos(array $OcrHitInfos) 设置该字段用于返回OCR命中的关键词信息。
 */
...
返回值：**Block**：建议屏蔽，**Review** ：建议人工复审，**Pass**：建议通过
     ...
     * @param array $OcrHitInfos 该字段用于返回OCR命中的关键词信息。
     */

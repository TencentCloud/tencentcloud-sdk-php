...
注意：此字段可能返回 null，表示取不到有效值。
 * @method StrToStrMap getProperties() 获取任务属性（key-value 形式）
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setProperties(StrToStrMap $Properties) 设置任务属性（key-value 形式）
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getDryRunExtAttributes() 获取任务试运行-扩展业务属性
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setDryRunExtAttributes(array $DryRunExtAttributes) 设置任务试运行-扩展业务属性
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 */
class TaskExtOpsDto extends AbstractModel
{
    /**
     * @var string 任务ID
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var StrToStrMap 任务属性（key-value 形式）
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Properties;

    /**
     * @var array 任务试运行-扩展业务属性
注意：此字段可能返回 null，表示取不到有效值。
     */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param StrToStrMap $Properties 任务属性（key-value 形式）
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $DryRunExtAttributes 任务试运行-扩展业务属性
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Properties",$param) and $param["Properties"] !== null) {
            $this->Properties = new StrToStrMap();
            $this->Properties->deserialize($param["Properties"]);
        }

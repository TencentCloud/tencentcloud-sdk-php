...
注意：此字段可能返回 null，表示取不到有效值。
 * @method QualityRuleGroupExecStrategy getExecStrategy() 获取<p>执行策略</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setExecStrategy(QualityRuleGroupExecStrategy $ExecStrategy) 设置<p>执行策略</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method QualityRuleGroupSubscribe getSubscription() 获取<p>订阅信息</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setSubscription(QualityRuleGroupSubscribe $Subscription) 设置<p>订阅信息</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 * @method boolean getMonitorStatus() 获取<p>监控状态</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setMonitorStatus(boolean $MonitorStatus) 设置<p>监控状态</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var QualityRuleGroupExecStrategy <p>执行策略</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $ExecStrategy;

    /**
     * @var QualityRuleGroupSubscribe <p>订阅信息</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Subscription;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param QualityRuleGroupExecStrategy $ExecStrategy <p>执行策略</p>
注意：此字段可能返回 null，表示取不到有效值。
     * @param QualityRuleGroupSubscribe $Subscription <p>订阅信息</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param boolean $MonitorStatus <p>监控状态</p>
注意：此字段可能返回 null，表示取不到有效值。

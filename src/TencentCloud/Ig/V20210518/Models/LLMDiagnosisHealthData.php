 ...
 * @method integer getKind() 获取<p>结果类型，0：正常结果，1：追问问题</p>
 * @method void setKind(integer $Kind) 设置<p>结果类型，0：正常结果，1：追问问题</p>
 * @method string getRiskReminder() 获取<p>风险提示</p>
 * @method void setRiskReminder(string $RiskReminder) 设置<p>风险提示</p>
 ...
 * @method array getFollowUpQuestions() 获取<p>追问问题列表，流式输出方式，只在流式结束输出结果。只会在kind=1追问类型时有结果。</p>
 * @method void setFollowUpQuestions(array $FollowUpQuestions) 设置<p>追问问题列表，流式输出方式，只在流式结束输出结果。只会在kind=1追问类型时有结果。</p>
 * @method array getDrugList() 获取<p>药品列表，流式输出方式，只在流式结束输出结果。</p>
 * @method void setDrugList(array $DrugList) 设置<p>药品列表，流式输出方式，只在流式结束输出结果。</p>
 */
class LLMDiagnosisHealthData extends AbstractModel
{
    /**
    ...
    /**
     * @var integer <p>结果类型，0：正常结果，1：追问问题</p>
     */
    public $Kind;
    ...
    /**
     * @var array <p>追问问题列表，流式输出方式，只在流式结束输出结果。只会在kind=1追问类型时有结果。</p>
     */
    public $FollowUpQuestions;

    /**
     * @var array <p>药品列表，流式输出方式，只在流式结束输出结果。</p>
     */
    public $DrugList;
     ...
     * @param integer $Kind <p>结果类型，0：正常结果，1：追问问题</p>
     * @param string $RiskReminder <p>风险提示</p>
     ...
     * @param array $FollowUpQuestions <p>追问问题列表，流式输出方式，只在流式结束输出结果。只会在kind=1追问类型时有结果。</p>
     * @param array $DrugList <p>药品列表，流式输出方式，只在流式结束输出结果。</p>
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("RiskReminder",$param) and $param["RiskReminder"] !== null) {
            $this->RiskReminder = $param["RiskReminder"];
        }
        ...
        if (array_key_exists("FollowUpQuestions",$param) and $param["FollowUpQuestions"] !== null) {
            $this->FollowUpQuestions = [];
            foreach ($param["FollowUpQuestions"] as $key => $value){
                $obj = new HealthFollowUpQuestion();
                $obj->deserialize($value);
                array_push($this->FollowUpQuestions, $obj);
            }
        }

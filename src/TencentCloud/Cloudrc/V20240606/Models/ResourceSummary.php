 ...
 * @method string getPayMode() 获取<p>付费类型，包括后付费(0)、预付费(1)、预留实例(2)</p>
 * @method void setPayMode(string $PayMode) 设置<p>付费类型，包括后付费(0)、预付费(1)、预留实例(2)</p>
 ...
 */
class ResourceSummary extends AbstractModel
{
    /**
     * @var string <p>资源ID</p>
     */
    ...
    /**
     * @var string <p>付费类型，包括后付费(0)、预付费(1)、预留实例(2)</p>
     */
    public $PayMode;
     ...
     * @param string $PayMode <p>付费类型，包括后付费(0)、预付费(1)、预留实例(2)</p>

 ...
 *
 * @method array getResourceMaps() 获取<p>资源地图列表</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResourceMaps(array $ResourceMaps) 设置<p>资源地图列表</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $ResourceMaps <p>资源地图列表</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ResourceMaps",$param) and $param["ResourceMaps"] !== null) {
            $this->ResourceMaps = [];
            foreach ($param["ResourceMaps"] as $key => $value){
                $obj = new ResourceMapInfo();
                $obj->deserialize($value);
                array_push($this->ResourceMaps, $obj);
            }
        }

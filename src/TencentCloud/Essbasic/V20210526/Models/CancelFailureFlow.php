 ...
 * 撤销失败的流程信息
 *
 * @method string getFlowId() 获取<p>签署流程编号，为32位字符串</p>
 * @method void setFlowId(string $FlowId) 设置<p>签署流程编号，为32位字符串</p>
...
class CancelFailureFlow extends AbstractModel
{
    ...
    /**
     * @param string $FlowId <p>签署流程编号，为32位字符串</p>

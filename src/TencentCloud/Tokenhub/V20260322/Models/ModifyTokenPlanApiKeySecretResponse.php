 ...
 * @method integer getKeyVersion() 获取重置后的密钥版本号。
 * @method void setKeyVersion(integer $KeyVersion) 设置重置后的密钥版本号。
...
class ModifyTokenPlanApiKeySecretResponse extends AbstractModel
{
     ...
     * @param integer $KeyVersion 重置后的密钥版本号。

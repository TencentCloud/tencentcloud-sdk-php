 ...
 * @method integer getStatus() 获取<p>数据项是否启用</p><p>枚举值：</p><ul><li>0： 否</li><li>1： 是</li></ul><p>默认值：0</p>
 * @method void setStatus(integer $Status) 设置<p>数据项是否启用</p><p>枚举值：</p><ul><li>0： 否</li><li>1： 是</li></ul><p>默认值：0</p>
...
class DescribeDspmIdentifyRuleDetailResponse extends AbstractModel
{
    ...
    /**
     * @var integer <p>数据项是否启用</p><p>枚举值：</p><ul><li>0： 否</li><li>1： 是</li></ul><p>默认值：0</p>
     */
    public $Status;
     ...
     * @param integer $Status <p>数据项是否启用</p><p>枚举值：</p><ul><li>0： 否</li><li>1： 是</li></ul><p>默认值：0</p>

 ...
 * @method string getName() 获取<p>服务名称，最长60个字符，支持中英文大小写、数字及分隔符（“-”、“_”)，不能以数字和分隔符开头，不能以分隔符结尾。</p>
 * @method void setName(string $Name) 设置<p>服务名称，最长60个字符，支持中英文大小写、数字及分隔符（“-”、“_”)，不能以数字和分隔符开头，不能以分隔符结尾。</p>
 * @method string getServiceType() 获取<p>服务类型。目前仅支持 LLMService。</p><p>枚举值：</p><ul><li>LLMService： 大语言模型服务</li></ul>
 * @method void setServiceType(string $ServiceType) 设置<p>服务类型。目前仅支持 LLMService。</p><p>枚举值：</p><ul><li>LLMService： 大语言模型服务</li></ul>
 * @method string getModelProvider() 获取<p>选择模型提供商, 选项：OpenAI、Anthropic、Azure OpenAI等。</p>
 * @method void setModelProvider(string $ModelProvider) 设置<p>选择模型提供商, 选项：OpenAI、Anthropic、Azure OpenAI等。</p>
 ...
 * @method array getSecretKeyIds() 获取<p>LLM 厂商颁发的认证信息 token 。</p>
 * @method void setSecretKeyIds(array $SecretKeyIds) 设置<p>LLM 厂商颁发的认证信息 token 。</p>
 ...
 * @method string getUpstreamURL() 获取<p>服务提供商自定义 url</p>
 * @method void setUpstreamURL(string $UpstreamURL) 设置<p>服务提供商自定义 url</p>
 ...
 * @method string getUpstreamUrlMode() 获取<p>路径拼接模式</p><p>枚举值：</p><ul><li>FixedPath： 固定地址</li><li>AutoConcat： 自动拼接</li></ul>
 ...
 * @method string getNamespace() 获取<p>服务来源命名空间</p>
 * @method void setNamespace(string $Namespace) 设置<p>服务来源命名空间</p>
 * @method string getServiceName() 获取<p>服务来源服务名</p>
 * @method void setServiceName(string $ServiceName) 设置<p>服务来源服务名</p>
 * @method string getProtocol() 获取<p>服务来源协议</p>
 * @method void setProtocol(string $Protocol) 设置<p>服务来源协议</p>
 * @method array getExtParams() 获取<p>扩展参数</p>
 * @method void setExtParams(array $ExtParams) 设置<p>扩展参数</p>
 * @method string getCustomProviderName() 获取<p>自定义供应商名字</p>
 * @method void setCustomProviderName(string $CustomProviderName) 设置<p>自定义供应商名字</p>
 * @method boolean getKeyRotationEnabled() 获取<p>是否开启密钥轮转</p>
 * @method void setKeyRotationEnabled(boolean $KeyRotationEnabled) 设置<p>是否开启密钥轮转</p>
...
class CreateCloudNativeAPIGatewayLLMModelServiceRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>服务名称，最长60个字符，支持中英文大小写、数字及分隔符（“-”、“_”)，不能以数字和分隔符开头，不能以分隔符结尾。</p>
     */
    public $Name;

    /**
     * @var string <p>服务类型。目前仅支持 LLMService。</p><p>枚举值：</p><ul><li>LLMService： 大语言模型服务</li></ul>
     */
    public $ServiceType;

    /**
     * @var string <p>选择模型提供商, 选项：OpenAI、Anthropic、Azure OpenAI等。</p>
     */
    ...
    /**
     * @var array <p>LLM 厂商颁发的认证信息 token 。</p>
     */
    public $SecretKeyIds;
    ...
    /**
     * @var string <p>路径拼接模式</p><p>枚举值：</p><ul><li>FixedPath： 固定地址</li><li>AutoConcat： 自动拼接</li></ul>
     */
    ...
    /**
     * @var string <p>服务来源命名空间</p>
     */
    public $Namespace;

    /**
     * @var string <p>服务来源服务名</p>
     */
    public $ServiceName;

    /**
     * @var string <p>服务来源协议</p>
     */
    public $Protocol;
    ...
    /**
     * @var string <p>自定义供应商名字</p>
     */
    public $CustomProviderName;

    /**
     * @var boolean <p>是否开启密钥轮转</p>
     */
     ...
     * @param string $ModelProvider <p>选择模型提供商, 选项：OpenAI、Anthropic、Azure OpenAI等。</p>
     ...
     * @param array $SecretKeyIds <p>LLM 厂商颁发的认证信息 token 。</p>
     ...
     * @param string $UpstreamURL <p>服务提供商自定义 url</p>
     ...
     * @param string $Namespace <p>服务来源命名空间</p>
     * @param string $ServiceName <p>服务来源服务名</p>
     * @param string $Protocol <p>服务来源协议</p>
     * @param array $ExtParams <p>扩展参数</p>
     * @param string $CustomProviderName <p>自定义供应商名字</p>

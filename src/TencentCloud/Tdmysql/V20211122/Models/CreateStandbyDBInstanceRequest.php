 ...
 *
 * @method string getPrimaryInstanceId() 获取<p>主实例 id</p>
 * @method void setPrimaryInstanceId(string $PrimaryInstanceId) 设置<p>主实例 id</p>
 ...
 * @method string getTimeUnit() 获取<p>时间单位，y：年，m：月，d：日</p>
 * @method void setTimeUnit(string $TimeUnit) 设置<p>时间单位，y：年，m：月，d：日</p>
 ...
 * @method string getInstanceType() 获取<p>实例架构类型，19.0.0 起支持 &quot;hybrid&quot;&quot;</p>
 * @method void setInstanceType(string $InstanceType) 设置<p>实例架构类型，19.0.0 起支持 &quot;hybrid&quot;&quot;</p>
 ...
 * @method string getPrimaryInstanceRegion() 获取<p>主实例地域</p>
 * @method void setPrimaryInstanceRegion(string $PrimaryInstanceRegion) 设置<p>主实例地域</p>
 ...
 * @method array getSecurityGroupIds() 获取<p>绑定安全组id列表</p>
 * @method void setSecurityGroupIds(array $SecurityGroupIds) 设置<p>绑定安全组id列表</p>
 */
class CreateStandbyDBInstanceRequest extends AbstractModel
{
    /**
     * @var string <p>主实例 id</p>
     */
    ...
    /**
     * @var string <p>时间单位，y：年，m：月，d：日</p>
     */
    public $TimeUnit;
    ...
    /**
     * @var string <p>实例架构类型，19.0.0 起支持 &quot;hybrid&quot;&quot;</p>
     */
    public $InstanceType;
    ...
    /**
     * @var array <p>绑定安全组id列表</p>
     */
    public $SecurityGroupIds;

    /**
     * @param string $PrimaryInstanceId <p>主实例 id</p>
     ...
     * @param string $TimeUnit <p>时间单位，y：年，m：月，d：日</p>

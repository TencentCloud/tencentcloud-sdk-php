...
/**
 * CreateResourceGraph请求参数结构体
 *
 * @method string getName() 获取<p>资源图谱名称</p>
 * @method void setName(string $Name) 设置<p>资源图谱名称</p>
 * @method string getDescription() 获取<p>资源图谱描述</p>
 * @method void setDescription(string $Description) 设置<p>资源图谱描述</p>
 ...
 */
class CreateResourceGraphRequest extends AbstractModel
{
    /**
    ...
    /**
     * @param string $Name <p>资源图谱名称</p>
     * @param string $Description <p>资源图谱描述</p>

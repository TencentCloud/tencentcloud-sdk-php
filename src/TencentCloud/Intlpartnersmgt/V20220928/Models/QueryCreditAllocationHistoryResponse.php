 ...
 *
 * @method integer getTotal() 获取历史信息总条数
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTotal(integer $Total) 设置历史信息总条数
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getHistory() 获取历史信息详细列表数据
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setHistory(array $History) 设置历史信息详细列表数据
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param integer $Total 历史信息总条数
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $History 历史信息详细列表数据
注意：此字段可能返回 null，表示取不到有效值。

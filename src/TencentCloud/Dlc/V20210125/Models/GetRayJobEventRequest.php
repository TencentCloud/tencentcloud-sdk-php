 ...
 *
 * @method string getId() 获取<p>ray-job ID</p>
 * @method void setId(string $Id) 设置<p>ray-job ID</p>
 ...
 */
class GetRayJobEventRequest extends AbstractModel
{
    /**
     * @var string <p>ray-job ID</p>
     */
    public $Id;
    ...
    /**
     * @param string $Id <p>ray-job ID</p>

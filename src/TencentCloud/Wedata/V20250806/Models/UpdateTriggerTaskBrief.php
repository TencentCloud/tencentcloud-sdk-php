 ...
 * 更新任务对象入参
 *
 * @method UpdateTriggerTaskBaseAttribute getTriggerTaskBaseAttribute() 获取任务基本属性
 * @method void setTriggerTaskBaseAttribute(UpdateTriggerTaskBaseAttribute $TriggerTaskBaseAttribute) 设置任务基本属性
...
{
    /**
     * @var UpdateTriggerTaskBaseAttribute 任务基本属性
     */
    ...
    /**
     * @param UpdateTriggerTaskBaseAttribute $TriggerTaskBaseAttribute 任务基本属性
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("TriggerTaskBaseAttribute",$param) and $param["TriggerTaskBaseAttribute"] !== null) {
            $this->TriggerTaskBaseAttribute = new UpdateTriggerTaskBaseAttribute();

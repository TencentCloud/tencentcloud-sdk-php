 ...
 *
 * @method array getBackupLimitClusterRestrictions() 获取集群备份下载限制
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setBackupLimitClusterRestrictions(array $BackupLimitClusterRestrictions) 设置集群备份下载限制
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $BackupLimitClusterRestrictions 集群备份下载限制
注意：此字段可能返回 null，表示取不到有效值。

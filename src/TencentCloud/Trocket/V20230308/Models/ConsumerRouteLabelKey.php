...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getLabel() 获取<p>灰度标签名称，为空表示完整路由配置</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setLabel(string $Label) 设置<p>灰度标签名称，为空表示完整路由配置</p>
注意：此字段可能返回 null，表示取不到有效值。
 */
class ConsumerRouteLabelKey extends AbstractModel
{
    /**
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var string <p>灰度标签名称，为空表示完整路由配置</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Label;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $Label <p>灰度标签名称，为空表示完整路由配置</p>
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 * @method integer getLimit() 获取查询前多少个数据，最大值为1000，不填默认为10， 表示查询前top 10的数据。
 * @method void setLimit(integer $Limit) 设置查询前多少个数据，最大值为1000，不填默认为10， 表示查询前top 10的数据。
...
<li> l7Cache_outFlux_statusCode：状态码。</li>
    ...
    /**
     * @var integer 查询前多少个数据，最大值为1000，不填默认为10， 表示查询前top 10的数据。
     */
    public $Limit;
...
<li> l7Cache_outFlux_statusCode：状态码。</li>
     ...
     * @param integer $Limit 查询前多少个数据，最大值为1000，不填默认为10， 表示查询前top 10的数据。

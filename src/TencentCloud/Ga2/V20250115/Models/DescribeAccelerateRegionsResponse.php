...
class DescribeAccelerateRegionsResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("AcceleratorRegionSet",$param) and $param["AcceleratorRegionSet"] !== null) {
            $this->AcceleratorRegionSet = [];
            foreach ($param["AcceleratorRegionSet"] as $key => $value){
                $obj = new AcceleratorRegionSet();
                $obj->deserialize($value);
                array_push($this->AcceleratorRegionSet, $obj);
            }
        }

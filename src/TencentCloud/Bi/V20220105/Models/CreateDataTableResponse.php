...
注意：此字段可能返回 null，表示取不到有效值。
 * @method IdDTO getData() 获取成功返回数据表的id
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setData(IdDTO $Data) 设置成功返回数据表的id
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getExtra() 获取额外信息
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setExtra(string $Extra) 设置额外信息
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getMsg() 获取错误提示
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setMsg(string $Msg) 设置错误提示
注意：此字段可能返回 null，表示取不到有效值。

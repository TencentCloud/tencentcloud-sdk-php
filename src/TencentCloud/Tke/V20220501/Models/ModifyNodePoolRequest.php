 ...
 * @method UpdateNativeNodePoolParam getNative() 获取原生节点池更新参数
 * @method void setNative(UpdateNativeNodePoolParam $Native) 设置原生节点池更新参数
...
class ModifyNodePoolRequest extends AbstractModel
{
    ...
    /**
     * @var UpdateNativeNodePoolParam 原生节点池更新参数
     */
    public $Native;
     ...
     * @param UpdateNativeNodePoolParam $Native 原生节点池更新参数

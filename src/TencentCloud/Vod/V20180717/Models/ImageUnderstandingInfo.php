 ...
 * 图片理解信息。
 *
 * @method array getImageUnderstandingSet() 获取图片理解项集合。
 * @method void setImageUnderstandingSet(array $ImageUnderstandingSet) 设置图片理解项集合。
 */
class ImageUnderstandingInfo extends AbstractModel
{
    ...
    /**
     * @param array $ImageUnderstandingSet 图片理解项集合。
     */

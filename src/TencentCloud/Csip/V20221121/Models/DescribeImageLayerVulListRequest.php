 ...
 * @method string getId() 获取<p>镜像层id</p>
 * @method void setId(string $Id) 设置<p>镜像层id</p>
 */
class DescribeImageLayerVulListRequest extends AbstractModel
{
    /**

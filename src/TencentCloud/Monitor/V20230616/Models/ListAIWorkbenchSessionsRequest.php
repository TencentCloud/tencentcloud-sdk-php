 ...
 * @method array getSessionIds() 获取<p>会话 ID 列表筛选</p>
 * @method void setSessionIds(array $SessionIds) 设置<p>会话 ID 列表筛选</p>
 */
class ListAIWorkbenchSessionsRequest extends AbstractModel
{
     ...
     * @param array $SessionIds <p>会话 ID 列表筛选</p>
     */

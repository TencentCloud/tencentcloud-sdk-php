 ...
 * @method array getMemberIdSet() 获取需删除的成员用户ID集合
 * @method void setMemberIdSet(array $MemberIdSet) 设置需删除的成员用户ID集合
 */
class DeleteUserGroupMembersRequest extends AbstractModel
{
    ...
    /**
     * @var array 需删除的成员用户ID集合
     */
    public $MemberIdSet;

    /**
     * @param integer $Id 用户组ID
     * @param array $MemberIdSet 需删除的成员用户ID集合
     */

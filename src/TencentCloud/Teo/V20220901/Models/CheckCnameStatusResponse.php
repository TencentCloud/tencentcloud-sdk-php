 ...
 *
 * @method array getCnameStatus() 获取接入域名的 CNAME 配置状态信息列表。
 * @method void setCnameStatus(array $CnameStatus) 设置接入域名的 CNAME 配置状态信息列表。
...
{
    /**
     * @var array 接入域名的 CNAME 配置状态信息列表。
     */
    public $CnameStatus;
    ...
    /**
     * @param array $CnameStatus 接入域名的 CNAME 配置状态信息列表。

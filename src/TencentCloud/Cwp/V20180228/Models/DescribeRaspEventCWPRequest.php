 ...
 *
 * @method array getFilters() 获取过滤条件：Keywords: ip或者主机名, VulKeywords漏洞名或者CveId模糊查询;AttackTypeKeywords攻击类型名模糊查询;Quuid，VulId，EventType，Status精确匹配，CreateBeginTime，CreateEndTime时间段查询
Source区分内存马注入和漏洞防御，rasp：漏洞防御，memshell_inject：内存马注入
 * @method void setFilters(array $Filters) 设置过滤条件：Keywords: ip或者主机名, VulKeywords漏洞名或者CveId模糊查询;AttackTypeKeywords攻击类型名模糊查询;Quuid，VulId，EventType，Status精确匹配，CreateBeginTime，CreateEndTime时间段查询
Source区分内存马注入和漏洞防御，rasp：漏洞防御，memshell_inject：内存马注入
...
{
    /**
     * @var array 过滤条件：Keywords: ip或者主机名, VulKeywords漏洞名或者CveId模糊查询;AttackTypeKeywords攻击类型名模糊查询;Quuid，VulId，EventType，Status精确匹配，CreateBeginTime，CreateEndTime时间段查询
Source区分内存马注入和漏洞防御，rasp：漏洞防御，memshell_inject：内存马注入
     */
    public $Filters;
    ...
    /**
     * @param array $Filters 过滤条件：Keywords: ip或者主机名, VulKeywords漏洞名或者CveId模糊查询;AttackTypeKeywords攻击类型名模糊查询;Quuid，VulId，EventType，Status精确匹配，CreateBeginTime，CreateEndTime时间段查询
Source区分内存马注入和漏洞防御，rasp：漏洞防御，memshell_inject：内存马注入

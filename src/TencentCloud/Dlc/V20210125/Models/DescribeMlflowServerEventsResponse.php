 ...
 * @method integer getStartTime() 获取<p>本次检索实际使用的起始时间（Unix 时间戳，毫秒）</p>
 * @method void setStartTime(integer $StartTime) 设置<p>本次检索实际使用的起始时间（Unix 时间戳，毫秒）</p>
 * @method integer getEndTime() 获取<p>本次检索实际使用的结束时间（Unix 时间戳，毫秒）</p>
 * @method void setEndTime(integer $EndTime) 设置<p>本次检索实际使用的结束时间（Unix 时间戳，毫秒）</p>
 ...
 */
class DescribeMlflowServerEventsResponse extends AbstractModel
{
    /**
    ...
    /**
     * @var integer <p>本次检索实际使用的起始时间（Unix 时间戳，毫秒）</p>
     */
    public $StartTime;

    /**
     * @var integer <p>本次检索实际使用的结束时间（Unix 时间戳，毫秒）</p>
     */
    public $EndTime;
     ...
     * @param integer $StartTime <p>本次检索实际使用的起始时间（Unix 时间戳，毫秒）</p>
     * @param integer $EndTime <p>本次检索实际使用的结束时间（Unix 时间戳，毫秒）</p>

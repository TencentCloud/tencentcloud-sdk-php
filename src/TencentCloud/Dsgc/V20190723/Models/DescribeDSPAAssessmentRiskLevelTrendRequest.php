 ...
 * @method string getEndTime() 获取结束时日期
 * @method void setEndTime(string $EndTime) 设置结束时日期
 * @method string getTemplateId() 获取评估模版id
 * @method void setTemplateId(string $TemplateId) 设置评估模版id
 */
class DescribeDSPAAssessmentRiskLevelTrendRequest extends AbstractModel
{
    /**
     * @var string dspa实例id
     */

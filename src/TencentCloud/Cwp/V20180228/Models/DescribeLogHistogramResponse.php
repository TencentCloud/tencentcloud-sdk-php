 ...
 *
 * @method array getData() 获取周期内统计结果详情
 * @method void setData(array $Data) 设置周期内统计结果详情
 * @method integer getPeriod() 获取统计周期： 单位ms
 * @method void setPeriod(integer $Period) 设置统计周期： 单位ms
...
class DescribeLogHistogramResponse extends AbstractModel
{
    ...
    /**
     * @param array $Data 周期内统计结果详情
     * @param integer $Period 统计周期： 单位ms

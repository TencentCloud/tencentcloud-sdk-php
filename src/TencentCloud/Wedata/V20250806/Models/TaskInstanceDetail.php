...
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getTaskTypeId() 获取taskType对应的id
 * @method void setTaskTypeId(integer $TaskTypeId) 设置taskType对应的id
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $TaskTypeId taskType对应的id

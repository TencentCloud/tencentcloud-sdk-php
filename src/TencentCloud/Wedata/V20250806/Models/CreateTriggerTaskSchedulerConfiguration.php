 ...
 * 创建任务调度配置信息
 *
 * @method array getUpstreamDependencyConfigList() 获取<p>上游依赖的任务数组</p>
 * @method void setUpstreamDependencyConfigList(array $UpstreamDependencyConfigList) 设置<p>上游依赖的任务数组</p>

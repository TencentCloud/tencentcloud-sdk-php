 ...
 * @method string getOutOrderId() 获取外部商户订单号。与ChannelOrderId不能同时为空字符串。
 * @method void setOutOrderId(string $OutOrderId) 设置外部商户订单号。与ChannelOrderId不能同时为空字符串。
 * @method string getChannelOrderId() 获取云平台订单号。与OutOrderId不能同时为空字符串。
 * @method void setChannelOrderId(string $ChannelOrderId) 设置云平台订单号。与OutOrderId不能同时为空字符串。
...
class QueryOpenBankPaymentOrderRequest extends AbstractModel
{
    ...
    /**
     * @var string 外部商户订单号。与ChannelOrderId不能同时为空字符串。
     */
    public $OutOrderId;

    /**
     * @var string 云平台订单号。与OutOrderId不能同时为空字符串。
     */
     ...
     * @param string $OutOrderId 外部商户订单号。与ChannelOrderId不能同时为空字符串。
     * @param string $ChannelOrderId 云平台订单号。与OutOrderId不能同时为空字符串。

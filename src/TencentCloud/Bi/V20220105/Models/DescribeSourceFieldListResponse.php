...
注意：此字段可能返回 null，表示取不到有效值。
 * @method TableColumnListData getData() 获取表中字段的列表
 * @method void setData(TableColumnListData $Data) 设置表中字段的列表
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var TableColumnListData 表中字段的列表
     */
    public $Data;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $Msg 信息
注意：此字段可能返回 null，表示取不到有效值。
     * @param TableColumnListData $Data 表中字段的列表
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Data",$param) and $param["Data"] !== null) {
            $this->Data = new TableColumnListData();

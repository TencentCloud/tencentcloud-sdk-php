 ...
 * @method SmartSubtitleTaskResultInput getInput() 获取语音全文识别任务输入信息。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setInput(SmartSubtitleTaskResultInput $Input) 设置语音全文识别任务输入信息。
注意：此字段可能返回 null，表示取不到有效值。
 * @method SmartSubtitleTaskAsrFullTextResultOutput getOutput() 获取语音全文识别任务输出信息。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(SmartSubtitleTaskAsrFullTextResultOutput $Output) 设置语音全文识别任务输出信息。
注意：此字段可能返回 null，表示取不到有效值。
...
class SmartSubtitleTaskAsrFullTextResult extends AbstractModel
{
    ...
    /**
     * @var SmartSubtitleTaskResultInput 语音全文识别任务输入信息。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Input;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param SmartSubtitleTaskResultInput $Input 语音全文识别任务输入信息。
注意：此字段可能返回 null，表示取不到有效值。
     * @param SmartSubtitleTaskAsrFullTextResultOutput $Output 语音全文识别任务输出信息。
注意：此字段可能返回 null，表示取不到有效值。

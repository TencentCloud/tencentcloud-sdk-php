 ...
 * @method string getStreamMixNotifyUrl() 获取混流回调URL。
 * @method void setStreamMixNotifyUrl(string $StreamMixNotifyUrl) 设置混流回调URL。
...
class CallBackTemplateInfo extends AbstractModel
{
     ...
     * @param string $StreamMixNotifyUrl 混流回调URL。

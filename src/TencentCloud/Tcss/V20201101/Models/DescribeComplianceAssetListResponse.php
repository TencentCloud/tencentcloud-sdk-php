...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("AssetInfoList",$param) and $param["AssetInfoList"] !== null) {
            $this->AssetInfoList = [];
            foreach ($param["AssetInfoList"] as $key => $value){
                $obj = new ComplianceAssetInfo();
                $obj->deserialize($value);
                array_push($this->AssetInfoList, $obj);
            }
        }

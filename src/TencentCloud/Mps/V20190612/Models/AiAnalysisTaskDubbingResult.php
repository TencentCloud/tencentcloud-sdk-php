 ...
 * @method AiAnalysisTaskDubbingInput getInput() 获取智能译制任务输入。
 * @method void setInput(AiAnalysisTaskDubbingInput $Input) 设置智能译制任务输入。
 * @method AiAnalysisTaskDubbingOutput getOutput() 获取智能译制任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiAnalysisTaskDubbingOutput $Output) 设置智能译制任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiAnalysisTaskDubbingResult extends AbstractModel
{
    ...
    /**
     * @var AiAnalysisTaskDubbingInput 智能译制任务输入。
     */
    public $Input;

    /**
     * @var AiAnalysisTaskDubbingOutput 智能译制任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiAnalysisTaskDubbingInput $Input 智能译制任务输入。
     * @param AiAnalysisTaskDubbingOutput $Output 智能译制任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 * @method AiReviewPornAsrTaskInput getInput() 获取智能识别 Asr 文字涉及令人反感的信息的任务输入。
 * @method void setInput(AiReviewPornAsrTaskInput $Input) 设置智能识别 Asr 文字涉及令人反感的信息的任务输入。
 * @method AiReviewPornAsrTaskOutput getOutput() 获取智能识别 Asr 文字涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewPornAsrTaskOutput $Output) 设置智能识别 Asr 文字涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiReviewTaskPornAsrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPornAsrTaskInput 智能识别 Asr 文字涉及令人反感的信息的任务输入。
     */
    public $Input;

    /**
     * @var AiReviewPornAsrTaskOutput 智能识别 Asr 文字涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiReviewPornAsrTaskInput $Input 智能识别 Asr 文字涉及令人反感的信息的任务输入。
     * @param AiReviewPornAsrTaskOutput $Output 智能识别 Asr 文字涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 * @method string getAuthor() 获取<p>事件作者。取值示例：user、assistant、tool。</p>
 * @method void setAuthor(string $Author) 设置<p>事件作者。取值示例：user、assistant、tool。</p>
 * @method string getAfterTimestamp() 获取<p>起始时间，仅返回该时间之后的事件，使用 RFC3339 格式，最大长度 64 字符。</p>
 * @method void setAfterTimestamp(string $AfterTimestamp) 设置<p>起始时间，仅返回该时间之后的事件，使用 RFC3339 格式，最大长度 64 字符。</p>
 * @method integer getOffset() 获取<p>分页偏移量，默认为 0。</p>
 * @method void setOffset(integer $Offset) 设置<p>分页偏移量，默认为 0。</p>
 * @method integer getLimit() 获取<p>返回数量，默认为 50，最大值为 200。</p>
 * @method void setLimit(integer $Limit) 设置<p>返回数量，默认为 50，最大值为 200。</p>
 */
class DescribeEventsRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>事件作者。取值示例：user、assistant、tool。</p>
     */
    public $Author;

    /**
     * @var string <p>起始时间，仅返回该时间之后的事件，使用 RFC3339 格式，最大长度 64 字符。</p>
     */
    ...
    /**
     * @var integer <p>返回数量，默认为 50，最大值为 200。</p>
     */
    public $Limit;
     ...
     * @param string $Author <p>事件作者。取值示例：user、assistant、tool。</p>
     * @param string $AfterTimestamp <p>起始时间，仅返回该时间之后的事件，使用 RFC3339 格式，最大长度 64 字符。</p>
     * @param integer $Offset <p>分页偏移量，默认为 0。</p>
     * @param integer $Limit <p>返回数量，默认为 50，最大值为 200。</p>
     */

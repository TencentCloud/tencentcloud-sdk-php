...
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getTries() 获取当前运行已下发运行次数
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTries(integer $Tries) 设置当前运行已下发运行次数
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getInstanceRunType() 获取**实例运行触发类型**
...
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setInstanceRunType(string $InstanceRunType) 设置**实例运行触发类型**
...
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getInstanceLifeCycleList() 获取**实例生命周期列表**
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setInstanceLifeCycleList(array $InstanceLifeCycleList) 设置**实例生命周期列表**
注意：此字段可能返回 null，表示取不到有效值。
 * @method InstanceLogVO getLatestLog() 获取**实例最近一次的执行日志**
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setLatestLog(InstanceLogVO $LatestLog) 设置**实例最近一次的执行日志**
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $Tries 当前运行已下发运行次数
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $InstanceRunType **实例运行触发类型**
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $InstanceLifeCycleList **实例生命周期列表**
注意：此字段可能返回 null，表示取不到有效值。
     * @param InstanceLogVO $LatestLog **实例最近一次的执行日志**
注意：此字段可能返回 null，表示取不到有效值。
     */

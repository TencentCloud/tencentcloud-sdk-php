 ...
 * @method string getKeyId() 获取需要修改描述信息的的CMK ID
 * @method void setKeyId(string $KeyId) 设置需要修改描述信息的的CMK ID
 */
...
class UpdateKeyDescriptionRequest extends AbstractModel
{
    ...
    /**
     * @var string 需要修改描述信息的的CMK ID
     */
    public $KeyId;
    /**
     * @param string $Description 新的描述信息，最大支持1024字节
     * @param string $KeyId 需要修改描述信息的的CMK ID
     */

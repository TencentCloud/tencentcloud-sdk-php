 ...
 *
 * @method array getInfos() 获取SourceLocation列表。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setInfos(array $Infos) 设置SourceLocation列表。
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $Infos SourceLocation列表。
注意：此字段可能返回 null，表示取不到有效值。

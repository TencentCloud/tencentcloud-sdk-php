 ...
 * @method string getApiKey() 获取APIKey 密钥值（明文）。请妥善保管。
 * @method void setApiKey(string $ApiKey) 设置APIKey 密钥值（明文）。请妥善保管。
...
class DescribeTokenPlanApiKeySecretResponse extends AbstractModel
{
    ...
    /**
     * @var string APIKey 密钥值（明文）。请妥善保管。
     */
    public $ApiKey;
     ...
     * @param string $ApiKey APIKey 密钥值（明文）。请妥善保管。

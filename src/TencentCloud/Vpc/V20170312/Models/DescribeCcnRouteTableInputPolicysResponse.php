 ...
 *
 * @method array getPolicySet() 获取路由表接收策略。
 * @method void setPolicySet(array $PolicySet) 设置路由表接收策略。
 ...
 */
class DescribeCcnRouteTableInputPolicysResponse extends AbstractModel
{
    /**
     * @var array 路由表接收策略。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("PolicySet",$param) and $param["PolicySet"] !== null) {
            ...
            foreach ($param["PolicySet"] as $key => $value){
                $obj = new CcnRouteTableInputPolicys();

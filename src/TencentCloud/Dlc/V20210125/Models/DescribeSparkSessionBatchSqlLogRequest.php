 ...
 * @method string getCustomKey() 获取用户自定义主键，若不为空，则按照该值进行查询
 * @method void setCustomKey(string $CustomKey) 设置用户自定义主键，若不为空，则按照该值进行查询
 */
class DescribeSparkSessionBatchSqlLogRequest extends AbstractModel
{
    ...
    /**
     * @var string 用户自定义主键，若不为空，则按照该值进行查询
     */
    public $CustomKey;

    /**
     * @param string $BatchId SparkSQL唯一标识
     * @param string $CustomKey 用户自定义主键，若不为空，则按照该值进行查询
     */

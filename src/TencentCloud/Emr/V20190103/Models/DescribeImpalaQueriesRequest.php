 ...
 * @method array getState() 获取执行状态，CREATED、INITIALIZED、COMPILED、RUNNING、FINISHED、EXCEPTION
 * @method void setState(array $State) 设置执行状态，CREATED、INITIALIZED、COMPILED、RUNNING、FINISHED、EXCEPTION
 * @method integer getEndTimeGte() 获取结束时间大于的时间点
 * @method void setEndTimeGte(integer $EndTimeGte) 设置结束时间大于的时间点
 * @method integer getEndTimeLte() 获取结束时间小于的时间点
 * @method void setEndTimeLte(integer $EndTimeLte) 设置结束时间小于的时间点
 */
class DescribeImpalaQueriesRequest extends AbstractModel
{
    ...
    /**
     * @var array 执行状态，CREATED、INITIALIZED、COMPILED、RUNNING、FINISHED、EXCEPTION
     */
    public $State;
     ...
     * @param array $State 执行状态，CREATED、INITIALIZED、COMPILED、RUNNING、FINISHED、EXCEPTION
     * @param integer $EndTimeGte 结束时间大于的时间点
     * @param integer $EndTimeLte 结束时间小于的时间点
     */

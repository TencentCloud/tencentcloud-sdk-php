 ...
 * @method integer getIsDisabled() 获取开启状态[0:开启|1:关闭]
 * @method void setIsDisabled(integer $IsDisabled) 设置开启状态[0:开启|1:关闭]
 */
class ModifyWebHookRuleStatusRequest extends AbstractModel
{
    ...
    /**
     * @var integer 开启状态[0:开启|1:关闭]
     */
    public $IsDisabled;

    /**
     * @param integer $Id 规则Id
     * @param integer $IsDisabled 开启状态[0:开启|1:关闭]
     */

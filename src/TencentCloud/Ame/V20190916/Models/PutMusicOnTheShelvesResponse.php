 ...
 *
 * @method integer getSuccessNum() 获取操作成功数量
 * @method void setSuccessNum(integer $SuccessNum) 设置操作成功数量
 * @method integer getFailedNum() 获取操作失败数量
 * @method void setFailedNum(integer $FailedNum) 设置操作失败数量
 * @method array getFailedMusicIds() 获取失败歌曲Id
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setFailedMusicIds(array $FailedMusicIds) 设置失败歌曲Id
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param integer $SuccessNum 操作成功数量
     * @param integer $FailedNum 操作失败数量
     * @param array $FailedMusicIds 失败歌曲Id
注意：此字段可能返回 null，表示取不到有效值。

 ...
 *
 * @method array getHostList() 获取<p>镜像关联主机信息列表</p>
 * @method void setHostList(array $HostList) 设置<p>镜像关联主机信息列表</p>
 ...
 */
class DescribeImageAssociatedHostListResponse extends AbstractModel
{
    /**
     * @var array <p>镜像关联主机信息列表</p>
     */
    public $HostList;
    ...
    /**
     * @param array $HostList <p>镜像关联主机信息列表</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("HostList",$param) and $param["HostList"] !== null) {
            ...
            foreach ($param["HostList"] as $key => $value){
                $obj = new ImageAssociatedHostAsset();

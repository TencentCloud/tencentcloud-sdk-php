...
class DescribeHealthCheckTemplatesResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("HealthCheckTemplates",$param) and $param["HealthCheckTemplates"] !== null) {
            $this->HealthCheckTemplates = [];
            foreach ($param["HealthCheckTemplates"] as $key => $value){
                $obj = new HealthCheckTemplate();
                $obj->deserialize($value);
                array_push($this->HealthCheckTemplates, $obj);
            }
        }

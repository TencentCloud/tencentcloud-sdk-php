 ...
 * @method string getLoadByPath() 获取预热路径，入参单条挂载路径。入参数LoadType为LoadByPath，该参数不应为空
 * @method void setLoadByPath(string $LoadByPath) 设置预热路径，入参单条挂载路径。入参数LoadType为LoadByPath，该参数不应为空
 ...
 * @method string getReplica() 获取副本数配置，枚举值，可选值 SingleReplica（单副本，默认）｜MaxReplica（最大副本）
 * @method void setReplica(string $Replica) 设置副本数配置，枚举值，可选值 SingleReplica（单副本，默认）｜MaxReplica（最大副本）
 * @method boolean getMetadataSync() 获取同步执行元数据预热，并基于预热后的元数据执行 DistributedLoad。默认为 false
 * @method void setMetadataSync(boolean $MetadataSync) 设置同步执行元数据预热，并基于预热后的元数据执行 DistributedLoad。默认为 false
 */
class DistributedLoadAttrs extends AbstractModel
{
    /**
    ...
    /**
     * @var string 预热路径，入参单条挂载路径。入参数LoadType为LoadByPath，该参数不应为空
     */
    public $LoadByPath;
    ...
    /**
     * @var string 副本数配置，枚举值，可选值 SingleReplica（单副本，默认）｜MaxReplica（最大副本）
     */
    public $Replica;

    /**
     * @var boolean 同步执行元数据预热，并基于预热后的元数据执行 DistributedLoad。默认为 false
     */
    public $MetadataSync;
     ...
     * @param string $LoadByPath 预热路径，入参单条挂载路径。入参数LoadType为LoadByPath，该参数不应为空
     ...
     * @param string $Replica 副本数配置，枚举值，可选值 SingleReplica（单副本，默认）｜MaxReplica（最大副本）
     * @param boolean $MetadataSync 同步执行元数据预热，并基于预热后的元数据执行 DistributedLoad。默认为 false
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("MetadataSync",$param) and $param["MetadataSync"] !== null) {
            $this->MetadataSync = $param["MetadataSync"];
        }
    }
}

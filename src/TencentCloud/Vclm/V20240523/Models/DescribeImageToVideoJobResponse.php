 ...
 * @method string getDuration() 获取<p>视频总时长，单位s</p>
 ...
 */
class DescribeImageToVideoJobResponse extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>视频总时长，单位s</p>
     */
    public $Duration;

    /**
     * @var string <p>任务最终扣减积分数值</p>
     */

 ...
 * @method integer getLimitRuleID() 获取创建规则的ruleID
 * @method void setLimitRuleID(integer $LimitRuleID) 设置创建规则的ruleID
 * @method string getDomain() 获取所属域名
 * @method void setDomain(string $Domain) 设置所属域名
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class CreateRateLimitV2Response extends AbstractModel
{
    /**
     ...
     * @param integer $LimitRuleID 创建规则的ruleID

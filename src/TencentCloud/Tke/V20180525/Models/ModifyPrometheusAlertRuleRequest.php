 ...
 * @method PrometheusAlertRuleDetail getAlertRule() 获取告警配置
 * @method void setAlertRule(PrometheusAlertRuleDetail $AlertRule) 设置告警配置
 */
class ModifyPrometheusAlertRuleRequest extends AbstractModel
{
    ...
    /**
     * @var PrometheusAlertRuleDetail 告警配置
     */
    public $AlertRule;

    /**
     * @param string $InstanceId 实例id
     * @param PrometheusAlertRuleDetail $AlertRule 告警配置
     */

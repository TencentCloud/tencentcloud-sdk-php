 ...
 * 镜像资产信息
 *
 * @method string getImageRepoAddress() 获取<p>镜像仓库地址</p>
 * @method void setImageRepoAddress(string $ImageRepoAddress) 设置<p>镜像仓库地址</p>
 ...
 * @method string getScanStatus() 获取<p>扫描状态</p><p>枚举值：</p><ul><li>INIT： 未扫描</li><li>SCANNING： 扫描中</li><li>FINISH： 扫描成功</li><li>TIMEOUT： 扫描超时</li><li>FAILED： 扫描失败</li><li>STOPPING： 终止中</li><li>CANCELLED： 扫描已取消</li><li>CREATING： 扫描任务创建中</li><li>LICENSE_NOT_ENOUGH： 授权不足</li></ul>
 * @method void setScanStatus(string $ScanStatus) 设置<p>扫描状态</p><p>枚举值：</p><ul><li>INIT： 未扫描</li><li>SCANNING： 扫描中</li><li>FINISH： 扫描成功</li><li>TIMEOUT： 扫描超时</li><li>FAILED： 扫描失败</li><li>STOPPING： 终止中</li><li>CANCELLED： 扫描已取消</li><li>CREATING： 扫描任务创建中</li><li>LICENSE_NOT_ENOUGH： 授权不足</li></ul>
 ...
 * @method string getOsName() 获取<p>镜像操作系统</p>
 * @method void setOsName(string $OsName) 设置<p>镜像操作系统</p>
 * @method string getInstanceId() 获取<p>所属仓库实例id</p>
 * @method void setInstanceId(string $InstanceId) 设置<p>所属仓库实例id</p>
 * @method string getInstanceName() 获取<p>所属镜像仓库实例名</p>
 * @method void setInstanceName(string $InstanceName) 设置<p>所属镜像仓库实例名</p>
 ...
 * @method boolean getIsLatestImage() 获取<p>是否是最新镜像</p>
 * @method void setIsLatestImage(boolean $IsLatestImage) 设置<p>是否是最新镜像</p>
 ...
 * @method integer getRiskCnt() 获取<p>风险数</p>
 * @method void setRiskCnt(integer $RiskCnt) 设置<p>风险数</p>
 * @method string getScanFailReason() 获取<p>扫描失败原因</p>
 * @method void setScanFailReason(string $ScanFailReason) 设置<p>扫描失败原因</p>
 * @method string getScanSolution() 获取<p>扫描失败解决方案</p>
 * @method void setScanSolution(string $ScanSolution) 设置<p>扫描失败解决方案</p>
 * @method RegionInfo getRegionInfo() 获取<p>地域信息</p>
 * @method void setRegionInfo(RegionInfo $RegionInfo) 设置<p>地域信息</p>
 * @method integer getScanTaskId() 获取<p>最近扫描任务Id</p>
 * @method void setScanTaskId(integer $ScanTaskId) 设置<p>最近扫描任务Id</p>
 */
class ImageAssetInfo extends AbstractModel
{
    /**
     * @var string <p>镜像仓库地址</p>
     */
    ...
    /**
     * @var string <p>扫描状态</p><p>枚举值：</p><ul><li>INIT： 未扫描</li><li>SCANNING： 扫描中</li><li>FINISH： 扫描成功</li><li>TIMEOUT： 扫描超时</li><li>FAILED： 扫描失败</li><li>STOPPING： 终止中</li><li>CANCELLED： 扫描已取消</li><li>CREATING： 扫描任务创建中</li><li>LICENSE_NOT_ENOUGH： 授权不足</li></ul>
     */
    public $ScanStatus;
    ...
    /**
     * @var string <p>镜像操作系统</p>
     */
    public $OsName;

    /**
     * @var string <p>所属仓库实例id</p>
     */
    public $InstanceId;

    /**
     * @var string <p>所属镜像仓库实例名</p>
     */
    public $InstanceName;
    ...
    /**
     * @var string <p>扫描失败原因</p>
     */
    public $ScanFailReason;

    /**
     * @var string <p>扫描失败解决方案</p>
     */
    public $ScanSolution;
    ...
    /**
     * @var integer <p>最近扫描任务Id</p>
     */
    public $ScanTaskId;

    /**
     * @param string $ImageRepoAddress <p>镜像仓库地址</p>
     ...
     * @param string $ScanStatus <p>扫描状态</p><p>枚举值：</p><ul><li>INIT： 未扫描</li><li>SCANNING： 扫描中</li><li>FINISH： 扫描成功</li><li>TIMEOUT： 扫描超时</li><li>FAILED： 扫描失败</li><li>STOPPING： 终止中</li><li>CANCELLED： 扫描已取消</li><li>CREATING： 扫描任务创建中</li><li>LICENSE_NOT_ENOUGH： 授权不足</li></ul>
     * @param integer $VulCnt <p>漏洞数</p>
     * @param integer $VirusCnt <p>木马数</p>
     * @param integer $SensitiveCnt <p>敏感信息数</p>
     * @param string $OsName <p>镜像操作系统</p>
     * @param string $InstanceId <p>所属仓库实例id</p>
     * @param string $InstanceName <p>所属镜像仓库实例名</p>
     ...
     * @param boolean $IsLatestImage <p>是否是最新镜像</p>
     ...
     * @param integer $RiskCnt <p>风险数</p>
     * @param string $ScanFailReason <p>扫描失败原因</p>
     * @param string $ScanSolution <p>扫描失败解决方案</p>
     * @param RegionInfo $RegionInfo <p>地域信息</p>
     * @param integer $ScanTaskId <p>最近扫描任务Id</p>
     */

 ...
 *
 * @method array getWebCallbacks() 获取告警渠道回调配置列表。
 * @method void setWebCallbacks(array $WebCallbacks) 设置告警渠道回调配置列表。
 * @method integer getTotalCount() 获取符合条件的通知内容配置总数。
 * @method void setTotalCount(integer $TotalCount) 设置符合条件的通知内容配置总数。

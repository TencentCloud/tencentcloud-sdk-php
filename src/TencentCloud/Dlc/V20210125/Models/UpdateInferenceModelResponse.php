 ...
 *
 * @method string getModelId() 获取<p>推理模型ID</p>
 * @method void setModelId(string $ModelId) 设置<p>推理模型ID</p>
 ...
 */
class UpdateInferenceModelResponse extends AbstractModel
{
    /**
     * @var string <p>推理模型ID</p>
     */
    public $ModelId;
    ...
    /**
     * @param string $ModelId <p>推理模型ID</p>

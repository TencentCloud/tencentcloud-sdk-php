...
/**
 * @method integer getX() 获取人脸框左上角 x。
 * @method void setX(integer $X) 设置人脸框左上角 x。
 * @method integer getY() 获取人脸框左上角 y。
 * @method void setY(integer $Y) 设置人脸框左上角 y。
...
{
    /**
     * @var integer 人脸框左上角 x。
     */
    public $X;

    /**
     * @var integer 人脸框左上角 y。
     */
    public $Y;
...
魅力( beauty )、眼镜( glass )、口罩（mask）、头发（hair）和姿态 (pitch，roll，yaw )。只有当 NeedFaceAttributes 设为 1 时才返回有效信息。
    ...
    /**
     * @param integer $X 人脸框左上角 x。
     * @param integer $Y 人脸框左上角 y。

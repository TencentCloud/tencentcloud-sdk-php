 ...
 * @method string getName() 获取主机记录
 * @method void setName(string $Name) 设置主机记录
 ...
 * @method integer getTtl() 获取TTL 值
 * @method void setTtl(integer $Ttl) 设置TTL 值
 ...
 * @method boolean getLocked() 获取域名锁
 * @method void setLocked(boolean $Locked) 设置域名锁

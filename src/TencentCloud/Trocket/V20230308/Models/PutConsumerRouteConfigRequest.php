 ...
 * @method array getRules() 获取<p>路由规则</p>
 * @method void setRules(array $Rules) 设置<p>路由规则</p>
 */
class PutConsumerRouteConfigRequest extends AbstractModel
{
    /**

 ...
 *
 * @method array getData() 获取CC防护客户端（攻击源）ip信息列表。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setData(array $Data) 设置CC防护客户端（攻击源）ip信息列表。
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $Data CC防护客户端（攻击源）ip信息列表。
注意：此字段可能返回 null，表示取不到有效值。

 ...
 * @method string getSubProductType() 获取子产品名称
 * @method void setSubProductType(string $SubProductType) 设置子产品名称
 * @method integer getSpecCore() 获取规格核数
 * @method void setSpecCore(integer $SpecCore) 设置规格核数
 * @method integer getSpecMemory() 获取规格内存
 * @method void setSpecMemory(integer $SpecMemory) 设置规格内存
 * @method integer getDiskCount() 获取磁盘大小
 * @method void setDiskCount(integer $DiskCount) 设置磁盘大小
 * @method integer getEncrypt() 获取是否加密
 * @method void setEncrypt(integer $Encrypt) 设置是否加密
 * @method integer getMaxDiskSize() 获取最大磁盘
 * @method void setMaxDiskSize(integer $MaxDiskSize) 设置最大磁盘
 */
class NodesSummary extends AbstractModel
{
     ...
     * @param string $SubProductType 子产品名称
     * @param integer $SpecCore 规格核数
     * @param integer $SpecMemory 规格内存
     * @param integer $DiskCount 磁盘大小
     * @param integer $Encrypt 是否加密
     * @param integer $MaxDiskSize 最大磁盘
     */

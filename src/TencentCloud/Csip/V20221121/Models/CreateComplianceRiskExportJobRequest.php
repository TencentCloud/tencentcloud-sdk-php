 ...
 *
 * @method integer getStandardID() 获取<p>合规标准ID</p>
 * @method void setStandardID(integer $StandardID) 设置<p>合规标准ID</p>
 ...
 */
class CreateComplianceRiskExportJobRequest extends AbstractModel
{
    /**
     * @var integer <p>合规标准ID</p>
     */
    public $StandardID;
    ...
    /**
     * @param integer $StandardID <p>合规标准ID</p>

 ...
 * @method array getPartitions() 获取分区信息
 * @method void setPartitions(array $Partitions) 设置分区信息
 * @method array getProperties() 获取属性
 * @method void setProperties(array $Properties) 设置属性
 * @method array getUpsertKeys() 获取V2 upsert表 upsert键
 * @method void setUpsertKeys(array $UpsertKeys) 设置V2 upsert表 upsert键
 */
class GenerateInternalTableRequest extends AbstractModel
{
    /**

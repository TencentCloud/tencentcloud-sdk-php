 ...
 * @method array getFilters() 获取筛选条件,Name支持ApplicantId,PhoneNumber(按号码模糊查找)
 * @method void setFilters(array $Filters) 设置筛选条件,Name支持ApplicantId,PhoneNumber(按号码模糊查找)
 */
class DescribeCarrierPrivilegeNumberApplicantsRequest extends AbstractModel
{
    ...
    /**
     * @var array 筛选条件,Name支持ApplicantId,PhoneNumber(按号码模糊查找)
     */
    public $Filters;

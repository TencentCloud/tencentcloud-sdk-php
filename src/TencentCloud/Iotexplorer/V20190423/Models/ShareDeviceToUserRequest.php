 ...
 * @method string getToOpenID() 获取<p>被分享用户 OpenID（不存在则自动创建）</p>
 * @method void setToOpenID(string $ToOpenID) 设置<p>被分享用户 OpenID（不存在则自动创建）</p>
 * @method string getToNickName() 获取<p>被分享用户昵称（仅自动创建时使用）</p>
 * @method void setToNickName(string $ToNickName) 设置<p>被分享用户昵称（仅自动创建时使用）</p>
 */
class ShareDeviceToUserRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>被分享用户 OpenID（不存在则自动创建）</p>
     */
    public $ToOpenID;

    /**
     * @var string <p>被分享用户昵称（仅自动创建时使用）</p>
     */
    public $ToNickName;
     ...
     * @param string $ToOpenID <p>被分享用户 OpenID（不存在则自动创建）</p>
     * @param string $ToNickName <p>被分享用户昵称（仅自动创建时使用）</p>
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ToNickName",$param) and $param["ToNickName"] !== null) {

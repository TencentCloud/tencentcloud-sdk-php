 ...
 * @method string getPublishStatus() 获取<p>模型服务是否发布到广场</p><p>枚举值：</p><ul><li>Published： 已发布</li><li>Unpublished： 未发布</li></ul>
 * @method void setPublishStatus(string $PublishStatus) 设置<p>模型服务是否发布到广场</p><p>枚举值：</p><ul><li>Published： 已发布</li><li>Unpublished： 未发布</li></ul>
 * @method boolean getCanPublish() 获取<p>模型服务是否可以发布</p>
 * @method void setCanPublish(boolean $CanPublish) 设置<p>模型服务是否可以发布</p>
 ...
 * @method string getSourceType() 获取<p>资源类型</p><p>枚举值：</p><ul><li>Public： 公共</li><li>Private： 私有</li><li>SourceDelete： 资源删除</li></ul>
 * @method void setSourceType(string $SourceType) 设置<p>资源类型</p><p>枚举值：</p><ul><li>Public： 公共</li><li>Private： 私有</li><li>SourceDelete： 资源删除</li></ul>
 * @method string getSyncedVersion() 获取<p>同步版本</p>
 * @method void setSyncedVersion(string $SyncedVersion) 设置<p>同步版本</p>
 * @method string getStatus() 获取<p>健康状态</p><p>枚举值：</p><ul><li>Error： 异常</li></ul>
 * @method void setStatus(string $Status) 设置<p>健康状态</p><p>枚举值：</p><ul><li>Error： 异常</li></ul>
...
class CloudNativeAPIGatewayLLMModelService extends AbstractModel
{
    ...
    /**
     * @var string <p>模型服务是否发布到广场</p><p>枚举值：</p><ul><li>Published： 已发布</li><li>Unpublished： 未发布</li></ul>
     */
    public $PublishStatus;

    /**
     * @var boolean <p>模型服务是否可以发布</p>
     */
    public $CanPublish;
    ...
    /**
     * @var string <p>资源类型</p><p>枚举值：</p><ul><li>Public： 公共</li><li>Private： 私有</li><li>SourceDelete： 资源删除</li></ul>
     */
    public $SourceType;
    ...
    /**
     * @var string <p>健康状态</p><p>枚举值：</p><ul><li>Error： 异常</li></ul>
     */
    public $Status;
     ...
     * @param string $PublishStatus <p>模型服务是否发布到广场</p><p>枚举值：</p><ul><li>Published： 已发布</li><li>Unpublished： 未发布</li></ul>
     * @param boolean $CanPublish <p>模型服务是否可以发布</p>
     * @param string $SyncStatus <p>同步状态</p><p>枚举值：</p><ul><li>Fail： 失败</li><li>Success： 成功</li></ul>
     * @param string $SourceType <p>资源类型</p><p>枚举值：</p><ul><li>Public： 公共</li><li>Private： 私有</li><li>SourceDelete： 资源删除</li></ul>
     * @param string $SyncedVersion <p>同步版本</p>
     * @param string $Status <p>健康状态</p><p>枚举值：</p><ul><li>Error： 异常</li></ul>

 ...
 * 批量写入路由配置的单条失败项
 *
 * @method ConsumerRouteKey getKey() 获取<p>失败项标识</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setKey(ConsumerRouteKey $Key) 设置<p>失败项标识</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 */
class PutConsumerRouteConfigFailure extends AbstractModel
{
    /**
     * @var ConsumerRouteKey <p>失败项标识</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Key;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param ConsumerRouteKey $Key <p>失败项标识</p>
注意：此字段可能返回 null，表示取不到有效值。

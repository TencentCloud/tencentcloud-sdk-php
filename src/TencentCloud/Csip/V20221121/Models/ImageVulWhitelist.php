 ...
 * @method string getVulName() 获取<p>漏洞白名单名</p>
 * @method void setVulName(string $VulName) 设置<p>漏洞白名单名</p>
 * @method integer getStatus() 获取<p>白名单状态</p><p>枚举值：</p><ul><li>0： 失效</li><li>1： 生效</li></ul>
 * @method void setStatus(integer $Status) 设置<p>白名单状态</p><p>枚举值：</p><ul><li>0： 失效</li><li>1： 生效</li></ul>
...
class ImageVulWhitelist extends AbstractModel
{
    ...
    /**
     * @var string <p>漏洞白名单名</p>
     */
    public $VulName;

    /**
     * @var integer <p>白名单状态</p><p>枚举值：</p><ul><li>0： 失效</li><li>1： 生效</li></ul>
     */
    public $Status;
     ...
     * @param string $VulName <p>漏洞白名单名</p>
     * @param integer $Status <p>白名单状态</p><p>枚举值：</p><ul><li>0： 失效</li><li>1： 生效</li></ul>

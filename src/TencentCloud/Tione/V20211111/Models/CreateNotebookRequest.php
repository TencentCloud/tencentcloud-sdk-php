 ...
 * @method string getChargeType() 获取<p>计算资源付费模式 ，可选值为：<br>PREPAID：预付费，即包年包月<br>POSTPAID_BY_HOUR：按小时后付费</p>
 * @method void setChargeType(string $ChargeType) 设置<p>计算资源付费模式 ，可选值为：<br>PREPAID：预付费，即包年包月<br>POSTPAID_BY_HOUR：按小时后付费</p>
 ...
 * @method string getVolumeSourceType() 获取<p>存储的类型。取值包含：<br>FREE：预付费的免费存储<br>CLOUD_PREMIUM：高性能云硬盘<br>CLOUD_SSD：SSD云硬盘<br>CFS：CFS存储<br>CFS_TURBO：CFS Turbo存储<br>GooseFSx：GooseFSx存储</p>
 * @method void setVolumeSourceType(string $VolumeSourceType) 设置<p>存储的类型。取值包含：<br>FREE：预付费的免费存储<br>CLOUD_PREMIUM：高性能云硬盘<br>CLOUD_SSD：SSD云硬盘<br>CFS：CFS存储<br>CFS_TURBO：CFS Turbo存储<br>GooseFSx：GooseFSx存储</p>
 * @method integer getVolumeSizeInGB() 获取<p>云硬盘存储卷大小，单位GB</p>
 * @method void setVolumeSizeInGB(integer $VolumeSizeInGB) 设置<p>云硬盘存储卷大小，单位GB</p>
 ...
 * @method array getDataConfigs() 获取<p>数据存储挂载配置</p>
 * @method void setDataConfigs(array $DataConfigs) 设置<p>数据存储挂载配置</p>
 ...
 * @method SSHConfig getSSHConfig() 获取<p>SSH配置信息</p>
 * @method void setSSHConfig(SSHConfig $SSHConfig) 设置<p>SSH配置信息</p>
...
class CreateNotebookRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>计算资源付费模式 ，可选值为：<br>PREPAID：预付费，即包年包月<br>POSTPAID_BY_HOUR：按小时后付费</p>
     */
    public $ChargeType;
    ...
    /**
     * @var string <p>存储的类型。取值包含：<br>FREE：预付费的免费存储<br>CLOUD_PREMIUM：高性能云硬盘<br>CLOUD_SSD：SSD云硬盘<br>CFS：CFS存储<br>CFS_TURBO：CFS Turbo存储<br>GooseFSx：GooseFSx存储</p>
     */
    public $VolumeSourceType;

    /**
     * @var integer <p>云硬盘存储卷大小，单位GB</p>
     */
     ...
     * @param string $ChargeType <p>计算资源付费模式 ，可选值为：<br>PREPAID：预付费，即包年包月<br>POSTPAID_BY_HOUR：按小时后付费</p>
     ...
     * @param string $VolumeSourceType <p>存储的类型。取值包含：<br>FREE：预付费的免费存储<br>CLOUD_PREMIUM：高性能云硬盘<br>CLOUD_SSD：SSD云硬盘<br>CFS：CFS存储<br>CFS_TURBO：CFS Turbo存储<br>GooseFSx：GooseFSx存储</p>
     * @param integer $VolumeSizeInGB <p>云硬盘存储卷大小，单位GB</p>

 ...
 *
 * @method array getOrderFields() 获取1
 * @method void setOrderFields(array $OrderFields) 设置1
 * @method array getFilters() 获取1
 * @method void setFilters(array $Filters) 设置1
 */
class DescribeDataSourceWithoutInfoRequest extends AbstractModel
{
    ...
    /**
     * @param array $OrderFields 1
     * @param array $Filters 1
     */

 ...
 * @method LLMReportInterpretationData getData() 获取<p>返回数据</p>
 * @method void setData(LLMReportInterpretationData $Data) 设置<p>返回数据</p>
 ...
 */
class GetLLMReportInterpretationResponse extends AbstractModel
{
    /**
    ...
    /**
     * @var LLMReportInterpretationData <p>返回数据</p>
     */
    public $Data;
     ...
     * @param LLMReportInterpretationData $Data <p>返回数据</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Data",$param) and $param["Data"] !== null) {
            $this->Data = new LLMReportInterpretationData();

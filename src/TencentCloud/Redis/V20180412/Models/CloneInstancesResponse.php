 ...
 * @method array getInstanceIds() 获取<p>克隆实例的 ID。</p>
 * @method void setInstanceIds(array $InstanceIds) 设置<p>克隆实例的 ID。</p>
...
class CloneInstancesResponse extends AbstractModel
{
     ...
     * @param array $InstanceIds <p>克隆实例的 ID。</p>

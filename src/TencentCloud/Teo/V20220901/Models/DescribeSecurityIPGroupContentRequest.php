 ...
 * @method integer getLimit() 获取分页查询限制数目。默认值：2000，最大值：100000。
 * @method void setLimit(integer $Limit) 设置分页查询限制数目。默认值：2000，最大值：100000。
...
class DescribeSecurityIPGroupContentRequest extends AbstractModel
{
    ...
    /**
     * @var integer 分页查询限制数目。默认值：2000，最大值：100000。
     */
    public $Limit;
     ...
     * @param integer $Limit 分页查询限制数目。默认值：2000，最大值：100000。

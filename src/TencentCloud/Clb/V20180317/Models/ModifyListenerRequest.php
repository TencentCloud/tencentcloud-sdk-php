 ...
 * @method integer getMaxCps() 获取监听器最大连接数，只有TCP/UDP/TCP_SSL/QUIC监听器支持，不传或者传-1表示监听器维度不限速。
 * @method void setMaxCps(integer $MaxCps) 设置监听器最大连接数，只有TCP/UDP/TCP_SSL/QUIC监听器支持，不传或者传-1表示监听器维度不限速。
 */
...
分别表示按权重轮询、最小连接数， 默认为 WRR。
     ...
     * @param integer $MaxCps 监听器最大连接数，只有TCP/UDP/TCP_SSL/QUIC监听器支持，不传或者传-1表示监听器维度不限速。
     */

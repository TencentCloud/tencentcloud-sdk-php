 ...
 *
 * @method ExecutionInfo getExecution() 获取<p>执行记录</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setExecution(ExecutionInfo $Execution) 设置<p>执行记录</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param ExecutionInfo $Execution <p>执行记录</p>
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Execution",$param) and $param["Execution"] !== null) {
            $this->Execution = new ExecutionInfo();

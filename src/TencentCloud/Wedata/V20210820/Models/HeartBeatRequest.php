 ...
 * @method boolean getEditFlag() 获取编辑标志
 * @method void setEditFlag(boolean $EditFlag) 设置编辑标志
 */
class HeartBeatRequest extends AbstractModel
{
    /**
     * @var string 资源唯一路径
     */

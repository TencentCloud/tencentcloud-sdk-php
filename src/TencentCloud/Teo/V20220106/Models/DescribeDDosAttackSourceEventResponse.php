 ...
 *
 * @method DDosAttackSourceEventData getData() 获取DDos攻击源数据。
 * @method void setData(DDosAttackSourceEventData $Data) 设置DDos攻击源数据。
...
{
    /**
     * @var DDosAttackSourceEventData DDos攻击源数据。
     */
    public $Data;
...
<li>0 ：成功 。</li>
    ...
    /**
     * @param DDosAttackSourceEventData $Data DDos攻击源数据。
...
<li>0 ：成功 。</li>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Data",$param) and $param["Data"] !== null) {
            $this->Data = new DDosAttackSourceEventData();

 ...
 * @method CloseOpenBankPaymentOrderResult getResult() 获取关单响应对象
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(CloseOpenBankPaymentOrderResult $Result) 设置关单响应对象
注意：此字段可能返回 null，表示取不到有效值。
...
class CloseOpenBankPaymentOrderResponse extends AbstractModel
{
    ...
    /**
     * @var CloseOpenBankPaymentOrderResult 关单响应对象
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
     ...
     * @param CloseOpenBankPaymentOrderResult $Result 关单响应对象
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new CloseOpenBankPaymentOrderResult();

 ...
 */
class DescribeLiveStreamMonitorListResponse extends AbstractModel
{
    /**
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("LiveStreamMonitors",$param) and $param["LiveStreamMonitors"] !== null) {
            $this->LiveStreamMonitors = [];
            foreach ($param["LiveStreamMonitors"] as $key => $value){
                $obj = new LiveStreamMonitorInfo();
                $obj->deserialize($value);
                array_push($this->LiveStreamMonitors, $obj);
            }
        }

 ...
 *
 * @method integer getFailedCount() 获取在批量删除的时候表示删除失败的条数
 * @method void setFailedCount(integer $FailedCount) 设置在批量删除的时候表示删除失败的条数
...
class DeleteIpAccessControlV2Response extends AbstractModel
{
    ...
    /**
     * @param integer $FailedCount 在批量删除的时候表示删除失败的条数

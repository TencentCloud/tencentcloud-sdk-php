 ...
 * @method string getBy() 获取排序字段：生效时间：EffectTime，更新时间：UpdateTime
 * @method void setBy(string $By) 设置排序字段：生效时间：EffectTime，更新时间：UpdateTime
 * @method boolean getTopTurnOn() 获取置顶已开启规则 true：是 ，否：false
 * @method void setTopTurnOn(boolean $TopTurnOn) 设置置顶已开启规则 true：是 ，否：false
 */
...
<li>Status- string - 是否必填：否 - 开启状态 0：开启，1：关闭。</li>
    ...
    /**
     * @var string 排序字段：生效时间：EffectTime，更新时间：UpdateTime
     */
    public $By;

    /**
     * @var boolean 置顶已开启规则 true：是 ，否：false
     */
    public $TopTurnOn;
...
<li>Status- string - 是否必填：否 - 开启状态 0：开启，1：关闭。</li>
     ...
     * @param string $By 排序字段：生效时间：EffectTime，更新时间：UpdateTime
     * @param boolean $TopTurnOn 置顶已开启规则 true：是 ，否：false
     */

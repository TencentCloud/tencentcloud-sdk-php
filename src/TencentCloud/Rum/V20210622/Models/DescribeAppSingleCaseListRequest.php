 ...
 *
 * @method integer getProjectID() 获取app 项目 ID
 * @method void setProjectID(integer $ProjectID) 设置app 项目 ID
 ...
 */
class DescribeAppSingleCaseListRequest extends AbstractModel
{
    /**
     * @var integer app 项目 ID
     */
    public $ProjectID;
    ...
    /**
     * @param integer $ProjectID app 项目 ID

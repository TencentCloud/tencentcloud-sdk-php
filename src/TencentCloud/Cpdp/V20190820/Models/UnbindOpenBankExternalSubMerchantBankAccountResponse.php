 ...
 * @method UnbindOpenBankExternalSubMerchantBankAccountResult getResult() 获取返回结果。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(UnbindOpenBankExternalSubMerchantBankAccountResult $Result) 设置返回结果。
注意：此字段可能返回 null，表示取不到有效值。
...
__其他__: 见附录-错误码表
    ...
    /**
     * @var UnbindOpenBankExternalSubMerchantBankAccountResult 返回结果。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
...
__其他__: 见附录-错误码表
     ...
     * @param UnbindOpenBankExternalSubMerchantBankAccountResult $Result 返回结果。
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new UnbindOpenBankExternalSubMerchantBankAccountResult();

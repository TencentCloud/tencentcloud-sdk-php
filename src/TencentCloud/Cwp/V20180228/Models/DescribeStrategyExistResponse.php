 ...
 *
 * @method integer getIfExist() 获取策略是否存在, 1是 0否
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setIfExist(integer $IfExist) 设置策略是否存在, 1是 0否
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param integer $IfExist 策略是否存在, 1是 0否
注意：此字段可能返回 null，表示取不到有效值。

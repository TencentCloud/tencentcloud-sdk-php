 ...
 * @method string getMpApplicationKey() 获取新建应用的base64密钥字符串，非必选，如果不填写则由系统自动生成
 * @method void setMpApplicationKey(string $MpApplicationKey) 设置新建应用的base64密钥字符串，非必选，如果不填写则由系统自动生成
...
class AddApplicationRequest extends AbstractModel
{
    ...
    /**
     * @var string 新建应用的base64密钥字符串，非必选，如果不填写则由系统自动生成
     */
     ...
     * @param string $MpApplicationKey 新建应用的base64密钥字符串，非必选，如果不填写则由系统自动生成

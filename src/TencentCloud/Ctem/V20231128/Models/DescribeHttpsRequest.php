 ...
 * @method boolean getIsShowChange() 获取是否显示变更
...
class DescribeHttpsRequest extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("IsShowChange",$param) and $param["IsShowChange"] !== null) {
            $this->IsShowChange = $param["IsShowChange"];
        }

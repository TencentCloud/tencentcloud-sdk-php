 ...
 * @method TextToSpeechAsyncInput getInput() 获取<p>语音合成任务输入信息。</p>
 * @method void setInput(TextToSpeechAsyncInput $Input) 设置<p>语音合成任务输入信息。</p>
 * @method TextToSpeechAsyncOutput getOutput() 获取<p>语音合成任务输出信息。</p>
 * @method void setOutput(TextToSpeechAsyncOutput $Output) 设置<p>语音合成任务输出信息。</p>
...
class TextToSpeechAsyncTask extends AbstractModel
{
    ...
    /**
     * @var TextToSpeechAsyncInput <p>语音合成任务输入信息。</p>
     */
    public $Input;

    /**
     * @var TextToSpeechAsyncOutput <p>语音合成任务输出信息。</p>
     */
    public $Output;
     ...
     * @param TextToSpeechAsyncInput $Input <p>语音合成任务输入信息。</p>
     * @param TextToSpeechAsyncOutput $Output <p>语音合成任务输出信息。</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Input",$param) and $param["Input"] !== null) {
            $this->Input = new TextToSpeechAsyncInput();
            $this->Input->deserialize($param["Input"]);
        }

        if (array_key_exists("Output",$param) and $param["Output"] !== null) {
            $this->Output = new TextToSpeechAsyncOutput();

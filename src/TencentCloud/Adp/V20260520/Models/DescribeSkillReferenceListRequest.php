 ...
 *
 * @method string getSkillId() 获取<p>Skill ID，必填</p>
 * @method void setSkillId(string $SkillId) 设置<p>Skill ID，必填</p>
 * @method string getSpaceId() 获取<p>空间ID，必填</p>
 * @method void setSpaceId(string $SpaceId) 设置<p>空间ID，必填</p>
 */
class DescribeSkillReferenceListRequest extends AbstractModel
{
    /**
     * @var string <p>Skill ID，必填</p>
     */
    public $SkillId;
    ...
    /**
     * @param string $SkillId <p>Skill ID，必填</p>

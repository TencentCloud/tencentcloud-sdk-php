 ...
 * @method integer getLimit() 获取分页限制条数
 * @method void setLimit(integer $Limit) 设置分页限制条数
 */
class DescribeAIWorkbenchSREDigitalTwinWorkLogListRequest extends AbstractModel
{
    /**
     * @var integer 数字分身ID
     */

 ...
 * @method array getResources() 获取<p>要解除关联的资源列表。</p>
 * @method void setResources(array $Resources) 设置<p>要解除关联的资源列表。</p>
 */
class DisassociateBudgetRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var array <p>要解除关联的资源列表。</p>
     */
    public $Resources;

    /**
     * @param string $BudgetId <p>Budget ID。</p>
     * @param array $Resources <p>要解除关联的资源列表。</p>
     */

 ...
 * @method integer getEndTime() 获取结束时间，采用unix时间戳。
 * @method void setEndTime(integer $EndTime) 设置结束时间，采用unix时间戳。
 */
class DDoSBlockData extends AbstractModel
{
    ...
    /**
     * @var integer 结束时间，采用unix时间戳。
     */
    public $EndTime;

    /**
     * @param integer $StartTime 开始时间，采用unix时间戳。
     * @param integer $EndTime 结束时间，采用unix时间戳。
     */

 ...
 *
 * @method integer getBackupSetId() 获取<p>备份集ID</p>
 * @method void setBackupSetId(integer $BackupSetId) 设置<p>备份集ID</p>
...
class CreateDBSBackupResponse extends AbstractModel
{
    ...
    /**
     * @param integer $BackupSetId <p>备份集ID</p>

 ...
 * @method integer getStatus() 获取域名解析状态。True 表示正常解析，Flase 表示解析失败。
 * @method void setStatus(integer $Status) 设置域名解析状态。True 表示正常解析，Flase 表示解析失败。
...
class DomainSetList extends AbstractModel
{
    ...
    /**
     * @var integer 域名解析状态。True 表示正常解析，Flase 表示解析失败。
     */
    public $Status;
     ...
     * @param integer $Status 域名解析状态。True 表示正常解析，Flase 表示解析失败。

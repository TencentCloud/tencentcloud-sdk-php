 ...
 * @method array getAlarmInfoSet() 获取告警列表集合
 * @method void setAlarmInfoSet(array $AlarmInfoSet) 设置告警列表集合
 */
class DescribeAlarmListRes extends AbstractModel
{
    /**
     * @var integer 第几页
     */
     ...
     * @param array $AlarmInfoSet 告警列表集合
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("AlarmInfoSet",$param) and $param["AlarmInfoSet"] !== null) {
            $this->AlarmInfoSet = [];
            foreach ($param["AlarmInfoSet"] as $key => $value){
                $obj = new AlarmInfo();
                $obj->deserialize($value);
                array_push($this->AlarmInfoSet, $obj);
            }
        }
    }
}

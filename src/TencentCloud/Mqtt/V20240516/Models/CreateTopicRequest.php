 ...
 * @method string getRemark() 获取<p>备注，最长 128 字符</p>
 * @method void setRemark(string $Remark) 设置<p>备注，最长 128 字符</p>
 */
class CreateTopicRequest extends AbstractModel
{
     ...
     * @param string $Remark <p>备注，最长 128 字符</p>
     */

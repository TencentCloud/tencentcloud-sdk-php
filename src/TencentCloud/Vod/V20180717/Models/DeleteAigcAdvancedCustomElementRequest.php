 ...
 * @method string getElementId() 获取<p>AIGC 高级自定义主体的 ID</p>
 * @method void setElementId(string $ElementId) 设置<p>AIGC 高级自定义主体的 ID</p>
 */
class DeleteAigcAdvancedCustomElementRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>AIGC 高级自定义主体的 ID</p>
     */
    public $ElementId;
     ...
     * @param string $ElementId <p>AIGC 高级自定义主体的 ID</p>
     */

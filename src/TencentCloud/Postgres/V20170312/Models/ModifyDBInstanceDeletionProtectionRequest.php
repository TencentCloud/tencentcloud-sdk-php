 ...
 * @method boolean getDeletionProtection() 获取开启或关闭实例删除保护。true - 开启 ；false - 关闭。
 * @method void setDeletionProtection(boolean $DeletionProtection) 设置开启或关闭实例删除保护。true - 开启 ；false - 关闭。
 */

 ...
 * @method string getFileId() 获取加签接口返回的文件Id
 * @method void setFileId(string $FileId) 设置加签接口返回的文件Id
 */
class VerifyDigitFileRequest extends AbstractModel
{
    /**
     ...
     * @param string $FileId 加签接口返回的文件Id
     */

 ...
 * @method array getPolicyIDList() 获取<p>待重新扫描的基线策略 ID 列表，不可为空且元素不可为 0。</p>
 * @method void setPolicyIDList(array $PolicyIDList) 设置<p>待重新扫描的基线策略 ID 列表，不可为空且元素不可为 0。</p>
...
class ScanBaselinePolicyListRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>待重新扫描的基线策略 ID 列表，不可为空且元素不可为 0。</p>
     */
    public $PolicyIDList;
     ...
     * @param array $PolicyIDList <p>待重新扫描的基线策略 ID 列表，不可为空且元素不可为 0。</p>

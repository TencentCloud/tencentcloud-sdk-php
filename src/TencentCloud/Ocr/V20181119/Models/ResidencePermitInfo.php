 ...
 * @method ContentInfo getPassNum() 获取通行证号码，港澳台居住证国徽面 返回该字段
 * @method void setPassNum(ContentInfo $PassNum) 设置通行证号码，港澳台居住证国徽面 返回该字段
 * @method ContentInfo getIssueNum() 获取签发次数，港澳台居住证国徽面 返回该字段
 * @method void setIssueNum(ContentInfo $IssueNum) 设置签发次数，港澳台居住证国徽面 返回该字段
 */
class ResidencePermitInfo extends AbstractModel
{
    /**
    ...
    /**
     * @var ContentInfo 通行证号码，港澳台居住证国徽面 返回该字段
     */
    public $PassNum;

    /**
     * @var ContentInfo 签发次数，港澳台居住证国徽面 返回该字段
     */
    public $IssueNum;
     ...
     * @param ContentInfo $PassNum 通行证号码，港澳台居住证国徽面 返回该字段
     * @param ContentInfo $IssueNum 签发次数，港澳台居住证国徽面 返回该字段
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("PassNum",$param) and $param["PassNum"] !== null) {
            $this->PassNum = new ContentInfo();
            $this->PassNum->deserialize($param["PassNum"]);
        }

        if (array_key_exists("IssueNum",$param) and $param["IssueNum"] !== null) {
            $this->IssueNum = new ContentInfo();
            $this->IssueNum->deserialize($param["IssueNum"]);
        }
    }
}

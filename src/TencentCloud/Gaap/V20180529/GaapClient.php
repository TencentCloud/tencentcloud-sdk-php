 ...
 * @method Models\CreateFirstLinkSessionResponse CreateFirstLinkSession(Models\CreateFirstLinkSessionRequest $req) 产品功能已下线，对应的api接口下线
 ...
 * @method Models\DeleteFirstLinkSessionResponse DeleteFirstLinkSession(Models\DeleteFirstLinkSessionRequest $req) 产品功能已下线，下线对应的api接口
 ...
 * @method Models\DescribeAuthSignatureResponse DescribeAuthSignature(Models\DescribeAuthSignatureRequest $req) 为了防止在下单、询价、后付费开通等过程中确保来源合法以及订单参数没有被篡改过，各个业务方使用下单、询价等场景需调用计费签名接口获取签名，获取签名的请求需带上签名以验证身份，本接口可以获取计费签名。
 ...
 * @method Models\EnableGlobalDomainResponse EnableGlobalDomain(Models\EnableGlobalDomainRequest $req) 开启域名解析
 ...
 * @method Models\ModifyGlobalDomainAttributeResponse ModifyGlobalDomainAttribute(Models\ModifyGlobalDomainAttributeRequest $req) 修改域名属性
 * @method Models\ModifyGlobalDomainDnsResponse ModifyGlobalDomainDns(Models\ModifyGlobalDomainDnsRequest $req) 修改域名解析记录

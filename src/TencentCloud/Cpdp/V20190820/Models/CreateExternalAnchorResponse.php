 ...
 * @method CreateExternalAnchorData getResult() 获取返回响应
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(CreateExternalAnchorData $Result) 设置返回响应
注意：此字段可能返回 null，表示取不到有效值。
...
class CreateExternalAnchorResponse extends AbstractModel
{
    ...
    /**
     * @var CreateExternalAnchorData 返回响应
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
     ...
     * @param CreateExternalAnchorData $Result 返回响应
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new CreateExternalAnchorData();

 ...
 *
 * @method array getDataList() 获取推荐返回的内容信息列表，返回结果已按策略规则做好了排序
 * @method void setDataList(array $DataList) 设置推荐返回的内容信息列表，返回结果已按策略规则做好了排序
...
{
    /**
     * @var array 推荐返回的内容信息列表，返回结果已按策略规则做好了排序
     */
    public $DataList;
    ...
    /**
     * @param array $DataList 推荐返回的内容信息列表，返回结果已按策略规则做好了排序

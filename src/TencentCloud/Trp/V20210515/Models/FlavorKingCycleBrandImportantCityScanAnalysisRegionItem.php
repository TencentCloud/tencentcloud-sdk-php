 ...
 * @method string getRegion() 获取<p>区</p>
 * @method void setRegion(string $Region) 设置<p>区</p>
 */
class FlavorKingCycleBrandImportantCityScanAnalysisRegionItem extends AbstractModel
{
    /**
     * @var float <p>口味王分布</p>
     */

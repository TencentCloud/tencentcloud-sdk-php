 ...
 * @method array getTags() 获取设备Tag
 * @method void setTags(array $Tags) 设置设备Tag
 * @method integer getBindTime() 获取子设备绑定时间
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setBindTime(integer $BindTime) 设置子设备绑定时间
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param array $Tags 设备Tag
     * @param integer $BindTime 子设备绑定时间
注意：此字段可能返回 null，表示取不到有效值。
     */

...
* Preset：系统预置模板；
* Custom：用户自定义模板。
 * @method string getName() 获取智能审核模板标识过滤条件，长度限制：64 个字符。
 * @method void setName(string $Name) 设置智能审核模板标识过滤条件，长度限制：64 个字符。
 */
...
* Custom：用户自定义模板。
    ...
    /**
     * @var string 智能审核模板标识过滤条件，长度限制：64 个字符。
     */
    public $Name;
...
* Preset：系统预置模板；
* Custom：用户自定义模板。
     * @param string $Name 智能审核模板标识过滤条件，长度限制：64 个字符。
     */

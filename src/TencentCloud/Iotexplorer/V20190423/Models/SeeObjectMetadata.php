 ...
 * @method string getCOSURI() 获取<p>对象的 COS URI</p>
 * @method void setCOSURI(string $COSURI) 设置<p>对象的 COS URI</p>
 * @method string getContentType() 获取<p>对象的 MIME 类型</p>
 * @method void setContentType(string $ContentType) 设置<p>对象的 MIME 类型</p>
 ...
 * @method array getMetadata() 获取<p>对象的自定义元数据列表</p>
 * @method void setMetadata(array $Metadata) 设置<p>对象的自定义元数据列表</p>
 */
class SeeObjectMetadata extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>对象的 COS URI</p>
     */
    public $COSURI;

    /**
     * @var string <p>对象的 MIME 类型</p>
     */
    public $ContentType;
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Metadata",$param) and $param["Metadata"] !== null) {
            ...
            foreach ($param["Metadata"] as $key => $value){
                $obj = new SeeObjectMetadataEntry();

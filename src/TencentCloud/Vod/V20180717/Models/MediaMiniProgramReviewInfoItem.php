 ...
 * @method string getUrl() 获取小程序音视频审核视频播放地址。
 * @method void setUrl(string $Url) 设置小程序音视频审核视频播放地址。
...
<li>Pass：成功。</li>
<li>Rejected：未通过。</li>
 * @method array getReviewSummary() 获取小程序音视频审核元素。
 * @method void setReviewSummary(array $ReviewSummary) 设置小程序音视频审核元素。
 */
...
<li>Rejected：未通过。</li>
     ...
     * @param string $Url 小程序音视频审核视频播放地址。
     * @param string $ReviewResult 小程序视频发布状态：
<li>Pass：成功。</li>
<li>Rejected：未通过。</li>
     * @param array $ReviewSummary 小程序音视频审核元素。
     */

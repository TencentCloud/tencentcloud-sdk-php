 ...
 *
 * @method array getEnableRegions() 获取操作审计支持的cos可用区
 * @method void setEnableRegions(array $EnableRegions) 设置操作审计支持的cos可用区
...
class ListCosEnableRegionResponse extends AbstractModel
{
    ...
    /**
     * @param array $EnableRegions 操作审计支持的cos可用区

 ...
 * GetEidResult请求参数结构体
 *
 * @method string getEidToken() 获取人脸核身流程的标识，调用DetectAuth接口时生成。
 * @method void setEidToken(string $EidToken) 设置人脸核身流程的标识，调用DetectAuth接口时生成。
...
默认值：0
    ...
    /**
     * @param string $EidToken 人脸核身流程的标识，调用DetectAuth接口时生成。

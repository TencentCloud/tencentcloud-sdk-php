 ...
 *
 * @method integer getWorkGroupId() 获取工作组Id，全局唯一
 * @method void setWorkGroupId(integer $WorkGroupId) 设置工作组Id，全局唯一
...
class CreateWorkGroupResponse extends AbstractModel
{
    ...
    /**
     * @param integer $WorkGroupId 工作组Id，全局唯一

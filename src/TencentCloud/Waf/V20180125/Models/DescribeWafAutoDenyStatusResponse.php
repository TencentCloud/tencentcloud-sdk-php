 ...
 *
 * @method AutoDenyDetail getWafAutoDenyDetails() 获取WAF 自动封禁详情
 * @method void setWafAutoDenyDetails(AutoDenyDetail $WafAutoDenyDetails) 设置WAF 自动封禁详情
...
class DescribeWafAutoDenyStatusResponse extends AbstractModel
{
    ...
    /**
     * @param AutoDenyDetail $WafAutoDenyDetails WAF 自动封禁详情

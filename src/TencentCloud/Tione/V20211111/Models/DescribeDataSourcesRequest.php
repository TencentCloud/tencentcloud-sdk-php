 ...
 * @method string getOrderField() 获取排序的依据字段
 * @method void setOrderField(string $OrderField) 设置排序的依据字段
 ...
 */
class DescribeDataSourcesRequest extends AbstractModel
{
    /**
     * @var array 过滤条件
     */
     ...
     * @param string $OrderField 排序的依据字段

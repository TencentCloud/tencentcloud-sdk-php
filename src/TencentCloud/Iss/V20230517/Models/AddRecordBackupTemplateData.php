 ...
 * @method integer getDayOffset() 获取<p>周期偏移量，默认1，表示拉取昨天的设备录像，0表示取去今天的设备录像，3表示拉取前天的设备录像</p><p>默认值：1</p>
 * @method void setDayOffset(integer $DayOffset) 设置<p>周期偏移量，默认1，表示拉取昨天的设备录像，0表示取去今天的设备录像，3表示拉取前天的设备录像</p><p>默认值：1</p>
 */
class AddRecordBackupTemplateData extends AbstractModel
{
    /**
     * @var string <p>模板ID</p>
     */
    ...
    /**
     * @var integer <p>周期偏移量，默认1，表示拉取昨天的设备录像，0表示取去今天的设备录像，3表示拉取前天的设备录像</p><p>默认值：1</p>
     */
    public $DayOffset;
     ...
     * @param integer $DayOffset <p>周期偏移量，默认1，表示拉取昨天的设备录像，0表示取去今天的设备录像，3表示拉取前天的设备录像</p><p>默认值：1</p>
     */

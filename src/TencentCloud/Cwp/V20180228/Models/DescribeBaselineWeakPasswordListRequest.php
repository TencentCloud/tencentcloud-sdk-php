 ...
 * @method string getBy() 获取可选排序列 [CreateTime|ModifyTime]
 * @method void setBy(string $By) 设置可选排序列 [CreateTime|ModifyTime]
 */
class DescribeBaselineWeakPasswordListRequest extends AbstractModel
{
    ...
    /**
     * @var string 可选排序列 [CreateTime|ModifyTime]
     */
    public $By;
     ...
     * @param string $By 可选排序列 [CreateTime|ModifyTime]
     */

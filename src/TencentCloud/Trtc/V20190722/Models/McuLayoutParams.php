 ...
 * @method integer getPureAudioHoldPlaceMode() 获取纯音频上行是否占布局位置，只在动态布局中有效。0表示纯音频占布局位置，1表示纯音频不占布局位置，不填默认为0。
 * @method void setPureAudioHoldPlaceMode(integer $PureAudioHoldPlaceMode) 设置纯音频上行是否占布局位置，只在动态布局中有效。0表示纯音频占布局位置，1表示纯音频不占布局位置，不填默认为0。
...
class McuLayoutParams extends AbstractModel
{
    ...
    /**
     * @var integer 纯音频上行是否占布局位置，只在动态布局中有效。0表示纯音频占布局位置，1表示纯音频不占布局位置，不填默认为0。
     */
     ...
     * @param integer $PureAudioHoldPlaceMode 纯音频上行是否占布局位置，只在动态布局中有效。0表示纯音频占布局位置，1表示纯音频不占布局位置，不填默认为0。

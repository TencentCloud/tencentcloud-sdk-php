 ...
 * 匹配请求信息
 *
 * @method string getId() 获取MatchTicketId 长度 128
 * @method void setId(string $Id) 设置MatchTicketId 长度 128
...
{
    /**
     * @var string MatchTicketId 长度 128
     */
    public $Id;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param string $Id MatchTicketId 长度 128

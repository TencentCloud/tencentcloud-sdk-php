...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getConfigValue() 获取配置项的值
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setConfigValue(string $ConfigValue) 设置配置项的值
注意：此字段可能返回 null，表示取不到有效值。
 */
class EngineResourceGroupConfigPair extends AbstractModel
{
    /**
     * @var string 配置项
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $ConfigValue 配置项的值
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 * @method array getQuuidList() 获取<p>需要绑定的机器quuid列表, 当IsAll = false 时必填,反之忽略该参数.<br>最大长度=100</p>
 * @method void setQuuidList(array $QuuidList) 设置<p>需要绑定的机器quuid列表, 当IsAll = false 时必填,反之忽略该参数.<br>最大长度=100</p>
 */
class ModifyLicenseUnBindsRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>需要绑定的机器quuid列表, 当IsAll = false 时必填,反之忽略该参数.<br>最大长度=100</p>
     */
    public $QuuidList;
     ...
     * @param array $QuuidList <p>需要绑定的机器quuid列表, 当IsAll = false 时必填,反之忽略该参数.<br>最大长度=100</p>
     */

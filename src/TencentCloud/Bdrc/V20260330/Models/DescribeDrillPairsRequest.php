 ...
 *
 * @method string getDrillPairType() 获取要查询演练对的类型。枚举值：DISK / INSTANCE / CFS。
 * @method void setDrillPairType(string $DrillPairType) 设置要查询演练对的类型。枚举值：DISK / INSTANCE / CFS。
 * @method array getDrillPairIds() 获取要查询演练对ID列表。
 * @method void setDrillPairIds(array $DrillPairIds) 设置要查询演练对ID列表。
 ...
 * @method string getOrderField() 获取输出结果的排序字段。枚举值：CREATE_TIME / END_TIME。
 * @method void setOrderField(string $OrderField) 设置输出结果的排序字段。枚举值：CREATE_TIME / END_TIME。
 */
class DescribeDrillPairsRequest extends AbstractModel
{
    /**
     * @var string 要查询演练对的类型。枚举值：DISK / INSTANCE / CFS。
     */
    public $DrillPairType;

    /**
     * @var array 要查询演练对ID列表。
     */
    public $DrillPairIds;
    ...
    /**
     * @var string 输出结果的排序字段。枚举值：CREATE_TIME / END_TIME。
     */
    public $OrderField;

    /**
     * @param string $DrillPairType 要查询演练对的类型。枚举值：DISK / INSTANCE / CFS。
     * @param array $DrillPairIds 要查询演练对ID列表。
     ...
     * @param string $OrderField 输出结果的排序字段。枚举值：CREATE_TIME / END_TIME。
     */

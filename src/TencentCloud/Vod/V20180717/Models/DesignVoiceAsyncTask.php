 ...
 * @method DesignVoiceAsyncInput getInput() 获取<p>音色设计任务输入信息。</p>
 * @method void setInput(DesignVoiceAsyncInput $Input) 设置<p>音色设计任务输入信息。</p>
 * @method DesignVoiceAsyncOutput getOutput() 获取<p>音色设计任务输出信息。</p>
 * @method void setOutput(DesignVoiceAsyncOutput $Output) 设置<p>音色设计任务输出信息。</p>
 ...
 */
class DesignVoiceAsyncTask extends AbstractModel
{
    /**
    ...
    /**
     * @var DesignVoiceAsyncInput <p>音色设计任务输入信息。</p>
     */
    public $Input;

    /**
     * @var DesignVoiceAsyncOutput <p>音色设计任务输出信息。</p>
     */
    public $Output;
     ...
     * @param DesignVoiceAsyncInput $Input <p>音色设计任务输入信息。</p>
     * @param DesignVoiceAsyncOutput $Output <p>音色设计任务输出信息。</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Input",$param) and $param["Input"] !== null) {
            $this->Input = new DesignVoiceAsyncInput();
            $this->Input->deserialize($param["Input"]);
        }

        if (array_key_exists("Output",$param) and $param["Output"] !== null) {
            $this->Output = new DesignVoiceAsyncOutput();

 ...
 *
 * @method array getRegionZones() 获取<p>各可用区的资源售卖情况以及支持的存储类型、存储协议等信息</p>
 * @method void setRegionZones(array $RegionZones) 设置<p>各可用区的资源售卖情况以及支持的存储类型、存储协议等信息</p>
...
{
    /**
     * @var array <p>各可用区的资源售卖情况以及支持的存储类型、存储协议等信息</p>
     */
    public $RegionZones;
    ...
    /**
     * @param array $RegionZones <p>各可用区的资源售卖情况以及支持的存储类型、存储协议等信息</p>

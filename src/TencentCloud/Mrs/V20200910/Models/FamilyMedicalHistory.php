 ...
 * 家族疾病史
 *
 * @method string getRelativeHistory() 获取""
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setRelativeHistory(string $RelativeHistory) 设置""
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getRelativeCancerHistory() 获取""
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setRelativeCancerHistory(string $RelativeCancerHistory) 设置""
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getGeneticHistory() 获取""
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setGeneticHistory(string $GeneticHistory) 设置""
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param string $RelativeHistory ""
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $RelativeCancerHistory ""
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $GeneticHistory ""
注意：此字段可能返回 null，表示取不到有效值。
     */

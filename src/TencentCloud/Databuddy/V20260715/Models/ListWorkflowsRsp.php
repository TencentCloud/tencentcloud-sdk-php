...
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getItems() 获取工作流列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setItems(array $Items) 设置工作流列表
注意：此字段可能返回 null，表示取不到有效值。
 */
class ListWorkflowsRsp extends AbstractModel
{
    /**
     * @var integer 当前页码
注意：此字段可能返回 null，表示取不到有效值。

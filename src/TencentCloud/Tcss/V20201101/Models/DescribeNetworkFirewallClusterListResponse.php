 ...
 * @method array getClusterInfoList() 获取集群的详细信息
 * @method void setClusterInfoList(array $ClusterInfoList) 设置集群的详细信息
...
class DescribeNetworkFirewallClusterListResponse extends AbstractModel
{
     ...
     * @param array $ClusterInfoList 集群的详细信息
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ClusterInfoList",$param) and $param["ClusterInfoList"] !== null) {
            ...
            foreach ($param["ClusterInfoList"] as $key => $value){
                $obj = new NetworkClusterInfoItem();

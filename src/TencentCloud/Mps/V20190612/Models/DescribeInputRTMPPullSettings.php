 ...
 * 查询输入的RTMP配置信息。
 *
 * @method array getSourceAddresses() 获取RTMP源站地址信息。
 * @method void setSourceAddresses(array $SourceAddresses) 设置RTMP源站地址信息。
 */
class DescribeInputRTMPPullSettings extends AbstractModel
{
    /**
     * @var array RTMP源站地址信息。
     */
    public $SourceAddresses;

    /**
     * @param array $SourceAddresses RTMP源站地址信息。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("SourceAddresses",$param) and $param["SourceAddresses"] !== null) {
            ...
            foreach ($param["SourceAddresses"] as $key => $value){
                $obj = new DescribeRTMPPullSourceAddress();

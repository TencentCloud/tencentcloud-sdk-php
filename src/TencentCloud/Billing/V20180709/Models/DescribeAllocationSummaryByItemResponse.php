 ...
 * @method array getDetail() 获取<p>分账账单按组件汇总明细</p>
 * @method void setDetail(array $Detail) 设置<p>分账账单按组件汇总明细</p>
...
class DescribeAllocationSummaryByItemResponse extends AbstractModel
{
     ...
     * @param array $Detail <p>分账账单按组件汇总明细</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Detail",$param) and $param["Detail"] !== null) {
            ...
            foreach ($param["Detail"] as $key => $value){
                $obj = new AllocationSummaryByItem();

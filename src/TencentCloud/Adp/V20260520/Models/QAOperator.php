...
注意：此字段可能返回 null，表示取不到有效值。
 * @method QAPermission getPermission() 获取<p>操作权限</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setPermission(QAPermission $Permission) 设置<p>操作权限</p>
注意：此字段可能返回 null，表示取不到有效值。
 */
class QAOperator extends AbstractModel
{
    /**
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param QAPermission $Permission <p>操作权限</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Permission",$param) and $param["Permission"] !== null) {
            $this->Permission = new QAPermission();

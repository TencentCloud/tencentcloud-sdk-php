 ...
 * @method array getEndpoints() 获取<p>端点列表</p>
 * @method void setEndpoints(array $Endpoints) 设置<p>端点列表</p>
 */
class EBPFDestEndpointFilter extends AbstractModel
{
    /**
     ...
     * @param array $Endpoints <p>端点列表</p>
     */

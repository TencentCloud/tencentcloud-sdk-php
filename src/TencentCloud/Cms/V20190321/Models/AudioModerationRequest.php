 ...
 * @method void setFileMD5(string $FileMD5) 设置音频文件的MD5值
 * @method string getFileUrl() 获取音频内容Url ，其中FileUrl和FileContent二选一
 * @method void setFileUrl(string $FileUrl) 设置音频内容Url ，其中FileUrl和FileContent二选一
 */
...
class AudioModerationRequest extends AbstractModel
{
    ...
    /**
     * @var string 音频内容的base64
     */
    public $FileContent;

    /**
     * @var string 音频文件的MD5值
     */
    public $FileMD5;

    /**
     * @var string 音频内容Url ，其中FileUrl和FileContent二选一
     */
    public $FileUrl;
    /**

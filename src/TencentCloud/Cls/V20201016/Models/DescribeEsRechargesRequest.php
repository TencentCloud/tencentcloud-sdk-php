...
- 通过 [获取日志主题列表](https://cloud.tencent.com/document/product/614/56454) 获取日志主题Id。
- 通过 [创建日志主题](https://cloud.tencent.com/document/product/614/56456) 获取日志主题Id。
 * @method array getFilters() 获取-  taskId按照【配置id】进行过滤。类型：String  必选：否
-  name按照【配置名称】进行过滤。类型：String 必选：否
-  statusFlag按照【配置状态标记】进行过滤。类型：String 必选：否
-  每次请求的Filters的上限为10，Filter.Values的上限为100。
 * @method void setFilters(array $Filters) 设置-  taskId按照【配置id】进行过滤。类型：String  必选：否
-  name按照【配置名称】进行过滤。类型：String 必选：否
-  statusFlag按照【配置状态标记】进行过滤。类型：String 必选：否
-  每次请求的Filters的上限为10，Filter.Values的上限为100。
...
- 通过 [创建日志主题](https://cloud.tencent.com/document/product/614/56456) 获取日志主题Id。
    ...
    /**
     * @var array -  taskId按照【配置id】进行过滤。类型：String  必选：否
-  name按照【配置名称】进行过滤。类型：String 必选：否
-  statusFlag按照【配置状态标记】进行过滤。类型：String 必选：否
-  每次请求的Filters的上限为10，Filter.Values的上限为100。
     */
...
- 通过 [获取日志主题列表](https://cloud.tencent.com/document/product/614/56454) 获取日志主题Id。
- 通过 [创建日志主题](https://cloud.tencent.com/document/product/614/56456) 获取日志主题Id。
     * @param array $Filters -  taskId按照【配置id】进行过滤。类型：String  必选：否
-  name按照【配置名称】进行过滤。类型：String 必选：否
-  statusFlag按照【配置状态标记】进行过滤。类型：String 必选：否
-  每次请求的Filters的上限为10，Filter.Values的上限为100。

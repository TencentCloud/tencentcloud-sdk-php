 ...
 *
 * @method array getFilters() 获取<p>过滤条件，支持 car-number（车牌号模糊匹配）、driver-name（驾驶员姓名模糊匹配）</p>
 * @method void setFilters(array $Filters) 设置<p>过滤条件，支持 car-number（车牌号模糊匹配）、driver-name（驾驶员姓名模糊匹配）</p>
 ...
 */
class DescribeWorkOrderCarCollectListRequest extends AbstractModel
{
    /**
     * @var array <p>过滤条件，支持 car-number（车牌号模糊匹配）、driver-name（驾驶员姓名模糊匹配）</p>
     */
    public $Filters;
    ...
    /**
     * @param array $Filters <p>过滤条件，支持 car-number（车牌号模糊匹配）、driver-name（驾驶员姓名模糊匹配）</p>

 ...
 * @method array getRegionConfig() 获取地域的可用区售卖配置
 * @method void setRegionConfig(array $RegionConfig) 设置地域的可用区售卖配置
 */
class CdbRegionSellConf extends AbstractModel
{
     ...
     * @param array $RegionConfig 地域的可用区售卖配置
     */

 ...
 * @method array getEntries() 获取需要更新的术语条目列表，单次请求限制100个
 * @method void setEntries(array $Entries) 设置需要更新的术语条目列表，单次请求限制100个
 */
class UpdateGlossaryEntryRequest extends AbstractModel
{
    /**
     * @var string 术语库 ID
     */
    ...
    /**
     * @var array 需要更新的术语条目列表，单次请求限制100个
     */
    public $Entries;

    /**
     * @param string $GlossaryId 术语库 ID
     * @param array $Entries 需要更新的术语条目列表，单次请求限制100个
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Entries",$param) and $param["Entries"] !== null) {
            ...
            foreach ($param["Entries"] as $key => $value){
                $obj = new GlossaryEntryUpdateItem();

 ...
 *
 * @method array getCertificateIds() 获取扩展证书 ID 列表。
 * @method void setCertificateIds(array $CertificateIds) 设置扩展证书 ID 列表。
...
false（默认值）：发送正常请求，通过检查后返回HTTP2xx状态码并直接进行操作。
    ...
    /**
     * @param array $CertificateIds 扩展证书 ID 列表。

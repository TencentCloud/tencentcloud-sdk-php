 ...
 *
 * @method array getRemindFlowRecords() 获取<p>合同催办结果的详细信息列表。</p>
 * @method void setRemindFlowRecords(array $RemindFlowRecords) 设置<p>合同催办结果的详细信息列表。</p>
...
class CreateFlowRemindsResponse extends AbstractModel
{
    ...
    /**
     * @param array $RemindFlowRecords <p>合同催办结果的详细信息列表。</p>

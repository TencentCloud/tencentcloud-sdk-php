 ...
 * @method string getAuthSubAccountUin() 获取子用户
 * @method void setAuthSubAccountUin(string $AuthSubAccountUin) 设置子用户
 */
class DescribeWorkSpaceUsersRequest extends AbstractModel
{
    /**
     ...
     * @param string $AuthSubAccountUin 子用户
     */

 ...
 * @method SmartEraseTaskInput getInput() 获取智能擦除输入。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setInput(SmartEraseTaskInput $Input) 设置智能擦除输入。
注意：此字段可能返回 null，表示取不到有效值。
...
class SmartEraseTaskResult extends AbstractModel
{
    ...
    /**
     * @var SmartEraseTaskInput 智能擦除输入。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Input;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param SmartEraseTaskInput $Input 智能擦除输入。
注意：此字段可能返回 null，表示取不到有效值。

 ...
 * @method string getProtocol() 获取 协议, 取值: TCP,UDP,ICMP,ICMPv6,ALL。
 * @method void setProtocol(string $Protocol) 设置 协议, 取值: TCP,UDP,ICMP,ICMPv6,ALL。
 * @method string getPort() 获取端口(all, 离散port,  range)。
 * @method void setPort(string $Port) 设置端口(all, 离散port,  range)。
 * @method ServiceTemplateSpecification getServiceTemplate() 获取端口ID或者协议端口组ID。ServiceTemplate和Protocol+Port互斥。
 * @method void setServiceTemplate(ServiceTemplateSpecification $ServiceTemplate) 设置端口ID或者协议端口组ID。ServiceTemplate和Protocol+Port互斥。
 ...
 * @method string getVersion() 获取安全组规则当前版本
 * @method void setVersion(string $Version) 设置安全组规则当前版本
 * @method string getDirection() 获取规则方向，Egress出站规则，Ingress入站规则
 * @method void setDirection(string $Direction) 设置规则方向，Egress出站规则，Ingress入站规则
 * @method string getModifyTime() 获取安全组最近修改时间。
 * @method void setModifyTime(string $ModifyTime) 设置安全组最近修改时间。
 * @method string getRegion() 获取安全组所在地域
 * @method void setRegion(string $Region) 设置安全组所在地域
 */
class SecurityGroupRiskPolicy extends AbstractModel
{
    /**
    ...
    /**
     * @var ServiceTemplateSpecification 端口ID或者协议端口组ID。ServiceTemplate和Protocol+Port互斥。
     */
    ...
    /**
     * @var string 安全组规则当前版本
     */
    public $Version;

    /**
     * @var string 规则方向，Egress出站规则，Ingress入站规则
     */
    public $Direction;
     ...
     * @param ServiceTemplateSpecification $ServiceTemplate 端口ID或者协议端口组ID。ServiceTemplate和Protocol+Port互斥。
     ...
     * @param string $Version 安全组规则当前版本
     * @param string $Direction 规则方向，Egress出站规则，Ingress入站规则
     * @param string $ModifyTime 安全组最近修改时间。
     * @param string $Region 安全组所在地域
     */

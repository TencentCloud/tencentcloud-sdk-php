 ...
 *
 * @method integer getLaunchTemplateVersionNumber() 获取<p>新创建的实例启动模板版本号。</p>
 * @method void setLaunchTemplateVersionNumber(integer $LaunchTemplateVersionNumber) 设置<p>新创建的实例启动模板版本号。</p>
...
class CreateLaunchTemplateVersionResponse extends AbstractModel
{
    ...
    /**
     * @param integer $LaunchTemplateVersionNumber <p>新创建的实例启动模板版本号。</p>

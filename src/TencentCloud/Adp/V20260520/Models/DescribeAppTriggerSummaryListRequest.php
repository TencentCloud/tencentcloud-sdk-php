 ...
 * @method array getFilterList() 获取<p>参数过滤列表</p>
 * @method void setFilterList(array $FilterList) 设置<p>参数过滤列表</p>
 ...
 * @method integer getPageSize() 获取<p>每页大小</p><p>取值范围：[1, 100]</p>
...
class DescribeAppTriggerSummaryListRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>每页大小</p><p>取值范围：[1, 100]</p>
     */
    public $PageSize;

    /**
     * @var string <p>模糊查询字符串</p>
     */
    public $Query;

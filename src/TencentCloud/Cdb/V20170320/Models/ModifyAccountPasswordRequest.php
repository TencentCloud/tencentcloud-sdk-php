 ...
 * @method boolean getSkipValidatePassword() 获取该字段已废弃。
 * @method void setSkipValidatePassword(boolean $SkipValidatePassword) 设置该字段已废弃。
 */
class ModifyAccountPasswordRequest extends AbstractModel
{
     ...
     * @param boolean $SkipValidatePassword 该字段已废弃。
     */

 ...
 * @method Models\RequestLocalTaskResponse RequestLocalTask(Models\RequestLocalTaskRequest $req) client任务请求地址
 * @method Models\UpdateClientStateResponse UpdateClientState(Models\UpdateClientStateRequest $req) 更新client状态
 * @method Models\UpdateLocalTaskResultResponse UpdateLocalTaskResult(Models\UpdateLocalTaskResultRequest $req) 更新本地任务结果
 */

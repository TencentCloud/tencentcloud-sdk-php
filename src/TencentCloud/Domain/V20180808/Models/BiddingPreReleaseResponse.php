 ...
 * @method string getBillingParam() 获取计费请求参数，以Json字符串的形式进行返回。
 * @method void setBillingParam(string $BillingParam) 设置计费请求参数，以Json字符串的形式进行返回。
...
class BiddingPreReleaseResponse extends AbstractModel
{
    ...
    /**
     * @var string 计费请求参数，以Json字符串的形式进行返回。
     */
    public $BillingParam;
     ...
     * @param string $BillingParam 计费请求参数，以Json字符串的形式进行返回。

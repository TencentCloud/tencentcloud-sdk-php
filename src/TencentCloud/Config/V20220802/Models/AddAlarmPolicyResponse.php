 ...
 *
 * @method integer getAlarmPolicyId() 获取<p>告警策略唯一id</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setAlarmPolicyId(integer $AlarmPolicyId) 设置<p>告警策略唯一id</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param integer $AlarmPolicyId <p>告警策略唯一id</p>
注意：此字段可能返回 null，表示取不到有效值。

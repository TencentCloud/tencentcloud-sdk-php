...
<li>bot_friendlyRequestNum ：友好bot请求次数 ；</li>
<li>bot_normalRequestNum ：正常bot请求次数 。</li>
 * @method array getDomains() 获取查询的子域名列表，不填默认选择全部子域名。
 * @method void setDomains(array $Domains) 设置查询的子域名列表，不填默认选择全部子域名。
 * @method array getZoneIds() 获取站点列表，不填默认选择全部站点。
 * @method void setZoneIds(array $ZoneIds) 设置站点列表，不填默认选择全部站点。
...
<li>bot_normalRequestNum ：正常bot请求次数 。</li>
    ...
    /**
     * @var array 查询的子域名列表，不填默认选择全部子域名。
     */
    public $Domains;

    /**
     * @var array 站点列表，不填默认选择全部站点。
     */
    public $ZoneIds;
...
<li>bot_friendlyRequestNum ：友好bot请求次数 ；</li>
<li>bot_normalRequestNum ：正常bot请求次数 。</li>
     * @param array $Domains 查询的子域名列表，不填默认选择全部子域名。
     * @param array $ZoneIds 站点列表，不填默认选择全部站点。

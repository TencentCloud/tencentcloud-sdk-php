 ...
 *
 * @method string getContainer() 获取<p>封装格式，可选值：mp4、flv、hls、ts、webm、mkv、mxf、mov、mp3、flac、ogg、m4a、wav。其中，mp3、flac、ogg、m4a、wav 为纯音频文件。</p>
 * @method void setContainer(string $Container) 设置<p>封装格式，可选值：mp4、flv、hls、ts、webm、mkv、mxf、mov、mp3、flac、ogg、m4a、wav。其中，mp3、flac、ogg、m4a、wav 为纯音频文件。</p>
 ...
 * @method string getStdExtInfo() 获取<p>扩展参数，序列化的 json 字符串。</p>
 * @method void setStdExtInfo(string $StdExtInfo) 设置<p>扩展参数，序列化的 json 字符串。</p>
 */
class CreateTranscodeTemplateRequest extends AbstractModel
{
    /**
     * @var string <p>封装格式，可选值：mp4、flv、hls、ts、webm、mkv、mxf、mov、mp3、flac、ogg、m4a、wav。其中，mp3、flac、ogg、m4a、wav 为纯音频文件。</p>
     */
    public $Container;
    ...
    /**
     * @var string <p>扩展参数，序列化的 json 字符串。</p>
     */
    public $StdExtInfo;

    /**
     * @param string $Container <p>封装格式，可选值：mp4、flv、hls、ts、webm、mkv、mxf、mov、mp3、flac、ogg、m4a、wav。其中，mp3、flac、ogg、m4a、wav 为纯音频文件。</p>
     ...
     * @param string $StdExtInfo <p>扩展参数，序列化的 json 字符串。</p>
     */

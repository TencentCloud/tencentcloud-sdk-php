 ...
 * @method array getKeywords() 获取<p>关键词。</p>
 * @method void setKeywords(array $Keywords) 设置<p>关键词。</p>
 * @method string getDesc() 获取<p>中文二级标签。</p>
 * @method void setDesc(string $Desc) 设置<p>中文二级标签。</p>
 * @method integer getScore() 获取<p>置信度分数，取值范围：0（置信度最低）-100（置信度最高 ），越高代表越有可能属于当前返回的标签。 实例值：100</p>
 * @method void setScore(integer $Score) 设置<p>置信度分数，取值范围：0（置信度最低）-100（置信度最高 ），越高代表越有可能属于当前返回的标签。 实例值：100</p>
...
class ModerationCheckDetail extends AbstractModel
{
     ...
     * @param array $Keywords <p>关键词。</p>
     * @param string $Desc <p>中文二级标签。</p>
     * @param integer $Score <p>置信度分数，取值范围：0（置信度最低）-100（置信度最高 ），越高代表越有可能属于当前返回的标签。 实例值：100</p>

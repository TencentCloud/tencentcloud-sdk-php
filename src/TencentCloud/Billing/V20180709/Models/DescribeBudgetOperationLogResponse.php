 ...
 *
 * @method DataForBudgetOperationLogPage getData() 获取预算修改记录详情
 * @method void setData(DataForBudgetOperationLogPage $Data) 设置预算修改记录详情
...
{
    /**
     * @var DataForBudgetOperationLogPage 预算修改记录详情
     */
    public $Data;
    ...
    /**
     * @param DataForBudgetOperationLogPage $Data 预算修改记录详情

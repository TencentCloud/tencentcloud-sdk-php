 ...
 * @method integer getIsGroupRole() 获取角色类型，0:saas角色，1:集团角色
默认0，saas角色
 * @method void setIsGroupRole(integer $IsGroupRole) 设置角色类型，0:saas角色，1:集团角色
默认0，saas角色
...
注: 在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。
    ...
    /**
     * @var integer 角色类型，0:saas角色，1:集团角色
默认0，saas角色
     */
    public $IsGroupRole;

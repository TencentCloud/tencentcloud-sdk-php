 ...
 * @method string getAuthorizationTime() 获取授权时间，格式20160801095509
 * @method void setAuthorizationTime(string $AuthorizationTime) 设置授权时间，格式20160801095509
...
class SignContractByCoordinateRequest extends AbstractModel
{
    ...
    /**
     * @var string 授权时间，格式20160801095509
     */
     ...
     * @param string $AuthorizationTime 授权时间，格式20160801095509

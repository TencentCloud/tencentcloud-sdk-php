 ...
 * @method Models\CreateAgentApplicationResponse CreateAgentApplication(Models\CreateAgentApplicationRequest $req) 本接口用于创建Agent应用
 ...
 * @method Models\CreateConsoleResponse CreateConsole(Models\CreateConsoleRequest $req) 本接口用于创建DataSight控制台
 ...
 * @method Models\DeleteAgentApplicationResponse DeleteAgentApplication(Models\DeleteAgentApplicationRequest $req) 本接口用于删除Agent应用
 ...
 * @method Models\DeleteConsoleResponse DeleteConsole(Models\DeleteConsoleRequest $req) 本接口用于删除DataSight控制台
 ...
 * @method Models\DescribeAgentApplicationsResponse DescribeAgentApplications(Models\DescribeAgentApplicationsRequest $req) 获取Agent应用列表
 * @method Models\DescribeAgentConfigsResponse DescribeAgentConfigs(Models\DescribeAgentConfigsRequest $req) 获取agent对应的采集配置
 ...
 * @method Models\DescribeConsolesResponse DescribeConsoles(Models\DescribeConsolesRequest $req) 查询DataSight控制台实例列表
 ...
 * @method Models\DescribeLogContextResponse DescribeLogContext(Models\DescribeLogContextRequest $req) 本接口用于搜索日志上下文附近的内容，部分日志采集方式不支持本接口，详情参考[上下文检索](https://cloud.tencent.com/document/product/614/53248)。
**注意事项**：
 ...
 * @method Models\ModifyAgentApplicationResponse ModifyAgentApplication(Models\ModifyAgentApplicationRequest $req) 本接口用于修改Agent应用
 ...
 * @method Models\ModifyConsoleResponse ModifyConsole(Models\ModifyConsoleRequest $req) 本接口用于编辑DataSight控制台
 ...
 * @method Models\SearchS3RechargeInfoResponse SearchS3RechargeInfo(Models\SearchS3RechargeInfoRequest $req) 本接口用于预览aws导入信息

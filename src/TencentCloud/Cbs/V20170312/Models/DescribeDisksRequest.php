...
/**
 * @method array getDiskIds() 获取按照一个或者多个云硬盘ID查询。云硬盘ID形如：`disk-11112222`，此参数的具体格式可参考API[简介](/document/362/15633)的ids.N一节）。参数不支持同时指定`DiskIds`和`Filters`。
 * @method void setDiskIds(array $DiskIds) 设置按照一个或者多个云硬盘ID查询。云硬盘ID形如：`disk-11112222`，此参数的具体格式可参考API[简介](/document/362/15633)的ids.N一节）。参数不支持同时指定`DiskIds`和`Filters`。
 ...
 * @method string getOrderField() 获取云盘列表排序的依据字段。取值范围：<br><li>CREATETIME：依据云盘的创建时间排序<br><li>DEADLINE：依据云盘的到期时间排序<br>默认按云盘创建时间排序。
 * @method void setOrderField(string $OrderField) 设置云盘列表排序的依据字段。取值范围：<br><li>CREATETIME：依据云盘的创建时间排序<br><li>DEADLINE：依据云盘的到期时间排序<br>默认按云盘创建时间排序。
...
{
    /**
     * @var array 按照一个或者多个云硬盘ID查询。云硬盘ID形如：`disk-11112222`，此参数的具体格式可参考API[简介](/document/362/15633)的ids.N一节）。参数不支持同时指定`DiskIds`和`Filters`。
     */
    public $DiskIds;
    ...
    /**
     * @var string 云盘列表排序的依据字段。取值范围：<br><li>CREATETIME：依据云盘的创建时间排序<br><li>DEADLINE：依据云盘的到期时间排序<br>默认按云盘创建时间排序。
     */
    public $OrderField;
    ...
    /**
     * @param array $DiskIds 按照一个或者多个云硬盘ID查询。云硬盘ID形如：`disk-11112222`，此参数的具体格式可参考API[简介](/document/362/15633)的ids.N一节）。参数不支持同时指定`DiskIds`和`Filters`。
     ...
     * @param string $OrderField 云盘列表排序的依据字段。取值范围：<br><li>CREATETIME：依据云盘的创建时间排序<br><li>DEADLINE：依据云盘的到期时间排序<br>默认按云盘创建时间排序。

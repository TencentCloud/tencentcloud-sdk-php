 ...
 */
class DescribeDeviceVirtualGroupsRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var Condition 滤条件、分页参数 <li>Name - String - 是否必填：否 - 操作符: like  - 排序支持：否- 按终端自定义分组过滤。</li> <li>DeviceVirtualGroupName - String - 是否必填：否 - 操作符: like  - 排序支持：否- 按终端自定义分组过滤。</li>
     */
    public $Condition;
    ...
    /**
     * @var array 非必填，自定义分组ids
     */
    public $VirtualGroupIds;
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("VirtualGroupIds",$param) and $param["VirtualGroupIds"] !== null) {
            $this->VirtualGroupIds = $param["VirtualGroupIds"];
        }
    }
}

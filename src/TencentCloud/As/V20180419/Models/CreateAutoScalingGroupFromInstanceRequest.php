 ...
 * @method integer getDesiredCapacity() 获取期望实例数，大小介于最小实例数和最大实例数之间。不传入时默认值等于最小值。
 * @method void setDesiredCapacity(integer $DesiredCapacity) 设置期望实例数，大小介于最小实例数和最大实例数之间。不传入时默认值等于最小值。
...
class CreateAutoScalingGroupFromInstanceRequest extends AbstractModel
{
    ...
    /**
     * @var integer 期望实例数，大小介于最小实例数和最大实例数之间。不传入时默认值等于最小值。
     */
     ...
     * @param integer $DesiredCapacity 期望实例数，大小介于最小实例数和最大实例数之间。不传入时默认值等于最小值。

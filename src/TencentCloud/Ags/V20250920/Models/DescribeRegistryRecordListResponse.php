 ...
 *
 * @method array getRecordSet() 获取<p>Record 对象数组。</p>
 * @method void setRecordSet(array $RecordSet) 设置<p>Record 对象数组。</p>
 ...
 */
class DescribeRegistryRecordListResponse extends AbstractModel
{
    /**
     * @var array <p>Record 对象数组。</p>
     */
    public $RecordSet;
    ...
    /**
     * @param array $RecordSet <p>Record 对象数组。</p>

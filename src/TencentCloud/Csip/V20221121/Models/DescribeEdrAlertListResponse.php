 ...
 * @method array getAlertCategoryCounts() 获取<p>告警大类统计（随筛选变化，排除 AlertCategory filter）</p>
 * @method void setAlertCategoryCounts(array $AlertCategoryCounts) 设置<p>告警大类统计（随筛选变化，排除 AlertCategory filter）</p>
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeEdrAlertListResponse extends AbstractModel
{
    /**
     * @var integer <p>总数</p>
     */
    ...
    /**
     * @var array <p>告警大类统计（随筛选变化，排除 AlertCategory filter）</p>
     */
    public $AlertCategoryCounts;
     ...
     * @param array $AlertCategoryCounts <p>告警大类统计（随筛选变化，排除 AlertCategory filter）</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("AlertCategoryCounts",$param) and $param["AlertCategoryCounts"] !== null) {
            $this->AlertCategoryCounts = [];
            foreach ($param["AlertCategoryCounts"] as $key => $value){
                $obj = new EdrAlertCategoryCount();
                $obj->deserialize($value);
                array_push($this->AlertCategoryCounts, $obj);
            }
        }

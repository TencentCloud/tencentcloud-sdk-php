 ...
 * @method integer getRoleArn() 获取<p>数据访问策略，CAM Role arn，控制台通过数据作业—&gt;作业配置获取，SDK通过DescribeUserRoles接口获取对应的值；</p>
 * @method void setRoleArn(integer $RoleArn) 设置<p>数据访问策略，CAM Role arn，控制台通过数据作业—&gt;作业配置获取，SDK通过DescribeUserRoles接口获取对应的值；</p>
 ...
 * @method string getCmdArgs() 获取<p>spark作业程序入参，空格分割</p>
 * @method void setCmdArgs(string $CmdArgs) 设置<p>spark作业程序入参，空格分割</p>
 ...
 * @method string getDataSource() 获取<p>数据源名称</p>
 * @method void setDataSource(string $DataSource) 设置<p>数据源名称</p>
 ...
 * @method string getSessionId() 获取<p>关联dlc查询脚本id</p>
 * @method void setSessionId(string $SessionId) 设置<p>关联dlc查询脚本id</p>
 ...
 * @method array getDependencyPackages() 获取<p>依赖包信息</p>
 * @method void setDependencyPackages(array $DependencyPackages) 设置<p>依赖包信息</p>
 */
class CreateSparkAppForTDLCRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var integer <p>数据访问策略，CAM Role arn，控制台通过数据作业—&gt;作业配置获取，SDK通过DescribeUserRoles接口获取对应的值；</p>
     */
    public $RoleArn;
    ...
    /**
     * @var string <p>spark作业程序入参，空格分割</p>
     */
    public $CmdArgs;
     ...
     * @param integer $RoleArn <p>数据访问策略，CAM Role arn，控制台通过数据作业—&gt;作业配置获取，SDK通过DescribeUserRoles接口获取对应的值；</p>
     ...
     * @param string $CmdArgs <p>spark作业程序入参，空格分割</p>
     * @param integer $MaxRetries <p>最大重试次数，只对spark流任务生效</p>
     * @param string $DataSource <p>数据源名称</p>
     ...
     * @param string $SessionId <p>关联dlc查询脚本id</p>
     ...
     * @param array $DependencyPackages <p>依赖包信息</p>
     */

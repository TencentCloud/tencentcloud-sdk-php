 ...
 * @method string getVoiceId() 获取<p>克隆生成的音色ID</p>
 * @method void setVoiceId(string $VoiceId) 设置<p>克隆生成的音色ID</p>
 * @method string getAudioData() 获取<p>合成音频的base64编码</p>
...
class CloneVoiceResponse extends AbstractModel
{
    ...
    /**
     * @var string <p>克隆生成的音色ID</p>
     */
    public $VoiceId;

    /**
     * @var string <p>合成音频的base64编码</p>
     */
    public $AudioData;

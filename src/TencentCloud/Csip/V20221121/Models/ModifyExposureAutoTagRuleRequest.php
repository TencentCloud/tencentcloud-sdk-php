 ...
 * @method boolean getApplyNow() 获取<p>是否立即执行打标</p>
 * @method void setApplyNow(boolean $ApplyNow) 设置<p>是否立即执行打标</p>
 */
class ModifyExposureAutoTagRuleRequest extends AbstractModel
{
     ...
     * @param boolean $ApplyNow <p>是否立即执行打标</p>
     */

 ...
 * @method array getQaIdList() 获取<p>待删除的 QA ID 列表（数量：1~20）</p>
 * @method void setQaIdList(array $QaIdList) 设置<p>待删除的 QA ID 列表（数量：1~20）</p>
 */
class DeleteQAListRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var array <p>待删除的 QA ID 列表（数量：1~20）</p>
     */
    public $QaIdList;

    /**
     * @param string $KbId <p>所属知识库 ID</p>
     * @param array $QaIdList <p>待删除的 QA ID 列表（数量：1~20）</p>
     */

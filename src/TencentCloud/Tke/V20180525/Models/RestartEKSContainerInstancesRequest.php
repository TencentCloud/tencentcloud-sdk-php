 ...
 *
 * @method array getEksCiIds() 获取EKS instance ids
 * @method void setEksCiIds(array $EksCiIds) 设置EKS instance ids
 */
class RestartEKSContainerInstancesRequest extends AbstractModel
{
    /**
     * @var array EKS instance ids
     */
    public $EksCiIds;

    /**
     * @param array $EksCiIds EKS instance ids
     */

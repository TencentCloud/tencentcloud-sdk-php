...
class DescribePredictiveDialingCampaignsResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("CampaignList",$param) and $param["CampaignList"] !== null) {
            $this->CampaignList = [];
            foreach ($param["CampaignList"] as $key => $value){
                $obj = new DescribePredictiveDialingCampaignsElement();
                $obj->deserialize($value);
                array_push($this->CampaignList, $obj);
            }
        }

 ...
 * @method integer getParentCategoryId() 获取<p>父分类ID</p>
 * @method void setParentCategoryId(integer $ParentCategoryId) 设置<p>父分类ID</p>
...
class CreateDspmIdentifyComplianceCategoryRelationRequest extends AbstractModel
{
     ...
     * @param integer $ParentCategoryId <p>父分类ID</p>

 ...
 * @method integer getUseApi() 获取是否生成子用户密钥
 * @method void setUseApi(integer $UseApi) 设置是否生成子用户密钥
 * @method string getPassword() 获取子用户控制台登录密码，只有可以登录控制台时才有效，如果传空并且上面指定允许登录控制台，则自动生成随机密码
 * @method void setPassword(string $Password) 设置子用户控制台登录密码，只有可以登录控制台时才有效，如果传空并且上面指定允许登录控制台，则自动生成随机密码
...
class AddUserRequest extends AbstractModel
{
    ...
    /**
     * @var integer 是否生成子用户密钥
     */
    public $UseApi;

    /**
     * @var string 子用户控制台登录密码，只有可以登录控制台时才有效，如果传空并且上面指定允许登录控制台，则自动生成随机密码
     */
    public $Password;
     ...
     * @param integer $UseApi 是否生成子用户密钥
     * @param string $Password 子用户控制台登录密码，只有可以登录控制台时才有效，如果传空并且上面指定允许登录控制台，则自动生成随机密码

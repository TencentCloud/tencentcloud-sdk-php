 ...
 * @method string getFlowGroupName() 获取合同（流程）组名称,最大长度200个字符
 * @method void setFlowGroupName(string $FlowGroupName) 设置合同（流程）组名称,最大长度200个字符
 ...
 * @method FlowGroupOptions getFlowGroupOptions() 获取合同（流程）组的配置项信息。包括是否通知本企业签署方，是否通知其他签署方
 * @method void setFlowGroupOptions(FlowGroupOptions $FlowGroupOptions) 设置合同（流程）组的配置项信息。包括是否通知本企业签署方，是否通知其他签署方
 */
class CreateFlowGroupByFilesRequest extends AbstractModel
{
    ...
    /**
     * @var string 合同（流程）组名称,最大长度200个字符
     */
    ...
    /**
     * @var FlowGroupOptions 合同（流程）组的配置项信息。包括是否通知本企业签署方，是否通知其他签署方
     */
    public $FlowGroupOptions;

    /**
     * @param UserInfo $Operator 调用方用户信息，userId 必填。支持填入集团子公司经办人 userId 代发合同
     * @param string $FlowGroupName 合同（流程）组名称,最大长度200个字符
     * @param array $FlowGroupInfos 合同（流程）组的子合同信息，支持2-50个子合同
     * @param Agent $Agent 代理相关应用信息，如集团主企业代子企业操作的场景中ProxyOrganizationId必填
     * @param FlowGroupOptions $FlowGroupOptions 合同（流程）组的配置项信息。包括是否通知本企业签署方，是否通知其他签署方
     */

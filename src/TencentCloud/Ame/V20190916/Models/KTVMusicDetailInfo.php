 ...
 * 即使广播曲库歌曲信息详情列表
 *
 * @method KTVMusicBaseInfo getKTVMusicBaseInfo() 获取即使广播曲库歌曲基础信息
 * @method void setKTVMusicBaseInfo(KTVMusicBaseInfo $KTVMusicBaseInfo) 设置即使广播曲库歌曲基础信息
...
{
    /**
     * @var KTVMusicBaseInfo 即使广播曲库歌曲基础信息
     */
    ...
    /**
     * @param KTVMusicBaseInfo $KTVMusicBaseInfo 即使广播曲库歌曲基础信息

 ...
 * @method string getNotifyUrl() 获取签约成功回调地址。
 * @method void setNotifyUrl(string $NotifyUrl) 设置签约成功回调地址。
 */
class ApplyOpenBankSubMerchantSignOnlineRequest extends AbstractModel
{
    /**
     ...
     * @param string $NotifyUrl 签约成功回调地址。
     */

 ...
 * @method string getMpApplicationId() 获取<p>应用ID, 查询分组流量时无需使用。 查询应用流量时该字段为应用ID，GroupId 填写 &quot;-1&quot;</p>
 * @method void setMpApplicationId(string $MpApplicationId) 设置<p>应用ID, 查询分组流量时无需使用。 查询应用流量时该字段为应用ID，GroupId 填写 &quot;-1&quot;</p>
 */
class GetFlowStatisticByGroupRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>应用ID, 查询分组流量时无需使用。 查询应用流量时该字段为应用ID，GroupId 填写 &quot;-1&quot;</p>
     */
     ...
     * @param string $MpApplicationId <p>应用ID, 查询分组流量时无需使用。 查询应用流量时该字段为应用ID，GroupId 填写 &quot;-1&quot;</p>
     */

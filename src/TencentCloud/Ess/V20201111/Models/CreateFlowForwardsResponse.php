...
class CreateFlowForwardsResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("FailedFlows",$param) and $param["FailedFlows"] !== null) {
            $this->FailedFlows = [];
            foreach ($param["FailedFlows"] as $key => $value){
                $obj = new FlowForwardResult();
                $obj->deserialize($value);
                array_push($this->FailedFlows, $obj);
            }
        }

        if (array_key_exists("SuccessFlows",$param) and $param["SuccessFlows"] !== null) {
            $this->SuccessFlows = $param["SuccessFlows"];
        }

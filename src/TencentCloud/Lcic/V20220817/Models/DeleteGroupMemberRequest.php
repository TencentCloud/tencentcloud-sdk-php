 ...
 *
 * @method string getGroupId() 获取群组ID，联合群组无法删除群组成员
 * @method void setGroupId(string $GroupId) 设置群组ID，联合群组无法删除群组成员
...
class DeleteGroupMemberRequest extends AbstractModel
{
    ...
    /**
     * @param string $GroupId 群组ID，联合群组无法删除群组成员

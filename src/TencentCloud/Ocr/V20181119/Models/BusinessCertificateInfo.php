 ...
 *
 * @method string getName() 获取识别出的名称
 * @method void setName(string $Name) 设置识别出的名称
 * @method string getValue() 获取识别出的字段名称对应的值
 * @method void setValue(string $Value) 设置识别出的字段名称对应的值
 * @method Rect getRect() 获取坐标
 * @method void setRect(Rect $Rect) 设置坐标
 */
class BusinessCertificateInfo extends AbstractModel
{
    /**
     * @var string 识别出的名称
     */

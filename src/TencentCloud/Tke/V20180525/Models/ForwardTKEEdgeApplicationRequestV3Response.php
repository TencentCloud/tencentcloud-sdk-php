 ...
 *
 * @method string getResponseBody() 获取请求集群addon后返回的数据
 * @method void setResponseBody(string $ResponseBody) 设置请求集群addon后返回的数据
...
class ForwardTKEEdgeApplicationRequestV3Response extends AbstractModel
{
    ...
    /**
     * @param string $ResponseBody 请求集群addon后返回的数据

 ...
 *
 * @method array getMetricSampleMatrixSet() 获取批量指标矩阵
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setMetricSampleMatrixSet(array $MetricSampleMatrixSet) 设置批量指标矩阵
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $MetricSampleMatrixSet 批量指标矩阵
注意：此字段可能返回 null，表示取不到有效值。

 ...
 * @method float getScore() 获取<p>整体质量得分，范围 [0, 100]，越高表示越好。</p>
 * @method void setScore(float $Score) 设置<p>整体质量得分，范围 [0, 100]，越高表示越好。</p>
...
class QualityInspectLLMDetectionResultItem extends AbstractModel
{
    ...
    /**
     * @var float <p>整体质量得分，范围 [0, 100]，越高表示越好。</p>
     */
    public $Score;
     ...
     * @param float $Score <p>整体质量得分，范围 [0, 100]，越高表示越好。</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("IssueSet",$param) and $param["IssueSet"] !== null) {
            ...
            foreach ($param["IssueSet"] as $key => $value){
                $obj = new QualityInspectLLMDetectionIssue();

 ...
 * @method string getConnectorResourceId() 获取connector ID
 * @method void setConnectorResourceId(string $ConnectorResourceId) 设置connector ID
 ...
 */
class ModifyConnectorRequest extends AbstractModel
{
    /**
     * @var string 空间
     */
     ...
     * @param string $ConnectorResourceId connector ID
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ConnectorResourceId",$param) and $param["ConnectorResourceId"] !== null) {
            $this->ConnectorResourceId = $param["ConnectorResourceId"];
        }

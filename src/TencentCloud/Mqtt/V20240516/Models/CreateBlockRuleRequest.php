 ...
 * @method string getName() 获取封禁规则名，不可重复，只支持数字字母中划线
 * @method void setName(string $Name) 设置封禁规则名，不可重复，只支持数字字母中划线
 * @method integer getType() 获取封禁规则类型
    CLIENT_ID(1), 默认值
    USERNAME(2),
    IP_ADDRESS(3);
 * @method void setType(integer $Type) 设置封禁规则类型
    CLIENT_ID(1), 默认值
    USERNAME(2),
    IP_ADDRESS(3);
 ...
 */
class CreateBlockRuleRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string 封禁规则名，不可重复，只支持数字字母中划线
     */
    public $Name;
     ...
     * @param string $Name 封禁规则名，不可重复，只支持数字字母中划线
     * @param integer $Type 封禁规则类型
    CLIENT_ID(1), 默认值
    USERNAME(2),
    IP_ADDRESS(3);

 ...
 * @method string getBanCall() 获取是否禁止拨打
 * @method void setBanCall(string $BanCall) 设置是否禁止拨打
 * @method string getStartTimeBan() 获取禁止拨打起始时间
 * @method void setStartTimeBan(string $StartTimeBan) 设置禁止拨打起始时间
 * @method string getEndTimeBan() 获取禁止拨打结束时间
 * @method void setEndTimeBan(string $EndTimeBan) 设置禁止拨打结束时间
...
class CreateBotTaskRequest extends AbstractModel
{
     ...
     * @param string $BanCall 是否禁止拨打
     * @param string $StartTimeBan 禁止拨打起始时间
     * @param string $EndTimeBan 禁止拨打结束时间

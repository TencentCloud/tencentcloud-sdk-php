 ...
 * @method integer getBandwidth() 获取<p>带宽，单位：Mbps</p>
 * @method void setBandwidth(integer $Bandwidth) 设置<p>带宽，单位：Mbps</p>
...
class ModifyInsPublicEndpointRequest extends AbstractModel
{
     ...
     * @param integer $Bandwidth <p>带宽，单位：Mbps</p>

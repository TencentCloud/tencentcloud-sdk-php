...
注意：此字段可能返回 null，表示取不到有效值。
 * @method CorpUserListData getData() 获取<p>数据</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setData(CorpUserListData $Data) 设置<p>数据</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getExtra() 获取<p>扩展</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setExtra(string $Extra) 设置<p>扩展</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param CorpUserListData $Data <p>数据</p>
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $Extra <p>扩展</p>
注意：此字段可能返回 null，表示取不到有效值。

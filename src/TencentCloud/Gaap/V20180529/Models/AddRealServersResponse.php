 ...
 *
 * @method array getRealServerSet() 获取<p>源站信息列表</p>
 * @method void setRealServerSet(array $RealServerSet) 设置<p>源站信息列表</p>
...
class AddRealServersResponse extends AbstractModel
{
    ...
    /**
     * @param array $RealServerSet <p>源站信息列表</p>

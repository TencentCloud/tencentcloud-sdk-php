 ...
 *
 * @method array getRoutePolicyAssociationSet() 获取路由接收策略绑定对象列表。
 * @method void setRoutePolicyAssociationSet(array $RoutePolicyAssociationSet) 设置路由接收策略绑定对象列表。
 */
class CreateRoutePolicyAssociationsRequest extends AbstractModel
{
    /**
     * @var array 路由接收策略绑定对象列表。
     */
    public $RoutePolicyAssociationSet;

    /**
     * @param array $RoutePolicyAssociationSet 路由接收策略绑定对象列表。
     */

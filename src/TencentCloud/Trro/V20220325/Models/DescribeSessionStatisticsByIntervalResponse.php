...
class DescribeSessionStatisticsByIntervalResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("SessionStatistics",$param) and $param["SessionStatistics"] !== null) {
            $this->SessionStatistics = [];
            foreach ($param["SessionStatistics"] as $key => $value){
                $obj = new SessionIntervalStatistic();
                $obj->deserialize($value);
                array_push($this->SessionStatistics, $obj);
            }
        }

 ...
 *
 * @method integer getTotalCount() 获取告警历史总数
 * @method void setTotalCount(integer $TotalCount) 设置告警历史总数
 * @method array getRecords() 获取告警历史详情
 * @method void setRecords(array $Records) 设置告警历史详情

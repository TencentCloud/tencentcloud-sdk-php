 ...
 * @method string getBy() 获取可选排序列: [HostScope|UpdateTime]
 * @method void setBy(string $By) 设置可选排序列: [HostScope|UpdateTime]
 */
...
<li>IsEnabled - int - 是否必填：否 - 是否生效</li>
    ...
    /**
     * @var string 可选排序列: [HostScope|UpdateTime]
     */
    public $By;
...
<li>IsEnabled - int - 是否必填：否 - 是否生效</li>
     ...
     * @param string $By 可选排序列: [HostScope|UpdateTime]
     */

 ...
 *
 * @method WafThreatenIntelligenceDetails getWafThreatenIntelligenceDetails() 获取当前WAF威胁情报封禁模块详情
 * @method void setWafThreatenIntelligenceDetails(WafThreatenIntelligenceDetails $WafThreatenIntelligenceDetails) 设置当前WAF威胁情报封禁模块详情
...
{
    /**
     * @var WafThreatenIntelligenceDetails 当前WAF威胁情报封禁模块详情
     */
    ...
    /**
     * @param WafThreatenIntelligenceDetails $WafThreatenIntelligenceDetails 当前WAF威胁情报封禁模块详情

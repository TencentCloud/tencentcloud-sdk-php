 ...
 * @method string getCurrentProgress() 获取当前进度
 * @method void setCurrentProgress(string $CurrentProgress) 设置当前进度
...
class DescribeIntegrateTaskResponse extends AbstractModel
{
     ...
     * @param string $CurrentProgress 当前进度
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("CurrentProgress",$param) and $param["CurrentProgress"] !== null) {
            $this->CurrentProgress = $param["CurrentProgress"];
        }

 ...
 * @method string getKeyword() 获取文件夹名称/脚本名称搜索
 * @method void setKeyword(string $Keyword) 设置文件夹名称/脚本名称搜索
 * @method boolean getOnlyFolderNode() 获取只查询文件夹
 * @method void setOnlyFolderNode(boolean $OnlyFolderNode) 设置只查询文件夹
 * @method boolean getOnlyUserSelfScript() 获取是否只查询用户自己创建的脚本
 * @method void setOnlyUserSelfScript(boolean $OnlyUserSelfScript) 设置是否只查询用户自己创建的脚本
...
class ListSQLFolderContentsRequest extends AbstractModel
{
     ...
     * @param string $Keyword 文件夹名称/脚本名称搜索
     * @param boolean $OnlyFolderNode 只查询文件夹
     * @param boolean $OnlyUserSelfScript 是否只查询用户自己创建的脚本

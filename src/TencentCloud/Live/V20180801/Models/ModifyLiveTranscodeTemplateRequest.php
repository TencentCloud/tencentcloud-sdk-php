 ...
 * @method integer getVideoBitrate() 获取视频码率。100-8000
 * @method void setVideoBitrate(integer $VideoBitrate) 设置视频码率。100-8000
...
aac/mp3。
     ...
     * @param integer $VideoBitrate 视频码率。100-8000

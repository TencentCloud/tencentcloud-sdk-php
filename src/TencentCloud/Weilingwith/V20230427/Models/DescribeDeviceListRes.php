 ...
 * @method array getDeviceDataSet() 获取设备信息集合
 * @method void setDeviceDataSet(array $DeviceDataSet) 设置设备信息集合
 */
class DescribeDeviceListRes extends AbstractModel
{
    /**
     * @var integer 第几页
     */
     ...
     * @param array $DeviceDataSet 设备信息集合
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("DeviceDataSet",$param) and $param["DeviceDataSet"] !== null) {
            $this->DeviceDataSet = [];
            foreach ($param["DeviceDataSet"] as $key => $value){
                $obj = new DeviceDataInfo();
                $obj->deserialize($value);
                array_push($this->DeviceDataSet, $obj);
            }
        }
    }
}

...
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getModelId() 获取<p>关联的模型ID</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setModelId(integer $ModelId) 设置<p>关联的模型ID</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getApiKeyBindMessage() 获取<p>API Key 绑定结果（success 表示成功，其他为错误信息）</p>
 * @method void setApiKeyBindMessage(string $ApiKeyBindMessage) 设置<p>API Key 绑定结果（success 表示成功，其他为错误信息）</p>
 ...
 * @method string getAdvancedOptions() 获取<p>AdvancedOptions 高级参数 JSON 字符串（扁平 KV 结构，取自第一个部署）</p>
 * @method void setAdvancedOptions(string $AdvancedOptions) 设置<p>AdvancedOptions 高级参数 JSON 字符串（扁平 KV 结构，取自第一个部署）</p>
 ...
 * @method string getDeploymentMode() 获取<p>部署模式</p>
 * @method void setDeploymentMode(string $DeploymentMode) 设置<p>部署模式</p>
 * @method boolean getIsCustom() 获取<p>是否是自定义 RayServe 创建</p>
 * @method void setIsCustom(boolean $IsCustom) 设置<p>是否是自定义 RayServe 创建</p>
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class CreateInferenceServiceResponse extends AbstractModel
{
    /**
     * @var string <p>服务ID</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var string <p>API Key 绑定结果（success 表示成功，其他为错误信息）</p>
     */
    public $ApiKeyBindMessage;
    ...
    /**
     * @var string <p>AdvancedOptions 高级参数 JSON 字符串（扁平 KV 结构，取自第一个部署）</p>
     */
    ...
    /**
     * @var boolean <p>是否是自定义 RayServe 创建</p>
     */
    public $IsCustom;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $ModelId <p>关联的模型ID</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $ApiKeyBindMessage <p>API Key 绑定结果（success 表示成功，其他为错误信息）</p>
     ...
     * @param string $AdvancedOptions <p>AdvancedOptions 高级参数 JSON 字符串（扁平 KV 结构，取自第一个部署）</p>
     * @param array $ResourceTags <p>系统标签列表（TagKey-TagValue）</p>
     * @param string $DeploymentMode <p>部署模式</p>
     * @param boolean $IsCustom <p>是否是自定义 RayServe 创建</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ApiKeyBindMessage",$param) and $param["ApiKeyBindMessage"] !== null) {
            $this->ApiKeyBindMessage = $param["ApiKeyBindMessage"];
        }

...
注意：此字段可能返回 null，表示取不到有效值。
 * @method boolean getStealFlag() 获取偷锁标志（有人偷锁为true）
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setStealFlag(boolean $StealFlag) 设置偷锁标志（有人偷锁为true）
注意：此字段可能返回 null，表示取不到有效值。
 * @method boolean getLockedByMe() 获取持有锁标志（true表示被自己锁定）
 * @method void setLockedByMe(boolean $LockedByMe) 设置持有锁标志（true表示被自己锁定）
 * @method boolean getLocked() 获取资源是否被锁定
 * @method void setLocked(boolean $Locked) 设置资源是否被锁定
 ...
 */
class HeartBeatResponse extends AbstractModel
{
    /**
     * @var string 资源唯一路径
     */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param boolean $StealFlag 偷锁标志（有人偷锁为true）
注意：此字段可能返回 null，表示取不到有效值。
     * @param boolean $LockedByMe 持有锁标志（true表示被自己锁定）
     * @param boolean $Locked 资源是否被锁定
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("StealFlag",$param) and $param["StealFlag"] !== null) {
            $this->StealFlag = $param["StealFlag"];
        }

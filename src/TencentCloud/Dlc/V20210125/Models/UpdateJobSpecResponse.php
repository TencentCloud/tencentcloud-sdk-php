 ...
 * @method string getSubmissionTarget() 获取<p>作业提交目标</p><p>枚举值：</p><ul><li>GROUP： 按计算组分派</li></ul>
 * @method void setSubmissionTarget(string $SubmissionTarget) 设置<p>作业提交目标</p><p>枚举值：</p><ul><li>GROUP： 按计算组分派</li></ul>
 * @method string getGroupName() 获取<p>计算组名称</p>
 * @method void setGroupName(string $GroupName) 设置<p>计算组名称</p>
 ...
 */
class UpdateJobSpecResponse extends AbstractModel
{
    /**
     * @var string <p>配置ID</p>
     */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var string <p>作业提交目标</p><p>枚举值：</p><ul><li>GROUP： 按计算组分派</li></ul>
     */
    public $SubmissionTarget;

    /**
     * @var string <p>计算组名称</p>
     */
    public $GroupName;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param string $SubmissionTarget <p>作业提交目标</p><p>枚举值：</p><ul><li>GROUP： 按计算组分派</li></ul>
     * @param string $GroupName <p>计算组名称</p>

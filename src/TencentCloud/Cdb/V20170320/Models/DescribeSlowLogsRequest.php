 ...
 * @method integer getLimit() 获取返回记录数量，默认值为20，最大值为100。
 * @method void setLimit(integer $Limit) 设置返回记录数量，默认值为20，最大值为100。
 */

 ...
 * @method CloudNativeAPIGatewayStrategyCronScalerConfig getCronScalerConfig() 获取定时伸缩配置
 * @method void setCronScalerConfig(CloudNativeAPIGatewayStrategyCronScalerConfig $CronScalerConfig) 设置定时伸缩配置
 * @method integer getMaxReplicas() 获取最大节点数
 * @method void setMaxReplicas(integer $MaxReplicas) 设置最大节点数
 * @method CloudNativeAPIGatewayStrategyCronScalerConfig getCronConfig() 获取指标伸缩配置
 * @method void setCronConfig(CloudNativeAPIGatewayStrategyCronScalerConfig $CronConfig) 设置指标伸缩配置
 */
class ModifyAutoScalerResourceStrategyRequest extends AbstractModel
{
    ...
    /**
     * @var CloudNativeAPIGatewayStrategyCronScalerConfig 指标伸缩配置
     */
    public $CronConfig;
     ...
     * @param CloudNativeAPIGatewayStrategyCronScalerConfig $CronScalerConfig 定时伸缩配置
     * @param integer $MaxReplicas 最大节点数
     * @param CloudNativeAPIGatewayStrategyCronScalerConfig $CronConfig 指标伸缩配置
     */

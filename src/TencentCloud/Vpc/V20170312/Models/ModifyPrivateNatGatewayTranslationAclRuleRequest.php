 ...
 * @method array getTranslationAclRules() 获取访问控制列表，需要附带AclRuleId参数。
 * @method void setTranslationAclRules(array $TranslationAclRules) 设置访问控制列表，需要附带AclRuleId参数。
 * @method string getOriginalIp() 获取源`IP`,当转换规则类型为三层时有效
 * @method void setOriginalIp(string $OriginalIp) 设置源`IP`,当转换规则类型为三层时有效
 */
class ModifyPrivateNatGatewayTranslationAclRuleRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var array 访问控制列表，需要附带AclRuleId参数。
     */
     ...
     * @param array $TranslationAclRules 访问控制列表，需要附带AclRuleId参数。

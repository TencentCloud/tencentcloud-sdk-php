 ...
 * @method array getTemplateSet() 获取防火墙模板列表。
 * @method void setTemplateSet(array $TemplateSet) 设置防火墙模板列表。
 * @method string getRequestId() 获取唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeFirewallTemplatesResponse extends AbstractModel
{
    /**
     * @var integer 模板总数量。
     */
     ...
     * @param array $TemplateSet 防火墙模板列表。

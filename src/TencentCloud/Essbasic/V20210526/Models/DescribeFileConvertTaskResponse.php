 ...
 * @method string getResourceId() 获取<p>资源Id（即FileId），用于<a href="https://qian.tencent.com/developers/partnerApis/startFlows/ChannelCreateFlowByFiles">用PDF文件创建签署流程</a></p>
 * @method void setResourceId(string $ResourceId) 设置<p>资源Id（即FileId），用于<a href="https://qian.tencent.com/developers/partnerApis/startFlows/ChannelCreateFlowByFiles">用PDF文件创建签署流程</a></p>
...
class DescribeFileConvertTaskResponse extends AbstractModel
{
    ...
    /**
     * @var string <p>资源Id（即FileId），用于<a href="https://qian.tencent.com/developers/partnerApis/startFlows/ChannelCreateFlowByFiles">用PDF文件创建签署流程</a></p>
     */
    public $ResourceId;
     ...
     * @param string $ResourceId <p>资源Id（即FileId），用于<a href="https://qian.tencent.com/developers/partnerApis/startFlows/ChannelCreateFlowByFiles">用PDF文件创建签署流程</a></p>

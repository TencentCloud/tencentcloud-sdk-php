 ...
 * ReleaseLock返回参数结构体
 *
 * @method boolean getSuccess() 获取释放锁请求结果
 * @method void setSuccess(boolean $Success) 设置释放锁请求结果
 ...
 */
class ReleaseLockResponse extends AbstractModel
{
    /**
     * @var boolean 释放锁请求结果
     */

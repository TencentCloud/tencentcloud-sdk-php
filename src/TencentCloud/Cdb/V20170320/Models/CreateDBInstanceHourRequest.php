 ...
 *
 * @method integer getGoodsNum() 获取<p>实例数量，默认值为 1，最小值 1，最大值为 100。</p>
 * @method void setGoodsNum(integer $GoodsNum) 设置<p>实例数量，默认值为 1，最小值 1，最大值为 100。</p>
 ...
 * @method integer getProjectId() 获取<p>项目 ID，不填为默认项目。</p>
 * @method void setProjectId(integer $ProjectId) 设置<p>项目 ID，不填为默认项目。</p>
 ...
 * @method string getMasterInstanceId() 获取<p>实例 ID，购买只读实例或者灾备实例时必填，该字段表示只读实例或者灾备实例的主实例 ID，请使用 <a href="https://cloud.tencent.com/document/api/236/15872">查询实例列表</a> 接口查询云数据库实例 ID。</p>
 * @method void setMasterInstanceId(string $MasterInstanceId) 设置<p>实例 ID，购买只读实例或者灾备实例时必填，该字段表示只读实例或者灾备实例的主实例 ID，请使用 <a href="https://cloud.tencent.com/document/api/236/15872">查询实例列表</a> 接口查询云数据库实例 ID。</p>
 ...
 * @method integer getPort() 获取<p>自定义端口，端口支持范围：[1024 - 65535]。<br>说明：不填则默认为3306。</p>
 ...
 * @method void setDeployMode(integer $DeployMode) 设置<p>多可用区域，默认为 0，支持值包括：0 - 表示单可用区，1 - 表示多可用区，购买主实例时可指定该参数，购买只读实例或者灾备实例时指定该参数无意义。</p>
 ...
 * @method RoGroup getRoGroup() 获取<p>只读实例信息。购买只读实例时，该参数必传。</p>
 * @method void setRoGroup(RoGroup $RoGroup) 设置<p>只读实例信息。购买只读实例时，该参数必传。</p>
 * @method integer getAutoRenewFlag() 获取<p>购买按量计费实例该字段无意义。</p>
 * @method void setAutoRenewFlag(integer $AutoRenewFlag) 设置<p>购买按量计费实例该字段无意义。</p>
 * @method string getInstanceName() 获取<p>实例名称。一次购买多个实例命名会用后缀数字区分，例instanceName=db，goodsNum=3，实例命名分别为db1，db2，db3。</p>
 * @method void setInstanceName(string $InstanceName) 设置<p>实例名称。一次购买多个实例命名会用后缀数字区分，例instanceName=db，goodsNum=3，实例命名分别为db1，db2，db3。</p>
 ...
 * @method integer getInstanceNodes() 获取<p>实例节点数。</p><p>对于 RO 和 基础版实例，该值默认为1。如果需要购买三节点实例，请将该值设置为3，或指定 BackupZone 参数；当购买主实例，且未指定该参数和 BackupZone 参数时，该值默认是2，即购买双节点实例；如果需要购买四节点实例，请将该值设置为4，或指定 FourthZone 参数。</p>
 * @method void setInstanceNodes(integer $InstanceNodes) 设置<p>实例节点数。</p><p>对于 RO 和 基础版实例，该值默认为1。如果需要购买三节点实例，请将该值设置为3，或指定 BackupZone 参数；当购买主实例，且未指定该参数和 BackupZone 参数时，该值默认是2，即购买双节点实例；如果需要购买四节点实例，请将该值设置为4，或指定 FourthZone 参数。</p>
 ...
 * @method string getParamTemplateType() 获取<p>默认参数模板类型。支持值包括：&quot;HIGH_STABILITY&quot; - 高稳定模板，&quot;HIGH_PERFORMANCE&quot; - 高性能模板，默认值是：&quot;HIGH_STABILITY&quot;。<br>备注：如您需使用云数据库 MySQL 默认参数模板，请设置 ParamTemplateType。</p>
 * @method void setParamTemplateType(string $ParamTemplateType) 设置<p>默认参数模板类型。支持值包括：&quot;HIGH_STABILITY&quot; - 高稳定模板，&quot;HIGH_PERFORMANCE&quot; - 高性能模板，默认值是：&quot;HIGH_STABILITY&quot;。<br>备注：如您需使用云数据库 MySQL 默认参数模板，请设置 ParamTemplateType。</p>
 ...
 * @method string getDiskType() 获取<p>硬盘类型，单节点（云盘）或者云盘版实例可以指定此参数。CLOUD_SSD 表示 SSD 云硬盘，CLOUD_HSSD 表示增强型 SSD 云硬盘，CLOUD_PREMIUM 表示高性能云硬盘。<br>说明：单节点（云盘）、云盘版实例硬盘类型所支持的地域略有不同，具体支持情况请参考 <a href="https://cloud.tencent.com/document/product/236/8458">地域和可用区</a>。</p>
...
{
    /**
     * @var integer <p>实例数量，默认值为 1，最小值 1，最大值为 100。</p>
     */
    public $GoodsNum;
    ...
    /**
     * @var string <p>实例 ID，购买只读实例或者灾备实例时必填，该字段表示只读实例或者灾备实例的主实例 ID，请使用 <a href="https://cloud.tencent.com/document/api/236/15872">查询实例列表</a> 接口查询云数据库实例 ID。</p>
     */
    ...
    /**
     * @var integer <p>自定义端口，端口支持范围：[1024 - 65535]。<br>说明：不填则默认为3306。</p>
     */
    public $Port;
    ...
    /**
     * @var integer <p>数据复制方式，默认为 0，支持值包括：0 - 表示异步复制，1 - 表示半同步复制，2 - 表示强同步复制，购买主实例时可指定该参数，购买只读实例或者灾备实例时指定该参数无意义。</p>
     */
    public $ProtectMode;

    /**
     * @var integer <p>多可用区域，默认为 0，支持值包括：0 - 表示单可用区，1 - 表示多可用区，购买主实例时可指定该参数，购买只读实例或者灾备实例时指定该参数无意义。</p>
     */
    public $DeployMode;
    ...
    /**
     * @var RoGroup <p>只读实例信息。购买只读实例时，该参数必传。</p>
     */
    public $RoGroup;

    /**
     * @var integer <p>购买按量计费实例该字段无意义。</p>
     */
    public $AutoRenewFlag;

    /**
     * @var string <p>实例名称。一次购买多个实例命名会用后缀数字区分，例instanceName=db，goodsNum=3，实例命名分别为db1，db2，db3。</p>
     */
    public $InstanceName;
    ...
    /**
     * @var integer <p>实例节点数。</p><p>对于 RO 和 基础版实例，该值默认为1。如果需要购买三节点实例，请将该值设置为3，或指定 BackupZone 参数；当购买主实例，且未指定该参数和 BackupZone 参数时，该值默认是2，即购买双节点实例；如果需要购买四节点实例，请将该值设置为4，或指定 FourthZone 参数。</p>
     */
    ...
    /**
     * @var string <p>默认参数模板类型。支持值包括：&quot;HIGH_STABILITY&quot; - 高稳定模板，&quot;HIGH_PERFORMANCE&quot; - 高性能模板，默认值是：&quot;HIGH_STABILITY&quot;。<br>备注：如您需使用云数据库 MySQL 默认参数模板，请设置 ParamTemplateType。</p>
     */
    ...
    /**
     * @var string <p>硬盘类型，单节点（云盘）或者云盘版实例可以指定此参数。CLOUD_SSD 表示 SSD 云硬盘，CLOUD_HSSD 表示增强型 SSD 云硬盘，CLOUD_PREMIUM 表示高性能云硬盘。<br>说明：单节点（云盘）、云盘版实例硬盘类型所支持的地域略有不同，具体支持情况请参考 <a href="https://cloud.tencent.com/document/product/236/8458">地域和可用区</a>。</p>
     */
    public $DiskType;

    /**
     * @var string <p>集群类型:cage——金融围拢，cdc——CDB ON CDC；dedicate——独享集群</p>
     */
    public $ClusterType;
    ...
    /**
     * @param integer $GoodsNum <p>实例数量，默认值为 1，最小值 1，最大值为 100。</p>
     ...
     * @param integer $ProjectId <p>项目 ID，不填为默认项目。</p>
     ...
     * @param string $MasterInstanceId <p>实例 ID，购买只读实例或者灾备实例时必填，该字段表示只读实例或者灾备实例的主实例 ID，请使用 <a href="https://cloud.tencent.com/document/api/236/15872">查询实例列表</a> 接口查询云数据库实例 ID。</p>
     ...
     * @param RoGroup $RoGroup <p>只读实例信息。购买只读实例时，该参数必传。</p>
     * @param integer $AutoRenewFlag <p>购买按量计费实例该字段无意义。</p>
     * @param string $InstanceName <p>实例名称。一次购买多个实例命名会用后缀数字区分，例instanceName=db，goodsNum=3，实例命名分别为db1，db2，db3。</p>
     ...
     * @param integer $InstanceNodes <p>实例节点数。</p><p>对于 RO 和 基础版实例，该值默认为1。如果需要购买三节点实例，请将该值设置为3，或指定 BackupZone 参数；当购买主实例，且未指定该参数和 BackupZone 参数时，该值默认是2，即购买双节点实例；如果需要购买四节点实例，请将该值设置为4，或指定 FourthZone 参数。</p>

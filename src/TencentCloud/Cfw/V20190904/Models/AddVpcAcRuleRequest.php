 ...
 * AddVpcAcRule请求参数结构体
 *
 * @method array getRules() 获取<p>需要添加的vpc内网间规则列表</p>
 * @method void setRules(array $Rules) 设置<p>需要添加的vpc内网间规则列表</p>
...
class AddVpcAcRuleRequest extends AbstractModel
{
    ...
    /**
     * @param array $Rules <p>需要添加的vpc内网间规则列表</p>

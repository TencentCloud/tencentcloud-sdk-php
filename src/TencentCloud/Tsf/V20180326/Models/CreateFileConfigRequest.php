 ...
 * @method string getConfigFileName() 获取配置项文件名，最多支持60个字符，只能包含英文、数字、"-"（英文）、"_"（英文）、"."（英文）。
 * @method void setConfigFileName(string $ConfigFileName) 设置配置项文件名，最多支持60个字符，只能包含英文、数字、"-"（英文）、"_"（英文）、"."（英文）。
...
class CreateFileConfigRequest extends AbstractModel
{
    ...
    /**
     * @var string 配置项文件名，最多支持60个字符，只能包含英文、数字、"-"（英文）、"_"（英文）、"."（英文）。
     */
...
- false：关闭
     ...
     * @param string $ConfigFileName 配置项文件名，最多支持60个字符，只能包含英文、数字、"-"（英文）、"_"（英文）、"."（英文）。

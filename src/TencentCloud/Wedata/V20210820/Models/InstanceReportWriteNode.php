 ...
 * @method float getWaitReaderTime() 获取等待上游数据发送过来的时间
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setWaitReaderTime(float $WaitReaderTime) 设置等待上游数据发送过来的时间
注意：此字段可能返回 null，表示取不到有效值。
 */
class InstanceReportWriteNode extends AbstractModel
{
    ...
    /**
     * @var float 等待上游数据发送过来的时间
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $WaitReaderTime;
     ...
     * @param float $WaitReaderTime 等待上游数据发送过来的时间
注意：此字段可能返回 null，表示取不到有效值。
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("WaitReaderTime",$param) and $param["WaitReaderTime"] !== null) {
            $this->WaitReaderTime = $param["WaitReaderTime"];
        }
    }
}

 ...
 * @method string getStatus() 获取ENABLE-开启；DISABLE-关闭。
 * @method void setStatus(string $Status) 设置ENABLE-开启；DISABLE-关闭。
 */
class ModifyDomainRecursiveStatusBatchRequest extends AbstractModel
{
    /**
     * @var array 域名列表
     */
    ...
    /**
     * @var string ENABLE-开启；DISABLE-关闭。
     */
    public $Status;

    /**
     * @param array $DomainList 域名列表
     * @param string $Status ENABLE-开启；DISABLE-关闭。
     */

 ...
 * @method AiReviewPornTaskInput getInput() 获取智能识别涉及令人反感的信息的任务输入。
 * @method void setInput(AiReviewPornTaskInput $Input) 设置智能识别涉及令人反感的信息的任务输入。
 * @method AiReviewPornTaskOutput getOutput() 获取智能识别涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewPornTaskOutput $Output) 设置智能识别涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiReviewTaskPornResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPornTaskInput 智能识别涉及令人反感的信息的任务输入。
     */
    public $Input;

    /**
     * @var AiReviewPornTaskOutput 智能识别涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiReviewPornTaskInput $Input 智能识别涉及令人反感的信息的任务输入。
     * @param AiReviewPornTaskOutput $Output 智能识别涉及令人反感的信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 * @method string getConfig() 获取<p>配置是通过 SM2 加密再 Hex 之后的数据</p>
 * @method void setConfig(string $Config) 设置<p>配置是通过 SM2 加密再 Hex 之后的数据</p>
...
class CreateCompanyDirectoryConfigRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>配置是通过 SM2 加密再 Hex 之后的数据</p>
     */
    public $Config;
    ...
    /**
     * @var string <p>使用场景：API 创建，快速上手，普通配置等</p>
     */
    public $Scene;

 ...
 * @method array getToolConfigs() 获取<p>工具集配置（openapi可能会用到）</p>
 * @method void setToolConfigs(array $ToolConfigs) 设置<p>工具集配置（openapi可能会用到）</p>
...
class ModifyMcpServerRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>工具集配置（openapi可能会用到）</p>
     */
    public $ToolConfigs;
     ...
     * @param array $ToolConfigs <p>工具集配置（openapi可能会用到）</p>

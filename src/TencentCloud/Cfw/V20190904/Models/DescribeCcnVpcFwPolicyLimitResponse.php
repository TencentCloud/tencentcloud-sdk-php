...
class DescribeCcnVpcFwPolicyLimitResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("CcnPolicyInterconnectPairLenLimit",$param) and $param["CcnPolicyInterconnectPairLenLimit"] !== null) {
            $this->CcnPolicyInterconnectPairLenLimit = $param["CcnPolicyInterconnectPairLenLimit"];
        }

        if (array_key_exists("CcnPolicyGroupLenLimit",$param) and $param["CcnPolicyGroupLenLimit"] !== null) {
            $this->CcnPolicyGroupLenLimit = $param["CcnPolicyGroupLenLimit"];
        }

        if (array_key_exists("CcnPolicyCidrLenLimit",$param) and $param["CcnPolicyCidrLenLimit"] !== null) {
            $this->CcnPolicyCidrLenLimit = $param["CcnPolicyCidrLenLimit"];
        }

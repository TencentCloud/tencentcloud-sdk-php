 ...
 *
 * @method string getInstanceId() 获取待修改同步模式的实例ID。形如：tdsql-ow728lmc。
 * @method void setInstanceId(string $InstanceId) 设置待修改同步模式的实例ID。形如：tdsql-ow728lmc。
...
{
    /**
     * @var string 待修改同步模式的实例ID。形如：tdsql-ow728lmc。
     */
    public $InstanceId;
    ...
    /**
     * @param string $InstanceId 待修改同步模式的实例ID。形如：tdsql-ow728lmc。

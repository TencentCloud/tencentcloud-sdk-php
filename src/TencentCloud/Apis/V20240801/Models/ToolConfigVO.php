 ...
 * @method array getMcpSecurityRules() 获取绑定安全规则（响应）
 * @method void setMcpSecurityRules(array $McpSecurityRules) 设置绑定安全规则（响应）
 */
class ToolConfigVO extends AbstractModel
{
    /**
     * @var string 工具名称
     */
     ...
     * @param array $McpSecurityRules 绑定安全规则（响应）
     */

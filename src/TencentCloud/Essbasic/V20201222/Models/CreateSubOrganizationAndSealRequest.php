...
OrganizationType 为 ENTERPRISE时，INDIVIDUALBIZ 时必填，其他情况选填
 * @method string getVerifyClientIp() 获取实名认证的客户端IP/请求生成企业印章的客户端Ip
 * @method void setVerifyClientIp(string $VerifyClientIp) 设置实名认证的客户端IP/请求生成企业印章的客户端Ip
 ...
 * @method string getSealType() 获取印章类型：默认: CONTRACT
1. OFFICIAL-公章
...
6. OTHER-其他
 * @method void setSealType(string $SealType) 设置印章类型：默认: CONTRACT
1. OFFICIAL-公章
2. SPECIAL_FINANCIAL-财务专用章
3. CONTRACT-合同专用章
4. LEGAL_REPRESENTATIVE-法定代表人章
5. SPECIAL_NATIONWIDE_INVOICE-发票专用章
6. OTHER-其他
 * @method string getSealHorizontalText() 获取企业印章横向文字，最多可填8个汉字（可为空，默认为"电子签名专用章"）
 * @method void setSealHorizontalText(string $SealHorizontalText) 设置企业印章横向文字，最多可填8个汉字（可为空，默认为"电子签名专用章"）
...
OrganizationType 为 ENTERPRISE时，INDIVIDUALBIZ 时必填，其他情况选填
    ...
    /**
     * @var string 实名认证的客户端IP/请求生成企业印章的客户端Ip
     */
...
6. OTHER-其他
    ...
    /**
     * @var string 企业印章横向文字，最多可填8个汉字（可为空，默认为"电子签名专用章"）
     */
...
OrganizationType 为 ENTERPRISE时，INDIVIDUALBIZ 时必填，其他情况选填
     * @param string $VerifyClientIp 实名认证的客户端IP/请求生成企业印章的客户端Ip
...
2. LICENSEFILE - 营业执照
     ...
     * @param string $SealType 印章类型：默认: CONTRACT
1. OFFICIAL-公章
2. SPECIAL_FINANCIAL-财务专用章
3. CONTRACT-合同专用章
4. LEGAL_REPRESENTATIVE-法定代表人章
5. SPECIAL_NATIONWIDE_INVOICE-发票专用章
6. OTHER-其他
     * @param string $SealHorizontalText 企业印章横向文字，最多可填8个汉字（可为空，默认为"电子签名专用章"）

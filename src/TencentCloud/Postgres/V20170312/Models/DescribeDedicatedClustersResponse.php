 ...
 *
 * @method array getDedicatedClusterSet() 获取专属集群信息
 * @method void setDedicatedClusterSet(array $DedicatedClusterSet) 设置专属集群信息
...
class DescribeDedicatedClustersResponse extends AbstractModel
{
    ...
    /**
     * @param array $DedicatedClusterSet 专属集群信息

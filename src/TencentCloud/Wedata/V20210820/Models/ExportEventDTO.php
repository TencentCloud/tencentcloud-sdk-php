...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getToken() 获取前端下载token token
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setToken(string $Token) 设置前端下载token token
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 */
class ExportEventDTO extends AbstractModel
{
    /**
     * @var string cos文件路径
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $Token 前端下载token token
注意：此字段可能返回 null，表示取不到有效值。

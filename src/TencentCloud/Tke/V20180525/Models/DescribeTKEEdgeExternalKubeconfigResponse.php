 ...
 *
 * @method string getKubeconfig() 获取kubeconfig文件内容
 * @method void setKubeconfig(string $Kubeconfig) 设置kubeconfig文件内容
...
class DescribeTKEEdgeExternalKubeconfigResponse extends AbstractModel
{
    ...
    /**
     * @param string $Kubeconfig kubeconfig文件内容

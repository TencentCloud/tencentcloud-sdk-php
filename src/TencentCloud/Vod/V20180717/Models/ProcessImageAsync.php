 ...
 * @method ProcessImageAsyncInput getInput() 获取图片异步处理任务的输入信息。
 * @method void setInput(ProcessImageAsyncInput $Input) 设置图片异步处理任务的输入信息。
 * @method ProcessImageAsyncOutput getOutput() 获取图片异步处理任务的输出信息。
 * @method void setOutput(ProcessImageAsyncOutput $Output) 设置图片异步处理任务的输出信息。
...
class ProcessImageAsync extends AbstractModel
{
    ...
    /**
     * @var ProcessImageAsyncInput 图片异步处理任务的输入信息。
     */
    public $Input;

    /**
     * @var ProcessImageAsyncOutput 图片异步处理任务的输出信息。
     */
    public $Output;
     ...
     * @param ProcessImageAsyncInput $Input 图片异步处理任务的输入信息。
     * @param ProcessImageAsyncOutput $Output 图片异步处理任务的输出信息。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Input",$param) and $param["Input"] !== null) {
            $this->Input = new ProcessImageAsyncInput();
            $this->Input->deserialize($param["Input"]);
        }

        if (array_key_exists("Output",$param) and $param["Output"] !== null) {
            $this->Output = new ProcessImageAsyncOutput();

 ...
 * @method AiRecognitionTaskTransTextResultInput getInput() 获取翻译任务输入信息。
 * @method void setInput(AiRecognitionTaskTransTextResultInput $Input) 设置翻译任务输入信息。
 * @method AiRecognitionTaskTransTextResultOutput getOutput() 获取翻译任务输出信息。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiRecognitionTaskTransTextResultOutput $Output) 设置翻译任务输出信息。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiRecognitionTaskTransTextResult extends AbstractModel
{
    ...
    /**
     * @var AiRecognitionTaskTransTextResultInput 翻译任务输入信息。
     */
    public $Input;

    /**
     * @var AiRecognitionTaskTransTextResultOutput 翻译任务输出信息。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiRecognitionTaskTransTextResultInput $Input 翻译任务输入信息。
     * @param AiRecognitionTaskTransTextResultOutput $Output 翻译任务输出信息。
注意：此字段可能返回 null，表示取不到有效值。
     */

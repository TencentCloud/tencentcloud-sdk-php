...
注意：此字段可能返回 null，表示取不到有效值。
 * @method QualityRuleFieldConfig getFieldConfig() 获取自定义模版sql表达式参数
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setFieldConfig(QualityRuleFieldConfig $FieldConfig) 设置自定义模版sql表达式参数
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 * @method QualityRuleGroupExecStrategy getExecStrategy() 获取执行策略信息
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setExecStrategy(QualityRuleGroupExecStrategy $ExecStrategy) 设置执行策略信息
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getTargetCatalogName() 获取目标表的数据目录
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setTargetCatalogName(string $TargetCatalogName) 设置目标表的数据目录
注意：此字段可能返回 null，表示取不到有效值。
 */
class QualityRule extends AbstractModel
{
    /**
     * @var integer 规则ID
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var QualityRuleFieldConfig 自定义模版sql表达式参数
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $FieldConfig;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var QualityRuleGroupExecStrategy 执行策略信息
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $ExecStrategy;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param QualityRuleFieldConfig $FieldConfig 自定义模版sql表达式参数
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param QualityRuleGroupExecStrategy $ExecStrategy 执行策略信息
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $TargetCatalogName 目标表的数据目录
注意：此字段可能返回 null，表示取不到有效值。
     */

 ...
 * @method string getLogsetId() 获取日志集ID，若指定则代表选择已有日志集。选择已有日志集时，LogsetName可以不填
 * @method void setLogsetId(string $LogsetId) 设置日志集ID，若指定则代表选择已有日志集。选择已有日志集时，LogsetName可以不填
 ...
 * @method string getTopicId() 获取日志主题ID，若指定则代表选择已有日志主题，选择已有日志主题时，TopicName可以不填
 * @method void setTopicId(string $TopicId) 设置日志主题ID，若指定则代表选择已有日志主题，选择已有日志主题时，TopicName可以不填
 * @method string getExtend() 获取日志配置拓展信息， 一般用于存储额外的日志投递配置
 * @method void setExtend(string $Extend) 设置日志配置拓展信息， 一般用于存储额外的日志投递配置
 */
class CreateCloudProductLogTaskRequest extends AbstractModel
{
    /**
     * @var string 实例ID
     */
...
- APIS所有日志类型：gz
    ...
    /**
     * @var string 日志集ID，若指定则代表选择已有日志集。选择已有日志集时，LogsetName可以不填
     */
    public $LogsetId;
    ...
    /**
     * @var string 日志主题ID，若指定则代表选择已有日志主题，选择已有日志主题时，TopicName可以不填
     */
    public $TopicId;
...
- APIS所有日志类型：gz
     ...
     * @param string $LogsetId 日志集ID，若指定则代表选择已有日志集。选择已有日志集时，LogsetName可以不填
     * @param string $TopicName 日志主题名称，在未填TopicId时必填。 若日志主题不存在，将自动创建
     * @param string $TopicId 日志主题ID，若指定则代表选择已有日志主题，选择已有日志主题时，TopicName可以不填

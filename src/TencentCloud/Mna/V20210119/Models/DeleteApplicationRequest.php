 ...
 *
 * @method array getMpApplicationIdList() 获取应用id列表
 * @method void setMpApplicationIdList(array $MpApplicationIdList) 设置应用id列表
 */
class DeleteApplicationRequest extends AbstractModel
{
    ...
    /**
     * @param array $MpApplicationIdList 应用id列表
     */

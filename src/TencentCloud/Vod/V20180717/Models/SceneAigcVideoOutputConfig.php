 ...
 * @method string getAspectRatio() 获取指定所生成视频的宽高比。输入格式为 W:H。仅生商品图场景有效。可选：16:9、9:16。
 * @method void setAspectRatio(string $AspectRatio) 设置指定所生成视频的宽高比。输入格式为 W:H。仅生商品图场景有效。可选：16:9、9:16。
 * @method float getDuration() 获取生成视频时长。可选值4、6、8秒
 * @method void setDuration(float $Duration) 设置生成视频时长。可选值4、6、8秒
 */
...
<li>默认值：0，表示其他分类。</li>
    ...
    /**
     * @var string 指定所生成视频的宽高比。输入格式为 W:H。仅生商品图场景有效。可选：16:9、9:16。
     */
    public $AspectRatio;

    /**
     * @var float 生成视频时长。可选值4、6、8秒
     */
    public $Duration;
...
<li>默认值：0，表示其他分类。</li>
     ...
     * @param string $AspectRatio 指定所生成视频的宽高比。输入格式为 W:H。仅生商品图场景有效。可选：16:9、9:16。
     * @param float $Duration 生成视频时长。可选值4、6、8秒
     */

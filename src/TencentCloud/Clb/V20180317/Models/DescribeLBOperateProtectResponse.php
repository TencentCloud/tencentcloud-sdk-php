 ...
 *
 * @method array getLoadBalancerSet() 获取返回的负载均衡操作保护信息数组。
 * @method void setLoadBalancerSet(array $LoadBalancerSet) 设置返回的负载均衡操作保护信息数组。
...
class DescribeLBOperateProtectResponse extends AbstractModel
{
    ...
    /**
     * @param array $LoadBalancerSet 返回的负载均衡操作保护信息数组。

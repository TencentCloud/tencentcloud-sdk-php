 ...
 *
 * @method UserItem getUserInfo() 获取<p>用户配额信息</p>
 * @method void setUserInfo(UserItem $UserInfo) 设置<p>用户配额信息</p>
...
class DescribeUserInfoResponse extends AbstractModel
{
    ...
    /**
     * @param UserItem $UserInfo <p>用户配额信息</p>

 ...
 *
 * @method string getInstanceId() 获取当前实例ID。
 * @method void setInstanceId(string $InstanceId) 设置当前实例ID。
 * @method integer getGoodsNum() 获取单次克隆实例的数量。包年包月每次购买最大数量为100。按量计费每次购买最大数量为30，每个地域购买数量取值范围为[1,100]。
 * @method void setGoodsNum(integer $GoodsNum) 设置单次克隆实例的数量。包年包月每次购买最大数量为100。按量计费每次购买最大数量为30，每个地域购买数量取值范围为[1,100]。
 ...
 * @method string getVpcId() 获取私有网络ID。如果未配置该参数，默认选择基础网络。
 * @method void setVpcId(string $VpcId) 设置私有网络ID。如果未配置该参数，默认选择基础网络。
 * @method string getSubnetId() 获取私有网络所属子网。基础网络时该参数无需配置。
 * @method void setSubnetId(string $SubnetId) 设置私有网络所属子网。基础网络时该参数无需配置。
 ...
 * @method integer getProjectId() 获取项目 ID。登录控制台，可在右上角的<b>账号中心</b> > <b>项目管理</b>中查找项目ID。
 * @method void setProjectId(integer $ProjectId) 设置项目 ID。登录控制台，可在右上角的<b>账号中心</b> > <b>项目管理</b>中查找项目ID。
 * @method array getResourceTags() 获取克隆实例需绑定的标签。
 * @method void setResourceTags(array $ResourceTags) 设置克隆实例需绑定的标签。
 * @method string getTemplateId() 获取克隆实例需要应用的参数模板ID,请登录 Redis 控制台，在<b>参数模板</b>页面获取。若不配置该参数，则应用默认的参数模板。
 * @method void setTemplateId(string $TemplateId) 设置克隆实例需要应用的参数模板ID,请登录 Redis 控制台，在<b>参数模板</b>页面获取。若不配置该参数，则应用默认的参数模板。
 * @method array getAlarmPolicyList() 获取指定克隆实例的告警策略 ID。请登录控制台，在<b>云监控</b> > <b>告警配置</b> > <b>告警策略</b>页面获取策略 ID 信息。
 * @method void setAlarmPolicyList(array $AlarmPolicyList) 设置指定克隆实例的告警策略 ID。请登录控制台，在<b>云监控</b> > <b>告警配置</b> > <b>告警策略</b>页面获取策略 ID 信息。
 */
class CloneInstancesRequest extends AbstractModel
{
    ...
    /**
     * @var integer 单次克隆实例的数量。包年包月每次购买最大数量为100。按量计费每次购买最大数量为30，每个地域购买数量取值范围为[1,100]。
     */
    public $GoodsNum;
    ...
    /**
     * @var string 私有网络ID。如果未配置该参数，默认选择基础网络。
     */
    public $VpcId;

    /**
     * @var string 私有网络所属子网。基础网络时该参数无需配置。
     */
    public $SubnetId;
    ...
    /**
     * @var integer 项目 ID。登录控制台，可在右上角的<b>账号中心</b> > <b>项目管理</b>中查找项目ID。
     */
    public $ProjectId;
    ...
    /**
     * @var string 克隆实例需要应用的参数模板ID,请登录 Redis 控制台，在<b>参数模板</b>页面获取。若不配置该参数，则应用默认的参数模板。
     */
    public $TemplateId;

    /**
     * @var array 指定克隆实例的告警策略 ID。请登录控制台，在<b>云监控</b> > <b>告警配置</b> > <b>告警策略</b>页面获取策略 ID 信息。
     */
    public $AlarmPolicyList;

    /**
     * @param string $InstanceId 当前实例ID。
     * @param integer $GoodsNum 单次克隆实例的数量。包年包月每次购买最大数量为100。按量计费每次购买最大数量为30，每个地域购买数量取值范围为[1,100]。
     ...
     * @param string $VpcId 私有网络ID。如果未配置该参数，默认选择基础网络。
     * @param string $SubnetId 私有网络所属子网。基础网络时该参数无需配置。
     ...
     * @param integer $ProjectId 项目 ID。登录控制台，可在右上角的<b>账号中心</b> > <b>项目管理</b>中查找项目ID。
     * @param array $ResourceTags 克隆实例需绑定的标签。
     * @param string $TemplateId 克隆实例需要应用的参数模板ID,请登录 Redis 控制台，在<b>参数模板</b>页面获取。若不配置该参数，则应用默认的参数模板。
     * @param array $AlarmPolicyList 指定克隆实例的告警策略 ID。请登录控制台，在<b>云监控</b> > <b>告警配置</b> > <b>告警策略</b>页面获取策略 ID 信息。
     */

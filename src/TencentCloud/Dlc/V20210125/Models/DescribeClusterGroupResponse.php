 ...
 *
 * @method string getId() 获取<p>集群组 ID（系统生成）</p>
 * @method void setId(string $Id) 设置<p>集群组 ID（系统生成）</p>
 * @method string getName() 获取<p>集群组名称（同一 AppId 下唯一）</p>
 * @method void setName(string $Name) 设置<p>集群组名称（同一 AppId 下唯一）</p>
 ...
 * @method boolean getDeleted() 获取<p>是否已软删除（false=活跃，true=已删除）</p>
 * @method void setDeleted(boolean $Deleted) 设置<p>是否已软删除（false=活跃，true=已删除）</p>
 ...
 */
class DescribeClusterGroupResponse extends AbstractModel
{
    /**
     * @var string <p>集群组 ID（系统生成）</p>
     */
    public $Id;

    /**
     * @var string <p>集群组名称（同一 AppId 下唯一）</p>
     */
    public $Name;
    ...
    /**
     * @var boolean <p>是否已软删除（false=活跃，true=已删除）</p>
     */
    public $Deleted;
    ...
    /**
     * @param string $Id <p>集群组 ID（系统生成）</p>
     * @param string $Name <p>集群组名称（同一 AppId 下唯一）</p>
     ...
     * @param boolean $Deleted <p>是否已软删除（false=活跃，true=已删除）</p>

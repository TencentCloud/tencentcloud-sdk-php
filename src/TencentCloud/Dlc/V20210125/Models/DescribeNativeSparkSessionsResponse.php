 ...
 */
class DescribeNativeSparkSessionsResponse extends AbstractModel
{
    /**
     * @var array spark session列表
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("SparkSessionsList",$param) and $param["SparkSessionsList"] !== null) {
            $this->SparkSessionsList = [];
            foreach ($param["SparkSessionsList"] as $key => $value){
                $obj = new SparkSessionInfo();

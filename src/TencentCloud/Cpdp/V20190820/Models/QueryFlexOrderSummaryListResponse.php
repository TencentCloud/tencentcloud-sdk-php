 ...
 * @method OrderSummaries getResult() 获取返回结果
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(OrderSummaries $Result) 设置返回结果
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getRequestId() 获取唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 */
class QueryFlexOrderSummaryListResponse extends AbstractModel
{
    /**
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param OrderSummaries $Result 返回结果
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new OrderSummaries();

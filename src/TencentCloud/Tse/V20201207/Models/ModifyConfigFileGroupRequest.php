 ...
 * @method ConfigFileGroup getConfigFileGroup() 获取配置文件组
 * @method void setConfigFileGroup(ConfigFileGroup $ConfigFileGroup) 设置配置文件组
 */
class ModifyConfigFileGroupRequest extends AbstractModel
{
    /**
     * @var string tse实例id
     */
    ...
    /**
     * @var ConfigFileGroup 配置文件组
     */
    public $ConfigFileGroup;

    /**
     * @param string $InstanceId tse实例id
     * @param ConfigFileGroup $ConfigFileGroup 配置文件组
     */

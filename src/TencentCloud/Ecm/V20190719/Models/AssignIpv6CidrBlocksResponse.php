 ...
 *
 * @method array getIPv6CidrBlockSet() 获取IPv6网段和所属运营商。	
 * @method void setIPv6CidrBlockSet(array $IPv6CidrBlockSet) 设置IPv6网段和所属运营商。	
 * @method string getRequestId() 获取唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
 */
class AssignIpv6CidrBlocksResponse extends AbstractModel
{
    /**
     * @var array IPv6网段和所属运营商。	
     */
    ...
    /**
     * @param array $IPv6CidrBlockSet IPv6网段和所属运营商。	

 ...
 * TI资源规格
 *
 * @method string getSpecAlias() 获取规格简称
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setSpecAlias(string $SpecAlias) 设置规格简称
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getSpecId() 获取规格Id
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setSpecId(string $SpecId) 设置规格Id
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getSpecName() 获取规则名称
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setSpecName(string $SpecName) 设置规则名称
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param string $SpecAlias 规格简称
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $SpecId 规格Id
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $SpecName 规则名称
注意：此字段可能返回 null，表示取不到有效值。
     */

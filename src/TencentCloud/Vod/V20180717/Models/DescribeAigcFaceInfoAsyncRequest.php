 ...
 * @method array getFileInfos() 获取<p>需要获取人脸信息的输入视频信息，最多包含一个文件。</p>
 * @method void setFileInfos(array $FileInfos) 设置<p>需要获取人脸信息的输入视频信息，最多包含一个文件。</p>
...
class DescribeAigcFaceInfoAsyncRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>需要获取人脸信息的输入视频信息，最多包含一个文件。</p>
     */
    public $FileInfos;
     ...
     * @param array $FileInfos <p>需要获取人脸信息的输入视频信息，最多包含一个文件。</p>

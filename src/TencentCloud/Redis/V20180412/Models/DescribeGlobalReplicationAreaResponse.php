 ...
 *
 * @method array getAvailableRegions() 获取可用地域信息
 * @method void setAvailableRegions(array $AvailableRegions) 设置可用地域信息
...
class DescribeGlobalReplicationAreaResponse extends AbstractModel
{
    ...
    /**
     * @param array $AvailableRegions 可用地域信息
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("AvailableRegions",$param) and $param["AvailableRegions"] !== null) {
            ...
            foreach ($param["AvailableRegions"] as $key => $value){
                $obj = new AvailableRegion();
                $obj->deserialize($value);
                array_push($this->AvailableRegions, $obj);
            }
        }

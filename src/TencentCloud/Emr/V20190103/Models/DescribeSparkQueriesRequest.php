 ...
 * @method array getStatus() 获取执行状态:RUNNING,COMPLETED,FAILED
 * @method void setStatus(array $Status) 设置执行状态:RUNNING,COMPLETED,FAILED
 */
class DescribeSparkQueriesRequest extends AbstractModel
{
    ...
    /**
     * @var array 执行状态:RUNNING,COMPLETED,FAILED
     */
    public $Status;
     ...
     * @param array $Status 执行状态:RUNNING,COMPLETED,FAILED
     */

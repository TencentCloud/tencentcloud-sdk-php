 ...
 * @method AiContentReviewTaskInput getInput() 获取审核任务的输入。
 * @method void setInput(AiContentReviewTaskInput $Input) 设置审核任务的输入。
 * @method array getOutput() 获取审核任务的输出。
...
class ScheduleReviewTaskResult extends AbstractModel
{
    ...
    /**
     * @var AiContentReviewTaskInput 审核任务的输入。
     */
    public $Input;

 ...
 *
 * @method boolean getIsReturnable() 获取实例是否支持退还/退货
 * @method void setIsReturnable(boolean $IsReturnable) 设置实例是否支持退还/退货
 * @method string getReturnFailMessage() 获取不支持退还的原因
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setReturnFailMessage(string $ReturnFailMessage) 设置不支持退还的原因
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param boolean $IsReturnable 实例是否支持退还/退货
     * @param string $ReturnFailMessage 不支持退还的原因
注意：此字段可能返回 null，表示取不到有效值。

 ...
 * @method string getRouteId() 获取<p>Route ID</p>
 * @method void setRouteId(string $RouteId) 设置<p>Route ID</p>
 ...
 * @method array getHeaderMatch() 获取<p>Header 匹配规则</p>
 * @method void setHeaderMatch(array $HeaderMatch) 设置<p>Header 匹配规则</p>
 ...
 * @method string getPathMatchType() 获取<p>匹配规则</p><p>枚举值：</p><ul><li>Exact： 精确</li><li>Prefix： 前缀</li><li>Regex： 正则</li></ul>
 * @method void setPathMatchType(string $PathMatchType) 设置<p>匹配规则</p><p>枚举值：</p><ul><li>Exact： 精确</li><li>Prefix： 前缀</li><li>Regex： 正则</li></ul>
 * @method integer getPriority() 获取<p>路由优先级</p>
 * @method void setPriority(integer $Priority) 设置<p>路由优先级</p>
 */
class ModifyCloudNativeAPIGatewayMCPRouteRequest extends AbstractModel
{
    /**
     * @var string <p>网关ID</p>
     */
    ...
    /**
     * @var string <p>匹配规则</p><p>枚举值：</p><ul><li>Exact： 精确</li><li>Prefix： 前缀</li><li>Regex： 正则</li></ul>
     */
     ...
     * @param string $RouteId <p>Route ID</p>
     * @param string $ServerId <p>MCP Server ID</p>
     * @param string $Description <p>描述</p>
     * @param array $HeaderMatch <p>Header 匹配规则</p>
     * @param array $Methods <p>http method</p>
     * @param string $Path <p>路径</p>
     * @param string $PathMatchType <p>匹配规则</p><p>枚举值：</p><ul><li>Exact： 精确</li><li>Prefix： 前缀</li><li>Regex： 正则</li></ul>
     * @param integer $Priority <p>路由优先级</p>
     */

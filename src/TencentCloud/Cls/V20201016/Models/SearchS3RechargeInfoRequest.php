 ...
 * @method string getName() 获取<p>s3导入任务名称,最大支持128个字节。</p>
 * @method void setName(string $Name) 设置<p>s3导入任务名称,最大支持128个字节。</p>
 ...
 */
class SearchS3RechargeInfoRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>s3导入任务名称,最大支持128个字节。</p>
     */
    public $Name;
     ...
     * @param string $Name <p>s3导入任务名称,最大支持128个字节。</p>

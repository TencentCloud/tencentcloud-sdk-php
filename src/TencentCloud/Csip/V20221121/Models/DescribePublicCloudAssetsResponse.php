 ...
 * @method array getAssets() 获取资产集合
 * @method void setAssets(array $Assets) 设置资产集合
 * @method array getAssetTypeList() 获取资产类型集合
 * @method void setAssetTypeList(array $AssetTypeList) 设置资产类型集合
 * @method array getRegionList() 获取地域集合
 * @method void setRegionList(array $RegionList) 设置地域集合
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class DescribePublicCloudAssetsResponse extends AbstractModel
{
    /**
     * @var integer 资产数量
     */
     ...
     * @param array $Assets 资产集合
     * @param array $AssetTypeList 资产类型集合
     * @param array $RegionList 地域集合

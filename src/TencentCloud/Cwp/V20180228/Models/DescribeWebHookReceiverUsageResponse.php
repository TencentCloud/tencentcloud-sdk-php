 ...
 *
 * @method array getList() 获取告警接收人的关联策略使用信息
 * @method void setList(array $List) 设置告警接收人的关联策略使用信息
...
class DescribeWebHookReceiverUsageResponse extends AbstractModel
{
    ...
    /**
     * @param array $List 告警接收人的关联策略使用信息

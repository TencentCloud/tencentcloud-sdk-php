 ...
 * DetachPolicy请求参数结构体
 *
 * @method integer getTargetId() 获取<p>解绑策略目标ID。成员Uin或部门ID</p>
 * @method void setTargetId(integer $TargetId) 设置<p>解绑策略目标ID。成员Uin或部门ID</p>
...
{
    /**
     * @var integer <p>解绑策略目标ID。成员Uin或部门ID</p>
     */
    public $TargetId;
    ...
    /**
     * @param integer $TargetId <p>解绑策略目标ID。成员Uin或部门ID</p>

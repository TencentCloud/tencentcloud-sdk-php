 ...
 * @method string getCdcId() 获取<p>CDC集群ID，非CDC场景无需指定该入参</p>
 * @method void setCdcId(string $CdcId) 设置<p>CDC集群ID，非CDC场景无需指定该入参</p>
...
class CreateDBInstanceHourRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>CDC集群ID，非CDC场景无需指定该入参</p>
     */
    public $CdcId;
     ...
     * @param string $CdcId <p>CDC集群ID，非CDC场景无需指定该入参</p>

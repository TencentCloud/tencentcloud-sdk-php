 ...
 * 查询页面列表
 *
 * @method array getList() 获取列表数据集合
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setList(array $List) 设置列表数据集合
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 */
class DescribeUserGroupMemberPageListContainer extends AbstractModel
{
    /**
     * @var array 列表数据集合
注意：此字段可能返回 null，表示取不到有效值。

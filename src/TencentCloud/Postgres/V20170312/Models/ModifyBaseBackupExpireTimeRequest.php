 ...
 * @method string getBaseBackupId() 获取数据备份ID。可通过[DescribeBaseBackups](https://cloud.tencent.com/document/api/409/89022)接口获取
 * @method void setBaseBackupId(string $BaseBackupId) 设置数据备份ID。可通过[DescribeBaseBackups](https://cloud.tencent.com/document/api/409/89022)接口获取
...
class ModifyBaseBackupExpireTimeRequest extends AbstractModel
{
    ...
    /**
     * @var string 数据备份ID。可通过[DescribeBaseBackups](https://cloud.tencent.com/document/api/409/89022)接口获取
     */
    public $BaseBackupId;
     ...
     * @param string $BaseBackupId 数据备份ID。可通过[DescribeBaseBackups](https://cloud.tencent.com/document/api/409/89022)接口获取

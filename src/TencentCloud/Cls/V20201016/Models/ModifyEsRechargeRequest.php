 ...
 *
 * @method string getTaskId() 获取导入任务id。
 * @method void setTaskId(string $TaskId) 设置导入任务id。
 ...
 * @method integer getStatus() 获取任务状态。1:运行， 2:暂停
 * @method void setStatus(integer $Status) 设置任务状态。1:运行， 2:暂停
...
- 通过 [创建日志主题](https://cloud.tencent.com/document/product/614/56456) 获取日志主题Id。
     ...
     * @param integer $Status 任务状态。1:运行， 2:暂停

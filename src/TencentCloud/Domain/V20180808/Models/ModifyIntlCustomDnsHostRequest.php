 ...
 * @method string getDnsName() 获取DNS Host
 * @method void setDnsName(string $DnsName) 设置DNS Host
 * @method array getIpSet() 获取IP地址
 * @method void setIpSet(array $IpSet) 设置IP地址
 */
class ModifyIntlCustomDnsHostRequest extends AbstractModel
{
    /**
     * @var string 域名ID
     */
     ...
     * @param string $DnsName DNS Host
     * @param array $IpSet IP地址
     */

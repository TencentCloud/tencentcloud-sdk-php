 ...
 * 查询控制台用户组成员列表响应
 *
 * @method array getItems() 获取用户组成员列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setItems(array $Items) 设置用户组成员列表
注意：此字段可能返回 null，表示取不到有效值。
 ...
 */
class ListConsoleGroupUsersRsp extends AbstractModel
{
    /**
     * @var array 用户组成员列表
注意：此字段可能返回 null，表示取不到有效值。

 ...
 *
 * @method array getDocList() 获取<p>文档列表</p>
 * @method void setDocList(array $DocList) 设置<p>文档列表</p>
 ...
 */
class DescribeDocSummaryListResponse extends AbstractModel
{
    /**
     * @var array <p>文档列表</p>
     */

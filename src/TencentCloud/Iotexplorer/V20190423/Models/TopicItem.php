 ...
 * @method integer getPrivilege() 获取Topic权限 , 1上报  2下发
 * @method void setPrivilege(integer $Privilege) 设置Topic权限 , 1上报  2下发
 */
class TopicItem extends AbstractModel
{
    ...
    /**
     * @var integer Topic权限 , 1上报  2下发
     */
    public $Privilege;

    /**
     * @param string $TopicName Topic名称
     * @param integer $Privilege Topic权限 , 1上报  2下发
     */

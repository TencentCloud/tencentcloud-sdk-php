 ...
 *
 * @method integer getSchedule() 获取进度
 * @method void setSchedule(integer $Schedule) 设置进度
 * @method array getList() 获取绑定任务详情
 * @method void setList(array $List) 设置绑定任务详情
...
class DescribeLicenseBindScheduleResponse extends AbstractModel
{
    ...
    /**
     * @param integer $Schedule 进度
     * @param array $List 绑定任务详情

 ...
 * @method array getConfigGroupVersionInfos() 获取版本信息列表。
 * @method void setConfigGroupVersionInfos(array $ConfigGroupVersionInfos) 设置版本信息列表。
...
class DescribeConfigGroupVersionsResponse extends AbstractModel
{
     ...
     * @param array $ConfigGroupVersionInfos 版本信息列表。

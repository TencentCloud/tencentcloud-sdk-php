...
- `BASIC`：基础版
- `ADVANCED`：高级版
 * @method integer getPeriod() 获取订阅购买时长，单位：月
 * @method void setPeriod(integer $Period) 设置订阅购买时长，单位：月
 ...
 */
class SeeCreateSubscriptionEntry extends AbstractModel
{
    /**
     * @var string 产品 ID
     */
...
- `BASIC`：基础版
- `ADVANCED`：高级版
     * @param integer $Period 订阅购买时长，单位：月

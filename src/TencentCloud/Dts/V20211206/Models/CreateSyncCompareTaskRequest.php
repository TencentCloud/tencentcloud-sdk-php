 ...
 * @method CompareObject getObjects() 获取对比对象，当ObjectMode值为custom时，此项需要填写
 * @method void setObjects(CompareObject $Objects) 设置对比对象，当ObjectMode值为custom时，此项需要填写
 * @method CompareOptions getOptions() 获取一致性校验选项
 * @method void setOptions(CompareOptions $Options) 设置一致性校验选项
 */
class CreateSyncCompareTaskRequest extends AbstractModel
{
    /**
     * @var string 任务 Id
     */
    ...
    /**
     * @var CompareObject 对比对象，当ObjectMode值为custom时，此项需要填写
     */
    public $Objects;
     ...
     * @param CompareObject $Objects 对比对象，当ObjectMode值为custom时，此项需要填写

 ...
 * @method string getMessage() 获取<p>本次问答用户输入的问题，（最大长度1000）</p>
 * @method void setMessage(string $Message) 设置<p>本次问答用户输入的问题，（最大长度1000）</p>
 ...
 * @method integer getSex() 获取<p>性别，0:未知，1:男，2:女</p>
 * @method void setSex(integer $Sex) 设置<p>性别，0:未知，1:男，2:女</p>
 * @method integer getAge() 获取<p>年龄，0:未知，最大值：120</p>
 * @method void setAge(integer $Age) 设置<p>年龄，0:未知，最大值：120</p>
 * @method integer getRoundNumber() 获取<p>追问轮数，-1:不追问；0:使用默认规则； 1-10:按指定轮数追问；（最大值10轮）； 默认：0</p>
 * @method void setRoundNumber(integer $RoundNumber) 设置<p>追问轮数，-1:不追问；0:使用默认规则； 1-10:按指定轮数追问；（最大值10轮）； 默认：0</p>
 * @method integer getOutputStructured() 获取<p>是否追问结构化结果，0：否，1：是；</p>
 * @method void setOutputStructured(integer $OutputStructured) 设置<p>是否追问结构化结果，0：否，1：是；</p>
 */
class GetLLMDiagnosisHealthRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>本次问答用户输入的问题，（最大长度1000）</p>
     */
    public $Message;
    ...
    /**
     * @var integer <p>性别，0:未知，1:男，2:女</p>
     */
    public $Sex;

    /**
     * @var integer <p>年龄，0:未知，最大值：120</p>
     */
    public $Age;

    /**
     * @var integer <p>追问轮数，-1:不追问；0:使用默认规则； 1-10:按指定轮数追问；（最大值10轮）； 默认：0</p>
     */
    public $RoundNumber;

    /**
     * @var integer <p>是否追问结构化结果，0：否，1：是；</p>
     */
    public $OutputStructured;
     ...
     * @param string $Message <p>本次问答用户输入的问题，（最大长度1000）</p>
     * @param integer $ResultType <p>返回类型：0:正常返回； 1:流式返回； 默认：0</p>
     * @param integer $Sex <p>性别，0:未知，1:男，2:女</p>
     * @param integer $Age <p>年龄，0:未知，最大值：120</p>
     * @param integer $RoundNumber <p>追问轮数，-1:不追问；0:使用默认规则； 1-10:按指定轮数追问；（最大值10轮）； 默认：0</p>
     * @param integer $OutputStructured <p>是否追问结构化结果，0：否，1：是；</p>
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("OutputStructured",$param) and $param["OutputStructured"] !== null) {
            $this->OutputStructured = $param["OutputStructured"];
        }
    }
}

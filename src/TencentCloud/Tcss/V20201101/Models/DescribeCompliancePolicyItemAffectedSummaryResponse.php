 ...
 *
 * @method CompliancePolicyItemSummary getPolicyItemSummary() 获取返回各检测项影响的资产的汇总信息。
 * @method void setPolicyItemSummary(CompliancePolicyItemSummary $PolicyItemSummary) 设置返回各检测项影响的资产的汇总信息。
...
{
    /**
     * @var CompliancePolicyItemSummary 返回各检测项影响的资产的汇总信息。
     */
    public $PolicyItemSummary;

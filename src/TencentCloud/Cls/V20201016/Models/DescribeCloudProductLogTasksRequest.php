 ...
 * @method boolean getWithTags() 获取<p>是否携带topic和logset的标签信息</p>
 * @method void setWithTags(boolean $WithTags) 设置<p>是否携带topic和logset的标签信息</p>
 */
class DescribeCloudProductLogTasksRequest extends AbstractModel
{
    ...
    /**
     * @var boolean <p>是否携带topic和logset的标签信息</p>
     */
    public $WithTags;
     ...
     * @param boolean $WithTags <p>是否携带topic和logset的标签信息</p>
     */

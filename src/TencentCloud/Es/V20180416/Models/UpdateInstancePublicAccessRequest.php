 ...
 * @method array getKibanaAlteringPublicAccess() 获取是否开启Altering 外网告警输出
 * @method void setKibanaAlteringPublicAccess(array $KibanaAlteringPublicAccess) 设置是否开启Altering 外网告警输出
 */
class UpdateInstancePublicAccessRequest extends AbstractModel
{
    /**
     * @var string 实例ID
     */
...
专用主节点磁盘大小（单位GB系统默认配置为50GB,暂不支持自定义）
     ...
     * @param array $KibanaAlteringPublicAccess 是否开启Altering 外网告警输出
     */

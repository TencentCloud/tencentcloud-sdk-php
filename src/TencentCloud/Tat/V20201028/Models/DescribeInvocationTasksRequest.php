 ...
 * @method array getFilters() 获取过滤条件。<br>
 ...
 * @method void setFilters(array $Filters) 设置过滤条件。<br>
 ...
 * @method boolean getHideOutput() 获取是否隐藏命令输出结果，取值范围：

- true：隐藏输出
- false：不隐藏
 
默认为 true。
 * @method void setHideOutput(boolean $HideOutput) 设置是否隐藏命令输出结果，取值范围：
...
每次请求的 `Filters` 的上限为10， `Filter.Values` 的上限为5。参数不支持同时指定 `InvocationTaskIds` 和 `Filters` 。
     ...
     * @param boolean $HideOutput 是否隐藏命令输出结果，取值范围：

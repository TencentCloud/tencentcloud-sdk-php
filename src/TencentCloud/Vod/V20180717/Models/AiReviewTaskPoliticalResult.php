 ...
 * @method AiReviewPoliticalTaskInput getInput() 获取智能识别涉及令人不适宜信息的任务输入。
 * @method void setInput(AiReviewPoliticalTaskInput $Input) 设置智能识别涉及令人不适宜信息的任务输入。
 * @method AiReviewPoliticalTaskOutput getOutput() 获取智能识别涉及令人不适宜信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewPoliticalTaskOutput $Output) 设置智能识别涉及令人不适宜信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiReviewTaskPoliticalResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPoliticalTaskInput 智能识别涉及令人不适宜信息的任务输入。
     */
    public $Input;

    /**
     * @var AiReviewPoliticalTaskOutput 智能识别涉及令人不适宜信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiReviewPoliticalTaskInput $Input 智能识别涉及令人不适宜信息的任务输入。
     * @param AiReviewPoliticalTaskOutput $Output 智能识别涉及令人不适宜信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

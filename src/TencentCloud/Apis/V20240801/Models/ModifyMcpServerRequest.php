 ...
 * @method integer getTargetHostType() 获取目标Host类型 0 默认 1 vpc
 * @method void setTargetHostType(integer $TargetHostType) 设置目标Host类型 0 默认 1 vpc
 ...
 * @method array getToolConfigs() 获取工具集配置（openapi可能会用到）
 * @method void setToolConfigs(array $ToolConfigs) 设置工具集配置（openapi可能会用到）
...
class ModifyMcpServerRequest extends AbstractModel
{
    ...
    /**
     * @var integer 目标Host类型 0 默认 1 vpc
     */
     ...
     * @param integer $TargetHostType 目标Host类型 0 默认 1 vpc
     ...
     * @param array $ToolConfigs 工具集配置（openapi可能会用到）

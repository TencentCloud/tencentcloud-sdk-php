 ...
 * @method boolean getKillInstance() 获取是否终止已生成实例，默认false
 * @method void setKillInstance(boolean $KillInstance) 设置是否终止已生成实例，默认false
 */
class StopOpsTasksAsyncRequest extends AbstractModel
{
     ...
     * @param boolean $KillInstance 是否终止已生成实例，默认false
     */

 ...
 * @method LLMDiagnosisDrugData getData() 获取<p>返回数据</p>
 * @method void setData(LLMDiagnosisDrugData $Data) 设置<p>返回数据</p>
 ...
 */
class GetLLMDiagnosisDrugChatResponse extends AbstractModel
{
    /**
    ...
    /**
     * @var LLMDiagnosisDrugData <p>返回数据</p>
     */
    public $Data;
     ...
     * @param LLMDiagnosisDrugData $Data <p>返回数据</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Data",$param) and $param["Data"] !== null) {
            $this->Data = new LLMDiagnosisDrugData();

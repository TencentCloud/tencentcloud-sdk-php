 ...
 * @method string getSourceTerm() 获取源语言术语。
 * @method void setSourceTerm(string $SourceTerm) 设置源语言术语。
 * @method string getTargetTerm() 获取目标语言术语。
 * @method void setTargetTerm(string $TargetTerm) 设置目标语言术语。
 * @method integer getUpdatedAt() 获取更新时间。Unix 时间戳（毫秒）。
 * @method void setUpdatedAt(integer $UpdatedAt) 设置更新时间。Unix 时间戳（毫秒）。
 */
class GlossaryEntryItem extends AbstractModel
{
    ...
    /**
     * @var integer 更新时间。Unix 时间戳（毫秒）。
     */
    public $UpdatedAt;

    /**
     * @param string $EntryId 术语条目 ID。
     * @param string $SourceTerm 源语言术语。
     * @param string $TargetTerm 目标语言术语。
     * @param integer $UpdatedAt 更新时间。Unix 时间戳（毫秒）。
     */

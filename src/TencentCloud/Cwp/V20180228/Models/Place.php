 ...
 * @method integer getCountryId() 获取国家ID，暂只支持境内：1。
 * @method void setCountryId(integer $CountryId) 设置国家ID，暂只支持境内：1。
...
class Place extends AbstractModel
{
     ...
     * @param integer $CountryId 国家ID，暂只支持境内：1。

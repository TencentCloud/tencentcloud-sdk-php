 ...
 * 智能分析通用任务输入类型
 *
 * @method integer getDefinition() 获取<p>智能分析模板 ID。</p>
 * @method void setDefinition(integer $Definition) 设置<p>智能分析模板 ID。</p>
 * @method string getExtendedParameter() 获取<p>扩展参数。</p>
 * @method void setExtendedParameter(string $ExtendedParameter) 设置<p>扩展参数。</p>
 */
class AiAnalysisTaskGenericInput extends AbstractModel
{
    /**
     * @var integer <p>智能分析模板 ID。</p>
     */
    public $Definition;
    ...
    /**
     * @param integer $Definition <p>智能分析模板 ID。</p>

 ...
 * @method string getSharedCNAME() 获取需要删除的共享 CNAME。
 * @method void setSharedCNAME(string $SharedCNAME) 设置需要删除的共享 CNAME。
 */
class DeleteSharedCNAMERequest extends AbstractModel
{
    ...
    /**
     * @var string 需要删除的共享 CNAME。
     */
    public $SharedCNAME;

    /**
     * @param string $ZoneId 共享 CNAME 所属站点 ID。
     * @param string $SharedCNAME 需要删除的共享 CNAME。
     */

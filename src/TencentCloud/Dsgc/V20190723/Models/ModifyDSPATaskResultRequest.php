 ...
 * @method integer getSrcRuleId() 获取调整前的规则ID

 * @method void setSrcRuleId(integer $SrcRuleId) 设置调整前的规则ID

 * @method integer getSrcCategoryId() 获取调整之前的分类id
 * @method void setSrcCategoryId(integer $SrcCategoryId) 设置调整之前的分类id
 * @method integer getSrcLevelId() 获取调整之前的分级id
 * @method void setSrcLevelId(integer $SrcLevelId) 设置调整之前的分级id
 * @method integer getIdentifyType() 获取识别方式
0-系统识别，1-人工打标
 * @method void setIdentifyType(integer $IdentifyType) 设置识别方式
0-系统识别，1-人工打标
 */
class ModifyDSPATaskResultRequest extends AbstractModel
{
    /**
     * @var string DSPA实例ID
     */
    ...
    /**
     * @var integer 调整前的规则ID

     */
    public $SrcRuleId;

    /**
     * @var integer 调整之前的分类id
     */
    public $SrcCategoryId;

    /**
     * @var integer 调整之前的分级id
     */
    public $SrcLevelId;
...
0-系统识别，1-人工打标
     ...
     * @param integer $SrcRuleId 调整前的规则ID

     * @param integer $SrcCategoryId 调整之前的分类id
     * @param integer $SrcLevelId 调整之前的分级id
     * @param integer $IdentifyType 识别方式
0-系统识别，1-人工打标
     */

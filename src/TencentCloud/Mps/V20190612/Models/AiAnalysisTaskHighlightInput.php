 ...
 * 智能精彩片段任务输入类型
 *
 * @method integer getDefinition() 获取<p>视频智能精彩片段模板 ID。</p>
 * @method void setDefinition(integer $Definition) 设置<p>视频智能精彩片段模板 ID。</p>
...
class AiAnalysisTaskHighlightInput extends AbstractModel
{
    ...
    /**
     * @param integer $Definition <p>视频智能精彩片段模板 ID。</p>

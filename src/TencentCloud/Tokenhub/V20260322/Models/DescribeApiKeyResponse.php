 ...
 * @method string getApiKey() 获取API 密钥值（明文）。
 * @method void setApiKey(string $ApiKey) 设置API 密钥值（明文）。
 * @method string getRemark() 获取备注。
 * @method void setRemark(string $Remark) 设置备注。
 * @method string getPlatform() 获取平台类型。枚举：maas
 * @method void setPlatform(string $Platform) 设置平台类型。枚举：maas
 ...
 * @method string getBindType() 获取绑定类型。取值：all（全部模型和接入点）、model_all_endpoint_custom（全部模型+自定义接入点）、model_custom_endpoint_all（自定义模型+全部接入点）、model_custom_endpoint_custom（自定义模型+自定义接入点）。
 * @method void setBindType(string $BindType) 设置绑定类型。取值：all（全部模型和接入点）、model_all_endpoint_custom（全部模型+自定义接入点）、model_custom_endpoint_all（自定义模型+全部接入点）、model_custom_endpoint_custom（自定义模型+自定义接入点）。
 ...
 * @method array getIpWhitelist() 获取IP 白名单列表。支持 IPv4和 CIDR 格式。空数组表示不限制 IP。
 * @method void setIpWhitelist(array $IpWhitelist) 设置IP 白名单列表。支持 IPv4和 CIDR 格式。空数组表示不限制 IP。
 * @method string getCreator() 获取当Platform为maas时该字段为空
 * @method void setCreator(string $Creator) 设置当Platform为maas时该字段为空
 * @method array getQuotaSet() 获取Token 限额多维度信息。未配置限额时不返回该字段。
 * @method void setQuotaSet(array $QuotaSet) 设置Token 限额多维度信息。未配置限额时不返回该字段。
...
class DescribeApiKeyResponse extends AbstractModel
{
    ...
    /**
     * @var string 绑定类型。取值：all（全部模型和接入点）、model_all_endpoint_custom（全部模型+自定义接入点）、model_custom_endpoint_all（自定义模型+全部接入点）、model_custom_endpoint_custom（自定义模型+自定义接入点）。
     */
    public $BindType;
    ...
    /**
     * @var array IP 白名单列表。支持 IPv4和 CIDR 格式。空数组表示不限制 IP。
     */
    public $IpWhitelist;
    ...
    /**
     * @var array Token 限额多维度信息。未配置限额时不返回该字段。
     */
    public $QuotaSet;
     ...
     * @param string $ApiKey API 密钥值（明文）。
     * @param string $Remark 备注。
     * @param string $Platform 平台类型。枚举：maas
     * @param string $Uin 主账号。
     * @param string $SubUin 子账号。
     * @param string $Status 状态。取值：enable（启用）、disable（禁用）。
     * @param string $BindType 绑定类型。取值：all（全部模型和接入点）、model_all_endpoint_custom（全部模型+自定义接入点）、model_custom_endpoint_all（自定义模型+全部接入点）、model_custom_endpoint_custom（自定义模型+自定义接入点）。
     ...
     * @param array $IpWhitelist IP 白名单列表。支持 IPv4和 CIDR 格式。空数组表示不限制 IP。
     * @param string $Creator 当Platform为maas时该字段为空
     * @param array $QuotaSet Token 限额多维度信息。未配置限额时不返回该字段。

 ...
 * @method string getInvocationId() 获取<p>执行活动ID。</p>
 * @method void setInvocationId(string $InvocationId) 设置<p>执行活动ID。</p>
...
class RunCommandResponse extends AbstractModel
{
     ...
     * @param string $InvocationId <p>执行活动ID。</p>

 ...
 * @method string getDeviceName() 获取<p>设备名称；BindingScope=device 时必填</p>
 * @method void setDeviceName(string $DeviceName) 设置<p>设备名称；BindingScope=device 时必填</p>
 ...
 */
class UnbindTWeTalkAgentRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>设备名称；BindingScope=device 时必填</p>
     */
    public $DeviceName;
     ...
     * @param string $DeviceName <p>设备名称；BindingScope=device 时必填</p>

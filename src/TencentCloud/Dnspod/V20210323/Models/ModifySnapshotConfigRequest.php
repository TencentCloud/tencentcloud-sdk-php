 ...
 * @method string getPeriod() 获取备件间隔：空字符串-不备份，half_hour-每半小时，hourly-每小时，daily-每天，monthly-每月
 * @method void setPeriod(string $Period) 设置备件间隔：空字符串-不备份，half_hour-每半小时，hourly-每小时，daily-每天，monthly-每月
...
class ModifySnapshotConfigRequest extends AbstractModel
{
    ...
    /**
     * @var string 备件间隔：空字符串-不备份，half_hour-每半小时，hourly-每小时，daily-每天，monthly-每月
     */
    public $Period;
     ...
     * @param string $Period 备件间隔：空字符串-不备份，half_hour-每半小时，hourly-每小时，daily-每天，monthly-每月

 ...
 *
 * @method array getApplicationInfoList() 获取应用license列表
 * @method void setApplicationInfoList(array $ApplicationInfoList) 设置应用license列表
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeVcubeApplicationAndXMagicListResponse extends AbstractModel
{
    /**
     * @var array 应用license列表
     */
    ...
    /**
     * @param array $ApplicationInfoList 应用license列表

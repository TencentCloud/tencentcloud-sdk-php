 ...
 * @method array getInstanceCLSDeliveryInfos() 获取实例投递信息

 * @method void setInstanceCLSDeliveryInfos(array $InstanceCLSDeliveryInfos) 设置实例投递信息
...
class DescribeInstanceCLSLogDeliveryResponse extends AbstractModel
{
     ...
     * @param array $InstanceCLSDeliveryInfos 实例投递信息

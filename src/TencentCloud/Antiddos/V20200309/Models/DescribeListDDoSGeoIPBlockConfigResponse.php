 ...
 * @method array getConfigList() 获取DDoS区域封禁配置列表
 * @method void setConfigList(array $ConfigList) 设置DDoS区域封禁配置列表
...
class DescribeListDDoSGeoIPBlockConfigResponse extends AbstractModel
{
     ...
     * @param array $ConfigList DDoS区域封禁配置列表
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ConfigList",$param) and $param["ConfigList"] !== null) {
            ...
            foreach ($param["ConfigList"] as $key => $value){
                $obj = new DDoSGeoIPBlockConfigRelation();

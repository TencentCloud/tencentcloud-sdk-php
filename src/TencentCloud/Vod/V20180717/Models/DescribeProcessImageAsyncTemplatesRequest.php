 ...
 * @method array getDefinitions() 获取图片异步处理模板唯一标识过滤条件，数组长度最大值：100。
 * @method void setDefinitions(array $Definitions) 设置图片异步处理模板唯一标识过滤条件，数组长度最大值：100。
 ...
 */
class DescribeProcessImageAsyncTemplatesRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var array 图片异步处理模板唯一标识过滤条件，数组长度最大值：100。
     */
    public $Definitions;
     ...
     * @param array $Definitions 图片异步处理模板唯一标识过滤条件，数组长度最大值：100。

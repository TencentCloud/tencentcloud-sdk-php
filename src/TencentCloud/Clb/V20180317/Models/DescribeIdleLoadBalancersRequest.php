 ...
 * @method string getLoadBalancerRegion() 获取负载均衡所在地域，可以通过 [DescribeRegions](https://cloud.tencent.com/document/product/1596/77930) 查询获取。
 * @method void setLoadBalancerRegion(string $LoadBalancerRegion) 设置负载均衡所在地域，可以通过 [DescribeRegions](https://cloud.tencent.com/document/product/1596/77930) 查询获取。
 */
class DescribeIdleLoadBalancersRequest extends AbstractModel
{
    ...
    /**
     * @var string 负载均衡所在地域，可以通过 [DescribeRegions](https://cloud.tencent.com/document/product/1596/77930) 查询获取。
     */
     ...
     * @param string $LoadBalancerRegion 负载均衡所在地域，可以通过 [DescribeRegions](https://cloud.tencent.com/document/product/1596/77930) 查询获取。
     */

 ...
 * AI配音外部翻译字幕信息
 *
 * @method MediaInputInfo getDstSubtitleInfo() 获取<p>外部翻译字幕信息。</p>
 * @method void setDstSubtitleInfo(MediaInputInfo $DstSubtitleInfo) 设置<p>外部翻译字幕信息。</p>
 */
class DstSubtitleInput extends AbstractModel
{
    /**
     * @var MediaInputInfo <p>外部翻译字幕信息。</p>
     */
    public $DstSubtitleInfo;

    /**
     * @param MediaInputInfo $DstSubtitleInfo <p>外部翻译字幕信息。</p>
     */

 ...
 * @method integer getPolicyVersion() 获取路由接收策略版本号。
 * @method void setPolicyVersion(integer $PolicyVersion) 设置路由接收策略版本号。
 */
class DescribeCcnRouteTableInputPolicysRequest extends AbstractModel
{
    /**
     * @var string 云联网ID。
     */
     ...
     * @param integer $PolicyVersion 路由接收策略版本号。
     */

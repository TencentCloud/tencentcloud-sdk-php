 ...
 * @method array getDimensions() 获取需要绑定的对象维度信息，当为实例绑定渠道时，此处为必填信息
 * @method void setDimensions(array $Dimensions) 设置需要绑定的对象维度信息，当为实例绑定渠道时，此处为必填信息
...
class BindingPolicyObjectRequest extends AbstractModel
{
    ...
    /**
     * @var array 需要绑定的对象维度信息，当为实例绑定渠道时，此处为必填信息
     */
    public $Dimensions;
     ...
     * @param array $Dimensions 需要绑定的对象维度信息，当为实例绑定渠道时，此处为必填信息

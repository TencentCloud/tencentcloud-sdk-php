 ...
 *
 * @method integer getLimit() 获取限额
 * @method void setLimit(integer $Limit) 设置限额
 * @method array getExtraInfos() 获取详细信息
 * @method void setExtraInfos(array $ExtraInfos) 设置详细信息
...
class DescribeInstanceLimitResponse extends AbstractModel
{
    ...
    /**
     * @param integer $Limit 限额
     * @param array $ExtraInfos 详细信息

 ...
 * @method array getDispenseConditions() 获取转发过滤条件信息
 * @method void setDispenseConditions(array $DispenseConditions) 设置转发过滤条件信息
 */
class CreateDispenseExternalRuleRequest extends AbstractModel
{
    /**
     * @var string 规则名称
     */
     ...
     * @param array $DispenseConditions 转发过滤条件信息
     */

 ...
 *
 * @method array getFireInstanceIdList() 获取实例列表
 * @method void setFireInstanceIdList(array $FireInstanceIdList) 设置实例列表
 ...
 */
class MarkTimerTaskRunLogReadRequest extends AbstractModel
{
    /**
     * @var array 实例列表
     */
    public $FireInstanceIdList;
    ...
    /**
     * @param array $FireInstanceIdList 实例列表
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("FireInstanceIdList",$param) and $param["FireInstanceIdList"] !== null) {
            $this->FireInstanceIdList = $param["FireInstanceIdList"];
        }

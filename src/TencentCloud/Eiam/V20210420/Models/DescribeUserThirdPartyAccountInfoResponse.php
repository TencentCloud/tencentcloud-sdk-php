 ...
 * @method array getThirdPartyAccounts() 获取三方账号的绑定情况。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setThirdPartyAccounts(array $ThirdPartyAccounts) 设置三方账号的绑定情况。
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param array $ThirdPartyAccounts 三方账号的绑定情况。
注意：此字段可能返回 null，表示取不到有效值。

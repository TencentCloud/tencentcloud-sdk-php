 ...
 *
 * @method string getDnsRecordId() 获取DNS解析记录ID。
 * @method void setDnsRecordId(string $DnsRecordId) 设置DNS解析记录ID。
...
class CreateDnsRecordResponse extends AbstractModel
{
    ...
    /**
     * @param string $DnsRecordId DNS解析记录ID。

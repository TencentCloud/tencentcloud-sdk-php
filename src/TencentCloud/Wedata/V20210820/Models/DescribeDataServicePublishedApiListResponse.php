 ...
 * @method array getDataSet() 获取服务列表
 * @method void setDataSet(array $DataSet) 设置服务列表
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeDataServicePublishedApiListResponse extends AbstractModel
{
    /**
     * @var integer 总条数
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("DataSet",$param) and $param["DataSet"] !== null) {
            ...
            foreach ($param["DataSet"] as $key => $value){
                $obj = new DescribeDataServicePublishedApiListResp();

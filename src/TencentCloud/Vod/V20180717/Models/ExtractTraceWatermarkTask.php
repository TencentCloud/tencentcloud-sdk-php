 ...
 * @method ExtractTraceWatermarkTaskInput getInput() 获取提取溯源水印任务输入信息。
 * @method void setInput(ExtractTraceWatermarkTaskInput $Input) 设置提取溯源水印任务输入信息。
 * @method ExtractTraceWatermarkTaskOutput getOutput() 获取提取溯源水印任务输出信息。
 * @method void setOutput(ExtractTraceWatermarkTaskOutput $Output) 设置提取溯源水印任务输出信息。
...
<li>70000：内部服务错误，建议重试。</li>
    ...
    /**
     * @var ExtractTraceWatermarkTaskInput 提取溯源水印任务输入信息。
     */
    public $Input;

    /**
     * @var ExtractTraceWatermarkTaskOutput 提取溯源水印任务输出信息。
     */
    public $Output;
...
<li>70000：内部服务错误，建议重试。</li>
     ...
     * @param ExtractTraceWatermarkTaskInput $Input 提取溯源水印任务输入信息。
     * @param ExtractTraceWatermarkTaskOutput $Output 提取溯源水印任务输出信息。

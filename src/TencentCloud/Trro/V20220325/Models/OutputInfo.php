 ...
 * @method string getKey() 获取<p>输出文件路径，如 output/result.json</p>
 * @method void setKey(string $Key) 设置<p>输出文件路径，如 output/result.json</p>
 * @method SecretInfo getSecret() 获取<p>访问凭证，需对该桶有写入权限</p>
 * @method void setSecret(SecretInfo $Secret) 设置<p>访问凭证，需对该桶有写入权限</p>
 */
class OutputInfo extends AbstractModel
{
    ...
    /**
     * @var string <p>输出文件路径，如 output/result.json</p>
     */
    public $Key;

    /**
     * @var SecretInfo <p>访问凭证，需对该桶有写入权限</p>
     */
    public $Secret;
     ...
     * @param string $Key <p>输出文件路径，如 output/result.json</p>
     * @param SecretInfo $Secret <p>访问凭证，需对该桶有写入权限</p>
     */

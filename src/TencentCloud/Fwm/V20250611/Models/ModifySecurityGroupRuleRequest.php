 ...
 * @method SecurityGroupRule getRule() 获取规则
 * @method void setRule(SecurityGroupRule $Rule) 设置规则
 */
class ModifySecurityGroupRuleRequest extends AbstractModel
{
    ...
    /**
     * @var SecurityGroupRule 规则
     */
    public $Rule;

    /**
     * @param string $GroupId 规则组ID
     * @param SecurityGroupRule $Rule 规则
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Rule",$param) and $param["Rule"] !== null) {
            $this->Rule = new SecurityGroupRule();

...
/**
 * @method Models\CreatePrefetchTaskResponse CreatePrefetchTask(Models\CreatePrefetchTaskRequest $req) 老版本接口，最近一次调用时23年11月了

创建预热任务
 * @method Models\CreatePurgeTaskResponse CreatePurgeTask(Models\CreatePurgeTaskRequest $req) 老版本接口，老版本pod的最近一次调用在23年11月

 ...
 * @method string getLabImage() 获取<p>实验室镜像地址</p>
 * @method void setLabImage(string $LabImage) 设置<p>实验室镜像地址</p>
 ...
 */
class ExampleEntity extends AbstractModel
{
    /**
     * @var integer <p>ID</p>
     */
     ...
     * @param string $LabImage <p>实验室镜像地址</p>

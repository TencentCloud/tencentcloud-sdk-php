 ...
 * @method string getBackupMethod() 获取备份方式。枚举值，physical - 物理备份；logical - 逻辑备份。
 * @method void setBackupMethod(string $BackupMethod) 设置备份方式。枚举值，physical - 物理备份；logical - 逻辑备份。
 * @method string getBackupMode() 获取备份模式。枚举值，manual - 手动备份；automatic - 自动备份 。
 * @method void setBackupMode(string $BackupMode) 设置备份模式。枚举值，manual - 手动备份；automatic - 自动备份 。
...
class LogBackup extends AbstractModel
{
    ...
    /**
     * @var string 备份方式。枚举值，physical - 物理备份；logical - 逻辑备份。
     */
    public $BackupMethod;

    /**
     * @var string 备份模式。枚举值，manual - 手动备份；automatic - 自动备份 。
     */
    public $BackupMode;
     ...
     * @param string $BackupMethod 备份方式。枚举值，physical - 物理备份；logical - 逻辑备份。
     * @param string $BackupMode 备份模式。枚举值，manual - 手动备份；automatic - 自动备份 。

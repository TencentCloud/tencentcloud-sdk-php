...
* @method Models\ModifyEventNotificationConfigForConsoleResponse ModifyEventNotificationConfigForConsole(Models\ModifyEventNotificationConfigForConsoleRequest $req) 腾讯云点播为客户提供了媒体上传、媒体管理、媒体处理等等服务，在这些服务执行过程或执行结束时，腾讯云点播也提供各种对应的事件通知，方便开发者感知服务处理状态，并做下一步的业务操作。

 ...
 * @method UpdateTriggerTaskPart getNewSetting() 获取任务基本属性
 * @method void setNewSetting(UpdateTriggerTaskPart $NewSetting) 设置任务基本属性
...
class UpdateTriggerTaskPartiallyRequest extends AbstractModel
{
    ...
    /**
     * @var UpdateTriggerTaskPart 任务基本属性
     */
    public $NewSetting;
     ...
     * @param UpdateTriggerTaskPart $NewSetting 任务基本属性

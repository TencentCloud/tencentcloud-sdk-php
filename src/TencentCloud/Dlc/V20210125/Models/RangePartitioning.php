 ...
 * @method array getAssignments() 获取<p>分区信息</p>
 * @method void setAssignments(array $Assignments) 设置<p>分区信息</p>
 */
class RangePartitioning extends AbstractModel
{
    /**
     * @var string <p>字段名</p>
     */
     ...
     * @param array $Assignments <p>分区信息</p>
     */

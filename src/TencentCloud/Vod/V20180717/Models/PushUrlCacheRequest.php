 ...
 * PushUrlCache请求参数结构体
 *
 * @method array getUrls() 获取<p>预热的 URL 列表，单次最多指定20个 URL。</p>
 * @method void setUrls(array $Urls) 设置<p>预热的 URL 列表，单次最多指定20个 URL。</p>
...
{
    /**
     * @var array <p>预热的 URL 列表，单次最多指定20个 URL。</p>
     */
    public $Urls;
    ...
    /**
     * @param array $Urls <p>预热的 URL 列表，单次最多指定20个 URL。</p>

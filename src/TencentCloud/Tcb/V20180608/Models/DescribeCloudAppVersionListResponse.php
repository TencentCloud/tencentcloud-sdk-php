 ...
 *
 * @method array getVersionList() 获取<p>版本列表</p>
 * @method void setVersionList(array $VersionList) 设置<p>版本列表</p>
 ...
 */
class DescribeCloudAppVersionListResponse extends AbstractModel
{
    /**
     * @var array <p>版本列表</p>
     */
    ...
    /**
     * @param array $VersionList <p>版本列表</p>

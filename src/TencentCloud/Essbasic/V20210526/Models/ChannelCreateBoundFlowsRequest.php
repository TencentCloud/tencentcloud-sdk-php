...
第三方平台子客企业和员工必须已经经过实名认证,  合同会领取给对应的Agent.ProxyOperator.OpenId指定的员工来处理
 * @method array getFlowIds() 获取需要领取的合同流程的ID列表
 * @method void setFlowIds(array $FlowIds) 设置需要领取的合同流程的ID列表
...
第三方平台子客企业和员工必须已经经过实名认证,  合同会领取给对应的Agent.ProxyOperator.OpenId指定的员工来处理
     * @param array $FlowIds 需要领取的合同流程的ID列表

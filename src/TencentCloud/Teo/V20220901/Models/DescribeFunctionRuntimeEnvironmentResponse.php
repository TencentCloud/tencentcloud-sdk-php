 ...
 *
 * @method array getEnvironmentVariables() 获取环境变量列表。
 * @method void setEnvironmentVariables(array $EnvironmentVariables) 设置环境变量列表。
...
class DescribeFunctionRuntimeEnvironmentResponse extends AbstractModel
{
    ...
    /**
     * @param array $EnvironmentVariables 环境变量列表。

 ...
 * @method integer getPageNum() 获取页码（从1开始）
 * @method void setPageNum(integer $PageNum) 设置页码（从1开始）
 */
class GetPaginationTaskScriptRequest extends AbstractModel
{
    /**
     * @var string 项目编号
     */

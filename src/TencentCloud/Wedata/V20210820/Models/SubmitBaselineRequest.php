 ...
 *
 * @method string getBaselineId() 获取1
 * @method void setBaselineId(string $BaselineId) 设置1
 * @method string getProjectId() 获取1
 * @method void setProjectId(string $ProjectId) 设置1
 */
class SubmitBaselineRequest extends AbstractModel
{
    /**
     * @var string 1
     */

 ...
 * @method array getData() 获取风险列表
 * @method void setData(array $Data) 设置风险列表
 ...
 * @method array getPasswordTypeLists() 获取弱口令类型列表
 * @method void setPasswordTypeLists(array $PasswordTypeLists) 设置弱口令类型列表

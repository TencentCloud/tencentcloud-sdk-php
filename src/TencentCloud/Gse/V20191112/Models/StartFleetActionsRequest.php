 ...
 * @method array getActions() 获取扩展策略，为空或者AUTO_SCALING
 * @method void setActions(array $Actions) 设置扩展策略，为空或者AUTO_SCALING
 */
class StartFleetActionsRequest extends AbstractModel
{
    ...
    /**
     * @var array 扩展策略，为空或者AUTO_SCALING
     */
    public $Actions;

    /**
     * @param string $FleetId 服务器舰队 Id
     * @param array $Actions 扩展策略，为空或者AUTO_SCALING
     */

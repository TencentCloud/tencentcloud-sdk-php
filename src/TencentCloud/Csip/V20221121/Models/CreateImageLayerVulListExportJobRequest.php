 ...
 * @method string getId() 获取<p>layer id</p>
 * @method void setId(string $Id) 设置<p>layer id</p>
 ...
 * @method string getExportName() 获取<p>导出文件名</p>
 * @method void setExportName(string $ExportName) 设置<p>导出文件名</p>
 */
class CreateImageLayerVulListExportJobRequest extends AbstractModel
{
    /**

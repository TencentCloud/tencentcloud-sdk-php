 ...
 * @method boolean getExactMatch() 获取是否模糊查询。默认为是。
 * @method void setExactMatch(boolean $ExactMatch) 设置是否模糊查询。默认为是。
 */
class ComplianceFilters extends AbstractModel
{
     ...
     * @param boolean $ExactMatch 是否模糊查询。默认为是。
     */

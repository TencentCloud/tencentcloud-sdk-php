 ...
 * @method Models\CreateAddressUnsubscribeConfigResponse CreateAddressUnsubscribeConfig(Models\CreateAddressUnsubscribeConfigRequest $req) 创建地址级退订配置
 * @method Models\CreateCustomBlacklistResponse CreateCustomBlacklist(Models\CreateCustomBlacklistRequest $req) 添加自定义黑名单
 ...
 * @method Models\DeleteAddressUnsubscribeConfigResponse DeleteAddressUnsubscribeConfig(Models\DeleteAddressUnsubscribeConfigRequest $req) 删除地址级退订配置
 ...
 * @method Models\ListAddressUnsubscribeConfigResponse ListAddressUnsubscribeConfig(Models\ListAddressUnsubscribeConfigRequest $req) 获取地址级退订配置列表
 ...
 * @method Models\ListCustomBlacklistResponse ListCustomBlacklist(Models\ListCustomBlacklistRequest $req) 获取自定义黑名单列表
 ...
 * @method Models\UpdateAddressUnsubscribeConfigResponse UpdateAddressUnsubscribeConfig(Models\UpdateAddressUnsubscribeConfigRequest $req) 用于更新地址级退订配置
 * @method Models\UpdateCustomBlackListResponse UpdateCustomBlackList(Models\UpdateCustomBlackListRequest $req) 更新自定义黑名单

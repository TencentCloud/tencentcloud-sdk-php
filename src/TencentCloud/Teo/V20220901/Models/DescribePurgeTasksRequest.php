...
必填参数。
 * @method string getStartTime() 获取查询起始时间，时间与job-id必填一个。
 * @method void setStartTime(string $StartTime) 设置查询起始时间，时间与job-id必填一个。
 * @method string getEndTime() 获取查询结束时间，时间与job-id必填一个。
 * @method void setEndTime(string $EndTime) 设置查询结束时间，时间与job-id必填一个。
...
必填参数。
    ...
    /**
     * @var string 查询起始时间，时间与job-id必填一个。
     */
    public $StartTime;

    /**
     * @var string 查询结束时间，时间与job-id必填一个。
     */
    public $EndTime;
...
必填参数。
     * @param string $StartTime 查询起始时间，时间与job-id必填一个。
     * @param string $EndTime 查询结束时间，时间与job-id必填一个。

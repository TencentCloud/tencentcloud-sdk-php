 ...
 *
 * @method array getDataInfoList() 获取时移计费明细数据。
 * @method void setDataInfoList(array $DataInfoList) 设置时移计费明细数据。
...
class DescribeLiveTimeShiftBillInfoListResponse extends AbstractModel
{
    ...
    /**
     * @param array $DataInfoList 时移计费明细数据。

 ...
 * @method AiReviewPoliticalOcrTaskInput getInput() 获取智能识别 Ocr 文字涉及令人不适宜信息的任务输入。
 * @method void setInput(AiReviewPoliticalOcrTaskInput $Input) 设置智能识别 Ocr 文字涉及令人不适宜信息的任务输入。
 * @method AiReviewPoliticalOcrTaskOutput getOutput() 获取智能识别 Ocr 文字涉及令人不适宜信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewPoliticalOcrTaskOutput $Output) 设置智能识别 Ocr 文字涉及令人不适宜信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiReviewTaskPoliticalOcrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPoliticalOcrTaskInput 智能识别 Ocr 文字涉及令人不适宜信息的任务输入。
     */
    public $Input;

    /**
     * @var AiReviewPoliticalOcrTaskOutput 智能识别 Ocr 文字涉及令人不适宜信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiReviewPoliticalOcrTaskInput $Input 智能识别 Ocr 文字涉及令人不适宜信息的任务输入。
     * @param AiReviewPoliticalOcrTaskOutput $Output 智能识别 Ocr 文字涉及令人不适宜信息的任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

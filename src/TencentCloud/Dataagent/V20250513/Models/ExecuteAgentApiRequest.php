 ...
 * @method string getRequestData() 获取<p>参数值</p>
 * @method void setRequestData(string $RequestData) 设置<p>参数值</p>
 ...
 */
class ExecuteAgentApiRequest extends AbstractModel
{
    /**
     * @var string <p>参数路径</p>
     */
     ...
     * @param string $RequestData <p>参数值</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("RequestData",$param) and $param["RequestData"] !== null) {
            $this->RequestData = $param["RequestData"];
        }

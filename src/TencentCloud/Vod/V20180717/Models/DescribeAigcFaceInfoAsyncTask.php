 ...
 * @method string getErrCodeExt() 获取<p>扩展错误码。</p><p>参数格式：扩展错误码。</p><p>枚举值：</p><ul><li>RequestLimitExceeded： 调用超出并发限制。</li><li>InvalidParameterValue： 参数错误。</li><li>InternalError： 内部错误。</li><li>FailedOperation： 操作失败。</li></ul>
 * @method void setErrCodeExt(string $ErrCodeExt) 设置<p>扩展错误码。</p><p>参数格式：扩展错误码。</p><p>枚举值：</p><ul><li>RequestLimitExceeded： 调用超出并发限制。</li><li>InvalidParameterValue： 参数错误。</li><li>InternalError： 内部错误。</li><li>FailedOperation： 操作失败。</li></ul>
 ...
 * @method DescribeAigcFaceInfoAsyncInput getInput() 获取<p>异步获取 AIGC 人脸信息任务的输入信息。</p>
 * @method void setInput(DescribeAigcFaceInfoAsyncInput $Input) 设置<p>异步获取 AIGC 人脸信息任务的输入信息。</p>
 * @method DescribeAigcFaceInfoAsyncOutput getOutput() 获取<p>异步获取 AIGC 人脸信息任务的输出信息。</p>
 * @method void setOutput(DescribeAigcFaceInfoAsyncOutput $Output) 设置<p>异步获取 AIGC 人脸信息任务的输出信息。</p>
...
class DescribeAigcFaceInfoAsyncTask extends AbstractModel
{
    ...
    /**
     * @var string <p>扩展错误码。</p><p>参数格式：扩展错误码。</p><p>枚举值：</p><ul><li>RequestLimitExceeded： 调用超出并发限制。</li><li>InvalidParameterValue： 参数错误。</li><li>InternalError： 内部错误。</li><li>FailedOperation： 操作失败。</li></ul>
     */
    public $ErrCodeExt;
    ...
    /**
     * @var DescribeAigcFaceInfoAsyncInput <p>异步获取 AIGC 人脸信息任务的输入信息。</p>
     */
    public $Input;

    /**
     * @var DescribeAigcFaceInfoAsyncOutput <p>异步获取 AIGC 人脸信息任务的输出信息。</p>
     */
    public $Output;
     ...
     * @param string $ErrCodeExt <p>扩展错误码。</p><p>参数格式：扩展错误码。</p><p>枚举值：</p><ul><li>RequestLimitExceeded： 调用超出并发限制。</li><li>InvalidParameterValue： 参数错误。</li><li>InternalError： 内部错误。</li><li>FailedOperation： 操作失败。</li></ul>
     * @param string $Message <p>错误信息。</p>
     * @param integer $Progress <p>任务进度，取值范围 [0-100] 。</p>
     * @param DescribeAigcFaceInfoAsyncInput $Input <p>异步获取 AIGC 人脸信息任务的输入信息。</p>
     * @param DescribeAigcFaceInfoAsyncOutput $Output <p>异步获取 AIGC 人脸信息任务的输出信息。</p>

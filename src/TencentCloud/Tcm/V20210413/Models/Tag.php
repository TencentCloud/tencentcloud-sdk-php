 ...
 * @method boolean getPassthrough() 获取是否透传给其他关联产品
 * @method void setPassthrough(boolean $Passthrough) 设置是否透传给其他关联产品
 */
class Tag extends AbstractModel
{
     ...
     * @param boolean $Passthrough 是否透传给其他关联产品
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Passthrough",$param) and $param["Passthrough"] !== null) {
            $this->Passthrough = $param["Passthrough"];
        }
    }
}

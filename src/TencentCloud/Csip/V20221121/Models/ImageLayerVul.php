 ...
 * @method integer getID() 获取<p>漏洞记录id</p>
 * @method void setID(integer $ID) 设置<p>漏洞记录id</p>
 ...
 */
class ImageLayerVul extends AbstractModel
{
    /**

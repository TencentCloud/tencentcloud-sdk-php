 ...
 * @method boolean getIsKickout() 获取是否开始延迟剔除，默认false，取值："true" | "false"
 * @method void setIsKickout(boolean $IsKickout) 设置是否开始延迟剔除，默认false，取值："true" | "false"
 * @method integer getMinCount() 获取最少保留数，最小为0，最大为实例数量
 * @method void setMinCount(integer $MinCount) 设置最少保留数，最小为0，最大为实例数量
 ...
 * @method boolean getFailOver() 获取是否开启故障转移，代理出现故障后，连接地址将路由到主实例，默认false，取值："true" | "false"
 * @method void setFailOver(boolean $FailOver) 设置是否开启故障转移，代理出现故障后，连接地址将路由到主实例，默认false，取值："true" | "false"
 * @method boolean getAutoAddRo() 获取是否自动添加只读实例，默认false，取值："true" | "false"
 * @method void setAutoAddRo(boolean $AutoAddRo) 设置是否自动添加只读实例，默认false，取值："true" | "false"
 */
class ModifyCDBProxyRequest extends AbstractModel
{
    ...
    /**
     * @var boolean 是否开始延迟剔除，默认false，取值："true" | "false"
     */
    public $IsKickout;

    /**
     * @var integer 最少保留数，最小为0，最大为实例数量
     */
    public $MinCount;
    ...
    /**
     * @var boolean 是否开启故障转移，代理出现故障后，连接地址将路由到主实例，默认false，取值："true" | "false"
     */
    public $FailOver;

    /**
     * @var boolean 是否自动添加只读实例，默认false，取值："true" | "false"
     */
    public $AutoAddRo;

    /**
     * @param string $ProxyGroupId 数据库代理组唯一ID
     * @param boolean $IsKickout 是否开始延迟剔除，默认false，取值："true" | "false"
     * @param integer $MinCount 最少保留数，最小为0，最大为实例数量
     ...
     * @param boolean $FailOver 是否开启故障转移，代理出现故障后，连接地址将路由到主实例，默认false，取值："true" | "false"
     * @param boolean $AutoAddRo 是否自动添加只读实例，默认false，取值："true" | "false"
     */

 ...
 * GetTagValues请求参数结构体
 *
 * @method array getTagKeys() 获取<p>标签键。返回所有标签键列表对应的标签值。最大长度：20</p>
 * @method void setTagKeys(array $TagKeys) 设置<p>标签键。返回所有标签键列表对应的标签值。最大长度：20</p>
...
{
    /**
     * @var array <p>标签键。返回所有标签键列表对应的标签值。最大长度：20</p>
     */
    public $TagKeys;
    ...
    /**
     * @param array $TagKeys <p>标签键。返回所有标签键列表对应的标签值。最大长度：20</p>

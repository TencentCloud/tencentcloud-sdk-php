 ...
 * @method string getName() 获取<p>自定义响应页面名称，名称为 2 - 60 个字符。</p>
 * @method void setName(string $Name) 设置<p>自定义响应页面名称，名称为 2 - 60 个字符。</p>
 * @method string getDescription() 获取<p>自定义响应页面描述，描述内容不超过 60 个字符。</p>
 * @method void setDescription(string $Description) 设置<p>自定义响应页面描述，描述内容不超过 60 个字符。</p>
...
class ModifyCustomErrorPageRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>自定义响应页面名称，名称为 2 - 60 个字符。</p>
     */
    public $Name;

    /**
     * @var string <p>自定义响应页面描述，描述内容不超过 60 个字符。</p>
     */
    public $Description;
     ...
     * @param string $Name <p>自定义响应页面名称，名称为 2 - 60 个字符。</p>
     * @param string $Description <p>自定义响应页面描述，描述内容不超过 60 个字符。</p>

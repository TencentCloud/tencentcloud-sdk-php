 ...
 *
 * @method array getCategoryList() 获取<p>分类列表</p>
 * @method void setCategoryList(array $CategoryList) 设置<p>分类列表</p>
 ...
 */
class DescribeCategoryListResponse extends AbstractModel
{
    /**
     * @var array <p>分类列表</p>
     */
    ...
    /**
     * @param array $CategoryList <p>分类列表</p>

...
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getClassificationId() 获取规则内的功能分类Id。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setClassificationId(integer $ClassificationId) 设置规则内的功能分类Id。
注意：此字段可能返回 null，表示取不到有效值。
 * @method string getStatus() 获取规则当前所属动作状态。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setStatus(string $Status) 设置规则当前所属动作状态。
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var integer 规则内的功能分类Id。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $ClassificationId;

    /**
     * @var string 规则当前所属动作状态。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Status;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $ClassificationId 规则内的功能分类Id。
注意：此字段可能返回 null，表示取不到有效值。
     * @param string $Status 规则当前所属动作状态。
注意：此字段可能返回 null，表示取不到有效值。
     */

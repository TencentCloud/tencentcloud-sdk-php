 ...
 * @method integer getEndTime() 获取<p>投递时间范围的结束时间。 如果为空，则表示不限时</p>
 * @method void setEndTime(integer $EndTime) 设置<p>投递时间范围的结束时间。 如果为空，则表示不限时</p>
...
class ModifyDlcDeliverRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>投递时间范围的结束时间。 如果为空，则表示不限时</p>
     */
    public $EndTime;
    ...
    /**
     * @var integer <p>任务状态。</p><p>枚举值：</p><ul><li>1： 运行</li><li>2： 停止</li></ul>
     */
    public $Status;
     ...
     * @param integer $EndTime <p>投递时间范围的结束时间。 如果为空，则表示不限时</p>

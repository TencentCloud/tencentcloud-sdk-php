 ...
 *
 * @method string getAddressTemplateId() 获取IP地址实例ID。例如：ipm-12345678。
 * @method void setAddressTemplateId(string $AddressTemplateId) 设置IP地址实例ID。例如：ipm-12345678。
...
{
    /**
     * @var string IP地址实例ID。例如：ipm-12345678。
     */
    ...
    /**
     * @param string $AddressTemplateId IP地址实例ID。例如：ipm-12345678。

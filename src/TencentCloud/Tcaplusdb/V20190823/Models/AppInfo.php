 ...
 * @method string getIdlType() 获取数据描述语言类型，如：`PROTO`,`TDR`或`MIX`
 * @method void setIdlType(string $IdlType) 设置数据描述语言类型，如：`PROTO`,`TDR`或`MIX`
 * @method string getNetworkType() 获取网络类型
 * @method void setNetworkType(string $NetworkType) 设置网络类型
 * @method string getVpcId() 获取关联的用户私有网络实例ID
 * @method void setVpcId(string $VpcId) 设置关联的用户私有网络实例ID
 * @method string getSubnetId() 获取关联的用户子网实例ID
 * @method void setSubnetId(string $SubnetId) 设置关联的用户子网实例ID
 * @method string getCreatedTime() 获取创建时间
 * @method void setCreatedTime(string $CreatedTime) 设置创建时间
 * @method string getPassword() 获取应用密码
 * @method void setPassword(string $Password) 设置应用密码
...
class AppInfo extends AbstractModel
{
    ...
    /**
     * @var string 数据描述语言类型，如：`PROTO`,`TDR`或`MIX`
     */
    public $IdlType;
    ...
    /**
     * @var string 关联的用户私有网络实例ID
     */
    public $VpcId;

    /**
     * @var string 关联的用户子网实例ID
     */
    public $SubnetId;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param string $IdlType 数据描述语言类型，如：`PROTO`,`TDR`或`MIX`
     * @param string $NetworkType 网络类型
     * @param string $VpcId 关联的用户私有网络实例ID
     * @param string $SubnetId 关联的用户子网实例ID

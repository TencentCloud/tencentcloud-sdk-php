 ...
 * @method Models\ReportFeedBehaviorResponse ReportFeedBehavior(Models\ReportFeedBehaviorRequest $req) 上报场景内的行为数据，随着数据的积累，模型的效果会逐渐稳定。
 * @method Models\ReportFeedItemResponse ReportFeedItem(Models\ReportFeedItemRequest $req) 上报被用于推荐的信息流内容
 * @method Models\ReportFeedUserResponse ReportFeedUser(Models\ReportFeedUserRequest $req) 上报用户信息，请务必确认用户的唯一性，并在请求推荐结果时指定用户的唯一标识信息（UserId），否则将无法进行千人千面的推荐
 */

...
class ConvertOperatingSystemsResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("SupportTargetOSList",$param) and $param["SupportTargetOSList"] !== null) {
            $this->SupportTargetOSList = [];
            foreach ($param["SupportTargetOSList"] as $key => $value){
                $obj = new TargetOS();
                $obj->deserialize($value);
                array_push($this->SupportTargetOSList, $obj);
            }
        }

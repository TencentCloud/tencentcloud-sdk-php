 ...
 * @method string getToolVersion() 获取<p>mcp tool版本id</p>
 * @method void setToolVersion(string $ToolVersion) 设置<p>mcp tool版本id</p>
 */
class CheckCloudNativeAPIGatewayMCPToolVersionExistRequest extends AbstractModel
{
    /**
     ...
     * @param string $ToolVersion <p>mcp tool版本id</p>
     */

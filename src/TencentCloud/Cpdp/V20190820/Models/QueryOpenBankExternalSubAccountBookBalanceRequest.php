...
__OPENBANK_PAYMENT__: openbank支付
__SAFT_ISV__: 安心发支付
 * @method string getOutAccountBookId() 获取外部账本号ID。与ChannelAccountBookId二者选填其一。
...
__SAFT_ISV__: 安心发支付
    ...
    /**
     * @var string 外部账本号ID。与ChannelAccountBookId二者选填其一。
     */
    public $OutAccountBookId;

    /**
     * @var string 渠道账本号ID。与OutAccountBookId二者选填其一。
     */

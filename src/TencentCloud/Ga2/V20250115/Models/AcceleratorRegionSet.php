 ...
 * 可加速地域信息
 *
 * @method string getName() 获取<p>地域名称。</p>
 * @method void setName(string $Name) 设置<p>地域名称。</p>
 ...
 * @method integer getIsChinaMainland() 获取<p>是否中国地域。1 代表是中国地域，0代表不是中国地域。</p>
 * @method void setIsChinaMainland(integer $IsChinaMainland) 设置<p>是否中国地域。1 代表是中国地域，0代表不是中国地域。</p>
 * @method array getSupportIspType() 获取<p>支持IspType类型。</p>
 * @method void setSupportIspType(array $SupportIspType) 设置<p>支持IspType类型。</p>
 * @method integer getIsTencentRegion() 获取<p>是否腾讯云地域。1代表是腾讯云地域，0代表不是。</p>
 * @method void setIsTencentRegion(integer $IsTencentRegion) 设置<p>是否腾讯云地域。1代表是腾讯云地域，0代表不是。</p>
 */
class AcceleratorRegionSet extends AbstractModel
{
    ...
    /**
     * @var integer <p>是否中国地域。1 代表是中国地域，0代表不是中国地域。</p>
     */
    ...
    /**
     * @var integer <p>是否腾讯云地域。1代表是腾讯云地域，0代表不是。</p>
     */
    public $IsTencentRegion;

    /**
     * @param string $Name <p>地域名称。</p>
     * @param integer $IsAvailable <p>是否可用；0：不可用，1:可用。</p>
     * @param string $Region <p>地域。</p>
     * @param string $AreaName <p>地区名称。</p>
     * @param integer $IsChinaMainland <p>是否中国地域。1 代表是中国地域，0代表不是中国地域。</p>
     * @param array $SupportIspType <p>支持IspType类型。</p>
     * @param integer $IsTencentRegion <p>是否腾讯云地域。1代表是腾讯云地域，0代表不是。</p>
     */

 ...
 * @method array getComponentList() 获取<p>资产组件信息列表</p>
 * @method void setComponentList(array $ComponentList) 设置<p>资产组件信息列表</p>
...
class DescribeAssetComponentListResponse extends AbstractModel
{
     ...
     * @param array $ComponentList <p>资产组件信息列表</p>

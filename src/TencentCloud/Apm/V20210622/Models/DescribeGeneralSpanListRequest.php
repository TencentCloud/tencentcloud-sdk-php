 ...
 * @method integer getLimit() 获取<p>单页项目个数，默认为1000，合法取值范围为1～1000</p>
 * @method void setLimit(integer $Limit) 设置<p>单页项目个数，默认为1000，合法取值范围为1～1000</p>
...
class DescribeGeneralSpanListRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>单页项目个数，默认为1000，合法取值范围为1～1000</p>
     */
    public $Limit;
     ...
     * @param integer $Limit <p>单页项目个数，默认为1000，合法取值范围为1～1000</p>

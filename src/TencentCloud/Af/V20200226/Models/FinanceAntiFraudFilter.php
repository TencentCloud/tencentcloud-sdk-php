 ...
 * @method string getIdNumber() 获取身份证Id(五选二) 参数详细定义请加微信：TYXGJ-01
 * @method void setIdNumber(string $IdNumber) 设置身份证Id(五选二) 参数详细定义请加微信：TYXGJ-01
 ...
 * @method string getScene() 获取业务场景ID，需要找技术对接
 * @method void setScene(string $Scene) 设置业务场景ID，需要找技术对接
 ...
 * @method string getAccountType() 获取1：关联的腾讯帐号QQ；2：开放帐号微信
 * @method void setAccountType(string $AccountType) 设置1：关联的腾讯帐号QQ；2：开放帐号微信
 * @method string getUid() 获取可选的 QQ 或微信 openid
 * @method void setUid(string $Uid) 设置可选的 QQ 或微信 openid
 * @method string getAppIdU() 获取qq 或微信分配给网站或应用的 appid，用来唯一标识网站或应用
 * @method void setAppIdU(string $AppIdU) 设置qq 或微信分配给网站或应用的 appid，用来唯一标识网站或应用
 ...
 * @method string getBusinessId() 获取业务 ID，在多个业务中使用此服务，通过此ID 区分统计数据
 * @method void setBusinessId(string $BusinessId) 设置业务 ID，在多个业务中使用此服务，通过此ID 区分统计数据
 * @method string getPhoneCryptoType() 获取手机号加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
 * @method void setPhoneCryptoType(string $PhoneCryptoType) 设置手机号加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
 * @method string getIdCryptoType() 获取身份证Id加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
 * @method void setIdCryptoType(string $IdCryptoType) 设置身份证Id加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
 * @method string getNameCryptoType() 获取姓名加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
 * @method void setNameCryptoType(string $NameCryptoType) 设置姓名加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
 */
class FinanceAntiFraudFilter extends AbstractModel
{
    ...
    /**
     * @var string 身份证Id(五选二) 参数详细定义请加微信：TYXGJ-01
     */
    public $IdNumber;
    ...
    /**
     * @var string 1：关联的腾讯帐号QQ；2：开放帐号微信
     */
    public $AccountType;
    ...
    /**
     * @var string qq 或微信分配给网站或应用的 appid，用来唯一标识网站或应用
     */
    public $AppIdU;
    ...
    /**
     * @var string 业务 ID，在多个业务中使用此服务，通过此ID 区分统计数据
     */
    public $BusinessId;

    /**
     * @var string 手机号加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
     */
    public $PhoneCryptoType;

    /**
     * @var string 身份证Id加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
     */
    public $IdCryptoType;

    /**
     * @var string 姓名加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
     */
    public $NameCryptoType;

    /**
     * @param string $PhoneNumber 电话号码(五选二)
     * @param string $IdNumber 身份证Id(五选二) 参数详细定义请加微信：TYXGJ-01
     ...
     * @param string $Scene 业务场景ID，需要找技术对接
     * @param string $Name 姓名
     * @param string $EmailAddress 用户邮箱地址
     * @param string $Address 用户住址
     * @param string $Mac MAC 地址
     * @param string $Imsi 国际移动用户识别码
     * @param string $AccountType 1：关联的腾讯帐号QQ；2：开放帐号微信
     * @param string $Uid 可选的 QQ 或微信 openid
     * @param string $AppIdU qq 或微信分配给网站或应用的 appid，用来唯一标识网站或应用
     * @param string $WifiMac WIFI MAC
     * @param string $WifiSSID WIFI 服务集标识
     * @param string $WifiBSSID WIFI-BSSID
     * @param string $BusinessId 业务 ID，在多个业务中使用此服务，通过此ID 区分统计数据
     * @param string $PhoneCryptoType 手机号加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
     * @param string $IdCryptoType 身份证Id加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
     * @param string $NameCryptoType 姓名加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
     */

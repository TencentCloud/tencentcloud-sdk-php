 ...
 *
 * @method string getAvailableCharSize() 获取所有应用已用的字符总数
 * @method void setAvailableCharSize(string $AvailableCharSize) 设置所有应用已用的字符总数
 * @method array getList() 获取应用饼图详情列表
 * @method void setList(array $List) 设置应用饼图详情列表
...
class DescribeKnowledgeUsagePieGraphResponse extends AbstractModel
{
    ...
    /**
     * @param string $AvailableCharSize 所有应用已用的字符总数
     * @param array $List 应用饼图详情列表

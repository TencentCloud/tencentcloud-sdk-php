 ...
 * @method Models\ParseDocResponse ParseDoc(Models\ParseDocRequest $req) 接口已迁移到新接口了，无调用量

接口即将下线，请切换使用新接口：[文档解析](https://cloud.tencent.com/document/product/1759/107504)
 * @method Models\QueryParseDocResultResponse QueryParseDocResult(Models\QueryParseDocResultRequest $req) 接口已迁移到新接口了，无调用量

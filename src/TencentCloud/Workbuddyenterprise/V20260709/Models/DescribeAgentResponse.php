 ...
 * @method integer getActiveSessionCount() 获取当前活跃 session 数（ACTIVE/CREATING/MIGRATING，未软删）；仅 DescribeAgent 读路径填充，写路径回显不下发
 * @method void setActiveSessionCount(integer $ActiveSessionCount) 设置当前活跃 session 数（ACTIVE/CREATING/MIGRATING，未软删）；仅 DescribeAgent 读路径填充，写路径回显不下发
 ...
 */
class DescribeAgentResponse extends AbstractModel
{
    /**
    ...
    /**
     * @var integer 当前活跃 session 数（ACTIVE/CREATING/MIGRATING，未软删）；仅 DescribeAgent 读路径填充，写路径回显不下发
     */
     ...
     * @param integer $ActiveSessionCount 当前活跃 session 数（ACTIVE/CREATING/MIGRATING，未软删）；仅 DescribeAgent 读路径填充，写路径回显不下发
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ActiveSessionCount",$param) and $param["ActiveSessionCount"] !== null) {
            $this->ActiveSessionCount = $param["ActiveSessionCount"];
        }

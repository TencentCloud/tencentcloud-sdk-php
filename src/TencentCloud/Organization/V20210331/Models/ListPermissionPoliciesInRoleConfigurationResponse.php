 ...
 *
 * @method integer getTotalCounts() 获取权限策略总个数。
 * @method void setTotalCounts(integer $TotalCounts) 设置权限策略总个数。
 * @method array getRolePolicies() 获取权限策略列表。
 * @method void setRolePolicies(array $RolePolicies) 设置权限策略列表。
...
class ListPermissionPoliciesInRoleConfigurationResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCounts 权限策略总个数。
     * @param array $RolePolicies 权限策略列表。

 ...
 * @method AiReviewPoliticalAsrTaskInput getInput() 获取内容审核 Asr 文字敏感任务输入。
 * @method void setInput(AiReviewPoliticalAsrTaskInput $Input) 设置内容审核 Asr 文字敏感任务输入。
 * @method AiReviewPoliticalAsrTaskOutput getOutput() 获取内容审核 Asr 文字敏感任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiReviewPoliticalAsrTaskOutput $Output) 设置内容审核 Asr 文字敏感任务输出。
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiReviewTaskPoliticalAsrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPoliticalAsrTaskInput 内容审核 Asr 文字敏感任务输入。
     */
    public $Input;

    /**
     * @var AiReviewPoliticalAsrTaskOutput 内容审核 Asr 文字敏感任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiReviewPoliticalAsrTaskInput $Input 内容审核 Asr 文字敏感任务输入。
     * @param AiReviewPoliticalAsrTaskOutput $Output 内容审核 Asr 文字敏感任务输出。
注意：此字段可能返回 null，表示取不到有效值。
     */

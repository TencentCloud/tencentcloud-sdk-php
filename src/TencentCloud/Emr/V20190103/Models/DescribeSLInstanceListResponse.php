 ...
 * @method array getInstancesList() 获取实例信息列表，如果进行了分页，只显示当前分页的示例信息列表。
 * @method void setInstancesList(array $InstancesList) 设置实例信息列表，如果进行了分页，只显示当前分页的示例信息列表。
...
class DescribeSLInstanceListResponse extends AbstractModel
{
    ...
    /**
     * @var array 实例信息列表，如果进行了分页，只显示当前分页的示例信息列表。
     */
     ...
     * @param array $InstancesList 实例信息列表，如果进行了分页，只显示当前分页的示例信息列表。

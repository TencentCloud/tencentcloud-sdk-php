 ...
 * AI数据源列表
 *
 * @method array getDataList() 获取<p>MCP服务列表</p>
 * @method void setDataList(array $DataList) 设置<p>MCP服务列表</p>
 * @method integer getTotalCount() 获取<p>总数</p>
 * @method void setTotalCount(integer $TotalCount) 设置<p>总数</p>
 */
class CNAPIGwAIServiceSourceList extends AbstractModel
{
    /**
     * @var array <p>MCP服务列表</p>
     */
    public $DataList;
    ...
    /**
     * @param array $DataList <p>MCP服务列表</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("DataList",$param) and $param["DataList"] !== null) {
            ...
            foreach ($param["DataList"] as $key => $value){
                $obj = new CNAPIGwAIServiceSource();

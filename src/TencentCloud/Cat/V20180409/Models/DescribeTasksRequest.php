 ...
 * @method integer getGroupId() 获取任务所使用的拨测分组Id
 * @method void setGroupId(integer $GroupId) 设置任务所使用的拨测分组Id
 */

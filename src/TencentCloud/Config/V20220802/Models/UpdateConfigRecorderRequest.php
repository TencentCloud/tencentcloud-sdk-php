 ...
 *
 * @method array getResourceTypes() 获取资源类型列表
 * @method void setResourceTypes(array $ResourceTypes) 设置资源类型列表
 */
class UpdateConfigRecorderRequest extends AbstractModel
{
    /**
     * @var array 资源类型列表
     */

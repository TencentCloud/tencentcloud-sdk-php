    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("VpcList",$param) and $param["VpcList"] !== null) {
            ...
            foreach ($param["VpcList"] as $key => $value){
                $obj = new CommonIdName();
                $obj->deserialize($value);
                array_push($this->VpcList, $obj);
            }
        }

        if (array_key_exists("NatList",$param) and $param["NatList"] !== null) {
            $this->NatList = [];
            foreach ($param["NatList"] as $key => $value){
                $obj = new CommonIdName();
                $obj->deserialize($value);
                array_push($this->NatList, $obj);
            }
        }

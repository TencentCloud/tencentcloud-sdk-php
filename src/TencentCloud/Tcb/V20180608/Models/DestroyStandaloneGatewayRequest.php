 ...
 * @method string getGatewayName() 获取网名名称
 * @method void setGatewayName(string $GatewayName) 设置网名名称
 * @method boolean getIsForce() 获取是否强制释放
 * @method void setIsForce(boolean $IsForce) 设置是否强制释放
 */
class DestroyStandaloneGatewayRequest extends AbstractModel
{
     ...
     * @param string $GatewayName 网名名称
     * @param boolean $IsForce 是否强制释放
     */

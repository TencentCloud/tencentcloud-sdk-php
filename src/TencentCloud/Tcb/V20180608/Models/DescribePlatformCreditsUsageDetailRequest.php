 ...
 * @method string getStartDate() 获取<p>开始日期</p><p>参数格式：YYYY-MM-DD</p>
 * @method void setStartDate(string $StartDate) 设置<p>开始日期</p><p>参数格式：YYYY-MM-DD</p>
 * @method string getEndDate() 获取<p>结束日期</p><p>参数格式：YYYY-MM-DD</p>
 * @method void setEndDate(string $EndDate) 设置<p>结束日期</p><p>参数格式：YYYY-MM-DD</p>
 ...
 */
class DescribePlatformCreditsUsageDetailRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>开始日期</p><p>参数格式：YYYY-MM-DD</p>
     */
    public $StartDate;

    /**
     * @var string <p>结束日期</p><p>参数格式：YYYY-MM-DD</p>
     */
    public $EndDate;
     ...
     * @param string $StartDate <p>开始日期</p><p>参数格式：YYYY-MM-DD</p>
     * @param string $EndDate <p>结束日期</p><p>参数格式：YYYY-MM-DD</p>

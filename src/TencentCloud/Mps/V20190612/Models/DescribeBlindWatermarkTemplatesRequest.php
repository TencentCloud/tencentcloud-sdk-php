 ...
 *
 * @method array getDefinitions() 获取数字水印模板唯一标识过滤条件，数组长度限制：100。
 * @method void setDefinitions(array $Definitions) 设置数字水印模板唯一标识过滤条件，数组长度限制：100。
 * @method string getName() 获取数字水印模板标识过滤条件，长度限制：64 个字符。
 * @method void setName(string $Name) 设置数字水印模板标识过滤条件，长度限制：64 个字符。
...
{
    /**
     * @var array 数字水印模板唯一标识过滤条件，数组长度限制：100。
     */
    public $Definitions;

    /**
     * @var string 数字水印模板标识过滤条件，长度限制：64 个字符。
     */
    public $Name;
...
<li>最大值：100。</li>
    ...
    /**
     * @param array $Definitions 数字水印模板唯一标识过滤条件，数组长度限制：100。
     * @param string $Name 数字水印模板标识过滤条件，长度限制：64 个字符。

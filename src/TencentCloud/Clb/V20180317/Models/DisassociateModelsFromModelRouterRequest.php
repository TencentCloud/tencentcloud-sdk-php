 ...
 * @method array getModels() 获取<p>需要解除关联的模型信息</p>
 * @method void setModels(array $Models) 设置<p>需要解除关联的模型信息</p>
 */
class DisassociateModelsFromModelRouterRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var array <p>需要解除关联的模型信息</p>
     */
    public $Models;

    /**
     * @param string $ModelRouterId <p>模型路由实例ID</p>
     * @param array $Models <p>需要解除关联的模型信息</p>
     */

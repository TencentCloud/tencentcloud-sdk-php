 ...
 *
 * @method string getHealthCheckTemplateId() 获取健康检查模板 ID，格式为 hct- 后接字母数字。
 * @method void setHealthCheckTemplateId(string $HealthCheckTemplateId) 设置健康检查模板 ID，格式为 hct- 后接字母数字。
...
- **HTTP1.0** 
> 仅当**HealthCheckProtocol**设置为**HTTP** 或 **HTTPS** 时，该参数生效。
 * @method integer getHealthCheckInterval() 获取健康检查的时间间隔。单位：秒。 取值范围：**2**-**300**。 默认值：**5**。
 * @method void setHealthCheckInterval(integer $HealthCheckInterval) 设置健康检查的时间间隔。单位：秒。 取值范围：**2**-**300**。 默认值：**5**。
 * @method string getHealthCheckMethod() 获取健康检查方法，取值： - **GET** - **HEAD**（默认值） 
> 仅当**HealthCheckProtocol**设置为**HTTP** 或 **HTTPS** 时，该参数生效。
 * @method void setHealthCheckMethod(string $HealthCheckMethod) 设置健康检查方法，取值： - **GET** - **HEAD**（默认值） 
> 仅当**HealthCheckProtocol**设置为**HTTP** 或 **HTTPS** 时，该参数生效。
...
> 仅当**HealthCheckProtocol**为**HTTP/HTTPS/GRPC/GRPCS**时，转发规则路径参数生效。
 * @method integer getHealthCheckPort() 获取健康检查访问后端服务器的端口。  取值范围：**0-65535**。  默认值：**0**，表示后端服务器的端口。
 * @method void setHealthCheckPort(integer $HealthCheckPort) 设置健康检查访问后端服务器的端口。  取值范围：**0-65535**。  默认值：**0**，表示后端服务器的端口。
...
{
    /**
     * @var string 健康检查模板 ID，格式为 hct- 后接字母数字。
     */
...
> 仅当**HealthCheckProtocol**设置为**HTTP** 或 **HTTPS** 时，该参数生效。
    ...
    /**
     * @var integer 健康检查的时间间隔。单位：秒。 取值范围：**2**-**300**。 默认值：**5**。
     */
    public $HealthCheckInterval;

    /**
     * @var string 健康检查方法，取值： - **GET** - **HEAD**（默认值） 
> 仅当**HealthCheckProtocol**设置为**HTTP** 或 **HTTPS** 时，该参数生效。
     */
...
> 仅当**HealthCheckProtocol**为**HTTP/HTTPS/GRPC/GRPCS**时，转发规则路径参数生效。
    ...
    /**
     * @var integer 健康检查访问后端服务器的端口。  取值范围：**0-65535**。  默认值：**0**，表示后端服务器的端口。
     */
...
默认值：**2**。
    ...
    /**
     * @param string $HealthCheckTemplateId 健康检查模板 ID，格式为 hct- 后接字母数字。
...
- **HTTP1.0** 
> 仅当**HealthCheckProtocol**设置为**HTTP** 或 **HTTPS** 时，该参数生效。
     * @param integer $HealthCheckInterval 健康检查的时间间隔。单位：秒。 取值范围：**2**-**300**。 默认值：**5**。
     * @param string $HealthCheckMethod 健康检查方法，取值： - **GET** - **HEAD**（默认值） 
> 仅当**HealthCheckProtocol**设置为**HTTP** 或 **HTTPS** 时，该参数生效。
     * @param string $HealthCheckPath 健康检查的转发规则路径。 长度为 **1-80** 个字符，只能使用字母、数字、字符`-/.%?#&=`以及扩展字符`_;~!（)*[]@$^:',+`。 URL 必须以正斜线（/）开头。 
> 仅当**HealthCheckProtocol**为**HTTP/HTTPS/GRPC/GRPCS**时，转发规则路径参数生效。
     * @param integer $HealthCheckPort 健康检查访问后端服务器的端口。  取值范围：**0-65535**。  默认值：**0**，表示后端服务器的端口。

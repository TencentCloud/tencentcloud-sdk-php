...
/**
 * @method integer getType() 获取过滤类型，1：政治，2：色情，3：涉毒
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setType(integer $Type) 设置过滤类型，1：政治，2：色情，3：涉毒
注意：此字段可能返回 null，表示取不到有效值。
...
{
    /**
     * @var integer 过滤类型，1：政治，2：色情，3：涉毒
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Type;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public $Word;
    /**
     * @param integer $Type 过滤类型，1：政治，2：色情，3：涉毒
注意：此字段可能返回 null，表示取不到有效值。

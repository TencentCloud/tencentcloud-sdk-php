 ...
 * @method string getToolName() 获取<p>toolcall工具名称</p>
 * @method void setToolName(string $ToolName) 设置<p>toolcall工具名称</p>
 * @method string getToolArgs() 获取<p>toolcall工具执行的参数</p>
 * @method void setToolArgs(string $ToolArgs) 设置<p>toolcall工具执行的参数</p>
 */
class DescribeQClawContentSecCheckRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>toolcall工具名称</p>
     */
    public $ToolName;

    /**
     * @var string <p>toolcall工具执行的参数</p>
     */
    public $ToolArgs;
     ...
     * @param string $ToolName <p>toolcall工具名称</p>
     * @param string $ToolArgs <p>toolcall工具执行的参数</p>
     */

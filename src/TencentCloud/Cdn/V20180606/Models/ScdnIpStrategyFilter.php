 ...
 * IP策略查询过滤参数
 *
 * @method string getName() 获取过滤字段名，支持domain, ip
 * @method void setName(string $Name) 设置过滤字段名，支持domain, ip
...
模糊查询时，Value长度最大为1
    ...
    /**
     * @param string $Name 过滤字段名，支持domain, ip

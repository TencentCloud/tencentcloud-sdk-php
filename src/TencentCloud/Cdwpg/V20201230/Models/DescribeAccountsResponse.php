 ...
 * @method array getAccounts() 获取账号数组
 * @method void setAccounts(array $Accounts) 设置账号数组
 * @method string getErrorMsg() 获取error:...
 * @method void setErrorMsg(string $ErrorMsg) 设置error:...

 ...
 * @method string getSubTag() 获取该字段用于返回音频文件的三级标签
 * @method void setSubTag(string $SubTag) 设置该字段用于返回音频文件的三级标签
 * @method string getSubTagCode() 获取该字段用于返回音频文件的三级标签码
...
返回值：**Block**：建议屏蔽，**Review** ：建议人工复审，**Pass**：建议通过
    ...
    /**
     * @var string 该字段用于返回音频文件的三级标签
     */
    public $SubTag;

    /**
     * @var string 该字段用于返回音频文件的三级标签码
     */
    public $SubTagCode;

    /**
     * @var array 该字段用于返回音频文件歌曲识别的详细审核结果
     */
    public $LabelResults;

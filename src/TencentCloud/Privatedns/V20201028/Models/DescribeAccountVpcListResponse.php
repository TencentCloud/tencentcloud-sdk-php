 ...
 *
 * @method integer getTotalCount() 获取VPC数量
 * @method void setTotalCount(integer $TotalCount) 设置VPC数量
 * @method array getVpcSet() 获取VPC 列表
 * @method void setVpcSet(array $VpcSet) 设置VPC 列表
...
class DescribeAccountVpcListResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount VPC数量
     * @param array $VpcSet VPC 列表

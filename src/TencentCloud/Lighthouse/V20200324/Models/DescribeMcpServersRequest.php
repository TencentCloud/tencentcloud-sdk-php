 ...
 * @method array getMcpServerIds() 获取MCP Server ID列表。列表为空时此条件不生效。最大长度：10
 * @method void setMcpServerIds(array $McpServerIds) 设置MCP Server ID列表。列表为空时此条件不生效。最大长度：10
...
class DescribeMcpServersRequest extends AbstractModel
{
    ...
    /**
     * @var array MCP Server ID列表。列表为空时此条件不生效。最大长度：10
     */
    public $McpServerIds;
     ...
     * @param array $McpServerIds MCP Server ID列表。列表为空时此条件不生效。最大长度：10

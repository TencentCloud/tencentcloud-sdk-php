 ...
 *
 * @method WafThreatenIntelligenceDetails getWafThreatenIntelligenceDetails() 获取WAF 威胁情报封禁信息
 * @method void setWafThreatenIntelligenceDetails(WafThreatenIntelligenceDetails $WafThreatenIntelligenceDetails) 设置WAF 威胁情报封禁信息
...
{
    /**
     * @var WafThreatenIntelligenceDetails WAF 威胁情报封禁信息
     */
    ...
    /**
     * @param WafThreatenIntelligenceDetails $WafThreatenIntelligenceDetails WAF 威胁情报封禁信息

 ...
 *
 * @method array getRiskItemList() 获取脆弱项列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setRiskItemList(array $RiskItemList) 设置脆弱项列表
注意：此字段可能返回 null，表示取不到有效值。
 ...
 */
class DescribeDSPAAssessmentRiskTemplateVulnerableListResponse extends AbstractModel
{
    /**
     * @var array 脆弱项列表
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param array $RiskItemList 脆弱项列表
注意：此字段可能返回 null，表示取不到有效值。

 ...
 *
 * @method array getCustomerGatewaySet() 获取<p>对端网关对象列表。</p>
 * @method void setCustomerGatewaySet(array $CustomerGatewaySet) 设置<p>对端网关对象列表。</p>
...
class DescribeCustomerGatewaysResponse extends AbstractModel
{
    ...
    /**
     * @param array $CustomerGatewaySet <p>对端网关对象列表。</p>

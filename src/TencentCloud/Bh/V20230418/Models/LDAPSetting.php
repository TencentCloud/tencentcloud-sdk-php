 ...
 * @method array getSyncUnitSet() 获取同步OU列表
 * @method void setSyncUnitSet(array $SyncUnitSet) 设置同步OU列表
 ...
 * @method string getResourceId() 获取请求LDAP服务的堡垒机实例
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResourceId(string $ResourceId) 设置请求LDAP服务的堡垒机实例
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 */
class LDAPSetting extends AbstractModel
{
    /**
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param array $SyncUnitSet 同步OU列表
     ...
     * @param string $ResourceId 请求LDAP服务的堡垒机实例
注意：此字段可能返回 null，表示取不到有效值。

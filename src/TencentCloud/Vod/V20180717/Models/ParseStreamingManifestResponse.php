 ...
 *
 * @method array getMediaSegmentSet() 获取<p>分片文件列表。</p>
 * @method void setMediaSegmentSet(array $MediaSegmentSet) 设置<p>分片文件列表。</p>
...
class ParseStreamingManifestResponse extends AbstractModel
{
    ...
    /**
     * @param array $MediaSegmentSet <p>分片文件列表。</p>

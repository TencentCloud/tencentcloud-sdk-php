 ...
 *
 * @method Price getDiskPrice() 获取描述了修改云硬盘备份点之后的云盘价格。
 * @method void setDiskPrice(Price $DiskPrice) 设置描述了修改云硬盘备份点之后的云盘价格。
...
class InquirePriceModifyDiskBackupQuotaResponse extends AbstractModel
{
    ...
    /**
     * @param Price $DiskPrice 描述了修改云硬盘备份点之后的云盘价格。

 ...
 * @method array getSignSeals() 获取签署内容
 * @method void setSignSeals(array $SignSeals) 设置签署内容
 * @method string getApproveMessage() 获取签署备注
 * @method void setApproveMessage(string $ApproveMessage) 设置签署备注
...
（注：普通情况下，VerifyChannel不能为None，如您不希望腾讯电子签对用户签署意愿做校验，请提前与客户经理或邮件至e-contract@tencent.com与我们联系）
     ...
     * @param array $SignSeals 签署内容
     * @param string $ApproveMessage 签署备注
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("SignSeals",$param) and $param["SignSeals"] !== null) {
            $this->SignSeals = [];
            foreach ($param["SignSeals"] as $key => $value){
                $obj = new SignSeal();
                $obj->deserialize($value);
                array_push($this->SignSeals, $obj);
            }
        }

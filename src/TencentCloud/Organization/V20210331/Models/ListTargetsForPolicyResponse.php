 ...
 * @method array getList() 获取<p>指定SCP策略关联目标列表。</p>
 * @method void setList(array $List) 设置<p>指定SCP策略关联目标列表。</p>
...
class ListTargetsForPolicyResponse extends AbstractModel
{
     ...
     * @param array $List <p>指定SCP策略关联目标列表。</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("List",$param) and $param["List"] !== null) {
            ...
            foreach ($param["List"] as $key => $value){
                $obj = new ListTargetsForPolicyNode();

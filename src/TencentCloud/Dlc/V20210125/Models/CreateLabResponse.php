 ...
 * CreateLab返回参数结构体
 *
 * @method string getExampleId() 获取<p>案例模板ID（从案例创建时返回）</p>
 * @method void setExampleId(string $ExampleId) 设置<p>案例模板ID（从案例创建时返回）</p>
 ...
 */
class CreateLabResponse extends AbstractModel
{
    /**
     * @var string <p>案例模板ID（从案例创建时返回）</p>
     */
    public $ExampleId;
    ...
    /**
     * @param string $ExampleId <p>案例模板ID（从案例创建时返回）</p>

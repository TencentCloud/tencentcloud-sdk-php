 ...
 *
 * @method string getExecution() 获取创建托管存储内表sql语句描述
 * @method void setExecution(string $Execution) 设置创建托管存储内表sql语句描述
...
class CreateInternalTableResponse extends AbstractModel
{
    ...
    /**
     * @param string $Execution 创建托管存储内表sql语句描述

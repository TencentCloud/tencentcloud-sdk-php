 ...
 * @method array getRows() 获取DLCCatalog授权列表
 * @method void setRows(array $Rows) 设置DLCCatalog授权列表
...
class DescribeDLCCatalogAccessResponse extends AbstractModel
{
     ...
     * @param array $Rows DLCCatalog授权列表

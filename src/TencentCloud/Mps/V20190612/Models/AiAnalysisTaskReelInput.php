 ...
 * 智能成片任务输入类型
 *
 * @method integer getDefinition() 获取<p>智能成片模板 ID。</p>
 * @method void setDefinition(integer $Definition) 设置<p>智能成片模板 ID。</p>
...
class AiAnalysisTaskReelInput extends AbstractModel
{
    ...
    /**
     * @param integer $Definition <p>智能成片模板 ID。</p>

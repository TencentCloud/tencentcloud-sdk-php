 ...
 * @method array getRequest() 获取入参
 * @method void setRequest(array $Request) 设置入参
 */
class CreateTaskParamDsRequest extends AbstractModel
{
    /**
     * @var string 项目ID
     */

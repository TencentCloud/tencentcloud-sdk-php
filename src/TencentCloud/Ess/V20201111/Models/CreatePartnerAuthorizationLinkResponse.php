 ...
 *
 * @method string getLink() 获取授权链接，以短链形式返回。短链的有效期参考回参中的 ExpiredTime。
 ...
 * @method void setLink(string $Link) 设置授权链接，以短链形式返回。短链的有效期参考回参中的 ExpiredTime。
 ...
 */
class CreatePartnerAuthorizationLinkResponse extends AbstractModel
{
    /**
...
2. 生成的链路后面不能再增加参数（会出现覆盖链接中已有参数导致错误）
    ...
    /**
     * @param string $Link 授权链接，以短链形式返回。短链的有效期参考回参中的 ExpiredTime。

 ...
 * @method string getTaskId() 获取任务接口条件
 * @method void setTaskId(string $TaskId) 设置任务接口条件
 * @method string getProjectId() 获取项目Id
 * @method void setProjectId(string $ProjectId) 设置项目Id
 */
class DescribeChildrenDsRequest extends AbstractModel
{
    /**
     * @var integer 页数
     */

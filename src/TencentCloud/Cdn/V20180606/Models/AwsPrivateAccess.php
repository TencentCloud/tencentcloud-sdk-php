 ...
 * s3源站回源鉴权。
 *
 * @method string getSwitch() 获取s3源站回源鉴权配置项开关，取值有：
on：开启
off：关闭
 * @method void setSwitch(string $Switch) 设置s3源站回源鉴权配置项开关，取值有：
on：开启
off：关闭
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param string $Switch s3源站回源鉴权配置项开关，取值有：
on：开启
off：关闭

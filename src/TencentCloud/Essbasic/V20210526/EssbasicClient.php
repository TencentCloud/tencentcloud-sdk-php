 ...
 * @method Models\ModifyOrganizationBusinessInfoResponse ModifyOrganizationBusinessInfo(Models\ModifyOrganizationBusinessInfoRequest $req) 本接口用于企业在已完成工商变更登记后，在电子签侧同步更新企业基础信息，并上传最新的营业执照或相关证照图片作为变更凭证。
⚠️ 重要说明

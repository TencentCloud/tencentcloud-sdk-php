...
1：结果未生成
2：结果生成失败
 * @method array getUnderwriteResults() 获取机器核保结果
 * @method void setUnderwriteResults(array $UnderwriteResults) 设置机器核保结果
...
1：结果未生成
2：结果生成失败
     * @param array $UnderwriteResults 机器核保结果
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("UnderwriteResults",$param) and $param["UnderwriteResults"] !== null) {
            ...
            foreach ($param["UnderwriteResults"] as $key => $value){
                $obj = new MachineUnderwriteOutput();

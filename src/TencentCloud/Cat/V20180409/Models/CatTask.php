 ...
 * @method integer getAvailRatioThres() 获取告警的可用率门限(0~100)
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setAvailRatioThres(integer $AvailRatioThres) 设置告警的可用率门限(0~100)
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getAvailRatioInterval() 获取告警的可用率持续时间。值为Period的0~4倍
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setAvailRatioInterval(integer $AvailRatioInterval) 设置告警的可用率持续时间。值为Period的0~4倍
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getReceiverGroupId() 获取告警接收组
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setReceiverGroupId(integer $ReceiverGroupId) 设置告警接收组
注意：此字段可能返回 null，表示取不到有效值。
...
class CatTask extends AbstractModel
{
    ...
    /**
     * @var integer 告警的可用率门限(0~100)
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $AvailRatioThres;

    /**
     * @var integer 告警的可用率持续时间。值为Period的0~4倍
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $AvailRatioInterval;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param integer $AvailRatioThres 告警的可用率门限(0~100)
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $AvailRatioInterval 告警的可用率持续时间。值为Period的0~4倍
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $ReceiverGroupId 告警接收组
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("AvailRatioThres",$param) and $param["AvailRatioThres"] !== null) {
            $this->AvailRatioThres = $param["AvailRatioThres"];
        }

        if (array_key_exists("AvailRatioInterval",$param) and $param["AvailRatioInterval"] !== null) {
            $this->AvailRatioInterval = $param["AvailRatioInterval"];
        }

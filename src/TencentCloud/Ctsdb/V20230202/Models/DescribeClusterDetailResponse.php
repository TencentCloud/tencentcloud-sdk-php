 ...
 *
 * @method ClusterDetail getCluster() 获取<p>实例详情</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setCluster(ClusterDetail $Cluster) 设置<p>实例详情</p>
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param ClusterDetail $Cluster <p>实例详情</p>
注意：此字段可能返回 null，表示取不到有效值。

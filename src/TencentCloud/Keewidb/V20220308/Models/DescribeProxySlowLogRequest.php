 ...
 *
 * @method string getInstanceId() 获取实例 ID，如：kee-6ubhgouj
 * @method void setInstanceId(string $InstanceId) 设置实例 ID，如：kee-6ubhgouj
...
{
    /**
     * @var string 实例 ID，如：kee-6ubhgouj
     */
    public $InstanceId;
    ...
    /**
     * @param string $InstanceId 实例 ID，如：kee-6ubhgouj

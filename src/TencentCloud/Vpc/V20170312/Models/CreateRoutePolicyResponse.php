 ...
 *
 * @method RoutePolicy getRoutePolicy() 获取路由策略ID及规则。
 * @method void setRoutePolicy(RoutePolicy $RoutePolicy) 设置路由策略ID及规则。
...
class CreateRoutePolicyResponse extends AbstractModel
{
    ...
    /**
     * @param RoutePolicy $RoutePolicy 路由策略ID及规则。

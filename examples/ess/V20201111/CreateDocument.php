...
try {
    ...
    $req->FileNames = [];
    // No need to care, just pass in any custom value
    array_push($req->FileNames, "filename");

    // Returned by CreateFlow
    $req->setFlowId("********************************");

    // Query after backend configuration
    $req->setTemplateId("********************************");

    $formField = new FormField();
    // Can be found in the template configuration drag-and-drop control interface

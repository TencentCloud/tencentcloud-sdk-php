 ...
 *
 * @method SmartPolicy getSmartPolicy() 获取策略描述
 * @method void setSmartPolicy(SmartPolicy $SmartPolicy) 设置策略描述
 */
class GetOptimizerPolicyRequest extends AbstractModel
{
    /**
     * @var SmartPolicy 策略描述
     */
    public $SmartPolicy;

    /**
     * @param SmartPolicy $SmartPolicy 策略描述
     */

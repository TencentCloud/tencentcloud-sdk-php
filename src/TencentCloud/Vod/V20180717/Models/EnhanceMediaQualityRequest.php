 ...
 * @method integer getDefinition() 获取音画质重生模板 ID，请联系腾讯云获取。
 * @method void setDefinition(integer $Definition) 设置音画质重生模板 ID，请联系腾讯云获取。
...
class EnhanceMediaQualityRequest extends AbstractModel
{
    ...
    /**
     * @var integer 音画质重生模板 ID，请联系腾讯云获取。
     */
    public $Definition;
     ...
     * @param integer $Definition 音画质重生模板 ID，请联系腾讯云获取。

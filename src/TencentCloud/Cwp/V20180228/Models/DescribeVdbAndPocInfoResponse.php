 ...
 *
 * @method string getVdbUpdateTime() 获取病毒库更新时间。
 * @method void setVdbUpdateTime(string $VdbUpdateTime) 设置病毒库更新时间。
 * @method string getPocUpdateTime() 获取漏洞库更新时间。
 * @method void setPocUpdateTime(string $PocUpdateTime) 设置漏洞库更新时间。
...
class DescribeVdbAndPocInfoResponse extends AbstractModel
{
    ...
    /**
     * @param string $VdbUpdateTime 病毒库更新时间。
     * @param string $PocUpdateTime 漏洞库更新时间。

...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("RecordingRuleSet",$param) and $param["RecordingRuleSet"] !== null) {
            $this->RecordingRuleSet = [];
            foreach ($param["RecordingRuleSet"] as $key => $value){
                $obj = new RecordingRuleSet();

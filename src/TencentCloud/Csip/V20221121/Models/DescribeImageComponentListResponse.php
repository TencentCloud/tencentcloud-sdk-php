 ...
 * @method array getComponentList() 获取<p>组件信息列表</p>
 * @method void setComponentList(array $ComponentList) 设置<p>组件信息列表</p>
...
class DescribeImageComponentListResponse extends AbstractModel
{
     ...
     * @param array $ComponentList <p>组件信息列表</p>

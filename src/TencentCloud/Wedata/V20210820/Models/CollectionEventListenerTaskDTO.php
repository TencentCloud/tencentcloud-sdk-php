...
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getCurrentPageItems() 获取当前页条数
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setCurrentPageItems(integer $CurrentPageItems) 设置当前页条数
注意：此字段可能返回 null，表示取不到有效值。
 * @method integer getCurrentPage() 获取当前页
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setCurrentPage(integer $CurrentPage) 设置当前页
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
 */
class CollectionEventListenerTaskDTO extends AbstractModel
{
    /**
     * @var integer 总数据条数
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param integer $CurrentPageItems 当前页条数
注意：此字段可能返回 null，表示取不到有效值。

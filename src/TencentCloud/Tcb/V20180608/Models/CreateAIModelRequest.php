 ...
 * @method string getGroupName() 获取<p>分组名</p><p>入参限制：不允许以 cloudbase 为前缀</p>
 * @method void setGroupName(string $GroupName) 设置<p>分组名</p><p>入参限制：不允许以 cloudbase 为前缀</p>
 * @method string getBaseUrl() 获取<p>模型服务地址</p>
 * @method void setBaseUrl(string $BaseUrl) 设置<p>模型服务地址</p>
 * @method array getModels() 获取<p>模型名列表</p>
 * @method void setModels(array $Models) 设置<p>模型名列表</p>
 * @method string getRemark() 获取<p>分组备注</p>
 * @method void setRemark(string $Remark) 设置<p>分组备注</p>
 ...
 */
class CreateAIModelRequest extends AbstractModel
{
    /**
     * @var string <p>环境id</p>
     */
    ...
    /**
     * @var string <p>分组名</p><p>入参限制：不允许以 cloudbase 为前缀</p>
     */
    public $GroupName;

    /**
     * @var string <p>模型服务地址</p>
     */
    public $BaseUrl;
     ...
     * @param string $GroupName <p>分组名</p><p>入参限制：不允许以 cloudbase 为前缀</p>
     * @param string $BaseUrl <p>模型服务地址</p>
     * @param array $Models <p>模型名列表</p>
     * @param string $Remark <p>分组备注</p>

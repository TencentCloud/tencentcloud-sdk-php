 ...
 * @method boolean getEnableFaceDetection() 获取<p>是否开启人脸检测</p>
 * @method void setEnableFaceDetection(boolean $EnableFaceDetection) 设置<p>是否开启人脸检测</p>
 * @method integer getInputRotateDegree() 获取<p>画面旋转角度</p><p>枚举值：</p><ul><li>0： 不旋转</li><li>90： 顺时针旋转90度</li><li>-90： 逆时针旋转90度</li><li>180： 旋转180度</li></ul><p>默认值：0</p>
 * @method void setInputRotateDegree(integer $InputRotateDegree) 设置<p>画面旋转角度</p><p>枚举值：</p><ul><li>0： 不旋转</li><li>90： 顺时针旋转90度</li><li>-90： 逆时针旋转90度</li><li>180： 旋转180度</li></ul><p>默认值：0</p>
 * @method boolean getEnableExtendedOutput() 获取<p>开启扩展字段输出</p><p>枚举值：</p><ul><li>true： 开启</li><li>false： 关闭</li></ul><p>默认值：false</p>
 * @method void setEnableExtendedOutput(boolean $EnableExtendedOutput) 设置<p>开启扩展字段输出</p><p>枚举值：</p><ul><li>true： 开启</li><li>false： 关闭</li></ul><p>默认值：false</p>
 * @method array getExtendedOutputPrompts() 获取<p>自定义扩展输出的提示词（目前仅支持覆盖 custom）</p>
 * @method void setExtendedOutputPrompts(array $ExtendedOutputPrompts) 设置<p>自定义扩展输出的提示词（目前仅支持覆盖 custom）</p>
 */
class SeeComprehensionConfig extends AbstractModel
{
    ...
    /**
     * @var boolean <p>是否开启人脸检测</p>
     */
    public $EnableFaceDetection;

    /**
     * @var integer <p>画面旋转角度</p><p>枚举值：</p><ul><li>0： 不旋转</li><li>90： 顺时针旋转90度</li><li>-90： 逆时针旋转90度</li><li>180： 旋转180度</li></ul><p>默认值：0</p>
     */
    public $InputRotateDegree;

    /**
     * @var boolean <p>开启扩展字段输出</p><p>枚举值：</p><ul><li>true： 开启</li><li>false： 关闭</li></ul><p>默认值：false</p>
     */
    public $EnableExtendedOutput;

    /**
     * @var array <p>自定义扩展输出的提示词（目前仅支持覆盖 custom）</p>
     */
    public $ExtendedOutputPrompts;
     ...
     * @param boolean $EnableFaceDetection <p>是否开启人脸检测</p>
     * @param integer $InputRotateDegree <p>画面旋转角度</p><p>枚举值：</p><ul><li>0： 不旋转</li><li>90： 顺时针旋转90度</li><li>-90： 逆时针旋转90度</li><li>180： 旋转180度</li></ul><p>默认值：0</p>
     * @param boolean $EnableExtendedOutput <p>开启扩展字段输出</p><p>枚举值：</p><ul><li>true： 开启</li><li>false： 关闭</li></ul><p>默认值：false</p>
     * @param array $ExtendedOutputPrompts <p>自定义扩展输出的提示词（目前仅支持覆盖 custom）</p>
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("EnableFaceDetection",$param) and $param["EnableFaceDetection"] !== null) {
            $this->EnableFaceDetection = $param["EnableFaceDetection"];
        }

        if (array_key_exists("InputRotateDegree",$param) and $param["InputRotateDegree"] !== null) {
            $this->InputRotateDegree = $param["InputRotateDegree"];
        }

        if (array_key_exists("EnableExtendedOutput",$param) and $param["EnableExtendedOutput"] !== null) {
            $this->EnableExtendedOutput = $param["EnableExtendedOutput"];
        }

        if (array_key_exists("ExtendedOutputPrompts",$param) and $param["ExtendedOutputPrompts"] !== null) {
            $this->ExtendedOutputPrompts = [];
            foreach ($param["ExtendedOutputPrompts"] as $key => $value){
                $obj = new SeeExtendedOutputPrompt();
                $obj->deserialize($value);
                array_push($this->ExtendedOutputPrompts, $obj);
            }
        }
    }
}

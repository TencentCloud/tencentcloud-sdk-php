 ...
 * 实例名称序号相关设置。
 *
 * @method boolean getEnabled() 获取<p>是否开启实例创建序号，默认不开启。取值范围：</p><p><strong>TRUE</strong>：表示开启实例创建序号; <strong>FALSE</strong>：表示不开启实例创建序号</p>
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setEnabled(boolean $Enabled) 设置<p>是否开启实例创建序号，默认不开启。取值范围：</p><p><strong>TRUE</strong>：表示开启实例创建序号; <strong>FALSE</strong>：表示不开启实例创建序号</p>
注意：此字段可能返回 null，表示取不到有效值。
...
{
    /**
     * @var boolean <p>是否开启实例创建序号，默认不开启。取值范围：</p><p><strong>TRUE</strong>：表示开启实例创建序号; <strong>FALSE</strong>：表示不开启实例创建序号</p>
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Enabled;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param boolean $Enabled <p>是否开启实例创建序号，默认不开启。取值范围：</p><p><strong>TRUE</strong>：表示开启实例创建序号; <strong>FALSE</strong>：表示不开启实例创建序号</p>
注意：此字段可能返回 null，表示取不到有效值。

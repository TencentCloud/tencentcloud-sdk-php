 ...
 * @method string getErrMsg() 获取响应消息
 * @method void setErrMsg(string $ErrMsg) 设置响应消息
 * @method AssignmentData getResult() 获取返回响应
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(AssignmentData $Result) 设置返回响应
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param AssignmentData $Result 返回响应
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new AssignmentData();

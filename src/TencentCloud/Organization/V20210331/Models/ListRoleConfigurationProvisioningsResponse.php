 ...
 * @method array getRoleConfigurationProvisionings() 获取部成员账号列表。
 * @method void setRoleConfigurationProvisionings(array $RoleConfigurationProvisionings) 设置部成员账号列表。
...
class ListRoleConfigurationProvisioningsResponse extends AbstractModel
{
     ...
     * @param array $RoleConfigurationProvisionings 部成员账号列表。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("RoleConfigurationProvisionings",$param) and $param["RoleConfigurationProvisionings"] !== null) {
            $this->RoleConfigurationProvisionings = [];
            foreach ($param["RoleConfigurationProvisionings"] as $key => $value){
                $obj = new RoleConfigurationProvisionings();
                $obj->deserialize($value);
                array_push($this->RoleConfigurationProvisionings, $obj);
            }
        }

 ...
 * @method DDoSGeoIPBlockConfig getDDoSGeoIPBlockConfig() 获取DDoS区域封禁配置，填写参数时配置ID不能为空
 * @method void setDDoSGeoIPBlockConfig(DDoSGeoIPBlockConfig $DDoSGeoIPBlockConfig) 设置DDoS区域封禁配置，填写参数时配置ID不能为空
 */
class DeleteDDoSGeoIPBlockConfigRequest extends AbstractModel
{
    ...
    /**
     * @var DDoSGeoIPBlockConfig DDoS区域封禁配置，填写参数时配置ID不能为空
     */
    public $DDoSGeoIPBlockConfig;

    /**
     * @param string $InstanceId 资源实例ID
     * @param DDoSGeoIPBlockConfig $DDoSGeoIPBlockConfig DDoS区域封禁配置，填写参数时配置ID不能为空
     */

 ...
 *
 * @method array getTargetGroupInstanceSet() 获取健康检查后端rs状态列表
 * @method void setTargetGroupInstanceSet(array $TargetGroupInstanceSet) 设置健康检查后端rs状态列表
...
class DescribeTargetGroupInstanceStatusResponse extends AbstractModel
{
    ...
    /**
     * @param array $TargetGroupInstanceSet 健康检查后端rs状态列表

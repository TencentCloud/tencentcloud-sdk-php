 ...
 * @method array getProductIds() 获取待解绑的子产品ID数组
 * @method void setProductIds(array $ProductIds) 设置待解绑的子产品ID数组
 */
class UnbindProductsRequest extends AbstractModel
{
    ...
    /**
     * @var array 待解绑的子产品ID数组
     */
    public $ProductIds;

    /**
     * @param string $GatewayProductId 网关产品ID
     * @param array $ProductIds 待解绑的子产品ID数组
     */

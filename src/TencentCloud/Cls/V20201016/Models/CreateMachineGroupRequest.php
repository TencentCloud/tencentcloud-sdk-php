 ...
 * @method MachineGroupTypeInfo getMachineGroupType() 获取创建机器组类型。Type：ip，Values中为ip字符串列表创建机器组；Type：label，Values中为标签字符串列表创建机器组。
 * @method void setMachineGroupType(MachineGroupTypeInfo $MachineGroupType) 设置创建机器组类型。Type：ip，Values中为ip字符串列表创建机器组；Type：label，Values中为标签字符串列表创建机器组。
...
class CreateMachineGroupRequest extends AbstractModel
{
    ...
    /**
     * @var MachineGroupTypeInfo 创建机器组类型。Type：ip，Values中为ip字符串列表创建机器组；Type：label，Values中为标签字符串列表创建机器组。
     */
     ...
     * @param MachineGroupTypeInfo $MachineGroupType 创建机器组类型。Type：ip，Values中为ip字符串列表创建机器组；Type：label，Values中为标签字符串列表创建机器组。

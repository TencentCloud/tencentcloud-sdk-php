 ...
 * @method string getNotifyType() 获取通知类型，默认不填为不通知开通方，填写 SMS 为短息通知。
 * @method void setNotifyType(string $NotifyType) 设置通知类型，默认不填为不通知开通方，填写 SMS 为短息通知。
...
E_PRESCRIPTION_AUTO_SIGN 电子处方
    ...
    /**
     * @var string 通知类型，默认不填为不通知开通方，填写 SMS 为短息通知。
     */
    public $NotifyType;
...
E_PRESCRIPTION_AUTO_SIGN 电子处方
     ...
     * @param string $NotifyType 通知类型，默认不填为不通知开通方，填写 SMS 为短息通知。

 ...
 * @method integer getCbsSysEncrypt() 获取<p>是否开启集群维度cbs系统盘加密,0关闭1开启</p>
 * @method void setCbsSysEncrypt(integer $CbsSysEncrypt) 设置<p>是否开启集群维度cbs系统盘加密,0关闭1开启</p>
 */
class CreateInstanceRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>是否开启集群维度cbs系统盘加密,0关闭1开启</p>
     */
    public $CbsSysEncrypt;
     ...
     * @param integer $CbsSysEncrypt <p>是否开启集群维度cbs系统盘加密,0关闭1开启</p>
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("CbsSysEncrypt",$param) and $param["CbsSysEncrypt"] !== null) {
            $this->CbsSysEncrypt = $param["CbsSysEncrypt"];
        }
    }
}

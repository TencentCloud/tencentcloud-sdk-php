 ...
 * @method AiAnalysisTaskVideoRemakeInput getInput() 获取去重任务输入
 * @method void setInput(AiAnalysisTaskVideoRemakeInput $Input) 设置去重任务输入
 * @method AiAnalysisTaskVideoRemakeOutput getOutput() 获取去重任务输出
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setOutput(AiAnalysisTaskVideoRemakeOutput $Output) 设置去重任务输出
注意：此字段可能返回 null，表示取不到有效值。
 */
class AiAnalysisTaskVideoRemakeResult extends AbstractModel
{
    ...
    /**
     * @var AiAnalysisTaskVideoRemakeInput 去重任务输入
     */
    public $Input;

    /**
     * @var AiAnalysisTaskVideoRemakeOutput 去重任务输出
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Output;
     ...
     * @param AiAnalysisTaskVideoRemakeInput $Input 去重任务输入
     * @param AiAnalysisTaskVideoRemakeOutput $Output 去重任务输出
注意：此字段可能返回 null，表示取不到有效值。
     */

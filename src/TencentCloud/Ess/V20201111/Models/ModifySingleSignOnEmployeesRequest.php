 ...
 * @method SingleSignOnEmployees getEmployee() 获取待修改员工的信息。
 * @method void setEmployee(SingleSignOnEmployees $Employee) 设置待修改员工的信息。
 * @method Agent getAgent() 获取代理企业和员工的信息。
在集团企业代理子企业操作的场景中，需设置此参数。在此情境下，ProxyOrganizationId（子企业的组织ID）为必填项。
 * @method void setAgent(Agent $Agent) 设置代理企业和员工的信息。
在集团企业代理子企业操作的场景中，需设置此参数。在此情境下，ProxyOrganizationId（子企业的组织ID）为必填项。
 */
class ModifySingleSignOnEmployeesRequest extends AbstractModel
{
    /**
...
注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
    ...
    /**
     * @var SingleSignOnEmployees 待修改员工的信息。
     */
    public $Employee;
...
注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
     ...
     * @param SingleSignOnEmployees $Employee 待修改员工的信息。
...
在集团企业代理子企业操作的场景中，需设置此参数。在此情境下，ProxyOrganizationId（子企业的组织ID）为必填项。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Employee",$param) and $param["Employee"] !== null) {
            $this->Employee = new SingleSignOnEmployees();
            $this->Employee->deserialize($param["Employee"]);
        }

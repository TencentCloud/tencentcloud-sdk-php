 ...
 * @method array getFilters() 获取过滤条件,当前只支持按照ClusterName和云标签进行过滤,云标签过滤格式Tags:["key1:value1","key2:value2"]
 * @method void setFilters(array $Filters) 设置过滤条件,当前只支持按照ClusterName和云标签进行过滤,云标签过滤格式Tags:["key1:value1","key2:value2"]
 */
...
表示获取账号下所有集群)
    ...
    /**
     * @var array 过滤条件,当前只支持按照ClusterName和云标签进行过滤,云标签过滤格式Tags:["key1:value1","key2:value2"]
     */
    public $Filters;
...
表示获取账号下所有集群)
     ...
     * @param array $Filters 过滤条件,当前只支持按照ClusterName和云标签进行过滤,云标签过滤格式Tags:["key1:value1","key2:value2"]
     */

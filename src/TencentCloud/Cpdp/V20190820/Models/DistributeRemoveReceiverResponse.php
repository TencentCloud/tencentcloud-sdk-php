 ...
 * @method DistributeReceiverResult getResult() 获取解除分账接收方响应对象
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(DistributeReceiverResult $Result) 设置解除分账接收方响应对象
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var DistributeReceiverResult 解除分账接收方响应对象
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param DistributeReceiverResult $Result 解除分账接收方响应对象
注意：此字段可能返回 null，表示取不到有效值。

 ...
 * @method string getTaskId() 获取加签任务Id
 * @method void setTaskId(string $TaskId) 设置加签任务Id
 */
class DescribeFileCounterSignResultRequest extends AbstractModel
{
    /**

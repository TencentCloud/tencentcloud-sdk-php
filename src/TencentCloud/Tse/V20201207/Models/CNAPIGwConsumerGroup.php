 ...
 * @method string getSourceType() 获取<p>资源类型</p><p>枚举值：</p><ul><li>Public： 公有</li></ul>
 * @method void setSourceType(string $SourceType) 设置<p>资源类型</p><p>枚举值：</p><ul><li>Public： 公有</li></ul>
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var string <p>资源类型</p><p>枚举值：</p><ul><li>Public： 公有</li></ul>
     */
    public $SourceType;
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param string $SourceType <p>资源类型</p><p>枚举值：</p><ul><li>Public： 公有</li></ul>

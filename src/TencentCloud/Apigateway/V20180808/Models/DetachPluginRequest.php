 ...
 * DetachPlugin请求参数结构体
 *
 * @method string getPluginId() 获取要解绑的API网关插件ID。
 * @method void setPluginId(string $PluginId) 设置要解绑的API网关插件ID。
 ...
 * @method string getApiId() 获取要解绑的API ID。
 * @method void setApiId(string $ApiId) 设置要解绑的API ID。
 */
class DetachPluginRequest extends AbstractModel
{
    /**
     * @var string 要解绑的API网关插件ID。
     */
    public $PluginId;
    ...
    /**
     * @var string 要解绑的API ID。
     */
    public $ApiId;

    /**
     * @param string $PluginId 要解绑的API网关插件ID。
     * @param string $ServiceId 要操作的服务ID。
     * @param string $EnvironmentName 要操作API的环境。
     * @param string $ApiId 要解绑的API ID。
     */

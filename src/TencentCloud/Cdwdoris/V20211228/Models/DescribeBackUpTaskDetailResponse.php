 ...
 *
 * @method array getBackupStatus() 获取备份任务进度详情
 * @method void setBackupStatus(array $BackupStatus) 设置备份任务进度详情
...
class DescribeBackUpTaskDetailResponse extends AbstractModel
{
    ...
    /**
     * @param array $BackupStatus 备份任务进度详情
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("BackupStatus",$param) and $param["BackupStatus"] !== null) {
            $this->BackupStatus = [];
            foreach ($param["BackupStatus"] as $key => $value){
                $obj = new BackupStatus();
                $obj->deserialize($value);
                array_push($this->BackupStatus, $obj);
            }
        }

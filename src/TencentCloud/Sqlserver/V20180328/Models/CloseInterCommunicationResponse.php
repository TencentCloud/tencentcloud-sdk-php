 ...
 *
 * @method array getInterInstanceFlowSet() 获取实例和异步流程ID
 * @method void setInterInstanceFlowSet(array $InterInstanceFlowSet) 设置实例和异步流程ID
...
class CloseInterCommunicationResponse extends AbstractModel
{
    ...
    /**
     * @param array $InterInstanceFlowSet 实例和异步流程ID

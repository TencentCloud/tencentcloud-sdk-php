 ...
 * @method CreateAigcAudioCloneInput getInput() 获取<p>AIGC 音频复刻任务的输入信息。</p>
 * @method void setInput(CreateAigcAudioCloneInput $Input) 设置<p>AIGC 音频复刻任务的输入信息。</p>
 * @method CreateAigcAudioCloneOutput getOutput() 获取<p>AIGC 音频复刻任务的输出信息。</p>
 * @method void setOutput(CreateAigcAudioCloneOutput $Output) 设置<p>AIGC 音频复刻任务的输出信息。</p>
 ...
 */
class CreateAigcAudioCloneTask extends AbstractModel
{
    /**
     * @var string <p>任务ID。</p>
     */
    ...
    /**
     * @var CreateAigcAudioCloneInput <p>AIGC 音频复刻任务的输入信息。</p>
     */
    public $Input;

    /**
     * @var CreateAigcAudioCloneOutput <p>AIGC 音频复刻任务的输出信息。</p>
     */
    public $Output;
     ...
     * @param CreateAigcAudioCloneInput $Input <p>AIGC 音频复刻任务的输入信息。</p>
     * @param CreateAigcAudioCloneOutput $Output <p>AIGC 音频复刻任务的输出信息。</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Input",$param) and $param["Input"] !== null) {
            $this->Input = new CreateAigcAudioCloneInput();
            $this->Input->deserialize($param["Input"]);
        }

        if (array_key_exists("Output",$param) and $param["Output"] !== null) {
            $this->Output = new CreateAigcAudioCloneOutput();

 ...
 *
 * @method AbnormalProcessRuleInfo getRuleDetail() 获取异常进程策略详细信息
 * @method void setRuleDetail(AbnormalProcessRuleInfo $RuleDetail) 设置异常进程策略详细信息
...
{
    /**
     * @var AbnormalProcessRuleInfo 异常进程策略详细信息
     */
    public $RuleDetail;

 ...
 * @method array getUserGroupIdList() 获取用户组id
 * @method void setUserGroupIdList(array $UserGroupIdList) 设置用户组id
 */
class ModifyUserDetailInfoRequest extends AbstractModel
{
    /**
     * @var string 用户ID
     */
     ...
     * @param array $UserGroupIdList 用户组id
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("UserGroupIdList",$param) and $param["UserGroupIdList"] !== null) {
            $this->UserGroupIdList = $param["UserGroupIdList"];
        }
    }
}

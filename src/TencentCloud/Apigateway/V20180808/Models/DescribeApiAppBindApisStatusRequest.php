 ...
 * @method array getFilters() 获取过滤条件。支持ApiId、ApiName、ServiceId、Environment 、KeyWord（ 可以匹配name或者ID）。
 * @method void setFilters(array $Filters) 设置过滤条件。支持ApiId、ApiName、ServiceId、Environment 、KeyWord（ 可以匹配name或者ID）。
 */
class DescribeApiAppBindApisStatusRequest extends AbstractModel
{
    ...
    /**
     * @var array 过滤条件。支持ApiId、ApiName、ServiceId、Environment 、KeyWord（ 可以匹配name或者ID）。
     */
    public $Filters;
     ...
     * @param array $Filters 过滤条件。支持ApiId、ApiName、ServiceId、Environment 、KeyWord（ 可以匹配name或者ID）。
     */

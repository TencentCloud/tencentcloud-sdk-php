 ...
 * @method string getCommand() 获取shell 命令
 * @method void setCommand(string $Command) 设置shell 命令
 */
class ExecuteCommandOnAndroidInstancesRequest extends AbstractModel
{
    /**

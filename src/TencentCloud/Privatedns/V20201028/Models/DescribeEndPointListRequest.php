 ...
 * @method array getFilters() 获取过滤参数，支持EndPointName,EndPointId,EndPointServiceId,EndPointVip
 * @method void setFilters(array $Filters) 设置过滤参数，支持EndPointName,EndPointId,EndPointServiceId,EndPointVip
 */
class DescribeEndPointListRequest extends AbstractModel
{
    ...
    /**
     * @var array 过滤参数，支持EndPointName,EndPointId,EndPointServiceId,EndPointVip
     */
    public $Filters;
     ...
     * @param array $Filters 过滤参数，支持EndPointName,EndPointId,EndPointServiceId,EndPointVip
     */

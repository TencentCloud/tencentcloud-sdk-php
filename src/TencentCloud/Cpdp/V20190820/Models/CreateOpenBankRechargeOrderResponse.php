...
注意：此字段可能返回 null，表示取不到有效值。
 * @method CreateOpenBankOrderRechargeResult getResult() 获取充值响应对象
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(CreateOpenBankOrderRechargeResult $Result) 设置充值响应对象
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var CreateOpenBankOrderRechargeResult 充值响应对象
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param CreateOpenBankOrderRechargeResult $Result 充值响应对象
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new CreateOpenBankOrderRechargeResult();

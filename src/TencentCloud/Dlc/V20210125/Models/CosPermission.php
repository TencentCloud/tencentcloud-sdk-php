...
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getPermissions() 获取权限【"read","write"】
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setPermissions(array $Permissions) 设置权限【"read","write"】
注意：此字段可能返回 null，表示取不到有效值。
 */
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $Permissions 权限【"read","write"】
注意：此字段可能返回 null，表示取不到有效值。
     */

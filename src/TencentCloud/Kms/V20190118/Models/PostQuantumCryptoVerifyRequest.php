 ...
 * @method string getSignatureValue() 获取签名值，通过调用KMS PostQuantumCryptoSign签名接口生成
 * @method void setSignatureValue(string $SignatureValue) 设置签名值，通过调用KMS PostQuantumCryptoSign签名接口生成
...
class PostQuantumCryptoVerifyRequest extends AbstractModel
{
    ...
    /**
     * @var string 签名值，通过调用KMS PostQuantumCryptoSign签名接口生成
     */
     ...
     * @param string $SignatureValue 签名值，通过调用KMS PostQuantumCryptoSign签名接口生成

...
注意：此字段可能返回 null，表示取不到有效值。
 * @method array getCopyJobsResults() 获取结果列表
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setCopyJobsResults(array $CopyJobsResults) 设置结果列表
注意：此字段可能返回 null，表示取不到有效值。
...
注意：此字段可能返回 null，表示取不到有效值。
     * @param array $CopyJobsResults 结果列表
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("CopyJobsResults",$param) and $param["CopyJobsResults"] !== null) {
            $this->CopyJobsResults = [];
            foreach ($param["CopyJobsResults"] as $key => $value){
                $obj = new CopyJobResult();
                $obj->deserialize($value);
                array_push($this->CopyJobsResults, $obj);
            }
        }

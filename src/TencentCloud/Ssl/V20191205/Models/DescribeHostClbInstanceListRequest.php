 ...
 * @method integer getAsyncCache() 获取是否异步缓存,0表示否,1表示是
 * @method void setAsyncCache(integer $AsyncCache) 设置是否异步缓存,0表示否,1表示是
...
class DescribeHostClbInstanceListRequest extends AbstractModel
{
     ...
     * @param integer $AsyncCache 是否异步缓存,0表示否,1表示是

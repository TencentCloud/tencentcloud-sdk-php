 ...
 *
 * @method array getGroups() 获取group列表
 * @method void setGroups(array $Groups) 设置group列表
 ...
 */
class DescribeRocketMQSourceClusterGroupListResponse extends AbstractModel
{
    /**
     * @var array group列表
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Groups",$param) and $param["Groups"] !== null) {
            ...
            foreach ($param["Groups"] as $key => $value){
                $obj = new RocketMQGroupConfigOutput();

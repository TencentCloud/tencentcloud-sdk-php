 ...
 * @method AigcHunyuan3DTask getAigcHunyuan3DCompleteEvent() 获取<p>AIGC 混元 3D 任务信息，仅当 EventType 为 AigcHunyuan3DTaskComplete，该字段有值。</p>
 * @method void setAigcHunyuan3DCompleteEvent(AigcHunyuan3DTask $AigcHunyuan3DCompleteEvent) 设置<p>AIGC 混元 3D 任务信息，仅当 EventType 为 AigcHunyuan3DTaskComplete，该字段有值。</p>
 */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @var AigcHunyuan3DTask <p>AIGC 混元 3D 任务信息，仅当 EventType 为 AigcHunyuan3DTaskComplete，该字段有值。</p>
     */
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param AigcHunyuan3DTask $AigcHunyuan3DCompleteEvent <p>AIGC 混元 3D 任务信息，仅当 EventType 为 AigcHunyuan3DTaskComplete，该字段有值。</p>
     */

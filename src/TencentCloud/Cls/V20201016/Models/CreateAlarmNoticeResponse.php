 ...
 *
 * @method string getAlarmNoticeId() 获取<p>告警模板ID</p>
 * @method void setAlarmNoticeId(string $AlarmNoticeId) 设置<p>告警模板ID</p>
...
class CreateAlarmNoticeResponse extends AbstractModel
{
    ...
    /**
     * @param string $AlarmNoticeId <p>告警模板ID</p>

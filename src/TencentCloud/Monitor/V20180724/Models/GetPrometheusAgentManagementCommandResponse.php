 ...
 *
 * @method ManagementCommand getCommand() 获取Agent 管理命令
 * @method void setCommand(ManagementCommand $Command) 设置Agent 管理命令
...
{
    /**
     * @var ManagementCommand Agent 管理命令
     */
    public $Command;
    ...
    /**
     * @param ManagementCommand $Command Agent 管理命令

 ...
 * @method string getUsedCharSize() 获取知识库使用字符总数
 * @method void setUsedCharSize(string $UsedCharSize) 设置知识库使用字符总数
...
class DescribeKnowledgeUsageResponse extends AbstractModel
{
     ...
     * @param string $UsedCharSize 知识库使用字符总数

 ...
 * @method string getState() 获取状态(ENABLE/DISABLE)
 * @method void setState(string $State) 设置状态(ENABLE/DISABLE)
 ...
 * @method string getNextHopIp() 获取下一跳资源ip
 * @method void setNextHopIp(string $NextHopIp) 设置下一跳资源ip
 * @method integer getPolicyBasedRoutingRulesCount() 获取0
 * @method void setPolicyBasedRoutingRulesCount(integer $PolicyBasedRoutingRulesCount) 设置0
 */
class CcnPolicyBasedRoutingNextHop extends AbstractModel
{
    /**
     ...
     * @var integer 0
     */
    public $PolicyBasedRoutingRulesCount;
     ...
     * @param string $State 状态(ENABLE/DISABLE)
     ...
     * @param string $NextHopIp 下一跳资源ip
     * @param integer $PolicyBasedRoutingRulesCount 0
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("NextHopIp",$param) and $param["NextHopIp"] !== null) {
            $this->NextHopIp = $param["NextHopIp"];
        }

        if (array_key_exists("PolicyBasedRoutingRulesCount",$param) and $param["PolicyBasedRoutingRulesCount"] !== null) {
            $this->PolicyBasedRoutingRulesCount = $param["PolicyBasedRoutingRulesCount"];
        }
    }
}

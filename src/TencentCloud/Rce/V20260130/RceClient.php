 ...
 * @method Models\AssessRiskResponse AssessRisk(Models\AssessRiskRequest $req) 事件风险评估
 * @method Models\ReportEventResponse ReportEvent(Models\ReportEventRequest $req) 事件信息上报
 */

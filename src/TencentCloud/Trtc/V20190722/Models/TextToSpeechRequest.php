 ...
 * @method string getLanguage() 获取 需要合成的语言（ISO 639-1），默认自动识别，支持的语言如下：
- zh（中文）
- en（英文）
- yue（粤语）
- ja（日语）
...
- id（印尼语）
- th（泰语）
 * @method void setLanguage(string $Language) 设置 需要合成的语言（ISO 639-1），默认自动识别，支持的语言如下：
- zh（中文）
- en（英文）
- yue（粤语）
- ja（日语）
...
class TextToSpeechRequest extends AbstractModel
{
    ...
    /**
     * @var string  需要合成的语言（ISO 639-1），默认自动识别，支持的语言如下：
- zh（中文）
- en（英文）
- yue（粤语）
- ja（日语）
...
- th（泰语）
     ...
     * @param string $Language  需要合成的语言（ISO 639-1），默认自动识别，支持的语言如下：
- zh（中文）
- en（英文）
- yue（粤语）
- ja（日语）

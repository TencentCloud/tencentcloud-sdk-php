 ...
 * @method string getModelVersion() 获取<p>要删除的版本号（如 v1, v2）</p>
 * @method void setModelVersion(string $ModelVersion) 设置<p>要删除的版本号（如 v1, v2）</p>
 */
class DeleteModelVersionRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>要删除的版本号（如 v1, v2）</p>
     */
    public $ModelVersion;

    /**
     * @param string $ModelUid <p>模型UID</p>
     * @param string $ModelVersion <p>要删除的版本号（如 v1, v2）</p>
     */

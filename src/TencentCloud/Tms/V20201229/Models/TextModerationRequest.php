 ...
 *
 * @method string getContent() 获取该字段表示待检测对象的文本内容，文本需要按utf-8格式编码，长度不能超过10000（按unicode编码计算），并进行 Base64加密
 * @method void setContent(string $Content) 设置该字段表示待检测对象的文本内容，文本需要按utf-8格式编码，长度不能超过10000（按unicode编码计算），并进行 Base64加密
...
{
    /**
     * @var string 该字段表示待检测对象的文本内容，文本需要按utf-8格式编码，长度不能超过10000（按unicode编码计算），并进行 Base64加密
     */
    public $Content;
    ...
    /**
     * @param string $Content 该字段表示待检测对象的文本内容，文本需要按utf-8格式编码，长度不能超过10000（按unicode编码计算），并进行 Base64加密

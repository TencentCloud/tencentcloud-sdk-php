 ...
 *
 * @method array getStrategySet() 获取<p>策略内容</p>
 * @method void setStrategySet(array $StrategySet) 设置<p>策略内容</p>
 ...
 */
class DescribeDspmAuditFilterStrategyResponse extends AbstractModel
{
    /**
     * @var array <p>策略内容</p>
     */
    ...
    /**
     * @param array $StrategySet <p>策略内容</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("StrategySet",$param) and $param["StrategySet"] !== null) {
            ...
            foreach ($param["StrategySet"] as $key => $value){
                $obj = new DescribeDspmAuditFilterStrategy();

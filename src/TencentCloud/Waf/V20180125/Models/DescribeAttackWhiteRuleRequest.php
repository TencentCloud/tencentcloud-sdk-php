 ...
 * @method void setFilters(array $Filters) 设置筛选条件，支持SignatureId, MatchContent
 */
class DescribeAttackWhiteRuleRequest extends AbstractModel
{
    /**
     * @var string 需要查询的域名
     */
    ...
    /**
     * @var array 筛选条件，支持SignatureId, MatchContent
     */
    public $Filters;

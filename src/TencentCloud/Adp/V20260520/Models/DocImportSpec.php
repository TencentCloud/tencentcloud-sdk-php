 ...
 * 文档导入规格（一次性输入的非持久化数据）
 *
 * @method string getFileId() 获取<p>文件 ID（通过文件管理服务获取的文件标识，不可为空）</p>
 * @method void setFileId(string $FileId) 设置<p>文件 ID（通过文件管理服务获取的文件标识，不可为空）</p>
 * @method string getCategoryId() 获取<p>归属分类 ID</p>
 * @method void setCategoryId(string $CategoryId) 设置<p>归属分类 ID</p>
 * @method array getDeDuplicateStrategyList() 获取<p>重复文件处理规则列表</p>
 * @method void setDeDuplicateStrategyList(array $DeDuplicateStrategyList) 设置<p>重复文件处理规则列表</p>
...
注意：此字段可能返回 null，表示取不到有效值。
 */
class DocImportSpec extends AbstractModel
{
    /**
     * @var string <p>文件 ID（通过文件管理服务获取的文件标识，不可为空）</p>
     */
    public $FileId;
    ...
    /**
     * @var array <p>重复文件处理规则列表</p>
     */
    public $DeDuplicateStrategyList;
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * @param string $FileId <p>文件 ID（通过文件管理服务获取的文件标识，不可为空）</p>
     * @param string $CategoryId <p>归属分类 ID</p>
     * @param array $DeDuplicateStrategyList <p>重复文件处理规则列表</p>
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("DeDuplicateStrategyList",$param) and $param["DeDuplicateStrategyList"] !== null) {
            $this->DeDuplicateStrategyList = [];
            foreach ($param["DeDuplicateStrategyList"] as $key => $value){
                $obj = new DeDuplicateStrategy();
                $obj->deserialize($value);
                array_push($this->DeDuplicateStrategyList, $obj);
            }
        }

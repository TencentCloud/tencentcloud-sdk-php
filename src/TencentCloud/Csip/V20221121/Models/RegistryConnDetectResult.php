 ...
 * 镜像仓库联通性检测结果
 *
 * @method string getConnDetectMessage() 获取<p>链接信息</p>
 * @method void setConnDetectMessage(string $ConnDetectMessage) 设置<p>链接信息</p>
 * @method string getConnDetectStatus() 获取<p>链接状态</p>
 * @method void setConnDetectStatus(string $ConnDetectStatus) 设置<p>链接状态</p>
 ...
 * @method string getSolution() 获取<p>失败解决方案</p>
 * @method void setSolution(string $Solution) 设置<p>失败解决方案</p>
...
class RegistryConnDetectResult extends AbstractModel
{
    ...
    /**
     * @param string $ConnDetectMessage <p>链接信息</p>
     * @param string $ConnDetectStatus <p>链接状态</p>
     * @param string $FailReason <p>失败原因</p>
     * @param string $Quuid <p>主机quuid</p>
     * @param string $Solution <p>失败解决方案</p>

 ...
 * @method array getDbTablePrivileges() 获取数据库表权限码数组
 * @method void setDbTablePrivileges(array $DbTablePrivileges) 设置数据库表权限码数组
...
class GrantAccountPrivilegesRequest extends AbstractModel
{
     ...
     * @param array $DbTablePrivileges 数据库表权限码数组

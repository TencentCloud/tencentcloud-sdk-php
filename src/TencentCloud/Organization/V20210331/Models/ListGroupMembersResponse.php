 ...
 * @method array getGroupMembers() 获取用户组的用户列表
 * @method void setGroupMembers(array $GroupMembers) 设置用户组的用户列表
...
class ListGroupMembersResponse extends AbstractModel
{
     ...
     * @param array $GroupMembers 用户组的用户列表
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("GroupMembers",$param) and $param["GroupMembers"] !== null) {
            $this->GroupMembers = [];
            foreach ($param["GroupMembers"] as $key => $value){
                $obj = new GroupMembers();
                $obj->deserialize($value);
                array_push($this->GroupMembers, $obj);
            }
        }

 ...
 * @method string getCloudProduct() 获取<p>待接入的云产品；支持tke、cdb、mongodb、redis</p>
 * @method void setCloudProduct(string $CloudProduct) 设置<p>待接入的云产品；支持tke、cdb、mongodb、redis</p>
 ...
 */
class CreateResourceGraphProductIngestTaskRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>待接入的云产品；支持tke、cdb、mongodb、redis</p>
     */
    public $CloudProduct;
     ...
     * @param string $CloudProduct <p>待接入的云产品；支持tke、cdb、mongodb、redis</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("CloudProduct",$param) and $param["CloudProduct"] !== null) {
            $this->CloudProduct = $param["CloudProduct"];
        }

 ...
 * @method boolean getGlobalHidden() 获取query参数配置是否隐藏不可见，true-隐藏不可见，false-可见
 * @method void setGlobalHidden(boolean $GlobalHidden) 设置query参数配置是否隐藏不可见，true-隐藏不可见，false-可见
 ...
 */
class AgentPluginQuery extends AbstractModel
{
    /**
     * @var string 参数名称
     */
    ...
    /**
     * @var boolean query参数配置是否隐藏不可见，true-隐藏不可见，false-可见
     */
    public $GlobalHidden;
     ...
     * @param boolean $GlobalHidden query参数配置是否隐藏不可见，true-隐藏不可见，false-可见

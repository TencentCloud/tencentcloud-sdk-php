 ...
 * @method array getWhiteList() 获取<p>敏感信息白名单列表</p>
 * @method void setWhiteList(array $WhiteList) 设置<p>敏感信息白名单列表</p>
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeImageSensitiveWhitelistResponse extends AbstractModel
{
    /**
     * @var integer <p>总数</p>
     */
     ...
     * @param array $WhiteList <p>敏感信息白名单列表</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("WhiteList",$param) and $param["WhiteList"] !== null) {
            ...
            foreach ($param["WhiteList"] as $key => $value){
                $obj = new ImageSensitiveWhitelist();

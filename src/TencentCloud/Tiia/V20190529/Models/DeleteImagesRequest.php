 ...
 * @method string getPicName() 获取图片名称，如果不指定本参数，则删除EntityId下所有的图片；否则删除指定的图。
 * @method void setPicName(string $PicName) 设置图片名称，如果不指定本参数，则删除EntityId下所有的图片；否则删除指定的图。
 */
class DeleteImagesRequest extends AbstractModel
{
    ...
    /**
     * @var string 图片名称，如果不指定本参数，则删除EntityId下所有的图片；否则删除指定的图。
     */
    public $PicName;
     ...
     * @param string $PicName 图片名称，如果不指定本参数，则删除EntityId下所有的图片；否则删除指定的图。
     */

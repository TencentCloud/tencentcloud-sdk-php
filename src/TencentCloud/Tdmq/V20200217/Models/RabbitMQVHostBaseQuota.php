 ...
 * @method integer getMaxQueuePerVhost() 获取单个 vhost 下允许的最大队列数
 * @method void setMaxQueuePerVhost(integer $MaxQueuePerVhost) 设置单个 vhost 下允许的最大队列数
 */
class RabbitMQVHostBaseQuota extends AbstractModel
{
    ...
    /**
     * @var integer 单个 vhost 下允许的最大队列数
     */
     ...
     * @param integer $MaxQueuePerVhost 单个 vhost 下允许的最大队列数
     */

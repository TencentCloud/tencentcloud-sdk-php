 ...
 * @method string getShieldId() 获取屏蔽策略的Id
 * @method void setShieldId(string $ShieldId) 设置屏蔽策略的Id
 ...
 * @method string getShieldAlarmLevel() 获取需要屏蔽的告警等级
 * @method void setShieldAlarmLevel(string $ShieldAlarmLevel) 设置需要屏蔽的告警等级
 ...
 */
class ModifyAlarmHistoryShieldRequest extends AbstractModel
{
    /**
     ...
     * @param string $ShieldAlarmLevel 需要屏蔽的告警等级

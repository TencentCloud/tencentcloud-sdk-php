 ...
 * @method array getInstanceList() 获取CLB实例监听器列表，取不到值返回空数组
 * @method void setInstanceList(array $InstanceList) 设置CLB实例监听器列表，取不到值返回空数组
 ...
 * @method string getAsyncCacheTime() 获取当前缓存读取时间，去不到值返回空
 * @method void setAsyncCacheTime(string $AsyncCacheTime) 设置当前缓存读取时间，去不到值返回空
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeHostClbInstanceListResponse extends AbstractModel
{
    /**
    ...
    /**
     * @var array CLB实例监听器列表，取不到值返回空数组
     */
    public $InstanceList;
     ...
     * @param array $InstanceList CLB实例监听器列表，取不到值返回空数组
     * @param integer $AsyncTotalNum 异步刷新总数，取不到值返回0
     * @param integer $AsyncOffset 异步刷新当前执行数，取不到值返回0
     * @param string $AsyncCacheTime 当前缓存读取时间，去不到值返回空

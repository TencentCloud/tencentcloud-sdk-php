 ...
 * @method string getName() 获取<p>分类名（长度：1~64 个字符）</p>
 * @method void setName(string $Name) 设置<p>分类名（长度：1~64 个字符）</p>
 * @method string getParentCategoryId() 获取<p>父分类 ID</p>
 * @method void setParentCategoryId(string $ParentCategoryId) 设置<p>父分类 ID</p>
 */
class CreateCategoryRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var string <p>分类名（长度：1~64 个字符）</p>
     */
    public $Name;

    /**
     * @var string <p>父分类 ID</p>
     */
     ...
     * @param string $Name <p>分类名（长度：1~64 个字符）</p>
     * @param string $ParentCategoryId <p>父分类 ID</p>
     */

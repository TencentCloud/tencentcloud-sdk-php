 ...
 *
 * @method ProcessImageAsyncTask getProcessImageConfigure() 获取图片异步处理任务配置。
 * @method void setProcessImageConfigure(ProcessImageAsyncTask $ProcessImageConfigure) 设置图片异步处理任务配置。
...
{
    /**
     * @var ProcessImageAsyncTask 图片异步处理任务配置。
     */
    ...
    /**
     * @param ProcessImageAsyncTask $ProcessImageConfigure 图片异步处理任务配置。

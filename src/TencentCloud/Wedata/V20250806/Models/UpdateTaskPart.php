 ...
 * 更新任务对象入参
 *
 * @method UpdateTaskBaseAttributePart getTaskBaseAttribute() 获取任务基本属性
 * @method void setTaskBaseAttribute(UpdateTaskBaseAttributePart $TaskBaseAttribute) 设置任务基本属性
...
{
    /**
     * @var UpdateTaskBaseAttributePart 任务基本属性
     */
    ...
    /**
     * @param UpdateTaskBaseAttributePart $TaskBaseAttribute 任务基本属性

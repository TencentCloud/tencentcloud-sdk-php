 ...
 * @method string getSourceId() 获取<p>服务来源</p>
 * @method void setSourceId(string $SourceId) 设置<p>服务来源</p>
 ...
 * @method string getProtocol() 获取<p>命名空间</p>
 * @method void setProtocol(string $Protocol) 设置<p>命名空间</p>
 ...
 * @method integer getKeyRotationPeriodDays() 获取<p>密钥轮转周期</p><p>单位：天</p>
...
class CloudNativeAPIGatewayLLMModelService extends AbstractModel
{
    ...
    /**
     * @var integer <p>密钥轮转周期</p><p>单位：天</p>
     */

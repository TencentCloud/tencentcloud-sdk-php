 ...
 * @method string getDescription() 获取自定义的账户描述
 * @method void setDescription(string $Description) 设置自定义的账户描述
 ...
 * @method integer getExpiresAt() 获取自定义的账户过期时间（时间戳，单位:毫秒）
 * @method void setExpiresAt(integer $ExpiresAt) 设置自定义的账户过期时间（时间戳，单位:毫秒）
 * @method boolean getDisable() 获取是否禁用自定义的账户
 * @method void setDisable(boolean $Disable) 设置是否禁用自定义的账户
 */
class CreateCustomAccountRequest extends AbstractModel
{
    ...
    /**
     * @var integer 自定义的账户过期时间（时间戳，单位:毫秒）
     */
    public $ExpiresAt;

    /**
     * @var boolean 是否禁用自定义的账户
     */
    public $Disable;
     ...
     * @param string $Description 自定义的账户描述
     * @param integer $Duration 有效期(单位：天)，从当前时间开始计算，优先级高于ExpiresAt
     * @param integer $ExpiresAt 自定义的账户过期时间（时间戳，单位:毫秒）
     * @param boolean $Disable 是否禁用自定义的账户
     */

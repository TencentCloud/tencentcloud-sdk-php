 ...
 * @method string getOrganizationOpenId() 获取动态签署方时，预设的企业OpenId，预设企业OpenId后，只允许对应的企业员工进行领取签署。
 * @method void setOrganizationOpenId(string $OrganizationOpenId) 设置动态签署方时，预设的企业OpenId，预设企业OpenId后，只允许对应的企业员工进行领取签署。
 */
class DynamicSignOption extends AbstractModel
{
    ...
    /**
     * @var string 动态签署方时，预设的企业OpenId，预设企业OpenId后，只允许对应的企业员工进行领取签署。
     */
     ...
     * @param string $OrganizationOpenId 动态签署方时，预设的企业OpenId，预设企业OpenId后，只允许对应的企业员工进行领取签署。
     */

 ...
 *
 * @method array getInfos() 获取<p>投递任务信息列表</p>
 * @method void setInfos(array $Infos) 设置<p>投递任务信息列表</p>
...
class DescribeCLSDeliverTasksResponse extends AbstractModel
{
    ...
    /**
     * @param array $Infos <p>投递任务信息列表</p>

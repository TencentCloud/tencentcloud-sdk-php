 ...
 *
 * @method integer getTotal() 获取列表总条数
 * @method void setTotal(integer $Total) 设置列表总条数
 * @method array getSessions() 获取列表内容
 * @method void setSessions(array $Sessions) 设置列表内容
...
class DescribePSTNActiveSessionListResponse extends AbstractModel
{
    ...
    /**
     * @param integer $Total 列表总条数
     * @param array $Sessions 列表内容

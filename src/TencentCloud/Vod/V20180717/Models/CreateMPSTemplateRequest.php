 ...
 * @method string getTemplateType() 获取<p>需要创建的 MPS 模板的类型。取值：</p><li>AIAnalysis: 创建智能分析模板。</li><li>SmartSubtitle: 创建智能字幕模板。</li><li>SmartErase: 创建智能擦除模板。</li><li>EmbedSubtitle: 创建字幕压制模板。</li>
 * @method void setTemplateType(string $TemplateType) 设置<p>需要创建的 MPS 模板的类型。取值：</p><li>AIAnalysis: 创建智能分析模板。</li><li>SmartSubtitle: 创建智能字幕模板。</li><li>SmartErase: 创建智能擦除模板。</li><li>EmbedSubtitle: 创建字幕压制模板。</li>
 ...
 * @method MPSEmbedSubtitleTemplate getEmbedSubtitleTemplate() 获取<p>字幕压制模板参数，MPSCreateTemplateParams为空时有效。</p>
 * @method void setEmbedSubtitleTemplate(MPSEmbedSubtitleTemplate $EmbedSubtitleTemplate) 设置<p>字幕压制模板参数，MPSCreateTemplateParams为空时有效。</p>
 */
class CreateMPSTemplateRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>需要创建的 MPS 模板的类型。取值：</p><li>AIAnalysis: 创建智能分析模板。</li><li>SmartSubtitle: 创建智能字幕模板。</li><li>SmartErase: 创建智能擦除模板。</li><li>EmbedSubtitle: 创建字幕压制模板。</li>
     */
    public $TemplateType;
    ...
    /**
     * @var MPSEmbedSubtitleTemplate <p>字幕压制模板参数，MPSCreateTemplateParams为空时有效。</p>
     */
    public $EmbedSubtitleTemplate;

    /**
     * @param integer $SubAppId <p><b>点播<a href="/document/product/266/14574">应用</a> ID。</b></p>
     * @param string $TemplateType <p>需要创建的 MPS 模板的类型。取值：</p><li>AIAnalysis: 创建智能分析模板。</li><li>SmartSubtitle: 创建智能字幕模板。</li><li>SmartErase: 创建智能擦除模板。</li><li>EmbedSubtitle: 创建字幕压制模板。</li>
     ...
     * @param MPSEmbedSubtitleTemplate $EmbedSubtitleTemplate <p>字幕压制模板参数，MPSCreateTemplateParams为空时有效。</p>
     */

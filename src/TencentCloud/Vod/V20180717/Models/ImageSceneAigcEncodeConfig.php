 ...
 * 图片编码格式参数。
 *
 * @method string getFormat() 获取图片格式，取值范围：JPEG、PNG，缺省为原图格式。不支持动画。
 * @method void setFormat(string $Format) 设置图片格式，取值范围：JPEG、PNG，缺省为原图格式。不支持动画。
...
{
    /**
     * @var string 图片格式，取值范围：JPEG、PNG，缺省为原图格式。不支持动画。
     */
    public $Format;
    ...
    /**
     * @param string $Format 图片格式，取值范围：JPEG、PNG，缺省为原图格式。不支持动画。

 ...
 * @method string getRegion() 获取<p>集群支持的地域</p>
 * @method void setRegion(string $Region) 设置<p>集群支持的地域</p>
 * @method string getClusterLevel() 获取<p>集群规模</p><p>默认值：L500</p>
 * @method void setClusterLevel(string $ClusterLevel) 设置<p>集群规模</p><p>默认值：L500</p>
 ...
 * @method string getClusterVersion() 获取<p>集群版本号</p>
 * @method void setClusterVersion(string $ClusterVersion) 设置<p>集群版本号</p>
 * @method integer getClusterNodeNum() 获取<p>集群中的节点数量</p><p>单位：台</p>
 * @method void setClusterNodeNum(integer $ClusterNodeNum) 设置<p>集群中的节点数量</p><p>单位：台</p>
 ...
 * @method array getTags() 获取<p>集群的标签信息</p>
...
class DBCustomCluster extends AbstractModel
{
    ...
    /**
     * @var string <p>集群支持的地域</p>
     */
    public $Region;

    /**
     * @var string <p>集群规模</p><p>默认值：L500</p>
     */
    public $ClusterLevel;
    ...
    /**
     * @var string <p>集群版本号</p>
     */
    public $ClusterVersion;

    /**
     * @var integer <p>集群中的节点数量</p><p>单位：台</p>
     */
...
注意：此字段可能返回 null，表示取不到有效值。
     ...
     * @param string $ClusterLevel <p>集群规模</p><p>默认值：L500</p>
     * @param string $ClusterStatus <p>DB Custom 集群状态</p><p>枚举值：</p><ul><li>Creating： 创建中</li><li>Running： 运行中</li><li>Destroying： 销毁中</li></ul>
     * @param string $ClusterVersion <p>集群版本号</p>
     * @param integer $ClusterNodeNum <p>集群中的节点数量</p><p>单位：台</p>

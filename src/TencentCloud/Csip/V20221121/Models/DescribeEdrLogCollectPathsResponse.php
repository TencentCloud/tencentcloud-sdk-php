 ...
 *
 * @method array getPaths() 获取<p>采集路径配置列表</p>
 * @method void setPaths(array $Paths) 设置<p>采集路径配置列表</p>
 ...
 */
class DescribeEdrLogCollectPathsResponse extends AbstractModel
{
    /**
     * @var array <p>采集路径配置列表</p>
     */
    public $Paths;
    ...
    /**
     * @param array $Paths <p>采集路径配置列表</p>

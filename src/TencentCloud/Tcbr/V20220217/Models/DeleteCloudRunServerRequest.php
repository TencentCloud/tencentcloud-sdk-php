 ...
 * @method string getOperatorRemark() 获取操作人信息
 * @method void setOperatorRemark(string $OperatorRemark) 设置操作人信息
 */
class DeleteCloudRunServerRequest extends AbstractModel
{
    /**
     * @var string 环境Id
     */
     ...
     * @param string $OperatorRemark 操作人信息
     */

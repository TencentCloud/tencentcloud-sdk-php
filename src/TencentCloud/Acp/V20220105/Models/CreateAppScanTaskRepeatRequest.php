 ...
 * @method string getFileID() 获取上传的文件ID(灵犀诊断必填)
 * @method void setFileID(string $FileID) 设置上传的文件ID(灵犀诊断必填)
...
class CreateAppScanTaskRepeatRequest extends AbstractModel
{
     ...
     * @param string $FileID 上传的文件ID(灵犀诊断必填)

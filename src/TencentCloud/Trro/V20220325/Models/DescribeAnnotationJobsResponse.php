 ...
 *
 * @method integer getTotalCount() 获取<p>符合条件的任务总数</p>
 * @method void setTotalCount(integer $TotalCount) 设置<p>符合条件的任务总数</p>
 ...
 * @method array getJobs() 获取<p>任务列表</p>
 * @method void setJobs(array $Jobs) 设置<p>任务列表</p>
 * @method string getRequestId() 获取唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 * @method void setRequestId(string $RequestId) 设置唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
 */
class DescribeAnnotationJobsResponse extends AbstractModel
{
    /**
     * @var integer <p>符合条件的任务总数</p>
     */
    public $TotalCount;
    ...
    /**
     * @param integer $TotalCount <p>符合条件的任务总数</p>
     * @param integer $Offset <p>分页偏移</p>
     * @param integer $Limit <p>每页数量</p>
     * @param array $Jobs <p>任务列表</p>

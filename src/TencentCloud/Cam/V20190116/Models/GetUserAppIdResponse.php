 ...
 * GetUserAppId返回参数结构体
 *
 * @method string getUin() 获取当前账号Uin
 * @method void setUin(string $Uin) 设置当前账号Uin
 * @method string getOwnerUin() 获取当前账号OwnerUin
...
class GetUserAppIdResponse extends AbstractModel
{
    ...
    /**
     * @var string 当前账号OwnerUin
     */
    public $OwnerUin;

    /**
     * @var integer 当前账号AppId
     */
    public $AppId;

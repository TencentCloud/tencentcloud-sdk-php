 ...
 * @method array getAudioTrackTemplateSet() 获取音频轨模板详情列表。
 * @method void setAudioTrackTemplateSet(array $AudioTrackTemplateSet) 设置音频轨模板详情列表。
...
class DescribeAudioTrackTemplatesResponse extends AbstractModel
{
     ...
     * @param array $AudioTrackTemplateSet 音频轨模板详情列表。

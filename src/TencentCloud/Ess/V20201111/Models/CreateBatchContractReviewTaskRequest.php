 ...
 * @method RiskIdentificationRoleInfo getRole() 获取合同审查中的角色信息，通过明确入参角色的名称和描述，可以提高合同审查的效率和准确性。
 * @method void setRole(RiskIdentificationRoleInfo $Role) 设置合同审查中的角色信息，通过明确入参角色的名称和描述，可以提高合同审查的效率和准确性。
...
<ul>
    ...
    /**
     * @var RiskIdentificationRoleInfo 合同审查中的角色信息，通过明确入参角色的名称和描述，可以提高合同审查的效率和准确性。
     */
    public $Role;
...
<ul>
     ...
     * @param RiskIdentificationRoleInfo $Role 合同审查中的角色信息，通过明确入参角色的名称和描述，可以提高合同审查的效率和准确性。

 ...
 *
 * @method integer getTotalCount() 获取总扩缩容记录数。
 * @method void setTotalCount(integer $TotalCount) 设置总扩缩容记录数。
 * @method array getRecordList() 获取记录列表。
 * @method void setRecordList(array $RecordList) 设置记录列表。
...
class DescribeAutoScaleRecordsResponse extends AbstractModel
{
    ...
    /**
     * @param integer $TotalCount 总扩缩容记录数。

 ...
 * @method QuerySinglePaymentResultData getResult() 获取返回响应
注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(QuerySinglePaymentResultData $Result) 设置返回响应
注意：此字段可能返回 null，表示取不到有效值。
...
class QuerySinglePaymentResultResponse extends AbstractModel
{
    ...
    /**
     * @var QuerySinglePaymentResultData 返回响应
注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
     ...
     * @param QuerySinglePaymentResultData $Result 返回响应
注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result",$param) and $param["Result"] !== null) {
            $this->Result = new QuerySinglePaymentResultData();

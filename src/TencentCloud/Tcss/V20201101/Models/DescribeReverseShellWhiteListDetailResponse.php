 ...
 *
 * @method ReverseShellWhiteListInfo getWhiteListDetailInfo() 获取事件基本信息
 * @method void setWhiteListDetailInfo(ReverseShellWhiteListInfo $WhiteListDetailInfo) 设置事件基本信息
...
{
    /**
     * @var ReverseShellWhiteListInfo 事件基本信息
     */

...
class DescribeUserDirectoryResponse extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("UserDirSet",$param) and $param["UserDirSet"] !== null) {
            $this->UserDirSet = [];
            foreach ($param["UserDirSet"] as $key => $value){
                $obj = new UserDirectory();
                $obj->deserialize($value);
                array_push($this->UserDirSet, $obj);
            }
        }

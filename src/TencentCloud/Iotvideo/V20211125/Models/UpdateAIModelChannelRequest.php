 ...
 * @method string getForwardKey() 获取第三方推送密钥，不填写则腾讯云自动生成。
 * @method void setForwardKey(string $ForwardKey) 设置第三方推送密钥，不填写则腾讯云自动生成。
...
class UpdateAIModelChannelRequest extends AbstractModel
{
    ...
    /**
     * @var string 第三方推送密钥，不填写则腾讯云自动生成。
     */
    public $ForwardKey;
     ...
     * @param string $ForwardKey 第三方推送密钥，不填写则腾讯云自动生成。

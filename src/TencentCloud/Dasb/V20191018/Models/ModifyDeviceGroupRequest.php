 ...
 *
 * @method string getName() 获取资产组名，最大长度32字符，不能为空
 * @method void setName(string $Name) 设置资产组名，最大长度32字符，不能为空
...
class ModifyDeviceGroupRequest extends AbstractModel
{
    ...
    /**
     * @param string $Name 资产组名，最大长度32字符，不能为空

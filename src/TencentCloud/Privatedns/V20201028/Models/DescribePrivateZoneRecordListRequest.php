 ...
 *
 * @method string getZoneId() 获取私有域ID: zone-12c5a6e8
 * @method void setZoneId(string $ZoneId) 设置私有域ID: zone-12c5a6e8
...
{
    /**
     * @var string 私有域ID: zone-12c5a6e8
     */
    public $ZoneId;
    ...
    /**
     * @param string $ZoneId 私有域ID: zone-12c5a6e8

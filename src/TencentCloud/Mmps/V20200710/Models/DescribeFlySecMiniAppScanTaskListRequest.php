 ...
 * @method string getMiniAppID() 获取小程序appid(为空的时候,则查询当前用户诊断的所有小程序)
 * @method void setMiniAppID(string $MiniAppID) 设置小程序appid(为空的时候,则查询当前用户诊断的所有小程序)
 */
class DescribeFlySecMiniAppScanTaskListRequest extends AbstractModel
{
    ...
    /**
     * @var string 小程序appid(为空的时候,则查询当前用户诊断的所有小程序)
     */
    public $MiniAppID;
     ...
     * @param string $MiniAppID 小程序appid(为空的时候,则查询当前用户诊断的所有小程序)
     */

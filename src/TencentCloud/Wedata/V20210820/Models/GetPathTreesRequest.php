 ...
 * @method boolean getScript() 获取是否为脚本 false 非脚本
true 脚本
 * @method void setScript(boolean $Script) 设置是否为脚本 false 非脚本
true 脚本
 */
class GetPathTreesRequest extends AbstractModel
{
    /**
     * @var string 项目ID
     */
...
true 脚本
     ...
     * @param boolean $Script 是否为脚本 false 非脚本
true 脚本
     */

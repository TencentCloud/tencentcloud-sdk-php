 ...
 * @method array getDefinitions() 获取音画质检测模板列表。长度限制：100。
 * @method void setDefinitions(array $Definitions) 设置音画质检测模板列表。长度限制：100。
...
<li>Custom：用户自定义模板。</li>
     ...
     * @param array $Definitions 音画质检测模板列表。长度限制：100。

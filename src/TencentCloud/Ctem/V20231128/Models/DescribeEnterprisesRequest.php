 ...
 * @method boolean getIsShowStatistics() 获取是否展示统计数据
 * @method void setIsShowStatistics(boolean $IsShowStatistics) 设置是否展示统计数据
 */
class DescribeEnterprisesRequest extends AbstractModel
{
    /**
    ...
    /**
     * @var boolean 是否展示统计数据
     */
    public $IsShowStatistics;
     ...
     * @param boolean $IsShowStatistics 是否展示统计数据
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("IsShowStatistics",$param) and $param["IsShowStatistics"] !== null) {
            $this->IsShowStatistics = $param["IsShowStatistics"];
        }
    }
}
